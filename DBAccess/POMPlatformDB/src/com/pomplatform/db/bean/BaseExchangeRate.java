...
public class BaseExchangeRate extends GenericBase implements BaseFactory<BaseExchangeRate>, Comparable<BaseExchangeRate> 
{


	public static BaseExchangeRate newInstance(){
		return new BaseExchangeRate();
	}

	@Override
	public BaseExchangeRate make(){
	...
	public final static java.lang.String ALL_CAPTIONS = "汇率表编码,,汇率,兑换日期";
	...
	public void cloneCopy(BaseExchangeRate __bean){
	...
	@Override
	public int compareTo(BaseExchangeRate o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseExchangeRate o = (BaseExchangeRate)obj;
