...
public class BaseCustomer extends GenericBase implements BaseFactory<BaseCustomer>, Comparable<BaseCustomer> 
{


	public static BaseCustomer newInstance(){
		return new BaseCustomer();
	}

	@Override
	public BaseCustomer make(){
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,客户名称,客户地址,网站,联系电话,传真,股票代码,邮编,省份,城市,4接洽过未合作客户)(对应于字典表151),3三级)(对应于字典表145),3设计合作单位),父级编码,是否确认,是否入库,是否已提供战略报价,客户集团公司名称,客户集团公司地址,分支机构,公司人数,公司成立日期,企业性质,企业资质,组织架构,公司简介,操作人,创建时间,备注,报备人员";
	...
	public void cloneCopy(BaseCustomer __bean){
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		sb.append(getCustomerLevel() == null ? "" : getCustomerLevel());
		sb.append(",");
		...
		sb.append(",");
		sb.append(getReportEmployeeId() == null ? "" : getReportEmployeeId());
		return sb.toString();
	}

	@Override
	public int compareTo(BaseCustomer o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseCustomer o = (BaseCustomer)obj;
