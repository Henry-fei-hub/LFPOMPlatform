...
public class BaseHrEmpFinger extends GenericBase implements BaseFactory<BaseHrEmpFinger>, Comparable<BaseHrEmpFinger> 
{


	public static BaseHrEmpFinger newInstance(){
		return new BaseHrEmpFinger();
	}

	@Override
	public BaseHrEmpFinger make(){
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,员工id,设备序列号,考勤号码,指纹,指纹版本,指纹类型,大小,有效日期,是否可用,指纹序号,时区";
	...
	public void cloneCopy(BaseHrEmpFinger __bean){
	...
	@Override
	public int compareTo(BaseHrEmpFinger o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseHrEmpFinger o = (BaseHrEmpFinger)obj;
