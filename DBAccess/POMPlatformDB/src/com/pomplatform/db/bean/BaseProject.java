...
public class BaseProject extends GenericBase implements BaseFactory<BaseProject>, Comparable<BaseProject> 
{


	public static BaseProject newInstance(){
		return new BaseProject();
	}

	@Override
	public BaseProject make(){
	...
	public final static java.lang.String CS_IS_HAS_PRICE = "is_has_price" ;
	public final static java.lang.String CS_COMMISSION_RATE = "commission_rate" ;
	...
	public final static java.lang.String CAPTIONS = "订单编号,项目名称,业务部门,业务类别,业务条线,项目类别,备注";
	...
	public java.math.BigDecimal getCommissionRate() {
		return this.__commission_rate;
	}

	public void setCommissionRate( java.math.BigDecimal value ) {
		this.__commission_rate = value;
	}

	public void cloneCopy(BaseProject __bean){
		...
		__bean.setIsHasPrice(getIsHasPrice());
		__bean.setCommissionRate(getCommissionRate());
	}

	public java.lang.String toCSVStringBussinessLine() {
		...
		sb.append(",");
		sb.append(getBusinessType() == null ? "" : delicacy.system.executor.SelectValueCache.getSelectValue("production_value_coefficient_type", String.valueOf(getBusinessType())));
		sb.append(",");
		sb.append(getBusinessLine() == null ? "" : delicacy.system.executor.SelectValueCache.getSelectValue("system_dictionary_205", String.valueOf(getBusinessLine())));
		sb.append(",");
		sb.append(getProjectType() == null ? "" : delicacy.system.executor.SelectValueCache.getSelectValue("system_dictionary_32", String.valueOf(getProjectType())));
		sb.append(",");
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		sb.append(getPricingType() == null ? "" : getPricingType());
		sb.append(",");
		sb.append(getIsHasPrice() == null ? "" : getIsHasPrice());
		sb.append(",");
		sb.append(getCommissionRate() == null ? "" : getCommissionRate());
		return sb.toString();
	}

	@Override
	public int compareTo(BaseProject o) {
	...
	public int hashCode() {
		...
		hash = 97 * hash + Objects.hashCode(this.__is_has_price);
		hash = 97 * hash + Objects.hashCode(this.__commission_rate);
		return hash;
	}
	...
	public boolean equals(Object obj) {
		...
		final BaseProject o = (BaseProject)obj;
		...
		if(!Objects.equals(this.__is_has_price, o.getIsHasPrice())) return false;
		if(!Objects.equals(this.__commission_rate, o.getCommissionRate())) return false;
		return true;
	}
	...
	public java.lang.String toJSONString() {
		...
		if(getIsHasPrice() != null) sb.append(__wrapBoolean(count++, "isHasPrice", getIsHasPrice()));
		if(getCommissionRate() != null) sb.append(__wrapDecimal(count++, "commissionRate", getCommissionRate()));
		return sb.toString();
	}
	...
	public Map<String, Object> toMap() {
		...
		if(getWorkHours() != null) res.put("workHours", getWorkHours());
		...
		if(getOldProjectDiscount() != null) res.put("oldProjectDiscount", getOldProjectDiscount());
		if(getBudget() != null) res.put("budget", getBudget());
		...
		if(getProjectProgress() != null) res.put("projectProgress", getProjectProgress());
		if(getProjectSize() != null) res.put("projectSize", getProjectSize());
		if(getProjectDescription() != null) res.put("projectDescription", getProjectDescription());
		if(getAuditReason() != null) res.put("auditReason", getAuditReason());
		if(getDepartmentManagerId() != null) res.put("departmentManagerId", getDepartmentManagerId());
		if(getBimArea() != null) res.put("bimArea", getBimArea());
		if(getCadArea() != null) res.put("cadArea", getCadArea());
		if(getHumanAmount() != null) res.put("humanAmount", getHumanAmount());
		if(getAppendTotalIntegral() != null) res.put("appendTotalIntegral", getAppendTotalIntegral());
		if(getAppendIntegral() != null) res.put("appendIntegral", getAppendIntegral());
		if(getRemark() != null) res.put("remark", getRemark());
		if(getProjectFinishPercent() != null) res.put("projectFinishPercent", getProjectFinishPercent());
		if(getParentId() != null) res.put("parentId", getParentId());
		if(getTotalFinishPercent() != null) res.put("totalFinishPercent", getTotalFinishPercent());
		if(getProjectGradeType() != null) res.put("projectGradeType", getProjectGradeType());
		if(getPlateManagerId() != null) res.put("plateManagerId", getPlateManagerId());
		if(getLastPercent() != null) res.put("lastPercent", getLastPercent());
		...
		if(getRevenuePlateId() != null) res.put("revenuePlateId", getRevenuePlateId());
		...
		if(getIsEcmcProject() != null) res.put("isEcmcProject", getIsEcmcProject());
		if(getMoneySum() != null) res.put("moneySum", getMoneySum());
		if(getProjectSetupFlag() != null) res.put("projectSetupFlag", getProjectSetupFlag());
		if(getIsLock() != null) res.put("isLock", getIsLock());
		if(getIsAuto() != null) res.put("isAuto", getIsAuto());
		if(getTimeCycle() != null) res.put("timeCycle", getTimeCycle());
		...
		if(getPricingType() != null) res.put("pricingType", getPricingType());
		if(getIsHasPrice() != null) res.put("isHasPrice", getIsHasPrice());
		if(getCommissionRate() != null) res.put("commissionRate", getCommissionRate());
		return res;
	}
	...
	public void setDataFromMap(Map<String, Object> values){
		...
		if((val = values.get("commissionRate")) != null) setCommissionRate(__getDecimal(val));  
	}
	...
	protected java.lang.Boolean  __is_has_price ;
	protected java.math.BigDecimal  __commission_rate ;
}
