...
public class BasePlateReportRecord extends GenericBase implements BaseFactory<BasePlateReportRecord>, Comparable<BasePlateReportRecord> 
{


	public static BasePlateReportRecord newInstance(){
		return new BasePlateReportRecord();
	}

	@Override
	public BasePlateReportRecord make(){
		BasePlateReportRecord b = new BasePlateReportRecord();
		return b;
	}

	public final static java.lang.String CS_PLATE_REPORT_RECORD_ID = "plate_report_record_id" ;
	...
	public final static java.lang.String ALL_CAPTIONS = "编码,业务部门,价值积分,项目结算,公司补贴,积分回流,人工成本回流,人工成本补贴,积分发放,运营成本,记录产生时间,是否锁定,项目补贴,品质管理费,公司费用,项目违规金";

	public java.lang.Integer getPlateReportRecordId() {
		return this.__plate_report_record_id;
	}

	public void setPlateReportRecordId( java.lang.Integer value ) {
		this.__plate_report_record_id = value;
	}
	...
	public void cloneCopy(BasePlateReportRecord __bean){
		__bean.setPlateReportRecordId(getPlateReportRecordId());
	...
	public java.lang.String toCSVString() {
		...
		sb.append(getPlateReportRecordId() == null ? "" : getPlateReportRecordId());
		sb.append(",");
	...
	@Override
	public int compareTo(BasePlateReportRecord o) {
		return __plate_report_record_id == null ? -1 : __plate_report_record_id.compareTo(o.getPlateReportRecordId());
	}

	@Override
	public int hashCode() {
		int hash = 7;
		hash = 97 * hash + Objects.hashCode(this.__plate_report_record_id);
	...
	public boolean equals(Object obj) {
		...
		final BasePlateReportRecord o = (BasePlateReportRecord)obj;
		if(!Objects.equals(this.__plate_report_record_id, o.getPlateReportRecordId())) return false;
		if(!Objects.equals(this.__plate_id, o.getPlateId())) return false;
		if(!Objects.equals(this.__achieve_integral, o.getAchieveIntegral())) return false;
		if(!Objects.equals(this.__project_settlement, o.getProjectSettlement())) return false;
		...
		if(!Objects.equals(this.__quality_fee, o.getQualityFee())) return false;
	...
	public java.lang.String toJSONString() {
		...
		StringBuilder sb = new StringBuilder();
		int count = 0;
		if(getPlateReportRecordId() != null) sb.append(__wrapNumber(count++, "plateReportRecordId", getPlateReportRecordId()));
		if(getPlateId() != null) sb.append(__wrapNumber(count++, "plateId", getPlateId()));
		if(getAchieveIntegral() != null) sb.append(__wrapDecimal(count++, "achieveIntegral", getAchieveIntegral()));
		if(getProjectSettlement() != null) sb.append(__wrapDecimal(count++, "projectSettlement", getProjectSettlement()));
		...
		if(getQualityFee() != null) sb.append(__wrapDecimal(count++, "qualityFee", getQualityFee()));
	...
	public void setDataFromMap(Map<String, Object> values){
		Object val;
		if((val = values.get("plateReportRecordId")) != null) setPlateReportRecordId(__getInt(val)); 
		if((val = values.get("plateId")) != null) setPlateId(__getInt(val)); 
		if((val = values.get("achieveIntegral")) != null) setAchieveIntegral(__getDecimal(val));  
		if((val = values.get("projectSettlement")) != null) setProjectSettlement(__getDecimal(val));  
		...
		if((val = values.get("qualityFee")) != null) setQualityFee(__getDecimal(val));  
	...
	protected java.lang.Integer  __plate_report_record_id ;
