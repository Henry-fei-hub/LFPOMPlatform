...
public class BasePlateAccountRecord extends GenericBase implements BaseFactory<BasePlateAccountRecord>, Comparable<BasePlateAccountRecord> 
{


	public static BasePlateAccountRecord newInstance(){
		return new BasePlateAccountRecord();
	}

	@Override
	public BasePlateAccountRecord make(){
		BasePlateAccountRecord b = new BasePlateAccountRecord();
		return b;
	}

	public final static java.lang.String CS_PLATE_ACCOUNT_RECORD_ID = "plate_account_record_id" ;
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,业务部门,业务功能编码,11绩效奖金),积分,日期,是否加锁,操作人,操作时间,备注";

	public java.lang.Integer getPlateAccountRecordId() {
		return this.__plate_account_record_id;
	}

	public void setPlateAccountRecordId( java.lang.Integer value ) {
		this.__plate_account_record_id = value;
	}
	...
	public void cloneCopy(BasePlateAccountRecord __bean){
		__bean.setPlateAccountRecordId(getPlateAccountRecordId());
	...
	public java.lang.String toCSVString() {
		...
		sb.append(getPlateAccountRecordId() == null ? "" : getPlateAccountRecordId());
		sb.append(",");
	...
	@Override
	public int compareTo(BasePlateAccountRecord o) {
		return __plate_account_record_id == null ? -1 : __plate_account_record_id.compareTo(o.getPlateAccountRecordId());
	}

	@Override
	public int hashCode() {
		int hash = 7;
		hash = 97 * hash + Objects.hashCode(this.__plate_account_record_id);
	...
	public boolean equals(Object obj) {
		...
		final BasePlateAccountRecord o = (BasePlateAccountRecord)obj;
		if(!Objects.equals(this.__plate_account_record_id, o.getPlateAccountRecordId())) return false;
	...
	public java.lang.String toJSONString() {
		...
		StringBuilder sb = new StringBuilder();
		int count = 0;
		if(getPlateAccountRecordId() != null) sb.append(__wrapNumber(count++, "plateAccountRecordId", getPlateAccountRecordId()));
	...
	public void setDataFromMap(Map<String, Object> values){
		Object val;
		if((val = values.get("plateAccountRecordId")) != null) setPlateAccountRecordId(__getInt(val)); 
	...
	protected java.lang.Integer  __plate_account_record_id ;
