...
public class BaseSubContract extends GenericBase implements BaseFactory<BaseSubContract>, Comparable<BaseSubContract> 
{


	public static BaseSubContract newInstance(){
		return new BaseSubContract();
	}

	@Override
	public BaseSubContract make(){
	...
	public final static java.lang.String ALL_CAPTIONS = "子合同编码,主合同编码,子合同编号,项目编号,业务类型,项目类型,承接部门,公区面积,后勤面积,小计 子订单总金额,创建时间,子合同名称  充当了区域,修改时间,设计面积,标记补充协议字段；除0之外，其他都表示第n个补充协议,项目总积分,投诉保证金,订单积分,投诉保证金比例,价格审核同意的时间,信息编号,业态编码,备注,项目经理,false 非历史版本  true (报价单/合同)变更,是否自动结算,预留订单Id,业务条线,占比";
	...
	public void cloneCopy(BaseSubContract __bean){
	...
	@Override
	public int compareTo(BaseSubContract o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSubContract o = (BaseSubContract)obj;
