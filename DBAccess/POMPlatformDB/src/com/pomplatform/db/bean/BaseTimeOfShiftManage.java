...
public class BaseTimeOfShiftManage extends GenericBase implements BaseFactory<BaseTimeOfShiftManage>, Comparable<BaseTimeOfShiftManage> 
{


	public static BaseTimeOfShiftManage newInstance(){
		return new BaseTimeOfShiftManage();
	}

	@Override
	public BaseTimeOfShiftManage make(){
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,班次id,时段id,星期一,星期二,星期三,星期四,星期五,星期六,星期日,操作人,操作时间,备注";
	...
	public void cloneCopy(BaseTimeOfShiftManage __bean){
	...
	@Override
	public int compareTo(BaseTimeOfShiftManage o) {
		return __time_of_shift_manage_id == null ? -1 : __time_of_shift_manage_id.compareTo(o.getTimeOfShiftManageId());
	}
	...
	public boolean equals(Object obj) {
		...
		final BaseTimeOfShiftManage o = (BaseTimeOfShiftManage)obj;
		if(!Objects.equals(this.__time_of_shift_manage_id, o.getTimeOfShiftManageId())) return false;
