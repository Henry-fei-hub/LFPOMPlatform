...
public class BaseBudgetAttachment extends GenericBase implements BaseFactory<BaseBudgetAttachment>, Comparable<BaseBudgetAttachment> 
{


	public static BaseBudgetAttachment newInstance(){
		return new BaseBudgetAttachment();
	}

	@Override
	public BaseBudgetAttachment make(){
	...
	public final static java.lang.String ALL_CAPTIONS = "主键id,预算管理id,附件编码,附件名称,上传人员,上传人员归属部门,上传时间,附件备注,合同金额,合同已付款金额,剩余合同金额,供应商,项目id,发票编码,预算类别  budget_detail_type,是否审批 0.未审批 1.审批进行中,2.已审批,";
	...
	public void cloneCopy(BaseBudgetAttachment __bean){
	...
	@Override
	public int compareTo(BaseBudgetAttachment o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseBudgetAttachment o = (BaseBudgetAttachment)obj;
