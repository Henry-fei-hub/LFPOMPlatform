...
public class BasePersonnelBusines extends GenericBase implements BaseFactory<BasePersonnelBusines>, Comparable<BasePersonnelBusines> 
{


	public static BasePersonnelBusines newInstance(){
		return new BasePersonnelBusines();
	}

	@Override
	public BasePersonnelBusines make(){
	...
	public void cloneCopy(BasePersonnelBusines __bean){
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		String strStartDateDetail = delicacy.system.executor.SelectValueCache.getSelectValue("system_dictionary", String.valueOf(getStartDateDetail()));
	...
	@Override
	public int compareTo(BasePersonnelBusines o) {
	...
	public boolean equals(Object obj) {
		...
		final BasePersonnelBusines o = (BasePersonnelBusines)obj;
