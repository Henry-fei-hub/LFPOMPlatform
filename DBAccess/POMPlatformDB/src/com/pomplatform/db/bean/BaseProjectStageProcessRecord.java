...
public class BaseProjectStageProcessRecord extends GenericBase implements BaseFactory<BaseProjectStageProcessRecord>, Comparable<BaseProjectStageProcessRecord> 
{


	public static BaseProjectStageProcessRecord newInstance(){
		return new BaseProjectStageProcessRecord();
	}

	@Override
	public BaseProjectStageProcessRecord make(){
	...
	public void cloneCopy(BaseProjectStageProcessRecord __bean){
	...
	@Override
	public int compareTo(BaseProjectStageProcessRecord o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseProjectStageProcessRecord o = (BaseProjectStageProcessRecord)obj;
	...
	public static List<Map<String, Object>> GenerateMapList(List<BaseProjectStageProcessRecord> ol) {
		List<Map<String, Object>> res = new ArrayList<>();
		for(BaseProjectStageProcessRecord b : ol) res.add(b.toMap());
		return res;
	}
