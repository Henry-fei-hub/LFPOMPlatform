...
public class BasePreProjectTransferRecord extends GenericBase implements BaseFactory<BasePreProjectTransferRecord>, Comparable<BasePreProjectTransferRecord> 
{


	public static BasePreProjectTransferRecord newInstance(){
		return new BasePreProjectTransferRecord();
	}

	@Override
	public BasePreProjectTransferRecord make(){
	...
	public void cloneCopy(BasePreProjectTransferRecord __bean){
	...
	@Override
	public int compareTo(BasePreProjectTransferRecord o) {
	...
	public boolean equals(Object obj) {
		...
		final BasePreProjectTransferRecord o = (BasePreProjectTransferRecord)obj;
