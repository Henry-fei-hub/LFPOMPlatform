...
public class BaseCapitalDistributionLinkDepartment extends GenericBase implements BaseFactory<BaseCapitalDistributionLinkDepartment>, Comparable<BaseCapitalDistributionLinkDepartment> 
{


	public static BaseCapitalDistributionLinkDepartment newInstance(){
		return new BaseCapitalDistributionLinkDepartment();
	}

	@Override
	public BaseCapitalDistributionLinkDepartment make(){
	...
	public final static java.lang.String ALL_CAPTIONS = ",回款分配编码,部门编码,金额,收款主键(手动分配回款使用),创建时间";
	...
	public void cloneCopy(BaseCapitalDistributionLinkDepartment __bean){
	...
	@Override
	public int compareTo(BaseCapitalDistributionLinkDepartment o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseCapitalDistributionLinkDepartment o = (BaseCapitalDistributionLinkDepartment)obj;
