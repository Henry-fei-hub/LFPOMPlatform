...
public class BaseProductInquiryTotal extends GenericBase implements BaseFactory<BaseProductInquiryTotal>, Comparable<BaseProductInquiryTotal> 
{


	public static BaseProductInquiryTotal newInstance(){
		return new BaseProductInquiryTotal();
	}

	@Override
	public BaseProductInquiryTotal make(){
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,主题,流程类型,事由,申请人工号,申请人部门,创建人,创建时间,删除状态 0未删除 1已删除,备注,大项目主键";
	...
	public void cloneCopy(BaseProductInquiryTotal __bean){
	...
	@Override
	public int compareTo(BaseProductInquiryTotal o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseProductInquiryTotal o = (BaseProductInquiryTotal)obj;
