...
public class BaseProjectSettlementDetail extends GenericBase implements BaseFactory<BaseProjectSettlementDetail>, Comparable<BaseProjectSettlementDetail> 
{


	public static BaseProjectSettlementDetail newInstance(){
		return new BaseProjectSettlementDetail();
	}

	@Override
	public BaseProjectSettlementDetail make(){
	...
	public final static java.lang.String ALL_CAPTIONS = "结算详细代码,结算代码,项目代码,结算操作人,工作内容,结算日期,计划分配,实际分配,分摊费用,最终获得,结算状态system_dictionary_97,完成百分比,该记录的积分是否回收的标识，true回收； false不回收,调整后的积分,3已驳回,历史确认积分,历史分摊成本";
	...
	public void cloneCopy(BaseProjectSettlementDetail __bean){
	...
	@Override
	public int compareTo(BaseProjectSettlementDetail o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseProjectSettlementDetail o = (BaseProjectSettlementDetail)obj;
