...
public class BaseAnnoucement extends GenericBase implements BaseFactory<BaseAnnoucement>, Comparable<BaseAnnoucement> 
{


	public static BaseAnnoucement newInstance(){
		return new BaseAnnoucement();
	}

	@Override
	public BaseAnnoucement make(){
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,项目编码,客户Id,公告主题,公告内容,公告时间,公告人员Id集,公告人员姓名集,操作人,操作时间,备注,公告状态（1已发布  2已发布）";
	...
	public void cloneCopy(BaseAnnoucement __bean){
	...
	@Override
	public int compareTo(BaseAnnoucement o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseAnnoucement o = (BaseAnnoucement)obj;
