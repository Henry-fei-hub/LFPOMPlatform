...
public class BaseProfessionalApproval extends GenericBase implements BaseFactory<BaseProfessionalApproval>, Comparable<BaseProfessionalApproval> 
{


	public static BaseProfessionalApproval newInstance(){
		return new BaseProfessionalApproval();
	}

	@Override
	public BaseProfessionalApproval make(){
	...
	public final static String ALL_CAPTIONS = "专业负责人审批编码,申请人,工号,开始日期,删除状态 0未删除  1已删除,项目编码,项目编号,项目名称,合同编码,合同编号,合同名称,业务部门,业务类别,项目类别,事业部负责人,项目等级,部门经理,积分管理员,专业负责人名称,专业负责人部门,公区面积,后勤面积,设计面积,项目总积分,项目积分,预留积分,核算比例,状态   0 操作记录 ，1 流程记录";
	...
	public void cloneCopy(BaseProfessionalApproval __bean){
	...
	@Override
	public int compareTo(BaseProfessionalApproval o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseProfessionalApproval o = (BaseProfessionalApproval)obj;
