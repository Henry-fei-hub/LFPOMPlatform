...
public class BaseK3Code extends GenericBase implements BaseFactory<BaseK3Code>, Comparable<BaseK3Code> 
{


	public static BaseK3Code newInstance(){
		return new BaseK3Code();
	}

	@Override
	public BaseK3Code make(){
	...
	public final static java.lang.String CS_ADDITIONAL_BUSINESS_ID = "additional_business_id" ;
	public final static java.lang.String CS_UPDATE_TIME = "update_time" ;

	public final static java.lang.String ALL_CAPTIONS = "主键编码, 12工资,原有业务表的编码,K3编号,K3名称,部门类型,附加的业务编码,修改时间";
	...
	public java.lang.Integer getAdditionalBusinessId() {
		return this.__additional_business_id;
	}

	public void setAdditionalBusinessId( java.lang.Integer value ) {
		this.__additional_business_id = value;
	}
	...
	public void cloneCopy(BaseK3Code __bean){
		...
		__bean.setAdditionalBusinessId(getAdditionalBusinessId());
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		sb.append(getAdditionalBusinessId() == null ? "" : getAdditionalBusinessId());
		sb.append(",");
	...
	@Override
	public int compareTo(BaseK3Code o) {
	...
	public int hashCode() {
		...
		hash = 97 * hash + Objects.hashCode(this.__additional_business_id);
	...
	public boolean equals(Object obj) {
		...
		final BaseK3Code o = (BaseK3Code)obj;
		...
		if(!Objects.equals(this.__additional_business_id, o.getAdditionalBusinessId())) return false;
	...
	public java.lang.String toJSONString() {
		...
		if(getAdditionalBusinessId() != null) sb.append(__wrapNumber(count++, "additionalBusinessId", getAdditionalBusinessId()));
	...
	public void setDataFromMap(Map<String, Object> values){
		...
		if((val = values.get("additionalBusinessId")) != null) setAdditionalBusinessId(__getInt(val)); 
	...
	protected java.lang.Integer  __additional_business_id ;
