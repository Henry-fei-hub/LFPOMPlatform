...
public class BaseProduct extends GenericBase implements BaseFactory<BaseProduct>, Comparable<BaseProduct> 
{
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,产品类别id,产品名称,产品类型,产品型号,产品单位,产品规格,产品外观尺寸,是否可用,创建人,创建时间,删除标志 0未删除  1已删除,备注";
	...
	public void cloneCopy(BaseProduct __bean){
	...
	public boolean equals(Object obj) {
		...
		final BaseProduct o = (BaseProduct)obj;
	...
	public Map<String, Object> toMap() {
		...
		if(getProductType() != null) res.put("productType", getProductType());
		...
		if(getProductSkinsSize() != null) res.put("productSkinsSize", getProductSkinsSize());
