...
public class BaseProjectUnitPrice extends GenericBase implements BaseFactory<BaseProjectUnitPrice>, Comparable<BaseProjectUnitPrice> 
{


	public static BaseProjectUnitPrice newInstance(){
		return new BaseProjectUnitPrice();
	}

	@Override
	public BaseProjectUnitPrice make(){
	...
	public void cloneCopy(BaseProjectUnitPrice __bean){
	...
	@Override
	public int compareTo(BaseProjectUnitPrice o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseProjectUnitPrice o = (BaseProjectUnitPrice)obj;
