...
public class BaseK3Voucher extends GenericBase implements BaseFactory<BaseK3Voucher>, Comparable<BaseK3Voucher> 
{


	public static BaseK3Voucher newInstance(){
		return new BaseK3Voucher();
	}

	@Override
	public BaseK3Voucher make(){
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,项目,归属公司,凭证号,凭证内序号,科目类型,科目编码,科目代码,科目名称,辅助核算类型,辅助核算编码,辅助核算代码,辅助核算名称,备注,简化备注,借方,贷方,报销汇总编号,报销金额,进项税,我方银行账号,对方银行账号,需要调整,归属日期,是否锁定,创建时间,修改时间,定稿时间,凭证类型(system_dictionary_117) 1报销  2发票  3回款  4收入 5确认函 6五险一金 7工资,关联编码,附加的关联编码,进项税转出金额,凭证年份,凭证月份,流程类型,流程编码,流程实例编码,流程实例业务编码,报销汇总单主表编码";
	...
	public void cloneCopy(BaseK3Voucher __bean){
	...
	@Override
	public int compareTo(BaseK3Voucher o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseK3Voucher o = (BaseK3Voucher)obj;
