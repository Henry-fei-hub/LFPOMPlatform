...
public class BaseContractStageModel extends GenericBase implements BaseFactory<BaseContractStageModel>, Comparable<BaseContractStageModel> 
{


	public static BaseContractStageModel newInstance(){
		return new BaseContractStageModel();
	}

	@Override
	public BaseContractStageModel make(){
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,合同,阶段小节点模板,名称,阶段百分比,父级,是否为叶子结点,排序序号,需要项目经理审批,需要设计总监审批,累积百分比,备注,项目经理意见,项目经理,项目经理审批日期,设计总监意见,设计总监,设计总监审批日期,是否锁定,流程状态，默认新建，0新建，1运行中，3结束,确认日期,是否取得证据,证据,年份";
	...
	public void cloneCopy(BaseContractStageModel __bean){
	...
	@Override
	public int compareTo(BaseContractStageModel o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseContractStageModel o = (BaseContractStageModel)obj;
