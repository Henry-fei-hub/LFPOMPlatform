...
public class BaseProjectIntegralAssignRecord extends GenericBase implements BaseFactory<BaseProjectIntegralAssignRecord>, Comparable<BaseProjectIntegralAssignRecord> 
{


	public static BaseProjectIntegralAssignRecord newInstance(){
		return new BaseProjectIntegralAssignRecord();
	}

	@Override
	public BaseProjectIntegralAssignRecord make(){
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,项目,人员,发放前预留积分,发放后预留积分,发放积分,发放日期,板块,板块负责人,备注";
	...
	public void cloneCopy(BaseProjectIntegralAssignRecord __bean){
	...
	@Override
	public int compareTo(BaseProjectIntegralAssignRecord o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseProjectIntegralAssignRecord o = (BaseProjectIntegralAssignRecord)obj;
