...
public class BaseCwdTaskTemplate extends GenericBase implements BaseFactory<BaseCwdTaskTemplate>, Comparable<BaseCwdTaskTemplate> 
{


	public static BaseCwdTaskTemplate newInstance(){
		return new BaseCwdTaskTemplate();
	}

	@Override
	public BaseCwdTaskTemplate make(){
	...
	public final static java.lang.String ALL_CAPTIONS = "主键,模板名称,项目面积,操作人,创建时间,部门,归属公司编码,公司编号,天数(周期),项目类型(5A写字楼等等),参与人数,大项目编码(记录该模板根据哪个项目进行创建)";
	...
	public void cloneCopy(BaseCwdTaskTemplate __bean){
	...
	@Override
	public int compareTo(BaseCwdTaskTemplate o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseCwdTaskTemplate o = (BaseCwdTaskTemplate)obj;
