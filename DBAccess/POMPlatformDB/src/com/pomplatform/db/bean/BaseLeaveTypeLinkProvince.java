...
public class BaseLeaveTypeLinkProvince extends GenericBase implements BaseFactory<BaseLeaveTypeLinkProvince>, Comparable<BaseLeaveTypeLinkProvince> 
{


	public static BaseLeaveTypeLinkProvince newInstance(){
		return new BaseLeaveTypeLinkProvince();
	}

	@Override
	public BaseLeaveTypeLinkProvince make(){
	...
	public final static java.lang.String ALL_CAPTIONS = "请假类型省份关联表,请假类型编码,适用省份,天数,,是否启用";
	...
	public void cloneCopy(BaseLeaveTypeLinkProvince __bean){
	...
	@Override
	public int compareTo(BaseLeaveTypeLinkProvince o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseLeaveTypeLinkProvince o = (BaseLeaveTypeLinkProvince)obj;
