...
public class BaseProjectPerformanceSettlementDetail extends GenericBase implements BaseFactory<BaseProjectPerformanceSettlementDetail>, Comparable<BaseProjectPerformanceSettlementDetail> 
{


	public static BaseProjectPerformanceSettlementDetail newInstance(){
		return new BaseProjectPerformanceSettlementDetail();
	}

	@Override
	public BaseProjectPerformanceSettlementDetail make(){
		BaseProjectPerformanceSettlementDetail b = new BaseProjectPerformanceSettlementDetail();
		return b;
	}

	public final static java.lang.String CS_PROJECT_PERFORMANCE_SETTLEMENT_DETAIL_ID = "project_performance_settlement_detail_id" ;
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,总表id,项目id,项目成员,日期,绩效积分,2奖励,操作人,操作时间,备注";

	public java.lang.Integer getProjectPerformanceSettlementDetailId() {
		return this.__project_performance_settlement_detail_id;
	}

	public void setProjectPerformanceSettlementDetailId( java.lang.Integer value ) {
		this.__project_performance_settlement_detail_id = value;
	}
	...
	public void cloneCopy(BaseProjectPerformanceSettlementDetail __bean){
		__bean.setProjectPerformanceSettlementDetailId(getProjectPerformanceSettlementDetailId());
	...
	public java.lang.String toCSVString() {
		...
		sb.append(getProjectPerformanceSettlementDetailId() == null ? "" : getProjectPerformanceSettlementDetailId());
		sb.append(",");
	...
	@Override
	public int compareTo(BaseProjectPerformanceSettlementDetail o) {
		return __project_performance_settlement_detail_id == null ? -1 : __project_performance_settlement_detail_id.compareTo(o.getProjectPerformanceSettlementDetailId());
	}

	@Override
	public int hashCode() {
		int hash = 7;
		hash = 97 * hash + Objects.hashCode(this.__project_performance_settlement_detail_id);
	...
	public boolean equals(Object obj) {
		...
		final BaseProjectPerformanceSettlementDetail o = (BaseProjectPerformanceSettlementDetail)obj;
		if(!Objects.equals(this.__project_performance_settlement_detail_id, o.getProjectPerformanceSettlementDetailId())) return false;
	...
	public java.lang.String toJSONString() {
		...
		StringBuilder sb = new StringBuilder();
		int count = 0;
		if(getProjectPerformanceSettlementDetailId() != null) sb.append(__wrapNumber(count++, "projectPerformanceSettlementDetailId", getProjectPerformanceSettlementDetailId()));
	...
	public void setDataFromMap(Map<String, Object> values){
		Object val;
		if((val = values.get("projectPerformanceSettlementDetailId")) != null) setProjectPerformanceSettlementDetailId(__getInt(val)); 
	...
	protected java.lang.Integer  __project_performance_settlement_detail_id ;
