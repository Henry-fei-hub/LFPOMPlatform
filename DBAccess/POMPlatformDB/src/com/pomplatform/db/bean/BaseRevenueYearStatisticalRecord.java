...
public class BaseRevenueYearStatisticalRecord extends GenericBase implements BaseFactory<BaseRevenueYearStatisticalRecord>, Comparable<BaseRevenueYearStatisticalRecord> 
{


	public static BaseRevenueYearStatisticalRecord newInstance(){
		return new BaseRevenueYearStatisticalRecord();
	}

	@Override
	public BaseRevenueYearStatisticalRecord make(){
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,项目编码,年份,1月,2月,3月,4月,5月,6月,7月,8月,9月,10月,11月,12月,操作人,操作时间,备注,是否加锁";
	...
	public void cloneCopy(BaseRevenueYearStatisticalRecord __bean){
	...
	@Override
	public int compareTo(BaseRevenueYearStatisticalRecord o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseRevenueYearStatisticalRecord o = (BaseRevenueYearStatisticalRecord)obj;
