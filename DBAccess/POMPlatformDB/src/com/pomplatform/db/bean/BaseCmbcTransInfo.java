...
public class BaseCmbcTransInfo extends GenericBase implements BaseFactory<BaseCmbcTransInfo>, Comparable<BaseCmbcTransInfo> 
{


	public static BaseCmbcTransInfo newInstance(){
		return new BaseCmbcTransInfo();
	}

	@Override
	public BaseCmbcTransInfo make(){
	...
	public void cloneCopy(BaseCmbcTransInfo __bean){
	...
	@Override
	public int compareTo(BaseCmbcTransInfo o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseCmbcTransInfo o = (BaseCmbcTransInfo)obj;
