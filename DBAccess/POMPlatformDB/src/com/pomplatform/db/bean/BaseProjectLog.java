...
public class BaseProjectLog extends GenericBase implements BaseFactory<BaseProjectLog>, Comparable<BaseProjectLog> 
{


	public static BaseProjectLog newInstance(){
		return new BaseProjectLog();
	}

	@Override
	public BaseProjectLog make(){
	...
	public void cloneCopy(BaseProjectLog __bean){
	...
	@Override
	public int compareTo(BaseProjectLog o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseProjectLog o = (BaseProjectLog)obj;
