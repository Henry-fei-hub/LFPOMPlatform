...
public class BaseAccountRecord extends GenericBase implements BaseFactory<BaseAccountRecord>, Comparable<BaseAccountRecord> 
{


	public static BaseAccountRecord newInstance(){
		return new BaseAccountRecord();
	}

	@Override
	public BaseAccountRecord make(){
		BaseAccountRecord b = new BaseAccountRecord();
		return b;
	}

	public final static java.lang.String CS_ACCOUNT_RECORD_ID = "account_record_id" ;
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,账户编码(即对象编码),业务功能编码,业务功能类型,),收入积分,支出积分,记录日期,记录时间,操作人,操作时间,备注";

	public java.lang.Integer getAccountRecordId() {
		return this.__account_record_id;
	}

	public void setAccountRecordId( java.lang.Integer value ) {
		this.__account_record_id = value;
	}
	...
	public void cloneCopy(BaseAccountRecord __bean){
		__bean.setAccountRecordId(getAccountRecordId());
	...
	public java.lang.String toCSVString() {
		...
		sb.append(getAccountRecordId() == null ? "" : getAccountRecordId());
		sb.append(",");
	...
	@Override
	public int compareTo(BaseAccountRecord o) {
		return __account_record_id == null ? -1 : __account_record_id.compareTo(o.getAccountRecordId());
	}

	@Override
	public int hashCode() {
		int hash = 7;
		hash = 97 * hash + Objects.hashCode(this.__account_record_id);
	...
	public boolean equals(Object obj) {
		...
		final BaseAccountRecord o = (BaseAccountRecord)obj;
		if(!Objects.equals(this.__account_record_id, o.getAccountRecordId())) return false;
	...
	public java.lang.String toJSONString() {
		...
		StringBuilder sb = new StringBuilder();
		int count = 0;
		if(getAccountRecordId() != null) sb.append(__wrapNumber(count++, "accountRecordId", getAccountRecordId()));
	...
	public void setDataFromMap(Map<String, Object> values){
		Object val;
		if((val = values.get("accountRecordId")) != null) setAccountRecordId(__getInt(val)); 
	...
	protected java.lang.Integer  __account_record_id ;
