...
public class BaseClockRecevieCmd extends GenericBase implements BaseFactory<BaseClockRecevieCmd>, Comparable<BaseClockRecevieCmd> 
{


	public static BaseClockRecevieCmd newInstance(){
		return new BaseClockRecevieCmd();
	}

	@Override
	public BaseClockRecevieCmd make(){
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,序列号,命令内容,提交时间,传送时间,返回值,返回条数,返回成功标志,返回数据,命令内容,系统,返回时间,数据库更新标记,操作人,修改人,修改时间,创建人,创建时间,删除人,删除时间,状态";
	...
	public void cloneCopy(BaseClockRecevieCmd __bean){
	...
	@Override
	public int compareTo(BaseClockRecevieCmd o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseClockRecevieCmd o = (BaseClockRecevieCmd)obj;
