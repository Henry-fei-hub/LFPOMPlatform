...
public class BaseNewAccount extends GenericBase implements BaseFactory<BaseNewAccount>, Comparable<BaseNewAccount> 
{


	public static BaseNewAccount newInstance(){
		return new BaseNewAccount();
	}

	@Override
	public BaseNewAccount make(){
	...
	public final static java.lang.String ALL_CAPTIONS = "账户表主键,账户类型(1个人 ,2项目组，3部门，4公司，5供应商),账户编号（唯一）,账户名称,拥有者编码,状态（1活动，2冻结，3关户）,余额,冻结余额,,开户人活着操作人,订单编码";
	...
	public void cloneCopy(BaseNewAccount __bean){
	...
	@Override
	public int compareTo(BaseNewAccount o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseNewAccount o = (BaseNewAccount)obj;
	...
	public java.lang.String toJSONString() {
		...
		if(getFreezingBalance() != null) sb.append(__wrapDecimal(count++, "freezingBalance", getFreezingBalance()));
	...
	protected java.math.BigDecimal  __freezing_balance ;
