...
public class BaseSystemProcessInstanceActivity extends GenericBase implements BaseFactory<BaseSystemProcessInstanceActivity>, Comparable<BaseSystemProcessInstanceActivity> 
{


	public static BaseSystemProcessInstanceActivity newInstance(){
		return new BaseSystemProcessInstanceActivity();
	}

	@Override
	public BaseSystemProcessInstanceActivity make(){
	...
	public final static java.lang.String CS_TIME_OUT_MESSAGE_STATUS = "time_out_message_status" ;

	public final static java.lang.String ALL_CAPTIONS = "主键编码,流程类型,业务编码,业务名称,活动编码,流程编码,流程实列编码,返回数据集,节点类型 0 - 开始 1 - 结束 2 - 审批 3 - 处理 4 - 知会,附加节点，说明节点是预定义的节点还是动态加的节点， 0 - 正常定义的节点， 1 - 申请人或者审批人加的处理人或者审批人,当前流程实例节点的内部编码,下一个流程节点的编码,如果是知会节点，所依附的主节点,流程实例节点创建时间,流程实例节点开始处于活动时间,处理人,操作时间,提交意见,状态,删除状态  0未删除    1已删除,消息状态 0  未发送 1  已发送,超时消息推送状态 0  未发送    1  提前15分钟已发送   2  延迟24小时已发送";
	...
	public java.lang.Integer getTimeOutMessageStatus() {
		return this.__time_out_message_status;
	}

	public void setTimeOutMessageStatus( java.lang.Integer value ) {
		this.__time_out_message_status = value;
	}

	public void cloneCopy(BaseSystemProcessInstanceActivity __bean){
		...
		__bean.setTimeOutMessageStatus(getTimeOutMessageStatus());
	}
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		sb.append(getMessageStatus() == null ? "" : getMessageStatus());
		sb.append(",");
		sb.append(getTimeOutMessageStatus() == null ? "" : getTimeOutMessageStatus());
		return sb.toString();
	}

	@Override
	public int compareTo(BaseSystemProcessInstanceActivity o) {
	...
	public int hashCode() {
		...
		hash = 97 * hash + Objects.hashCode(this.__time_out_message_status);
		return hash;
	}
	...
	public boolean equals(Object obj) {
		...
		final BaseSystemProcessInstanceActivity o = (BaseSystemProcessInstanceActivity)obj;
		...
		if(!Objects.equals(this.__time_out_message_status, o.getTimeOutMessageStatus())) return false;
		return true;
	}
	...
	public java.lang.String toJSONString() {
		...
		if(getTimeOutMessageStatus() != null) sb.append(__wrapNumber(count++, "timeOutMessageStatus", getTimeOutMessageStatus()));
		return sb.toString();
	}
	...
	public void setDataFromMap(Map<String, Object> values){
		...
		if((val = values.get("timeOutMessageStatus")) != null) setTimeOutMessageStatus(__getInt(val)); 
	}
	...
	protected java.lang.Integer  __time_out_message_status ;
}
