...
public class BaseProjectAppendIntegralRecord extends GenericBase implements BaseFactory<BaseProjectAppendIntegralRecord>, Comparable<BaseProjectAppendIntegralRecord> 
{


	public static BaseProjectAppendIntegralRecord newInstance(){
		return new BaseProjectAppendIntegralRecord();
	}

	@Override
	public BaseProjectAppendIntegralRecord make(){
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,项目编码,追加积分,核算比例,核算比例,备注";
	...
	public void cloneCopy(BaseProjectAppendIntegralRecord __bean){
	...
	@Override
	public int compareTo(BaseProjectAppendIntegralRecord o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseProjectAppendIntegralRecord o = (BaseProjectAppendIntegralRecord)obj;
