...
public class BaseSalaryAnnualBonus extends GenericBase implements BaseFactory<BaseSalaryAnnualBonus>, Comparable<BaseSalaryAnnualBonus> 
{
	...
	public final static java.lang.String CS_SALARY_ANNUAL_BONUS_ID = "salary_annual_bonus_id" ;
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,银行卡号,员工工号,员工id,员工姓名,年份,所属公司,业务部门,所属部门,全薪,年度工作日,实际出勤工作日,年度服务系数,年度考核等级,考核系数,应发13薪奖金,应发年度绩效工资,应发项目奖金,调户押金/返还,应发合计,应纳个税,实发奖金,是否发放,操作人,操作时间,备注,调户押金扣除,流程业务表Id,),补/扣工资差额,报销扣款,其它扣款,已发奖金,应纳税所得,发放时间,完成时间,1-3季度剩余奖金,住房补贴,年度绩效扣款,代扣款项";

	public java.lang.Integer getSalaryAnnualBonusId() {
		return this.__salary_annual_bonus_id;
	}

	public void setSalaryAnnualBonusId( java.lang.Integer value ) {
		this.__salary_annual_bonus_id = value;
	}
	...
	public void cloneCopy(BaseSalaryAnnualBonus __bean){
		__bean.setSalaryAnnualBonusId(getSalaryAnnualBonusId());
	...
	public java.lang.String toCSVString() {
		...
		sb.append(getSalaryAnnualBonusId() == null ? "" : getSalaryAnnualBonusId());
		sb.append(",");
	...
	public int compareTo(BaseSalaryAnnualBonus o) {
		return __salary_annual_bonus_id == null ? -1 : __salary_annual_bonus_id.compareTo(o.getSalaryAnnualBonusId());
	}

	@Override
	public int hashCode() {
		int hash = 7;
		hash = 97 * hash + Objects.hashCode(this.__salary_annual_bonus_id);
	...
	public boolean equals(Object obj) {
		...
		if(!Objects.equals(this.__salary_annual_bonus_id, o.getSalaryAnnualBonusId())) return false;
	...
	public java.lang.String toJSONString() {
		...
		StringBuilder sb = new StringBuilder();
		int count = 0;
		if(getSalaryAnnualBonusId() != null) sb.append(__wrapNumber(count++, "salaryAnnualBonusId", getSalaryAnnualBonusId()));
	...
	public Map<String, Object> toMap() {
		...
		if(getSalaryAnnualBonusId() != null) res.put("salaryAnnualBonusId", getSalaryAnnualBonusId());
		...
		if(getTotalPay() != null) res.put("totalPay", getTotalPay());
		if(getYearShouldWorkDay() != null) res.put("yearShouldWorkDay", getYearShouldWorkDay());
		if(getYearFactWorkDay() != null) res.put("yearFactWorkDay", getYearFactWorkDay());
		if(getYearServiceNum() != null) res.put("yearServiceNum", getYearServiceNum());
		if(getYearTestLevel() != null) res.put("yearTestLevel", getYearTestLevel());
		if(getTestNum() != null) res.put("testNum", getTestNum());
		if(getThirteenBonus() != null) res.put("thirteenBonus", getThirteenBonus());
		if(getYearPerformanceBonus() != null) res.put("yearPerformanceBonus", getYearPerformanceBonus());
		if(getProgramBonus() != null) res.put("programBonus", getProgramBonus());
		if(getTransferAccountMoney() != null) res.put("transferAccountMoney", getTransferAccountMoney());
		...
		if(getDepositDeduct() != null) res.put("depositDeduct", getDepositDeduct());
		...
		if(getSalaryDiffDeduct() != null) res.put("salaryDiffDeduct", getSalaryDiffDeduct());
		if(getReimbursementDeduct() != null) res.put("reimbursementDeduct", getReimbursementDeduct());
		if(getOtherDeduct() != null) res.put("otherDeduct", getOtherDeduct());
		...
		if(getSendTime() != null) res.put("sendTime", getSendTime());
		if(getFinishTime() != null) res.put("finishTime", getFinishTime());
		if(getOneToThreeRest() != null) res.put("oneToThreeRest", getOneToThreeRest());
		if(getHousingSubsidy() != null) res.put("housingSubsidy", getHousingSubsidy());
		if(getDeductPerformanceBonus() != null) res.put("deductPerformanceBonus", getDeductPerformanceBonus());
	...
	public void setDataFromMap(Map<String, Object> values){
		Object val;
		if((val = values.get("salaryAnnualBonusId")) != null) setSalaryAnnualBonusId(__getInt(val)); 
	...
	protected java.lang.Integer  __salary_annual_bonus_id ;
