...
public class BaseStorage extends GenericBase implements BaseFactory<BaseStorage>, Comparable<BaseStorage> 
{


	public static BaseStorage newInstance(){
		return new BaseStorage();
	}

	@Override
	public BaseStorage make(){
	...
	public void cloneCopy(BaseStorage __bean){
	...
	@Override
	public int compareTo(BaseStorage o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseStorage o = (BaseStorage)obj;
	...
	public Map<String, Object> toMap() {
		...
		if(getStorageCode() != null) res.put("storageCode", getStorageCode());
		if(getStorageName() != null) res.put("storageName", getStorageName());
		if(getStorageType() != null) res.put("storageType", getStorageType());
		...
		if(getContactEmployeeId() != null) res.put("contactEmployeeId", getContactEmployeeId());
