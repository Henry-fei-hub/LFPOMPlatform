...
public class BaseNewAccountTransation extends GenericBase implements BaseFactory<BaseNewAccountTransation>, Comparable<BaseNewAccountTransation> 
{


	public static BaseNewAccountTransation newInstance(){
		return new BaseNewAccountTransation();
	}

	@Override
	public BaseNewAccountTransation make(){
	...
	public final static java.lang.String ALL_CAPTIONS = "主键,关联账户编码,原币借,原币借,汇率,本位币,本位贷,事项类别,大项目编号,合同,部门编码,业务部门,员工编码,记录时间,归属时间,备注,关联的账号,交易流水号";
	...
	public void cloneCopy(BaseNewAccountTransation __bean){
	...
	@Override
	public int compareTo(BaseNewAccountTransation o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseNewAccountTransation o = (BaseNewAccountTransation)obj;
