...
public class BaseActivity extends GenericBase implements BaseFactory<BaseActivity>, Comparable<BaseActivity> 
{
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,项目编码,客户Id,客户名称,项目名称,2我司出差拜访),会议时间,会议地址,会议主题,会议目标,联系人,甲方要求,甲方出席人员,我方出席人员,操作人,操作时间,备注,我方设计出席人员,会议地址（省）,会议地址（市）,外出开始时间,外出结束时间";
	...
	public void cloneCopy(BaseActivity __bean){
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		sb.append(getMeetAddress() == null ? "" : getMeetAddress());
		sb.append(",");
		...
		sb.append(",");
		sb.append(getOutTimeStart() == null ? "" : sdf.format(getOutTimeStart()));
		sb.append(",");
		sb.append(getOutTimeEnd() == null ? "" : sdf.format(getOutTimeEnd()));
		return sb.toString();
	}
	...
	public boolean equals(Object obj) {
		...
		final BaseActivity o = (BaseActivity)obj;
	...
	public Map<String, Object> toMap() {
		...
		if(getActivitieId() != null) res.put("activitieId", getActivitieId());
		...
		if(getMeetType() != null) res.put("meetType", getMeetType());
		if(getMeetTime() != null) res.put("meetTime", getMeetTime());
		if(getMeetAddress() != null) res.put("meetAddress", getMeetAddress());
		if(getMeetTitle() != null) res.put("meetTitle", getMeetTitle());
		if(getMeetTarget() != null) res.put("meetTarget", getMeetTarget());
		if(getContactName() != null) res.put("contactName", getContactName());
		if(getTheirRequire() != null) res.put("theirRequire", getTheirRequire());
		if(getTheirEmployees() != null) res.put("theirEmployees", getTheirEmployees());
		if(getOurEmployees() != null) res.put("ourEmployees", getOurEmployees());
		...
		if(getOurDesignerEmployees() != null) res.put("ourDesignerEmployees", getOurDesignerEmployees());
		if(getProvince() != null) res.put("province", getProvince());
		if(getCity() != null) res.put("city", getCity());
		if(getOutTimeStart() != null) res.put("outTimeStart", getOutTimeStart());
		if(getOutTimeEnd() != null) res.put("outTimeEnd", getOutTimeEnd());
		return res;
	}
