...
public class BaseThreadTaskManage extends GenericBase implements BaseFactory<BaseThreadTaskManage>, Comparable<BaseThreadTaskManage> 
{


	public static BaseThreadTaskManage newInstance(){
		return new BaseThreadTaskManage();
	}

	@Override
	public BaseThreadTaskManage make(){
	...
	public final static java.lang.String ALL_CAPTIONS = ",任务类型 1月考勤统计,任务状态 0新建 1运行中 2完成 3失败(发生异常),错误信息,操作人,操作类型  1手动操作 2程序创建,开始时间,结束时间,创建时间,备注";
	...
	public void cloneCopy(BaseThreadTaskManage __bean){
	...
	@Override
	public int compareTo(BaseThreadTaskManage o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseThreadTaskManage o = (BaseThreadTaskManage)obj;
