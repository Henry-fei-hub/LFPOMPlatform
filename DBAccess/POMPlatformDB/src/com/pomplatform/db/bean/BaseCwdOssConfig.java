...
public class BaseCwdOssConfig extends GenericBase implements BaseFactory<BaseCwdOssConfig>, Comparable<BaseCwdOssConfig> 
{


	public static BaseCwdOssConfig newInstance(){
		return new BaseCwdOssConfig();
	}

	@Override
	public BaseCwdOssConfig make(){
	...
	public void cloneCopy(BaseCwdOssConfig __bean){
	...
	@Override
	public int compareTo(BaseCwdOssConfig o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseCwdOssConfig o = (BaseCwdOssConfig)obj;
