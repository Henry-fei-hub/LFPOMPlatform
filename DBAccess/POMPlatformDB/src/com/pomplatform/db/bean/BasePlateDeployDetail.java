...
public class BasePlateDeployDetail extends GenericBase implements BaseFactory<BasePlateDeployDetail>, Comparable<BasePlateDeployDetail> 
{


	public static BasePlateDeployDetail newInstance(){
		return new BasePlateDeployDetail();
	}

	@Override
	public BasePlateDeployDetail make(){
		BasePlateDeployDetail b = new BasePlateDeployDetail();
		return b;
	}

	public final static java.lang.String CS_PLATE_DEPLOY_DETAIL_ID = "plate_deploy_detail_id" ;
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,总表id,调配成员,调配积分,调配日期,操作时间,操作人,备注";

	public java.lang.Integer getPlateDeployDetailId() {
		return this.__plate_deploy_detail_id;
	}

	public void setPlateDeployDetailId( java.lang.Integer value ) {
	...
	public void cloneCopy(BasePlateDeployDetail __bean){
	...
	@Override
	public int compareTo(BasePlateDeployDetail o) {
	...
	public boolean equals(Object obj) {
		...
		final BasePlateDeployDetail o = (BasePlateDeployDetail)obj;
	...
	protected java.lang.Integer  __plate_deploy_detail_id ;
