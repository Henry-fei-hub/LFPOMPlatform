...
public class BaseContractMessageDetail extends GenericBase implements BaseFactory<BaseContractMessageDetail>, Comparable<BaseContractMessageDetail> 
{


	public static BaseContractMessageDetail newInstance(){
		return new BaseContractMessageDetail();
	}

	@Override
	public BaseContractMessageDetail make(){
	...
	public final static java.lang.String ALL_CAPTIONS = "id,父id,合同id,操作人id,创建时间,消息推送人员";
	...
	public void cloneCopy(BaseContractMessageDetail __bean){
	...
	@Override
	public int compareTo(BaseContractMessageDetail o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseContractMessageDetail o = (BaseContractMessageDetail)obj;
