...
public class BaseEmployee extends GenericBase implements BaseFactory<BaseEmployee>, Comparable<BaseEmployee> 
{
	...
	public final static String CS_ALTERNATE_FIELD1 = "alternate_field1" ;
	public final static String CS_ALTERNATE_FIELD2 = "alternate_field2" ;
	public final static String CS_ALTERNATE_FIELD3 = "alternate_field3" ;
	...
	public final static String CS_OA_ID = "oa_id" ;
	public final static String CS_OA_DEPART = "oa_depart" ;
	public final static String CS_IS_HEADCOUNT = "is_headcount" ;
	public final static String CS_IS_CHECK = "is_check" ;
	public final static String CS_DIRECT_LEADER = "direct_leader" ;
	public final static String CS_IS_MANAGER = "is_manager" ;
	...
	public final static String CS_LANGUAGES = "languages" ;
	...
	public final static String CS_TRY_TIME = "try_time" ;
	...
	public final static String CS_JOBS = "jobs" ;
	public final static String CS_PERSONAL_BUSINESS_REMARK = "personal_business_remark" ;
	public final static String CS_SELF_INTRODUCTION = "self_introduction" ;
	...
	public final static String CS_HOME_PHONE = "home_phone" ;
	public final static String CS_NOW_ADDRESS = "now_address" ;
	public final static String CS_TRY_TIME_PAY = "try_time_pay" ;
	public final static String CS_POSITIVE_PAY = "positive_pay" ;
	public final static String CS_APPLY_EMPLOYEE_ID = "apply_employee_id" ;
	...
	public final static String CS_FOREMAN = "foreman" ;
	...
	public final static String CS_EMPLOYEE_SHIFT = "employee_shift" ;
	public final static String CS_CARD_ADDRESS = "card_address" ;
	public final static String CS_ANNUAL_PERFORMANCE = "annual_performance" ;
	public final static String CS_ANNUAL_BONUS = "annual_bonus" ;
	...
	public final static String CS_ECMC_USER_ID = "ecmc_user_id" ;
	public final static String CS_ONBOARD_STATUS = "onboard_status" ;
	public final static String CS_ATTACHMENT_REMARK = "attachment_remark" ;
	public final static String CS_WORK_YEAR_TYPE = "work_year_type" ;
	public final static String CS_ISBUSY = "isbusy" ;
	public final static String CS_FOREIGNER_ID_CARD = "foreigner_id_card" ;
	public final static String CS_REAL_BIRTHDATE = "real_birthdate" ;
	public final static String CS_WORK_YEAR = "work_year" ;
	public final static String CS_SHENZHEN_HOUSE = "shenzhen_house" ;
	public final static String CS_TRANS_HOUSEHOLD_DATE = "trans_household_date" ;
	public final static String CS_PROFESSIONAL_DIRECTION = "professional_direction" ;
	public final static String CS_RECRUITMENT_SOURCES = "recruitment_sources" ;
	public final static String CS_WECHAT_NUM = "wechat_num" ;
	public final static String CS_AUTO_SIGN_YEAR = "auto_sign_year" ;
	public final static String CS_RESUME_ATTACHMENT = "resume_attachment" ;
	public final static String CS_SIGNATURE_ATTACHMENT = "signature_attachment" ;
	public final static String CS_SOCIAL_ATTACHMENT = "social_attachment" ;
	public final static String CS_FUND_ATTACHMENT = "fund_attachment" ;
	public final static String CS_SPARE_ATTACHMENT1 = "spare_attachment1" ;
	public final static String CS_SPARE_ATTACHMENT2 = "spare_attachment2" ;
	public final static String CS_SPARE_ATTACHMENT3 = "spare_attachment3" ;
	public final static String CS_EMPLOYEE_TYPE = "employee_type" ;
	public final static String CS_IS_LONG_SICK_LEAVE = "is_long_sick_leave" ;
	public final static String CS_BASIC_SALARY = "basic_salary" ;
	public final static String CS_JOB_TITLE_ALLOWANCE = "job_title_allowance" ;
	public final static String CS_POST_ALLOWANCE = "post_allowance" ;
	public final static String CS_OTHER = "other" ;
	public final static String CS_COMMUNICATION_SUBSIDY = "communication_subsidy" ;
	public final static String CS_SUBTOTAL_MONTHLY_WAGE = "subtotal_monthly_wage" ;
	public final static String CS_MONTHLY_PREISSUED_BONUS = "monthly_preissued_bonus" ;
	public final static String CS_TOTAL_MONTHLY_REMUNERATION = "total_monthly_remuneration" ;
	public final static String CS_PHOTO_ID = "photo_id" ;
	public final static String CS_LABOR_ATTACHMENT_ID = "labor_attachment_id" ;
	public final static String CS_CARD_ATTACHMENT_ID = "card_attachment_id" ;
	public final static String CS_TECHNICAL_ATTACHMENT_ID = "technical_attachment_id" ;
	...
	public void setPoliticalFace( Integer value ) {
	...
	public String getTryTimePay() {
		return this.__try_time_pay;
	}

	public void setTryTimePay( String value ) {
	...
	public void setPositivePay( String value ) {
	...
	public void setHouseholdRegistration( Integer value ) {
	...
	public Integer getEmployeeShift() {
		return this.__employee_shift;
	}

	public void setEmployeeShift( Integer value ) {
	...
	public void setAnnualPerformance( String value ) {
	...
	public Integer getEcmcUserId() {
		return this.__ecmc_user_id;
	}

	public void setEcmcUserId( Integer value ) {
	...
	public void setOnboardStatus( Integer value ) {
	...
	public void setAttachmentRemark( String value ) {
	...
	public void setWorkYearType( Integer value ) {
	...
	public void setIsbusy( Integer value ) {
		this.__isbusy = value;
	}

	public String getForeignerIdCard() {
		return this.__foreigner_id_card;
	}

	public void setForeignerIdCard( String value ) {
	...
	public Integer getShenzhenHouse() {
		return this.__shenzhen_house;
	}

	public void setShenzhenHouse( Integer value ) {
	...
	public Integer getProfessionalDirection() {
		return this.__professional_direction;
	}

	public void setProfessionalDirection( Integer value ) {
		this.__professional_direction = value;
	}

	public Integer getRecruitmentSources() {
		return this.__recruitment_sources;
	}

	public void setRecruitmentSources( Integer value ) {
	...
	public Integer getAutoSignYear() {
		return this.__auto_sign_year;
	}

	public void setAutoSignYear( Integer value ) {
	...
	public void setResumeAttachment( String value ) {
	...
	public void setSignatureAttachment( String value ) {
		this.__signature_attachment = value;
	}

	public String getSocialAttachment() {
		return this.__social_attachment;
	}

	public void setSocialAttachment( String value ) {
	...
	public void setFundAttachment( String value ) {
		this.__fund_attachment = value;
	}

	public String getSpareAttachment1() {
		return this.__spare_attachment1;
	}

	public void setSpareAttachment1( String value ) {
		this.__spare_attachment1 = value;
	}

	public String getSpareAttachment2() {
		return this.__spare_attachment2;
	}

	public void setSpareAttachment2( String value ) {
		this.__spare_attachment2 = value;
	}

	public String getSpareAttachment3() {
		return this.__spare_attachment3;
	}

	public void setSpareAttachment3( String value ) {
	...
	public Boolean getIsLongSickLeave() {
		return this.__is_long_sick_leave;
	}

	public void setIsLongSickLeave( Boolean value ) {
	...
	public Integer getLaborAttachmentId() {
		return this.__labor_attachment_id;
	}

	public void setLaborAttachmentId( Integer value ) {
		this.__labor_attachment_id = value;
	}

	public Integer getCardAttachmentId() {
		return this.__card_attachment_id;
	}

	public void setCardAttachmentId( Integer value ) {
		this.__card_attachment_id = value;
	}

	public Integer getTechnicalAttachmentId() {
		return this.__technical_attachment_id;
	}

	public void setTechnicalAttachmentId( Integer value ) {
		this.__technical_attachment_id = value;
	}

	public Integer getEducationProofId() {
		return this.__education_proof_id;
	}

	public void setEducationProofId( Integer value ) {
		this.__education_proof_id = value;
	}

	public Integer getDegreeProofId() {
		return this.__degree_proof_id;
	}

	public void setDegreeProofId( Integer value ) {
		this.__degree_proof_id = value;
	}

	public String getBankCardAttachment() {
		return this.__bank_card_attachment;
	}

	public void setBankCardAttachment( String value ) {
		this.__bank_card_attachment = value;
	}

	public Integer getBankCardAttachmentId() {
		return this.__bank_card_attachment_id;
	}

	public void setBankCardAttachmentId( Integer value ) {
	...
	public boolean equals(Object obj) {
		...
		if(!Objects.equals(this.__oa_id, o.getOaId())) return false;
		if(!Objects.equals(this.__oa_depart, o.getOaDepart())) return false;
		...
		if(!Objects.equals(this.__direct_leader, o.getDirectLeader())) return false;
		if(!Objects.equals(this.__is_manager, o.getIsManager())) return false;
		...
		if(!Objects.equals(this.__languages, o.getLanguages())) return false;
		...
		if(!Objects.equals(this.__try_time, o.getTryTime())) return false;
		...
		if(!Objects.equals(this.__jobs, o.getJobs())) return false;
		if(!Objects.equals(this.__personal_business_remark, o.getPersonalBusinessRemark())) return false;
		if(!Objects.equals(this.__self_introduction, o.getSelfIntroduction())) return false;
		...
		if(!Objects.equals(this.__home_phone, o.getHomePhone())) return false;
		if(!Objects.equals(this.__now_address, o.getNowAddress())) return false;
		...
		if(!Objects.equals(this.__foreman, o.getForeman())) return false;
		...
		if(!Objects.equals(this.__employee_shift, o.getEmployeeShift())) return false;
		...
		if(!Objects.equals(this.__annual_bonus, o.getAnnualBonus())) return false;
		...
		if(!Objects.equals(this.__foreigner_id_card, o.getForeignerIdCard())) return false;
		if(!Objects.equals(this.__real_birthdate, o.getRealBirthdate())) return false;
		if(!Objects.equals(this.__work_year, o.getWorkYear())) return false;
		if(!Objects.equals(this.__shenzhen_house, o.getShenzhenHouse())) return false;
		if(!Objects.equals(this.__trans_household_date, o.getTransHouseholdDate())) return false;
		if(!Objects.equals(this.__professional_direction, o.getProfessionalDirection())) return false;
		if(!Objects.equals(this.__recruitment_sources, o.getRecruitmentSources())) return false;
		if(!Objects.equals(this.__wechat_num, o.getWechatNum())) return false;
		if(!Objects.equals(this.__auto_sign_year, o.getAutoSignYear())) return false;
		if(!Objects.equals(this.__resume_attachment, o.getResumeAttachment())) return false;
		if(!Objects.equals(this.__signature_attachment, o.getSignatureAttachment())) return false;
		if(!Objects.equals(this.__social_attachment, o.getSocialAttachment())) return false;
		if(!Objects.equals(this.__fund_attachment, o.getFundAttachment())) return false;
		if(!Objects.equals(this.__spare_attachment1, o.getSpareAttachment1())) return false;
		if(!Objects.equals(this.__spare_attachment2, o.getSpareAttachment2())) return false;
		if(!Objects.equals(this.__spare_attachment3, o.getSpareAttachment3())) return false;
		if(!Objects.equals(this.__employee_type, o.getEmployeeType())) return false;
		if(!Objects.equals(this.__is_long_sick_leave, o.getIsLongSickLeave())) return false;
		if(!Objects.equals(this.__basic_salary, o.getBasicSalary())) return false;
		if(!Objects.equals(this.__job_title_allowance, o.getJobTitleAllowance())) return false;
		if(!Objects.equals(this.__post_allowance, o.getPostAllowance())) return false;
		if(!Objects.equals(this.__other, o.getOther())) return false;
		if(!Objects.equals(this.__communication_subsidy, o.getCommunicationSubsidy())) return false;
		if(!Objects.equals(this.__subtotal_monthly_wage, o.getSubtotalMonthlyWage())) return false;
		if(!Objects.equals(this.__monthly_preissued_bonus, o.getMonthlyPreissuedBonus())) return false;
		if(!Objects.equals(this.__total_monthly_remuneration, o.getTotalMonthlyRemuneration())) return false;
		if(!Objects.equals(this.__photo_id, o.getPhotoId())) return false;
		if(!Objects.equals(this.__labor_attachment_id, o.getLaborAttachmentId())) return false;
		if(!Objects.equals(this.__card_attachment_id, o.getCardAttachmentId())) return false;
		if(!Objects.equals(this.__technical_attachment_id, o.getTechnicalAttachmentId())) return false;
		...
		if(!Objects.equals(this.__bank_card_attachment, o.getBankCardAttachment())) return false;
		if(!Objects.equals(this.__bank_card_attachment_id, o.getBankCardAttachmentId())) return false;
		return true;
	}
	...
	public String toJSONString() {
		...
		if(getOaId() != null) sb.append(__wrapNumber(count++, "oaId", getOaId()));
		if(getOaDepart() != null) sb.append(__wrapNumber(count++, "oaDepart", getOaDepart()));
		if(getIsHeadcount() != null) sb.append(__wrapBoolean(count++, "isHeadcount", getIsHeadcount()));
		if(getIsCheck() != null) sb.append(__wrapBoolean(count++, "isCheck", getIsCheck()));
		if(getDirectLeader() != null) sb.append(__wrapNumber(count++, "directLeader", getDirectLeader()));
		if(getIsManager() != null) sb.append(__wrapBoolean(count++, "isManager", getIsManager()));
		if(getPoliticalFace() != null) sb.append(__wrapNumber(count++, "politicalFace", getPoliticalFace()));
		...
		if(getLanguages() != null) sb.append(__wrapString(count++, "languages", getLanguages()));
		...
		if(getTryTime() != null) sb.append(__wrapString(count++, "tryTime", getTryTime()));
		if(getContractStartDate() != null) sb.append(__wrapDate(count++, "contractStartDate", getContractStartDate()));
		if(getContractEndDate() != null) sb.append(__wrapDate(count++, "contractEndDate", getContractEndDate()));
		if(getOwnedCompany() != null) sb.append(__wrapString(count++, "ownedCompany", getOwnedCompany()));
		if(getJobs() != null) sb.append(__wrapString(count++, "jobs", getJobs()));
		if(getPersonalBusinessRemark() != null) sb.append(__wrapString(count++, "personalBusinessRemark", getPersonalBusinessRemark()));
		if(getSelfIntroduction() != null) sb.append(__wrapString(count++, "selfIntroduction", getSelfIntroduction()));
		...
		if(getHomePhone() != null) sb.append(__wrapString(count++, "homePhone", getHomePhone()));
		if(getNowAddress() != null) sb.append(__wrapString(count++, "nowAddress", getNowAddress()));
		...
		if(getHouseholdRegistration() != null) sb.append(__wrapNumber(count++, "householdRegistration", getHouseholdRegistration()));
		if(getForeman() != null) sb.append(__wrapString(count++, "foreman", getForeman()));
		...
		if(getEmployeeShift() != null) sb.append(__wrapNumber(count++, "employeeShift", getEmployeeShift()));
		...
		if(getAnnualBonus() != null) sb.append(__wrapString(count++, "annualBonus", getAnnualBonus()));
		...
		if(getEcmcUserId() != null) sb.append(__wrapNumber(count++, "ecmcUserId", getEcmcUserId()));
		...
		if(getWorkYearType() != null) sb.append(__wrapNumber(count++, "workYearType", getWorkYearType()));
		if(getIsbusy() != null) sb.append(__wrapNumber(count++, "isbusy", getIsbusy()));
		if(getForeignerIdCard() != null) sb.append(__wrapString(count++, "foreignerIdCard", getForeignerIdCard()));
		if(getRealBirthdate() != null) sb.append(__wrapDate(count++, "realBirthdate", getRealBirthdate()));
		if(getWorkYear() != null) sb.append(__wrapString(count++, "workYear", getWorkYear()));
		if(getShenzhenHouse() != null) sb.append(__wrapNumber(count++, "shenzhenHouse", getShenzhenHouse()));
		if(getTransHouseholdDate() != null) sb.append(__wrapDate(count++, "transHouseholdDate", getTransHouseholdDate()));
		if(getProfessionalDirection() != null) sb.append(__wrapNumber(count++, "professionalDirection", getProfessionalDirection()));
		if(getRecruitmentSources() != null) sb.append(__wrapNumber(count++, "recruitmentSources", getRecruitmentSources()));
		if(getWechatNum() != null) sb.append(__wrapString(count++, "wechatNum", getWechatNum()));
		if(getAutoSignYear() != null) sb.append(__wrapNumber(count++, "autoSignYear", getAutoSignYear()));
		if(getResumeAttachment() != null) sb.append(__wrapString(count++, "resumeAttachment", getResumeAttachment()));
		if(getSignatureAttachment() != null) sb.append(__wrapString(count++, "signatureAttachment", getSignatureAttachment()));
		if(getSocialAttachment() != null) sb.append(__wrapString(count++, "socialAttachment", getSocialAttachment()));
		if(getFundAttachment() != null) sb.append(__wrapString(count++, "fundAttachment", getFundAttachment()));
		if(getSpareAttachment1() != null) sb.append(__wrapString(count++, "spareAttachment1", getSpareAttachment1()));
		if(getSpareAttachment2() != null) sb.append(__wrapString(count++, "spareAttachment2", getSpareAttachment2()));
		if(getSpareAttachment3() != null) sb.append(__wrapString(count++, "spareAttachment3", getSpareAttachment3()));
		if(getEmployeeType() != null) sb.append(__wrapNumber(count++, "employeeType", getEmployeeType()));
		if(getIsLongSickLeave() != null) sb.append(__wrapBoolean(count++, "isLongSickLeave", getIsLongSickLeave()));
		if(getBasicSalary() != null) sb.append(__wrapDecimal(count++, "basicSalary", getBasicSalary()));
		if(getJobTitleAllowance() != null) sb.append(__wrapDecimal(count++, "jobTitleAllowance", getJobTitleAllowance()));
		if(getPostAllowance() != null) sb.append(__wrapDecimal(count++, "postAllowance", getPostAllowance()));
		if(getOther() != null) sb.append(__wrapDecimal(count++, "other", getOther()));
		if(getCommunicationSubsidy() != null) sb.append(__wrapDecimal(count++, "communicationSubsidy", getCommunicationSubsidy()));
		if(getSubtotalMonthlyWage() != null) sb.append(__wrapDecimal(count++, "subtotalMonthlyWage", getSubtotalMonthlyWage()));
		if(getMonthlyPreissuedBonus() != null) sb.append(__wrapDecimal(count++, "monthlyPreissuedBonus", getMonthlyPreissuedBonus()));
		if(getTotalMonthlyRemuneration() != null) sb.append(__wrapDecimal(count++, "totalMonthlyRemuneration", getTotalMonthlyRemuneration()));
		if(getPhotoId() != null) sb.append(__wrapNumber(count++, "photoId", getPhotoId()));
		if(getLaborAttachmentId() != null) sb.append(__wrapNumber(count++, "laborAttachmentId", getLaborAttachmentId()));
		if(getCardAttachmentId() != null) sb.append(__wrapNumber(count++, "cardAttachmentId", getCardAttachmentId()));
		if(getTechnicalAttachmentId() != null) sb.append(__wrapNumber(count++, "technicalAttachmentId", getTechnicalAttachmentId()));
		if(getEducationProofId() != null) sb.append(__wrapNumber(count++, "educationProofId", getEducationProofId()));
		if(getDegreeProofId() != null) sb.append(__wrapNumber(count++, "degreeProofId", getDegreeProofId()));
		if(getBankCardAttachment() != null) sb.append(__wrapString(count++, "bankCardAttachment", getBankCardAttachment()));
		if(getBankCardAttachmentId() != null) sb.append(__wrapNumber(count++, "bankCardAttachmentId", getBankCardAttachmentId()));
		return sb.toString();
	}
	...
	public Map<String, Object> toMap() {
		...
		if(getOaId() != null) res.put("oaId", getOaId());
		if(getOaDepart() != null) res.put("oaDepart", getOaDepart());
		if(getIsHeadcount() != null) res.put("isHeadcount", getIsHeadcount());
		if(getIsCheck() != null) res.put("isCheck", getIsCheck());
		if(getDirectLeader() != null) res.put("directLeader", getDirectLeader());
		if(getIsManager() != null) res.put("isManager", getIsManager());
		...
		if(getLanguages() != null) res.put("languages", getLanguages());
		...
		if(getTryTime() != null) res.put("tryTime", getTryTime());
		...
		if(getJobs() != null) res.put("jobs", getJobs());
		if(getPersonalBusinessRemark() != null) res.put("personalBusinessRemark", getPersonalBusinessRemark());
		if(getSelfIntroduction() != null) res.put("selfIntroduction", getSelfIntroduction());
		...
		if(getHomePhone() != null) res.put("homePhone", getHomePhone());
		if(getNowAddress() != null) res.put("nowAddress", getNowAddress());
		if(getTryTimePay() != null) res.put("tryTimePay", getTryTimePay());
		if(getPositivePay() != null) res.put("positivePay", getPositivePay());
		...
		if(getForeman() != null) res.put("foreman", getForeman());
		...
		if(getEmployeeShift() != null) res.put("employeeShift", getEmployeeShift());
		if(getCardAddress() != null) res.put("cardAddress", getCardAddress());
		if(getAnnualPerformance() != null) res.put("annualPerformance", getAnnualPerformance());
		if(getAnnualBonus() != null) res.put("annualBonus", getAnnualBonus());
		...
		if(getEcmcUserId() != null) res.put("ecmcUserId", getEcmcUserId());
		...
		if(getIsbusy() != null) res.put("isbusy", getIsbusy());
		if(getForeignerIdCard() != null) res.put("foreignerIdCard", getForeignerIdCard());
		if(getRealBirthdate() != null) res.put("realBirthdate", getRealBirthdate());
		if(getWorkYear() != null) res.put("workYear", getWorkYear());
		if(getShenzhenHouse() != null) res.put("shenzhenHouse", getShenzhenHouse());
		if(getTransHouseholdDate() != null) res.put("transHouseholdDate", getTransHouseholdDate());
		if(getProfessionalDirection() != null) res.put("professionalDirection", getProfessionalDirection());
		if(getRecruitmentSources() != null) res.put("recruitmentSources", getRecruitmentSources());
		if(getWechatNum() != null) res.put("wechatNum", getWechatNum());
		if(getAutoSignYear() != null) res.put("autoSignYear", getAutoSignYear());
		if(getResumeAttachment() != null) res.put("resumeAttachment", getResumeAttachment());
		if(getSignatureAttachment() != null) res.put("signatureAttachment", getSignatureAttachment());
		if(getSocialAttachment() != null) res.put("socialAttachment", getSocialAttachment());
		if(getFundAttachment() != null) res.put("fundAttachment", getFundAttachment());
		if(getSpareAttachment1() != null) res.put("spareAttachment1", getSpareAttachment1());
		if(getSpareAttachment2() != null) res.put("spareAttachment2", getSpareAttachment2());
		if(getSpareAttachment3() != null) res.put("spareAttachment3", getSpareAttachment3());
		if(getEmployeeType() != null) res.put("employeeType", getEmployeeType());
		if(getIsLongSickLeave() != null) res.put("isLongSickLeave", getIsLongSickLeave());
		if(getBasicSalary() != null) res.put("basicSalary", getBasicSalary());
		if(getJobTitleAllowance() != null) res.put("jobTitleAllowance", getJobTitleAllowance());
		if(getPostAllowance() != null) res.put("postAllowance", getPostAllowance());
		if(getOther() != null) res.put("other", getOther());
		if(getCommunicationSubsidy() != null) res.put("communicationSubsidy", getCommunicationSubsidy());
		if(getSubtotalMonthlyWage() != null) res.put("subtotalMonthlyWage", getSubtotalMonthlyWage());
		if(getMonthlyPreissuedBonus() != null) res.put("monthlyPreissuedBonus", getMonthlyPreissuedBonus());
		if(getTotalMonthlyRemuneration() != null) res.put("totalMonthlyRemuneration", getTotalMonthlyRemuneration());
		if(getPhotoId() != null) res.put("photoId", getPhotoId());
		if(getLaborAttachmentId() != null) res.put("laborAttachmentId", getLaborAttachmentId());
		if(getCardAttachmentId() != null) res.put("cardAttachmentId", getCardAttachmentId());
		if(getTechnicalAttachmentId() != null) res.put("technicalAttachmentId", getTechnicalAttachmentId());
		...
		if(getBankCardAttachment() != null) res.put("bankCardAttachment", getBankCardAttachment());
		if(getBankCardAttachmentId() != null) res.put("bankCardAttachmentId", getBankCardAttachmentId());
		return res;
	}
	...
	public void setDataFromMap(Map<String, Object> values){
		...
		if((val = values.get("oaId")) != null) setOaId(__getInt(val)); 
		if((val = values.get("oaDepart")) != null) setOaDepart(__getInt(val)); 
		...
		if((val = values.get("directLeader")) != null) setDirectLeader(__getInt(val)); 
		if((val = values.get("isManager")) != null) setIsManager(__getBoolean(val));
		if((val = values.get("politicalFace")) != null) setPoliticalFace(__getInt(val)); 
		...
		if((val = values.get("languages")) != null) setLanguages(__getString(val));
		...
		if((val = values.get("contractStartDate")) != null) setContractStartDate(__getDate(val)); 
		if((val = values.get("contractEndDate")) != null) setContractEndDate(__getDate(val)); 
		if((val = values.get("ownedCompany")) != null) setOwnedCompany(__getString(val));
		if((val = values.get("jobs")) != null) setJobs(__getString(val));
		if((val = values.get("personalBusinessRemark")) != null) setPersonalBusinessRemark(__getString(val));
		if((val = values.get("selfIntroduction")) != null) setSelfIntroduction(__getString(val));
		...
		if((val = values.get("homePhone")) != null) setHomePhone(__getString(val));
		if((val = values.get("nowAddress")) != null) setNowAddress(__getString(val));
		...
		if((val = values.get("householdRegistration")) != null) setHouseholdRegistration(__getInt(val)); 
		if((val = values.get("foreman")) != null) setForeman(__getString(val));
		...
		if((val = values.get("employeeShift")) != null) setEmployeeShift(__getInt(val)); 
		...
		if((val = values.get("annualBonus")) != null) setAnnualBonus(__getString(val));
		...
		if((val = values.get("ecmcUserId")) != null) setEcmcUserId(__getInt(val)); 
		...
		if((val = values.get("workYearType")) != null) setWorkYearType(__getInt(val)); 
		if((val = values.get("isbusy")) != null) setIsbusy(__getInt(val)); 
		if((val = values.get("foreignerIdCard")) != null) setForeignerIdCard(__getString(val));
		if((val = values.get("realBirthdate")) != null) setRealBirthdate(__getDate(val)); 
		if((val = values.get("workYear")) != null) setWorkYear(__getString(val));
		if((val = values.get("shenzhenHouse")) != null) setShenzhenHouse(__getInt(val)); 
		if((val = values.get("transHouseholdDate")) != null) setTransHouseholdDate(__getDate(val)); 
		if((val = values.get("professionalDirection")) != null) setProfessionalDirection(__getInt(val)); 
		if((val = values.get("recruitmentSources")) != null) setRecruitmentSources(__getInt(val)); 
		if((val = values.get("wechatNum")) != null) setWechatNum(__getString(val));
		if((val = values.get("autoSignYear")) != null) setAutoSignYear(__getInt(val)); 
		if((val = values.get("resumeAttachment")) != null) setResumeAttachment(__getString(val));
		if((val = values.get("signatureAttachment")) != null) setSignatureAttachment(__getString(val));
		if((val = values.get("socialAttachment")) != null) setSocialAttachment(__getString(val));
		if((val = values.get("fundAttachment")) != null) setFundAttachment(__getString(val));
		if((val = values.get("spareAttachment1")) != null) setSpareAttachment1(__getString(val));
		if((val = values.get("spareAttachment2")) != null) setSpareAttachment2(__getString(val));
		if((val = values.get("spareAttachment3")) != null) setSpareAttachment3(__getString(val));
		if((val = values.get("employeeType")) != null) setEmployeeType(__getInt(val)); 
		if((val = values.get("isLongSickLeave")) != null) setIsLongSickLeave(__getBoolean(val));
		if((val = values.get("basicSalary")) != null) setBasicSalary(__getDecimal(val));  
		if((val = values.get("jobTitleAllowance")) != null) setJobTitleAllowance(__getDecimal(val));  
		if((val = values.get("postAllowance")) != null) setPostAllowance(__getDecimal(val));  
		if((val = values.get("other")) != null) setOther(__getDecimal(val));  
		if((val = values.get("communicationSubsidy")) != null) setCommunicationSubsidy(__getDecimal(val));  
		if((val = values.get("subtotalMonthlyWage")) != null) setSubtotalMonthlyWage(__getDecimal(val));  
		if((val = values.get("monthlyPreissuedBonus")) != null) setMonthlyPreissuedBonus(__getDecimal(val));  
		if((val = values.get("totalMonthlyRemuneration")) != null) setTotalMonthlyRemuneration(__getDecimal(val));  
		if((val = values.get("photoId")) != null) setPhotoId(__getInt(val)); 
		if((val = values.get("laborAttachmentId")) != null) setLaborAttachmentId(__getInt(val)); 
		if((val = values.get("cardAttachmentId")) != null) setCardAttachmentId(__getInt(val)); 
		if((val = values.get("technicalAttachmentId")) != null) setTechnicalAttachmentId(__getInt(val)); 
		if((val = values.get("educationProofId")) != null) setEducationProofId(__getInt(val)); 
		if((val = values.get("degreeProofId")) != null) setDegreeProofId(__getInt(val)); 
		if((val = values.get("bankCardAttachment")) != null) setBankCardAttachment(__getString(val));
		if((val = values.get("bankCardAttachmentId")) != null) setBankCardAttachmentId(__getInt(val)); 
	}
	...
	protected Boolean  __is_manager ;
	protected Integer  __political_face ;
	protected String  __birthplace ;
	protected String  __country ;
	protected String  __account_location ;
	protected String  __languages ;
	...
	protected String  __jobs ;
	protected String  __personal_business_remark ;
	protected String  __self_introduction ;
	...
	protected String  __home_phone ;
	protected String  __now_address ;
	protected String  __try_time_pay ;
	protected String  __positive_pay ;
	protected Integer  __apply_employee_id ;
	protected String  __bank_card_num ;
	protected String  __file_number ;
	protected Integer  __household_registration ;
	protected String  __foreman ;
	...
	protected Integer  __employee_shift ;
	protected String  __card_address ;
	protected String  __annual_performance ;
	protected String  __annual_bonus ;
	protected String  __company_weixin ;
	protected String  __company_email ;
	protected Integer  __company_id ;
	protected Integer  __ecmc_user_id ;
	protected Integer  __onboard_status ;
	protected String  __attachment_remark ;
	protected Integer  __work_year_type ;
	protected Integer  __isbusy ;
	protected String  __foreigner_id_card ;
	protected java.util.Date  __real_birthdate ;
	protected String  __work_year ;
	protected Integer  __shenzhen_house ;
	protected java.util.Date  __trans_household_date ;
	protected Integer  __professional_direction ;
	protected Integer  __recruitment_sources ;
	protected String  __wechat_num ;
	protected Integer  __auto_sign_year ;
	protected String  __resume_attachment ;
	protected String  __signature_attachment ;
	protected String  __social_attachment ;
	protected String  __fund_attachment ;
	protected String  __spare_attachment1 ;
	protected String  __spare_attachment2 ;
	protected String  __spare_attachment3 ;
	protected Integer  __employee_type ;
	protected Boolean  __is_long_sick_leave ;
	...
	protected Integer  __photo_id ;
	protected Integer  __labor_attachment_id ;
	protected Integer  __card_attachment_id ;
	protected Integer  __technical_attachment_id ;
	protected Integer  __education_proof_id ;
	protected Integer  __degree_proof_id ;
	protected String  __bank_card_attachment ;
	protected Integer  __bank_card_attachment_id ;
}
