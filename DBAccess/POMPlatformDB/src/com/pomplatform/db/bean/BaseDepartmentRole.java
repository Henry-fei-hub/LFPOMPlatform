...
public class BaseDepartmentRole extends GenericBase implements BaseFactory<BaseDepartmentRole>, Comparable<BaseDepartmentRole> 
{
	...
	public boolean equals(Object obj) {
		...
		if(!Objects.equals(this.__department_role_id, o.getDepartmentRoleId())) return false;
	...
	public java.lang.String toJSONString() {
		...
		StringBuilder sb = new StringBuilder();
		int count = 0;
		if(getDepartmentRoleId() != null) sb.append(__wrapNumber(count++, "departmentRoleId", getDepartmentRoleId()));
	...
	public void setDataFromMap(Map<String, Object> values){
		Object val;
		if((val = values.get("departmentRoleId")) != null) setDepartmentRoleId(__getInt(val)); 
