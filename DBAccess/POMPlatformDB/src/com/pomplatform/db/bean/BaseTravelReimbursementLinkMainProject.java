...
public class BaseTravelReimbursementLinkMainProject extends GenericBase implements BaseFactory<BaseTravelReimbursementLinkMainProject>, Comparable<BaseTravelReimbursementLinkMainProject> 
{


	public static BaseTravelReimbursementLinkMainProject newInstance(){
		return new BaseTravelReimbursementLinkMainProject();
	}

	@Override
	public BaseTravelReimbursementLinkMainProject make(){
		BaseTravelReimbursementLinkMainProject b = new BaseTravelReimbursementLinkMainProject();
		return b;
	}

	public final static java.lang.String CS_TRAVEL_REIMBURSEMENT_LINK_MAIN_PROJECT_ID = "travel_reimbursement_link_main_project_id" ;
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,日常报销编码,项目,前期项目名称,信息编号,费用,备注,业务部门,进项税,成本,是否个人承担费用,进项税转出金额,有无电子发票  1 无 2有,发票关联key 用于发票信息关联";

	public java.lang.Integer getTravelReimbursementLinkMainProjectId() {
		return this.__travel_reimbursement_link_main_project_id;
	}

	public void setTravelReimbursementLinkMainProjectId( java.lang.Integer value ) {
		this.__travel_reimbursement_link_main_project_id = value;
	}
	...
	public void cloneCopy(BaseTravelReimbursementLinkMainProject __bean){
		__bean.setTravelReimbursementLinkMainProjectId(getTravelReimbursementLinkMainProjectId());
	...
	public java.lang.String toCSVString() {
		...
		sb.append(getTravelReimbursementLinkMainProjectId() == null ? "" : getTravelReimbursementLinkMainProjectId());
		sb.append(",");
	...
	@Override
	public int compareTo(BaseTravelReimbursementLinkMainProject o) {
		return __travel_reimbursement_link_main_project_id == null ? -1 : __travel_reimbursement_link_main_project_id.compareTo(o.getTravelReimbursementLinkMainProjectId());
	}

	@Override
	public int hashCode() {
		int hash = 7;
		hash = 97 * hash + Objects.hashCode(this.__travel_reimbursement_link_main_project_id);
	...
	public boolean equals(Object obj) {
		...
		final BaseTravelReimbursementLinkMainProject o = (BaseTravelReimbursementLinkMainProject)obj;
		if(!Objects.equals(this.__travel_reimbursement_link_main_project_id, o.getTravelReimbursementLinkMainProjectId())) return false;
	...
	public java.lang.String toJSONString() {
		...
		StringBuilder sb = new StringBuilder();
		int count = 0;
		if(getTravelReimbursementLinkMainProjectId() != null) sb.append(__wrapNumber(count++, "travelReimbursementLinkMainProjectId", getTravelReimbursementLinkMainProjectId()));
	...
	public Map<String, Object> toMap() {
		...
		if(getTravelReimbursementLinkMainProjectId() != null) res.put("travelReimbursementLinkMainProjectId", getTravelReimbursementLinkMainProjectId());
	...
	public void setDataFromMap(Map<String, Object> values){
		Object val;
		if((val = values.get("travelReimbursementLinkMainProjectId")) != null) setTravelReimbursementLinkMainProjectId(__getInt(val)); 
	...
	protected java.lang.Integer  __travel_reimbursement_link_main_project_id ;
