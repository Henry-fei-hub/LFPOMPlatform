...
public class BaseTalentsMinimumArrangement extends GenericBase implements BaseFactory<BaseTalentsMinimumArrangement>, Comparable<BaseTalentsMinimumArrangement> 
{


	public static BaseTalentsMinimumArrangement newInstance(){
		return new BaseTalentsMinimumArrangement();
	}

	@Override
	public BaseTalentsMinimumArrangement make(){
		BaseTalentsMinimumArrangement b = new BaseTalentsMinimumArrangement();
		return b;
	}

	public final static java.lang.String CS_TALENTS_MINIMUM_ARRANGEMENT_ID = "talents_minimum_arrangement_id" ;
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,业务部门,高级设计师,中级设计师,初级设计师,项目级别,操作人,操作时间,备注";

	public java.lang.Integer getTalentsMinimumArrangementId() {
		return this.__talents_minimum_arrangement_id;
	}

	public void setTalentsMinimumArrangementId( java.lang.Integer value ) {
		this.__talents_minimum_arrangement_id = value;
	}
	...
	public void cloneCopy(BaseTalentsMinimumArrangement __bean){
		__bean.setTalentsMinimumArrangementId(getTalentsMinimumArrangementId());
	...
	public java.lang.String toCSVString() {
		...
		sb.append(getTalentsMinimumArrangementId() == null ? "" : getTalentsMinimumArrangementId());
		sb.append(",");
	...
	@Override
	public int compareTo(BaseTalentsMinimumArrangement o) {
		return __talents_minimum_arrangement_id == null ? -1 : __talents_minimum_arrangement_id.compareTo(o.getTalentsMinimumArrangementId());
	}

	@Override
	public int hashCode() {
		int hash = 7;
		hash = 97 * hash + Objects.hashCode(this.__talents_minimum_arrangement_id);
	...
	public boolean equals(Object obj) {
		...
		final BaseTalentsMinimumArrangement o = (BaseTalentsMinimumArrangement)obj;
		if(!Objects.equals(this.__talents_minimum_arrangement_id, o.getTalentsMinimumArrangementId())) return false;
	...
	public java.lang.String toJSONString() {
		...
		StringBuilder sb = new StringBuilder();
		int count = 0;
		if(getTalentsMinimumArrangementId() != null) sb.append(__wrapNumber(count++, "talentsMinimumArrangementId", getTalentsMinimumArrangementId()));
	...
	public void setDataFromMap(Map<String, Object> values){
		Object val;
		if((val = values.get("talentsMinimumArrangementId")) != null) setTalentsMinimumArrangementId(__getInt(val)); 
	...
	protected java.lang.Integer  __talents_minimum_arrangement_id ;
