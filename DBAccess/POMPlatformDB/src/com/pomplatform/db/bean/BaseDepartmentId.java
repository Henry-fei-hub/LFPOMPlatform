...
public class BaseDepartmentId extends GenericBase implements BaseFactory<BaseDepartmentId>, Comparable<BaseDepartmentId> 
{
	...
	public boolean equals(Object obj) {
		...
		if(!Objects.equals(this.__department_id_id, o.getDepartmentIdId())) return false;
		if(!Objects.equals(this.__department_id, o.getDepartmentId())) return false;
		if(!Objects.equals(this.__child_id, o.getChildId())) return false;
		return true;
	}
	...
	public java.lang.String toJSONString() {
		...
		StringBuilder sb = new StringBuilder();
		int count = 0;
		if(getDepartmentIdId() != null) sb.append(__wrapNumber(count++, "departmentIdId", getDepartmentIdId()));
		if(getDepartmentId() != null) sb.append(__wrapNumber(count++, "departmentId", getDepartmentId()));
		if(getChildId() != null) sb.append(__wrapNumber(count++, "childId", getChildId()));
		return sb.toString();
	}
	...
	public void setDataFromMap(Map<String, Object> values){
		Object val;
		if((val = values.get("departmentIdId")) != null) setDepartmentIdId(__getInt(val)); 
		if((val = values.get("departmentId")) != null) setDepartmentId(__getInt(val)); 
		if((val = values.get("childId")) != null) setChildId(__getInt(val)); 
	}
