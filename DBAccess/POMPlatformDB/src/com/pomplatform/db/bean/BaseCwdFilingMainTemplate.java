...
public class BaseCwdFilingMainTemplate extends GenericBase implements BaseFactory<BaseCwdFilingMainTemplate>, Comparable<BaseCwdFilingMainTemplate> 
{


	public static BaseCwdFilingMainTemplate newInstance(){
		return new BaseCwdFilingMainTemplate();
	}

	@Override
	public BaseCwdFilingMainTemplate make(){
	...
	public void cloneCopy(BaseCwdFilingMainTemplate __bean){
	...
	@Override
	public int compareTo(BaseCwdFilingMainTemplate o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseCwdFilingMainTemplate o = (BaseCwdFilingMainTemplate)obj;
