...
public class BasePaymentSequence extends GenericBase implements BaseFactory<BasePaymentSequence>, Comparable<BasePaymentSequence> 
{


	public static BasePaymentSequence newInstance(){
		return new BasePaymentSequence();
	}

	@Override
	public BasePaymentSequence make(){
	...
	public final static java.lang.String ALL_CAPTIONS = "主键id,预算管理id,预算附件id,付款金额,付款日期,付款状态,付款序列备注,年,月,收款单位编码(公司或者个人),流水编码,项目id,绑定状态,付款类型,是否加锁,报销金额,冲账金额,付款申请日期,还款金额,收款方类型 1个人，2公司,收款人名称,报销编号,流程类型,";
	...
	public void cloneCopy(BasePaymentSequence __bean){
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		sb.append(getBindStatus() == null ? "" : getBindStatus());
		sb.append(",");
	...
	@Override
	public int compareTo(BasePaymentSequence o) {
	...
	public boolean equals(Object obj) {
		...
		final BasePaymentSequence o = (BasePaymentSequence)obj;
