...
public class BaseProjectIntegralChangeRecord extends GenericBase implements BaseFactory<BaseProjectIntegralChangeRecord>, Comparable<BaseProjectIntegralChangeRecord> 
{


	public static BaseProjectIntegralChangeRecord newInstance(){
		return new BaseProjectIntegralChangeRecord();
	}

	@Override
	public BaseProjectIntegralChangeRecord make(){
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,项目,调整前项目积分,调整后项目积分,调整前预留积分,调整后预留积分,转移积分,转移日期,板块,板块负责人,备注";
	...
	public void cloneCopy(BaseProjectIntegralChangeRecord __bean){
	...
	@Override
	public int compareTo(BaseProjectIntegralChangeRecord o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseProjectIntegralChangeRecord o = (BaseProjectIntegralChangeRecord)obj;
