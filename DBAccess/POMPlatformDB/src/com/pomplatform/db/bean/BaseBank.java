...
public class BaseBank extends GenericBase implements BaseFactory<BaseBank>, Comparable<BaseBank> 
{


	public static BaseBank newInstance(){
		return new BaseBank();
	}

	@Override
	public BaseBank make(){
	...
	public final static java.lang.String ALL_CAPTIONS = ",银行名称,排序 越小排越前,创建时间";
	...
	public void cloneCopy(BaseBank __bean){
	...
	@Override
	public int compareTo(BaseBank o) {
