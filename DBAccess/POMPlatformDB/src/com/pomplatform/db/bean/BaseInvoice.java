...
public class BaseInvoice extends GenericBase implements BaseFactory<BaseInvoice>, Comparable<BaseInvoice> 
{


	public static BaseInvoice newInstance(){
		return new BaseInvoice();
	}

	@Override
	public BaseInvoice make(){
	...
	public final static java.lang.String CS_PRIMARY_INVOICE_CODE = "primary_invoice_code" ;
	public final static java.lang.String CS_PRIMARY_INVOICE_NUMBER = "primary_invoice_number" ;
	...
	public final static java.lang.String ALL_CAPTIONS = "开发票 编码,购票公司,发票类型 1专票，2普票 ，3代开,发票代码(10位 每次批量录入是一样),发票号码(8位 规则+1),发票入库日期,发票空白作废备注,发票空白作废操作人,发票入库操作人,信息编号,项目编号,合同id,合同编号,开票金额(如 100),税率(如 6%),,,开票操作人,开票日期,开发票的登记日期,3填开作废。当月发票，当月作废。4.负数作废。做了红字，然后又作废。5.空白作废。尚未开具，就直接作废（往往是不慎污染弄脏了，没法使用）,原发票代码(负数作废才能填),原发票号码(负数作废才能填),收款阶段id,确认函id,,可操作状态 0可操作,1禁止操作,是否有凭证,是否对应回款,回款金额,项目经理编码,客户";
	...
	public java.lang.String getPrimaryInvoiceCode() {
		return this.__primary_invoice_code;
	}

	public void setPrimaryInvoiceCode( java.lang.String value ) {
		this.__primary_invoice_code = value;
	}

	public java.lang.String getPrimaryInvoiceNumber() {
		return this.__primary_invoice_number;
	}

	public void setPrimaryInvoiceNumber( java.lang.String value ) {
		this.__primary_invoice_number = value;
	}
	...
	public void cloneCopy(BaseInvoice __bean){
		...
		__bean.setPrimaryInvoiceCode(getPrimaryInvoiceCode());
		__bean.setPrimaryInvoiceNumber(getPrimaryInvoiceNumber());
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		sb.append(getPrimaryInvoiceCode() == null ? "" : getPrimaryInvoiceCode());
		sb.append(",");
		sb.append(getPrimaryInvoiceNumber() == null ? "" : getPrimaryInvoiceNumber());
		sb.append(",");
	...
	@Override
	public int compareTo(BaseInvoice o) {
	...
	public int hashCode() {
		...
		hash = 97 * hash + Objects.hashCode(this.__primary_invoice_code);
		hash = 97 * hash + Objects.hashCode(this.__primary_invoice_number);
	...
	public boolean equals(Object obj) {
		...
		final BaseInvoice o = (BaseInvoice)obj;
		...
		if(!Objects.equals(this.__primary_invoice_code, o.getPrimaryInvoiceCode())) return false;
		if(!Objects.equals(this.__primary_invoice_number, o.getPrimaryInvoiceNumber())) return false;
	...
	public java.lang.String toJSONString() {
		...
		if(getPrimaryInvoiceCode() != null) sb.append(__wrapString(count++, "primaryInvoiceCode", getPrimaryInvoiceCode()));
		if(getPrimaryInvoiceNumber() != null) sb.append(__wrapString(count++, "primaryInvoiceNumber", getPrimaryInvoiceNumber()));
	...
	public Map<String, Object> toMap() {
		...
		if(getTicketingCompany() != null) res.put("ticketingCompany", getTicketingCompany());
		...
		if(getInStockDate() != null) res.put("inStockDate", getInStockDate());
		if(getInvalidRemark() != null) res.put("invalidRemark", getInvalidRemark());
		if(getIsInvalidOperator() != null) res.put("isInvalidOperator", getIsInvalidOperator());
		if(getStorageOperator() != null) res.put("storageOperator", getStorageOperator());
		...
		if(getNoTaxAmount() != null) res.put("noTaxAmount", getNoTaxAmount());
		if(getOutputTax() != null) res.put("outputTax", getOutputTax());
		if(getBillingOperation() != null) res.put("billingOperation", getBillingOperation());
		if(getInvoiceDate() != null) res.put("invoiceDate", getInvoiceDate());
		if(getRegistrationDate() != null) res.put("registrationDate", getRegistrationDate());
		if(getSign() != null) res.put("sign", getSign());
		if(getPrimaryInvoiceCode() != null) res.put("primaryInvoiceCode", getPrimaryInvoiceCode());
		if(getPrimaryInvoiceNumber() != null) res.put("primaryInvoiceNumber", getPrimaryInvoiceNumber());
		if(getContractReceivableId() != null) res.put("contractReceivableId", getContractReceivableId());
		if(getAcknowledgeLetterId() != null) res.put("acknowledgeLetterId", getAcknowledgeLetterId());
		if(getInvoiceExpressId() != null) res.put("invoiceExpressId", getInvoiceExpressId());
		if(getDisableType() != null) res.put("disableType", getDisableType());
		if(getHaveVoucher() != null) res.put("haveVoucher", getHaveVoucher());
		if(getIsCapital() != null) res.put("isCapital", getIsCapital());
		if(getCapitalAmount() != null) res.put("capitalAmount", getCapitalAmount());
		if(getProjectManagerId() != null) res.put("projectManagerId", getProjectManagerId());
	...
	public void setDataFromMap(Map<String, Object> values){
		...
		if((val = values.get("primaryInvoiceCode")) != null) setPrimaryInvoiceCode(__getString(val));
		if((val = values.get("primaryInvoiceNumber")) != null) setPrimaryInvoiceNumber(__getString(val));
	...
	protected java.lang.String  __primary_invoice_code ;
	protected java.lang.String  __primary_invoice_number ;
