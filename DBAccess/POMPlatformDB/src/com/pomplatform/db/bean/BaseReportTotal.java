...
public class BaseReportTotal extends GenericBase implements BaseFactory<BaseReportTotal>, Comparable<BaseReportTotal> 
{


	public static BaseReportTotal newInstance(){
		return new BaseReportTotal();
	}

	@Override
	public BaseReportTotal make(){
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,,年份,本月不含税营收,累计不含税营收,本月现金流(部门),累计现金流(部门),本月现金流(项目组),累计现金流(项目组),本月确认积分(部门),累计确认积分(部门),本月确认积分(项目组),累计确认积分(项目组),本月薪酬,累计薪酬,本月成本(部门),累计成本(部门),本月成本(项目),累计成本(项目),本月成本(前期项目),累计成本(前期项目),,,合同存量,累计平均人数,最低人数,年人均营收,年现金流,效益指数,年不含税营收,操作人,操作时间,备注";
	...
	public void setAverageEmpNum( java.math.BigDecimal value ) {
	...
	public void cloneCopy(BaseReportTotal __bean){
	...
	public java.lang.String toCSVString() {
		...
		sb.append(getReportTotalId() == null ? "" : getReportTotalId());
		sb.append(",");
	...
	@Override
	public int compareTo(BaseReportTotal o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseReportTotal o = (BaseReportTotal)obj;
	...
	public java.lang.String toJSONString() {
		...
		if(getAverageEmpNum() != null) sb.append(__wrapDecimal(count++, "averageEmpNum", getAverageEmpNum()));
	...
	public void setDataFromMap(Map<String, Object> values){
		...
		if((val = values.get("averageEmpNum")) != null) setAverageEmpNum(__getDecimal(val));  
	...
	protected java.math.BigDecimal  __average_emp_num ;
