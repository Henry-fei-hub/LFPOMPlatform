...
public class BaseEmployeeMonthCheck extends GenericBase implements BaseFactory<BaseEmployeeMonthCheck>, Comparable<BaseEmployeeMonthCheck> 
{


	public static BaseEmployeeMonthCheck newInstance(){
		return new BaseEmployeeMonthCheck();
	}

	@Override
	public BaseEmployeeMonthCheck make(){
		BaseEmployeeMonthCheck b = new BaseEmployeeMonthCheck();
		return b;
	}

	public final static java.lang.String CS_EMPLOYEE_MONTH_CHECK_ID = "employee_month_check_id" ;
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,职员编码,年份,月份,迟到/早退5分钟,迟到/早退10分钟,迟到/早退30分钟,扣款迟到/早退,事假次数,事假小时数,事假天数,病假次数,病假小时数,病假天数,其它假类次数,其它假类小时数,其它假类天数,平时加班小时数,周末加班小时数,节假日加班小时数,旷工天数,应到天数,实到天数,操作人,操作时间,备注,是否加锁,迟到次数,迟到分钟,早退次数,早退分钟,迟到扣款,调休假(小时),年假天数,婚假天数,产假天数,产检假天数,陪产假天数,丧假天数,因公外出次数,加班餐补(本月),加班补助(本月),加班补助,加班餐补,是否全勤";

	public java.lang.Integer getEmployeeMonthCheckId() {
		return this.__employee_month_check_id;
	}

	public void setEmployeeMonthCheckId( java.lang.Integer value ) {
		this.__employee_month_check_id = value;
	}
	...
	public void cloneCopy(BaseEmployeeMonthCheck __bean){
		__bean.setEmployeeMonthCheckId(getEmployeeMonthCheckId());
	...
	public java.lang.String toCSVString() {
		...
		sb.append(getEmployeeMonthCheckId() == null ? "" : getEmployeeMonthCheckId());
		sb.append(",");
	...
	@Override
	public int compareTo(BaseEmployeeMonthCheck o) {
		return __employee_month_check_id == null ? -1 : __employee_month_check_id.compareTo(o.getEmployeeMonthCheckId());
	}

	@Override
	public int hashCode() {
		int hash = 7;
		hash = 97 * hash + Objects.hashCode(this.__employee_month_check_id);
	...
	public boolean equals(Object obj) {
		...
		final BaseEmployeeMonthCheck o = (BaseEmployeeMonthCheck)obj;
		if(!Objects.equals(this.__employee_month_check_id, o.getEmployeeMonthCheckId())) return false;
	...
	public java.lang.String toJSONString() {
		...
		StringBuilder sb = new StringBuilder();
		int count = 0;
		if(getEmployeeMonthCheckId() != null) sb.append(__wrapNumber(count++, "employeeMonthCheckId", getEmployeeMonthCheckId()));
	...
	public Map<String, Object> toMap() {
		...
		if(getEmployeeMonthCheckId() != null) res.put("employeeMonthCheckId", getEmployeeMonthCheckId());
	...
	public void setDataFromMap(Map<String, Object> values){
		Object val;
		if((val = values.get("employeeMonthCheckId")) != null) setEmployeeMonthCheckId(__getInt(val)); 
	...
	protected java.lang.Integer  __employee_month_check_id ;
