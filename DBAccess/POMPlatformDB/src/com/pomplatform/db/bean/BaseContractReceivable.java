...
public class BaseContractReceivable extends GenericBase implements BaseFactory<BaseContractReceivable>, Comparable<BaseContractReceivable> 
{


	public static BaseContractReceivable newInstance(){
		return new BaseContractReceivable();
	}

	@Override
	public BaseContractReceivable make(){
	...
	public final static java.lang.String ALL_CAPTIONS = "合同阶段id,信息编号,项目编号,合同id,合同主编号,阶段名称,收款百分比,收款金额,是否已经被用做过确认函,收款阶段备注,收款阶段id的父节点,操作人,创建时间,修改时间";
	...
	public void setStageSumMoney( java.math.BigDecimal value ) {
		this.__stage_sum_money = value;//鍥炴闃舵閲戦
	}
	public void cloneCopy(BaseContractReceivable __bean){
	...
	@Override
	public int compareTo(BaseContractReceivable o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseContractReceivable o = (BaseContractReceivable)obj;
