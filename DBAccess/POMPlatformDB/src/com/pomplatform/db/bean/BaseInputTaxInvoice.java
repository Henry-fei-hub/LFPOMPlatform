...
public class BaseInputTaxInvoice extends GenericBase implements BaseFactory<BaseInputTaxInvoice>, Comparable<BaseInputTaxInvoice> 
{


	public static BaseInputTaxInvoice newInstance(){
		return new BaseInputTaxInvoice();
	}

	@Override
	public BaseInputTaxInvoice make(){
	...
	public final static java.lang.String ALL_CAPTIONS = ",发票类型 1专票，2普票 ，3代开,发票代码(10位 每次批量录入是一样),发票号码(8位),开票日期,开票金额(如 100),税率(如 6%),,创建时间,备注,其他备注,销方税号,税额,销方名称,年,月,";
	...
	public void cloneCopy(BaseInputTaxInvoice __bean){
	...
	@Override
	public int compareTo(BaseInputTaxInvoice o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseInputTaxInvoice o = (BaseInputTaxInvoice)obj;
