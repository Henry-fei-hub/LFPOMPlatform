...
public class BaseDesignConsideration extends GenericBase implements BaseFactory<BaseDesignConsideration>, Comparable<BaseDesignConsideration> 
{


	public static BaseDesignConsideration newInstance(){
		return new BaseDesignConsideration();
	}

	@Override
	public BaseDesignConsideration make(){
	...
	public final static java.lang.String ALL_CAPTIONS = "设计要素编码,信息编号,项目编号,业务类型,项目类型,区域,精简装状态   0精装    1简装,设计面积,设计单价,小计 设计面积总金额,子订单编码,现场配合,服务面积,配合金额,驻场时间(月),驻场价格(元/月),驻场总金额(元),创建时间,修改时间,标记补充协议字段；除0之外，其他都表示第n个补充协议,可操作状态 0可操作,1禁止操作,主订单id,报价单id,内部设计单价,内部设计面积总金额,备注,子项and专项,操作人(人员id),报价单子项的序号编码记录(用来表示顺序),拆分价总金额,父节点，第一级为0,报价单子项的id，该字段用来标识该报价单子项是否已经拆分了";
	...
	public void cloneCopy(BaseDesignConsideration __bean){
	...
	@Override
	public int compareTo(BaseDesignConsideration o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseDesignConsideration o = (BaseDesignConsideration)obj;
