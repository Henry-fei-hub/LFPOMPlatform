...
public class BaseClock extends GenericBase implements BaseFactory<BaseClock>, Comparable<BaseClock> 
{


	public static BaseClock newInstance(){
		return new BaseClock();
	}

	@Override
	public BaseClock make(){
	...
	public void cloneCopy(BaseClock __bean){
	...
	@Override
	public int compareTo(BaseClock o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseClock o = (BaseClock)obj;
	...
	public void setDataFromMap(Map<String, Object> values){
		...
		if((val = values.get("enabled")) != null) setEnabled(__getInt(val)); 
	...
	protected java.lang.Integer  __enabled ;
