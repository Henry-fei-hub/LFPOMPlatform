...
public class BaseEmployeeDayPlateRecord extends GenericBase implements BaseFactory<BaseEmployeeDayPlateRecord>, Comparable<BaseEmployeeDayPlateRecord> 
{


	public static BaseEmployeeDayPlateRecord newInstance(){
		return new BaseEmployeeDayPlateRecord();
	}

	@Override
	public BaseEmployeeDayPlateRecord make(){
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,职员id,职员工号,职员姓名,记录日期,年份,月份,所属公司,业务部门,所属部门,人事状态(0实习生，1试用期，2正式员工)";
	...
	public void cloneCopy(BaseEmployeeDayPlateRecord __bean){
	...
	@Override
	public int compareTo(BaseEmployeeDayPlateRecord o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseEmployeeDayPlateRecord o = (BaseEmployeeDayPlateRecord)obj;
