...
public class BaseEmployeeDayCheck extends GenericBase implements BaseFactory<BaseEmployeeDayCheck>, Comparable<BaseEmployeeDayCheck> 
{


	public static BaseEmployeeDayCheck newInstance(){
		return new BaseEmployeeDayCheck();
	}

	@Override
	public BaseEmployeeDayCheck make(){
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,职员编码,年份,月份,日期,班次,上班时间,下班时间,迟到/早退5分钟,迟到/早退10分钟,迟到/早退30分钟,扣款迟到/早退,事假次数,事假小时数,事假天数,病假次数,病假小时数,病假天数,其它假类次数,其它假类小时数,其它假类天数,平时加班小时数,周末加班小时数,节假日加班小时数,旷工天数,应到天数,实到天数,4旷工,操作人,操作时间,备注,是否加锁,迟到次数,迟到分钟,早退次数,早退分钟,迟到扣款,调休假(小时),年假天数,婚假天数,产假天数,产检假天数,陪产假天数,丧假天数,因公外出次数,加班餐补(本月),加班补助(本月),加班补助,加班餐补";
	...
	public void cloneCopy(BaseEmployeeDayCheck __bean){
	...
	@Override
	public int compareTo(BaseEmployeeDayCheck o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseEmployeeDayCheck o = (BaseEmployeeDayCheck)obj;
