...
public class BaseDepartment extends GenericBase implements BaseFactory<BaseDepartment>, Comparable<BaseDepartment> 
{
	...
	public boolean equals(Object obj) {
		...
		if(!Objects.equals(this.__weixin_department_id, o.getWeixinDepartmentId())) return false;
		if(!Objects.equals(this.__email_department_id, o.getEmailDepartmentId())) return false;
	...
	public java.lang.String toJSONString() {
		...
		if(getWeixinDepartmentId() != null) sb.append(__wrapNumber(count++, "weixinDepartmentId", getWeixinDepartmentId()));
		if(getEmailDepartmentId() != null) sb.append(__wrapNumber(count++, "emailDepartmentId", getEmailDepartmentId()));
	...
	public void setDataFromMap(Map<String, Object> values){
		...
		if((val = values.get("weixinDepartmentId")) != null) setWeixinDepartmentId(__getLong(val)); 
		if((val = values.get("emailDepartmentId")) != null) setEmailDepartmentId(__getLong(val)); 
