...
public class BaseManageProject extends GenericBase implements BaseFactory<BaseManageProject>, Comparable<BaseManageProject> 
{


	public static BaseManageProject newInstance(){
		return new BaseManageProject();
	}

	@Override
	public BaseManageProject make(){
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,项目名称,项目总积分,业务部门,日期,备注,剩余积分";
	...
	public void cloneCopy(BaseManageProject __bean){
	...
	@Override
	public int compareTo(BaseManageProject o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseManageProject o = (BaseManageProject)obj;
