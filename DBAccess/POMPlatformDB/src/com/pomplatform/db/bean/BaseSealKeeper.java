...
public class BaseSealKeeper extends GenericBase implements BaseFactory<BaseSealKeeper>, Comparable<BaseSealKeeper> 
{


	public static BaseSealKeeper newInstance(){
		return new BaseSealKeeper();
	}

	@Override
	public BaseSealKeeper make(){
	...
	public final static java.lang.String ALL_CAPTIONS = "id,印章名称,保管员,创建时间,操作人,删除标志 0未删除 1已删除,公司,数量,印章类型,备注";
	...
	public void cloneCopy(BaseSealKeeper __bean){
	...
	@Override
	public int compareTo(BaseSealKeeper o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSealKeeper o = (BaseSealKeeper)obj;
