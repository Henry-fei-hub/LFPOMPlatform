...
public class BasePoolManage extends GenericBase implements BaseFactory<BasePoolManage>, Comparable<BasePoolManage> 
{


	public static BasePoolManage newInstance(){
		return new BasePoolManage();
	}

	@Override
	public BasePoolManage make(){
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,池子名称,地区id,业态,池子类型对应字典表234,备注";
	...
	public void cloneCopy(BasePoolManage __bean){
	...
	@Override
	public int compareTo(BasePoolManage o) {
	...
	public boolean equals(Object obj) {
		...
		final BasePoolManage o = (BasePoolManage)obj;
