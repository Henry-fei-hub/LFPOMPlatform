...
public class BasePreProject extends GenericBase implements BaseFactory<BasePreProject>, Comparable<BasePreProject> 
{


	public static BasePreProject newInstance(){
		return new BasePreProject();
	}

	@Override
	public BasePreProject make(){
	...
	public void cloneCopy(BasePreProject __bean){
	...
	@Override
	public int compareTo(BasePreProject o) {
	...
	public boolean equals(Object obj) {
		...
		final BasePreProject o = (BasePreProject)obj;
