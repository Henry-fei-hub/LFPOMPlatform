...
public class BaseTrainingManagementDetail extends GenericBase implements BaseFactory<BaseTrainingManagementDetail>, Comparable<BaseTrainingManagementDetail> 
{


	public static BaseTrainingManagementDetail newInstance(){
		return new BaseTrainingManagementDetail();
	}

	@Override
	public BaseTrainingManagementDetail make(){
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,培训管理编码,签到时间,签退时间,是否签退(0签退2没有签退),签到人编码,签到人工号,部门编码,培训内容得分,培训方式得分,培训频率选择(1每月2每季3半年4每年),培训时长(1半个小时21到2个小时33到4个小时4一天),是否接受业余时间培训(1是2否3看课程),建议,课程评价,指导作用";
	...
	public void cloneCopy(BaseTrainingManagementDetail __bean){
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		sb.append(getSignOutFlag() == null ? "" : getSignOutFlag());
		sb.append(",");
	...
	@Override
	public int compareTo(BaseTrainingManagementDetail o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseTrainingManagementDetail o = (BaseTrainingManagementDetail)obj;
