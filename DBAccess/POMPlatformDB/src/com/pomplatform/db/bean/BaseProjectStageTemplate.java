...
public class BaseProjectStageTemplate extends GenericBase implements BaseFactory<BaseProjectStageTemplate>, Comparable<BaseProjectStageTemplate> 
{


	public static BaseProjectStageTemplate newInstance(){
		return new BaseProjectStageTemplate();
	}

	@Override
	public BaseProjectStageTemplate make(){
	...
	public void cloneCopy(BaseProjectStageTemplate __bean){
	...
	@Override
	public int compareTo(BaseProjectStageTemplate o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseProjectStageTemplate o = (BaseProjectStageTemplate)obj;
