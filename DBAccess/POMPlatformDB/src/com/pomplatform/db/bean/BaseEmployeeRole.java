...
public class BaseEmployeeRole extends GenericBase implements BaseFactory<BaseEmployeeRole>, Comparable<BaseEmployeeRole> 
{
	...
	public boolean equals(Object obj) {
		...
		if(!Objects.equals(this.__employee_role_id, o.getEmployeeRoleId())) return false;
	...
	public java.lang.String toJSONString() {
		...
		StringBuilder sb = new StringBuilder();
		int count = 0;
		if(getEmployeeRoleId() != null) sb.append(__wrapNumber(count++, "employeeRoleId", getEmployeeRoleId()));
	...
	public void setDataFromMap(Map<String, Object> values){
		Object val;
		if((val = values.get("employeeRoleId")) != null) setEmployeeRoleId(__getInt(val)); 
