...
public class BaseAttachmentManage extends GenericBase implements BaseFactory<BaseAttachmentManage>, Comparable<BaseAttachmentManage>
{


	public static BaseAttachmentManage newInstance(){
		return new BaseAttachmentManage();
	}

	@Override
	public BaseAttachmentManage make(){
	...
	public final static java.lang.String CS_CONFIRMATION_LETTER = "confirmation_letter" ;

	public final static java.lang.String ALL_CAPTIONS = "主键编码,合同编码,编号,附件名称,附件路径,专业备注,金额,回款金额,收款确认,收款阶段描述,序列号(生成编号的序号),记录日期,操作人,操作时间,备注,0/1 是/否删除,项目负责人,负责部门,大项目负责人,流程主表编码,是否有凭证,财务备注，用来记录回款不全的原因,本月可能回款,确认函是否回收";
	...
	public java.lang.Boolean getCanReceivedPayment() {
		return this.__can_received_payment;
	}
	...
	public void cloneCopy(BaseAttachmentManage __bean){
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		sb.append(getFinanceRemark() == null ? "" : getFinanceRemark());
		sb.append(",");
		sb.append(getCanReceivedPayment() == null ? "" : getCanReceivedPayment());
		sb.append(",");
	...
	@Override
	public int compareTo(BaseAttachmentManage o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseAttachmentManage o = (BaseAttachmentManage)obj;
	...
	public Map<String, Object> toMap() {
		...
		if(getSuperProjectManageId() != null) res.put("superProjectManageId", getSuperProjectManageId());
		...
		if(getFinanceRemark() != null) res.put("financeRemark", getFinanceRemark());
		if(getCanReceivedPayment() != null) res.put("canReceivedPayment", getCanReceivedPayment());
