...
public class BaseTargetRecord extends GenericBase implements BaseFactory<BaseTargetRecord>, Comparable<BaseTargetRecord> 
{


	public static BaseTargetRecord newInstance(){
		return new BaseTargetRecord();
	}

	@Override
	public BaseTargetRecord make(){
	...
	public final static java.lang.String ALL_CAPTIONS = "编码,条线类型,年份,月份,指标,指标（万）,1营收 2现金流,备注,操作日期";
	...
	public void cloneCopy(BaseTargetRecord __bean){
	...
	@Override
	public int compareTo(BaseTargetRecord o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseTargetRecord o = (BaseTargetRecord)obj;
