...
public class SystemLogHandler implements GenericDao {
	...
	public static boolean isSystemLogExists( com.pomplatform.db.bean.BaseSystemLog bean, String additional ) throws Exception {
	...
	public static int countSystemLog( com.pomplatform.db.bean.BaseSystemLog bean, String additional ) throws Exception {
	...
	public static BaseCollection<BaseSystemLog> querySystemLog( com.pomplatform.db.bean.BaseSystemLog bean, int pageNo, int pageLines, String additionalCondition ) throws Exception {
		SystemLog dao = new SystemLog();
		setConditions(bean, dao);
