...
public class SystemProcessPooledTaskHandler implements GenericDao {
	...
	public static boolean isSystemProcessPooledTaskExists( com.pomplatform.db.bean.BaseSystemProcessPooledTask bean, String additional ) throws Exception {
	...
	public static int countSystemProcessPooledTask( com.pomplatform.db.bean.BaseSystemProcessPooledTask bean, String additional ) throws Exception {
	...
	public static BaseCollection<BaseSystemProcessPooledTask> querySystemProcessPooledTask( com.pomplatform.db.bean.BaseSystemProcessPooledTask bean, int pageNo, int pageLines, String additionalCondition ) throws Exception {
		SystemProcessPooledTask dao = new SystemProcessPooledTask();
		setConditions(bean, dao);
