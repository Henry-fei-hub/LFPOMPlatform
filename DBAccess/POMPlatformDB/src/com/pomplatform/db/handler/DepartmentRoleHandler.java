...
import com.pomplatform.db.bean.BaseDepartmentRole;
...
public class DepartmentRoleHandler implements GenericDao {
	...
	public static boolean isDepartmentRoleExists( com.pomplatform.db.bean.BaseDepartmentRole bean, String additional ) throws Exception {
	...
	public static int countDepartmentRole( com.pomplatform.db.bean.BaseDepartmentRole bean, String additional ) throws Exception {
	...
	public static BaseCollection<BaseDepartmentRole> queryDepartmentRole( com.pomplatform.db.bean.BaseDepartmentRole bean, int pageNo, int pageLines, String additionalCondition ) throws Exception {
		DepartmentRole dao = new DepartmentRole();
		setConditions(bean, dao);
