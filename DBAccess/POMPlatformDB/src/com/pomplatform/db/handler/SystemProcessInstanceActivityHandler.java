...
public class SystemProcessInstanceActivityHandler implements GenericDao {
	...
	public static boolean isSystemProcessInstanceActivityExists( com.pomplatform.db.bean.BaseSystemProcessInstanceActivity bean, String additional ) throws Exception {
	...
	public static int countSystemProcessInstanceActivity( com.pomplatform.db.bean.BaseSystemProcessInstanceActivity bean, String additional ) throws Exception {
	...
	public static BaseCollection<BaseSystemProcessInstanceActivity> querySystemProcessInstanceActivity( com.pomplatform.db.bean.BaseSystemProcessInstanceActivity bean, int pageNo, int pageLines, String additionalCondition ) throws Exception {
		SystemProcessInstanceActivity dao = new SystemProcessInstanceActivity();
		setConditions(bean, dao);
