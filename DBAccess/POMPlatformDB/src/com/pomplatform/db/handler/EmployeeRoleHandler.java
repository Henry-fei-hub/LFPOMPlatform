...
public class EmployeeRoleHandler implements GenericDao {
	...
	public static boolean isEmployeeRoleExists( com.pomplatform.db.bean.BaseEmployeeRole bean, String additional ) throws Exception {
	...
	public static int countEmployeeRole( com.pomplatform.db.bean.BaseEmployeeRole bean, String additional ) throws Exception {
	...
	public static BaseCollection<BaseEmployeeRole> queryEmployeeRole( com.pomplatform.db.bean.BaseEmployeeRole bean, int pageNo, int pageLines, String additionalCondition ) throws Exception {
		EmployeeRole dao = new EmployeeRole();
		setConditions(bean, dao);
