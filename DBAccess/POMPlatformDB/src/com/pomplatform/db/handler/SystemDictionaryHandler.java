...
public class SystemDictionaryHandler implements GenericDao {
	...
	public static boolean isSystemDictionaryExists( com.pomplatform.db.bean.BaseSystemDictionary bean, String additional ) throws Exception {
	...
	public static int countSystemDictionary( com.pomplatform.db.bean.BaseSystemDictionary bean, String additional ) throws Exception {
	...
	public static BaseCollection<BaseSystemDictionary> querySystemDictionary( com.pomplatform.db.bean.BaseSystemDictionary bean, int pageNo, int pageLines, String additionalCondition ) throws Exception {
		SystemDictionary dao = new SystemDictionary();
		setConditions(bean, dao);
