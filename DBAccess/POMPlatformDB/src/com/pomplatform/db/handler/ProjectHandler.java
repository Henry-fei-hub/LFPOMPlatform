...
public class ProjectHandler implements GenericDao {
	...
	public static boolean isProjectExists( com.pomplatform.db.bean.BaseProject bean, String additional ) throws Exception {
	...
	public static int countProject( com.pomplatform.db.bean.BaseProject bean, String additional ) throws Exception {
	...
	public static BaseCollection<BaseProject> queryProject( com.pomplatform.db.bean.BaseProject bean, int pageNo, int pageLines, String additionalCondition ) throws Exception {
		Project dao = new Project();
		setConditions(bean, dao);
	...
	public static int setDeleteConditions(BaseProject bean, Project dao){
		...
		if(!foundKey) {
			...
			if(bean.getRevenuePlateId() != null) {
				dao.setConditionRevenuePlateId("=", bean.getRevenuePlateId());
				count++;
			}
			...
			if(bean.getIsEcmcProject() != null) {
				dao.setConditionIsEcmcProject("=", bean.getIsEcmcProject());
				count++;
			}
			if(bean.getProjectSetupFlag() != null) {
				dao.setConditionProjectSetupFlag("=", bean.getProjectSetupFlag());
				count++;
			}
			...
			if(bean.getTimeCycle() != null) {
				dao.setConditionTimeCycle("=", bean.getTimeCycle());
				count++;
			}
			...
			if(bean.getPricingType() != null) {
				dao.setConditionPricingType("=", bean.getPricingType());
				count++;
			}
			if(bean.getIsHasPrice() != null) {
				dao.setConditionIsHasPrice("=", bean.getIsHasPrice());
				count++;
			}
		}
		return count;
	...
	public static int setConditions(BaseProject bean, Project dao){
		...
		if(bean.getCommissionRate() != null) {
			dao.setConditionCommissionRate("=", bean.getCommissionRate());
			count++;
		}
		return count;
	}
