...
import com.pomplatform.db.bean.BaseMainFunction;
import com.pomplatform.db.dao.MainFunction;
...
public class MainFunctionHandler implements GenericDao {
	...
	public static boolean isMainFunctionExists( com.pomplatform.db.bean.BaseMainFunction bean, String additional ) throws Exception {
	...
	public static int countMainFunction( com.pomplatform.db.bean.BaseMainFunction bean, String additional ) throws Exception {
	...
	public static BaseCollection<BaseMainFunction> queryMainFunction( com.pomplatform.db.bean.BaseMainFunction bean, int pageNo, int pageLines, String additionalCondition ) throws Exception {
		MainFunction dao = new MainFunction();
		setConditions(bean, dao);
