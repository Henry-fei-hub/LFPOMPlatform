...
public class RoleFunctionHandler implements GenericDao {
	...
	public static boolean isRoleFunctionExists( com.pomplatform.db.bean.BaseRoleFunction bean, String additional ) throws Exception {
	...
	public static int countRoleFunction( com.pomplatform.db.bean.BaseRoleFunction bean, String additional ) throws Exception {
	...
	public static BaseCollection<BaseRoleFunction> queryRoleFunction( com.pomplatform.db.bean.BaseRoleFunction bean, int pageNo, int pageLines, String additionalCondition ) throws Exception {
		RoleFunction dao = new RoleFunction();
		setConditions(bean, dao);
