...
public class RoleHandler implements GenericDao {
	...
	public static boolean isRoleExists( com.pomplatform.db.bean.BaseRole bean, String additional ) throws Exception {
	...
	public static int countRole( com.pomplatform.db.bean.BaseRole bean, String additional ) throws Exception {
	...
	public static BaseCollection<BaseRole> queryRole( com.pomplatform.db.bean.BaseRole bean, int pageNo, int pageLines, String additionalCondition ) throws Exception {
		Role dao = new Role();
		setConditions(bean, dao);
