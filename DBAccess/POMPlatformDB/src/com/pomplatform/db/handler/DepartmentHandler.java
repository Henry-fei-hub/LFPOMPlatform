...
public class DepartmentHandler implements GenericDao {
	...
	public static boolean isDepartmentExists( com.pomplatform.db.bean.BaseDepartment bean, String additional ) throws Exception {
	...
	public static int countDepartment( com.pomplatform.db.bean.BaseDepartment bean, String additional ) throws Exception {
	...
	public static BaseCollection<BaseDepartment> queryDepartment( com.pomplatform.db.bean.BaseDepartment bean, int pageNo, int pageLines, String additionalCondition ) throws Exception {
		Department dao = new Department();
		setConditions(bean, dao);
