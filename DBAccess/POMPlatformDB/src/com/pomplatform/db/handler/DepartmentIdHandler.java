...
public class DepartmentIdHandler implements GenericDao {
	...
	public static boolean isDepartmentIdExists( BaseDepartmentId bean, String additional ) throws Exception {
	...
	public static int countDepartmentId( BaseDepartmentId bean, String additional ) throws Exception {
	...
	public static BaseCollection<BaseDepartmentId> queryDepartmentId( BaseDepartmentId bean, int pageNo, int pageLines, String additionalCondition ) throws Exception {
		DepartmentId dao = new DepartmentId();
		setConditions(bean, dao);
