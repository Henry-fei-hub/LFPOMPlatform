...
public class Function extends AbstractTable<BaseFunction>
{
	...
	protected final void initColumnNames()  throws java.sql.SQLException {
		...
		__column_names[8] = BaseFunction.CS_FUNCTION_STATIC_NAME;
		__column_names[9] = BaseFunction.CS_SECURITY_LEVEL;
		__column_names[10] = BaseFunction.CS_RISK_TIP;
	...
	public void setDataToBase(BaseFunction b){
		...
		if((val = __current_data[count++]) != null) b.setSecurityLevel(GenericBase.__getInt(val));
		if((val = __current_data[count++]) != null) b.setRiskTip(GenericBase.__getString(val));
	}
	...
	public void setBaseToBuffer(BaseFunction b, Object[] buff){
		...
		buff[count++] = b.getSecurityLevel();
		buff[count++] = b.getRiskTip();
	}
	...
	public void setDataFromBase(BaseFunction b){
		...
		if(b.getSecurityLevel() != null) setSecurityLevel(b.getSecurityLevel());
		if(b.getRiskTip() != null) setRiskTip(b.getRiskTip());
	}
	...
	public void setQueryResultToBase(BaseFunction __base, java.sql.ResultSet sdr ) throws java.sql.SQLException {
		...
		if(__select_flags[index++] && count <= columnCount && (val = sdr.getObject(count++)) != null) __base.setSecurityLevel(GenericBase.__getInt(val));
		if(__select_flags[index++] && count <= columnCount && (val = sdr.getObject(count++)) != null) __base.setRiskTip(GenericBase.__getString(val));
	}
	...
	public void setSecurityLevel(java.lang.Integer val) {
	...
	public void setRiskTip(java.lang.String val) {
	...
	public void setConditionSecurityLevel(String op, java.lang.Integer val) {
		setConditionSecurityLevel(op, val, CONDITION_AND);
	}

	public void setConditionSecurityLevel(String op, java.lang.Integer val, String relation) {
		addCondition(9, op, relation, val);
	}

	public void setSelectSecurityLevel(boolean val) {
		__select_flags[9] = val;
	}

	public void setConditionRiskTip(String op, java.lang.String val) {
		setConditionRiskTip(op, val, CONDITION_AND);
	}

	public void setConditionRiskTip(String op, java.lang.String val, String relation) {
		addCondition(10, op, relation, val);
	}

	public void setSelectRiskTip(boolean val) {
