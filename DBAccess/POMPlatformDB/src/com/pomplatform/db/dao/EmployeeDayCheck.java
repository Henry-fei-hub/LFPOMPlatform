...
public class EmployeeDayCheck extends AbstractTable<BaseEmployeeDayCheck>
{

	public EmployeeDayCheck() throws java.sql.SQLException 
	{
	...
	protected final void initColumnNames()  throws java.sql.SQLException {
		...
		__tableName            = "employee_day_checks";

		__key_columns          = new int[1];
		__key_columns[0] = 0;

		__column_names[0] = BaseEmployeeDayCheck.CS_EMPLOYEE_DAY_CHECK_ID;
		__column_names[1] = BaseEmployeeDayCheck.CS_EMPLOYEE_ID;
		__column_names[2] = BaseEmployeeDayCheck.CS_YEAR;
		__column_names[3] = BaseEmployeeDayCheck.CS_MONTH;
		__column_names[4] = BaseEmployeeDayCheck.CS_RECORD_DATE;
		__column_names[5] = BaseEmployeeDayCheck.CS_SHIFT_MANAGE_ID;
		__column_names[6] = BaseEmployeeDayCheck.CS_CHECKIN;
		__column_names[7] = BaseEmployeeDayCheck.CS_CHECKOUT;
		__column_names[8] = BaseEmployeeDayCheck.CS_LATE_LEAVE_5M;
		__column_names[9] = BaseEmployeeDayCheck.CS_LATE_LEAVE_10M;
		__column_names[10] = BaseEmployeeDayCheck.CS_LATE_LEAVE_30M;
		__column_names[11] = BaseEmployeeDayCheck.CS_LATE_LEAVE;
		__column_names[12] = BaseEmployeeDayCheck.CS_THING_LEAVE_TIMES;
		__column_names[13] = BaseEmployeeDayCheck.CS_THING_LEAVE_HOURS;
		__column_names[14] = BaseEmployeeDayCheck.CS_THING_LEAVE_DAYS;
		__column_names[15] = BaseEmployeeDayCheck.CS_ILL_LEAVE_TIMES;
		__column_names[16] = BaseEmployeeDayCheck.CS_ILL_LEAVE_HOURS;
		__column_names[17] = BaseEmployeeDayCheck.CS_ILL_LEAVE_DAYS;
		__column_names[18] = BaseEmployeeDayCheck.CS_OTHER_LEAVE_TIMES;
		__column_names[19] = BaseEmployeeDayCheck.CS_OTHER_LEAVE_HOURS;
		__column_names[20] = BaseEmployeeDayCheck.CS_OTHER_LEAVE_DAYS;
		__column_names[21] = BaseEmployeeDayCheck.CS_NORNAL_OVERTIME_HOURS;
		__column_names[22] = BaseEmployeeDayCheck.CS_WEEKEND_OVERTIME_HOURS;
		__column_names[23] = BaseEmployeeDayCheck.CS_HOLIDAY_OVERTIME_HOURS;
		__column_names[24] = BaseEmployeeDayCheck.CS_ABSENCE_DAYS;
		__column_names[25] = BaseEmployeeDayCheck.CS_SHOULD_DAYS;
		__column_names[26] = BaseEmployeeDayCheck.CS_FACT_DAYS;
		__column_names[27] = BaseEmployeeDayCheck.CS_STATUS;
		__column_names[28] = BaseEmployeeDayCheck.CS_OPERATE_EMPLOYEE_ID;
		__column_names[29] = BaseEmployeeDayCheck.CS_OPERATE_TIME;
		__column_names[30] = BaseEmployeeDayCheck.CS_REMARK;
		__column_names[31] = BaseEmployeeDayCheck.CS_IS_LOCKED;
		__column_names[32] = BaseEmployeeDayCheck.CS_NUMBER_OF_LATE;
		__column_names[33] = BaseEmployeeDayCheck.CS_LATE_FOR_MINUTES;
		__column_names[34] = BaseEmployeeDayCheck.CS_NUMBER_OF_LEAVE;
		__column_names[35] = BaseEmployeeDayCheck.CS_LEAVE_FOR_MINUTES;
		__column_names[36] = BaseEmployeeDayCheck.CS_LATE_CHARGE;
		__column_names[37] = BaseEmployeeDayCheck.CS_ADJUST;
		__column_names[38] = BaseEmployeeDayCheck.CS_ANNUAL_LEAVE;
		__column_names[39] = BaseEmployeeDayCheck.CS_WEDDING_LEAVE;
		__column_names[40] = BaseEmployeeDayCheck.CS_MATERNITY_LEAVE;
		__column_names[41] = BaseEmployeeDayCheck.CS_PRENATAL_CHECK_LEAVE;
		__column_names[42] = BaseEmployeeDayCheck.CS_MATERNITY_LEAVE_DAYS;
		__column_names[43] = BaseEmployeeDayCheck.CS_FUNERAL_LEAVE;
		__column_names[44] = BaseEmployeeDayCheck.CS_OUT_FOR_BUSINESS;
		__column_names[45] = BaseEmployeeDayCheck.CS_OVERTIME_PAY;
		__column_names[46] = BaseEmployeeDayCheck.CS_OVERTIME_PAY_SUB;
		__column_names[47] = BaseEmployeeDayCheck.CS_OVERTIME_PAY_SUB_BEFORE;
		__column_names[48] = BaseEmployeeDayCheck.CS_OVERTIME_PAY_BEFORE;
	...
	public void setPrimaryKeyFromBase(BaseEmployeeDayCheck b) {
		clear();
		setEmployeeDayCheckIdClear(b.getEmployeeDayCheckId());
	}

	public boolean isPrimaryKeyNull() {
		return getEmployeeDayCheckId() == null;
	}

	@Override
	public BaseEmployeeDayCheck generateBase(){
		BaseEmployeeDayCheck b = new BaseEmployeeDayCheck();
		setDataToBase(b);
		return b;
	}

	@Override
	public void setDataToBase(BaseEmployeeDayCheck b){
		int count = 0; Object val;
		if((val = __current_data[count++]) != null) b.setEmployeeDayCheckId(GenericBase.__getInt(val));
		...
		if((val = __current_data[count++]) != null) b.setCheckin(GenericBase.__getDateFromSQL(val));
		if((val = __current_data[count++]) != null) b.setCheckout(GenericBase.__getDateFromSQL(val));
	...
	public void setDataFromCSV(String csvLine, String names){
		...
		if((num = __inputNames[count++]) != null) {
			val = values[num];
			if(val != null && !val.isEmpty()) setEmployeeDayCheckId(GenericBase.__getInt(val));
		}
		if((num = __inputNames[count++]) != null) {
			val = values[num];
		...
		if((num = __inputNames[count++]) != null) {
			val = values[num];
			if(val != null && !val.isEmpty()) setShiftManageId(GenericBase.__getInt(val));
		}
		if((num = __inputNames[count++]) != null) {
			val = values[num];
			if(val != null && !val.isEmpty()) setCheckin(GenericBase.__getDate(val));
		}
		if((num = __inputNames[count++]) != null) {
			val = values[num];
			if(val != null && !val.isEmpty()) setCheckout(GenericBase.__getDate(val));
		}
		if((num = __inputNames[count++]) != null) {
			val = values[num];
	...
	@Override
	public void setBaseToBuffer(BaseEmployeeDayCheck b, Object[] buff){
		int count = 0;
		buff[count++] = b.getEmployeeDayCheckId();
		...
		buff[count++] = generateTimestampFromDate(b.getCheckin());
		buff[count++] = generateTimestampFromDate(b.getCheckout());
	...
	@Override
	public void setDataFromBase(BaseEmployeeDayCheck b){
		if(b.getEmployeeDayCheckId() != null) setEmployeeDayCheckIdClear(b.getEmployeeDayCheckId());
		...
		if(b.getCheckin() != null) setCheckin(b.getCheckin());
		if(b.getCheckout() != null) setCheckout(b.getCheckout());
	...
	@Override
	public BaseEmployeeDayCheck generateBaseFromResultSet(java.sql.ResultSet sdr)  throws java.sql.SQLException {
	...
	@Override
	public void setQueryResultToBase(BaseEmployeeDayCheck __base, java.sql.ResultSet sdr ) throws java.sql.SQLException {
		int count = 1, index = 0;
		java.sql.ResultSetMetaData rsmd = sdr.getMetaData();
		int columnCount = rsmd.getColumnCount();
		Object val;
		if(__select_flags[index++] && count <= columnCount && (val = sdr.getObject(count++)) != null) __base.setEmployeeDayCheckId(GenericBase.__getInt(val));
		...
		if(__select_flags[index++] && count <= columnCount && (val = sdr.getObject(count++)) != null) __base.setCheckin(GenericBase.__getDateFromSQL(val));
		if(__select_flags[index++] && count <= columnCount && (val = sdr.getObject(count++)) != null) __base.setCheckout(GenericBase.__getDateFromSQL(val));
	...
	public void setEmployeeDayCheckId(java.lang.Integer val) {
	...
	public void setEmployeeDayCheckIdClear(java.lang.Integer val) {
	...
	public void setCheckin(java.util.Date val) {
	...
	public void setCheckout(java.util.Date val) {
	...
	public java.lang.Boolean getIsLocked() {
		return GenericBase.__getBoolean(__current_data[31]);
	}
	...
	public void setConditionEmployeeDayCheckId(String op, java.lang.Integer val) {
		setConditionEmployeeDayCheckId(op, val, CONDITION_AND);
	}

	public void setConditionEmployeeDayCheckId(String op, java.lang.Integer val, String relation) {
		addCondition(0, op, relation, val);
	}

	public void setSelectEmployeeDayCheckId(boolean val) {
		__select_flags[0] = val;
	}

	public void setEmployeeDayCheckIdExpression(String val) {
	...
	public void setShiftManageIdExpression(String val) {
		__dataExpressions[5] = val;
	}

	public void setConditionCheckin(String op, java.util.Date val) {
		setConditionCheckin(op, val, CONDITION_AND);
	}

	public void setConditionCheckin(String op, java.util.Date val, String relation) {
		addCondition(6, op, relation, generateTimestampFromDate(val));
	}

	public void setSelectCheckin(boolean val) {
		__select_flags[6] = val;
	}

	public void setCheckinExpression(String val) {
		__dataExpressions[6] = val;
	}

	public void setConditionCheckout(String op, java.util.Date val) {
		setConditionCheckout(op, val, CONDITION_AND);
	}

	public void setConditionCheckout(String op, java.util.Date val, String relation) {
		addCondition(7, op, relation, generateTimestampFromDate(val));
	}

	public void setSelectCheckout(boolean val) {
		__select_flags[7] = val;
	}

	public void setCheckoutExpression(String val) {
