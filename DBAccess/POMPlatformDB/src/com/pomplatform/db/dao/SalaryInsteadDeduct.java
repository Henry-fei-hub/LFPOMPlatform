...
public class SalaryInsteadDeduct extends AbstractTable<BaseSalaryInsteadDeduct>
{

	public SalaryInsteadDeduct() throws java.sql.SQLException 
	{
	...
	protected final void initColumnNames()  throws java.sql.SQLException {
		...
		__tableName            = "salary_instead_deducts";

		__key_columns          = new int[1];
		__key_columns[0] = 0;

		__column_names[0] = BaseSalaryInsteadDeduct.CS_SALARY_INSTEAD_DEDUCT_ID;
		__column_names[1] = BaseSalaryInsteadDeduct.CS_EMPLOYEE_ID;
		__column_names[2] = BaseSalaryInsteadDeduct.CS_YEAR;
		__column_names[3] = BaseSalaryInsteadDeduct.CS_MONTH;
		__column_names[4] = BaseSalaryInsteadDeduct.CS_RECORD_DATE;
		__column_names[5] = BaseSalaryInsteadDeduct.CS_INSTEAD_DEDUCT;
		__column_names[6] = BaseSalaryInsteadDeduct.CS_IS_SENDED;
		__column_names[7] = BaseSalaryInsteadDeduct.CS_OPERATE_EMPLOYEE_ID;
		__column_names[8] = BaseSalaryInsteadDeduct.CS_OPERATE_TIME;
		__column_names[9] = BaseSalaryInsteadDeduct.CS_REMARK;
	...
	public void setPrimaryKeyFromBase(BaseSalaryInsteadDeduct b) {
		clear();
		setSalaryInsteadDeductIdClear(b.getSalaryInsteadDeductId());
	}

	public boolean isPrimaryKeyNull() {
		return getSalaryInsteadDeductId() == null;
	}

	@Override
	public BaseSalaryInsteadDeduct generateBase(){
	...
	@Override
	public void setDataToBase(BaseSalaryInsteadDeduct b){
		int count = 0; Object val;
		if((val = __current_data[count++]) != null) b.setSalaryInsteadDeductId(GenericBase.__getInt(val));
	...
	@Override
	public void setBaseToBuffer(BaseSalaryInsteadDeduct b, Object[] buff){
		int count = 0;
		buff[count++] = b.getSalaryInsteadDeductId();
	...
	@Override
	public void setDataFromBase(BaseSalaryInsteadDeduct b){
		if(b.getSalaryInsteadDeductId() != null) setSalaryInsteadDeductIdClear(b.getSalaryInsteadDeductId());
	...
	@Override
	public BaseSalaryInsteadDeduct generateBaseFromResultSet(java.sql.ResultSet sdr)  throws java.sql.SQLException {
	...
	@Override
	public void setQueryResultToBase(BaseSalaryInsteadDeduct __base, java.sql.ResultSet sdr ) throws java.sql.SQLException {
		int count = 1, index = 0;
		java.sql.ResultSetMetaData rsmd = sdr.getMetaData();
		int columnCount = rsmd.getColumnCount();
		Object val;
		if(__select_flags[index++] && count <= columnCount && (val = sdr.getObject(count++)) != null) __base.setSalaryInsteadDeductId(GenericBase.__getInt(val));
	...
	public void setSalaryInsteadDeductId(java.lang.Integer val) {
	...
	public void setSalaryInsteadDeductIdClear(java.lang.Integer val) {
	...
	public void setConditionSalaryInsteadDeductId(String op, java.lang.Integer val) {
		setConditionSalaryInsteadDeductId(op, val, CONDITION_AND);
	}

	public void setConditionSalaryInsteadDeductId(String op, java.lang.Integer val, String relation) {
		addCondition(0, op, relation, val);
	}

	public void setSelectSalaryInsteadDeductId(boolean val) {
