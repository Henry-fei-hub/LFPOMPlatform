...
public class OrderInfo extends AbstractTable<BaseOrderInfo>
{

	public OrderInfo() throws java.sql.SQLException 
	{
	...
	protected final void initColumnNames()  throws java.sql.SQLException {
		...
		__tableName            = "order_info";

		__key_columns          = new int[1];
		__key_columns[0] = 0;

		__column_names[0] = BaseOrderInfo.CS_ORDER_INFO_ID;
		__column_names[1] = BaseOrderInfo.CS_CONTRACT_ID;
		__column_names[2] = BaseOrderInfo.CS_CONTRACT_CODE;
		__column_names[3] = BaseOrderInfo.CS_CONTRACT_NAME;
		__column_names[4] = BaseOrderInfo.CS_CUSTOMER_NAME;
		__column_names[5] = BaseOrderInfo.CS_START_DATE;
		__column_names[6] = BaseOrderInfo.CS_END_DATE;
		__column_names[7] = BaseOrderInfo.CS_STATUS;
		__column_names[8] = BaseOrderInfo.CS_PROJECT_CODE;
		__column_names[9] = BaseOrderInfo.CS_CONTRACT_TYPE;
		__column_names[10] = BaseOrderInfo.CS_PROJECT_LEVEL;
		__column_names[11] = BaseOrderInfo.CS_CONTRACT_PRICE;
		__column_names[12] = BaseOrderInfo.CS_PROJECT_ADDRESS;
		__column_names[13] = BaseOrderInfo.CS_CONTRACT_FOLLOWER;
		__column_names[14] = BaseOrderInfo.CS_REMARK;
		__column_names[15] = BaseOrderInfo.CS_CONTRACT_DATE;
		__column_names[16] = BaseOrderInfo.CS_SIGNING_COMPANY_NAME;
		__column_names[17] = BaseOrderInfo.CS_CREATE_TIME;
		__column_names[18] = BaseOrderInfo.CS_UPDATE_TIME;
		__column_names[19] = BaseOrderInfo.CS_BUSINESS_TYPE;
		__column_names[20] = BaseOrderInfo.CS_FLOW_STATUS;
		__column_names[21] = BaseOrderInfo.CS_SERIAL_NUMBER;
		__column_names[22] = BaseOrderInfo.CS_PROJECT_TYPE;
		__column_names[23] = BaseOrderInfo.CS_COVERED_AREA;
		__column_names[24] = BaseOrderInfo.CS_PROFESSIONAL_COOPERATION;
		__column_names[25] = BaseOrderInfo.CS_PROVINCE;
		__column_names[26] = BaseOrderInfo.CS_CITY;
		__column_names[27] = BaseOrderInfo.CS_DETAIL_ADDRESS;
		__column_names[28] = BaseOrderInfo.CS_CUSTOMER_ADDRESS;
		__column_names[29] = BaseOrderInfo.CS_SERVICE_SUGGEST_BOOK;
		__column_names[30] = BaseOrderInfo.CS_PROJECT_APPROVAL_TIME;
		__column_names[31] = BaseOrderInfo.CS_ORDER_NO;
		__column_names[32] = BaseOrderInfo.CS_INFO_CODE;
		__column_names[33] = BaseOrderInfo.CS_CONTRACT_STATUS;
		__column_names[34] = BaseOrderInfo.CS_CLIENT_CONTRACT_ID;
		__column_names[35] = BaseOrderInfo.CS_IS_FINISH;
		__column_names[36] = BaseOrderInfo.CS_IS_SYSTEM_ADD;
		__column_names[37] = BaseOrderInfo.CS_HAS_OUT_QUOTATIONS;
		__column_names[38] = BaseOrderInfo.CS_FILE_ID;
		__column_names[39] = BaseOrderInfo.CS_FILE_URL;
		__column_names[40] = BaseOrderInfo.CS_TOTAL_PROJECT_TIME;
		__column_names[41] = BaseOrderInfo.CS_DESIGN_AREAS;
		__column_names[42] = BaseOrderInfo.CS_SIGNING_MONEY_SUM;
		__column_names[43] = BaseOrderInfo.CS_HAS_SPLIT_PRICE;
		__column_names[44] = BaseOrderInfo.CS_MAIN_PROJECT_ID;
		__column_names[45] = BaseOrderInfo.CS_OUT_OUTTATION_ID;
		__column_names[46] = BaseOrderInfo.CS_FILE_NAME;
	...
	public void setPrimaryKeyFromBase(BaseOrderInfo b) {
		clear();
		setOrderInfoIdClear(b.getOrderInfoId());
	}

	public boolean isPrimaryKeyNull() {
		return getOrderInfoId() == null;
	}

	@Override
	public BaseOrderInfo generateBase(){
	...
	@Override
	public void setDataToBase(BaseOrderInfo b){
		...
		if((val = __current_data[count++]) != null) b.setStatus(GenericBase.__getString(val));
		if((val = __current_data[count++]) != null) b.setProjectCode(GenericBase.__getString(val));
		if((val = __current_data[count++]) != null) b.setContractType(GenericBase.__getString(val));
		if((val = __current_data[count++]) != null) b.setProjectLevel(GenericBase.__getString(val));
		...
		if((val = __current_data[count++]) != null) b.setOutOuttationId(GenericBase.__getInt(val));
	...
	public void setDataFromCSV(String csvLine, String names){
		...
		if((num = __inputNames[count++]) != null) {
			val = values[num];
			if(val != null && !val.isEmpty()) setStatus(GenericBase.__getString(val));
		}
		if((num = __inputNames[count++]) != null) {
			val = values[num];
		...
		if((num = __inputNames[count++]) != null) {
			val = values[num];
			if(val != null && !val.isEmpty()) setContractType(GenericBase.__getString(val));
		}
		if((num = __inputNames[count++]) != null) {
			val = values[num];
			if(val != null && !val.isEmpty()) setProjectLevel(GenericBase.__getString(val));
		}
		if((num = __inputNames[count++]) != null) {
			val = values[num];
		...
		if((num = __inputNames[count++]) != null) {
			val = values[num];
			if(val != null && !val.isEmpty()) setOutOuttationId(GenericBase.__getInt(val));
		}
		if((num = __inputNames[count++]) != null) {
			val = values[num];
			if(val != null && !val.isEmpty()) setFlieName(GenericBase.__getString(val));
		}
	}

	@Override
	public void setBaseToBuffer(BaseOrderInfo b, Object[] buff){
		int count = 0;
		...
		buff[count++] = b.getOutOuttationId();
		buff[count++] = b.getFileName();
	}

	@Override
	public void setDataFromBase(BaseOrderInfo b){
		if(b.getOrderInfoId() != null) setOrderInfoIdClear(b.getOrderInfoId());
		...
		if(b.getOutOuttationId() != null) setOutOuttationId(b.getOutOuttationId());
		if(b.getFileName() != null) setFlieName(b.getFileName());
	}

	@Override
	public BaseOrderInfo generateBaseFromResultSet(java.sql.ResultSet sdr)  throws java.sql.SQLException {
	...
	@Override
	public void setQueryResultToBase(BaseOrderInfo __base, java.sql.ResultSet sdr ) throws java.sql.SQLException {
		int count = 1, index = 0;
		...
		if(__select_flags[index++] && count <= columnCount && (val = sdr.getObject(count++)) != null) __base.setStatus(GenericBase.__getString(val));
		if(__select_flags[index++] && count <= columnCount && (val = sdr.getObject(count++)) != null) __base.setProjectCode(GenericBase.__getString(val));
		if(__select_flags[index++] && count <= columnCount && (val = sdr.getObject(count++)) != null) __base.setContractType(GenericBase.__getString(val));
		if(__select_flags[index++] && count <= columnCount && (val = sdr.getObject(count++)) != null) __base.setProjectLevel(GenericBase.__getString(val));
		...
		if(__select_flags[index++] && count <= columnCount && (val = sdr.getObject(count++)) != null) __base.setOutOuttationId(GenericBase.__getInt(val));
	...
	public void setOrderInfoIdClear(Integer val) {
	...
	public void setContractType(String val) {
	...
	public void setProjectLevel(String val) {
	...
	public void setProjectAddress(String val) {
	...
	public void setContractFollower(Integer val) {
	...
	public void setSigningCompanyName(Integer val) {
	...
	public void setFlowStatus(Integer val) {
	...
	public void setProjectType(String val) {
	...
	public void setProfessionalCooperation(String val) {
	...
	public void setCustomerAddress(String val) {
	...
	public void setServiceSuggestBook(String val) {
	...
	public void setInfoCode(String val) {
	...
	public void setContractStatus(Integer val) {
	...
	public void setClientContractId(String val) {
	...
	public Boolean getIsFinish() {
		return GenericBase.__getBoolean(__current_data[35]);
	}

	public void setIsSystemAdd(Boolean val) {
	...
	public void setHasOutQuotations(Boolean val) {
	...
	public void setFileId(Integer val) {
	...
	public void setTotalProjectTime(Integer val) {
	...
	public void setHasSplitPrice(Boolean val) {
	...
	public void setMainProjectId(Integer val) {
	...
	public void setOutOuttationId(Integer val) {
	...
	public void setFlieName(String val) {
	...
	public void setConditionCustomerName(String op, String val) {
		setConditionCustomerName(op, val, CONDITION_AND);
	}

	public void setConditionCustomerName(String op, String val, String relation) {
	...
	public void setConditionStatus(String op, String val) {
		setConditionStatus(op, val, CONDITION_AND);
	}

	public void setConditionStatus(String op, String val, String relation) {
	...
	public void setConditionContractType(String op, String val) {
		setConditionContractType(op, val, CONDITION_AND);
	}

	public void setConditionContractType(String op, String val, String relation) {
	...
	public void setConditionProjectLevel(String op, String val) {
		setConditionProjectLevel(op, val, CONDITION_AND);
	}

	public void setConditionProjectLevel(String op, String val, String relation) {
	...
	public void setConditionProjectAddress(String op, String val) {
		setConditionProjectAddress(op, val, CONDITION_AND);
	}

	public void setConditionProjectAddress(String op, String val, String relation) {
	...
	public void setConditionContractFollower(String op, Integer val) {
		setConditionContractFollower(op, val, CONDITION_AND);
	}

	public void setConditionContractFollower(String op, Integer val, String relation) {
	...
	public void setConditionSigningCompanyName(String op, Integer val) {
		setConditionSigningCompanyName(op, val, CONDITION_AND);
	}

	public void setConditionSigningCompanyName(String op, Integer val, String relation) {
	...
	public void setConditionBusinessType(String op, String val) {
		setConditionBusinessType(op, val, CONDITION_AND);
	}

	public void setConditionBusinessType(String op, String val, String relation) {
	...
	public void setConditionFlowStatus(String op, Integer val) {
		setConditionFlowStatus(op, val, CONDITION_AND);
	}

	public void setConditionFlowStatus(String op, Integer val, String relation) {
	...
	public void setConditionSerialNumber(String op, String val) {
		setConditionSerialNumber(op, val, CONDITION_AND);
	}

	public void setConditionSerialNumber(String op, String val, String relation) {
	...
	public void setConditionProjectType(String op, String val) {
		setConditionProjectType(op, val, CONDITION_AND);
	}

	public void setConditionProjectType(String op, String val, String relation) {
	...
	public void setConditionProfessionalCooperation(String op, String val) {
		setConditionProfessionalCooperation(op, val, CONDITION_AND);
	}

	public void setConditionProfessionalCooperation(String op, String val, String relation) {
	...
	public void setConditionProvince(String op, String val) {
		setConditionProvince(op, val, CONDITION_AND);
	}

	public void setConditionProvince(String op, String val, String relation) {
	...
	public void setConditionCity(String op, String val) {
		setConditionCity(op, val, CONDITION_AND);
	}

	public void setConditionCity(String op, String val, String relation) {
	...
	public void setConditionDetailAddress(String op, String val) {
		setConditionDetailAddress(op, val, CONDITION_AND);
	}

	public void setConditionDetailAddress(String op, String val, String relation) {
	...
	public void setConditionCustomerAddress(String op, String val) {
		setConditionCustomerAddress(op, val, CONDITION_AND);
	}

	public void setConditionCustomerAddress(String op, String val, String relation) {
	...
	public void setConditionServiceSuggestBook(String op, String val) {
		setConditionServiceSuggestBook(op, val, CONDITION_AND);
	}

	public void setConditionServiceSuggestBook(String op, String val, String relation) {
	...
	public void setConditionInfoCode(String op, String val) {
		setConditionInfoCode(op, val, CONDITION_AND);
	}

	public void setConditionInfoCode(String op, String val, String relation) {
	...
	public void setConditionContractStatus(String op, Integer val) {
		setConditionContractStatus(op, val, CONDITION_AND);
	}

	public void setConditionContractStatus(String op, Integer val, String relation) {
	...
	public void setConditionClientContractId(String op, String val) {
		setConditionClientContractId(op, val, CONDITION_AND);
	}

	public void setConditionClientContractId(String op, String val, String relation) {
	...
	public void setConditionIsFinish(String op, Boolean val) {
		setConditionIsFinish(op, val, CONDITION_AND);
	}

	public void setConditionIsFinish(String op, Boolean val, String relation) {
	...
	public void setConditionIsSystemAdd(String op, Boolean val) {
		setConditionIsSystemAdd(op, val, CONDITION_AND);
	}

	public void setConditionIsSystemAdd(String op, Boolean val, String relation) {
	...
	public void setConditionHasOutQuotations(String op, Boolean val) {
		setConditionHasOutQuotations(op, val, CONDITION_AND);
	}

	public void setConditionHasOutQuotations(String op, Boolean val, String relation) {
	...
	public void setConditionFileId(String op, Integer val) {
		setConditionFileId(op, val, CONDITION_AND);
	}

	public void setConditionFileId(String op, Integer val, String relation) {
	...
	public void setConditionFileUrl(String op, String val) {
		setConditionFileUrl(op, val, CONDITION_AND);
	}

	public void setConditionFileUrl(String op, String val, String relation) {
	...
	public void setConditionTotalProjectTime(String op, Integer val) {
		setConditionTotalProjectTime(op, val, CONDITION_AND);
	}

	public void setConditionTotalProjectTime(String op, Integer val, String relation) {
	...
	public void setConditionHasSplitPrice(String op, Boolean val) {
		setConditionHasSplitPrice(op, val, CONDITION_AND);
	}

	public void setConditionHasSplitPrice(String op, Boolean val, String relation) {
	...
	public void setConditionMainProjectId(String op, Integer val) {
		setConditionMainProjectId(op, val, CONDITION_AND);
	}

	public void setConditionMainProjectId(String op, Integer val, String relation) {
	...
	public void setConditionOutOuttationId(String op, Integer val) {
		setConditionOutOuttationId(op, val, CONDITION_AND);
	}

	public void setConditionOutOuttationId(String op, Integer val, String relation) {
		addCondition(45, op, relation, val);
	}

	public void setSelectOutOuttationId(boolean val) {
		__select_flags[45] = val;
	}

	public void setOutOuttationIdExpression(String val) {
		__dataExpressions[45] = val;
	}

	public void setConditionFlieName(String op, String val) {
		setConditionFlieName(op, val, CONDITION_AND);
	}

	public void setConditionFlieName(String op, String val, String relation) {
		addCondition(46, op, relation, val);
	}

	public void setSelectFlieName(boolean val) {
		__select_flags[46] = val;
	}

	public void setFlieNameExpression(String val) {
