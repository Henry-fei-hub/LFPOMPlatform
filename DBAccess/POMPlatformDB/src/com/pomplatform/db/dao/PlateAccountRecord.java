...
public class PlateAccountRecord extends AbstractTable<BasePlateAccountRecord>
{

	public PlateAccountRecord() throws java.sql.SQLException 
	{
	...
	protected final void initColumnNames()  throws java.sql.SQLException {
		...
		__tableName            = "plate_account_records";

		__key_columns          = new int[1];
		__key_columns[0] = 0;

		__column_names[0] = BasePlateAccountRecord.CS_PLATE_ACCOUNT_RECORD_ID;
		__column_names[1] = BasePlateAccountRecord.CS_PLATE_ID;
		__column_names[2] = BasePlateAccountRecord.CS_BUSINESS_ID;
		__column_names[3] = BasePlateAccountRecord.CS_BUSINESS_TYPE_ID;
		__column_names[4] = BasePlateAccountRecord.CS_INTEGRAL;
		__column_names[5] = BasePlateAccountRecord.CS_RECORD_DATE;
		__column_names[6] = BasePlateAccountRecord.CS_IS_LOCK;
		__column_names[7] = BasePlateAccountRecord.CS_OPERATE_EMPLOYEE_ID;
		__column_names[8] = BasePlateAccountRecord.CS_OPERATE_TIME;
		__column_names[9] = BasePlateAccountRecord.CS_REMARK;
	...
	public void setPrimaryKeyFromBase(BasePlateAccountRecord b) {
		clear();
		setPlateAccountRecordIdClear(b.getPlateAccountRecordId());
	}

	public boolean isPrimaryKeyNull() {
		return getPlateAccountRecordId() == null;
	}

	@Override
	public BasePlateAccountRecord generateBase(){
		BasePlateAccountRecord b = new BasePlateAccountRecord();
		setDataToBase(b);
		return b;
	}

	@Override
	public void setDataToBase(BasePlateAccountRecord b){
		int count = 0; Object val;
		if((val = __current_data[count++]) != null) b.setPlateAccountRecordId(GenericBase.__getInt(val));
	...
	@Override
	public void setBaseToBuffer(BasePlateAccountRecord b, Object[] buff){
		int count = 0;
		buff[count++] = b.getPlateAccountRecordId();
	...
	@Override
	public void setDataFromBase(BasePlateAccountRecord b){
		if(b.getPlateAccountRecordId() != null) setPlateAccountRecordIdClear(b.getPlateAccountRecordId());
	...
	@Override
	public BasePlateAccountRecord generateBaseFromResultSet(java.sql.ResultSet sdr)  throws java.sql.SQLException {
	...
	@Override
	public void setQueryResultToBase(BasePlateAccountRecord __base, java.sql.ResultSet sdr ) throws java.sql.SQLException {
		int count = 1, index = 0;
		java.sql.ResultSetMetaData rsmd = sdr.getMetaData();
		int columnCount = rsmd.getColumnCount();
		Object val;
		if(__select_flags[index++] && count <= columnCount && (val = sdr.getObject(count++)) != null) __base.setPlateAccountRecordId(GenericBase.__getInt(val));
	...
	public void setPlateAccountRecordId(java.lang.Integer val) {
		setCurrentData(0, val);
	}

	public java.lang.Integer getPlateAccountRecordId() {
		return GenericBase.__getInt(__current_data[0]);
	}

	public void setPlateAccountRecordIdClear(java.lang.Integer val) {
	...
	public void setConditionPlateAccountRecordId(String op, java.lang.Integer val) {
		setConditionPlateAccountRecordId(op, val, CONDITION_AND);
	}

	public void setConditionPlateAccountRecordId(String op, java.lang.Integer val, String relation) {
		addCondition(0, op, relation, val);
	}

	public void setSelectPlateAccountRecordId(boolean val) {
