...
public class PurchaseProductDetail extends AbstractTable<BasePurchaseProductDetail>
{

	public PurchaseProductDetail() throws java.sql.SQLException 
	{
	...
	protected final void initColumnNames()  throws java.sql.SQLException {
		...
		__tableName            = "purchase_product_details";

		__key_columns          = new int[1];
		__key_columns[0] = 0;

		__column_names[0] = BasePurchaseProductDetail.CS_PURCHASE_PRODUCT_DETAIL_ID;
		__column_names[1] = BasePurchaseProductDetail.CS_PERSONNEL_BUSINESS_ID;
		__column_names[2] = BasePurchaseProductDetail.CS_MAIN_PROJECT_ID;
		__column_names[3] = BasePurchaseProductDetail.CS_SUPPLIER_ID;
		__column_names[4] = BasePurchaseProductDetail.CS_PRODUCT_ID;
		__column_names[5] = BasePurchaseProductDetail.CS_PRODUCT_NUMBER;
		__column_names[6] = BasePurchaseProductDetail.CS_PRODUCT_UNIT;
		__column_names[7] = BasePurchaseProductDetail.CS_PRODUCT_PRICE;
		__column_names[8] = BasePurchaseProductDetail.CS_TOTAL_PRICE;
		__column_names[9] = BasePurchaseProductDetail.CS_TAX_POINTS;
		__column_names[10] = BasePurchaseProductDetail.CS_TAX_PRICE;
		__column_names[11] = BasePurchaseProductDetail.CS_FINAL_PRICE;
		__column_names[12] = BasePurchaseProductDetail.CS_PLAN_ARRIVAL_DATE;
		__column_names[13] = BasePurchaseProductDetail.CS_CREATE_EMPLOYEE_ID;
		__column_names[14] = BasePurchaseProductDetail.CS_CREATE_TIME;
		__column_names[15] = BasePurchaseProductDetail.CS_REMARK;
		__column_names[16] = BasePurchaseProductDetail.CS_PURCHASE_CONTRACT_ID;
	...
	public void setPrimaryKeyFromBase(BasePurchaseProductDetail b) {
		clear();
		setPurchaseProductDetailIdClear(b.getPurchaseProductDetailId());
	}

	public boolean isPrimaryKeyNull() {
		return getPurchaseProductDetailId() == null;
	}

	@Override
	public BasePurchaseProductDetail generateBase(){
	...
	@Override
	public void setDataToBase(BasePurchaseProductDetail b){
		int count = 0; Object val;
		if((val = __current_data[count++]) != null) b.setPurchaseProductDetailId(GenericBase.__getInt(val));
	...
	@Override
	public void setBaseToBuffer(BasePurchaseProductDetail b, Object[] buff){
		int count = 0;
		buff[count++] = b.getPurchaseProductDetailId();
	...
	@Override
	public void setDataFromBase(BasePurchaseProductDetail b){
		if(b.getPurchaseProductDetailId() != null) setPurchaseProductDetailIdClear(b.getPurchaseProductDetailId());
	...
	@Override
	public BasePurchaseProductDetail generateBaseFromResultSet(java.sql.ResultSet sdr)  throws java.sql.SQLException {
	...
	@Override
	public void setQueryResultToBase(BasePurchaseProductDetail __base, java.sql.ResultSet sdr ) throws java.sql.SQLException {
		int count = 1, index = 0;
		java.sql.ResultSetMetaData rsmd = sdr.getMetaData();
		int columnCount = rsmd.getColumnCount();
		Object val;
		if(__select_flags[index++] && count <= columnCount && (val = sdr.getObject(count++)) != null) __base.setPurchaseProductDetailId(GenericBase.__getInt(val));
	...
	public void setPurchaseProductDetailId(java.lang.Integer val) {
	...
	public void setPurchaseProductDetailIdClear(java.lang.Integer val) {
	...
	public void setConditionPurchaseProductDetailId(String op, java.lang.Integer val) {
		setConditionPurchaseProductDetailId(op, val, CONDITION_AND);
	}

	public void setConditionPurchaseProductDetailId(String op, java.lang.Integer val, String relation) {
		addCondition(0, op, relation, val);
	}

	public void setSelectPurchaseProductDetailId(boolean val) {
