...
public class AboutProjectQuoteTemplatesParentViewer extends AbstractDetailViewer
{
	...
	public AboutProjectQuoteTemplatesParentViewer() {
	}
	...
	public void load() {
		...
		params.put("projectQuoteTemplatesParentId", getBusinessId());
		DBDataSource.callOperation("NQ_AboutProjectQuoteTemplatesParent", "find", new DSCallback() {
			@Override
