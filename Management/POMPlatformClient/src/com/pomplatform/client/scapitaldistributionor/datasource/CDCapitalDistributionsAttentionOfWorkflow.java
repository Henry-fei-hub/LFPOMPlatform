...
public class CDCapitalDistributionsAttentionOfWorkflow extends DataSource
{


	public static CDCapitalDistributionsAttentionOfWorkflow instance = null;

	public static CDCapitalDistributionsAttentionOfWorkflow getInstance() {
		if(instance == null) {
			instance = new CDCapitalDistributionsAttentionOfWorkflow("CDCapitalDistributionsAttentionOfWorkflow");
		}
		return instance;
	}
	...
	public CDCapitalDistributionsAttentionOfWorkflow(String dataSourceID) {
