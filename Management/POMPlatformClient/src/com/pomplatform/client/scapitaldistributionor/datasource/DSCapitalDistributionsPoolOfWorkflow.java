...
public class DSCapitalDistributionsPoolOfWorkflow extends DBDataSource
{


	public static DSCapitalDistributionsPoolOfWorkflow instance = null;

	public static DSCapitalDistributionsPoolOfWorkflow getInstance() {
		if(instance == null) {
			instance = new DSCapitalDistributionsPoolOfWorkflow("DSCapitalDistributionsPoolOfWorkflow");
		}
		return instance;
	}
	...
	public DSCapitalDistributionsPoolOfWorkflow(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("CapitalDistributionsPoolOfWorkflow");
		...
		setFields(processPooledTaskIdField, businessIdField, businessNameField, processActivityIdField, processIdField, processInstanceIdField, backViewNameField, activityTypeField, nodeTypeField, activityIdField, instanceActivityCreateTimeField, instanceActivityStartTimeField, statusField, processTypeField, departmentIdField, employeeIdField, codeField, companyIdField, titleField, mainProfessionalField, remarkField, contractCodeField, contractChangeAmountField, signingMoneySumField, contractNameField, customerNameField, happenDateField, otherNameField, borrowMoneyField, allBorrowMoneyField, operateTimeField, processCommentField);
	}
