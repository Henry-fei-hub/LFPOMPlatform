...
public class CapitalDistributionsApplyOfWorkflowViewer extends AbstractDetailViewer
{
	...
	public CapitalDistributionsApplyOfWorkflowViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_CapitalDistributionsApplyOfWorkflow", "find", new DSCallback() {
			@Override
