...
public class UpdateScapitaldistributionorWorkflow extends AbstractProcessPanel {
	...
	public boolean checkData(Map data) {
		...
		if(!getProcessName().contains("回款分配")){
			isFrance = true;
		}
		boolean flag = true;
		int i = 0;
	...
	public List<AbstractWizadPage> getPages() {
		...
		ScapitaldistributionorUpdateForm mainInfoPage = new ScapitaldistributionorUpdateForm(this.processName);
		CapitalDistributionDetailCapitalDistributionLinkSubContract capitaldistributionlinksubcontract = new CapitalDistributionDetailCapitalDistributionLinkSubContract(this.processName);
		mainInfoPage.setSubContractGrid(capitaldistributionlinksubcontract.getGrid());
		...
		capitaldistributionlinkdepartment.setMainInfoPage(mainInfoPage);
		...
		capitaldistributionlinksubcontract.setMainInfoPage(mainInfoPage);
