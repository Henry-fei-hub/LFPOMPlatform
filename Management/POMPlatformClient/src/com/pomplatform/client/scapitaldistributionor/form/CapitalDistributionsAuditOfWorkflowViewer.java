...
public class CapitalDistributionsAuditOfWorkflowViewer extends AbstractDetailViewer
{
	...
	public CapitalDistributionsAuditOfWorkflowViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_CapitalDistributionsAuditOfWorkflow", "find", new DSCallback() {
			@Override
