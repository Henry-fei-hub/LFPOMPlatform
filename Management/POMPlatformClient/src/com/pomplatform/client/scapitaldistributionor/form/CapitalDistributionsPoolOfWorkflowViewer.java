...
public class CapitalDistributionsPoolOfWorkflowViewer extends AbstractDetailViewer {

	private SearchForm __parentSearchForm;

	public CapitalDistributionsPoolOfWorkflowViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_CapitalDistributionsPoolOfWorkflow", "find", new DSCallback() {
			@Override
