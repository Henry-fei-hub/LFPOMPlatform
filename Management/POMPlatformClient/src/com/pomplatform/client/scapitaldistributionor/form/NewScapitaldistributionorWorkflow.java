...
public class NewScapitaldistributionorWorkflow extends AbstractProcessPanel {
	...
	public List<AbstractWizadPage> getPages() {
		...
		ScapitaldistributionorNewForm mainInfoPage = new ScapitaldistributionorNewForm();
		CapitalDistributionDetailCapitalDistributionLinkSubContract subContractPanel = new CapitalDistributionDetailCapitalDistributionLinkSubContract("");
		mainInfoPage.setSubContractGrid(subContractPanel.getGrid());
		mainInfoPage.initNewData(getData());
		res.add(mainInfoPage);
		
		CapitalDistributionDetailCapitalDistributionLinkDepartment deparmtmentPanel = new CapitalDistributionDetailCapitalDistributionLinkDepartment();
		deparmtmentPanel.setMainInfoPage(mainInfoPage);
		res.add(deparmtmentPanel);
		
		
		subContractPanel.setMainInfoPage(mainInfoPage);
		res.add(subContractPanel);
		return res;
	}
