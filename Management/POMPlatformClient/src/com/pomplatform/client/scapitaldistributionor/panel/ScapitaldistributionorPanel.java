...
import com.pomplatform.client.scapitaldistributionor.form.NewScapitaldistributionorForm;
import com.pomplatform.client.scapitaldistributionor.form.ScapitaldistributionorSearchForm;
import com.pomplatform.client.scapitaldistributionor.form.ScapitaldistributionorViewer;
import com.pomplatform.client.scapitaldistributionor.form.UpdateScapitaldistributionorForm;
...
public class ScapitaldistributionorPanel extends AbstractSearchPanel {
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			ScapitaldistributionorPanel cm = new ScapitaldistributionorPanel();
			id = cm.getID();
			return cm;
		}
	...
	public void initComponents() {
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateScapitaldistributionorForm detailForm = new UpdateScapitaldistributionorForm();
		...
		operation3Button.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					@Override
					public void onSuccess() {
						NewScapitaldistributionorForm detailForm = new NewScapitaldistributionorForm();
		...
		removeButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				DBDataSource.callOperation("ST_Scapitaldistributionor", "delete", selected.toMap(), new DSCallback() {
					@Override
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("Scapitaldistributionor");
				detail.setWidth100();
				detail.setHeight100();
				ScapitaldistributionorViewer detailForm = new ScapitaldistributionorViewer();
	...
	public SearchForm generateSearchForm() {
		return new ScapitaldistributionorSearchForm();
	}
