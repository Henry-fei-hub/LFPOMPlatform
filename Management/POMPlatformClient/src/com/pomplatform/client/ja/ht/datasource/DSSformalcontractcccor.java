...
public class DSSformalcontractcccor extends DBDataSource
{


	public static DSSformalcontractcccor instance = null;

	public static DSSformalcontractcccor getInstance() {
		if(instance == null) {
			instance = new DSSformalcontractcccor("DSSformalcontractcccor");
		}
		return instance;
	}

	private final DataSourceIntegerField formalContractIdField;
	...
	public DSSformalcontractcccor(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("Sformalcontractcccor");


		formalContractIdField = new DataSourceIntegerField("formalContractId", "正式合同编码");
		formalContractIdField.setLength(11);
		formalContractIdField.setPrimaryKey(true);
		formalContractIdField.setRequired(true);
		formalContractIdField.setHidden(true);
		...
		serviceSuggestBookField = new DataSourceLinkField("serviceSuggestBook", "服务建议书");
		...
		setFields(formalContractIdField, clientContractIdField, contractCodeField, contractNameField, customerNameField, startDateField, endDateField, statusField, projectCodeField, contractTypeField, projectLevelField, totalProjectTimeField, signingMoneySumField, designAreasField, contractPriceField, projectAddressField, contractFollowerField, remarkField, contractDateField, signingCompanyNameField, createTimeField, updateTimeField, businessTypeField, flowStatusField, serialNumberField, projectTypeField, coveredAreaField, professionalCooperationField, provinceField, cityField, detailAddressField, customerAddressField, serviceSuggestBookField, projectApprovalTimeField, orderNoField,infoCodeField);
	}
