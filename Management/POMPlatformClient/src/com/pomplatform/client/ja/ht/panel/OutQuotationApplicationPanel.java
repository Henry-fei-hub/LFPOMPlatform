...
import com.pomplatform.client.ja.ht.form.OutQuotationApplicationSearchForm;
import com.pomplatform.client.ja.ht.form.OutQuotationApplicationViewer;
import com.pomplatform.client.ja.ht.form.NewOutQuotationApplicationForm;
import com.pomplatform.client.ja.ht.form.UpdateOutQuotationApplicationForm;
...
public class OutQuotationApplicationPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			OutQuotationApplicationPanel cm = new OutQuotationApplicationPanel();
			id = cm.getID();
			return cm;
		}
	...
	public void initComponents() {
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						NewOutQuotationApplicationForm detailForm = new NewOutQuotationApplicationForm();
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateOutQuotationApplicationForm detailForm = new UpdateOutQuotationApplicationForm();
		...
		removeButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				DBDataSource.callOperation("ST_OutQuotationApplication", "delete", selected.toMap(), new DSCallback() {
					@Override
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("OutQuotationApplication"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				OutQuotationApplicationViewer detailForm = new OutQuotationApplicationViewer();
	...
	public boolean checkSearchCriteria(Map criteria) {
		criteria.put("addtionalCondition", "order by out_quotation_id");
		return true;
	}
	...
	public SearchForm generateSearchForm() {
		return new OutQuotationApplicationSearchForm();
	}
