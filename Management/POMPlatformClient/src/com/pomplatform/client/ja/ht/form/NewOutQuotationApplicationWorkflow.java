...
public class NewOutQuotationApplicationWorkflow extends AbstractProcessPanel
{
	...
	public List<AbstractWizadPage> getPages(){
		...
		OutQuotationApplicationNewForm outQuotationApplicationNewForm = new OutQuotationApplicationNewForm();
		OutQuotationApplicationDetailOutDesignConsideration outQuotationApplicationDetailOutDesignConsideration = new OutQuotationApplicationDetailOutDesignConsideration();
		outQuotationApplicationNewForm.setRecord(getData());
		outQuotationApplicationDetailOutDesignConsideration.setRecord(getData());
		res.add(outQuotationApplicationNewForm);
		res.add(outQuotationApplicationDetailOutDesignConsideration);
		return res;
	}
