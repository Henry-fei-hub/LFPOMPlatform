...
public class DSOutQuotationApplication extends DBDataSource
{


	public static DSOutQuotationApplication instance = null;

	public static DSOutQuotationApplication getInstance() {
		if(instance == null) {
			instance = new DSOutQuotationApplication("DSOutQuotationApplication");
		}
		return instance;
	}
	...
	public DSOutQuotationApplication(String dataSourceID) {
		...
		setFields(outQuotationIdField, quotationNumberField,newCreateQuotationNameField, quotationNameField, moneySumField, createTimeField, infoCodeField, projectCodeField,contractNameField, businessTypeField, projectTypeField, quotationFilesField, quotationStatusField, disableTypeField, employeeIdField, contractIdField, updateTimeField, detailOutDesignConsideration);
	}
