...
public class OutDesignConsiderationViewer extends AbstractDetailViewer
{




	public OutDesignConsiderationViewer() {
	}
	...
	public void load() {
		...
		params.put("outDesignConsiderationId", getBusinessId());
		DBDataSource.callOperation("ST_OutDesignConsideration", "find", new DSCallback() {
			@Override
