...
public final class UploadServiceFileForm extends PopupWindow implements HasHandlers {

    private static final Logger __logger = Logger.getLogger("");
    private Map<String, Object> params = new HashMap<>();

    public UploadServiceFileForm(final int contractId,final String contractName) {
        super("文件上传");
        setWidth("30%");
        setHeight("26%");
        centerInPage();
...
//                        SC.say("文件上传成功");
        ...
        vertical.setText(1, 0, "合同名称：" + contractName);
        final FileUpload fileUpload = new FileUpload();
        fileUpload.setName("合同附件");
        vertical.setWidget(2, 0, fileUpload);
        vertical.setHTML(3, 0, "<span></span>");
        ...
        button.addClickHandler(new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                ...
                formPanel.setAction(DBDataSource.getServerURL("UP_UploadServiceFiles"));
                formPanel.submit();
            }
        });
    }
