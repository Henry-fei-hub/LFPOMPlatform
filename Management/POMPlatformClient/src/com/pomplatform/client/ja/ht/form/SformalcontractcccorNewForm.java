...
public class SformalcontractcccorNewForm extends AbstractWizadPage
{
	...
	public SformalcontractcccorNewForm(Map<String, Object> map) {
		...
		contractNameItem.setDefaultValue(BaseHelpUtils.getStringValue(map, "projectName"));
		contractNameItem.setWidth("*");
		__formItems.add(contractNameItem);
		
		contractPriceItem = new TextItem("contractPrice", "合同金额");
		contractPriceItem.setDefaultValue(BaseHelpUtils.getStringValue(map, "projectTotalInvestment"));
		contractPriceItem.setWidth("*");
		__formItems.add(contractPriceItem);
		
		coveredAreaItem = new TextItem("coveredArea", "建筑面积(㎡)");
		coveredAreaItem.setDefaultValue(BaseHelpUtils.getStringValue(map, "totalBuildingAreas"));
		coveredAreaItem.setWidth("*");
		__formItems.add(coveredAreaItem);
		
		designAreasItem = new TextItem("designAreas", "计容建筑面积(㎡)");
		designAreasItem.setDefaultValue(BaseHelpUtils.getStringValue(map, "actualDesignAreas"));
		designAreasItem.setWidth("*");
		__formItems.add(designAreasItem);
		
		businessTypeItem = new SelectItem("businessType", "业务类别");
		businessTypeItem.setDefaultValue(BaseHelpUtils.getIntValue(map, "businessType"));
...
//		businessTypeItem.setValueMap(KeyValueManager.getValueMap("production_value_coefficient_type"));
		...
		projectTypeItem.setDefaultValue(BaseHelpUtils.getIntValue(map, "projectType"));
		...
		customerNameItem.setDefaultValue(BaseHelpUtils.getStringValue(map, "customerName"));
		customerNameItem.setWidth("*");
		__formItems.add(customerNameItem);
		
		customerAddressItem = new TextItem("customerAddress", "客户地址");
		customerAddressItem.setDefaultValue(BaseHelpUtils.getStringValue(map, "customerAddress"));
		...
		projectLevelItem.setDefaultValue(BaseHelpUtils.getIntValue(map, "projectLevel"));
		...
		remarkItem.setDefaultValue(BaseHelpUtils.getStringValue(map, "equityedgeRemark"));
		remarkItem.setWidth("*");
		__formItems.add(remarkItem);
		
		serviceSuggestBookItem = new TextItem("serviceSuggestBook", "服务建议书");
		serviceSuggestBookItem.setDefaultValue(BaseHelpUtils.getStringValue(map, "serviceSuggestBook"));
		...
		projectCodeItem.setDefaultValue(BaseHelpUtils.getStringValue(map, "projectCode"));
		...
		signingMoneySumItem.setDefaultValue(BaseHelpUtils.getStringValue(map, "totalMoney"));
		...
		signingCompanyNameItem.setDefaultValue(BaseHelpUtils.getIntValue(map,"signCompany"));
		...
		provinceItem.setDefaultValue(BaseHelpUtils.getStringValue(map, "province"));
		provinceItem.setWidth("*");
		__formItems.add(provinceItem);
		cityItem = new TextItem("city", "城市");
		cityItem.setHidden(true);
		cityItem.setDefaultValue(BaseHelpUtils.getStringValue(map, "city"));
		cityItem.setWidth("*");
		...
		infoCodeItem.setDefaultValue(BaseHelpUtils.getStringValue(map, "infoCode"));
