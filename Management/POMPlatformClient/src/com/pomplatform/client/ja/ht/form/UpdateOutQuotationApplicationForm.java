...
public class UpdateOutQuotationApplicationForm extends GenericWizadWindow
{
	...
	public List<AbstractWizadPage> getPages(){
		...
		res.add(new OutQuotationApplicationUpdateForm());
		...
		outdesignconsideration.setPageMode(AbstractWizadPage.PAGE_MODE_UPDATE);
