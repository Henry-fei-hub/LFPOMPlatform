package com.pomplatform.client.ja.ht2.datasource;
...
public class DSOutDesignConsideration extends DBDataSource
{
	...
	public DSOutDesignConsideration(String dataSourceID) {
		...
		outDesignConsiderationIdField.setHidden(false);
		...
		moneySumField = new DataSourceFloatField("moneySum", "总价(设计面积*设计单价)");
