...
public class SsubcontractssporViewer extends AbstractDetailViewer
{
	...
	public SsubcontractssporViewer() {
	}
	...
	public void load() {
		...
		params.put("subContractId", getBusinessId());
		DBDataSource.callOperation("NQ_Ssubcontractsspor", "find", new DSCallback() {
			@Override
