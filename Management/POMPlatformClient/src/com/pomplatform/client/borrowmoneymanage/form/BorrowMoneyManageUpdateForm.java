...
public class BorrowMoneyManageUpdateForm extends AbstractWizadPage
{

	private final ComboBoxItem employeeIdItem;
	private final TextItem borrowLimitMoneyItem;

	public BorrowMoneyManageUpdateForm() {
	...
	public java.util.Map getValuesAsMap() {
		//设置更新人和时间
		int updateEmployeeId = ClientUtil.getEmployeeId();
		Map param = __form.getValues();
		param.put("updateEmployeeId", updateEmployeeId);
