...
public class BorrowMoneyManageViewer extends AbstractDetailViewer
{
	...
	public BorrowMoneyManageViewer() {
	}
	...
	public void load() {
		...
		params.put("borrowLimitManageId", getBusinessId());
		DBDataSource.callOperation("NQ_BorrowMoneyManage", "find", new DSCallback() {
			@Override
