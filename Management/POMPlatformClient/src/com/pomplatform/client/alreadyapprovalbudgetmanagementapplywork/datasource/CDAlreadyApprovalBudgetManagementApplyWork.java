...
public class CDAlreadyApprovalBudgetManagementApplyWork extends DataSource
{


	public static CDAlreadyApprovalBudgetManagementApplyWork instance = null;

	public static CDAlreadyApprovalBudgetManagementApplyWork getInstance() {
		if(instance == null) {
			instance = new CDAlreadyApprovalBudgetManagementApplyWork("CDAlreadyApprovalBudgetManagementApplyWork");
		}
		return instance;
	}
	...
	public CDAlreadyApprovalBudgetManagementApplyWork(String dataSourceID) {
