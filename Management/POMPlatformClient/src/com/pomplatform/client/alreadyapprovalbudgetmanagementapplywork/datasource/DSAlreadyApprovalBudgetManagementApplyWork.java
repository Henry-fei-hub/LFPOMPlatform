package com.pomplatform.client.alreadyapprovalbudgetmanagementapplywork.datasource;
...
public class DSAlreadyApprovalBudgetManagementApplyWork extends DBDataSource
{


	public static DSAlreadyApprovalBudgetManagementApplyWork instance = null;

	public static DSAlreadyApprovalBudgetManagementApplyWork getInstance() {
		if(instance == null) {
			instance = new DSAlreadyApprovalBudgetManagementApplyWork("DSAlreadyApprovalBudgetManagementApplyWork");
		}
		return instance;
	}
	...
	public DSAlreadyApprovalBudgetManagementApplyWork(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("AlreadyApprovalBudgetManagementApplyWork");
...
//		KeyValueManager.loadValueMap("projects",projectIdField);
		...
		setFields(processInstanceActivityIdField, budgetManagementIdField, businessIdField, businessNameField, processActivityIdField, processIdField, processInstanceIdField, nodeTypeField, activityIdField, nextActivityIdField, mainActivityIdField, instanceActivityCreateTimeField, instanceActivityStartTimeField, bdCodeField, activityTypeField, backViewNameField,  bdTypeField, bdTotalAmountField, bdUseAmountField, bdRestAmountField,  bdApplyTimeField, bdEstimatecloseTimeField, bdStatusField, projectIdField,  inputTaxInvoiceIdField, bdApplyEmployeeIdField,departmentIdField, companyIdField,operateTimeField, processCommentField, statusField,bdRemarkField);
	}
