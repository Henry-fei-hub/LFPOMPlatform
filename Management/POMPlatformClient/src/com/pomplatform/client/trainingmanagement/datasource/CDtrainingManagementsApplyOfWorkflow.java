...
public class CDtrainingManagementsApplyOfWorkflow extends DataSource
{


	public static CDtrainingManagementsApplyOfWorkflow instance = null;

	public static CDtrainingManagementsApplyOfWorkflow getInstance() {
		if(instance == null) {
			instance = new CDtrainingManagementsApplyOfWorkflow("CDtrainingManagementsApplyOfWorkflow");
		}
		return instance;
	}
	...
	public CDtrainingManagementsApplyOfWorkflow(String dataSourceID) {
		...
		setFields(trainingManagementIdField, subjectField, compereTypeField, compereField, employeeIdField, departmentIdField, signInDelayField, signOutDelayField, detailField, createPersonIdField, fileManageIdField, statusField, siteField, plateIdField, isSiteField, trainingTypeField, fileIdField, isSendField, currentPageField, pageLinesField);
