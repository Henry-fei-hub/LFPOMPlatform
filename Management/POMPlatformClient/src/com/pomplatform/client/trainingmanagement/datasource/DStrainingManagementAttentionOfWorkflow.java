...
public class DStrainingManagementAttentionOfWorkflow extends DBDataSource
{


	public static DStrainingManagementAttentionOfWorkflow instance = null;

	public static DStrainingManagementAttentionOfWorkflow getInstance() {
		if(instance == null) {
			instance = new DStrainingManagementAttentionOfWorkflow("DStrainingManagementAttentionOfWorkflow");
		}
		return instance;
	}
	...
	public DStrainingManagementAttentionOfWorkflow(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("trainingManagementAttentionOfWorkflow");
		...
		setFields(systemProcessAttentionIdField, trainingManagementIdField, businessIdField, businessNameField, processActivityIdField, processIdField, processInstanceIdField, backViewNameField, instanceActivityIdField, instanceActivityCreateTimeField, instanceActivityStartTimeField, statusField, processTypeField, operateTimeField, processCommentField, subjectField,startTimeField,endTimeField, compereTypeField, compereField, employeeIdField, departmentIdField, signInDelayField, signOutDelayField, courseScoreField, detailField, createPersonIdField, fileManageIdField, siteField, plateIdField, isSiteField, trainingTypeField, trainingFeeField, fileIdField, fileUrlField, isSendField, plateidsField);
	}
