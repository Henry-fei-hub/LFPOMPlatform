...
public class CDtrainingManagementAuditOfWorkflow extends DataSource
{


	public static CDtrainingManagementAuditOfWorkflow instance = null;

	public static CDtrainingManagementAuditOfWorkflow getInstance() {
		if(instance == null) {
			instance = new CDtrainingManagementAuditOfWorkflow("CDtrainingManagementAuditOfWorkflow");
		}
		return instance;
	}
	...
	public CDtrainingManagementAuditOfWorkflow(String dataSourceID) {
		...
		setFields(employeeIdField, statusField, trainingManagementIdField, subjectField, compereTypeField, compereField, departmentIdField, siteField, plateIdField, isSiteField, trainingTypeField, isSendField, currentPageField, pageLinesField);
