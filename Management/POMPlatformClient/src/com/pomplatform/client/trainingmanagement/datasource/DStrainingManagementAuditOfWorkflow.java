...
public class DStrainingManagementAuditOfWorkflow extends DBDataSource
{


	public static DStrainingManagementAuditOfWorkflow instance = null;

	public static DStrainingManagementAuditOfWorkflow getInstance() {
		if(instance == null) {
			instance = new DStrainingManagementAuditOfWorkflow("DStrainingManagementAuditOfWorkflow");
		}
		return instance;
	}
	...
	public DStrainingManagementAuditOfWorkflow(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("trainingManagementAuditOfWorkflow");
		...
		setFields(processPooledTaskIdField, processInstanceActivityIdField, trainingManagementIdField, processTypeNameField, typeFlagField, businessIdField, businessNameField, processActivityIdField, processIdField, processInstanceIdField, nodeTypeField, activityIdField, nextActivityIdField, mainActivityIdField, instanceActivityCreateTimeField, instanceActivityStartTimeField, operateTimeField, processCommentField, statusField, activityTypeField, backViewNameField, processTypeField, subjectField,startTimeField,endTimeField, compereTypeField, compereField, employeeIdField, departmentIdField, signInDelayField, signOutDelayField, courseScoreField, detailField, createPersonIdField, fileManageIdField, siteField, plateIdField, isSiteField, trainingTypeField, trainingFeeField, fileIdField, fileUrlField, isSendField, plateidsField);
	}
