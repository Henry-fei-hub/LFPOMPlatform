...
public class CDTrainingManagementInformation extends DataSource
{


	public static CDTrainingManagementInformation instance = null;

	public static CDTrainingManagementInformation getInstance() {
		if(instance == null) {
			instance = new CDTrainingManagementInformation("CDTrainingManagementInformation");
		}
		return instance;
	}
	...
	public CDTrainingManagementInformation(String dataSourceID) {
