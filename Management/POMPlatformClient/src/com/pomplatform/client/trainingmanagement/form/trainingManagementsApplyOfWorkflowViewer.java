...
public class trainingManagementsApplyOfWorkflowViewer extends AbstractDetailViewer
{
	...
	public trainingManagementsApplyOfWorkflowViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_trainingManagementsApplyOfWorkflow", "find", new DSCallback() {
			@Override
