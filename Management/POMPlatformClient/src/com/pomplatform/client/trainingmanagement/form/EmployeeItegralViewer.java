...
public class EmployeeItegralViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_EmployeeItegral", "find", new DSCallback() {
			@Override
