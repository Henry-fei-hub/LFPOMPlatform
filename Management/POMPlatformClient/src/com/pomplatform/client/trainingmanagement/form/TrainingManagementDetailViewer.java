...
public class TrainingManagementDetailViewer extends AbstractDetailViewer
{




	public TrainingManagementDetailViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("ST_TrainingManagementDetail", "find", new DSCallback() {
			@Override
	...
	public DataSource getMainDataSource() {
		return DSTrainingManagementDetail.getInstance();
	}
