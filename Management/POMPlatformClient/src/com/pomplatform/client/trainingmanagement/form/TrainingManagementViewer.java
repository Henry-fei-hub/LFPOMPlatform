...
public class TrainingManagementViewer extends AbstractDetailViewer
{
	...
	public TrainingManagementViewer() {
	}
	...
	public void load() {
		...
		params.put("trainingManagementId", getBusinessId());
		DBDataSource.callOperation("NQ_TrainingManagement", "find", new DSCallback() {
			@Override
