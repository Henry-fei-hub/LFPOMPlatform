...
public class TrainingManagementInformationViewer extends AbstractDetailViewer
{
	...
	public TrainingManagementInformationViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_TrainingManagementInformation", "find", new DSCallback() {
			@Override
