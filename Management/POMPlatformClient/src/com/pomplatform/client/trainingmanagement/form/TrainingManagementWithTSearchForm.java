...
import com.pomplatform.client.trainingmanagement.datasource.CDTrainingManagementWithT;

public class TrainingManagementWithTSearchForm extends SearchForm
{
	...
	public TrainingManagementWithTSearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDTrainingManagementWithT.getInstance());
