...
import com.pomplatform.client.trainingmanagement.datasource.DStrainingManagementAttentionOfWorkflow;
import com.pomplatform.client.trainingmanagement.form.trainingManagementAttentionOfWorkflowSearchForm;
import com.pomplatform.client.trainingmanagement.form.trainingManagementAttentionOfWorkflowViewer;
...
public class trainingManagementAttentionOfWorkflowPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			trainingManagementAttentionOfWorkflowPanel cm = new trainingManagementAttentionOfWorkflowPanel();
			id = cm.getID();
			return cm;
		}
		...
		public String getDescription() {
			return "trainingManagementAttentionOfWorkflow";
		}
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("trainingManagementAttentionOfWorkflow"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				trainingManagementAttentionOfWorkflowViewer detailForm = new trainingManagementAttentionOfWorkflowViewer();
...
//		return new trainingManagementAttentionOfWorkflowSearchForm();
		return null;
	}

	@Override
	public DataSource getDataSource() {
		return DStrainingManagementAttentionOfWorkflow.getInstance();
	}
