...
import com.pomplatform.client.trainingmanagement.datasource.DStrainingManagementAuditOfWorkflow;
import com.pomplatform.client.trainingmanagement.form.trainingManagementAuditOfWorkflowSearchForm;
import com.pomplatform.client.trainingmanagement.form.trainingManagementAuditOfWorkflowViewer;
...
public class trainingManagementAuditOfWorkflowPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			trainingManagementAuditOfWorkflowPanel cm = new trainingManagementAuditOfWorkflowPanel();
			id = cm.getID();
			return cm;
		}
		...
		public String getDescription() {
			return "trainingManagementAuditOfWorkflow";
		}
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("trainingManagementAuditOfWorkflow"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				trainingManagementAuditOfWorkflowViewer detailForm = new trainingManagementAuditOfWorkflowViewer();
	...
	public SearchForm generateSearchForm() {
		return new trainingManagementAuditOfWorkflowSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DStrainingManagementAuditOfWorkflow.getInstance();
	}
