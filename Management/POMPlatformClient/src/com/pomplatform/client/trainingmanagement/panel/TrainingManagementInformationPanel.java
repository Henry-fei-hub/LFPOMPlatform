...
import com.pomplatform.client.trainingmanagement.form.TrainingManagementInformationSearchForm;
import com.pomplatform.client.trainingmanagement.form.TrainingManagementInformationViewer;
import com.pomplatform.client.trainingmanagement.form.UpdateTrainingManagementInformationForm;
import com.pomplatform.client.trainingmanagement.form.NewTrainingManagementInformationForm;
...
public class TrainingManagementInformationPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			TrainingManagementInformationPanel cm = new TrainingManagementInformationPanel();
			id = cm.getID();
			return cm;
		}
	...
	public void initComponents() {
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateTrainingManagementInformationForm detailForm = new UpdateTrainingManagementInformationForm();
		...
		operation2Button.addClickHandler(new ClickHandler(){
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					@Override
					public void onSuccess() {
						NewTrainingManagementInformationForm detailForm = new NewTrainingManagementInformationForm();
		...
		removeButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				DBDataSource.callOperation("ST_TrainingManagementInformation", "delete", selected.toMap(), new DSCallback() {
					@Override
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("TrainingManagementInformation"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				TrainingManagementInformationViewer detailForm = new TrainingManagementInformationViewer();
	...
	public SearchForm generateSearchForm() {
		return new TrainingManagementInformationSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSTrainingManagementInformation.getInstance();
	}
