...
public class AttachmentApprovalApplyViewer extends AbstractDetailViewer
{
	...
	public AttachmentApprovalApplyViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_AttachmentApprovalApply", "find", new DSCallback() {
			@Override
