package com.pomplatform.client.attachmentapprovalapply.form;
...
import com.pomplatform.client.attachmentapprovalapply.datasource.CDAttachmentApprovalApply;

public class AttachmentApprovalApplySearchForm extends SearchForm
{
	...
	public AttachmentApprovalApplySearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDAttachmentApprovalApply.getInstance());
...
//		KeyValueManager.loadValueMap("projects",projectIdItem);
		...
		setItems(processTypeItem, createTimeItem, employeeIdItem, budgetManagementIdItem, attachmentNameItem, uploadEmployeeIdItem, uploadTimeItem, uploadRemarkItem, projectIdItem, bddTypeItem, isApprovalItem, departmentIdItem);
