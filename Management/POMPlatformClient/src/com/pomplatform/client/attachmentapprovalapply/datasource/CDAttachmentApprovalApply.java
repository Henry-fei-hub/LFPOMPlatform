...
public class CDAttachmentApprovalApply extends DataSource
{


	public static CDAttachmentApprovalApply instance = null;

	public static CDAttachmentApprovalApply getInstance() {
		if(instance == null) {
			instance = new CDAttachmentApprovalApply("CDAttachmentApprovalApply");
		}
		return instance;
	}
	...
	public CDAttachmentApprovalApply(String dataSourceID) {
		...
		setFields(processTypeField, createTimeField, employeeIdField, budgetManagementIdField, attachmentNameField, uploadEmployeeIdField, uploadTimeField, uploadRemarkField, projectIdField, bddTypeField, isApprovalField, departmentIdField, currentPageField, pageLinesField);
