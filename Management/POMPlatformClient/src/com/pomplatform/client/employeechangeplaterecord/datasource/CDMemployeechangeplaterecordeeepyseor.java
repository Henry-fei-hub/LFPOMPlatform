...
public class CDMemployeechangeplaterecordeeepyseor extends DataSource
{


	public static CDMemployeechangeplaterecordeeepyseor instance = null;

	public static CDMemployeechangeplaterecordeeepyseor getInstance() {
		if(instance == null) {
			instance = new CDMemployeechangeplaterecordeeepyseor("CDMemployeechangeplaterecordeeepyseor");
		}
		return instance;
	}
	...
	public CDMemployeechangeplaterecordeeepyseor(String dataSourceID) {
		...
		setFields(employeeNoField, employeeIdField, plateIdField, yearField, startMonthField, endMonthField, currentPageField, pageLinesField);
