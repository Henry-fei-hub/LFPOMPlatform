...
public class DSEmployee extends DBDataSource {

    public static DSEmployee instance = null;

    public static DSEmployee getInstance() {
        if (instance == null) {
            instance = new DSEmployee("DSEmployee");
        }
        return instance;
    }
    ...
    private final DataSourceBooleanField isPlateManagerField;

    public DSEmployee(String dataSourceID) {
        ...
        employeeNameField = new DataSourceTextField("employeeName", "职员名称");
...
//        roleIdField.setValueMap(KeyValueManager.getValueMap("roles"));
        ...
        ageField = new DataSourceIntegerField("age", "");
