...
public class OnLoadProjectTransitionRecordViewer extends AbstractDetailViewer
{
	...
	public OnLoadProjectTransitionRecordViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadProjectTransitionRecord", "find", new DSCallback() {
			@Override
