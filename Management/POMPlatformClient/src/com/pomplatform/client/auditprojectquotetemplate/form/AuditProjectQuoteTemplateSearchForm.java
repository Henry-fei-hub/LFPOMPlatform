package com.pomplatform.client.auditprojectquotetemplate.form;
...
import com.pomplatform.client.auditprojectquotetemplate.datasource.CDAuditProjectQuoteTemplate;

public class AuditProjectQuoteTemplateSearchForm extends SearchForm
{
	...
	public AuditProjectQuoteTemplateSearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDAuditProjectQuoteTemplate.getInstance());
