...
public class AuditProjectQuoteTemplateViewer extends AbstractDetailViewer
{
	...
	public AuditProjectQuoteTemplateViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_AuditProjectQuoteTemplate", "find", new DSCallback() {
			@Override
