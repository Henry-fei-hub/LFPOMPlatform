...
public class MfinancialAccountingViewer extends AbstractDetailViewer
{
	...
	public MfinancialAccountingViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_MfinancialAccounting", "find", new DSCallback() {
			@Override
