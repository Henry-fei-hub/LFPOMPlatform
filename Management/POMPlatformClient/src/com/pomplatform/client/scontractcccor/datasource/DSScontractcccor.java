...
public class DSScontractcccor extends DBDataSource
{


	public static DSScontractcccor instance = null;

	public static DSScontractcccor getInstance() {
		if(instance == null) {
			instance = new DSScontractcccor("DSScontractcccor");
		}
		return instance;
	}
...
/*	private final DataSourceBooleanField hasSplitPriceField;
	...
	public DSScontractcccor(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("Scontractcccor");
        ...
        contractIdField.setForeignKey("DSScontractcccor.contractId");  
		...
		totalProjectTimeField = new DataSourceIntegerField("totalProjectTime", "主办设计团队");
		totalProjectTimeField.setLength(11);
		totalProjectTimeField.setRequired(false);
		totalProjectTimeField.setHidden(false);
		totalProjectTimeField.setValueMap(KeyValueManager.getValueMap("plate_records"));
		...
		fileIdField = new DataSourceTextField("fileId", "附件id");
		fileIdField.setLength(128);
