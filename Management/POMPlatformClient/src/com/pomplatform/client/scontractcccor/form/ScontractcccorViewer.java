...
public class ScontractcccorViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Scontractcccor", "find", new DSCallback() {
			@Override
