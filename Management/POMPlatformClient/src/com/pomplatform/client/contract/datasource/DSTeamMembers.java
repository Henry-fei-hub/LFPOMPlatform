...
public class DSTeamMembers extends DBDataSource
{


	public static DSTeamMembers instance = null;

	public static DSTeamMembers getInstance() {
		if(instance == null) {
			instance = new DSTeamMembers("DSTeamMembers");
		}
		return instance;
	}
	...
	public DSTeamMembers(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("TeamMembers");
