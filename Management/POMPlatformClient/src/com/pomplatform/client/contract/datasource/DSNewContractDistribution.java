...
public class DSNewContractDistribution extends DBDataSource
{


	public static DSNewContractDistribution instance = null;

	public static DSNewContractDistribution getInstance() {
		if(instance == null) {
			instance = new DSNewContractDistribution("DSNewContractDistribution");
		}
		return instance;
	}
	...
	private final DataSourceTextField teamField;
	...
	public DSNewContractDistribution(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("NewContractDistribution");
		...
		contractNameField.setLength(256);
		...
		contractDateField.setLength(32);
		...
		financialContractCodeField.setHidden(true);


		contractAreaField = new DataSourceIntegerField("contractArea", "合同区域 system_dictionary_116");
		...
		contractInfoAuditedField = new DataSourceBooleanField("contractInfoAudited", "合同信息审核无误");
		contractInfoAuditedField.setRequired(false);
		contractInfoAuditedField.setHidden(true);
		...
		contractSigningStatusField.setHidden(true);


		sendingDateField = new DataSourceDateField("sendingDate", "合同寄出日期");
		sendingDateField.setRequired(false);
		sendingDateField.setHidden(true);


		teamField = new DataSourceTextField("team", "营销团队");
		teamField.setRequired(true);
		teamField.setHidden(false);
