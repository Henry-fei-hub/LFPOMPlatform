...
public class DSContractDistribution extends DBDataSource
{


	public static DSContractDistribution instance = null;

	public static DSContractDistribution getInstance() {
		if(instance == null) {
			instance = new DSContractDistribution("DSContractDistribution");
		}
		return instance;
	}
	...
	public DSContractDistribution(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("ContractDistribution");
