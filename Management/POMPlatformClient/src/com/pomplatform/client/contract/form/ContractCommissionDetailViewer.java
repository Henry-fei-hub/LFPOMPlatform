...
public class ContractCommissionDetailViewer extends AbstractDetailViewer
{
	...
	public ContractCommissionDetailViewer() {
	}
	...
	public void load() {
		...
		params.put("contractCommissionDetailId", getBusinessId());
		DBDataSource.callOperation("NQ_ContractCommissionDetail", "find", new DSCallback() {
			@Override
