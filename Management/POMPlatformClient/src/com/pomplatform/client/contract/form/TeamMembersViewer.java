...
public class TeamMembersViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_TeamMembers", "find", new DSCallback() {
			@Override
