...
public class ContractAmountAnalyzeViewer extends AbstractDetailViewer
{
	...
	public ContractAmountAnalyzeViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ContractAmountAnalyze", "find", new DSCallback() {
			@Override
