...
public class ContractDistributionNewViewer extends AbstractDetailViewer
{
	...
	public ContractDistributionNewViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ContractDistributionNew", "find", new DSCallback() {
			@Override
