...
public class OnLoadContractAttachmentDataViewer extends AbstractDetailViewer
{
	...
	public OnLoadContractAttachmentDataViewer() {
	}
	...
	public void load() {
		...
		params.put("contractAttachmentId", getBusinessId());
		DBDataSource.callOperation("NQ_OnLoadContractAttachmentData", "find", new DSCallback() {
			@Override
