...
public class ContractDistributionViewer extends AbstractDetailViewer
{
	...
	public ContractDistributionViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ContractDistribution", "find", new DSCallback() {
			@Override
