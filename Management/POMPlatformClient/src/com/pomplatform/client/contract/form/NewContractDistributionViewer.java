...
public class NewContractDistributionViewer extends AbstractDetailViewer
{
	...
	public NewContractDistributionViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_NewContractDistribution", "find", new DSCallback() {
			@Override
