...
public class ContractManageViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ContractManage", "find", new DSCallback() {
			@Override
