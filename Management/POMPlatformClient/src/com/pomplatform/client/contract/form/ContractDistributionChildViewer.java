...
public class ContractDistributionChildViewer extends AbstractDetailViewer
{
	...
	public ContractDistributionChildViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ContractDistributionChild", "find", new DSCallback() {
			@Override
