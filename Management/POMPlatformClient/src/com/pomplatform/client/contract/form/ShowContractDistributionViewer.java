...
public class ShowContractDistributionViewer extends AbstractDetailViewer
{
	...
	public ShowContractDistributionViewer() {
	}
	...
	public void load() {
		...
		params.put("contractDistributionId", getBusinessId());
		DBDataSource.callOperation("NQ_ShowContractDistribution", "find", new DSCallback() {
			@Override
