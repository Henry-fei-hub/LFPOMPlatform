...
public class ContractDistributionMonthlyDetailViewer extends AbstractDetailViewer
{
	...
	public ContractDistributionMonthlyDetailViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ContractDistributionMonthlyDetail", "find", new DSCallback() {
			@Override
