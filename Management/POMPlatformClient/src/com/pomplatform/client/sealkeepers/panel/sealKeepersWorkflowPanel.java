...
import com.pomplatform.client.sealkeepers.form.*;
...
public class sealKeepersWorkflowPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			sealKeepersWorkflowPanel cm = new sealKeepersWorkflowPanel();
			id = cm.getID();
			return cm;
		}
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						SealKeepersWorkflowForm detailForm = new SealKeepersWorkflowForm();
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateSealKeepersWorkflowForm detailForm = new UpdateSealKeepersWorkflowForm();
...
//				DBDataSource.callOperation("ST_SealKeeper", "delete", selected.toMap(), new DSCallback() {
//					@Override
...
//				});
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setWidth100(); 
				detail.setHeight100(); 
				sealKeepersWorkflowViewer detailForm = new sealKeepersWorkflowViewer();
	...
	public boolean checkSearchCriteria(Map criteria) {
		criteria.put("addtionalCondition", "order by seal_keeper_id");
		return true;
	}
	...
	public SearchForm generateSearchForm() {
		return new sealKeepersWorkflowSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSsealKeepersWorkflow.getInstance();
	}
