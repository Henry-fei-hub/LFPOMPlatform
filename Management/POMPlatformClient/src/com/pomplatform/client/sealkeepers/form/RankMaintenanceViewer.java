...
public class RankMaintenanceViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_RankMaintenance", "find", new DSCallback() {
			@Override
