...
public class McapitaldepartmentdccddorViewer extends AbstractDetailViewer
{
	...
	public McapitaldepartmentdccddorViewer() {
	}
	...
	public void load() {
		...
		params.put("capitalDepartmentId", getBusinessId());
		DBDataSource.callOperation("NQ_Mcapitaldepartmentdccddor", "find", new DSCallback() {
			@Override
