...
public class UpdateRightInvoiceexpressPanel extends AbstractWizadPage implements HasHandlers{
	...
	public UpdateRightInvoiceexpressPanel(final int __contractId, final int __optionType){
		this.contractId = __contractId;
		this.optionType = __optionType;
...
//		setBackgroundColor(BACKGROUND_COLOR);
		...
		Label title = new Label("需寄送发票信息选择");
		title.setHeight(30);
	...
	public void startEdit() {
		...
		params.put("opt_type", "getInvoiceByContract");
		DBDataSource.callOperation("EP_CustomerMinvoiceexpresitssccmisiiorHandler", "getInvoiceByContract", params, new DSCallback() {
