...
public class DSMItemCollection extends DBDataSource
{


	public static DSMItemCollection instance = null;

	public static DSMItemCollection getInstance() {
		if(instance == null) {
			instance = new DSMItemCollection("DSMItemCollection");
		}
		return instance;
	}
	...
	public DSMItemCollection(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("MItemCollection");
