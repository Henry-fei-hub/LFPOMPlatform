...
public class MItemCollectionViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_MItemCollection", "find", new DSCallback() {
			@Override
