...
public class SactivityMpcorViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		params.put("activitieId", getBusinessId());
		DBDataSource.callOperation("NQ_SactivityMpcor", "find", new DSCallback() {
			@Override
