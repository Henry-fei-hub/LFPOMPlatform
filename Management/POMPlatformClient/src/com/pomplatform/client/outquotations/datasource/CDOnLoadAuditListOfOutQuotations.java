...
public class CDOnLoadAuditListOfOutQuotations extends DataSource
{


	public static CDOnLoadAuditListOfOutQuotations instance = null;

	public static CDOnLoadAuditListOfOutQuotations getInstance() {
		if(instance == null) {
			instance = new CDOnLoadAuditListOfOutQuotations("CDOnLoadAuditListOfOutQuotations");
		}
		return instance;
	}
	...
	public CDOnLoadAuditListOfOutQuotations(String dataSourceID) {
