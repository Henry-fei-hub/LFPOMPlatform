...
import com.pomplatform.client.outquotations.datasource.DSOnLoadAuditListOfOutQuotations;
import com.pomplatform.client.outquotations.form.OnLoadAuditListOfOutQuotationsSearchForm;
import com.pomplatform.client.outquotations.form.OnLoadAuditListOfOutQuotationsViewer;
...
public class OnLoadAuditListOfOutQuotationsPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			OnLoadAuditListOfOutQuotationsPanel cm = new OnLoadAuditListOfOutQuotationsPanel();
			id = cm.getID();
			return cm;
		}
		...
		public String getDescription() {
			return "OnLoadAuditListOfOutQuotations";
		}
...
//		commonQuery();
	...
	public SearchForm generateSearchForm() {
		return new OnLoadAuditListOfOutQuotationsSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSOnLoadAuditListOfOutQuotations.getInstance();
	}
