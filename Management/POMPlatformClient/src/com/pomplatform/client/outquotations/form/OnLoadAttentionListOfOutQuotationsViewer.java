...
public class OnLoadAttentionListOfOutQuotationsViewer extends AbstractDetailViewer
{
	...
	public OnLoadAttentionListOfOutQuotationsViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadAttentionListOfOutQuotations", "find", new DSCallback() {
			@Override
