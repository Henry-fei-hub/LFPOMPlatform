...
import com.pomplatform.client.outquotations.datasource.CDOnLoadAttentionListOfOutQuotations;
import com.pomplatform.client.outquotations.datasource.CDOnLoadAuditListOfOutQuotations;

public class OnLoadAttentionListOfOutQuotationsSearchForm extends SearchForm
{
...
//	private final TextItem employeeIdItem;
	...
	public OnLoadAttentionListOfOutQuotationsSearchForm() {
		setWidth100();
		setHeight100();
...
//		employeeIdItem.setTextMatchStyle(TextMatchStyle.SUBSTRING);
		...
		setItems(statusItem,employeeNameItem,employeeNoItem, quotationNumberItem, quotationNameItem, infoCodeItem, projectCodeItem, quotationStatusItem);
