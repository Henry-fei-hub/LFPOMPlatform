...
public class DSGContractInfo extends DBDataSource {

    public static DSGContractInfo instance = null;

    public static DSGContractInfo getInstance() {
        if (instance == null) {
            instance = new DSGContractInfo("DSGContractInfo");
        }
        return instance;
    }
    ...
    public DSGContractInfo(String dataSourceID) {

        super();
        setID(dataSourceID);
        setActionMode(ACTION_MODE_QUERY);
        setActionName("GContractInfo");
        ...
        setFields(contractIdField, contractCodeField, contractNameField, customerNameField, startDateField, endDateField, statusField, projectCodeField, contractTypeField, businessTypeField, projectLevelField, totalProjectTimeField, signingMoneySumField, designAreasField, contractPriceField, projectAddressField, contractFollowerField, remarkField, contractDateField, createTimeField, updateTimeField, signingCompanyNameField, flowStatusField);
    }
