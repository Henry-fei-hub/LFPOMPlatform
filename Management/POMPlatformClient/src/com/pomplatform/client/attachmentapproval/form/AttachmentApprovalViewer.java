...
public class AttachmentApprovalViewer extends AbstractDetailViewer
{
	...
	public AttachmentApprovalViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_AttachmentApproval", "find", new DSCallback() {
			@Override
