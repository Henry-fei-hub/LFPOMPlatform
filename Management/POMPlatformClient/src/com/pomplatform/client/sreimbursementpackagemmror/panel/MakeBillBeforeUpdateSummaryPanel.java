...
public class MakeBillBeforeUpdateSummaryPanel extends AbstractWizadPage implements HasHandlers {
	...
	public MakeBillBeforeUpdateSummaryPanel(boolean isCompleted, Integer companyId) {
