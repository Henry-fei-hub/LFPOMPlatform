...
public class DSScmbcpaydetailctyor extends DBDataSource
{


	public static DSScmbcpaydetailctyor instance = null;

	public static DSScmbcpaydetailctyor getInstance() {
		if(instance == null) {
			instance = new DSScmbcpaydetailctyor("DSScmbcpaydetailctyor");
		}
		return instance;
	}
	...
	public DSScmbcpaydetailctyor(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("Scmbcpaydetailctyor");
