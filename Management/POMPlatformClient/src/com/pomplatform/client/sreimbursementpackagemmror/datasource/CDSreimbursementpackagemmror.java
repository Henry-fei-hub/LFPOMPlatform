...
public class CDSreimbursementpackagemmror extends DataSource {

	public static CDSreimbursementpackagemmror instance = null;

	public static CDSreimbursementpackagemmror getInstance() {
		if (instance == null) {
			instance = new CDSreimbursementpackagemmror("CDSreimbursementpackagemmror");
		}
		return instance;
	}
	...
	private final DataSourceBooleanField isOnlinePayItem;

	public CDSreimbursementpackagemmror(String dataSourceID) {
		...
		isOnlinePayItem = new DataSourceBooleanField("isOnlinePay", "是否在线支付");
		isOnlinePayItem.setRequired(false);
		isOnlinePayItem.setHidden(false);
		...
		setFields(minCreateTimeField, maxCreateTimeField, reimbursementPackageIdField, companyIdField, isCompletedField,
				remarkField, employeeIdField, roleIdField, operatorIdField, codeField, dcodeField, isOnlinePayItem,
