...
public class MCmbcPaymentDetailporViewer extends AbstractDetailViewer
{
	...
	public MCmbcPaymentDetailporViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_MCmbcPaymentDetailpor", "find", new DSCallback() {
			@Override
