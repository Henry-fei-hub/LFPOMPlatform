...
public class SreimbursementpackagemmrorViewer extends AbstractDetailViewer
{
	...
	public SreimbursementpackagemmrorViewer() {
	}
	...
	public void load() {
		...
		params.put("reimbursementPackageId", getBusinessId());
		DBDataSource.callOperation("NQ_Sreimbursementpackagemmror", "find", new DSCallback() {
			@Override
