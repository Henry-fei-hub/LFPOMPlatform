...
public class ScmbcpaydetailctyorViewer extends AbstractDetailViewer
{
	...
	public ScmbcpaydetailctyorViewer() {
	}
	...
	public void load() {
		...
		params.put("cmbcPayDetailId", getBusinessId());
		DBDataSource.callOperation("NQ_Scmbcpaydetailctyor", "find", new DSCallback() {
			@Override
