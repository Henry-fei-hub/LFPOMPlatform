...
public class McmbcpaydetailcctyrrosoowwwpporViewer extends AbstractDetailViewer
{
	...
	public McmbcpaydetailcctyrrosoowwwpporViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Mcmbcpaydetailcctyrrosoowwwppor", "find", new DSCallback() {
			@Override
