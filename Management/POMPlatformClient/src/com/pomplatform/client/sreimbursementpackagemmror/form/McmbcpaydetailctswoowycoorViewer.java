...
public class McmbcpaydetailctswoowycoorViewer extends AbstractDetailViewer
{
	...
	public McmbcpaydetailctswoowycoorViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Mcmbcpaydetailctswoowycoor", "find", new DSCallback() {
			@Override
