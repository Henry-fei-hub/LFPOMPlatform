...
import com.pomplatform.client.payment.datasource.DSOnLeaveSubsidysData;
import com.pomplatform.client.payment.form.OnLeaveSubsidysDataSearchForm;
import com.pomplatform.client.payment.form.OnLeaveSubsidysDataViewer;
...
public class OnLeaveSubsidysDataPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			OnLeaveSubsidysDataPanel cm = new OnLeaveSubsidysDataPanel();
			id = cm.getID();
			return cm;
		}
	...
	public void initComponents() {
		...
		resultGrid.addEditCompleteHandler(new EditCompleteHandler() {
			...
			public void onEditComplete(EditCompleteEvent event) {
				...
				//不扣税
				BigDecimal noDeductTax = BaseHelpUtils.getBigDecimalValue(params.get("noDeductTax"));
				//扣税
				BigDecimal deductTax = BaseHelpUtils.getBigDecimalValue(params.get("deductTax"));
				//设置合计
				BigDecimal totalAmount = noDeductTax.add(deductTax);
				//获取日期
				...
				DBDataSource.callOperation("ST_SalaryLeaveSubsidy","saveOrUpdate", params, new DSCallback() {
					@Override
			...
			public void onClick(ClickEvent event) {
				...
				SC.ask("提示","您确认要删除吗?",new BooleanCallback() {
					...
					public void execute(Boolean value) {
						...
						DBDataSource.callOperation("ST_SalaryLeaveSubsidy", "delete", selected.toMap(), new DSCallback() {
							@Override
							public void execute(DSResponse dsResponse, Object data, DSRequest dsRequest) {
								if (dsResponse.getStatus() < 0) {
									ClientUtil.displayErrorMessage(dsResponse);
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("离职补偿"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				OnLeaveSubsidysDataViewer detailForm = new OnLeaveSubsidysDataViewer();
	...
	public SearchForm generateSearchForm() {
		return new OnLeaveSubsidysDataSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSOnLeaveSubsidysData.getInstance();
	}
