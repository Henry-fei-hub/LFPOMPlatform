 ...
 */
public class BonusDynamicPagesPanel extends VLayout {
    ...
    private List<BonusCommonPanel> panels = new ArrayList<>();
        ...
        for (int i = 0; i < rows; i++) {
            ...
            if (i != rows - 1) {
                for (int j = 0; j < 3; j++) {
                    ...
                    BonusCommonPanel commonPanel = new BonusCommonPanel(map);
        ...
        saveButton.addClickHandler(new ClickHandler() {
            ...
            public void onClick(ClickEvent clickEvent) {
                ...
                if (null != panels) {
                    ...
                    params.put("optType", "saveBonus");
                    //装载所有页面的数据
                    for (int i = 0; i < panels.size(); i++) {
                        BonusCommonPanel commonPanel = panels.get(i);
