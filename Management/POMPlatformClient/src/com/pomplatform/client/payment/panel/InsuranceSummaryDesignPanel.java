...
public class InsuranceSummaryDesignPanel extends AbstractWizadPage {
    ...
    private SelectItem companyItem;
	...
	public InsuranceSummaryDesignPanel() {
    	...
    	companyItem = new SelectItem("companyId","公司");
    	companyItem.setWidth(280);
    	companyItem.setHeight(26);
    	companyItem.setValueMap(KeyValueManager.getValueMap("company_records"));
    	...
    	__infoForm.setItems(companyItem,yearItem,startMonthItem,endMonthItem);
    	...
    	summaryGrid.addDoubleClickHandler(new DoubleClickHandler() {
			...
			public void onDoubleClick(DoubleClickEvent event) {
				...
				InsuranceSummaryPlateforCompanyDesignPanel panel = new InsuranceSummaryPlateforCompanyDesignPanel();
				pw.addItem(panel);
				int companyId = record.getAttributeAsInt("companyId");
				int year = record.getAttributeAsInt("year");
				int month = record.getAttributeAsInt("month");
    ...
    public void startEdit() {
    	...
    	if(!BaseHelpUtils.isNullOrEmpty(companyItem.getValue())){
    		param.put("companyId", companyItem.getValue());
    	}
    	...
    	DBDataSource.callOperation("NQ_FiveinsuranceSummary", param, new DSCallback() {
