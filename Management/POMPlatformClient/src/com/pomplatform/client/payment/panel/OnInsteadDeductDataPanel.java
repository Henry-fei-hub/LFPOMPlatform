...
import com.pomplatform.client.common.UploadInsteadDeductData;
import com.pomplatform.client.payment.datasource.DSOnInsteadDeductData;
import com.pomplatform.client.payment.form.OnInsteadDeductDataSearchForm;
import com.pomplatform.client.payment.form.OnInsteadDeductDataViewer;
...
public class OnInsteadDeductDataPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			OnInsteadDeductDataPanel cm = new OnInsteadDeductDataPanel();
			id = cm.getID();
			return cm;
		}
	...
	public void initComponents() {
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						UploadInsteadDeductData uploadXls = new UploadInsteadDeductData();
		...
		resultGrid.addEditCompleteHandler(new EditCompleteHandler() {
			...
			public void onEditComplete(EditCompleteEvent event) {
				...
				DBDataSource.callOperation("ST_SalaryInsteadDeduct","saveOrUpdate", params, new DSCallback() {
					@Override
			...
			public void onClick(ClickEvent event) {
				...
				SC.ask("提示","您确认要删除吗?",new BooleanCallback() {
					...
					public void execute(Boolean value) {
						...
						DBDataSource.callOperation("ST_SalaryInsteadDeduct", "delete", selected.toMap(), new DSCallback() {
							@Override
							public void execute(DSResponse dsResponse, Object data, DSRequest dsRequest) {
								if (dsResponse.getStatus() < 0) {
									ClientUtil.displayErrorMessage(dsResponse);
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("代扣款项"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				OnInsteadDeductDataViewer detailForm = new OnInsteadDeductDataViewer();
	...
	public SearchForm generateSearchForm() {
		return new OnInsteadDeductDataSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSOnInsteadDeductData.getInstance();
	}
