...
public class OnSalaryBonusTotalDataViewer extends AbstractDetailViewer
{
	...
	public OnSalaryBonusTotalDataViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnSalaryBonusTotalData", "find", new DSCallback() {
			@Override
