...
public class OnSalarySendDataViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnSalarySendData", "find", new DSCallback() {
			@Override
