...
public class OnSalaryReportByEmployeeViewer extends AbstractDetailViewer
{
	...
	public OnSalaryReportByEmployeeViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnSalaryReportByEmployee", "find", new DSCallback() {
			@Override
