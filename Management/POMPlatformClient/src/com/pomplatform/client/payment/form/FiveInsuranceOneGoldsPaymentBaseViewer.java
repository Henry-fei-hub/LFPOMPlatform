...
public class FiveInsuranceOneGoldsPaymentBaseViewer extends AbstractDetailViewer
{
	...
	public FiveInsuranceOneGoldsPaymentBaseViewer() {
	}
	...
	public void load() {
		...
		params.put("fiveInsuranceOneGoldId", getBusinessId());
		DBDataSource.callOperation("NQ_FiveInsuranceOneGoldsPaymentBase", "find", new DSCallback() {
			@Override
