...
public class OnJobSubsidysDataViewer extends AbstractDetailViewer
{
	...
	public OnJobSubsidysDataViewer() {
	}
	...
	public void load() {
		...
		params.put("salaryJobSubsidyId", getBusinessId());
		DBDataSource.callOperation("NQ_OnJobSubsidysData", "find", new DSCallback() {
			@Override
