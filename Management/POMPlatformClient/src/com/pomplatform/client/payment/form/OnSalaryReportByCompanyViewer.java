...
public class OnSalaryReportByCompanyViewer extends AbstractDetailViewer
{
	...
	public OnSalaryReportByCompanyViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnSalaryReportByCompany", "find", new DSCallback() {
			@Override
