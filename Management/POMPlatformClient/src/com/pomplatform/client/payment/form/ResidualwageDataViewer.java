...
public class ResidualwageDataViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ResidualwageData", "find", new DSCallback() {
			@Override
