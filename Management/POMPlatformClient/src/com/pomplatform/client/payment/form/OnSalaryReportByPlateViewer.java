...
public class OnSalaryReportByPlateViewer extends AbstractDetailViewer
{
	...
	public OnSalaryReportByPlateViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnSalaryReportByPlate", "find", new DSCallback() {
			@Override
