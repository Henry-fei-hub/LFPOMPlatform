...
public class OnSalaryPlateBonusByCompanyViewer extends AbstractDetailViewer
{
	...
	public OnSalaryPlateBonusByCompanyViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnSalaryPlateBonusByCompany", "find", new DSCallback() {
			@Override
