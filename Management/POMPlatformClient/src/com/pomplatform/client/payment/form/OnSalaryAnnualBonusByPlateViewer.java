...
public class OnSalaryAnnualBonusByPlateViewer extends AbstractDetailViewer
{
	...
	public OnSalaryAnnualBonusByPlateViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnSalaryAnnualBonusByPlate", "find", new DSCallback() {
			@Override
