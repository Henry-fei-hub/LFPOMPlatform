...
import com.pomplatform.client.payment.datasource.CDOnReplacementTaxData;

public class OnReplacementTaxDataSearchForm extends SearchForm
{
	...
	public OnReplacementTaxDataSearchForm() {
		setWidth100();
		setHeight100();
