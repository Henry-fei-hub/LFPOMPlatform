...
public class OnInsteadDeductIllDataViewer extends AbstractDetailViewer
{
	...
	public OnInsteadDeductIllDataViewer() {
	}
	...
	public void load() {
		...
		params.put("salaryInsteadDeductIllId", getBusinessId());
		DBDataSource.callOperation("NQ_OnInsteadDeductIllData", "find", new DSCallback() {
			@Override
