...
import com.pomplatform.client.payment.datasource.CDOnOtherDeductionData;

public class OnOtherDeductionDataSearchForm extends SearchForm
{
	...
	public OnOtherDeductionDataSearchForm() {
		setWidth100();
		setHeight100();
