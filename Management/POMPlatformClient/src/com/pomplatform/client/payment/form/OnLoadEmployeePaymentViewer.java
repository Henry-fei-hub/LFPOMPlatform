...
public class OnLoadEmployeePaymentViewer extends AbstractDetailViewer
{
	...
	public OnLoadEmployeePaymentViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadEmployeePayment", "find", new DSCallback() {
			@Override
