...
public class OnSalaryEmpBonusByDepartmentViewer extends AbstractDetailViewer
{
	...
	public OnSalaryEmpBonusByDepartmentViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnSalaryEmpBonusByDepartment", "find", new DSCallback() {
			@Override
