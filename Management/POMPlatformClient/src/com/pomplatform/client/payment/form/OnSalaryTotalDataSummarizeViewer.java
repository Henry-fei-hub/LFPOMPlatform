...
public class OnSalaryTotalDataSummarizeViewer extends AbstractDetailViewer
{
	...
	public OnSalaryTotalDataSummarizeViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnSalaryTotalDataSummarize", "find", new DSCallback() {
			@Override
