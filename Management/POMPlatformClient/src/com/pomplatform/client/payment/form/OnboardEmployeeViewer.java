...
public class OnboardEmployeeViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnboardEmployee", "find", new DSCallback() {
			@Override
