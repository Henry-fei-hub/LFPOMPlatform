...
public class OnOtherDeductionDataViewer extends AbstractDetailViewer
{
	...
	public OnOtherDeductionDataViewer() {
	}
	...
	public void load() {
		...
		params.put("otherDeductionId", getBusinessId());
		DBDataSource.callOperation("NQ_OnOtherDeductionData", "find", new DSCallback() {
			@Override
