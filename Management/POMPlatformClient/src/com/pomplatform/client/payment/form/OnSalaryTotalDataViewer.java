...
public class OnSalaryTotalDataViewer extends AbstractDetailViewer
{
	...
	public OnSalaryTotalDataViewer() {
	}
...
/*    	Map<String, String> kv = new HashMap<>();
		...
		DBDataSource.callOperation("NQ_OnSalaryTotalData", "find", new DSCallback() {
			@Override
