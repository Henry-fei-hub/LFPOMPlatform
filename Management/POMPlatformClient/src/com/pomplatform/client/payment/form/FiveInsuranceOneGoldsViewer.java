...
public class FiveInsuranceOneGoldsViewer extends AbstractDetailViewer
{
	...
	public FiveInsuranceOneGoldsViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_FiveInsuranceOneGolds", "find", new DSCallback() {
			@Override
