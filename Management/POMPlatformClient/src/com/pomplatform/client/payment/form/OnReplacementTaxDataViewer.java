...
public class OnReplacementTaxDataViewer extends AbstractDetailViewer
{
	...
	public OnReplacementTaxDataViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnReplacementTaxData", "find", new DSCallback() {
			@Override
