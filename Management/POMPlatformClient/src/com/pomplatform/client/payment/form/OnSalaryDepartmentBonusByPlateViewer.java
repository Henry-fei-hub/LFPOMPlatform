...
public class OnSalaryDepartmentBonusByPlateViewer extends AbstractDetailViewer
{
	...
	public OnSalaryDepartmentBonusByPlateViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnSalaryDepartmentBonusByPlate", "find", new DSCallback() {
			@Override
