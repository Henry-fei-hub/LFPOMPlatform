...
public class OnFillSendDeductDataViewer extends AbstractDetailViewer
{
	...
	public OnFillSendDeductDataViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnFillSendDeductData", "find", new DSCallback() {
			@Override
