...
public class OnSalaryReportByDepartmentViewer extends AbstractDetailViewer
{
	...
	public OnSalaryReportByDepartmentViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnSalaryReportByDepartment", "find", new DSCallback() {
			@Override
