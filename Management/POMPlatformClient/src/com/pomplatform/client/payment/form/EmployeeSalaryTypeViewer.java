...
public class EmployeeSalaryTypeViewer extends AbstractDetailViewer
{
	...
	public EmployeeSalaryTypeViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_EmployeeSalaryType", "find", new DSCallback() {
			@Override
