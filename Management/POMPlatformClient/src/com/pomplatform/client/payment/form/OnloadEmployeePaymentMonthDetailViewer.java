...
public class OnloadEmployeePaymentMonthDetailViewer extends AbstractDetailViewer
{
	...
	public OnloadEmployeePaymentMonthDetailViewer() {
	}
	...
	public void load() {
		...
		params.put("employeePaymentMonthDetailId", getBusinessId());
		DBDataSource.callOperation("NQ_OnloadEmployeePaymentMonthDetail", "find", new DSCallback() {
			@Override
