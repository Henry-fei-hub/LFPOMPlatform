...
public class OnOtherDeductionDataUpdateForm extends AbstractWizadPage
{


	private final TextItem otherDeductionIdItem;
	...
	public OnOtherDeductionDataUpdateForm() {
		DSOnOtherDeductionData ds = DSOnOtherDeductionData.getInstance();
		__form.setWidth100();
		__form.setHeight100();
		otherDeductionIdItem = new TextItem("otherDeductionId", "主键编码");
		otherDeductionIdItem.setDisabled(true);
		otherDeductionIdItem.setRequired(true);
		IsIntegerValidator otherDeductionIdValidator = new IsIntegerValidator();
		otherDeductionIdItem.setValidators(otherDeductionIdValidator);
		__formItems.add(otherDeductionIdItem);
