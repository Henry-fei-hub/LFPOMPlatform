...
public class OnSalaryBonusSendDataViewer extends AbstractDetailViewer
{
	...
	public OnSalaryBonusSendDataViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnSalaryBonusSendData", "find", new DSCallback() {
			@Override
