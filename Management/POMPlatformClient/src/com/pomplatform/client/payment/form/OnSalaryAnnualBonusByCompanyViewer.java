...
public class OnSalaryAnnualBonusByCompanyViewer extends AbstractDetailViewer
{
	...
	public OnSalaryAnnualBonusByCompanyViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnSalaryAnnualBonusByCompany", "find", new DSCallback() {
			@Override
