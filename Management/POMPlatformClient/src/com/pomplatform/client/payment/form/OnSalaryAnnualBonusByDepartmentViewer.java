...
public class OnSalaryAnnualBonusByDepartmentViewer extends AbstractDetailViewer
{
	...
	public OnSalaryAnnualBonusByDepartmentViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnSalaryAnnualBonusByDepartment", "find", new DSCallback() {
			@Override
