...
public class DSOnSalaryReportByCompany extends DBDataSource
{


	public static DSOnSalaryReportByCompany instance = null;

	public static DSOnSalaryReportByCompany getInstance() {
		if(instance == null) {
			instance = new DSOnSalaryReportByCompany("DSOnSalaryReportByCompany");
		}
		return instance;
	}
	...
	public DSOnSalaryReportByCompany(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("OnSalaryReportByCompany");
		...
		suspendBonusField.setLength(18);
		suspendBonusField.setDecimalPad(2);
		suspendBonusField.setFormat("#,###,###,###,###,##0.00");
		suspendBonusField.setRequired(true);
		suspendBonusField.setHidden(false);


		setFields(companyIdField, yearField, monthField, shouldSalaryField, leaveAdvanceField,replacementTaxField,suspendBonusField, shouldBonusField, shouldTotalField, shouldTaxField, totalInsuranceField, totalFundField, insteadDeductField, insteadDeductIllField,replacementTaxField, factSalaryField, numField, unitTotalInsuranceField, unitTotalFundField);
	}
