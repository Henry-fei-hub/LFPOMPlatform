...
public class DSOnSalaryAnnualBonusByDepartment extends DBDataSource
{

	public static DSOnSalaryAnnualBonusByDepartment instance = null;

	public static DSOnSalaryAnnualBonusByDepartment getInstance() {
		if(instance == null) {
			instance = new DSOnSalaryAnnualBonusByDepartment("DSOnSalaryAnnualBonusByDepartment");
		}
		return instance;
	}
	...
	public DSOnSalaryAnnualBonusByDepartment(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("OnSalaryAnnualBonusByDepartment");
