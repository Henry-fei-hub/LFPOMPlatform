...
public class DSOnSalaryAnnualBonusByCompany extends DBDataSource
{


	public static DSOnSalaryAnnualBonusByCompany instance = null;

	public static DSOnSalaryAnnualBonusByCompany getInstance() {
		if(instance == null) {
			instance = new DSOnSalaryAnnualBonusByCompany("DSOnSalaryAnnualBonusByCompany");
		}
		return instance;
	}
	...
	public DSOnSalaryAnnualBonusByCompany(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("OnSalaryAnnualBonusByCompany");
		...
		yearPerformanceBonusField = new DataSourceFloatField("yearPerformanceBonus", "应发年度绩效工资");
		...
		programBonusField = new DataSourceFloatField("programBonus", "应发项目奖金");
		...
		salaryDiffDeductField = new DataSourceFloatField("salaryDiffDeduct", "补/扣工资差额");
