...
public class DSOnLoadSalaryPaymentByCompany extends DBDataSource
{


	public static DSOnLoadSalaryPaymentByCompany instance = null;

	public static DSOnLoadSalaryPaymentByCompany getInstance() {
		if(instance == null) {
			instance = new DSOnLoadSalaryPaymentByCompany("DSOnLoadSalaryPaymentByCompany");
		}
		return instance;
	}
	...
	public DSOnLoadSalaryPaymentByCompany(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("OnLoadSalaryPaymentByCompany");
