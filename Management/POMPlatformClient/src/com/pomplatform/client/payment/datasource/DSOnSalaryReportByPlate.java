...
public class DSOnSalaryReportByPlate extends DBDataSource
{


	public static DSOnSalaryReportByPlate instance = null;

	public static DSOnSalaryReportByPlate getInstance() {
		if(instance == null) {
			instance = new DSOnSalaryReportByPlate("DSOnSalaryReportByPlate");
		}
		return instance;
	}
	...
	public DSOnSalaryReportByPlate(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("OnSalaryReportByPlate");
		...
		setFields(plateIdField, yearField, monthField, shouldSalaryField, leaveAdvanceField,replacementTaxField,suspendBonusField, shouldBonusField, shouldTotalField, shouldTaxField, totalInsuranceField, totalFundField, insteadDeductField, insteadDeductIllField, factSalaryField, numField, unitTotalInsuranceField, unitTotalFundField);
	}
