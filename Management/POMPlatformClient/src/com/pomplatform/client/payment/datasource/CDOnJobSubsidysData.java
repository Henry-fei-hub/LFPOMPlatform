...
public class CDOnJobSubsidysData extends DataSource
{


	public static CDOnJobSubsidysData instance = null;

	public static CDOnJobSubsidysData getInstance() {
		if(instance == null) {
			instance = new CDOnJobSubsidysData("CDOnJobSubsidysData");
		}
		return instance;
	}
	...
	public CDOnJobSubsidysData(String dataSourceID) {
