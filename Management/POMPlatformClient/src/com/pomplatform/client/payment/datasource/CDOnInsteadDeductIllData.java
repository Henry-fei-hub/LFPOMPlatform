...
public class CDOnInsteadDeductIllData extends DataSource
{


	public static CDOnInsteadDeductIllData instance = null;

	public static CDOnInsteadDeductIllData getInstance() {
		if(instance == null) {
			instance = new CDOnInsteadDeductIllData("CDOnInsteadDeductIllData");
		}
		return instance;
	}
	...
	public CDOnInsteadDeductIllData(String dataSourceID) {
