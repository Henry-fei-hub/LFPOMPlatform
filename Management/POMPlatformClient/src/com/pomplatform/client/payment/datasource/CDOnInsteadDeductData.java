...
public class CDOnInsteadDeductData extends DataSource
{


	public static CDOnInsteadDeductData instance = null;

	public static CDOnInsteadDeductData getInstance() {
		if(instance == null) {
			instance = new CDOnInsteadDeductData("CDOnInsteadDeductData");
		}
		return instance;
	}
	...
	public CDOnInsteadDeductData(String dataSourceID) {
