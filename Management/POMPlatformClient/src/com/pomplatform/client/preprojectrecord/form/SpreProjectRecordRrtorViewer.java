...
public class SpreProjectRecordRrtorViewer extends AbstractDetailViewer
{
	...
	public SpreProjectRecordRrtorViewer() {
	}
	...
	public void load() {
		...
		params.put("preProjectRecordId", getBusinessId());
		DBDataSource.callOperation("NQ_SpreProjectRecordRrtor", "find", new DSCallback() {
			@Override
