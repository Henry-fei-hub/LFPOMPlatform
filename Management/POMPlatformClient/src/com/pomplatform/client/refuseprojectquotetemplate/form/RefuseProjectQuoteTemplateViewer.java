...
public class RefuseProjectQuoteTemplateViewer extends AbstractDetailViewer
{
	...
	public RefuseProjectQuoteTemplateViewer() {
	}
	...
	public String getName() {
		return "RefuseProjectQuoteTemplate";
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_RefuseProjectQuoteTemplate", "find", new DSCallback() {
			@Override
