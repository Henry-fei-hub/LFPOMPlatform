...
public class CDOnSupplierInfo extends DataSource
{


	public static CDOnSupplierInfo instance = null;

	public static CDOnSupplierInfo getInstance() {
		if(instance == null) {
			instance = new CDOnSupplierInfo("CDOnSupplierInfo");
		}
		return instance;
	}
	...
	public CDOnSupplierInfo(String dataSourceID) {
