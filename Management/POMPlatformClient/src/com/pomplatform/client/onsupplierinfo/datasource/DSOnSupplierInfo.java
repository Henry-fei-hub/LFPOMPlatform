package com.pomplatform.client.onsupplierinfo.datasource;
...
public class DSOnSupplierInfo extends DBDataSource
{


	public static DSOnSupplierInfo instance = null;

	public static DSOnSupplierInfo getInstance() {
		if(instance == null) {
			instance = new DSOnSupplierInfo("DSOnSupplierInfo");
		}
		return instance;
	}
	...
	public DSOnSupplierInfo(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("OnSupplierInfo");
		...
		supplierNameField.setLength(255);
		supplierNameField.setRequired(false);
		supplierNameField.setHidden(false);


		supplierContactField = new DataSourceTextField("supplierContact", "供应商负责人");
		supplierContactField.setLength(64);
