...
public class GetBudgetUplodaNewsViewer extends AbstractDetailViewer
{
	...
	public GetBudgetUplodaNewsViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_GetBudgetUplodaNews", "find", new DSCallback() {
			@Override
	...
	public DataSource getMainDataSource() {
		return DSGetBudgetUplodaNews.getInstance();
	}
