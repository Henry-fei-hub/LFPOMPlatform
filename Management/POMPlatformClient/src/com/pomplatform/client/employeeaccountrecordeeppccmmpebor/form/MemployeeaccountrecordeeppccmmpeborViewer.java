...
public class MemployeeaccountrecordeeppccmmpeborViewer extends AbstractDetailViewer
{
	...
	public MemployeeaccountrecordeeppccmmpeborViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Memployeeaccountrecordeeppccmmpebor", "find", new DSCallback() {
			@Override
