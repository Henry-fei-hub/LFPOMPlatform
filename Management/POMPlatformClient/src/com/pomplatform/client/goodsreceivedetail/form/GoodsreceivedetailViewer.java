...
public class GoodsreceivedetailViewer extends AbstractDetailViewer
{
	...
	public GoodsreceivedetailViewer() {
	}
	...
	public void load() {
		...
		params.put("goodsReceiveDetailId", getBusinessId());
		DBDataSource.callOperation("NQ_Goodsreceivedetail", "find", new DSCallback() {
			@Override
