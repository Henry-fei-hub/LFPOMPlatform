package com.pomplatform.client.goodsreceivedetail.panel;
...
import com.pomplatform.client.goodsreceivedetail.form.GoodsreceivedetailSearchForm;
import com.pomplatform.client.goodsreceivedetail.form.GoodsreceivedetailViewer;
import com.pomplatform.client.goodsreceivedetail.form.NewGoodsreceivedetailForm;
import com.pomplatform.client.goodsreceivedetail.form.UpdateGoodsreceivedetailForm;
...
public class GoodsreceivedetailPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			GoodsreceivedetailPanel cm = new GoodsreceivedetailPanel();
			id = cm.getID();
			return cm;
		}
	...
	public void initComponents() {
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateGoodsreceivedetailForm detailForm = new UpdateGoodsreceivedetailForm();
		...
		IButton operation2Button = new IButton("查看明细");
		...
		operation3Button.addClickHandler(new ClickHandler(){
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					@Override
					public void onSuccess() {
						NewGoodsreceivedetailForm detailForm = new NewGoodsreceivedetailForm();
		...
		removeButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				DBDataSource.callOperation("ST_Goodsreceivedetail", "delete", selected.toMap(), new DSCallback() {
					@Override
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("Goodreceivedetail"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				GoodsreceivedetailViewer detailForm = new GoodsreceivedetailViewer();
	...
	public boolean checkSearchCriteria(Map criteria) {
		criteria.put("addtionalCondition", "order by goods_receive_detail_id");
	...
	public SearchForm generateSearchForm() {
		return new GoodsreceivedetailSearchForm();
	}
