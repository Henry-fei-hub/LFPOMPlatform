...
public class OnLoadFlowPersonnelBuisnessDataViewer extends AbstractDetailViewer
{
	...
	public OnLoadFlowPersonnelBuisnessDataViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadFlowPersonnelBuisnessData", "find", new DSCallback() {
			@Override
