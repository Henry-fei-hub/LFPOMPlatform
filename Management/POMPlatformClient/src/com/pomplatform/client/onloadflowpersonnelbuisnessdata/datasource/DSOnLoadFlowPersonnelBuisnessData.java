package com.pomplatform.client.onloadflowpersonnelbuisnessdata.datasource;
...
public class DSOnLoadFlowPersonnelBuisnessData extends DBDataSource
{


	public static DSOnLoadFlowPersonnelBuisnessData instance = null;

	public static DSOnLoadFlowPersonnelBuisnessData getInstance() {
		if(instance == null) {
			instance = new DSOnLoadFlowPersonnelBuisnessData("DSOnLoadFlowPersonnelBuisnessData");
		}
		return instance;
	}
	...
	public DSOnLoadFlowPersonnelBuisnessData(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("OnLoadFlowPersonnelBuisnessData");
		...
		map.put("1", "项目");
		map.put("2", "前期项目");
		projectTypeField.setValueMap(map);
		...
		costAttributionField = new DataSourceIntegerField("costAttribution", "费用归属");
		...
		empStatusField.setHidden(false);
		empStatusField.setValueMap(KeyValueManager.getValueMap("system_dictionary_11"));
		...
		setFields(processPooledTaskIdField, processInstanceActivityIdField, personnelBusinessIdField, processTypeNameField, typeFlagField, businessIdField, businessNameField, processActivityIdField, processIdField, processInstanceIdField, nodeTypeField, activityIdField, nextActivityIdField, mainActivityIdField, instanceActivityCreateTimeField, instanceActivityStartTimeField, operateTimeField, processCommentField, statusField, activityTypeField, backViewNameField, processTypeField, employeeIdField, employeeNoField, departmentIdField, companyIdField, typeField, startDateField, startDateDetailField, endDateField, endDateDetailField, daysField, reasonField, addressField, planField, transportationField, feeField, unitField, contactPersonField, deleteFlagField, nextAuditorField, subTypeField, hoursField, companyProvinceField, targetProvinceField, numberOfBabyField, attachmentField, isCompletedField, subTypeStrField, projectTypeField, projectIdField, projectNameField, projectCodeField, parentIdField, isRemoteCityField, provideAccommodationField, livingExpensesField, housingFinanceField, drafterField, cardField, dutyIdField, equivalentNumberField, linkIdField, severanceField, salary1Field, salary2Field, originalPayField, monthPayField, basicProportionStrField, basicProportionField, monthBasicPayField, monthPerformancePayField, foremanPayField, otherSubsidyField, totalPayField, annualPerformanceField, costAttributionField, certificationTimeField, projectIdsField, paymentSequenceIdField, budgetManagementIdField, budgetAttachmentIdField,applyEmployeeIdField,onboardDateField,ownedCompanyField, stageIdField, empStatusField, remarkField, createTimeField);
	}
