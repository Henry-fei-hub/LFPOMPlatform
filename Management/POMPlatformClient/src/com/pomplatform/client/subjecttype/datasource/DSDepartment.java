...
public class DSDepartment extends DBDataSource
{
	...
	public DSDepartment(String dataSourceID) {
		...
		setFields(departmentIdField,hasSelectedField, departmentNameField, abbreviationField, managerIdField, managerNameField, parentIdField, enabledField, originalIdField, plateIdField, isHeadcountField);
	}
