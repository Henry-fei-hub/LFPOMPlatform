...
public class SubjectDepartmentViewer extends AbstractDetailViewer
{




	public SubjectDepartmentViewer() {
	}
	...
	public void load() {
		...
		params.put("subjectDepartmentId", getBusinessId());
		DBDataSource.callOperation("ST_SubjectDepartment", "find", new DSCallback() {
			@Override
	...
	public DataSource getMainDataSource() {
		return DSSubjectDepartment.getInstance();
	}
