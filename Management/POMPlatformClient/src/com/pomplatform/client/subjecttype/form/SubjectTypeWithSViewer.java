...
public class SubjectTypeWithSViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		DBDataSource.callOperation("ST_SubjectTypeWithS", "find", new DSCallback() {
			@Override
