...
public class PlateIntegralSendsViewer extends AbstractDetailViewer
{
	...
	public PlateIntegralSendsViewer() {
	}
	...
	public void load() {
		...
		params.put("plateIntegralSendId", getBusinessId());
		DBDataSource.callOperation("NQ_PlateIntegralSends", "find", new DSCallback() {
			@Override
