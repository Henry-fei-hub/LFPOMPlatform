...
public class CwdFilingTemplateViewer extends AbstractDetailViewer
{




	public CwdFilingTemplateViewer() {
	}
	...
	public void load() {
		...
		params.put("cwdFilingTemplateId", getBusinessId());
		DBDataSource.callOperation("ST_CwdFilingTemplate", "find", new DSCallback() {
			@Override
