...
public class CompanyWorkplaceServerViewer extends AbstractDetailViewer
{




	public CompanyWorkplaceServerViewer() {
	}
	...
	public void load() {
		...
		params.put("workplaceServerId", getBusinessId());
		DBDataSource.callOperation("ST_CompanyWorkplaceServer", "find", new DSCallback() {
			@Override
	...
	public DataSource getMainDataSource() {
		return DSCompanyWorkplaceServer.getInstance();
	}
