...
public class OssConfigManageViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		params.put("ossConfigId", getBusinessId());
		DBDataSource.callOperation("NQ_OssConfigManage", "find", new DSCallback() {
			@Override
