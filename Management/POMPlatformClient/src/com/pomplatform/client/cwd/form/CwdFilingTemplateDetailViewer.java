...
public class CwdFilingTemplateDetailViewer extends AbstractDetailViewer
{




	public CwdFilingTemplateDetailViewer() {
	}
	...
	public void load() {
		...
		params.put("cwdFilingTemplateDetailId", getBusinessId());
		DBDataSource.callOperation("ST_CwdFilingTemplateDetail", "find", new DSCallback() {
			@Override
