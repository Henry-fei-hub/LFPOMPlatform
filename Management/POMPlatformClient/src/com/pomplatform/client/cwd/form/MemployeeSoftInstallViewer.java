...
public class MemployeeSoftInstallViewer extends AbstractDetailViewer
{
	...
	public MemployeeSoftInstallViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_MemployeeSoftInstall", "find", new DSCallback() {
			@Override
