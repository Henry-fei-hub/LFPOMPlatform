...
public class CompanyWorkplaceAndServerManageNewForm extends AbstractWizadPage
{
	...
	public CompanyWorkplaceAndServerManageNewForm() {
		...
		hasInitItem.setDefaultValue(false);
