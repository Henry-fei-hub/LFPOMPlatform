...
public class SoftwareUpdateFileViewer extends AbstractDetailViewer
{




	public SoftwareUpdateFileViewer() {
	}
	...
	public void load() {
		...
		params.put("softwareUpdateFileId", getBusinessId());
		DBDataSource.callOperation("ST_SoftwareUpdateFile", "find", new DSCallback() {
			@Override
	...
	public DataSource getMainDataSource() {
		return DSSoftwareUpdateFile.getInstance();
	}
