...
public class ScwdfilingmaintemplatetrcorUpdateForm extends AbstractWizadPage {
	...
	public ScwdfilingmaintemplatetrcorUpdateForm() {
		...
		cwdFilingMainTemplateIdItem.setDisabled(true);
		cwdFilingMainTemplateIdItem.setRequired(true);
		cwdFilingMainTemplateIdItem.setHidden(true);
		IsIntegerValidator cwdFilingMainTemplateIdValidator = new IsIntegerValidator();
		cwdFilingMainTemplateIdItem.setValidators(cwdFilingMainTemplateIdValidator);
		__formItems.add(cwdFilingMainTemplateIdItem);
