...
public class PersonalRegisterAddressManageUpdateForm extends AbstractWizadPage
{


	private final TextItem personalRegisterAddressIdItem;
	...
	public PersonalRegisterAddressManageUpdateForm() {
		DSPersonalRegisterAddressManage ds = DSPersonalRegisterAddressManage.getInstance();
		__form.setWidth100();
		__form.setHeight100();
		personalRegisterAddressIdItem = new TextItem("personalRegisterAddressId", "工作场所编码");
		personalRegisterAddressIdItem.setDisabled(true);
		personalRegisterAddressIdItem.setRequired(true);
		IsIntegerValidator personalRegisterAddressIdValidator = new IsIntegerValidator();
		personalRegisterAddressIdItem.setValidators(personalRegisterAddressIdValidator);
		personalRegisterAddressIdItem.hide();
		__formItems.add(personalRegisterAddressIdItem);
