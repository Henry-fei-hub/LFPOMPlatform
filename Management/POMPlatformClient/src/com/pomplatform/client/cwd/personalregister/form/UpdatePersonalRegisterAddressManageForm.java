...
public class UpdatePersonalRegisterAddressManageForm extends GenericWizadWindow
{
	...
	public String getActionName(){
		// 需要根据实际业务修改
		return "ST_PersonalRegisterAddress";
	}
	...
	public List<AbstractWizadPage> getPages(){
		...
		res.add(new PersonalRegisterAddressManageUpdateForm());
		return res;
	}
