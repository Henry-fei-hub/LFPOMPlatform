...
public class PersonalRegisterAddressManageViewer extends AbstractDetailViewer
{
	...
	public PersonalRegisterAddressManageViewer() {
	}
	...
	public void load() {
		...
		params.put("personalRegisterAddressId", getBusinessId());
		DBDataSource.callOperation("NQ_PersonalRegisterAddressManage", "find", new DSCallback() {
			@Override
