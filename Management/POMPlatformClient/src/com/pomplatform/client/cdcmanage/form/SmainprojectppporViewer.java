...
public class SmainprojectppporViewer extends AbstractDetailViewer
{
	...
	public SmainprojectppporViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Smainprojectpppor", "find", new DSCallback() {
			@Override
