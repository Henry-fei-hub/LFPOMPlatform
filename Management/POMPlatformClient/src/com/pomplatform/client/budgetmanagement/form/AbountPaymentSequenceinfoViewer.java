...
public class AbountPaymentSequenceinfoViewer extends AbstractDetailViewer
{
	...
	public AbountPaymentSequenceinfoViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_AbountPaymentSequenceinfo", "find", new DSCallback() {
			@Override
