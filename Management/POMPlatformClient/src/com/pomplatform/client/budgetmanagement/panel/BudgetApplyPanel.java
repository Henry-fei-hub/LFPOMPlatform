...
public class BudgetApplyPanel extends VLayout implements HasHandlers{
...
//		projectItem.setValueMap(KeyValueManager.getValueMap("projects"));
		...
		searchForm.setFields(bdtypeItem,bdTotalAmountItem,bdApplyTimeItem,bdEstimatecloseTimeItem,bdApplyEmployeeIdItem,projectItem,remarkItem);
