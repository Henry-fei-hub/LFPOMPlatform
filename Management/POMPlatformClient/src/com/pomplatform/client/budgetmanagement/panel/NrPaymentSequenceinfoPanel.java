...
public class NrPaymentSequenceinfoPanel extends HLayout implements HasHandlers{
...
//		aFields[a].setValueMap(KeyValueManager.getValueMap("receive_unit_manages_company"));
		...
		grid.setHeaderSpans(new HeaderSpan(shouldNotBeNull+"预算付款序列", new String[] {"budgetManagementId","attachmentName","fileUrl","budgetAttachmentId","payDate","payAmount","receiveUnitManageId","psRemark"}));
	...
	public void lodaDate() {
		//获取项目ID
		int projectId=record[0].getAttributeAsInt("projectId");
