...
public class McontractisubccacccorViewer extends AbstractDetailViewer
{
	...
	public McontractisubccacccorViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Mcontractisubccacccor", "find", new DSCallback() {
			@Override
