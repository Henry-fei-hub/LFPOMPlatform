...
public class DSMcontractisubccacccor extends DBDataSource
{


	public static DSMcontractisubccacccor instance = null;

	public static DSMcontractisubccacccor getInstance() {
		if(instance == null) {
			instance = new DSMcontractisubccacccor("DSMcontractisubccacccor");
		}
		return instance;
	}
	...
	public DSMcontractisubccacccor(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("Mcontractisubccacccor");
