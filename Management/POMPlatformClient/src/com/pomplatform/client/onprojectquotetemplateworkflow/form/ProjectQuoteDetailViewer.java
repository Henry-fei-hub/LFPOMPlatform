...
public class ProjectQuoteDetailViewer extends AbstractDetailViewer
{




	public ProjectQuoteDetailViewer() {
	}
	...
	public void load() {
		...
		params.put("projectQuoteDetailId", getBusinessId());
		DBDataSource.callOperation("ST_ProjectQuoteDetail", "find", new DSCallback() {
			@Override
	...
	public DataSource getMainDataSource() {
		return DSProjectQuoteDetail.getInstance();
	}
