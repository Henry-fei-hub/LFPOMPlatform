...
public class OnProjectQuoteTemplateUpdateForm extends AbstractWizadPage
{
	...
	public OnProjectQuoteTemplateUpdateForm() {
	...
	public void startEdit() {
		Record recordAll=getRecord();
		java.util.Map condition = null;
		condition = new java.util.HashMap();
		//获取项目ID
		int projectId=BaseHelpUtils.getIntValue(recordAll.getAttribute("projectId")); 
		...
		condition.put("projectQuoteId", recordAll.getAttributeAsString("projectQuoteId"));
		...
		//获取模板父级ID
		int projectQuoteTemplatesParentId=BaseHelpUtils.getIntValue(recordAll.getAttribute("projectQuoteTemplatesParentId"));
