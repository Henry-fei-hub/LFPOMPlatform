...
public class SalaryExceptionViewer extends AbstractDetailViewer
{




	public SalaryExceptionViewer() {
	}
	...
	public void load() {
		...
		params.put("salaryExceptionId", getBusinessId());
		DBDataSource.callOperation("ST_SalaryException", "find", new DSCallback() {
			@Override
	...
	public DataSource getMainDataSource() {
		return DSSalaryException.getInstance();
	}
