package com.pomplatform.client.salaryexceptions.panel;
...
import com.pomplatform.client.salaryexceptions.form.OnSalaryExceptionsSearchForm;
import com.pomplatform.client.salaryexceptions.form.OnSalaryExceptionsViewer;
import com.pomplatform.client.salaryexceptions.form.NewOnSalaryExceptionsForm;
import com.pomplatform.client.salaryexceptions.form.UpdateOnSalaryExceptionsForm;
...
public class OnSalaryExceptionsPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			OnSalaryExceptionsPanel cm = new OnSalaryExceptionsPanel();
			id = cm.getID();
			return cm;
		}
	...
	public void initComponents() {
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						NewOnSalaryExceptionsForm detailForm = new NewOnSalaryExceptionsForm();
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateOnSalaryExceptionsForm detailForm = new UpdateOnSalaryExceptionsForm();
		...
		removeButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				DBDataSource.callOperation("ST_OnSalaryExceptions", "delete", selected.toMap(), new DSCallback() {
					@Override
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("工资异常申请"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				OnSalaryExceptionsViewer detailForm = new OnSalaryExceptionsViewer();
	...
	public SearchForm generateSearchForm() {
		return new OnSalaryExceptionsSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSOnSalaryExceptions.getInstance();
	}
