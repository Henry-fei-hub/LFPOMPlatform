...
public class CDOnSalaryExceptions extends DataSource
{


	public static CDOnSalaryExceptions instance = null;

	public static CDOnSalaryExceptions getInstance() {
		if(instance == null) {
			instance = new CDOnSalaryExceptions("CDOnSalaryExceptions");
		}
		return instance;
	}
	...
	public CDOnSalaryExceptions(String dataSourceID) {
