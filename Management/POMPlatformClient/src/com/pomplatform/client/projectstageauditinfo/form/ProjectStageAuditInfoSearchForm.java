...
import com.pomplatform.client.projectstageauditinfo.datasource.CDProjectStageAuditInfo;

public class ProjectStageAuditInfoSearchForm extends SearchForm
{
	...
	public ProjectStageAuditInfoSearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDProjectStageAuditInfo.getInstance());
