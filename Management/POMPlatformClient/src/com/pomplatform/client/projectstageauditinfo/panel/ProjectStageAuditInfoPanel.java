package com.pomplatform.client.projectstageauditinfo.panel;
...
import com.pomplatform.client.projectstageauditinfo.form.ProjectStageAuditInfoSearchForm;
import com.pomplatform.client.projectstageauditinfo.form.ProjectStageAuditInfoViewer;
import com.pomplatform.client.projectstageauditinfo.form.NewProjectStageAuditInfoForm;
import com.pomplatform.client.projectstageauditinfo.form.UpdateProjectStageAuditInfoForm;
...
public class ProjectStageAuditInfoPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			ProjectStageAuditInfoPanel cm = new ProjectStageAuditInfoPanel();
			id = cm.getID();
			return cm;
		}
	...
	public void initComponents() {
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						NewProjectStageAuditInfoForm detailForm = new NewProjectStageAuditInfoForm();
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateProjectStageAuditInfoForm detailForm = new UpdateProjectStageAuditInfoForm();
		...
		removeButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				DBDataSource.callOperation("ST_ProjectStageAuditInfo", "delete", selected.toMap(), new DSCallback() {
					@Override
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("ProjectStageAuditInfo"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				ProjectStageAuditInfoViewer detailForm = new ProjectStageAuditInfoViewer();
	...
	public SearchForm generateSearchForm() {
		return new ProjectStageAuditInfoSearchForm();
	}
