...
public class DSProjectStageAuditInfo extends DBDataSource
{


	public static DSProjectStageAuditInfo instance = null;

	public static DSProjectStageAuditInfo getInstance() {
		if(instance == null) {
			instance = new DSProjectStageAuditInfo("DSProjectStageAuditInfo");
		}
		return instance;
	}
	...
	public DSProjectStageAuditInfo(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("ProjectStageAuditInfo");
