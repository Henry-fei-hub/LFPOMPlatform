...
public class SannoucementaaaorViewer extends AbstractDetailViewer
{
	...
	public SannoucementaaaorViewer() {
	}
	...
	public void load() {
		...
		params.put("annoucementId", getBusinessId());
		DBDataSource.callOperation("NQ_Sannoucementaaaor", "find", new DSCallback() {
			@Override
