...
public class AnnoucementUpdateForm extends AbstractWizadPage {
	...
	public AnnoucementUpdateForm() {
		...
		annoucementEmployeeIdsItem.setDefaultToFirstOption(true);
	...
	public void startEdit() {
		if(getRecord() != null) {
			...
			String idStr = record.getAttribute("annoucementEmployeeIds");
			if(!BaseHelpUtils.isNullOrEmpty(idStr)){
				String [] strArra = idStr.split(",");
				record.setAttribute("annoucementEmployeeIds", strArra);
			}
