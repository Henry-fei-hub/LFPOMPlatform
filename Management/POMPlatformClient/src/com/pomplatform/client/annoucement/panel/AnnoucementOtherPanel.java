...
import com.pomplatform.client.annoucement.datasource.DSSannoucementaaaorOther;
import com.pomplatform.client.annoucement.form.NewAnnoucementForm;
import com.pomplatform.client.annoucement.form.OtherSannoucementaaaorSearchForm;
...
public class AnnoucementOtherPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			AnnoucementOtherPanel cm = new AnnoucementOtherPanel();
			id = cm.getID();
			return cm;
		}
...
//		});
	...
	public boolean checkSearchCriteria(Map criteria) {
		...
		criteria.put("selfEmployeeId", ClientUtil.getEmployeeId());
		criteria.put("optType", "findAnnoucement");
		return true;
	}
	...
	public SearchForm generateSearchForm() {
		return new OtherSannoucementaaaorSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSSannoucementaaaorOther.getInstance();
	}
