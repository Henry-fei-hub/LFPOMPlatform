...
public class ProductionValueCoefficientViewer extends AbstractDetailViewer
{
	...
	public ProductionValueCoefficientViewer() {
	}
	...
	public void load() {
		...
		params.put("productionValueCoefficientId", getBusinessId());
		DBDataSource.callOperation("NQ_ProductionValueCoefficient", "find", new DSCallback() {
			@Override
