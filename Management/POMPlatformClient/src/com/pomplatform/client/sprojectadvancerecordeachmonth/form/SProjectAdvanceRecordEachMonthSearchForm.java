package com.pomplatform.client.sprojectadvancerecordeachmonth.form;
...
import com.pomplatform.client.sprojectadvancerecordeachmonth.datasource.CDSProjectAdvanceRecordEachMonth;

public class SProjectAdvanceRecordEachMonthSearchForm extends SearchForm
{
	...
	public SProjectAdvanceRecordEachMonthSearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDSProjectAdvanceRecordEachMonth.getInstance());
