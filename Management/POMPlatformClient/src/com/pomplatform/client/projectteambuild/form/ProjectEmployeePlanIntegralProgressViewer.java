...
public class ProjectEmployeePlanIntegralProgressViewer extends AbstractDetailViewer
{
	...
	public ProjectEmployeePlanIntegralProgressViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ProjectEmployeePlanIntegralProgress", "find", new DSCallback() {
			@Override
