...
public class SprojectteambuildViewer extends AbstractDetailViewer
{
	...
	public SprojectteambuildViewer() {
	}
	...
	public void viewSelectedData(ListGrid grid){
		...
		condition.put("projectId", selected.getAttribute("projectId"));
