...
public class DSNormalReimbursementLinkMainProject extends DBDataSource {

	public static DSNormalReimbursementLinkMainProject instance = null;

	public static DSNormalReimbursementLinkMainProject getInstance() {
		if (instance == null) {
			instance = new DSNormalReimbursementLinkMainProject("DSNormalReimbursementLinkMainProject");
		}
		return instance;
	}
	...
	public DSNormalReimbursementLinkMainProject(String dataSourceID) {
		...
		normalReimbursementLinkMainProjectIdField = new DataSourceIntegerField("normalReimbursementLinkMainProjectId",
				"主键编码");
		...
		setFields(mainItemIdField, subItemIdField, remarkField, normalReimbursementLinkMainProjectIdField,
				projectNormalReimbursementIdField, mainProjectIdField, mainProjectNameField, infoCodeField,
