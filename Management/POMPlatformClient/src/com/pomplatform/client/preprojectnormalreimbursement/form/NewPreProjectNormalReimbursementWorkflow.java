...
public class NewPreProjectNormalReimbursementWorkflow extends AbstractProcessPanel
{
	...
	public List<AbstractWizadPage> getPages(){
		...
		final PreProjectNormalReimbursementNewForm main = new PreProjectNormalReimbursementNewForm();
        ...
        final NormalReimbursementLinkMainProjectPanel link = new NormalReimbursementLinkMainProjectPanel(null);
