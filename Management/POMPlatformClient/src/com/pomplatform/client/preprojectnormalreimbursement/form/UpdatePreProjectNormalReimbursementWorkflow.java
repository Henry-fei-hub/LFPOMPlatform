...
public class UpdatePreProjectNormalReimbursementWorkflow extends AbstractProcessPanel {
	...
	public List<AbstractWizadPage> getPages() {
		...
		final PreProjectNormalReimbursementUpdateForm main = new PreProjectNormalReimbursementUpdateForm();
		...
		final NormalReimbursementLinkMainProjectPanel link = new NormalReimbursementLinkMainProjectPanel(processName);
