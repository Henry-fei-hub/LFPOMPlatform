...
public class NewPreProjectNormalReimbursementForm extends GenericWizadWindow
{
	...
	public List<AbstractWizadPage> getPages(){
		...
		res.add(new PreProjectNormalReimbursementNewForm());
		res.add(new ProjectNormalReimbursementDetailProjectNormalReimbursementDetail());
		res.add(new ProjectNormalReimbursementDetailNormalReimbursementLinkMainProject());
		return res;
	}
