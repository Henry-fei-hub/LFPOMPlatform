...
public class DSSprojectstagestorageor2 extends DBDataSource
{


	public static DSSprojectstagestorageor2 instance = null;

	public static DSSprojectstagestorageor2 getInstance() {
		if(instance == null) {
			instance = new DSSprojectstagestorageor2("DSSprojectstagestorageor");
		}
		return instance;
	}
	...
	public DSSprojectstagestorageor2(String dataSourceID) {
		...
		riginalPlanField = new DataSourceIntegerField("riginalPlan", "是否原策划阶段 ");
		riginalPlanField.setLength(11);
		riginalPlanField.setRequired(false);
		riginalPlanField.setHidden(true);
		...
		projectConfirmAmountField.setHidden(true);


		tabAmountField = new DataSourceIntegerField("tabAmount", "是否跨阶段 ");
		tabAmountField.setLength(11);
		tabAmountField.setRequired(false);
		tabAmountField.setHidden(true);
		
		projectTemplateIdField = new DataSourceIntegerField("projectTemplateId", "项目阶段模板");
		projectTemplateIdField.setLength(11);
		projectTemplateIdField.setRequired(false);
		projectTemplateIdField.setHidden(true);


		setFields(projectStageStorageIdField, projectIdField, stageIdField, stageNameField, percentField, projectAmountField, remarkField, riginalPlanField, projectConfirmAmountField, tabAmountField,projectTemplateIdField);
	}
