...
public class SprojectstagestorageporViewer extends AbstractDetailViewer
{
	...
	public SprojectstagestorageporViewer() {
	}
	...
	public DataSource getMainDataSource() {
		return DSSprojectstagestoragepor.getInstance();
	}
