...
public class SprojectstagestorageorViewer extends AbstractDetailViewer
{
	...
	public SprojectstagestorageorViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Sprojectstagestorageor", "find", new DSCallback() {
			@Override
