...
public class SprojectPricePanelNewForm extends AbstractWizadPage {
    ...
    public SprojectPricePanelNewForm() {
        ...
        __form.setItems(plateIdItem, areaIdItem, gradeIdItem, squareIdItem, minSquareItem, maxSquareItem, unitPriceItem);
