...
public class FinancicalCapitalAnalysisViewer extends AbstractDetailViewer
{
	...
	public FinancicalCapitalAnalysisViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_FinancicalCapitalAnalysis", "find", new DSCallback() {
			@Override
