...
public class ScapitalipcorViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Scapitalipcor", "find", new DSCallback() {
			@Override
