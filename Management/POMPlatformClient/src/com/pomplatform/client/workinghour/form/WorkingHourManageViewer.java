...
public class WorkingHourManageViewer extends AbstractDetailViewer
{
	...
	public WorkingHourManageViewer() {
	}
	...
	public void load() {
		...
		params.put("workingHourId", getBusinessId());
		DBDataSource.callOperation("NQ_WorkingHourManage", "find", new DSCallback() {
			@Override
