...
public class DSCapitalDsitributionemployee extends DBDataSource
{


	public static DSCapitalDsitributionemployee instance = null;

	public static DSCapitalDsitributionemployee getInstance() {
		if(instance == null) {
			instance = new DSCapitalDsitributionemployee("DSCapitalDsitributionemployee");
		}
		return instance;
	}
	...
	public DSCapitalDsitributionemployee(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("CapitalDsitributionemployee");
