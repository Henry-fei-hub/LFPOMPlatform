...
public class MemployeeaccountrecordespemmorViewer extends AbstractDetailViewer
{
	...
	public MemployeeaccountrecordespemmorViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Memployeeaccountrecordespemmor", "find", new DSCallback() {
			@Override
