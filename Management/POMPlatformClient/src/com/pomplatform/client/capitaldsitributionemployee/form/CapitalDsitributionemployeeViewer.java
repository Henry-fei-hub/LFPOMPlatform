...
public class CapitalDsitributionemployeeViewer extends AbstractDetailViewer
{
	...
	public CapitalDsitributionemployeeViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_CapitalDsitributionemployee", "find", new DSCallback() {
			@Override
