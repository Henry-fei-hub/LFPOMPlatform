...
public class StrainingmanagementdetailorViewer extends AbstractDetailViewer
{
	...
	public StrainingmanagementdetailorViewer() {
	}
	...
	public void load() {
		...
		params.put("trainingManagementDetailId", getBusinessId());
		DBDataSource.callOperation("NQ_Strainingmanagementdetailor", "find", new DSCallback() {
			@Override
