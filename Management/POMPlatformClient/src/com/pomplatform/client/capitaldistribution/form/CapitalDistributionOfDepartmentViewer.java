...
public class CapitalDistributionOfDepartmentViewer extends AbstractDetailViewer
{
	...
	public CapitalDistributionOfDepartmentViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_CapitalDistributionOfDepartment", "find", new DSCallback() {
			@Override
