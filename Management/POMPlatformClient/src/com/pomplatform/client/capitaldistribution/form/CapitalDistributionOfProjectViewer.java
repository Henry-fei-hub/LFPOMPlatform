...
public class CapitalDistributionOfProjectViewer extends AbstractDetailViewer
{
	...
	public CapitalDistributionOfProjectViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_CapitalDistributionOfProject", "find", new DSCallback() {
			@Override
