...
public class CapitalDifferenceViewer extends AbstractDetailViewer
{
	...
	public CapitalDifferenceViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_CapitalDifference", "find", new DSCallback() {
			@Override
