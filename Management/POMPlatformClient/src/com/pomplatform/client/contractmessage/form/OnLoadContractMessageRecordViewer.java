...
public class OnLoadContractMessageRecordViewer extends AbstractDetailViewer
{
	...
	public OnLoadContractMessageRecordViewer() {
	}
	...
	public void load() {
		...
		params.put("contractMessageId", getBusinessId());
		DBDataSource.callOperation("NQ_OnLoadContractMessageRecord", "find", new DSCallback() {
			@Override
