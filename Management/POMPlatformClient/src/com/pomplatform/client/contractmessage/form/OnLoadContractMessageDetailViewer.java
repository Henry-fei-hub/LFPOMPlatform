...
public class OnLoadContractMessageDetailViewer extends AbstractDetailViewer
{
	...
	public OnLoadContractMessageDetailViewer() {
	}
	...
	public void load() {
		...
		params.put("contractMessageDetailId", getBusinessId());
		DBDataSource.callOperation("NQ_OnLoadContractMessageDetail", "find", new DSCallback() {
			@Override
