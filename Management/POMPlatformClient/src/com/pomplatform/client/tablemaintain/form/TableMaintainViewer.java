...
public class TableMaintainViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		params.put("tableMaintainId", getBusinessId());
		DBDataSource.callOperation("NQ_TableMaintain", "find", new DSCallback() {
			@Override
	...
	public DataSource getMainDataSource() {
		return DSTableMaintain.getInstance();
	}
