...
import com.pomplatform.client.employeesalary.datasource.DSEmployeeSalaryDetailMonth;
import com.pomplatform.client.employeesalary.form.EmployeeSalaryDetailMonthViewer;
...
public class EmployeeSalaryDetailMonthPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			EmployeeSalaryDetailMonthPanel cm = new EmployeeSalaryDetailMonthPanel();
			id = cm.getID();
			return cm;
		}
		...
		public String getDescription() {
			return "EmployeeSalaryDetailMonth";
		}
			...
			public void onClick(ClickEvent event) {
				...
				if (len > 0) {
					...
					for (int i = 0; i < len; i++) {
						...
						salary += ClientUtil.checkAndGetDoubleValue(recordList[i].getAttribute("basicSalary"));
						records[i] = recordList[i];
					}
					Record record = new Record();
					record.setAttribute("employeeId", "汇总");
					record.setAttribute("basicSalary", salary);
					records[len] = record;
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("员工每月人工成本"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				EmployeeSalaryDetailMonthViewer detailForm = new EmployeeSalaryDetailMonthViewer();
	...
	public SearchForm generateSearchForm() {
		// return new EmployeeSalaryDetailMonthSearchForm();
		return null;
	}

	@Override
	public DataSource getDataSource() {
		return DSEmployeeSalaryDetailMonth.getInstance();
	}
	...
	public void commonQuery() {
        ...
        DBDataSource.callOperation("EP_EmployeeSalaryDetailMonthProcessor", condition, new DSCallback() {
            @Override
