...
public class DSSelectGridEmployeeInDepartment extends DBDataSource
{


	public static DSSelectGridEmployeeInDepartment instance = null;

	public static DSSelectGridEmployeeInDepartment getInstance() {
		if(instance == null) {
			instance = new DSSelectGridEmployeeInDepartment("DSSelectGridEmployeeInDepartment");
		}
		return instance;
	}
	...
	public DSSelectGridEmployeeInDepartment(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("SelectGridEmployeeInDepartment");
