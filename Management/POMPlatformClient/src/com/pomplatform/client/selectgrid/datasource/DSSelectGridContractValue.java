...
public class DSSelectGridContractValue extends DBDataSource
{


	public static DSSelectGridContractValue instance = null;

	public static DSSelectGridContractValue getInstance() {
		if(instance == null) {
			instance = new DSSelectGridContractValue("DSSelectGridContractValue");
		}
		return instance;
	}
	...
	public DSSelectGridContractValue(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("SelectGridContractValue");
		...
		contractFollowerField.setLength(200);
