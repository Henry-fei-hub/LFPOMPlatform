...
public class DSSelectGridProjectValue extends DBDataSource
{


	public static DSSelectGridProjectValue instance = null;

	public static DSSelectGridProjectValue getInstance() {
		if(instance == null) {
			instance = new DSSelectGridProjectValue("DSSelectGridProjectValue");
		}
		return instance;
	}
	...
	public DSSelectGridProjectValue(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("SelectGridProjectValue");
