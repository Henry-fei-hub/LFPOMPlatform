...
public class DSSelectGridMyProjectValue extends DBDataSource
{


	public static DSSelectGridMyProjectValue instance = null;

	public static DSSelectGridMyProjectValue getInstance() {
		if(instance == null) {
			instance = new DSSelectGridMyProjectValue("DSSelectGridMyProjectValue");
		}
		return instance;
	}
	...
	public DSSelectGridMyProjectValue(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("SelectGridMyProjectValue");
...
//		parentIdField.setValueMap(KeyValueManager.getValueMap("project_types"));
		...
		projectFlagField = new DataSourceIntegerField("projectFlag", "3管理项目)");
