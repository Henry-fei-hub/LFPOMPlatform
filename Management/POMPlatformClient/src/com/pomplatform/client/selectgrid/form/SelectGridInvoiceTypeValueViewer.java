...
public class SelectGridInvoiceTypeValueViewer extends AbstractDetailViewer
{
	...
	public SelectGridInvoiceTypeValueViewer() {
	}
	...
	public void load() {
		...
		params.put("invoiceTypeId", getBusinessId());
		DBDataSource.callOperation("NQ_SelectGridInvoiceTypeValue", "find", new DSCallback() {
			@Override
