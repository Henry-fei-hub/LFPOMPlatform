...
public class SelectGridProjectValueViewer extends AbstractDetailViewer
{
	...
	public SelectGridProjectValueViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_SelectGridProjectValue", "find", new DSCallback() {
			@Override
