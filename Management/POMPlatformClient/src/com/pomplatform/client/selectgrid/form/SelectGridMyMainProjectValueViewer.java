...
public class SelectGridMyMainProjectValueViewer extends AbstractDetailViewer
{
	...
	public SelectGridMyMainProjectValueViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_SelectGridMyMainProjectValue", "find", new DSCallback() {
			@Override
