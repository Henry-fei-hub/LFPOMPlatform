...
public class SelectGridMyProjectValueViewer extends AbstractDetailViewer
{
	...
	public SelectGridMyProjectValueViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_SelectGridMyProjectValue", "find", new DSCallback() {
			@Override
