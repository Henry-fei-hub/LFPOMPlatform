...
public class SelectGridEmployeeInDepartmentViewer extends AbstractDetailViewer
{
	...
	public SelectGridEmployeeInDepartmentViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_SelectGridEmployeeInDepartment", "find", new DSCallback() {
			@Override
