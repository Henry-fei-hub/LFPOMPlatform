...
public class SelectGridReceiveUnitValueViewer extends AbstractDetailViewer
{
	...
	public SelectGridReceiveUnitValueViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_SelectGridReceiveUnitValue", "find", new DSCallback() {
			@Override
