...
public class RevenueYearStatisticalOfRevenueViewer extends AbstractDetailViewer
{
	...
	public RevenueYearStatisticalOfRevenueViewer() {
	}
	...
	public void load() {
		...
		params.put("revenueYearStatisticalRecordId", getBusinessId());
		DBDataSource.callOperation("NQ_RevenueYearStatisticalOfRevenue", "find", new DSCallback() {
			@Override
