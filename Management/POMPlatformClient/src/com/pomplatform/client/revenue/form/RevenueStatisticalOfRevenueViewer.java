...
public class RevenueStatisticalOfRevenueViewer extends AbstractDetailViewer
{
	...
	public RevenueStatisticalOfRevenueViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_RevenueStatisticalOfRevenue", "find", new DSCallback() {
			@Override
