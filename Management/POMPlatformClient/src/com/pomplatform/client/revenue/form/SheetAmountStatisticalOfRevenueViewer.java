...
public class SheetAmountStatisticalOfRevenueViewer extends AbstractDetailViewer
{




	public SheetAmountStatisticalOfRevenueViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("ST_SheetAmountStatisticalOfRevenue", "find", new DSCallback() {
			@Override
