...
public class PlateRateOfRevenueViewer extends AbstractDetailViewer
{




	public PlateRateOfRevenueViewer() {
	}
	...
	public void load() {
		...
		params.put("plateRateRecordId", getBusinessId());
		DBDataSource.callOperation("ST_PlateRateOfRevenue", "find", new DSCallback() {
			@Override
