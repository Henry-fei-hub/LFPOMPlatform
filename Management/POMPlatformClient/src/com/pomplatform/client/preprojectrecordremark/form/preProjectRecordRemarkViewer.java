...
public class preProjectRecordRemarkViewer extends AbstractDetailViewer
{
	...
	public preProjectRecordRemarkViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_preProjectRecordRemark", "find", new DSCallback() {
			@Override
