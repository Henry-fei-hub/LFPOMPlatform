...
public class MemployeeaaccadpppccorViewer extends AbstractDetailViewer
{
	...
	public MemployeeaaccadpppccorViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Memployeeaaccadpppccor", "find", new DSCallback() {
			@Override
