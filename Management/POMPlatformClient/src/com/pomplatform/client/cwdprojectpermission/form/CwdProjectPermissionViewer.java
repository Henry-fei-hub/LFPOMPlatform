...
public class CwdProjectPermissionViewer extends AbstractDetailViewer
{
	...
	public CwdProjectPermissionViewer() {
	}
	...
	public void load() {
		...
		params.put("cwdProjectPermissionId", getBusinessId());
		DBDataSource.callOperation("NQ_CwdProjectPermission", "find", new DSCallback() {
			@Override
