...
public class EmployeeCardManageViewer extends AbstractDetailViewer
{
	...
	public EmployeeCardManageViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_EmployeeCardManage", "find", new DSCallback() {
			@Override
