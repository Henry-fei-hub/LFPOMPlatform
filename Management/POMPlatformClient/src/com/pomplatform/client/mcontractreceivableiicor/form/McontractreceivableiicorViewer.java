...
public class McontractreceivableiicorViewer extends AbstractDetailViewer
{
	...
	public McontractreceivableiicorViewer() {
	}
	...
	public String getName() {
		return "mcontractreceivableiicor";
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Mcontractreceivableiicor", "find", new DSCallback() {
			@Override
