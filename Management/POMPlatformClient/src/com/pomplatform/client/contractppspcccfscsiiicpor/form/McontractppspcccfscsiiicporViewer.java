...
public class McontractppspcccfscsiiicporViewer extends AbstractDetailViewer
{
	...
	public McontractppspcccfscsiiicporViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Mcontractppspcccfscsiiicpor", "find", new DSCallback() {
			@Override
