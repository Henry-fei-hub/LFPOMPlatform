...
public class DSMcontractppspcccfscsiiicpor extends DBDataSource {

	public static DSMcontractppspcccfscsiiicpor instance = null;

	public static DSMcontractppspcccfscsiiicpor getInstance() {
		if (instance == null) {
			instance = new DSMcontractppspcccfscsiiicpor("DSMcontractppspcccfscsiiicpor");
		}
		return instance;
	}
	...
	public DSMcontractppspcccfscsiiicpor(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("Mcontractppspcccfscsiiicpor");
		...
		customerNameField = new DataSourceTextField("customerName", "合同名称");
...
//		parentIdField.setValueMap(KeyValueManager.getValueMap("project_types"));
		...
		setFields(contractIdField, contractCodeField, contractNameField, customerNameField, startDateField,
				endDateField, statusField, projectCodeField, contractTypeField, projectLevelField,
				totalProjectTimeField, signingMoneySumField, designAreasField, contractPriceField, projectAddressField,
				contractFollowerField, remarkField, contractDateField, signingCompanyNameField, createTimeField,
				updateTimeField, businessTypeField, flowStatusField, serialNumberField, projectTypeField,
				coveredAreaField, professionalCooperationField, provinceField, cityField, detailAddressField,
				customerAddressField, serviceSuggestBookField, projectApprovalTimeField, orderNoField, parentIdField,
				infoCodeField, contractStatusField, clientContractIdField, isFinishField, isSystemAddField,
				operatorField,contractSigningStatusField,msgCountField,msgStatusField);
	}
