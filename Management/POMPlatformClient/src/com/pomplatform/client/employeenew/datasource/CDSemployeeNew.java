...
public class CDSemployeeNew extends DataSource {

    public static CDSemployeeNew instance = null;

    public static CDSemployeeNew getInstance() {
        if (instance == null) {
            instance = new CDSemployeeNew("CDSemployeeNew");
        }
        return instance;
    }
    ...
    public CDSemployeeNew(String dataSourceID) {
...
//        roleIdField.setValueMap(KeyValueManager.getValueMap("roles"));
        ...
        setFields(plateIdField, dutyIdField, employeeNoField, employeeNameField, departmentIdField, roleIdField, gradeIdField, isDepartmentField, genderField, currentPageField, pageLinesField);
