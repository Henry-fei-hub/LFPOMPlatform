...
public final class SemployeeUploadImgForm extends PopupWindow implements HasHandlers {

    private static final Logger __logger = Logger.getLogger("");
    private Map<String, Object> params = new HashMap<>();

    public SemployeeUploadImgForm(final String employeeIdValue, final String employeeNoValue, final String employeeNameValue) {
        super("文件上传");
        setWidth("50%");
        setHeight("50%");
        centerInPage();
...
//                        SC.say("文件上传成功");
        ...
        vertical.setCellSpacing(1);
        formPanel.setWidget(vertical);

        for (int i = 0; i < 5; i++) {
            vertical.setText(i, 0, "");
        }
        vertical.setText(1, 0, "职员编号：" + employeeNoValue);
        vertical.setText(2, 0, "职员姓名：" + employeeNameValue);

        final FileUpload fileUpload = new FileUpload();
        fileUpload.setName("上传头像");
        vertical.setWidget(3, 0, fileUpload);
        ...
        button.addClickHandler(new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                ...
                params.clear();
                params.put("employeeId", employeeIdValue);
                params.put("employeeNo", employeeNoValue);
                ...
                formPanel.setAction(DBDataSource.getServerURL("UP_FileUpLoadToImage"));
                formPanel.submit();
            }
        });
    }
