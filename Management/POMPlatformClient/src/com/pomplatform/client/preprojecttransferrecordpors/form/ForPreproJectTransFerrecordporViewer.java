...
public class ForPreproJectTransFerrecordporViewer extends AbstractDetailViewer
{
	...
	public ForPreproJectTransFerrecordporViewer() {
	}
	...
	public DataSource getMainDataSource() {
		return DSForPreproJectTransFerrecordporDate.getInstance();
	}
