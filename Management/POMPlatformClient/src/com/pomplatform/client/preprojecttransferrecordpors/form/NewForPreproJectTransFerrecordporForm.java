...
public class NewForPreproJectTransFerrecordporForm extends GenericWizadWindow
{
	...
	public String getActionName(){
		// 需要根据实际业务修改
		return "ST_PreProjectTransferRecord";
	}
	...
	public List<AbstractWizadPage> getPages(){
		...
		res.add(new ForPreproJectTransFerrecordporNewForm());
		return res;
	}
