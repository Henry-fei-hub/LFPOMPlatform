package com.pomplatform.client.sprojectsettlementdetaileachmonth.form;
...
import com.pomplatform.client.sprojectsettlementdetaileachmonth.datasource.CDSProjectSettlementDetailEachMonth;

public class SProjectSettlementDetailEachMonthSearchForm extends SearchForm
{
	...
	public SProjectSettlementDetailEachMonthSearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDSProjectSettlementDetailEachMonth.getInstance());
