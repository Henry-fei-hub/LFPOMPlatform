...
import com.pomplatform.client.personnel.datasource.CDOnLoadFlowAttachmentApprovalUpcomingBuisnessData;

public class OnLoadFlowAttachmentApprovalUpcomingBuisnessDataSearchForm extends SearchForm
{
	...
	public OnLoadFlowAttachmentApprovalUpcomingBuisnessDataSearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDOnLoadFlowAttachmentApprovalUpcomingBuisnessData.getInstance());
