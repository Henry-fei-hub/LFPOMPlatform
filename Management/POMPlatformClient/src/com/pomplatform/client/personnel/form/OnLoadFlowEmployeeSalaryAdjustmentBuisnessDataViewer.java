...
public class OnLoadFlowEmployeeSalaryAdjustmentBuisnessDataViewer extends AbstractDetailViewer
{
	...
	public OnLoadFlowEmployeeSalaryAdjustmentBuisnessDataViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadFlowEmployeeSalaryAdjustmentBuisnessData", "find", new DSCallback() {
			@Override
