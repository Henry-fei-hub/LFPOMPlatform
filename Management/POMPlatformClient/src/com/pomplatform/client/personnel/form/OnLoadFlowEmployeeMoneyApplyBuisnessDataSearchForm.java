...
public class OnLoadFlowEmployeeMoneyApplyBuisnessDataSearchForm extends SearchForm
{
	...
	public OnLoadFlowEmployeeMoneyApplyBuisnessDataSearchForm() {
		setWidth100();
		setHeight100();
		...
		setItems(statusItem, employeeIdItem, processTypeItem, companyIdItem, codeItem, employeeNameItem, employeeNoItem, departmentIdItem);
