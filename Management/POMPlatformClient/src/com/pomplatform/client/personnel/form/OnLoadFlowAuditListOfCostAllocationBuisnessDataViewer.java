...
public class OnLoadFlowAuditListOfCostAllocationBuisnessDataViewer extends AbstractDetailViewer
{
	...
	public OnLoadFlowAuditListOfCostAllocationBuisnessDataViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadFlowAuditListOfCostAllocationBuisnessData", "find", new DSCallback() {
			@Override
