...
public class DSOnLoadFlowAuditOfEmployeeOnboardBuisnessData extends DBDataSource
{


	public static DSOnLoadFlowAuditOfEmployeeOnboardBuisnessData instance = null;

	public static DSOnLoadFlowAuditOfEmployeeOnboardBuisnessData getInstance() {
		if(instance == null) {
			instance = new DSOnLoadFlowAuditOfEmployeeOnboardBuisnessData("DSOnLoadFlowAuditOfEmployeeOnboardBuisnessData");
		}
		return instance;
	}
	...
	public DSOnLoadFlowAuditOfEmployeeOnboardBuisnessData(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("OnLoadFlowAuditOfEmployeeOnboardBuisnessData");
		...
		setFields(processPooledTaskIdField, processInstanceActivityIdField, processTypeNameField, typeFlagField, businessIdField, businessNameField, processActivityIdField, processIdField, processInstanceIdField, nodeTypeField, activityIdField, nextActivityIdField, mainActivityIdField, instanceActivityCreateTimeField, instanceActivityStartTimeField, statusField, processTypeField, departmentIdField, employeeNoField, employeeNameField, onboardDateField, ownedCompanyField, dutyIdField, applyEmployeeIdField, operateTimeField, processCommentField, activityTypeField, backViewNameField);
//		setFields(processInstanceIdField, processInstanceActivityIdField, businessIdField, businessNameField, processActivityIdField, processIdField, nodeTypeField, activityIdField, nextActivityIdField, mainActivityIdField, instanceActivityCreateTimeField, instanceActivityStartTimeField, statusField, processTypeField, employeeNoField, employeeNameField, onboardDateField, ownedCompanyField, departmentIdField, dutyIdField,applyEmployeeIdField, operateTimeField, processCommentField, activityTypeField, backViewNameField);
