...
public class DSOnLoadFlowAuditListOfCostAllocationBuisnessData extends DBDataSource
{


	public static DSOnLoadFlowAuditListOfCostAllocationBuisnessData instance = null;

	public static DSOnLoadFlowAuditListOfCostAllocationBuisnessData getInstance() {
		if(instance == null) {
			instance = new DSOnLoadFlowAuditListOfCostAllocationBuisnessData("DSOnLoadFlowAuditListOfCostAllocationBuisnessData");
		}
		return instance;
	}
	...
	public DSOnLoadFlowAuditListOfCostAllocationBuisnessData(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("OnLoadFlowAuditListOfCostAllocationBuisnessData");
...
//		setFields(processPooledTaskIdField, processInstanceActivityIdField, processTypeNameField, typeFlagField, businessIdField, businessNameField, processActivityIdField, processIdField, processInstanceIdField, nodeTypeField, activityIdField, nextActivityIdField, mainActivityIdField, instanceActivityCreateTimeField, instanceActivityStartTimeField, statusField, processTypeField, operateTimeField, processCommentField, activityTypeField, backViewNameField, costTypeField, codeField, nameField, costField, drafterField, reasonField);
	}
