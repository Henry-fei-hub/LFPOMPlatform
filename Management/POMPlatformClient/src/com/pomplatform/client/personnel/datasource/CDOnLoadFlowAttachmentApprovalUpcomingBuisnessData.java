...
public class CDOnLoadFlowAttachmentApprovalUpcomingBuisnessData extends DataSource
{


	public static CDOnLoadFlowAttachmentApprovalUpcomingBuisnessData instance = null;

	public static CDOnLoadFlowAttachmentApprovalUpcomingBuisnessData getInstance() {
		if(instance == null) {
			instance = new CDOnLoadFlowAttachmentApprovalUpcomingBuisnessData("CDOnLoadFlowAttachmentApprovalUpcomingBuisnessData");
		}
		return instance;
	}
	...
	public CDOnLoadFlowAttachmentApprovalUpcomingBuisnessData(String dataSourceID) {
		...
		setFields(employeeIdField, processTypeField, statusField, budgetManagementIdField, attachmentNameField, uploadEmployeeIdField, uploadTimeField, uploadRemarkField, projectIdField, bddTypeField, isApprovalField, departmentIdField, currentPageField, pageLinesField);
