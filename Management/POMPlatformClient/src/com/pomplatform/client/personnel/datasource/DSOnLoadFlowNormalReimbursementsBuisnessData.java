...
public class DSOnLoadFlowNormalReimbursementsBuisnessData extends DBDataSource
{


	public static DSOnLoadFlowNormalReimbursementsBuisnessData instance = null;

	public static DSOnLoadFlowNormalReimbursementsBuisnessData getInstance() {
		if(instance == null) {
			instance = new DSOnLoadFlowNormalReimbursementsBuisnessData("DSOnLoadFlowNormalReimbursementsBuisnessData");
		}
		return instance;
	}
	...
	public DSOnLoadFlowNormalReimbursementsBuisnessData(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("OnLoadFlowNormalReimbursementsBuisnessData");
		...
		businessIdField.setForeignKey("DSNormalReimbursementsAuditOfWorkflow.businessId");
		...
		setFields(processTypeNameField, businessIdField, businessNameField, processActivityIdField, processIdField, processInstanceIdField, backViewNameField, activityTypeField, nodeTypeField, activityIdField, instanceActivityCreateTimeField, instanceActivityStartTimeField, statusField, processTypeField, codeField, employeeIdField, departmentIdField, amountField, companyIdField, operateTimeField, processCommentField, receiveStatusField, titleField);
	}
