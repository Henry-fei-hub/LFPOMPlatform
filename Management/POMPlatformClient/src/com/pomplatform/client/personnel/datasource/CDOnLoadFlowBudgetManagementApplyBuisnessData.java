...
public class CDOnLoadFlowBudgetManagementApplyBuisnessData extends DataSource
{


	public static CDOnLoadFlowBudgetManagementApplyBuisnessData instance = null;

	public static CDOnLoadFlowBudgetManagementApplyBuisnessData getInstance() {
		if(instance == null) {
			instance = new CDOnLoadFlowBudgetManagementApplyBuisnessData("CDOnLoadFlowBudgetManagementApplyBuisnessData");
		}
		return instance;
	}
	...
	public CDOnLoadFlowBudgetManagementApplyBuisnessData(String dataSourceID) {
		...
		setFields(employeeIdField, processTypeField, statusField, bdTypeField, bdCodeField, companyIdField, bdApplyEmployeeIdField, bdApplyTimeField, projectIdField, plateIdField, currentPageField, pageLinesField);
