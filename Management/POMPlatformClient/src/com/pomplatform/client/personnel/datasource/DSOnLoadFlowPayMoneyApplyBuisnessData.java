...
public class DSOnLoadFlowPayMoneyApplyBuisnessData extends DBDataSource
{


	public static DSOnLoadFlowPayMoneyApplyBuisnessData instance = null;

	public static DSOnLoadFlowPayMoneyApplyBuisnessData getInstance() {
		if(instance == null) {
			instance = new DSOnLoadFlowPayMoneyApplyBuisnessData("DSOnLoadFlowPayMoneyApplyBuisnessData");
		}
		return instance;
	}
	...
	public DSOnLoadFlowPayMoneyApplyBuisnessData(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("OnLoadFlowPayMoneyApplyBuisnessData");
		...
		receiveStatusField.setHidden(true);
		...
		payAmountField = new DataSourceFloatField("payAmount", "金额");
		...
		setFields(statusField,processPooledTaskIdField, processInstanceActivityIdField, personnelBusinessIdField, processTypeNameField, codeField,payAmountField, employeeIdField, companyIdField, departmentIdField, operateTimeField, processCommentField,  typeFlagField, businessIdField, businessNameField, processActivityIdField, processIdField, processInstanceIdField, nodeTypeField, activityIdField, nextActivityIdField, mainActivityIdField, instanceActivityCreateTimeField, instanceActivityStartTimeField, activityTypeField, backViewNameField, titleField, reasonField, receiveStatusField, processTypeField, employeeNoField, typeField, startDateField, startDateDetailField, endDateField, endDateDetailField, daysField, remarkField, addressField, planField, transportationField, feeField, unitField, contactPersonField, createTimeField, deleteFlagField, nextAuditorField, subTypeField, hoursField, companyProvinceField, targetProvinceField, numberOfBabyField, attachmentField, isCompletedField, subTypeStrField, projectTypeField, projectIdField, projectNameField, projectCodeField, parentIdField, isRemoteCityField, provideAccommodationField, livingExpensesField, housingFinanceField, drafterField, cardField, dutyIdField, equivalentNumberField, linkIdField, severanceField, salary1Field, salary2Field, originalPayField, monthPayField, basicProportionStrField, basicProportionField, monthBasicPayField, monthPerformancePayField, foremanPayField, otherSubsidyField, totalPayField, annualPerformanceField, costAttributionField, certificationTimeField, projectIdsField, paymentSequenceIdField, budgetManagementIdField, budgetAttachmentIdField, stageIdField, empStatusField);
	}
