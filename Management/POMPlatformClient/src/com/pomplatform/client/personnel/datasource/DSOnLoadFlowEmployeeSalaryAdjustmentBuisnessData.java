...
public class DSOnLoadFlowEmployeeSalaryAdjustmentBuisnessData extends DBDataSource
{


	public static DSOnLoadFlowEmployeeSalaryAdjustmentBuisnessData instance = null;

	public static DSOnLoadFlowEmployeeSalaryAdjustmentBuisnessData getInstance() {
		if(instance == null) {
			instance = new DSOnLoadFlowEmployeeSalaryAdjustmentBuisnessData("DSOnLoadFlowEmployeeSalaryAdjustmentBuisnessData");
		}
		return instance;
	}
	...
	public DSOnLoadFlowEmployeeSalaryAdjustmentBuisnessData(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("OnLoadFlowEmployeeSalaryAdjustmentBuisnessData");
...
//		setFields(processPooledTaskIdField, personnelBusinessIdField, processInstanceActivityIdField, processTypeNameField, typeFlagField, employeeIdField, employeeNoField, targetProvinceField, departmentIdField, startDateField, endDateField, feeField, originalPayField, severanceField, monthPayField, subTypeField, processTypeField, processIdField, processInstanceIdField, businessIdField, processActivityIdField, activityTypeField, nodeTypeField, activityIdField, nextActivityIdField, mainActivityIdField, statusField, deleteFlagField, messageStatusField, businessNameField, backViewNameField, instanceActivityCreateTimeField, instanceActivityStartTimeField, remarkField);
	}
