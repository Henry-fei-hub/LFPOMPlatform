...
public class DSOnLoadFlowTravelReimbursementsApplyBuisnessData extends DBDataSource
{


	public static DSOnLoadFlowTravelReimbursementsApplyBuisnessData instance = null;

	public static DSOnLoadFlowTravelReimbursementsApplyBuisnessData getInstance() {
		if(instance == null) {
			instance = new DSOnLoadFlowTravelReimbursementsApplyBuisnessData("DSOnLoadFlowTravelReimbursementsApplyBuisnessData");
		}
		return instance;
	}
	...
	public DSOnLoadFlowTravelReimbursementsApplyBuisnessData(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("OnLoadFlowTravelReimbursementsApplyBuisnessData");
		...
		businessIdField.setForeignKey("DSOnLoadFlowTravelReimbursementsApplyBuisnessData.businessId");
...
//		applicantField.setValueMap(KeyValueManager.getValueMap("employees"));
		...
		setFields(processInstanceIdField, processInstanceActivityIdField, businessIdField, businessNameField, processActivityIdField, processIdField, nodeTypeField, activityIdField, nextActivityIdField, mainActivityIdField, instanceActivityCreateTimeField, instanceActivityStartTimeField, statusField, processTypeField, codeField, applicantField, departmentIdField, amountField, companyIdField, titleField, operateTimeField, processCommentField,activityTypeField);
	}
