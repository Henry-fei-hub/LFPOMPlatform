...
public class DSOnLoadFlowNormalReimbursementsApplyBuisnessData extends DBDataSource
{


	public static DSOnLoadFlowNormalReimbursementsApplyBuisnessData instance = null;

	public static DSOnLoadFlowNormalReimbursementsApplyBuisnessData getInstance() {
		if(instance == null) {
			instance = new DSOnLoadFlowNormalReimbursementsApplyBuisnessData("DSOnLoadFlowNormalReimbursementsApplyBuisnessData");
		}
		return instance;
	}
	...
	public DSOnLoadFlowNormalReimbursementsApplyBuisnessData(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("OnLoadFlowNormalReimbursementsApplyBuisnessData");
		...
		businessIdField.setForeignKey("DSOnLoadFlowNormalReimbursementsApplyBuisnessData.businessId");
		...
		setFields(processInstanceIdField, processInstanceActivityIdField, businessIdField, businessNameField, processActivityIdField, processIdField, nodeTypeField, activityIdField, nextActivityIdField, mainActivityIdField, instanceActivityCreateTimeField, instanceActivityStartTimeField, statusField, processTypeField, codeField, employeeIdField, departmentIdField, amountField, companyIdField, titleField, operateTimeField, processCommentField,activityTypeField);
	}
