...
public class DSOnLoadFlowRefuseListOfCostAllocationBuisnessData extends DBDataSource
{


	public static DSOnLoadFlowRefuseListOfCostAllocationBuisnessData instance = null;

	public static DSOnLoadFlowRefuseListOfCostAllocationBuisnessData getInstance() {
		if(instance == null) {
			instance = new DSOnLoadFlowRefuseListOfCostAllocationBuisnessData("DSOnLoadFlowRefuseListOfCostAllocationBuisnessData");
		}
		return instance;
	}
	...
	public DSOnLoadFlowRefuseListOfCostAllocationBuisnessData(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("OnLoadFlowRefuseListOfCostAllocationBuisnessData");
		...
		setFields(processPooledTaskIdField, processInstanceActivityIdField, preProjectTransferRecordIdField,statusField,processInstanceIdField, preProjectTransferRecordIdField, customerNameField, projectNameField,businessTypeField,provinceField, cityField, processInstanceActivityIdField, businessIdField, businessNameField, processActivityIdField, processIdField, nodeTypeField, activityIdField, nextActivityIdField, mainActivityIdField, instanceActivityCreateTimeField, instanceActivityStartTimeField,  processTypeField,  processCommentField, activityTypeField, backViewNameField, employeeIdField, transferEmployeeIdField, operateTimeField,preProjectIdField);
	}
