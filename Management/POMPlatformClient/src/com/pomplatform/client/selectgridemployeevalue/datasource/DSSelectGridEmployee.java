...
public class DSSelectGridEmployee extends DBDataSource
{


	public static DSSelectGridEmployee instance = null;

	public static DSSelectGridEmployee getInstance() {
		if(instance == null) {
			instance = new DSSelectGridEmployee("DSSelectGridEmployeeValue");
		}
		return instance;
	}
	...
	public DSSelectGridEmployee(String dataSourceID) {
