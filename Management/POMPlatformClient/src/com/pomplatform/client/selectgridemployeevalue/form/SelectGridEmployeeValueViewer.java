...
public class SelectGridEmployeeValueViewer extends AbstractDetailViewer
{
	...
	public SelectGridEmployeeValueViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_SelectGridEmployeeValue", "find", new DSCallback() {
			@Override
