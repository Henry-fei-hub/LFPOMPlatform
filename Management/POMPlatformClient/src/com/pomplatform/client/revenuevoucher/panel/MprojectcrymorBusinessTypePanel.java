...
public class MprojectcrymorBusinessTypePanel extends AbstractSearchPanel {
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			MprojectcrymorBusinessTypePanel cm = new MprojectcrymorBusinessTypePanel();
			id = cm.getID();
			return cm;
		}
	...
	public void initComponents() {
		...
		fields[index].addEditorExitHandler(new EditorExitHandler() {
			...
			public void onEditorExit(EditorExitEvent event) {
				int businessType = null == event.getNewValue() ? 0 : (int) event.getNewValue();
	...
	public boolean checkSearchCriteria(Map criteria) {
		...
		if(null != getIsAll() && getIsAll()){
			...
			kv.put("value", "(pj.business_type is null or pj.business_type <= 0 )");
		}
		keyvalues.add(kv);
