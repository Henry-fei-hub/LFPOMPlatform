...
public class DSMprojectcrymor extends DBDataSource
{


	public static DSMprojectcrymor instance = null;

	public static DSMprojectcrymor getInstance() {
		if(instance == null) {
			instance = new DSMprojectcrymor("DSMprojectcrymor");
		}
		return instance;
	}
	...
	public DSMprojectcrymor(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("Mprojectcrymor");
