...
public class MprojectcrymorViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Mprojectcrymor", "find", new DSCallback() {
			@Override
