...
public class RevenueVoucherViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_RevenueVoucher", "find", new DSCallback() {
			@Override
