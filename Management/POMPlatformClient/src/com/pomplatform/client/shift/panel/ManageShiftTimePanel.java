...
import com.pomplatform.client.shift.form.ManageShiftTimeSearchForm;
import com.pomplatform.client.shift.form.ManageShiftTimeViewer;
import com.pomplatform.client.shift.form.NewManageShiftTimeForm;
import com.pomplatform.client.shift.form.UpdateManageShiftTimeForm;
...
public class ManageShiftTimePanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			ManageShiftTimePanel cm = new ManageShiftTimePanel();
			id = cm.getID();
			return cm;
		}
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						NewManageShiftTimeForm detailForm = new NewManageShiftTimeForm();
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateManageShiftTimeForm detailForm = new UpdateManageShiftTimeForm();
				...
				SC.confirm("确定要删除这条记录吗？", new BooleanCallback() {
					...
					public void execute(Boolean value) {
						if(value){
							...
							params.put("optType", "deleteShiftTimeManage");
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("时段维护"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				ManageShiftTimeViewer detailForm = new ManageShiftTimeViewer();
	...
	public boolean checkSearchCriteria(Map criteria) {
		criteria.put("addtionalCondition", "order by shift_time_manage_id");
		return true;
	}
	...
	public SearchForm generateSearchForm() {
		return new ManageShiftTimeSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSManageShiftTime.getInstance();
	}
