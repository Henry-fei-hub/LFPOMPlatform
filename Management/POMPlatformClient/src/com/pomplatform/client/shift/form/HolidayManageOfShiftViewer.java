...
public class HolidayManageOfShiftViewer extends AbstractDetailViewer
{




	public HolidayManageOfShiftViewer() {
	}
	...
	public void load() {
		...
		params.put("holidayManageId", getBusinessId());
		DBDataSource.callOperation("ST_HolidayManageOfShift", "find", new DSCallback() {
			@Override
