...
public class OnLoadEmployeeShiftOfShiftViewer extends AbstractDetailViewer
{
	...
	public OnLoadEmployeeShiftOfShiftViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadEmployeeShiftOfShift", "find", new DSCallback() {
			@Override
