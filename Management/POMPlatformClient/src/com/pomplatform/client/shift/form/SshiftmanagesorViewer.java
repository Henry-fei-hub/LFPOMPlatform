...
public class SshiftmanagesorViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		params.put("shiftManageId", getBusinessId());
		DBDataSource.callOperation("NQ_Sshiftmanagesor", "find", new DSCallback() {
			@Override
