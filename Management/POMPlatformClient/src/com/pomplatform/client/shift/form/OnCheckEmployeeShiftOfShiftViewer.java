...
public class OnCheckEmployeeShiftOfShiftViewer extends AbstractDetailViewer
{
	...
	public OnCheckEmployeeShiftOfShiftViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnCheckEmployeeShiftOfShift", "find", new DSCallback() {
			@Override
