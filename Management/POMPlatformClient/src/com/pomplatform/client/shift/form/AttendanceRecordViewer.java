...
public class AttendanceRecordViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		params.put("employeeDayCheckId", getBusinessId());
		DBDataSource.callOperation("NQ_AttendanceRecord", "find", new DSCallback() {
			@Override
