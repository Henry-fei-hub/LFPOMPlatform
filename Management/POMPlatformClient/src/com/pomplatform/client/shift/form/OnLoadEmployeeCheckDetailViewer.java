...
public class OnLoadEmployeeCheckDetailViewer extends AbstractDetailViewer
{
	...
	public OnLoadEmployeeCheckDetailViewer() {
	}
	...
	public String getName() {
		return "Memployeecheckinoutdetailedseeeedor";
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadEmployeeCheckDetail", "find", new DSCallback() {
			@Override
