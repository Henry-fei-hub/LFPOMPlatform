...
public class OnLoadEmployeeShiftDetailOfShiftViewer extends AbstractDetailViewer
{
	...
	public OnLoadEmployeeShiftDetailOfShiftViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadEmployeeShiftDetailOfShift", "find", new DSCallback() {
			@Override
