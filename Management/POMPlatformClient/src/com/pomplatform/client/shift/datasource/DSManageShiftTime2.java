...
public class DSManageShiftTime2 extends DBDataSource
{


	public static DSManageShiftTime2 instance = null;

	public static DSManageShiftTime2 getInstance() {
		if(instance == null) {
			instance = new DSManageShiftTime2("DSManageShiftTime");
		}
		return instance;
	}
	...
	public DSManageShiftTime2(String dataSourceID) {
		...
		linkedMap.put("true", "需要");
		linkedMap.put("false", "不需要");
		...
		checkSignInField.setValueMap(linkedMap);
		...
		checkSignOffField.setValueMap(linkedMap);
		...
		signInStartTimeField.setHidden(false);
		...
		signInEndTimeField.setHidden(false);
		...
		signOffStartTimeField.setHidden(false);
		...
		signOffEndTimeField.setHidden(false);
		...
		overtimeStartTimeField = new DataSourceTextField("overtimeStartTime", "加班开始时间");
