...
public class MpurchaseplanmsommpmosrorViewer extends AbstractDetailViewer
{
	...
	public MpurchaseplanmsommpmosrorViewer() {
	}
	...
	public void load() {
		...
		params.put("purchasePlanId", getBusinessId());
		DBDataSource.callOperation("NQ_Mpurchaseplanmsommpmosror", "find", new DSCallback() {
			@Override
