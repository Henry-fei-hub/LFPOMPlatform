...
public class ProductAttributeViewer extends AbstractDetailViewer
{




	public ProductAttributeViewer() {
	}
	...
	public void load() {
		...
		params.put("productAttributeId", getBusinessId());
		DBDataSource.callOperation("ST_ProductAttribute", "find", new DSCallback() {
			@Override
