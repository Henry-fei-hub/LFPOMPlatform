...
public class PurchaseProductDetailViewer extends AbstractDetailViewer
{




	public PurchaseProductDetailViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("ST_PurchaseProductDetail", "find", new DSCallback() {
			@Override
	...
	public DataSource getMainDataSource() {
		return DSPurchaseProductDetail.getInstance();
	}
