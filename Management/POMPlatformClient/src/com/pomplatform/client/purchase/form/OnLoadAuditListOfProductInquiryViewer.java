...
public class OnLoadAuditListOfProductInquiryViewer extends AbstractDetailViewer
{
	...
	public OnLoadAuditListOfProductInquiryViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadAuditListOfProductInquiry", "find", new DSCallback() {
			@Override
