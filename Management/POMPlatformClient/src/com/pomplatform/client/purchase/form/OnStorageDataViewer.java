...
public class OnStorageDataViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnStorageData", "find", new DSCallback() {
			@Override
