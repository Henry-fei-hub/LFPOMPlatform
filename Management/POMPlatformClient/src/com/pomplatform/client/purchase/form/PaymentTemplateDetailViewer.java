...
public class PaymentTemplateDetailViewer extends AbstractDetailViewer
{




	public PaymentTemplateDetailViewer() {
	}
	...
	public void load() {
		...
		params.put("paymentTemplateDetailId", getBusinessId());
		DBDataSource.callOperation("ST_PaymentTemplateDetail", "find", new DSCallback() {
			@Override
