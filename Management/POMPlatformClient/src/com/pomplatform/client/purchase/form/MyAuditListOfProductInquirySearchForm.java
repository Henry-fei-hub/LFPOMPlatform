...
import com.pomplatform.client.purchase.datasource.CDMyAuditListOfProductInquiry;
import com.smartgwt.client.widgets.form.SearchForm;
import com.smartgwt.client.widgets.form.fields.IPickTreeItem;
import com.smartgwt.client.widgets.form.fields.SelectItem;
import com.smartgwt.client.widgets.form.fields.TextItem;

public class MyAuditListOfProductInquirySearchForm extends SearchForm
{
	...
	public MyAuditListOfProductInquirySearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDMyAuditListOfProductInquiry.getInstance());
		...
		setItems(processTypeItem, statusItem, employeeIdItem, createEmployeeIdItem, majorTitleItem, employeeNoItem, employeeNameItem, departmentIdItem);
