...
public class SproductmmporViewer extends AbstractDetailViewer
{
	...
	public SproductmmporViewer() {
	}

	@Override
	public void initComponents() {
		super.initComponents();
		productAttributesGrid.setDataSource(DSProductAttribute.getInstance());
		productAttributesGrid.addDoubleClickHandler(new DoubleClickHandler(){
			@Override
			public void onDoubleClick(DoubleClickEvent event) {
				GenericViewWindow detail = new GenericViewWindow();
				detail.setTitle("产品属性表");
				detail.setWidth(700); detail.setHeight(500); 
				ProductAttributeViewer viewer = new ProductAttributeViewer();
	...
	public void load() {
		...
		params.put("productId", getBusinessId());
		DBDataSource.callOperation("NQ_Sproductmmpor", "find", new DSCallback() {
			@Override
	...
	public void viewDetailData(){
		...
		condition.put("productId", selected.getAttributeAsString("productId"));
