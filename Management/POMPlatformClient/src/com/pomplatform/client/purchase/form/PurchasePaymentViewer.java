...
public class PurchasePaymentViewer extends AbstractDetailViewer
{




	public PurchasePaymentViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("ST_PurchasePayment", "find", new DSCallback() {
			@Override
