...
public class OnLoadApplyListOfProductInquiryViewer extends AbstractDetailViewer
{
	...
	public OnLoadApplyListOfProductInquiryViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadApplyListOfProductInquiry", "find", new DSCallback() {
			@Override
