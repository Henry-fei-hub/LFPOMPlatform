...
import com.pomplatform.client.purchase.form.NewOnStorageDataForm;
import com.pomplatform.client.purchase.form.OnStorageDataSearchForm;
import com.pomplatform.client.purchase.form.OnStorageDataViewer;
import com.pomplatform.client.purchase.form.UpdateOnStorageDataForm;
...
public class OnStorageDataPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			OnStorageDataPanel cm = new OnStorageDataPanel();
			id = cm.getID();
			return cm;
		}
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						NewOnStorageDataForm detailForm = new NewOnStorageDataForm();
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateOnStorageDataForm detailForm = new UpdateOnStorageDataForm();
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("仓库设置"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				OnStorageDataViewer detailForm = new OnStorageDataViewer();
	...
	public boolean checkSearchCriteria(Map criteria) {
		criteria.put("addtionalCondition", "order by storage_id");
		return true;
	}
	...
	public SearchForm generateSearchForm() {
		return new OnStorageDataSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSOnStorageData.getInstance();
	}
