...
import com.pomplatform.client.purchase.form.NewPaymentTemplateWithPForm;
...
import com.pomplatform.client.purchase.form.UpdatePaymentTemplateWithPForm;
...
public class PaymentTemplateWithPPanel extends AbstractExpansionRelatedPage {
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			PaymentTemplateWithPPanel cm = new PaymentTemplateWithPPanel();
			id = cm.getID();
			return cm;
		}
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdatePaymentTemplateWithPForm detailForm = new UpdatePaymentTemplateWithPForm();
						detailForm.setTitle("修改");
						detailForm.addDataEditedHandler(new DataEditedHandler() {
							@Override
							public void onDataEdited(DataEditEvent event) {
								commonQuery(resultGrid.getSelectedRecord());
							}
						});
		...
		operation3Button.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					@Override
					public void onSuccess() {
						NewPaymentTemplateWithPForm detailForm = new NewPaymentTemplateWithPForm();
				...
				SC.confirm("确认删除?", new BooleanCallback() {
					...
					public void execute(Boolean value) {
						if(null != value && value) {
							...
							DBDataSource.callOperation("ST_PaymentTemplateWithP", "delete", selected.toMap(), new DSCallback() {
								@Override
