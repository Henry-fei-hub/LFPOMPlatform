...
public class CDOnLoadTaskListOfProductInquiry extends DataSource
{


	public static CDOnLoadTaskListOfProductInquiry instance = null;

	public static CDOnLoadTaskListOfProductInquiry getInstance() {
		if(instance == null) {
			instance = new CDOnLoadTaskListOfProductInquiry("CDOnLoadTaskListOfProductInquiry");
		}
		return instance;
	}
	...
	public CDOnLoadTaskListOfProductInquiry(String dataSourceID) {
