...
public class CDOnLoadAuditListOfProductInquiry extends DataSource
{


	public static CDOnLoadAuditListOfProductInquiry instance = null;

	public static CDOnLoadAuditListOfProductInquiry getInstance() {
		if(instance == null) {
			instance = new CDOnLoadAuditListOfProductInquiry("CDOnLoadAuditListOfProductInquiry");
		}
		return instance;
	}
	...
	public CDOnLoadAuditListOfProductInquiry(String dataSourceID) {
