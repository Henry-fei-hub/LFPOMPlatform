...
public class CDOnLoadApplyListOfProductInquiry extends DataSource
{


	public static CDOnLoadApplyListOfProductInquiry instance = null;

	public static CDOnLoadApplyListOfProductInquiry getInstance() {
		if(instance == null) {
			instance = new CDOnLoadApplyListOfProductInquiry("CDOnLoadApplyListOfProductInquiry");
		}
		return instance;
	}
	...
	public CDOnLoadApplyListOfProductInquiry(String dataSourceID) {
		...
		setFields(processTypeField, createEmployeeIdField, majorTitleField, employeeNoField, employeeNameField, departmentIdField, currentPageField, pageLinesField);
