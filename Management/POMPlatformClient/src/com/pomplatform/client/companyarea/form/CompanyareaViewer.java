...
public class CompanyareaViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		params.put("companyAreaId", getBusinessId());
		DBDataSource.callOperation("NQ_Companyarea", "find", new DSCallback() {
			@Override
