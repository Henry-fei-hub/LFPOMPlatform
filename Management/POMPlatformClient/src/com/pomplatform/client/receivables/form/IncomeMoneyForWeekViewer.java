...
public class IncomeMoneyForWeekViewer extends AbstractDetailViewer
{
	...
	public IncomeMoneyForWeekViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_IncomeMoneyForWeek", "find", new DSCallback() {
			@Override
