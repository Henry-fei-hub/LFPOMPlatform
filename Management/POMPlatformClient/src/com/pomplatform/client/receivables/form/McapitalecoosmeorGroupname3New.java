...
public class McapitalecoosmeorGroupname3New extends AbstractWizadPage {
	...
	public McapitalecoosmeorGroupname3New() {
	...
	public DoubleItem getActualAmountItem() {
		return actualAmountItem;
	}

	public DateItem getActualReceiveDateItem() {
		return actualReceiveDateItem;
	}
