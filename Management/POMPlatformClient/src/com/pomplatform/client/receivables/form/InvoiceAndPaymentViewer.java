...
public class InvoiceAndPaymentViewer extends AbstractDetailViewer
{
	...
	public InvoiceAndPaymentViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_InvoiceAndPayment", "find", new DSCallback() {
			@Override
