...
public class InvoiceReportViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_InvoiceReport", "find", new DSCallback() {
			@Override
