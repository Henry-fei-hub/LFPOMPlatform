...
public class MemployeeeeedorViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Memployeeeeedor", "find", new DSCallback() {
			@Override
