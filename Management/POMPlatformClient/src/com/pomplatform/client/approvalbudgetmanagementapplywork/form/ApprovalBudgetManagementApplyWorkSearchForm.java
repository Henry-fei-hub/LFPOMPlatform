...
import com.pomplatform.client.approvalbudgetmanagementapplywork.datasource.CDApprovalBudgetManagementApplyWork;

public class ApprovalBudgetManagementApplyWorkSearchForm extends SearchForm
{
	...
	public ApprovalBudgetManagementApplyWorkSearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDApprovalBudgetManagementApplyWork.getInstance());
