...
public class QualityFeeDetailViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_QualityFeeDetail", "find", new DSCallback() {
			@Override
