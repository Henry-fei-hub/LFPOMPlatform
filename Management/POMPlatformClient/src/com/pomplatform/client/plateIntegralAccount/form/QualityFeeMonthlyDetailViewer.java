...
public class QualityFeeMonthlyDetailViewer extends AbstractDetailViewer
{
	...
	public QualityFeeMonthlyDetailViewer() {
	}
	...
	public void load() {
		...
		params.put("plateIntegralAchieveId", getBusinessId());
		DBDataSource.callOperation("NQ_QualityFeeMonthlyDetail", "find", new DSCallback() {
			@Override
