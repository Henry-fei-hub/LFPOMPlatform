...
public class DSQualityFeeDetail extends DBDataSource
{


	public static DSQualityFeeDetail instance = null;

	public static DSQualityFeeDetail getInstance() {
		if(instance == null) {
			instance = new DSQualityFeeDetail("DSQualityFeeDetail");
		}
		return instance;
	}
	...
	public DSQualityFeeDetail(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("QualityFeeDetail");
