...
public class DSQualityFeeMonthlyDetail extends DBDataSource
{


	public static DSQualityFeeMonthlyDetail instance = null;

	public static DSQualityFeeMonthlyDetail getInstance() {
		if(instance == null) {
			instance = new DSQualityFeeMonthlyDetail("DSQualityFeeMonthlyDetail");
		}
		return instance;
	}
	...
	public DSQualityFeeMonthlyDetail(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("QualityFeeMonthlyDetail");
		...
		sendDateField = new DataSourceDateField("sendDate", "发放日期");
