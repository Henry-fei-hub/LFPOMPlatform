...
import com.pomplatform.client.plateIntegralAccount.datasource.DSQualityFeeSumByMonth;
...
public class QualityFeeSumByMonthPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			QualityFeeSumByMonthPanel cm = new QualityFeeSumByMonthPanel();
			id = cm.getID();
			return cm;
		}
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				QualityFeeMonthlyDetailPanel panel = new QualityFeeMonthlyDetailPanel();
	...
	public DataSource getDataSource() {
		return DSQualityFeeSumByMonth.getInstance();
	}
