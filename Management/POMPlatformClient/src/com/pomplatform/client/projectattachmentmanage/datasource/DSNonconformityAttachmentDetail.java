...
public class DSNonconformityAttachmentDetail extends DBDataSource
{


	public static DSNonconformityAttachmentDetail instance = null;

	public static DSNonconformityAttachmentDetail getInstance() {
		if(instance == null) {
			instance = new DSNonconformityAttachmentDetail("DSNonconformityAttachmentDetail");
		}
		return instance;
	}
	...
	public DSNonconformityAttachmentDetail(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("NonconformityAttachmentDetail");
