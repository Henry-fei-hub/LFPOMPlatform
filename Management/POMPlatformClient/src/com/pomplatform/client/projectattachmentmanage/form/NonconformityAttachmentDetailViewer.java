...
public class NonconformityAttachmentDetailViewer extends AbstractDetailViewer
{
	...
	public NonconformityAttachmentDetailViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_NonconformityAttachmentDetail", "find", new DSCallback() {
			@Override
