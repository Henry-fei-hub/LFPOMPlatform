...
public class ProjectAttachmentManageViewer extends AbstractDetailViewer
{
	...
	public ProjectAttachmentManageViewer() {
	}
	...
	public void load() {
		...
		params.put("projectAttachmentId", getBusinessId());
		DBDataSource.callOperation("NQ_ProjectAttachmentManage", "find", new DSCallback() {
			@Override
