...
public class ResignEmployeeEachMonthDetailViewer extends AbstractDetailViewer
{
	...
	public ResignEmployeeEachMonthDetailViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ResignEmployeeEachMonthDetail", "find", new DSCallback() {
			@Override
