...
public class EmployeeInfoOfNoSalaryAdjustmentViewer extends AbstractDetailViewer
{
	...
	public EmployeeInfoOfNoSalaryAdjustmentViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_EmployeeInfoOfNoSalaryAdjustment", "find", new DSCallback() {
			@Override
