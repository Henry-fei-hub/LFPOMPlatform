...
public class ResignEmployeeEachMonthViewer extends AbstractDetailViewer
{
	...
	public ResignEmployeeEachMonthViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ResignEmployeeEachMonth", "find", new DSCallback() {
			@Override
