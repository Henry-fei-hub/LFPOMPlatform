...
public class UpdateFrozenIntegralViewer extends AbstractDetailViewer
{
	...
	public UpdateFrozenIntegralViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_UpdateFrozenIntegral", "find", new DSCallback() {
			@Override
