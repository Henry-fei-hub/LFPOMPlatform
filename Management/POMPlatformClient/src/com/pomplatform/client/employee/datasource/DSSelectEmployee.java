...
public class DSSelectEmployee extends DBDataSource
{


	public static DSSelectEmployee instance = null;

	public static DSSelectEmployee getInstance() {
		if(instance == null) {
			instance = new DSSelectEmployee("DSSelectEmployee");
		}
		return instance;
	}
	...
	public DSSelectEmployee(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("SelectEmployee");
