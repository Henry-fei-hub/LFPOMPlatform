...
public class SreimbursementpackagesummaryrrorViewer extends AbstractDetailViewer
{
	...
	public SreimbursementpackagesummaryrrorViewer() {
	}
	...
	public void load() {
		...
		params.put("reimbursementPackageSummaryId", getBusinessId());
		DBDataSource.callOperation("NQ_Sreimbursementpackagesummaryrror", "find", new DSCallback() {
			@Override
