...
public class DSTaskListOfPreProjectReport extends DBDataSource
{


	public static DSTaskListOfPreProjectReport instance = null;

	public static DSTaskListOfPreProjectReport getInstance() {
		if(instance == null) {
			instance = new DSTaskListOfPreProjectReport("DSTaskListOfPreProjectReport");
		}
		return instance;
	}
	...
	public DSTaskListOfPreProjectReport(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("TaskListOfPreProjectReport");
...
//		projectTypeField.setValueMap(KeyValueManager.getValueMap("pre_business_type"));
		...
		setFields(processPooledTaskIdField, processInstanceIdField, businessIdField, businessNameField, processActivityIdField, processIdField, backViewNameField, activityTypeField, nodeTypeField, activityIdField, instanceActivityCreateTimeField, instanceActivityStartTimeField, projectNameField, provinceField, cityField, projectTypeField, customerNameField, projectOriginationField, applyEmployeeIdField, statusField, processTypeField, processCommentField, operateTimeField);
	}
