...
public class DSOnLoadFlowAuditListOfMainProjectBuisnessData extends DBDataSource
{


	public static DSOnLoadFlowAuditListOfMainProjectBuisnessData instance = null;

	public static DSOnLoadFlowAuditListOfMainProjectBuisnessData getInstance() {
		if(instance == null) {
			instance = new DSOnLoadFlowAuditListOfMainProjectBuisnessData("DSOnLoadFlowAuditListOfMainProjectBuisnessData");
		}
		return instance;
	}
	...
	public DSOnLoadFlowAuditListOfMainProjectBuisnessData(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("OnLoadFlowAuditListOfMainProjectBuisnessData");
