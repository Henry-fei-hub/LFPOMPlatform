...
public class CDBeProjectApply extends DataSource
{


	public static CDBeProjectApply instance = null;

	public static CDBeProjectApply getInstance() {
		if(instance == null) {
			instance = new CDBeProjectApply("CDBeProjectApply");
		}
		return instance;
	}
	...
	public CDBeProjectApply(String dataSourceID) {
