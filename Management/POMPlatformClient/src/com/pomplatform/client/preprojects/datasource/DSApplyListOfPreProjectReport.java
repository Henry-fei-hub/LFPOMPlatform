...
public class DSApplyListOfPreProjectReport extends DBDataSource
{


	public static DSApplyListOfPreProjectReport instance = null;

	public static DSApplyListOfPreProjectReport getInstance() {
		if(instance == null) {
			instance = new DSApplyListOfPreProjectReport("DSApplyListOfPreProjectReport");
		}
		return instance;
	}
	...
	public DSApplyListOfPreProjectReport(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("ApplyListOfPreProjectReport");
...
//		projectTypeField.setValueMap(KeyValueManager.getValueMap("pre_business_type"));
		...
		setFields(processInstanceIdField, processTypeField, businessIdField, businessNameField, processIdField, processInstanceActivityIdField, completeTimeField, employeeIdField, projectNameField, provinceField, cityField, projectTypeField,customerNameField,projectOriginationField, createTimeField, processStatusField);
	}
