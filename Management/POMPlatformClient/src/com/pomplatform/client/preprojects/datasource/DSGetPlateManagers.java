...
public class DSGetPlateManagers extends DBDataSource
{


	public static DSGetPlateManagers instance = null;

	public static DSGetPlateManagers getInstance() {
		if(instance == null) {
			instance = new DSGetPlateManagers("DSGetPlateManagers");
		}
		return instance;
	}
	...
	public DSGetPlateManagers(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("GetPlateManagers");
