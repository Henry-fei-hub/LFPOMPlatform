...
public class DSAuditListOfPreProjectReport extends DBDataSource
{


	public static DSAuditListOfPreProjectReport instance = null;

	public static DSAuditListOfPreProjectReport getInstance() {
		if(instance == null) {
			instance = new DSAuditListOfPreProjectReport("DSAuditListOfPreProjectReport");
		}
		return instance;
	}
	...
	public DSAuditListOfPreProjectReport(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("AuditListOfPreProjectReport");
