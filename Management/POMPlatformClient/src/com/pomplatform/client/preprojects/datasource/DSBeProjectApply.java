...
public class DSBeProjectApply extends DBDataSource
{


	public static DSBeProjectApply instance = null;

	public static DSBeProjectApply getInstance() {
		if(instance == null) {
			instance = new DSBeProjectApply("DSBeProjectApply");
		}
		return instance;
	}
	...
	public DSBeProjectApply(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("BeProjectApply");
