...
public class OnLoadFlowAuditListOfMainProjectBuisnessDataViewer extends AbstractDetailViewer
{
	...
	public OnLoadFlowAuditListOfMainProjectBuisnessDataViewer() {
	}
	...
	public String getName() {
		return "OnLoadFlowAuditListOfMainProjectBuisnessData";
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadFlowAuditListOfMainProjectBuisnessData", "find", new DSCallback() {
			@Override
