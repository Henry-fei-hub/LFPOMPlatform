...
public class MainProjectSpecialtyViewer extends AbstractDetailViewer
{




	public MainProjectSpecialtyViewer() {
	}
	...
	public void load() {
		...
		params.put("mainProjectSpecialtyId", getBusinessId());
		DBDataSource.callOperation("ST_MainProjectSpecialty", "find", new DSCallback() {
			@Override
	...
	public DataSource getMainDataSource() {
		return DSMainProjectSpecialty.getInstance();
	}
