...
public class NewBeProjectApplyWorkflow extends AbstractProcessPanel {
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_BeProjectApply", "find", new DSCallback() {
			@Override
	...
	public List<AbstractWizadPage> getPages() {
		...
		BeProjectBasicInformationUpdate basic = new BeProjectBasicInformationUpdate();
		BeProjectDetailInformationUpdate detail = new BeProjectDetailInformationUpdate();
