...
public class ApplyListOfPreProjectReportViewer extends AbstractDetailViewer
{
	...
	public ApplyListOfPreProjectReportViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ApplyListOfPreProjectReport", "find", new DSCallback() {
			@Override
