...
import com.pomplatform.client.preprojects.datasource.CDAttentionListOfMainProjectReport;
import com.pomplatform.client.preprojects.datasource.CDAttentionListOfPreProjectReport;

public class AttentionListOfMainProjectReportSearchForm extends SearchForm
{
	...
	public AttentionListOfMainProjectReportSearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDAttentionListOfPreProjectReport.getInstance());
