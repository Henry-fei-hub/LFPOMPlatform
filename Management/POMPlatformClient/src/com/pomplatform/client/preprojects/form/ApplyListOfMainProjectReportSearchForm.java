...
import com.pomplatform.client.preprojects.datasource.CDApplyListOfMainProjectReport;
import com.pomplatform.client.preprojects.datasource.CDApplyListOfPreProjectReport;

public class ApplyListOfMainProjectReportSearchForm extends SearchForm
{
	...
	public ApplyListOfMainProjectReportSearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDApplyListOfPreProjectReport.getInstance());
...
//		projectTypeItem.setValueMap(KeyValueManager.getValueMap("pre_business_type"));
		...
		setItems(processTypeItem, projectNameItem, projectTypeItem, startDateItem, endDateItem, employeeIdItem);
