...
public class RefuseListOfPreProjectReportViewer extends AbstractDetailViewer
{
	...
	public RefuseListOfPreProjectReportViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_RefuseListOfPreProjectReport", "find", new DSCallback() {
			@Override
