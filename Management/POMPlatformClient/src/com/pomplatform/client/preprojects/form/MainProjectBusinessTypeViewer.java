...
public class MainProjectBusinessTypeViewer extends AbstractDetailViewer
{




	public MainProjectBusinessTypeViewer() {
	}
	...
	public void load() {
		...
		params.put("mainProjectBusinessTypeId", getBusinessId());
		DBDataSource.callOperation("ST_MainProjectBusinessType", "find", new DSCallback() {
			@Override
	...
	public DataSource getMainDataSource() {
		return DSMainProjectBusinessType.getInstance();
	}
