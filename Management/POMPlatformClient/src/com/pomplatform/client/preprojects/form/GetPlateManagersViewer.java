...
public class GetPlateManagersViewer extends AbstractDetailViewer
{




	public GetPlateManagersViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_GetPlateManagers", "find", new DSCallback() {
			@Override
