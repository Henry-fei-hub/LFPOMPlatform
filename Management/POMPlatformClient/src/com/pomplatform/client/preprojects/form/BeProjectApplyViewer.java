...
import com.pomplatform.client.preprojects.datasource.DSBeProjectApply;
...
public class BeProjectApplyViewer extends AbstractDetailViewer
{
	...
	public DataSource getMainDataSource() {
		return DSBeProjectApply.getInstance();
	}
