...
public class MainProjectCompetitionUnitViewer extends AbstractDetailViewer
{




	public MainProjectCompetitionUnitViewer() {
	}
	...
	public void load() {
		...
		params.put("mainProjectCompetitionUnitId", getBusinessId());
		DBDataSource.callOperation("ST_MainProjectCompetitionUnit", "find", new DSCallback() {
			@Override
	...
	public DataSource getMainDataSource() {
		return DSMainProjectCompetitionUnit.getInstance();
	}
