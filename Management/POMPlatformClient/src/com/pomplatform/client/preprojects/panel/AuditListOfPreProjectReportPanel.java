...
public class AuditListOfPreProjectReportPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			AuditListOfPreProjectReportPanel cm = new AuditListOfPreProjectReportPanel();
			id = cm.getID();
			return cm;
		}
		...
		public String getDescription() {
			return "AuditListOfPreProjectReport";
		}
...
//		return new AuditListOfPreProjectReportSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSOnLoadFlowAuditListOfPreProjectReportBuisnessData.getInstance(); 
//		return DSAuditListOfPreProjectReport.getInstance(); 
	}
