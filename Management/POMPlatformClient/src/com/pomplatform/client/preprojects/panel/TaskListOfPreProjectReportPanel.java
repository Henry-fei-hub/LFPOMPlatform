...
import com.pomplatform.client.preprojects.datasource.DSTaskListOfPreProjectReport;
import com.pomplatform.client.preprojects.form.TaskListOfPreProjectReportSearchForm;
import com.pomplatform.client.preprojects.form.TaskListOfPreProjectReportViewer;
 ...
 *
 */
public class TaskListOfPreProjectReportPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			TaskListOfPreProjectReportPanel cm = new TaskListOfPreProjectReportPanel();
			id = cm.getID();
			return cm;
		}
		...
		public String getDescription() {
			return "TaskListOfPreProjectReport";
		}
	...
	public SearchForm generateSearchForm() {
		return new TaskListOfPreProjectReportSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSTaskListOfPreProjectReport.getInstance();
	}
