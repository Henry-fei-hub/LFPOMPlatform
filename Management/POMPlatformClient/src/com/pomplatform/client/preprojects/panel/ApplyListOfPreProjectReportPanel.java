...
import com.pomplatform.client.preprojects.form.ApplyListOfPreProjectReportViewer;
...
public class ApplyListOfPreProjectReportPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public String getDescription() {
			return "ApplyListOfPreProjectReport";
		}
...
//		commonQuery();
	...
	public SearchForm generateSearchForm() {
		return new ApplyListOfPreProjectReportSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSApplyListOfPreProjectReport.getInstance();
	}
