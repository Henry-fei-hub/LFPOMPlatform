...
import com.pomplatform.client.preprojects.datasource.DSAttentionListOfMainProjectReport;
import com.pomplatform.client.preprojects.form.AttentionListOfMainProjectReportSearchForm;
import com.pomplatform.client.preprojects.form.AttentionListOfMainProjectReportViewer;
...
public class AttentionListOfMainProjectReportPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			AttentionListOfMainProjectReportPanel cm = new AttentionListOfMainProjectReportPanel();
			id = cm.getID();
			return cm;
		}
		...
		public String getDescription() {
			return "AttentionListOfMainProjectReport";
		}
...
//		commonQuery();
	...
	public SearchForm generateSearchForm() {
		return new AttentionListOfMainProjectReportSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSAttentionListOfMainProjectReport.getInstance();
	}
