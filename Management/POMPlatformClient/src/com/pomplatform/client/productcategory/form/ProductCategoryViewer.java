...
public class ProductCategoryViewer extends AbstractDetailViewer
{




	public ProductCategoryViewer() {
	}
	...
	public void load() {
		...
		params.put("categoryId", getBusinessId());
		DBDataSource.callOperation("ST_ProductCategory", "find", new DSCallback() {
			@Override
