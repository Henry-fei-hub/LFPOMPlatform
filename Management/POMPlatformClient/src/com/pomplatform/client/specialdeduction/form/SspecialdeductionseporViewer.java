...
public class SspecialdeductionseporViewer extends AbstractDetailViewer
{
	...
	public SspecialdeductionseporViewer() {
	}
	...
	public void load() {
		...
		params.put("specialDeductionId", getBusinessId());
		DBDataSource.callOperation("NQ_Sspecialdeductionsepor", "find", new DSCallback() {
			@Override
