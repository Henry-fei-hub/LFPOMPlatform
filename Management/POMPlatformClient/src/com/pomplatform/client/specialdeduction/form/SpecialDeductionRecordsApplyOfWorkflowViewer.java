...
public class SpecialDeductionRecordsApplyOfWorkflowViewer extends AbstractDetailViewer
{
	...
	public SpecialDeductionRecordsApplyOfWorkflowViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_SpecialDeductionRecordsApplyOfWorkflow", "find", new DSCallback() {
			@Override
