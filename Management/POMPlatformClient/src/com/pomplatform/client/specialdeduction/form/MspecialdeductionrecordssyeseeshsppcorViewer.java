...
public class MspecialdeductionrecordssyeseeshsppcorViewer extends AbstractDetailViewer
{
	...
	public MspecialdeductionrecordssyeseeshsppcorViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Mspecialdeductionrecordssyeseeshsppcor", "find", new DSCallback() {
			@Override
