...
public class SspecialdeductiondetailorViewer extends AbstractDetailViewer
{
	...
	public SspecialdeductiondetailorViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Sspecialdeductiondetailor", "find", new DSCallback() {
			@Override
