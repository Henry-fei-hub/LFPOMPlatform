...
public class SspecialdeductiontypessorViewer extends AbstractDetailViewer
{
	...
	public SspecialdeductiontypessorViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Sspecialdeductiontypessor", "find", new DSCallback() {
			@Override
