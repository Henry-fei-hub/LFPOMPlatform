...
public class SspecialdeductionmonthdetailedporViewer extends AbstractDetailViewer
{
	...
	public SspecialdeductionmonthdetailedporViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Sspecialdeductionmonthdetailedpor", "find", new DSCallback() {
			@Override
