...
public class MspecialdeductionrecordsorViewer extends AbstractDetailViewer
{
	...
	public MspecialdeductionrecordsorViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Mspecialdeductionrecordsor", "find", new DSCallback() {
			@Override
