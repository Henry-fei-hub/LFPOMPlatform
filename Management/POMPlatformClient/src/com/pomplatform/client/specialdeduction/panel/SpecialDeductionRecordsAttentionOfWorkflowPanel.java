...
import com.pomplatform.client.specialdeduction.datasource.DSSpecialDeductionRecordsAttentionOfWorkflow;
import com.pomplatform.client.specialdeduction.form.SpecialDeductionRecordsAttentionOfWorkflowSearchForm;
import com.pomplatform.client.specialdeduction.form.SpecialDeductionRecordsAttentionOfWorkflowViewer;
...
public class SpecialDeductionRecordsAttentionOfWorkflowPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			SpecialDeductionRecordsAttentionOfWorkflowPanel cm = new SpecialDeductionRecordsAttentionOfWorkflowPanel();
			id = cm.getID();
			return cm;
		}
		...
		public String getDescription() {
			return "SpecialDeductionRecordsAttentionOfWorkflow";
		}
	...
	public SearchForm generateSearchForm() {
		return new SpecialDeductionRecordsAttentionOfWorkflowSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSSpecialDeductionRecordsAttentionOfWorkflow.getInstance();
	}
