...
public class UpdateCapitalHappenDatePanel extends VLayout implements HasHandlers {
	...
	public UpdateCapitalHappenDatePanel() {
		vLayout = new VLayout();
		vLayout.setWidth100();
		...
		postingDateItem = new DateItem("happenDate", "发生日期");
