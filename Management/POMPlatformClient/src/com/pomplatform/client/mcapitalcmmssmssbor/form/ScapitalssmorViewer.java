...
public class ScapitalssmorViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Scapitalssmor", "find", new DSCallback() {
			@Override
