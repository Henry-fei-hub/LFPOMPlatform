...
public class McapitalcmmssmssborViewer extends AbstractDetailViewer
{
	...
	public McapitalcmmssmssborViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Mcapitalcmmssmssbor", "find", new DSCallback() {
			@Override
