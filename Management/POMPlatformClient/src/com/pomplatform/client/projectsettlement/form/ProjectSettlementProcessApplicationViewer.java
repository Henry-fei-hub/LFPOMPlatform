...
public class ProjectSettlementProcessApplicationViewer extends AbstractDetailViewer
{


	private final DelicacyListGrid projectSettlementDetailsGrid = new DelicacyListGrid();
	private SearchForm __parentSearchForm;


	public ProjectSettlementProcessApplicationViewer() {
	}
	...
	public void viewDetailData(){
		...
		DBDataSource.callOperation("ST_ProjectSettlementDetail", "find", condition, new DSCallback(){
			...
			public void execute(DSResponse dsResponse, Object data, DSRequest dsRequest) {
				if(dsResponse.getStatus() >= 0){
					projectSettlementDetailsGrid.setData(dsResponse.getData());
				}
			}
		});
	}
