...
import com.pomplatform.client.projectsettlement.datasource.CDOnLoadAuditListOfProjectSettlement;

public class OnLoadAuditListOfProjectSettlementSearchForm extends SearchForm
{
	...
	public OnLoadAuditListOfProjectSettlementSearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDOnLoadAuditListOfProjectSettlement.getInstance());
