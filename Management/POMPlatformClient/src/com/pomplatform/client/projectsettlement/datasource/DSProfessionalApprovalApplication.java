...
public class DSProfessionalApprovalApplication extends DBDataSource
{


	public static DSProfessionalApprovalApplication instance = null;

	public static DSProfessionalApprovalApplication getInstance() {
		if(instance == null) {
			instance = new DSProfessionalApprovalApplication("DSProfessionalApprovalApplication");
		}
		return instance;
	}
	...
	public DSProfessionalApprovalApplication(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("ProfessionalApprovalApplication");
