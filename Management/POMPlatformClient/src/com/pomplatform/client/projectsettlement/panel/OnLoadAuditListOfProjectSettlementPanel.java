...
import com.pomplatform.client.projectsettlement.datasource.DSOnLoadAuditListOfProjectSettlement;
import com.pomplatform.client.projectsettlement.form.OnLoadAuditListOfProjectSettlementSearchForm;
import com.pomplatform.client.projectsettlement.form.OnLoadAuditListOfProjectSettlementViewer;
...
public class OnLoadAuditListOfProjectSettlementPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			OnLoadAuditListOfProjectSettlementPanel cm = new OnLoadAuditListOfProjectSettlementPanel();
			id = cm.getID();
			return cm;
		}
		...
		public String getDescription() {
			return "OnLoadAuditListOfProjectSettlement";
		}
...
//		commonQuery();
	...
	public SearchForm generateSearchForm() {
		return new OnLoadAuditListOfProjectSettlementSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSOnLoadAuditListOfProjectSettlement.getInstance();
	}
