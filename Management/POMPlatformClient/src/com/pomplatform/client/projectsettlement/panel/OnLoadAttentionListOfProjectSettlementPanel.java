...
import com.pomplatform.client.projectsettlement.datasource.DSOnLoadAttentionListOfProjectSettlement;
import com.pomplatform.client.projectsettlement.form.OnLoadAttentionListOfProjectSettlementSearchForm;
import com.pomplatform.client.projectsettlement.form.OnLoadAttentionListOfProjectSettlementViewer;
...
public class OnLoadAttentionListOfProjectSettlementPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			OnLoadAttentionListOfProjectSettlementPanel cm = new OnLoadAttentionListOfProjectSettlementPanel();
			id = cm.getID();
			return cm;
		}
		...
		public String getDescription() {
			return "OnLoadAttentionListOfProjectSettlement";
		}
...
//		commonQuery();
	...
	public SearchForm generateSearchForm() {
		return new OnLoadAttentionListOfProjectSettlementSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSOnLoadAttentionListOfProjectSettlement.getInstance();
	}
