...
public class CDAttachmentApprovalUpcoming extends DataSource
{


	public static CDAttachmentApprovalUpcoming instance = null;

	public static CDAttachmentApprovalUpcoming getInstance() {
		if(instance == null) {
			instance = new CDAttachmentApprovalUpcoming("CDAttachmentApprovalUpcoming");
		}
		return instance;
	}
	...
	public CDAttachmentApprovalUpcoming(String dataSourceID) {
