...
public class AttachmentApprovalUpcomingViewer extends AbstractDetailViewer
{
	...
	public AttachmentApprovalUpcomingViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_AttachmentApprovalUpcoming", "find", new DSCallback() {
			@Override
