...
public class SprocessbilllistppporViewer extends AbstractDetailViewer
{
	...
	public SprocessbilllistppporViewer() {
	}
	...
	public void load() {
		...
		params.put("processBillListId", getBusinessId());
		DBDataSource.callOperation("NQ_Sprocessbilllistpppor", "find", new DSCallback() {
			@Override
