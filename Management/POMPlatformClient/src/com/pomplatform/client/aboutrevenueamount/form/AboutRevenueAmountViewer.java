...
public class AboutRevenueAmountViewer extends AbstractDetailViewer
{
	...
	public AboutRevenueAmountViewer() {
	}
	...
	public void load() {
		...
		params.put("revenueCapitalsId", getBusinessId());
		DBDataSource.callOperation("NQ_AboutRevenueAmount", "find", new DSCallback() {
			@Override
