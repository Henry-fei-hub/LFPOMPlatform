...
public class McapitalsubcontractscoorViewer extends AbstractDetailViewer
{
	...
	public McapitalsubcontractscoorViewer() {
	}
	...
	public void load() {
		...
		params.put("capitalSubContractId", getBusinessId());
		DBDataSource.callOperation("NQ_Mcapitalsubcontractscoor", "find", new DSCallback() {
			@Override
