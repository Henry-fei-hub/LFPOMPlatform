...
public class ProjectToDepartmentAdvancePanel extends HLayout implements HasHandlers {
	...
	public void initComponents(final int plateId,final String plateName, final BigDecimal achieveIntegral) {
		...
		form.setItems(plateNameItem, achieveIntegralItem,achieveIntegralLeftItem,projectIdItem,advanceIntegralItem,leftIntegralItem,advanceItem,advanceDateItem, remarkItem);
				...
				SC.ask("提示", "您确认要进行补贴操作吗?", new BooleanCallback() {
					...
					public void execute(Boolean value) {
						if (value) {
							...
							DBDataSource.callOperation("EP_OnProjectAdvanceRecordSave",params, new DSCallback() {
								@Override
		...
		goBtn.addClickHandler(new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                ...
                PopupWindow popupWindow = new PopupWindow(plateName+"-成员补贴");
                ...
                assignIntegral.initComponents(1,plateId,projectId,advanceIntegral,leftIntegral);
	...
	//数据加载
	public void onLoadData(int projectId,int plateId){
