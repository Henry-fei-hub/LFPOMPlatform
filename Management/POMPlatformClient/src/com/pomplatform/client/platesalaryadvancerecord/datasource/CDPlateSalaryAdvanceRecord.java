...
public class CDPlateSalaryAdvanceRecord extends DataSource
{


	public static CDPlateSalaryAdvanceRecord instance = null;

	public static CDPlateSalaryAdvanceRecord getInstance() {
		if(instance == null) {
			instance = new CDPlateSalaryAdvanceRecord("CDPlateSalaryAdvanceRecord");
		}
		return instance;
	}
	...
	public CDPlateSalaryAdvanceRecord(String dataSourceID) {
