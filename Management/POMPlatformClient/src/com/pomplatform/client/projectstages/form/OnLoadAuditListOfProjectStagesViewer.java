...
public class OnLoadAuditListOfProjectStagesViewer extends AbstractDetailViewer
{
	...
	public OnLoadAuditListOfProjectStagesViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadAuditListOfProjectStages", "find", new DSCallback() {
			@Override
