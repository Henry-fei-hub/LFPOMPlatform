...
public class SprojectstagecorViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Sprojectstagecor", "find", new DSCallback() {
			@Override
