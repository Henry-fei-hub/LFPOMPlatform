...
public class NewProjectStagesProcessApplicationForm extends GenericWizadWindow
{
	...
	public List<AbstractWizadPage> getPages(){
		...
		res.add(new ProjectStagesProcessApplicationNewForm());
		res.add(new ProjectStagesProcessApplicationDetailProjectStageProcessDetail(null));
		return res;
	}
