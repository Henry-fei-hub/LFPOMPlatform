...
public class ConfirmablePhasesListViewer extends AbstractDetailViewer
{
	...
	public ConfirmablePhasesListViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ConfirmablePhasesList", "find", new DSCallback() {
			@Override
