...
public class ProjectStageProcessDetailViewer extends AbstractDetailViewer
{




	public ProjectStageProcessDetailViewer() {
	}
	...
	public void load() {
		...
		params.put("projectStageProcessDetailId", getBusinessId());
		DBDataSource.callOperation("ST_ProjectStageProcessDetail", "find", new DSCallback() {
			@Override
	...
	public DataSource getMainDataSource() {
		return DSProjectStageProcessDetail.getInstance();
	}
