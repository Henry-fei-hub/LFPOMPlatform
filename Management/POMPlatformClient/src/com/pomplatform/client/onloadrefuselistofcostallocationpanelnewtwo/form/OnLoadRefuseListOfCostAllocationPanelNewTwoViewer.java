...
public class OnLoadRefuseListOfCostAllocationPanelNewTwoViewer extends AbstractDetailViewer
{
	...
	public OnLoadRefuseListOfCostAllocationPanelNewTwoViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadRefuseListOfCostAllocationPanelNewTwo", "find", new DSCallback() {
			@Override
