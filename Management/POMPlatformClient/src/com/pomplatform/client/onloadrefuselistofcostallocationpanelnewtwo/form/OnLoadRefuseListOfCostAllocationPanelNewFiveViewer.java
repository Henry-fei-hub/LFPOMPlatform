...
public class OnLoadRefuseListOfCostAllocationPanelNewFiveViewer extends AbstractDetailViewer
{
	...
	public OnLoadRefuseListOfCostAllocationPanelNewFiveViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadRefuseListOfCostAllocationPanelNewFive", "find", new DSCallback() {
			@Override
