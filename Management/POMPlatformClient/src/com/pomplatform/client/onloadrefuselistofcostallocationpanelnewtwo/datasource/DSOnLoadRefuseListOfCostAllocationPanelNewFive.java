...
public class DSOnLoadRefuseListOfCostAllocationPanelNewFive extends DBDataSource
{


	public static DSOnLoadRefuseListOfCostAllocationPanelNewFive instance = null;

	public static DSOnLoadRefuseListOfCostAllocationPanelNewFive getInstance() {
		if(instance == null) {
			instance = new DSOnLoadRefuseListOfCostAllocationPanelNewFive("DSOnLoadRefuseListOfCostAllocationPanelNewFive");
		}
		return instance;
	}
	...
	public DSOnLoadRefuseListOfCostAllocationPanelNewFive(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("OnLoadRefuseListOfCostAllocationPanelNewFive");
		...
		setFields(statusField,processPooledTaskIdField, processInstanceIdField, preProjectTransferRecordIdField, customerNameField, projectNameField, provinceField, cityField, businessIdField, businessNameField, processActivityIdField, processIdField, backViewNameField, activityTypeField, nodeTypeField, activityIdField, instanceActivityCreateTimeField, instanceActivityStartTimeField,  processTypeField, processCommentField, employeeIdField, transferEmployeeIdField, preProjectIdField, operateTimeField);
	}
