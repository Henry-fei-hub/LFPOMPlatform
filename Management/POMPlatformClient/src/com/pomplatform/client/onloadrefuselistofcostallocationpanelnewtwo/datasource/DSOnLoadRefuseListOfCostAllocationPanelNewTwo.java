...
public class DSOnLoadRefuseListOfCostAllocationPanelNewTwo extends DBDataSource
{


	public static DSOnLoadRefuseListOfCostAllocationPanelNewTwo instance = null;

	public static DSOnLoadRefuseListOfCostAllocationPanelNewTwo getInstance() {
		if(instance == null) {
			instance = new DSOnLoadRefuseListOfCostAllocationPanelNewTwo("DSOnLoadRefuseListOfCostAllocationPanelNewTwo");
		}
		return instance;
	}
	...
	public DSOnLoadRefuseListOfCostAllocationPanelNewTwo(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("OnLoadRefuseListOfCostAllocationPanelNewTwo");
