...
public class DSTaskApprovalBudgetManagementApplyWork extends DBDataSource
{


	public static DSTaskApprovalBudgetManagementApplyWork instance = null;

	public static DSTaskApprovalBudgetManagementApplyWork getInstance() {
		if(instance == null) {
			instance = new DSTaskApprovalBudgetManagementApplyWork("DSTaskApprovalBudgetManagementApplyWork");
		}
		return instance;
	}
	...
	public DSTaskApprovalBudgetManagementApplyWork(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("TaskApprovalBudgetManagementApplyWork");
...
//		KeyValueManager.loadValueMap("projects",projectIdField);
		...
		setFields(processPooledTaskIdField, budgetManagementIdField, businessIdField, businessNameField, processActivityIdField, processIdField, processInstanceIdField, backViewNameField, nodeTypeField, activityIdField, instanceActivityCreateTimeField, instanceActivityStartTimeField,  bdCodeField, bdTypeField, bdTotalAmountField, bdUseAmountField, bdRestAmountField,bdApplyTimeField, bdEstimatecloseTimeField, bdStatusField, projectIdField, bdRemarkField, inputTaxInvoiceIdField, bdApplyEmployeeIdField,departmentIdField, companyIdField, activityTypeField,statusField, operateTimeField, processCommentField, bdRemarkField);
	}
