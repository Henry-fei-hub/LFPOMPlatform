...
public class SinputtaxinvoiceabporViewer extends AbstractDetailViewer
{
	...
	public SinputtaxinvoiceabporViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Sinputtaxinvoiceabpor", "find", new DSCallback() {
			@Override
