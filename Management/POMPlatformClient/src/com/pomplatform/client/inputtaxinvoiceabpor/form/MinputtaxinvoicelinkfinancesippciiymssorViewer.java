...
public class MinputtaxinvoicelinkfinancesippciiymssorViewer extends AbstractDetailViewer
{
	...
	public MinputtaxinvoicelinkfinancesippciiymssorViewer() {
	}
	...
	public void load() {
		...
		params.put("inputTaxInvoiceId", getBusinessId());
		DBDataSource.callOperation("NQ_Minputtaxinvoicelinkfinancesippciiymssor", "find", new DSCallback() {
			@Override
