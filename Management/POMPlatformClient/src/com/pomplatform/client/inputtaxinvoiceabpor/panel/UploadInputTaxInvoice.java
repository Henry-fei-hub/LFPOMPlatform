...
public final class UploadInputTaxInvoice extends PopupWindow implements HasHandlers {
    private static final Logger __logger = Logger.getLogger("");
    private Map<String, Object> params = new HashMap<>();

    public UploadInputTaxInvoice(final Map<String, Object> map, final String action) {
        super("进项税发票导入");
        setWidth("50%");
        setHeight("50%");
        centerInPage();
