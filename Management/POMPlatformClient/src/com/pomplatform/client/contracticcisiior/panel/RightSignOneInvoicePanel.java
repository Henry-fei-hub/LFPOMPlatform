...
public class RightSignOneInvoicePanel extends AbstractWizadPage implements HasHandlers{
	...
	public RightSignOneInvoicePanel(){
...
//		setBackgroundColor(BACKGROUND_COLOR);
		...
		fields[idx].setRequired(true);
		fields[idx].setSummaryValueTitle("开票金额");
		fields[idx].setCanEdit(true);
		...
		fields[idx].setRequired(true);
		fields[idx].setCanEdit(true);
		fields[idx].setValidators(ValidateUtils.isFloatValidator(), ValidateUtils.decimalRangeValidator(0f, 100f));
		fields[idx].addChangedHandler(new ChangedHandler() {
