...
public class PersonalLeaveTypeViewer extends AbstractDetailViewer
{
	...
	public PersonalLeaveTypeViewer() {
	}
	...
	public void load() {
		...
		params.put("leaveTypeId", getBusinessId());
		DBDataSource.callOperation("NQ_PersonalLeaveType", "find", new DSCallback() {
			@Override
