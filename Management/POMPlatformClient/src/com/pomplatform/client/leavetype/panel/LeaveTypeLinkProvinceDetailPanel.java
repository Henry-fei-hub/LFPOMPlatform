...
public class LeaveTypeLinkProvinceDetailPanel extends AbstractWizadPage {
    ...
    //请假类型和省份关联信息
    LinkOfLeaveTypeAndProvincePanel provincePanel = new LinkOfLeaveTypeAndProvincePanel();
    
    public LeaveTypeLinkProvinceDetailPanel() {
        ...
        hLayout.addMember(provincePanel);
    	...
    	leaveTypeGrid.addCellClickHandler(new CellClickHandler() {
			...
			public void onCellClick(CellClickEvent event) {
				...
				provincePanel.setLeaveTypeId(leaveTypeId);
				provincePanel.commonQuery();
			}
		});
    }
