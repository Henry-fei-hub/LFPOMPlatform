...
import com.pomplatform.client.leavetype.datasource.DSLinkOfLeaveTypeAndArea;
...
public class LinkOfLeaveTypeAndAreaPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			LinkOfLeaveTypeAndAreaPanel cm = new LinkOfLeaveTypeAndAreaPanel();
			id = cm.getID();
			return cm;
		}
	...
	public void initComponents() {
		...
		idx++;
		fields[idx] = new ListGridField("areaId");
		ComboBoxItem provinceItem = new ComboBoxItem();
		provinceItem.setValueMap(KeyValueManager.getValueMap("areas"));
		...
		resultGrid.addEditCompleteHandler(new EditCompleteHandler() {
			...
			public void onEditComplete(EditCompleteEvent event) {
				...
				DBDataSource.callOperation("ST_LeaveTypeLinkArea", "saveOrUpdate", params, new DSCallback() {
					@Override
		...
		removeButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				if(null != selected.getAttribute("leaveTypeId")){
					DBDataSource.callOperation("ST_LeaveTypeLinkArea", "delete", selected.toMap(), new DSCallback() {
						@Override
						public void execute(DSResponse dsResponse, Object data, DSRequest dsRequest) {
							if (dsResponse.getStatus() < 0) {
								ClientUtil.displayErrorMessage(dsResponse);
...
//		return new LinkOfLeaveTypeAndProvinceSearchForm();
	...
	public DataSource getDataSource() {
		return DSLinkOfLeaveTypeAndArea.getInstance();
	}
