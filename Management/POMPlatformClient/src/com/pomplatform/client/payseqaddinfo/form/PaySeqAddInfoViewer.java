...
public class PaySeqAddInfoViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		params.put("paymentSequenceId", getBusinessId());
		DBDataSource.callOperation("NQ_PaySeqAddInfo", "find", new DSCallback() {
			@Override
