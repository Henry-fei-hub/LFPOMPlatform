...
public class CwdFileFilterViewer extends AbstractDetailViewer
{




	public CwdFileFilterViewer() {
	}
	...
	public void load() {
		...
		params.put("fileFilterId", getBusinessId());
		DBDataSource.callOperation("ST_CwdFileFilter", "find", new DSCallback() {
			@Override
