...
import com.pomplatform.client.workflow.personnelbusiness.form.AttachmentLinkInvoiceApplysPanel;
...
public class CheckContactsPanel extends AbstractWizadPage implements HasHandlers{
	...
	private ListGridRecord[] gridRecords;
	...
	public CheckContactsPanel(Boolean isUpdate){
//		setBorder(BORDER_STYLE);
		...
		invoiceTypeItem.setHidden(true);
		...
		dutyParagraphItem.setHidden(true);
		...
		registeredAddressItem.setHidden(true);
		...
		bankAccountItem.setHidden(true);
...
//				AttachmentLinkInvoiceApplysPanel panel = new AttachmentLinkInvoiceApplysPanel();
//				panel.setType(1);
//				panel.checkType(getGridRecords(),getContractId());
				DataEditEvent dee = new DataEditEvent();
				Record record = new Record();
				record.setAttribute("temp", 1);
				dee.setData(record);
                fireEvent(dee);
...
//				
		...
		IButton cancelBtn = new IButton("确认绑定");
...
//				panel.checkType(getGridRecords(),getContractId());
	...
	public void setGridRecords(ListGridRecord[] gridRecords) {
