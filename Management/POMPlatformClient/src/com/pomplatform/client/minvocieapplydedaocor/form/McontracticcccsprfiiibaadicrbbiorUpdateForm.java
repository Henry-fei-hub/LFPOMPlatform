...
public class McontracticcccsprfiiibaadicrbbiorUpdateForm extends AbstractWizadPage
{
	...
	public McontracticcccsprfiiibaadicrbbiorUpdateForm() {
		DSMcontracticcccsprfiiibaadicrbbior ds = DSMcontracticcccsprfiiibaadicrbbior.getInstance();
		__form.setWidth100();
		__form.setHeight100();
...
//		parentIdItem.setValueMap(KeyValueManager.getValueMap("project_types"));
		...
		attachmentRemarkItem = new TextItem("attachmentRemark", "确认函申请备注");
	...
	public void setValueManage(ValuesManager manager) {
		manager.setDataSource(DSMcontracticcccsprfiiibaadicrbbior.getInstance());
