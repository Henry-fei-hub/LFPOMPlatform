...
public class MinvocieapplydedaocorViewer extends AbstractDetailViewer
{
	...
	public MinvocieapplydedaocorViewer() {
	}
	...
	public void load() {
		...
		params.put("invoiceApplyId", getBusinessId());
		DBDataSource.callOperation("NQ_Minvocieapplydedaocor", "find", new DSCallback() {
			@Override
