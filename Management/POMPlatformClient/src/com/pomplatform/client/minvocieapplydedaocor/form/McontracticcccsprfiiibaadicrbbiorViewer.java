...
public class McontracticcccsprfiiibaadicrbbiorViewer extends AbstractDetailViewer
{
	...
	public McontracticcccsprfiiibaadicrbbiorViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Mcontracticcccsprfiiibaadicrbbior", "find", new DSCallback() {
			@Override
