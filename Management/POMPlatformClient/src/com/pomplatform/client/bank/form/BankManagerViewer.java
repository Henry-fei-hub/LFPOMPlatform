...
public class BankManagerViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		params.put("bankId", getBusinessId());
		DBDataSource.callOperation("NQ_BankManager", "find", new DSCallback() {
			@Override
