...
public class DSPoolEmployees extends DBDataSource
{


	public static DSPoolEmployees instance = null;

	public static DSPoolEmployees getInstance() {
		if(instance == null) {
			instance = new DSPoolEmployees("DSPoolEmployees");
		}
		return instance;
	}
	...
	public DSPoolEmployees(String dataSourceID) {
