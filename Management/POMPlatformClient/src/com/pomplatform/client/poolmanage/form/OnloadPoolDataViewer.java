...
public class OnloadPoolDataViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnloadPoolData", "find", new DSCallback() {
			@Override
