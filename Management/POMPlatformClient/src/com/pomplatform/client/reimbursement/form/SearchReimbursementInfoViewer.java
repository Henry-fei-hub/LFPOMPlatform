...
public class SearchReimbursementInfoViewer extends AbstractDetailViewer
{
	...
	public SearchReimbursementInfoViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_SearchReimbursementInfo", "find", new DSCallback() {
			@Override
