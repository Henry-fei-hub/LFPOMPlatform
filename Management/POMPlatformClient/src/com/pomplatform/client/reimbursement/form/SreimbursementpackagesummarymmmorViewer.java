...
public class SreimbursementpackagesummarymmmorViewer extends AbstractDetailViewer
{
	...
	public SreimbursementpackagesummarymmmorViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Sreimbursementpackagesummarymmmor", "find", new DSCallback() {
			@Override
