...
public class K3VoucherSummaryViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_K3VoucherSummary", "find", new DSCallback() {
			@Override
