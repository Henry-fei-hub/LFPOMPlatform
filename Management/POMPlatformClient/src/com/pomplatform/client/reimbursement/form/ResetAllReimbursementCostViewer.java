...
public class ResetAllReimbursementCostViewer extends AbstractDetailViewer
{
	...
	public ResetAllReimbursementCostViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ResetAllReimbursementCost", "find", new DSCallback() {
			@Override
