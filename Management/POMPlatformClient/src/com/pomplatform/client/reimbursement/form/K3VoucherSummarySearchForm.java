...
import com.pomplatform.client.reimbursement.datasource.CDK3VoucherSummary;
...
public class K3VoucherSummarySearchForm extends SearchForm
{
	...
	public K3VoucherSummarySearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDK3VoucherSummary.getInstance());
