...
public class K3VoucherListViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_K3VoucherList", "find", new DSCallback() {
			@Override
