...
import com.pomplatform.client.reimbursement.datasource.CDResetAllReimbursementCost;
...
public class ResetAllReimbursementCostSearchForm extends SearchForm
{
	...
	public ResetAllReimbursementCostSearchForm() {
		final String plateIds = PomPlatformClientUtil.getRolePlateId();
		setWidth100();
		setHeight100();
		setDataSource(CDResetAllReimbursementCost.getInstance());
		...
		endCompleteTimeItem = new DateItem("endCompleteTime", "完成截止日期");
		endCompleteTimeItem.setWidth("*");
		
		setItems(processTypeItem, feeTypeItem, processStatusItem, plateIdItem, codeItem, employeeIdItem, bearFeeCodeItem, bearFeeNameItem, startTimeItem, endTimeItem, startCompleteTimeItem, endCompleteTimeItem);
