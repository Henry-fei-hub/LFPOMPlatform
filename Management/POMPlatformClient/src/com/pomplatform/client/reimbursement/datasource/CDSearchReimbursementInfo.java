...
public class CDSearchReimbursementInfo extends DataSource
{


	public static CDSearchReimbursementInfo instance = null;

	public static CDSearchReimbursementInfo getInstance() {
		if(instance == null) {
			instance = new CDSearchReimbursementInfo("CDSearchReimbursementInfo");
		}
		return instance;
	}
	...
	public CDSearchReimbursementInfo(String dataSourceID) {
		...
		processStatusField.setValueMap(KeyValueManager.getValueMap("system_dictionary"));
		...
		currencyField.setValueMap(KeyValueManager.getValueMap("system_dictionary"));
		...
		setFields(startCreateTimeField, endCreateTimeField, startCompleteTimeField, endCompleteTimeField, processTypeField, bearFeeCodeField, bearFeeNameField, codeField, employeeIdField, plateIdField, processStatusField, packageCodeField, currencyField, contractCodeField, currentPageField, pageLinesField);
