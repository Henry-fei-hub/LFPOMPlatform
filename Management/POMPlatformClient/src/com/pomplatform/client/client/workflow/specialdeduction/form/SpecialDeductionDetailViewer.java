...
public class SpecialDeductionDetailViewer extends AbstractDetailViewer
{




	public SpecialDeductionDetailViewer() {
	}
	...
	public void load() {
		...
		params.put("specialDeductionDetailId", getBusinessId());
		DBDataSource.callOperation("ST_SpecialDeductionDetail", "find", new DSCallback() {
			@Override
	...
	public DataSource getMainDataSource() {
		return DSSpecialDeductionDetail.getInstance();
	}
