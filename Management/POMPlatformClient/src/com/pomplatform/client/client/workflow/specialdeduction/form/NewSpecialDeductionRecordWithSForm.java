...
public class NewSpecialDeductionRecordWithSForm extends GenericWizadWindow
{
	...
	public String getActionName(){
		// 需要根据实际业务修改
		return "ST_SpecialDeductionRecordWithS";
	}
	...
	public List<AbstractWizadPage> getPages(){
		...
		res.add(new SpecialDeductionRecordWithSNewForm());
		return res;
	}
