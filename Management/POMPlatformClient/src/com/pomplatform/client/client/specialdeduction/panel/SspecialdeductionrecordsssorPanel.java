package com.pomplatform.client.client.specialdeduction.panel;
...
import com.pomplatform.client.client.specialdeduction.form.SspecialdeductionrecordsssorSearchForm;
import com.pomplatform.client.client.specialdeduction.form.SspecialdeductionrecordsssorViewer;
import com.pomplatform.client.client.specialdeduction.form.NewSspecialdeductionrecordsssorForm;
import com.pomplatform.client.client.specialdeduction.form.UpdateSspecialdeductionrecordsssorForm;
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("Sspecialdeductionrecordsssor"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				SspecialdeductionrecordsssorViewer detailForm = new SspecialdeductionrecordsssorViewer();
