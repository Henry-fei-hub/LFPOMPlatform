...
public class SspecialdeductionrecordsssorViewer extends AbstractDetailViewer
{
	...
	public SspecialdeductionrecordsssorViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Sspecialdeductionrecordsssor", "find", new DSCallback() {
			@Override
