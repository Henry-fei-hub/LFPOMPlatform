...
public class McontracticcacccorViewer extends AbstractDetailViewer
{
	...
	public McontracticcacccorViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Mcontracticcacccor", "find", new DSCallback() {
			@Override
