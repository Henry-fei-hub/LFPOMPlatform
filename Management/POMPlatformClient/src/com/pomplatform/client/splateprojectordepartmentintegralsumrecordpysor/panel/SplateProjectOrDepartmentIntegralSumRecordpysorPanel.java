package com.pomplatform.client.splateprojectordepartmentintegralsumrecordpysor.panel;
...
import com.pomplatform.client.splateprojectordepartmentintegralsumrecordpysor.datasource.DSSplateProjectOrDepartmentIntegralSumRecordpysor;
import com.pomplatform.client.splateprojectordepartmentintegralsumrecordpysor.form.SplateProjectOrDepartmentIntegralSumRecordpysorViewer;
import com.google.gwt.core.client.GWT;
import com.google.gwt.core.client.RunAsyncCallback;
import com.pomplatform.client.common.CommonFormat;
import com.pomplatform.client.sprojectintegralsumrecordpysor.panel.SprojectintegralsumrecordpysorPanel;
...
public class SplateProjectOrDepartmentIntegralSumRecordpysorPanel extends AbstractSearchPanel {
    ...
    public static class Factory implements PanelFactory {
        ...
        public Canvas create() {
            SplateProjectOrDepartmentIntegralSumRecordpysorPanel cm = new SplateProjectOrDepartmentIntegralSumRecordpysorPanel();
            id = cm.getID();
            return cm;
        }
        ...
        public String getDescription() {
            return "SplateProjectOrDepartmentIntegralSumRecordpysor";
        }
    ...
    public void initComponents() {
        ...
        resultGrid.addDoubleClickHandler(new DoubleClickHandler() {
            ...
            public void onDoubleClick(DoubleClickEvent event) {
                ...
                Map paramMap = generateCriteria();
                paramMap.put("plateId", plateId);
                PopupWindow pw = new PopupWindow();
                SprojectintegralsumrecordpysorPanel panel = new SprojectintegralsumrecordpysorPanel();
                panel.setParamMap(paramMap);
                pw.addItem(panel.getViewPanel());
                pw.setTitle(KeyValueManager.getValue("system_dictionary_1", plateId + "") + "的项目积分汇总");
                pw.setWidth100();
                pw.setHeight100();
                pw.centerInPage();
                pw.show();
        ...
        downLoadButton.addClickHandler(new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                ...
                DBDataSource.downloadFile("DW_SplateProjectOrDepartmentIntegralSumRecordpysor", condition);
            }
        });
        commonQuery();
    }
    ...
    public void showDetail() {
        GWT.runAsync(new RunAsyncCallback() {
            ...
            public void onSuccess() {
                ...
                detail.setTitle("业务部门积分汇总明细");
                detail.setWidth100();
                detail.setHeight100();
                SplateProjectOrDepartmentIntegralSumRecordpysorViewer detailForm = new SplateProjectOrDepartmentIntegralSumRecordpysorViewer();
    ...
    public boolean checkSearchCriteria(Map criteria) {
        if (paramMap != null && paramMap.size() > 0) {
            int plateId = ClientUtil.checkAndGetIntValue(paramMap.get("plateId"));
    ...
    public DataSource getDataSource() {
        return DSSplateProjectOrDepartmentIntegralSumRecordpysor.getInstance();
    }
