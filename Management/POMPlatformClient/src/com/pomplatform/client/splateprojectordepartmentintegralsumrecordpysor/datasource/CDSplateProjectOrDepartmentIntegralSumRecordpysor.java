...
public class CDSplateProjectOrDepartmentIntegralSumRecordpysor extends DataSource
{


	public static CDSplateProjectOrDepartmentIntegralSumRecordpysor instance = null;

	public static CDSplateProjectOrDepartmentIntegralSumRecordpysor getInstance() {
		if(instance == null) {
			instance = new CDSplateProjectOrDepartmentIntegralSumRecordpysor("CDSplateProjectOrDepartmentIntegralSumRecordpysor");
		}
		return instance;
	}
	...
	public CDSplateProjectOrDepartmentIntegralSumRecordpysor(String dataSourceID) {
