...
public class PlateGetViolationChargesMonthlyDetailViewer extends AbstractDetailViewer
{
	...
	public PlateGetViolationChargesMonthlyDetailViewer() {
	}
	...
	public void load() {
		...
		params.put("employeeViolationChargesId", getBusinessId());
		DBDataSource.callOperation("NQ_PlateGetViolationChargesMonthlyDetail", "find", new DSCallback() {
			@Override
