...
public class EmployeeMonthlyAchieveIntegralViewer extends AbstractDetailViewer
{
	...
	public EmployeeMonthlyAchieveIntegralViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_EmployeeMonthlyAchieveIntegral", "find", new DSCallback() {
			@Override
