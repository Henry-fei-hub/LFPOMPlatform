...
import com.pomplatform.client.employeereportrecorddetail.datasource.CDPlateGetViolationChargesMonthlyDetail;

public class PlateGetViolationChargesMonthlyDetailSearchForm extends SearchForm
{
	...
	public PlateGetViolationChargesMonthlyDetailSearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDPlateGetViolationChargesMonthlyDetail.getInstance());
