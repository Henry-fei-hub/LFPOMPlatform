...
public class EmployeeViolationChargesMonthlyViewer extends AbstractDetailViewer
{
	...
	public EmployeeViolationChargesMonthlyViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_EmployeeViolationChargesMonthly", "find", new DSCallback() {
			@Override
