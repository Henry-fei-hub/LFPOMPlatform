...
public class CDOnAttachmentLinkInvoices extends DataSource
{


	public static CDOnAttachmentLinkInvoices instance = null;

	public static CDOnAttachmentLinkInvoices getInstance() {
		if(instance == null) {
			instance = new CDOnAttachmentLinkInvoices("CDOnAttachmentLinkInvoices");
		}
		return instance;
	}
	...
	public CDOnAttachmentLinkInvoices(String dataSourceID) {
