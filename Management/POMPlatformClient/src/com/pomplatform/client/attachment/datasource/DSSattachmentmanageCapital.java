...
public class DSSattachmentmanageCapital extends DBDataSource
{


	public static DSSattachmentmanageCapital instance = null;

	public static DSSattachmentmanageCapital getInstance() {
		if(instance == null) {
			instance = new DSSattachmentmanageCapital("DSSattachmentmanageCapital");
		}
		return instance;
	}
	...
	public DSSattachmentmanageCapital(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("SattachmentmanageCapital");
		...
		setFields(attachmentManageIdField, contractIdField, attachmentCodeField, attachmentNameField, attachmentAddressField, perfessionRemarkField, amountField, returnAmountField, paymentSureField, paymentGradeDescriptionField, serialNumberField, recordDateField, operateEmployeeIdField, operateTimeField, remarkField, deleteFlagField, projectManageIdField, departmentIdField, superProjectManageIdField);
	}
