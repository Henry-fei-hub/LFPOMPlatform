...
public class McontractAttachmentCapitalCountViewer extends AbstractDetailViewer
{
	...
	public McontractAttachmentCapitalCountViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_McontractAttachmentCapitalCount", "find", new DSCallback() {
			@Override
