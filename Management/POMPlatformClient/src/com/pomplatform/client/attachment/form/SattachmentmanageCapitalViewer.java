...
public class SattachmentmanageCapitalViewer extends AbstractDetailViewer
{
	...
	public SattachmentmanageCapitalViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_SattachmentmanageCapital", "find", new DSCallback() {
			@Override
