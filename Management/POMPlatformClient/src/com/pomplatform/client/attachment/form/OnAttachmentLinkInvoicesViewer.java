...
public class OnAttachmentLinkInvoicesViewer extends AbstractDetailViewer
{
	...
	public OnAttachmentLinkInvoicesViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnAttachmentLinkInvoices", "find", new DSCallback() {
			@Override
