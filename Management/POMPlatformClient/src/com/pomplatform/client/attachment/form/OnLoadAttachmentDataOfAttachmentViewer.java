...
public class OnLoadAttachmentDataOfAttachmentViewer extends AbstractDetailViewer
{
	...
	public OnLoadAttachmentDataOfAttachmentViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadAttachmentDataOfAttachment", "find", new DSCallback() {
			@Override
