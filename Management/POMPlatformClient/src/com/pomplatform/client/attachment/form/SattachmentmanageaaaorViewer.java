...
public class SattachmentmanageaaaorViewer extends AbstractDetailViewer
{
	...
	public SattachmentmanageaaaorViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Sattachmentmanageaaaor", "find", new DSCallback() {
			@Override
