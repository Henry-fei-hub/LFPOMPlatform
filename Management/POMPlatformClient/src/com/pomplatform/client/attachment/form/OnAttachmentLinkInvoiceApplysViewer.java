...
public class OnAttachmentLinkInvoiceApplysViewer extends AbstractDetailViewer
{
	...
	public OnAttachmentLinkInvoiceApplysViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnAttachmentLinkInvoiceApplys", "find", new DSCallback() {
			@Override
