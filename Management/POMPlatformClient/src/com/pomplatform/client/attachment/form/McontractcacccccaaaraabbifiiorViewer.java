...
public class McontractcacccccaaaraabbifiiorViewer extends AbstractDetailViewer
{
	...
	public McontractcacccccaaaraabbifiiorViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Mcontractcacccccaaaraabbifiior", "find", new DSCallback() {
			@Override
