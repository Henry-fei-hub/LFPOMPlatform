...
public class UpdateAttachmentLinkContractReceivablesPanel extends AbstractWizadPage {
	...
	public UpdateAttachmentLinkContractReceivablesPanel() {
		initPanel();
	}
...
//			if(selectedNode != null) grid.openFolder(selectedNode);
	...
	public void reloadDetailTableData() {
		...
		DBDataSource.callOperation("NQ_OnUpdateAttachmentLinkContractReceivables", "find", condition, new DSCallback() {
			@Override
