...
public class MprojectAcceptTeamPanel extends AbstractSearchPanel {
    ...
    public static class Factory implements PanelFactory {
        ...
        public Canvas create() {
            MprojectAcceptTeamPanel cm = new MprojectAcceptTeamPanel();
            id = cm.getID();
            return cm;
        }
    ...
    public boolean checkSearchCriteria(Map criteria) {
        ...
        kv.put("key", "pe.status = 0");
        kv.put("value", "pe.status = 1");
        keyvalues.add(kv);
