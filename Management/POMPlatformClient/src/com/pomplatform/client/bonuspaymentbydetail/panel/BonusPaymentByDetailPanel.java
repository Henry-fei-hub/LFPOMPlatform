package com.pomplatform.client.bonuspaymentbydetail.panel;
...
import com.pomplatform.client.bonuspaymentbydetail.datasource.DSBonusPaymentByDetail;
import com.pomplatform.client.bonuspaymentbydetail.form.BonusPaymentByDetailViewer;
...
public class BonusPaymentByDetailPanel extends AbstractSearchPanel {
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			BonusPaymentByDetailPanel cm = new BonusPaymentByDetailPanel();
			id = cm.getID();
			return cm;
		}
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("Sbonuspaymentdetaileymor");
				detail.setWidth100();
				detail.setHeight100();
				BonusPaymentByDetailViewer detailForm = new BonusPaymentByDetailViewer();
...
//		return new BonusPaymentByDetailSearchForm();
		return null;
	}

	@Override
	public DataSource getDataSource() {
		return DSBonusPaymentByDetail.getInstance();
	}
