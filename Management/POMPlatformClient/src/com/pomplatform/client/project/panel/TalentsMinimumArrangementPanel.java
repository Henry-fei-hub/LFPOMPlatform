...
public class TalentsMinimumArrangementPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			TalentsMinimumArrangementPanel cm = new TalentsMinimumArrangementPanel();
			id = cm.getID();
			return cm;
		}
		...
		public String getDescription() {
			return "TalentsMinimumArrangement";
		}
	...
	public void initComponents() {
		...
		int idx = 0;
		fields[idx] = new ListGridField("talentsMinimumArrangementId");
		...
		resultGrid.addEditCompleteHandler(new EditCompleteHandler() {
			...
			public void onEditComplete(EditCompleteEvent event) {
				...
				DBDataSource.callOperation("ST_TalentsMinimumArrangement", "saveOrUpdate", params, new DSCallback() {
					@Override
			...
			public void onClick(ClickEvent event) {
				...
				SC.ask("提示","您确认要删除吗?",new BooleanCallback() {
					...
					public void execute(Boolean value) {
						...
						DBDataSource.callOperation("ST_TalentsMinimumArrangement", "delete", selected.toMap(), new DSCallback() {
							@Override
							public void execute(DSResponse dsResponse, Object data, DSRequest dsRequest) {
								if (dsResponse.getStatus() < 0) {
									ClientUtil.displayErrorMessage(dsResponse);
	...
	public DataSource getDataSource() {
		return DSTalentsMinimumArrangement.getInstance();
	}
