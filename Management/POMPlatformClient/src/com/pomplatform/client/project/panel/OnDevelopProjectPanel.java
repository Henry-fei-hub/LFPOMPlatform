...
import com.pomplatform.client.project.form.OnDevelopProjectSearchForm;
...
public class OnDevelopProjectPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			OnDevelopProjectPanel cm = new OnDevelopProjectPanel();
			id = cm.getID();
			return cm;
		}
	...
	public void initComponents() {
		...
		//公司研发的立项
		IButton operation1Button = PermissionControl.createPermissionButton("立项", ERPPermissionStatic.DEVELOP_PROJECT_COMPANY_NEW);
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						int projectType = 55;//项目类型(默认为研发)
						int projectFlag = 2;//项目标示类型(默认为研发项目)
						int plateId = 18;//归属部门(默认为研发中心)
		...
		//部门研发的立项
		IButton departmentButton = PermissionControl.createPermissionButton("立项", ERPPermissionStatic.DEVELOP_PROJECT_DEPARTMENT_NEW);
		...
		IButton operation2Button = PermissionControl.createPermissionButton("修改", ERPPermissionStatic.DEVELOP_PROJECT_UPDATE);
	...
	public boolean checkSearchCriteria(Map criteria) {
		criteria.put("projectFlag",2);//只检索研发项目
	...
	public SearchForm generateSearchForm() {
		return new OnDevelopProjectSearchForm();
	}
