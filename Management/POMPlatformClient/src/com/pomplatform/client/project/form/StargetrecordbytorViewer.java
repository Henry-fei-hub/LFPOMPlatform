...
public class StargetrecordbytorViewer extends AbstractDetailViewer
{
	...
	public StargetrecordbytorViewer() {
	}
	...
	public void load() {
		...
		params.put("targetRecordId", getBusinessId());
		DBDataSource.callOperation("NQ_Stargetrecordbytor", "find", new DSCallback() {
			@Override
