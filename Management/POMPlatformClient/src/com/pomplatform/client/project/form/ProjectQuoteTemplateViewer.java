...
public class ProjectQuoteTemplateViewer extends AbstractDetailViewer
{




	public ProjectQuoteTemplateViewer() {
	}
	...
	public void load() {
		...
		params.put("projectQuoteTemplateId", getBusinessId());
		DBDataSource.callOperation("ST_ProjectQuoteTemplate", "find", new DSCallback() {
			@Override
