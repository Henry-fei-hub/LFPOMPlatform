...
public class OnLoadProjectOverviewViewer extends AbstractDetailViewer
{
	...
	public OnLoadProjectOverviewViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadProjectOverview", "find", new DSCallback() {
			@Override
