...
public class OnManageProjectSearchForm extends SearchForm
{
	...
	public OnManageProjectSearchForm() {
		setWidth100();
		setHeight100();
		...
		//查看所有部门的数据
		if(ClientUtil.checkIsHavePermission(ERPPermissionStatic.MANAGE_PROJECT_CHECK_ALL)){
			plateIdItem.setDefaultValue(ClientUtil.getPlateId());
			plateIdItem.setValueMap(KeyValueManager.getValueMap("system_dictionary_1"));
		}else if(ClientUtil.checkIsHavePermission(ERPPermissionStatic.MANAGE_PROJECT_CHECK_MYSELF)){
