...
public class GetProjectsViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_GetProjects", "find", new DSCallback() {
			@Override
