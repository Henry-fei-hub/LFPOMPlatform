...
public class TrackTalentsMinimumArrangementViewer extends AbstractDetailViewer
{




	public TrackTalentsMinimumArrangementViewer() {
	}
	...
	public void load() {
		...
		params.put("trackTalentsMinimumArrangementId", getBusinessId());
		DBDataSource.callOperation("ST_TrackTalentsMinimumArrangement", "find", new DSCallback() {
			@Override
