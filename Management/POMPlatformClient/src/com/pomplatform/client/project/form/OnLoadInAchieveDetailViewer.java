...
public class OnLoadInAchieveDetailViewer extends AbstractDetailViewer
{
	...
	public OnLoadInAchieveDetailViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadInAchieveDetail", "find", new DSCallback() {
			@Override
