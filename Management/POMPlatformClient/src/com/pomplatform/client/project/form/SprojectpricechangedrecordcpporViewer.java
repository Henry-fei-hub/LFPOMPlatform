...
public class SprojectpricechangedrecordcpporViewer extends AbstractDetailViewer
{
	...
	public SprojectpricechangedrecordcpporViewer() {
	}
	...
	public void load() {
		...
		params.put("projectPriceChangedRecordId", getBusinessId());
		DBDataSource.callOperation("NQ_Sprojectpricechangedrecordcppor", "find", new DSCallback() {
			@Override
