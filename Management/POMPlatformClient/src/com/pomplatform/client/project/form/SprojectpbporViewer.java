...
public class SprojectpbporViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Sprojectpbpor", "find", new DSCallback() {
			@Override
