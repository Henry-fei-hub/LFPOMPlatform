...
import static com.pomplatform.client.project.form.SprojectccporNewForm.setProjectManagerItemValueMap;
import com.smartgwt.client.widgets.form.fields.events.ChangedEvent;
import com.smartgwt.client.widgets.form.fields.events.ChangedHandler;

public class SprojectccporUpdateForm extends AbstractWizadPage {
    ...
    public SprojectccporUpdateForm() {
        ...
        contractCodeItem.addChangedHandler(new ChangedHandler() {
            ...
            public void onChanged(ChangedEvent event) {
                Object projectCode = projectCodeItem.getValue();
                if (!ClientUtil.isNullOrEmpty(projectCode)) {
                    return;
                }
                Object val = event.getValue();
                projectCodeItem.setValue(val);
            }
