...
public class OnDevelopProjectViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnDevelopProject", "find", new DSCallback() {
			@Override
