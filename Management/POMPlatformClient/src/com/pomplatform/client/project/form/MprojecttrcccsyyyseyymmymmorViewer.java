...
public class MprojecttrcccsyyyseyymmymmorViewer extends AbstractDetailViewer
{
	...
	public MprojecttrcccsyyyseyymmymmorViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Mprojecttrcccsyyyseyymmymmor", "find", new DSCallback() {
			@Override
