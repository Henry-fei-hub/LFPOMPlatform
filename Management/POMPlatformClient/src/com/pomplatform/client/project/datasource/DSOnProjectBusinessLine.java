...
public class DSOnProjectBusinessLine extends DBDataSource
{


	public static DSOnProjectBusinessLine instance = null;

	public static DSOnProjectBusinessLine getInstance() {
		if(instance == null) {
			instance = new DSOnProjectBusinessLine("DSOnProjectBusinessLine");
		}
		return instance;
	}
	...
	public DSOnProjectBusinessLine(String dataSourceID) {
...
//		contractCodeField.setValueMap(KeyValueManager.getValueMap("contracts"));
		...
		projectLevelField.setCanEdit(false);
