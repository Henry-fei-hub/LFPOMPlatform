...
public class DSGetProjects extends DBDataSource
{


	public static DSGetProjects instance = null;

	public static DSGetProjects getInstance() {
		if(instance == null) {
			instance = new DSGetProjects("DSGetProjects");
		}
		return instance;
	}
	...
	public DSGetProjects(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("GetProjects");
