...
public class DSOnLoadProjectEmpAndStageInfo extends DBDataSource
{


	public static DSOnLoadProjectEmpAndStageInfo instance = null;

	public static DSOnLoadProjectEmpAndStageInfo getInstance() {
		if(instance == null) {
			instance = new DSOnLoadProjectEmpAndStageInfo("DSOnLoadProjectEmpAndStageInfo");
		}
		return instance;
	}
	...
	public DSOnLoadProjectEmpAndStageInfo(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("OnLoadProjectEmpAndStageInfo");
		...
		sureIntegralField = new DataSourceFloatField("sureIntegral", "sureIntegral");
		...
		setFields(projectIdField, employeeIdField, employeeNoField, employeeNameField, stageIdField, planIntegralField, sureIntegralField, gradeIdField, alternateField1Field, alternateField2Field);
	}
