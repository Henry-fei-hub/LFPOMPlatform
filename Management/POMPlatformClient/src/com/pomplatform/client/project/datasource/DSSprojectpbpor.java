...
public class DSSprojectpbpor extends DBDataSource
{


	public static DSSprojectpbpor instance = null;

	public static DSSprojectpbpor getInstance() {
		if(instance == null) {
			instance = new DSSprojectpbpor("DSSprojectpbpor");
		}
		return instance;
	}
	...
	public DSSprojectpbpor(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("Sprojectpbpor");
		...
		projectIdField.setForeignKey("DSSprojectpbpor.projectId");  
