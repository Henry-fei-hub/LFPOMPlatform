...
public class AttendanceManagementStatisticsViewer extends AbstractDetailViewer
{
	...
	public AttendanceManagementStatisticsViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_AttendanceManagementStatistics", "find", new DSCallback() {
			@Override
