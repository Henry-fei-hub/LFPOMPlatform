...
public class DSMemployeecheckinouteeseor extends DBDataSource {

	public static DSMemployeecheckinouteeseor instance = null;

	public static DSMemployeecheckinouteeseor getInstance() {
		if (instance == null) {
			instance = new DSMemployeecheckinouteeseor("DSMemployeecheckinouteeseor");
		}
		return instance;
	}
	...
	public DSMemployeecheckinouteeseor(String dataSourceID) {
		...
		setFields(employeeIdField, employeeNoField, employeeNameField, checkDateField, dayOfWeekField, checkInField, checkOutField, statusField, finalStatusField, commentsField);
	}
