...
public class CDAttentionProjectQuoteTemplate extends DataSource
{


	public static CDAttentionProjectQuoteTemplate instance = null;

	public static CDAttentionProjectQuoteTemplate getInstance() {
		if(instance == null) {
			instance = new CDAttentionProjectQuoteTemplate("CDAttentionProjectQuoteTemplate");
		}
		return instance;
	}
	...
	public CDAttentionProjectQuoteTemplate(String dataSourceID) {
		...
		setFields(statusField, processTypeField, employeeIdField, projectNameField, projectTypeField, operateEmployeeIdField, businessTypeField, currentPageField, pageLinesField);
