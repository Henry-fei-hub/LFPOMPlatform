package com.pomplatform.client.attentionprojectquotetemplate.panel;
...
import com.pomplatform.client.attentionprojectquotetemplate.datasource.DSAttentionProjectQuoteTemplate;
import com.pomplatform.client.attentionprojectquotetemplate.form.AttentionProjectQuoteTemplateSearchForm;
...
public class AttentionProjectQuoteTemplatePanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			AttentionProjectQuoteTemplatePanel cm = new AttentionProjectQuoteTemplatePanel();
			id = cm.getID();
			return cm;
		}
		...
		public String getDescription() {
			return "AttentionProjectQuoteTemplate";
		}
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("项目报价详情"); 
				detail.setWidth100(); 
				detail.setHeight100();
				AttentionProjectQuoteTemplateViewer detailForm = new AttentionProjectQuoteTemplateViewer();
	...
	public SearchForm generateSearchForm() {
		return new AttentionProjectQuoteTemplateSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSAttentionProjectQuoteTemplate.getInstance();
	}
