...
import com.pomplatform.client.employeedetail.datasource.CDSalaryReturnDetail;

public class SalaryReturnDetailSearchForm extends SearchForm
{
	...
	public SalaryReturnDetailSearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDSalaryReturnDetail.getInstance());
