...
import com.pomplatform.client.employeedetail.datasource.CDManagerProjectIntegralDetail;

public class ManagerProjectIntegralDetailSearchForm extends SearchForm
{
	...
	public ManagerProjectIntegralDetailSearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDManagerProjectIntegralDetail.getInstance());
