...
import com.pomplatform.client.employeedetail.datasource.CDProjectCostDetail;

public class ProjectCostDetailSearchForm extends SearchForm
{
	...
	public ProjectCostDetailSearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDProjectCostDetail.getInstance());
