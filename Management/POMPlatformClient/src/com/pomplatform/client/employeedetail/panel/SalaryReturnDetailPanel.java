...
import com.pomplatform.client.employeedetail.datasource.DSSalaryReturnDetail;
import com.pomplatform.client.employeedetail.form.SalaryReturnDetailViewer;
...
public class SalaryReturnDetailPanel extends AbstractSearchPanel {
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			SalaryReturnDetailPanel cm = new SalaryReturnDetailPanel();
			id = cm.getID();
			return cm;
		}
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("人工成本回流");
				detail.setWidth100();
				detail.setHeight100();
				SalaryReturnDetailViewer detailForm = new SalaryReturnDetailViewer();
	...
	public SearchForm generateSearchForm() {
		// return new SalaryReturnDetailSearchForm();
		return null;
	}

	@Override
	public DataSource getDataSource() {
		return DSSalaryReturnDetail.getInstance();
	}
