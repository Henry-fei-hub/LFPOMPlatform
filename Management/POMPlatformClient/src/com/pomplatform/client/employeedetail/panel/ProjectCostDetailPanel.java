...
import com.pomplatform.client.employeedetail.datasource.DSProjectCostDetail;
import com.pomplatform.client.employeedetail.form.ProjectCostDetailViewer;
...
public class ProjectCostDetailPanel extends AbstractSearchPanel {
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			ProjectCostDetailPanel cm = new ProjectCostDetailPanel();
			id = cm.getID();
			return cm;
		}
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setWidth100();
				detail.setHeight100();
				ProjectCostDetailViewer detailForm = new ProjectCostDetailViewer();
	...
	public SearchForm generateSearchForm() {
		// return new ProjectCostDetailSearchForm();
		return null;
	}

	@Override
	public DataSource getDataSource() {
		return DSProjectCostDetail.getInstance();
	}
