...
public class CDSalaryReturnDetail extends DataSource
{


	public static CDSalaryReturnDetail instance = null;

	public static CDSalaryReturnDetail getInstance() {
		if(instance == null) {
			instance = new CDSalaryReturnDetail("CDSalaryReturnDetail");
		}
		return instance;
	}
	...
	public CDSalaryReturnDetail(String dataSourceID) {
