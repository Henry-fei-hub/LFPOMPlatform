...
public class CDProjectCostDetail extends DataSource
{


	public static CDProjectCostDetail instance = null;

	public static CDProjectCostDetail getInstance() {
		if(instance == null) {
			instance = new CDProjectCostDetail("CDProjectCostDetail");
		}
		return instance;
	}
	...
	public CDProjectCostDetail(String dataSourceID) {
