...
public final class UploadTaskTemplatePanel extends PopupWindow implements HasHandlers {
    private static final Logger __logger = Logger.getLogger("");
    private Map<String, Object> params = new HashMap<>();
    
	public UploadTaskTemplatePanel( final String title, final Map<String, Object> map, final String action) {
        super(title);
        setWidth("50%");
        setHeight("50%");
        centerInPage();
