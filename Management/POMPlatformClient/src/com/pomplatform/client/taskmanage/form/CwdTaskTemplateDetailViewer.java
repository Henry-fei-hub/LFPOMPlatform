...
public class CwdTaskTemplateDetailViewer extends AbstractDetailViewer
{




	public CwdTaskTemplateDetailViewer() {
	}
	...
	public void load() {
		...
		params.put("cwdTaskTemplateDetailId", getBusinessId());
		DBDataSource.callOperation("ST_CwdTaskTemplateDetail", "find", new DSCallback() {
			@Override
