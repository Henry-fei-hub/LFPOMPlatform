...
public class ScwdtasktemplatetccorUpdateForm extends AbstractWizadPage
{
	...
	public ScwdtasktemplatetccorUpdateForm() {
		DSScwdtasktemplatetccor ds = DSScwdtasktemplatetccor.getInstance();
		__form.setWidth100();
		__form.setHeight100();
		cwdTaskTemplateIdItem = new TextItem("cwdTaskTemplateId", "主键");
		cwdTaskTemplateIdItem.setDisabled(true);
		cwdTaskTemplateIdItem.setRequired(true);
		IsIntegerValidator cwdTaskTemplateIdValidator = new IsIntegerValidator();
		cwdTaskTemplateIdItem.setValidators(cwdTaskTemplateIdValidator);
