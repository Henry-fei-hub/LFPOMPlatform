...
public class ScwdtasktemplatetccorViewer extends AbstractDetailViewer
{
	...
	public ScwdtasktemplatetccorViewer() {
	}
	...
	public void load() {
		...
		params.put("cwdTaskTemplateId", getBusinessId());
		DBDataSource.callOperation("NQ_Scwdtasktemplatetccor", "find", new DSCallback() {
			@Override
