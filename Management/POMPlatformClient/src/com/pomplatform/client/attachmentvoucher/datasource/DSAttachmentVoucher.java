...
public class DSAttachmentVoucher extends DBDataSource
{


	public static DSAttachmentVoucher instance = null;

	public static DSAttachmentVoucher getInstance() {
		if(instance == null) {
			instance = new DSAttachmentVoucher("DSAttachmentVoucher");
		}
		return instance;
	}
	...
	public DSAttachmentVoucher(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("AttachmentVoucher");
		...
		attachmentManageIdField.setHidden(false);
		...
		setFields(k3VoucherIdField, attachmentManageIdField, projectIdField, companyIdField, sequenceNumberField, internalSequenceNumberField, codeTypeField, codeIdField, codeField, nameField, secondaryCodeTypeField, secondaryCodeIdField, secondaryCodeField, secondaryNameField, remarkField, simplifyRemarkField, debitSideField, creditSideField, reimbursementPackageCodeField, amountOfReimbursementField, inputTaxField, selfBankAccountField, otherBankAccountField, needToChangeField, vestingDateField, lockedField, createTimeField, updateTimeField, lockedTimeField, linkIdField, voucherTypeField, additionalLinkIdField, attachmentNameField, attachmentCodeField);
	}
