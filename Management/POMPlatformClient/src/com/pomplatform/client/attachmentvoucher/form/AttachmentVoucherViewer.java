...
public class AttachmentVoucherViewer extends AbstractDetailViewer
{
	...
	public AttachmentVoucherViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_AttachmentVoucher", "find", new DSCallback() {
			@Override
