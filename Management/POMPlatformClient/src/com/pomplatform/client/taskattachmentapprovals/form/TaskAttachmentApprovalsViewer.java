...
public class TaskAttachmentApprovalsViewer extends AbstractDetailViewer
{
	...
	public TaskAttachmentApprovalsViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_TaskAttachmentApprovals", "find", new DSCallback() {
			@Override
