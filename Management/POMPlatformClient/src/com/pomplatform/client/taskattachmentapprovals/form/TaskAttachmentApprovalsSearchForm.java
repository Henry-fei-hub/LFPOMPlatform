package com.pomplatform.client.taskattachmentapprovals.form;
...
import com.pomplatform.client.taskattachmentapprovals.datasource.CDTaskAttachmentApprovals;

public class TaskAttachmentApprovalsSearchForm extends SearchForm
{
	...
	public TaskAttachmentApprovalsSearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDTaskAttachmentApprovals.getInstance());
