...
public class DSTaskAttachmentApprovals extends DBDataSource
{


	public static DSTaskAttachmentApprovals instance = null;

	public static DSTaskAttachmentApprovals getInstance() {
		if(instance == null) {
			instance = new DSTaskAttachmentApprovals("DSTaskAttachmentApprovals");
		}
		return instance;
	}
	...
	public DSTaskAttachmentApprovals(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("TaskAttachmentApprovals");
		...
		setFields(processPooledTaskIdField, budgetAttachmentIdField, businessIdField, businessNameField, processActivityIdField, processIdField, processInstanceIdField, backViewNameField, nodeTypeField, activityIdField, instanceActivityCreateTimeField, instanceActivityStartTimeField, statusField, operateTimeField, processCommentField, fileUrlField, budgetManagementIdField, fileIdField, attachmentNameField, uploadEmployeeIdField, departmentIdField, uploadTimeField, uploadRemarkField, budgetContractAmountField, budgetContractAmountUseField, budgetContractAmountRestField, receiveUnitManageIdField, projectIdField, inputTaxInvoiceIdField, bddTypeField, isApprovalField, activityTypeField);
	}
