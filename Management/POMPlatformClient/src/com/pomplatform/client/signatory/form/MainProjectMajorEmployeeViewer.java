...
public class MainProjectMajorEmployeeViewer extends AbstractDetailViewer
{




	public MainProjectMajorEmployeeViewer() {
	}
	...
	public void load() {
		...
		params.put("mainProjectMajorEmployeeId", getBusinessId());
		DBDataSource.callOperation("ST_MainProjectMajorEmployee", "find", new DSCallback() {
			@Override
