...
public class MainProjectMajorEmployeeUpdateForm extends AbstractWizadPage
{


	private final TextItem mainProjectMajorEmployeeIdItem;
	...
	public MainProjectMajorEmployeeUpdateForm() {
		DSMainProjectMajorEmployee ds = DSMainProjectMajorEmployee.getInstance();
		__form.setWidth100();
		__form.setHeight100();
		mainProjectMajorEmployeeIdItem = new TextItem("mainProjectMajorEmployeeId", "主键");
		mainProjectMajorEmployeeIdItem.setDisabled(true);
		mainProjectMajorEmployeeIdItem.setRequired(true);
		IsIntegerValidator mainProjectMajorEmployeeIdValidator = new IsIntegerValidator();
		mainProjectMajorEmployeeIdItem.setValidators(mainProjectMajorEmployeeIdValidator);
		__formItems.add(mainProjectMajorEmployeeIdItem);
