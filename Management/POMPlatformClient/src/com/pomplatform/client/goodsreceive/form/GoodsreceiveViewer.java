...
public class GoodsreceiveViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		params.put("goodsReceiveId", getBusinessId());
		DBDataSource.callOperation("NQ_Goodsreceive", "find", new DSCallback() {
			@Override
