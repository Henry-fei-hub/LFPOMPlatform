...
public class DSSthreadtaskmanagemmmor extends DBDataSource {

	public static DSSthreadtaskmanagemmmor instance = null;

	public static DSSthreadtaskmanagemmmor getInstance() {
		if (instance == null) {
			instance = new DSSthreadtaskmanagemmmor("DSSthreadtaskmanagemmmor");
		}
		return instance;
	}
	...
	public DSSthreadtaskmanagemmmor(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("Sthreadtaskmanagemmmor");
		...
		setFields(threadTaskManageIdField, taskTypeField, statusField, operatorField, operationTypeField,
				beginTimeField, endTimeField, createTimeField, remarkField, errorMsgField);
	}
