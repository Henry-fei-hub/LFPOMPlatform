...
public class SthreadtaskmanagemmmorViewer extends AbstractDetailViewer
{
	...
	public SthreadtaskmanagemmmorViewer() {
	}
	...
	public void load() {
		...
		params.put("threadTaskManageId", getBusinessId());
		DBDataSource.callOperation("NQ_Sthreadtaskmanagemmmor", "find", new DSCallback() {
			@Override
