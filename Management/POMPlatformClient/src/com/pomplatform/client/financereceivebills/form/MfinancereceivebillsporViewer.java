...
public class MfinancereceivebillsporViewer extends AbstractDetailViewer
{
	...
	public MfinancereceivebillsporViewer() {
	}
	...
	public void load() {
		...
		params.put("financeReceiveBillId", getBusinessId());
		DBDataSource.callOperation("NQ_Mfinancereceivebillspor", "find", new DSCallback() {
			@Override
