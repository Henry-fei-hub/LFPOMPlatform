...
public class SreceiveunitmanagemmrorViewer extends AbstractDetailViewer
{
	...
	public SreceiveunitmanagemmrorViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Sreceiveunitmanagemmror", "find", new DSCallback() {
			@Override
