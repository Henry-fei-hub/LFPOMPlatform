...
public class SreceiveunitmanagemmrorNewForm extends AbstractWizadPage {
	...
	public SreceiveunitmanagemmrorNewForm() {
...
//		bankIdItem.setValueMap(KeyValueManager.getValueMap("banks"));
		...
		bankIdItem.addChangedHandler(new ChangedHandler() {
			...
			public void onChanged(ChangedEvent event) {
				if(null != event.getValue()){
					bankNameItem.setValue(bankIdItem.getDisplayValue());
				}
		...
		originItem.setWidth("*");
		originItem.setDefaultValue(0);
		originItem.setHidden(true);
