...
public class BudgetManagementApplyWorkViewer extends AbstractDetailViewer
{
	...
	public BudgetManagementApplyWorkViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_BudgetManagementApplyWork", "find", new DSCallback() {
			@Override
