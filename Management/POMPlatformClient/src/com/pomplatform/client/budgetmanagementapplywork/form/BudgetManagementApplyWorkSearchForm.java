package com.pomplatform.client.budgetmanagementapplywork.form;
...
import com.pomplatform.client.budgetmanagementapplywork.datasource.CDBudgetManagementApplyWork;

public class BudgetManagementApplyWorkSearchForm extends SearchForm
{
	...
	public BudgetManagementApplyWorkSearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDBudgetManagementApplyWork.getInstance());
		...
		bdApplyEmployeeIdItem.setHidden(true);
