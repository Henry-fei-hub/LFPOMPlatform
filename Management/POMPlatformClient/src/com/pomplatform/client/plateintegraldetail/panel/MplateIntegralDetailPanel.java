package com.pomplatform.client.plateintegraldetail.panel;
...
import com.pomplatform.client.plateintegraldetail.datasource.DSMplateIntegralDetail;
import com.google.gwt.core.client.GWT;
import com.google.gwt.core.client.RunAsyncCallback;
import com.pomplatform.client.plateprojectintegraldetail.panel.MplateProjectIntegralDetailPanel;
...
public class MplateIntegralDetailPanel extends AbstractSearchPanel {
    ...
    public static class Factory implements PanelFactory {
        ...
        public Canvas create() {
            MplateIntegralDetailPanel cm = new MplateIntegralDetailPanel();
            id = cm.getID();
            return cm;
        }
    ...
    public void showDetail() {
        GWT.runAsync(new RunAsyncCallback() {
            ...
            public void onSuccess() {
                ...
                MplateProjectIntegralDetailPanel myselfProject = new MplateProjectIntegralDetailPanel();
                myselfProject.setPlateId(plateId);
                pw.addItem(myselfProject.getViewPanel());
                pw.setTitle("业务部门(" + palteName + ")的项目明细");
                pw.setWidth100();
                pw.setHeight100();
                pw.centerInPage();
                pw.show();
...
//                detail.setTitle("板块积分汇总明细");
//                detail.setWidth100();
//                detail.setHeight100();
//                MplateIntegralDetailViewer detailForm = new MplateIntegralDetailViewer();
...
//        return new MplateIntegralDetailSearchForm();
        return null;
    }

    @Override
    public DataSource getDataSource() {
        return DSMplateIntegralDetail.getInstance();
    }
