...
public class OnEmployeeIntegralBusinessViewer extends AbstractDetailViewer
{
	...
	public OnEmployeeIntegralBusinessViewer() {
	}
	...
	public void load() {
		...
		params.put("employeeIntegralBusinessId", getBusinessId());
		DBDataSource.callOperation("NQ_OnEmployeeIntegralBusiness", "find", new DSCallback() {
			@Override
