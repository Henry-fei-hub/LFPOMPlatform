...
public class DSMemployeeAward extends DBDataSource {

    public static DSMemployeeAward instance = null;

    public static DSMemployeeAward getInstance() {
        if (instance == null) {
            instance = new DSMemployeeAward("DSMemployeeAward");
        }
        return instance;
    }
    ...
    public DSMemployeeAward(String dataSourceID) {

        super();
        setID(dataSourceID);
        setActionMode(ACTION_MODE_QUERY);
        setActionName("MemployeeAward");
        ...
        baseSalaryField = new DataSourceFloatField("baseSalary", "基本薪资");
        ...
        setFields(photoField, employeeIdField, employeeNameField, departmentIdField, plateIdField, yearsField, monthsField, planIntegralField,sureIntegralField, projectCostField, achieveIntegralField, achieveAwardField,baseSalaryField);
    }
