...
public class DSOnLoadCustomerChlidData extends DBDataSource
{


	public static DSOnLoadCustomerChlidData instance = null;

	public static DSOnLoadCustomerChlidData getInstance() {
		if(instance == null) {
			instance = new DSOnLoadCustomerChlidData("DSOnLoadCustomerData");
		}
		return instance;
	}
	...
	public DSOnLoadCustomerChlidData(String dataSourceID) {
