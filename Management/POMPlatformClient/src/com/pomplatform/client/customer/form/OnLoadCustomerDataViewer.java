...
public class OnLoadCustomerDataViewer extends AbstractDetailViewer
{
	...
	public OnLoadCustomerDataViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadCustomerData", "find", new DSCallback() {
			@Override
