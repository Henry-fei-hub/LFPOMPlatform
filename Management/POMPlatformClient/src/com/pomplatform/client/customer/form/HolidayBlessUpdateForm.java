...
public class HolidayBlessUpdateForm extends AbstractWizadPage
{
	private final TextItem holidayBlessManageIdItem;
	...
	public HolidayBlessUpdateForm() {
		DSHolidayBless ds = DSHolidayBless.getInstance();
		__form.setWidth100();
		__form.setHeight100();
		holidayBlessManageIdItem = new TextItem("holidayBlessManageId", "主键编码");
		holidayBlessManageIdItem.setDisabled(true);
		holidayBlessManageIdItem.setRequired(true);
		holidayBlessManageIdItem.hide();
		IsIntegerValidator holidayBlessManageIdValidator = new IsIntegerValidator();
		holidayBlessManageIdItem.setValidators(holidayBlessManageIdValidator);
		__formItems.add(holidayBlessManageIdItem);
