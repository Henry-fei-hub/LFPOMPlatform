...
public class CustomerResourcesUpdateForm extends AbstractWizadPage
{
	private final TextItem customerResourceIdItem;
	...
	public CustomerResourcesUpdateForm() {
		DSCustomerInfo ds = DSCustomerInfo.getInstance();
		__form.setWidth100();
		__form.setHeight100();
		customerResourceIdItem = new TextItem("customerResourceId", "主键编码");
		customerResourceIdItem.setDisabled(true);
		customerResourceIdItem.setRequired(true);
		customerResourceIdItem.hide();
		IsIntegerValidator customerResourceIdValidator = new IsIntegerValidator();
		customerResourceIdItem.setValidators(customerResourceIdValidator);
		__formItems.add(customerResourceIdItem);
