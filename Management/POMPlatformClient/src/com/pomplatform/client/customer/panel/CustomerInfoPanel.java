...
import com.pomplatform.client.customer.form.NewCustomerInfoForm;
import com.pomplatform.client.customer.form.UpdateCustomerInfoForm;
...
public class CustomerInfoPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			CustomerInfoPanel cm = new CustomerInfoPanel();
			id = cm.getID();
			return cm;
		}
	...
	public void initComponents() {
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						NewCustomerInfoForm detailForm = new NewCustomerInfoForm();
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateCustomerInfoForm detailForm = new UpdateCustomerInfoForm();
		...
		removeButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				DBDataSource.callOperation("ST_CustomerInfo", "delete", selected.toMap(), new DSCallback() {
					@Override
	...
	public boolean checkSearchCriteria(Map criteria) {
		criteria.put("addtionalCondition", "order by customer_id");
		return true;
	}
	...
	public DataSource getDataSource() {
		return DSCustomerInfo.getInstance();
	}
