...
public class ChangeProjectInfoViewer extends AbstractDetailViewer
{
	...
	public ChangeProjectInfoViewer() {
	}
	...
	public void load() {
		...
		params.put("projectChangeId", getBusinessId());
		DBDataSource.callOperation("NQ_ChangeProjectInfo", "find", new DSCallback() {
			@Override
