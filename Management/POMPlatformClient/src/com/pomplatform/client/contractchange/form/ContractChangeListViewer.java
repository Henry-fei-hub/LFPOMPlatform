...
public class ContractChangeListViewer extends AbstractDetailViewer
{
	...
	public ContractChangeListViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ContractChangeList", "find", new DSCallback() {
			@Override
