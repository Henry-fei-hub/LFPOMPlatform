...
public class ProjectBasicInfoViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ProjectBasicInfo", "find", new DSCallback() {
			@Override
