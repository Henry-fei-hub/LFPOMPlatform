...
public class ChangeContractInfoViewer extends AbstractDetailViewer
{
	...
	public ChangeContractInfoViewer() {
	}
	...
	public void load() {
		...
		params.put("contractChangeId", getBusinessId());
		DBDataSource.callOperation("NQ_ChangeContractInfo", "find", new DSCallback() {
			@Override
