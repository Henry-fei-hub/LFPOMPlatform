...
import com.pomplatform.client.contractchange.form.ChangeContractInfoSearchForm;
import com.pomplatform.client.contractchange.form.ChangeContractInfoViewer;
import com.pomplatform.client.contractchange.form.NewChangeContractInfoForm;
import com.pomplatform.client.contractchange.form.UpdateChangeContractInfoForm;
...
public class ChangeContractInfoPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			ChangeContractInfoPanel cm = new ChangeContractInfoPanel();
			id = cm.getID();
			return cm;
		}
	...
	public void initComponents() {
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						NewChangeContractInfoForm detailForm = new NewChangeContractInfoForm();
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateChangeContractInfoForm detailForm = new UpdateChangeContractInfoForm();
		...
		removeButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				DBDataSource.callOperation("ST_ChangeContractInfo", "delete", selected.toMap(), new DSCallback() {
					@Override
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("合同变更"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				ChangeContractInfoViewer detailForm = new ChangeContractInfoViewer();
	...
	public boolean checkSearchCriteria(Map criteria) {
		criteria.put("addtionalCondition", "order by contract_change_id");
		return true;
	}
	...
	public SearchForm generateSearchForm() {
		return new ChangeContractInfoSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSChangeContractInfo.getInstance();
	}
