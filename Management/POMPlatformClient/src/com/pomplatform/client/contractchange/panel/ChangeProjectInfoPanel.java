...
import com.pomplatform.client.contractchange.form.ChangeProjectInfoSearchForm;
import com.pomplatform.client.contractchange.form.ChangeProjectInfoViewer;
import com.pomplatform.client.contractchange.form.NewChangeProjectInfoForm;
import com.pomplatform.client.contractchange.form.UpdateChangeProjectInfoForm;
...
public class ChangeProjectInfoPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			ChangeProjectInfoPanel cm = new ChangeProjectInfoPanel();
			id = cm.getID();
			return cm;
		}
	...
	public void initComponents() {
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						NewChangeProjectInfoForm detailForm = new NewChangeProjectInfoForm();
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateChangeProjectInfoForm detailForm = new UpdateChangeProjectInfoForm();
		...
		removeButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				DBDataSource.callOperation("ST_ChangeProjectInfo", "delete", selected.toMap(), new DSCallback() {
					@Override
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("项目变更信息"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				ChangeProjectInfoViewer detailForm = new ChangeProjectInfoViewer();
	...
	public boolean checkSearchCriteria(Map criteria) {
		criteria.put("addtionalCondition", "order by project_change_id");
		return true;
	}
	...
	public SearchForm generateSearchForm() {
		return new ChangeProjectInfoSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSChangeProjectInfo.getInstance();
	}
