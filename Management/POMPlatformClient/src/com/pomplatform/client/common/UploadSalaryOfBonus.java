...
public final class UploadSalaryOfBonus extends PopupWindow implements HasHandlers {
    private static final Logger __logger = Logger.getLogger("");
    private Map<String, Object> params = new HashMap<>();

    public UploadSalaryOfBonus(final Map<String, Object> map, final String action) {
        super("职员奖金导入");
        setWidth("50%");
        setHeight("50%");
        centerInPage();
