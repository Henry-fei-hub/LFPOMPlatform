...
public final class UploadEmpFiveInsuranceOneGolds extends PopupWindow implements HasHandlers {
    private static final Logger __logger = Logger.getLogger("");
    private Map<String, Object> params = new HashMap<>();

    LoadingWindow loading = null;

    public UploadEmpFiveInsuranceOneGolds() {
        super("职员五险一金导入");
        setWidth("50%");
        setHeight("50%");
        centerInPage();
...
//        }
        ...
        button.addClickHandler(new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                ...
                formPanel.setAction(DBDataSource.getServerURL("UP_OnUploadEmpFiveInsuranceOneGold"));
                formPanel.submit();
