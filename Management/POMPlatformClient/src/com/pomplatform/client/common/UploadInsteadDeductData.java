...
public final class UploadInsteadDeductData extends PopupWindow implements HasHandlers {
    private static final Logger __logger = Logger.getLogger("");
    private Map<String, Object> params = new HashMap<>();

    public UploadInsteadDeductData() {
        super("代扣款项导入");
        setWidth("50%");
        setHeight("50%");
        centerInPage();
...
//        }
        ...
        button.addClickHandler(new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                ...
                formPanel.setAction(DBDataSource.getServerURL("UP_OnUploadInsteadDeductData"));
                formPanel.submit();
            }
        });
    }
