...
public final class UploadReimbursementAttachments extends PopupWindow implements HasHandlers {
    private static final Logger logger = Logger.getLogger("");
    private Map<String, Object> params = new HashMap<>();
    private String fileName = "";
    
    
    public UploadReimbursementAttachments(final Map<String, Object> map, final String action) {
        super("附件上传");
        setWidth("50%");
        setHeight("50%");
        centerInPage();
...
//                        SC.say("文件上传成功");
                    ...
                    record.setAttribute("attachmentUrl", res.getErrors().get("errorMsg"));
