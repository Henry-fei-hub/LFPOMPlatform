...
public final class UploadFillSendDeductData extends PopupWindow implements HasHandlers {
    private static final Logger __logger = Logger.getLogger("");
    private Map<String, Object> params = new HashMap<>();

    public UploadFillSendDeductData() {
        super("职员补发补扣导入");
        setWidth("50%");
        setHeight("50%");
        centerInPage();
...
//        }
        ...
        button.addClickHandler(new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                ...
                formPanel.setAction(DBDataSource.getServerURL("UP_OnUploadFillSendDeductData"));
                formPanel.submit();
            }
        });
    }
