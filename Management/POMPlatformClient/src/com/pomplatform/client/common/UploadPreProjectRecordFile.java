...
public final class UploadPreProjectRecordFile extends PopupWindow implements HasHandlers {
    private static final Logger logger = Logger.getLogger("");
    private Map<String, Object> params = new HashMap<>();

    public UploadPreProjectRecordFile(final Map<String, Object> map, final String action) {
        super("附件上传");
        setWidth("50%");
        setHeight("50%");
        centerInPage();
            ...
            public void onSubmitComplete(SubmitCompleteEvent event) {
                try {
                    ...
                    if (res.getStatus() >= 0) {
                    	...
                    	record.setAttribute("attachmentName",fileUrl);
                    	String fileName = fileUpload.getFilename();
                    	String[] name = fileName.split("\\\\");
                    	record.setAttribute("fileName", name[name.length-1]);
                    } else {
