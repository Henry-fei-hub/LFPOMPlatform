...
public final class UploadReplacementTaxData extends PopupWindow implements HasHandlers {
    private static final Logger __logger = Logger.getLogger("");
    private Map<String, Object> params = new HashMap<>();

    public UploadReplacementTaxData() {
        super("补发个税数据导入");
        setWidth("50%");
        setHeight("50%");
        centerInPage();
...
//        vertical.getElement().getStyle().setMarginLeft(100, Unit.PX);
        ...
        button.addClickHandler(new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                ...
                formPanel.setAction(DBDataSource.getServerURL("UP_OnUploadReplacementTaxData"));
                formPanel.submit();
            }
        });
    }
