...
public final class UploadOtherDeductionData extends PopupWindow implements HasHandlers {
    private static final Logger __logger = Logger.getLogger("");
    private Map<String, Object> params = new HashMap<>();

    public UploadOtherDeductionData() {
        super("其他扣除数据导入");
        setWidth("50%");
        setHeight("50%");
        centerInPage();
...
//        vertical.getElement().getStyle().setMarginLeft(100, Unit.PX);
        ...
        button.addClickHandler(new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                ...
                formPanel.setAction(DBDataSource.getServerURL("UP_OnUploadOtherDeductionData"));
                formPanel.submit();
            }
        });
    }
