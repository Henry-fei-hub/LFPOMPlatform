...
public final class UploadSystemInitDateOfBonus extends PopupWindow implements HasHandlers {
    private static final Logger __logger = Logger.getLogger("");
    private Map<String, Object> params = new HashMap<>();

    public UploadSystemInitDateOfBonus(final Map<String, Object> map, final String action) {
        super("系统初始化导入");
        setWidth("50%");
        setHeight("50%");
        centerInPage();
