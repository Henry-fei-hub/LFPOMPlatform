...
public final class UploadCustomerRescources extends PopupWindow implements HasHandlers {
    private static final Logger __logger = Logger.getLogger("");
    private Map<String, Object> params = new HashMap<>();

    public UploadCustomerRescources(final Map<String, Object> map, final String action) {
        super("客户资源导入");
        setWidth("50%");
        setHeight("50%");
        centerInPage();
