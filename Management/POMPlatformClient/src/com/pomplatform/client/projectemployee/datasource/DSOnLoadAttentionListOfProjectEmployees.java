...
public class DSOnLoadAttentionListOfProjectEmployees extends DBDataSource
{


	public static DSOnLoadAttentionListOfProjectEmployees instance = null;

	public static DSOnLoadAttentionListOfProjectEmployees getInstance() {
		if(instance == null) {
			instance = new DSOnLoadAttentionListOfProjectEmployees("DSOnLoadAttentionListOfProjectEmployees");
		}
		return instance;
	}
	...
	public DSOnLoadAttentionListOfProjectEmployees(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("OnLoadAttentionListOfProjectEmployees");
		...
		setFields(systemProcessAttentionIdField, personnelBusinessIdField, businessIdField, businessNameField, processActivityIdField, processIdField, processInstanceIdField, backViewNameField, instanceActivityIdField, instanceActivityCreateTimeField, instanceActivityStartTimeField, statusField, operateTimeField, processCommentField, processTypeField, employeeIdField, projectIdField, projectCodeField, projectNameField, totalAmountField, projectIntegralField, reserveIntegralField);
	}
