...
public class DSProjectEmployeeReport extends DBDataSource
{


	public static DSProjectEmployeeReport instance = null;

	public static DSProjectEmployeeReport getInstance() {
		if(instance == null) {
			instance = new DSProjectEmployeeReport("DSProjectEmployeeReport");
		}
		return instance;
	}
	...
	public DSProjectEmployeeReport(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("ProjectEmployeeReport");
