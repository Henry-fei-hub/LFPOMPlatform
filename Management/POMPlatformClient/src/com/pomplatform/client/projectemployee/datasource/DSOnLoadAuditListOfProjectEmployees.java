...
public class DSOnLoadAuditListOfProjectEmployees extends DBDataSource
{


	public static DSOnLoadAuditListOfProjectEmployees instance = null;

	public static DSOnLoadAuditListOfProjectEmployees getInstance() {
		if(instance == null) {
			instance = new DSOnLoadAuditListOfProjectEmployees("DSOnLoadAuditListOfProjectEmployees");
		}
		return instance;
	}
	...
	public DSOnLoadAuditListOfProjectEmployees(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("OnLoadAuditListOfProjectEmployees");
		...
		setFields(processPooledTaskIdField,typeFlagField,processInstanceActivityIdField, personnelBusinessIdField, businessIdField, businessNameField, processActivityIdField, processIdField, processInstanceIdField, nodeTypeField, activityIdField, nextActivityIdField, mainActivityIdField, instanceActivityCreateTimeField, instanceActivityStartTimeField, operateTimeField, processCommentField, statusField, activityTypeField, backViewNameField, processTypeField, employeeIdField, projectIdField, projectCodeField, projectNameField, totalAmountField, projectIntegralField, reserveIntegralField);
	}
