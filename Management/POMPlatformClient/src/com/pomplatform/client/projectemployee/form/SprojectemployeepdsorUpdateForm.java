...
public class SprojectemployeepdsorUpdateForm extends AbstractWizadPage
{


	private final TextItem projectEmployeeIdItem;
	...
	public SprojectemployeepdsorUpdateForm() {
		__form = new DynamicForm();
		DSSprojectemployeepdsor ds = DSSprojectemployeepdsor.getInstance();
		__form.setWidth100();
		__form.setHeight100();
		projectEmployeeIdItem = new TextItem("projectEmployeeId", "项目组建编码");
		projectEmployeeIdItem.setWidth("*");
		projectEmployeeIdItem.setDisabled(true);
		projectEmployeeIdItem.setRequired(true);
		IsIntegerValidator projectEmployeeIdValidator = new IsIntegerValidator();
		projectEmployeeIdItem.setValidators(projectEmployeeIdValidator);
		...
		__form.setItems(projectEmployeeIdItem, projectIdItem, employeeIdItem, workContentItem, planIntegralItem, realIntegralItem, costItem, settlementItem, planStartDateItem, planEndDateItem, startDateItem, endDateItem, statusItem);
	...
	public Map<String, FormItem> getItems() {
		...
		res.put("projectEmployeeId", projectEmployeeIdItem);
