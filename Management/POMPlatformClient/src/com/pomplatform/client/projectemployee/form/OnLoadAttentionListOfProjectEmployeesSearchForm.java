...
import com.pomplatform.client.projectemployee.datasource.CDOnLoadAttentionListOfProjectEmployees;

public class OnLoadAttentionListOfProjectEmployeesSearchForm extends SearchForm
{
	...
	public OnLoadAttentionListOfProjectEmployeesSearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDOnLoadAttentionListOfProjectEmployees.getInstance());
