...
import com.pomplatform.client.projectemployee.form.NewSprojectemployeepdsorForm;
import com.pomplatform.client.projectemployee.form.UpdateSprojectemployeepdsorForm;
...
public class SprojectemployeepdsorPanel extends AbstractSearchPanel {
    ...
    public static class Factory implements PanelFactory {
        ...
        public Canvas create() {
            SprojectemployeepdsorPanel cm = new SprojectemployeepdsorPanel();
            id = cm.getID();
            return cm;
        }
    ...
    public void initComponents() {
        ...
        IButton operation2Button = new IButton("邀请");
            ...
            public void onClick(ClickEvent event) {
                GWT.runAsync(new RunAsyncCallback() {
                    ...
                    public void onSuccess() {
                        NewSprojectemployeepdsorForm detailForm = new NewSprojectemployeepdsorForm();
                        detailForm.setTitle("邀请");
            ...
            public void onClick(ClickEvent event) {
                GWT.runAsync(new RunAsyncCallback() {
                    ...
                    public void onSuccess() {
                        ...
                        UpdateSprojectemployeepdsorForm detailForm = new UpdateSprojectemployeepdsorForm();
                        ...
                        detailForm.addDataEditedHandler(new DataEditedHandler() {
                            ...
                            public void onDataEdited(DataEditEvent event) {
                                ...
                                params.put("projectEmployeeId", event.getData().getAttribute("projectEmployeeId"));
        ...
        IButton operation4Button = new IButton("删除");
        controlLayout.addMember(operation4Button);
        operation4Button.setIcon("[SKIN]/actions/edit.png");
