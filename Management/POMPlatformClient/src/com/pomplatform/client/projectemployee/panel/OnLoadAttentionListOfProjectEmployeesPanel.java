...
import com.pomplatform.client.projectemployee.datasource.DSOnLoadAttentionListOfProjectEmployees;
import com.pomplatform.client.projectemployee.form.OnLoadAttentionListOfProjectEmployeesSearchForm;
import com.pomplatform.client.projectemployee.form.OnLoadAttentionListOfProjectEmployeesViewer;
...
public class OnLoadAttentionListOfProjectEmployeesPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			OnLoadAttentionListOfProjectEmployeesPanel cm = new OnLoadAttentionListOfProjectEmployeesPanel();
			id = cm.getID();
			return cm;
		}
		...
		public String getDescription() {
			return "OnLoadAttentionListOfProjectEmployees";
		}
...
//		commonQuery();
	...
	public SearchForm generateSearchForm() {
		return new OnLoadAttentionListOfProjectEmployeesSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSOnLoadAttentionListOfProjectEmployees.getInstance();
	}
