...
import com.pomplatform.client.projectemployee.datasource.DSOnLoadAuditListOfProjectEmployees;
import com.pomplatform.client.projectemployee.form.OnLoadAuditListOfProjectEmployeesSearchForm;
import com.pomplatform.client.projectemployee.form.OnLoadAuditListOfProjectEmployeesViewer;
...
public class OnLoadAuditListOfProjectEmployeesPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			OnLoadAuditListOfProjectEmployeesPanel cm = new OnLoadAuditListOfProjectEmployeesPanel();
			id = cm.getID();
			return cm;
		}
		...
		public String getDescription() {
			return "OnLoadAuditListOfProjectEmployees";
		}
...
//		commonQuery();
	...
	public SearchForm generateSearchForm() {
		return new OnLoadAuditListOfProjectEmployeesSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSOnLoadAuditListOfProjectEmployees.getInstance();
	}
