...
public class CostAllocationViewer extends AbstractDetailViewer
{




	public CostAllocationViewer() {
	}
	...
	public void load() {
		...
		params.put("costAllocationId", getBusinessId());
		DBDataSource.callOperation("ST_CostAllocation", "find", new DSCallback() {
			@Override
	...
	public DataSource getMainDataSource() {
		return DSCostAllocation.getInstance();
	}
