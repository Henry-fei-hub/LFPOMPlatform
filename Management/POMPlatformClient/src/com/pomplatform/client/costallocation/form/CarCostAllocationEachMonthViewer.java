...
public class CarCostAllocationEachMonthViewer extends AbstractDetailViewer
{
	...
	public CarCostAllocationEachMonthViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_CarCostAllocationEachMonth", "find", new DSCallback() {
			@Override
