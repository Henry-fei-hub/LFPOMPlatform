...
import com.pomplatform.client.costallocation.form.CostAllocationApplySearchForm;
import com.pomplatform.client.costallocation.form.CostAllocationApplyViewer;
import com.pomplatform.client.costallocation.form.NewCostAllocationApplyForm;
import com.pomplatform.client.costallocation.form.UpdateCostAllocationApplyForm;
...
public class CostAllocationApplyPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			CostAllocationApplyPanel cm = new CostAllocationApplyPanel();
			id = cm.getID();
			return cm;
		}
	...
	public void initComponents() {
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						NewCostAllocationApplyForm detailForm = new NewCostAllocationApplyForm();
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateCostAllocationApplyForm detailForm = new UpdateCostAllocationApplyForm();
		...
		removeButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				DBDataSource.callOperation("ST_CostAllocationApply", "delete", selected.toMap(), new DSCallback() {
					@Override
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("成本调节"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				CostAllocationApplyViewer detailForm = new CostAllocationApplyViewer();
	...
	public boolean checkSearchCriteria(Map criteria) {
		criteria.put("addtionalCondition", "order by reset_cost_id");
		return true;
	}
	...
	public SearchForm generateSearchForm() {
		return new CostAllocationApplySearchForm();
	}
