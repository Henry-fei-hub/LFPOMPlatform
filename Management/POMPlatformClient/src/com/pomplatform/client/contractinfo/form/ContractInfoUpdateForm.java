...
public class ContractInfoUpdateForm extends AbstractWizadPage {
...
//        projectCodeItem.setValueMap(KeyValueManager.getValueMap("main_projects"));
        ...
        IsStringValidator projectCodeValidator = new IsStringValidator();
        LengthRangeValidator projectCodeLengthValidator = new LengthRangeValidator();
        projectCodeLengthValidator.setMax(64);
        projectCodeItem.setValidators(projectCodeValidator, projectCodeLengthValidator);
        ...
        projectTypeItem = new SelectItem("flowStatus", "审核状态");
        projectTypeItem.setWidth("*");
        projectTypeItem.setValueMap((LinkedHashMap) ds.getField("flowStatus").getValueMap());
