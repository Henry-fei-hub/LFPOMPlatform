...
public class ContractInfoGroupname1NewWithProjectCode extends AbstractWizadPage {
    ...
    public ContractInfoGroupname1NewWithProjectCode(String projectCode) {
...
//        projectCodeItem.setValueMap(KeyValueManager.getValueMap("main_projects"));
        ...
        projectCodeItem.setDefaultValue(projectCode);
