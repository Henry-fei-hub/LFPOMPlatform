 ...
 * @author CL
 */
public class CustomAddSubContractMainTwoStartPanel extends AbstractWizadPage implements HasHandlers {
    ...
    public CustomAddSubContractMainTwoStartPanel(int contractId, Record record, int flowStatus, Map<String, String> map) {
        SC.debugger();
        setHeight100();
        setMembersMargin(5);
...
//        params.put("opt_type", "saveContentInfo");
        ...
        params.put("contentInfo", getReplaceAll(__infoForm.getItem("subContractRemark").getValue() + ""));
