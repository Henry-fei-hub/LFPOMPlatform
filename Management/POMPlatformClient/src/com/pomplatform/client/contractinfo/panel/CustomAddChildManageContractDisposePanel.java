...
import static com.pomplatform.client.contractinfo.panel.CustomAddSubContractMainTwoDisposePanel.childContract;

public class CustomAddChildManageContractDisposePanel extends AbstractWizadPage {

    private static final Logger logger = Logger.getLogger("");
    public static DelicacyListGrid SourceGrid;
    private ComboBoxItem projectManageItem;

    public CustomAddChildManageContractDisposePanel(int flowStatus, Map<String, String> map) {
