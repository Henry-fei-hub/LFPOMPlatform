...
public class CustomContractExpansionThreePanel extends AbstractExpansionRelatedPage {
    ...
    public static class Factory implements PanelFactory {
        ...
        public Canvas create() {
            CustomContractExpansionThreePanel cm = new CustomContractExpansionThreePanel();
            id = cm.getID();
            return cm;
        }
...
//        resultChildGrid.setCanEdit(false);
        ...
        IButton newChildButton = PermissionControl.createPermissionButton("添加子订单", ERPPermissionStatic.CONTRACT_INFO_MANAGEMENT);
        //只有主合同最开始才有添加子合同选项
        if(flowStatus == 0){
