...
public class CustomContractExpansionTwoPanel extends AbstractExpansionRelatedPage {
	private static final Logger __logger = Logger.getLogger("");
	
	private static int flowStatus = 2;
    ...
    public static class Factory implements PanelFactory {
        ...
        public Canvas create() {
            CustomContractExpansionTwoPanel cm = new CustomContractExpansionTwoPanel();
            id = cm.getID();
            return cm;
        }
