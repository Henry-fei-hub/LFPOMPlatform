...
import static com.pomplatform.client.contractinfo.panel.CustomAddSubContractMainTwoStartPanel.childManageContract;

public class CustomAddChildContractStartPanel extends AbstractWizadPage {
    ...
    public CustomAddChildContractStartPanel(int flowStatus, CustomAddConsiderationPanel consideration) {
...
//		SourceGrid.setSelectionAppearance(SelectionAppearance.CHECKBOX);
        ...
        SourceGrid.addEditCompleteHandler(new EditCompleteHandler() {
            ...
            public void onEditComplete(EditCompleteEvent event) {
                ...
                SC.debugger();
                if(BaseHelpUtils.isNullOrEmpty(event.getNewValues().get("departmentId"))){
                    return;
                }
