...
public class CustomContractExpansionOnePanel extends AbstractExpansionRelatedPage {
	private static final Logger __logger = Logger.getLogger("");
	
	private static int flowStatus = 1;
    ...
    public static class Factory implements PanelFactory {
        ...
        public Canvas create() {
            CustomContractExpansionOnePanel cm = new CustomContractExpansionOnePanel();
            id = cm.getID();
            return cm;
        }
