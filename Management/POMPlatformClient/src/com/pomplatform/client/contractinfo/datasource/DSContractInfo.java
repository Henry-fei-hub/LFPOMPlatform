...
public class DSContractInfo extends DBDataSource {

    public static DSContractInfo instance = null;

    public static DSContractInfo getInstance() {
        if (instance == null) {
            instance = new DSContractInfo("DSContractInfo");
        }
        return instance;
    }
    ...
    public DSContractInfo(String dataSourceID) {

        super();
        setID(dataSourceID);
        setActionMode(ACTION_MODE_QUERY);
        setActionName("ContractInfo");
        ...
        contractIdField.setForeignKey("DSContractInfo.contractId");
