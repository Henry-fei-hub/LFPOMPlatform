...
public class DSOnLoadAuditListOfBidPaySheetProject extends DBDataSource
{


	public static DSOnLoadAuditListOfBidPaySheetProject instance = null;

	public static DSOnLoadAuditListOfBidPaySheetProject getInstance() {
		if(instance == null) {
			instance = new DSOnLoadAuditListOfBidPaySheetProject("DSOnLoadAuditListOfBidPaySheetProject");
		}
		return instance;
	}
	...
	public DSOnLoadAuditListOfBidPaySheetProject(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("OnLoadAuditListOfBidPaySheetProject");
		...
		processInstanceIdField.setPrimaryKey(false);
		...
		setFields(processInstanceIdField, personnelBusinessIdField, processInstanceActivityIdField, businessIdField, businessNameField, processActivityIdField, processIdField, nodeTypeField, activityIdField, nextActivityIdField, mainActivityIdField, instanceActivityCreateTimeField, instanceActivityStartTimeField, operateTimeField, processCommentField, statusField, activityTypeField, backViewNameField, employeeIdField, employeeNoField,planField ,projectIdField,linkIdField,dutyIdField,projectCodeField,projectNameField,livingExpensesField,startDateField, startDateDetailField ,endDateDetailField,addressField,housingFinanceField,provideAccommodationField, severanceField, reasonField ,remarkField,    attachmentIdField, attachmentNameField);
	}
