...
public class NewBidPaySheetProjectWorkflow extends AbstractProcessPanel
{
	...
	public List<AbstractWizadPage> getPages(){
		...
		Record data = getData();
		BidPaySheetProjectNewForm bidPaySheetProjectNewForm = new BidPaySheetProjectNewForm(data);
		res.add(bidPaySheetProjectNewForm);
		return res;
	}
