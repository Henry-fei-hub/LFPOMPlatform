...
public class OnLoadApplyListOfBidPaySheetProjectViewer extends AbstractDetailViewer
{
	...
	public OnLoadApplyListOfBidPaySheetProjectViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadApplyListOfBidPaySheetProject", "find", new DSCallback() {
			@Override
