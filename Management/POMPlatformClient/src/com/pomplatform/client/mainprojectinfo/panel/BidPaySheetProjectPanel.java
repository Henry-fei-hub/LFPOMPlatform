...
import com.pomplatform.client.mainprojectinfo.form.BidPaySheetProjectSearchForm;
import com.pomplatform.client.mainprojectinfo.form.BidPaySheetProjectViewer;
import com.pomplatform.client.mainprojectinfo.form.NewBidPaySheetProjectForm;
import com.pomplatform.client.mainprojectinfo.form.UpdateBidPaySheetProjectForm;
...
public class BidPaySheetProjectPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			BidPaySheetProjectPanel cm = new BidPaySheetProjectPanel();
			id = cm.getID();
			return cm;
		}
	...
	public void initComponents() {
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						NewBidPaySheetProjectForm detailForm = new NewBidPaySheetProjectForm();
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateBidPaySheetProjectForm detailForm = new UpdateBidPaySheetProjectForm();
		...
		removeButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				DBDataSource.callOperation("ST_BidPaySheetProject", "delete", selected.toMap(), new DSCallback() {
					@Override
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("BidPaySheetProject"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				BidPaySheetProjectViewer detailForm = new BidPaySheetProjectViewer();
	...
	public SearchForm generateSearchForm() {
		return new BidPaySheetProjectSearchForm();
	}
