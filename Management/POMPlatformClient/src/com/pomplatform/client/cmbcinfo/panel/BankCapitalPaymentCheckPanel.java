 ...
 * @author cl
 */
public class BankCapitalPaymentCheckPanel extends DelicacyPanel {
	...
	McmbctransinfopaymentcheckPanel traninfoPanel;
	
	McapitalstoorPaymentCheckPanel capitalPanel;

	@Override
	public Canvas getViewPanel() {
		//构建
		traninfoPanel = new McmbctransinfopaymentcheckPanel();
		capitalPanel = new McapitalstoorPaymentCheckPanel();
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			BankCapitalPaymentCheckPanel cm = new BankCapitalPaymentCheckPanel();
			id = cm.getID();
			return cm;
		}
