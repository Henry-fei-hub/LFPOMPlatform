...
public class McapitalbccoccmsssoooblpommmmlorPanel extends AbstractSearchPanel {
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			McapitalbccoccmsssoooblpommmmlorPanel cm = new McapitalbccoccmsssoooblpommmmlorPanel();
			id = cm.getID();
			return cm;
		}
	...
	public SearchForm generateSearchForm() {
		return new McapitalbccoccmsssoooblpommmmlorSearchForm();
	}
