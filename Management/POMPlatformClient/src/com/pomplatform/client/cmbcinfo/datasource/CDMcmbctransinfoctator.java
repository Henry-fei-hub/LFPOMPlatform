...
public class CDMcmbctransinfoctator extends DataSource
{


	public static CDMcmbctransinfoctator instance = null;

	public static CDMcmbctransinfoctator getInstance() {
		if(instance == null) {
			instance = new CDMcmbctransinfoctator("CDMcmbctransinfoctator");
		}
		return instance;
	}
	...
	public CDMcmbctransinfoctator(String dataSourceID) {
		...
		setFields(bankAccountField, companyRecordIdField, naryurField, refnbrField, reqnbrField, busnamField, nusageField, yurrefField, rpynamField, rpyaccField, rpybnkField, rpyadrField, minTransDateField, maxTransDateField, minVltdatField, maxVltdatField, minCreateTimeField, maxCreateTimeField, minUpdateTimeField, maxUpdateTimeField, cmbcTransInfoIdField, trscodField, amtcdrField, trsanlField, currentPageField, pageLinesField);
