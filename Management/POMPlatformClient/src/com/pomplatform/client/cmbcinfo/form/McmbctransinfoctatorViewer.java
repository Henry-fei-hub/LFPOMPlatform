...
public class McmbctransinfoctatorViewer extends AbstractDetailViewer
{
	...
	public McmbctransinfoctatorViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Mcmbctransinfoctator", "find", new DSCallback() {
			@Override
