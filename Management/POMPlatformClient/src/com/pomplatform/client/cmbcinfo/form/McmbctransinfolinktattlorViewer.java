...
public class McmbctransinfolinktattlorViewer extends AbstractDetailViewer
{
	...
	public McmbctransinfolinktattlorViewer() {
	}
	...
	public void load() {
		...
		params.put("cmbcTransInfoId", getBusinessId());
		DBDataSource.callOperation("NQ_Mcmbctransinfolinktattlor", "find", new DSCallback() {
			@Override
