...
public class McapitalbccoccmsssoooblpommmmlorViewer extends AbstractDetailViewer {

	private SearchForm __parentSearchForm;

	public McapitalbccoccmsssoooblpommmmlorViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Mcapitalbccoccmsssoooblpommmmlor", "find", new DSCallback() {
			@Override
