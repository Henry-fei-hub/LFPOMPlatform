...
public class CDknowApprovalBudgetManagementApplyWork extends DataSource
{


	public static CDknowApprovalBudgetManagementApplyWork instance = null;

	public static CDknowApprovalBudgetManagementApplyWork getInstance() {
		if(instance == null) {
			instance = new CDknowApprovalBudgetManagementApplyWork("CDknowApprovalBudgetManagementApplyWork");
		}
		return instance;
	}
	...
	public CDknowApprovalBudgetManagementApplyWork(String dataSourceID) {
