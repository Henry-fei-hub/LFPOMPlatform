...
public class NewContractPanel extends AbstractWizadPage {
	...
	public NewContractPanel() {
		...
		projectApprovalTimeItem.setDisabled(false);
...
//		businessTypeItem.setValueMap(KeyValueManager.getValueMap("production_value_coefficient_type"));
		businessTypeItem.setDisabled(false);
...
//		projectTypeItem.setValueMap(KeyValueManager.getValueMap("system_dictionary_32"));
		...
		contractFollowerItem.setTextMatchStyle(TextMatchStyle.SUBSTRING);
	...
	public java.util.Map getValuesAsMap() {
		...
		values.put("operator", ClientUtil.getEmployeeId());
		return values;
	}
