...
public class MequipmentrecordedeorViewer extends AbstractDetailViewer
{
	...
	public MequipmentrecordedeorViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Mequipmentrecordedeor", "find", new DSCallback() {
			@Override
	...
	public DataSource getMainDataSource() {
		return DSMequipmentrecordedeor.getInstance();
	}
