...
public class AboutTrainingManagementViewer extends AbstractDetailViewer
{
	...
	public AboutTrainingManagementViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_AboutTrainingManagement", "find", new DSCallback() {
			@Override
