...
public class bonusSummaryDetailViewer extends AbstractDetailViewer
{
	...
	public bonusSummaryDetailViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_bonusSummaryDetail", "find", new DSCallback() {
			@Override
