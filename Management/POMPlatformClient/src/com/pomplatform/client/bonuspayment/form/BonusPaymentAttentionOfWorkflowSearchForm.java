...
import com.pomplatform.client.bonuspayment.datasource.CDBonusPaymentAttentionOfWorkflow;

public class BonusPaymentAttentionOfWorkflowSearchForm extends SearchForm
{
	...
	public BonusPaymentAttentionOfWorkflowSearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDBonusPaymentAttentionOfWorkflow.getInstance());
