...
public class BonusPaymentAuditOfWorkflowViewer extends AbstractDetailViewer
{
	...
	public BonusPaymentAuditOfWorkflowViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_BonusPaymentAuditOfWorkflow", "find", new DSCallback() {
			@Override
