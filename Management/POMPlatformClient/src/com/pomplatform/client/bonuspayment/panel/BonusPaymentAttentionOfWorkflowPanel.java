...
import com.pomplatform.client.bonuspayment.datasource.DSBonusPaymentAttentionOfWorkflow;
import com.pomplatform.client.bonuspayment.form.BonusPaymentAttentionOfWorkflowSearchForm;
import com.pomplatform.client.bonuspayment.form.BonusPaymentAttentionOfWorkflowViewer;
...
public class BonusPaymentAttentionOfWorkflowPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			BonusPaymentAttentionOfWorkflowPanel cm = new BonusPaymentAttentionOfWorkflowPanel();
			id = cm.getID();
			return cm;
		}
		...
		public String getDescription() {
			return "BonusPaymentAttentionOfWorkflow";
		}
	...
	public SearchForm generateSearchForm() {
		return new BonusPaymentAttentionOfWorkflowSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSBonusPaymentAttentionOfWorkflow.getInstance();
	}
