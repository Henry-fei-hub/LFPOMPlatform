...
import com.pomplatform.client.bonuspayment.datasource.DSbonusSummary;
import com.pomplatform.client.bonuspayment.form.bonusSummarySearchForm;
import com.pomplatform.client.bonuspayment.form.bonusSummaryViewer;
import com.pomplatform.client.report.panel.ReportOfSalaryTotalByDepartmentPanel;
...
public class bonusSummaryPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			bonusSummaryPanel cm = new bonusSummaryPanel();
			id = cm.getID();
			return cm;
		}
	...
	public void initComponents() {
		...
		outputButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				DBDataSource.downloadFile("DW_bonusSummary", condition);
			}
		});
		...
		outputButton2.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				DBDataSource.downloadFile("DW_bonusSummaryDetail", condition);
			}
		});
		...
		resultGrid.addDoubleClickHandler(new DoubleClickHandler() {
			...
			public void onDoubleClick(DoubleClickEvent event) {
				...
				bonusSummaryDetailPanel panel = new bonusSummaryDetailPanel();
				pw.addItem(panel);
...
//				panel.initComponents();
	...
	public SearchForm generateSearchForm() {
		return new bonusSummarySearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSbonusSummary.getInstance();
	}
