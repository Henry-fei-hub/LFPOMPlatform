...
public abstract class GenericContractWizadWindow extends GenericWizadWindow {
    ...
    public GenericContractWizadWindow() {
    }
...
//								SC.say(__originalName+"成功");
        ...
        submitButton.setIcon("[SKIN]/actions/save.png");
        navLayout.addButton(submitButton);
        navLayout.addSpacer(10);
...
//								SC.say(__originalName+"成功");
    ...
    protected ToolStripButton submitButton;
