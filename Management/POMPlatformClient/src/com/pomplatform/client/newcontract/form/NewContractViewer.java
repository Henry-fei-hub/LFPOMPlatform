...
public class NewContractViewer extends AbstractDetailViewer
{
	...
	public List<GroupColumn> getGroupColumnNames() {
		...
		gc.getColumnNames().add("serialNumber");
		gc.getColumnNames().add("projectType");
		gc.getColumnNames().add("coveredArea");
		gc.getColumnNames().add("professionalCooperation");
		...
		gc.getColumnNames().add("serviceSuggestBook");
