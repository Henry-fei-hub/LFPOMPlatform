...
public class ApplyProjectQuoteTemplateViewer extends AbstractDetailViewer
{
	...
	public ApplyProjectQuoteTemplateViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ApplyProjectQuoteTemplate", "find", new DSCallback() {
			@Override
