package com.pomplatform.client.applyprojectquotetemplate.datasource;
...
public class DSApplyProjectQuoteTemplate extends DBDataSource
{


	public static DSApplyProjectQuoteTemplate instance = null;

	public static DSApplyProjectQuoteTemplate getInstance() {
		if(instance == null) {
			instance = new DSApplyProjectQuoteTemplate("DSApplyProjectQuoteTemplate");
		}
		return instance;
	}
	...
	public DSApplyProjectQuoteTemplate(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("ApplyProjectQuoteTemplate");
		...
		otherTaxAmountField = new DataSourceFloatField("otherTaxAmount", "其它税金(%)");
		...
		setFields(processInstanceIdField, projectQuoteIdField, processTypeField, businessIdField, businessNameField, processIdField, processInstanceActivityIdField, processStatusField, createTimeField, completeTimeField, employeeIdField, projectNameField, provinceField, cityField, projectTypeField, customerNameField, projectOriginationField, contactNameField, contactPhoneField, detailAddressField, totalBuildingAreasField, clientIdField, infoCodeField, customerContactIdField, projectIdField, quoteStatusField, basicAmountField, totalAmountField, upAmountField, upPercentField, preferentialAmountField, perferentialPercentField, taxAmountField, otherTaxAmountField, finalAmountField, finalPercentField, taxFinalAmountField, operateEmployeeIdField, operateTimeField, remarkField, companyIdField,businessTypeField);
	}
