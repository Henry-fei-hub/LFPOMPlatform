...
public class CDApplyProjectQuoteTemplate extends DataSource
{


	public static CDApplyProjectQuoteTemplate instance = null;

	public static CDApplyProjectQuoteTemplate getInstance() {
		if(instance == null) {
			instance = new CDApplyProjectQuoteTemplate("CDApplyProjectQuoteTemplate");
		}
		return instance;
	}
	...
	public CDApplyProjectQuoteTemplate(String dataSourceID) {
		...
		setFields(processTypeField, projectNameField, createTimeStartField, createTimeEndField, employeeIdField, operateEmployeeIdField,  businessTypeField, currentPageField, pageLinesField);
