...
import com.pomplatform.client.platecostrecord.datasource.CDPlateCostMonthlyDetail;

public class PlateCostMonthlyDetailSearchForm extends SearchForm
{
	...
	public PlateCostMonthlyDetailSearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDPlateCostMonthlyDetail.getInstance());
