...
public class PlateCostMonthlyDetailViewer extends AbstractDetailViewer
{
	...
	public PlateCostMonthlyDetailViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_PlateCostMonthlyDetail", "find", new DSCallback() {
			@Override
