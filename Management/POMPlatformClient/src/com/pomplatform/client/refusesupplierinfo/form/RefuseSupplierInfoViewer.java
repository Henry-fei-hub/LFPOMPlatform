...
public class RefuseSupplierInfoViewer extends AbstractDetailViewer
{
	...
	public RefuseSupplierInfoViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_RefuseSupplierInfo", "find", new DSCallback() {
			@Override
