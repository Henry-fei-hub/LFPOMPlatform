...
public class TransDetailUpdateForm extends AbstractWizadPage
{


	private final TextItem financialTransactionDetailIdItem;
	...
	public TransDetailUpdateForm() {
		DSFinancialTransactionDetail ds = DSFinancialTransactionDetail.getInstance();
		__form.setWidth100();
		__form.setHeight100();
		
		financialTransactionDetailIdItem = new TextItem("financialTransactionDetailId", "主键编码");
		financialTransactionDetailIdItem.setDisabled(true);
		financialTransactionDetailIdItem.setRequired(true);
		financialTransactionDetailIdItem.hide();
		IsIntegerValidator financialTransactionDetailIdValidator = new IsIntegerValidator();
		financialTransactionDetailIdItem.setValidators(financialTransactionDetailIdValidator);
		__formItems.add(financialTransactionDetailIdItem);
	...
	public void startEdit() {
		...
		if(record != null) {
			DBDataSource.callOperation("ST_FinancialTransactionDetail", "find", record.toMap(), new DSCallback() {
