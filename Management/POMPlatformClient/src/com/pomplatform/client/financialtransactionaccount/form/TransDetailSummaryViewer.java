...
public class TransDetailSummaryViewer extends AbstractDetailViewer
{
	...
	public TransDetailSummaryViewer() {
	}
	...
	public void load() {
		...
		params.put("financialTransactionAccountId", getBusinessId());
		DBDataSource.callOperation("NQ_TransDetailSummary", "find", new DSCallback() {
			@Override
