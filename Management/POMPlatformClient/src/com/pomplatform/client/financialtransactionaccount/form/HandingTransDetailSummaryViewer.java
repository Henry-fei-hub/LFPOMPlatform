...
public class HandingTransDetailSummaryViewer extends AbstractDetailViewer
{
	...
	public HandingTransDetailSummaryViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_HandingTransDetailSummary", "find", new DSCallback() {
			@Override
