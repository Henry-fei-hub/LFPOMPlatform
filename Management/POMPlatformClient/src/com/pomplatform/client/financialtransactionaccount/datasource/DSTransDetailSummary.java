...
public class DSTransDetailSummary extends DBDataSource
{


	public static DSTransDetailSummary instance = null;

	public static DSTransDetailSummary getInstance() {
		if(instance == null) {
			instance = new DSTransDetailSummary("DSTransDetailSummary");
		}
		return instance;
	}
	...
	private final DataSourceFloatField endingStandardDebitField;
	private final DataSourceFloatField endingStandardCreditField;

	public DSTransDetailSummary(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("TransDetailSummary");
		...
		endingStandardDebitField = new DataSourceFloatField("endingStandardDebit", "期末借");
		endingStandardDebitField.setLength(18);
		endingStandardDebitField.setDecimalPad(2);
		endingStandardDebitField.setFormat("#,###,###,###,###,##0.00");
		endingStandardDebitField.setRequired(true);
		endingStandardDebitField.setHidden(false);


		endingStandardCreditField = new DataSourceFloatField("endingStandardCredit", "期末贷");
		endingStandardCreditField.setLength(18);
		endingStandardCreditField.setDecimalPad(2);
		endingStandardCreditField.setFormat("#,###,###,###,###,##0.00");
		endingStandardCreditField.setRequired(true);
		endingStandardCreditField.setHidden(false);


		setFields(financialTransactionAccountIdField, companyIdField, accountTypeField, financeNoField, accountNameField, reimbursableField, accountStatusField, initStandardDebitField, initStandardCreditField, standardDebitField, standardCreditField, endingStandardDebitField, endingStandardCreditField);
	}
