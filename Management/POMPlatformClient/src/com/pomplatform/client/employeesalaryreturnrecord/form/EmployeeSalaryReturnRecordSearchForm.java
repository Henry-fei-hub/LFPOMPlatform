package com.pomplatform.client.employeesalaryreturnrecord.form;

import java.util.Date;

import com.delicacy.client.data.ClientUtil;
import com.delicacy.client.data.KeyValueManager;
import com.pomplatform.client.employeesalaryreturnrecord.datasource.CDEmployeeSalaryReturnRecord;
...
public class EmployeeSalaryReturnRecordSearchForm extends SearchForm {
	...
	public EmployeeSalaryReturnRecordSearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDEmployeeSalaryReturnRecord.getInstance());
