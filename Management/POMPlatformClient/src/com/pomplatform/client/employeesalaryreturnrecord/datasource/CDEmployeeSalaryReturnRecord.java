...
public class CDEmployeeSalaryReturnRecord extends DataSource
{


	public static CDEmployeeSalaryReturnRecord instance = null;

	public static CDEmployeeSalaryReturnRecord getInstance() {
		if(instance == null) {
			instance = new CDEmployeeSalaryReturnRecord("CDEmployeeSalaryReturnRecord");
		}
		return instance;
	}
	...
	public CDEmployeeSalaryReturnRecord(String dataSourceID) {
