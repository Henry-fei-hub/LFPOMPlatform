...
public class AddNewPreProjectNumberPanel extends AbstractWizadPage {
	...
	public AddNewPreProjectNumberPanel() {
		...
		deptItem= new SelectItem("plateId", "业务部门");
		deptItem.setWidth("*");
		...
		__infoForm.setFields(mainProjectIdItem,projectManagerItem,businessTypeItem,projectTypeItem,
				deptItem,remarkItem);
		...
		saveBtn.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				params.put("opt_type", "addPreProject");
