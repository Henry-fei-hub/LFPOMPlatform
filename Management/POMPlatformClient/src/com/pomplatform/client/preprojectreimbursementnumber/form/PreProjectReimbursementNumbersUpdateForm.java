...
public class PreProjectReimbursementNumbersUpdateForm extends AbstractWizadPage
{
	...
	public PreProjectReimbursementNumbersUpdateForm() {
		...
		businessTypeItem = new SelectItem("businessTypes", "业务类别");
