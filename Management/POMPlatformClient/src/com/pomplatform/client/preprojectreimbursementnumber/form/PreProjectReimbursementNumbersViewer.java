...
public class PreProjectReimbursementNumbersViewer extends AbstractDetailViewer
{
	...
	public PreProjectReimbursementNumbersViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_PreProjectReimbursementNumbers", "find", new DSCallback() {
			@Override
