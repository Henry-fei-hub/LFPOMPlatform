...
public class AttachmentManageMeetingTorViewer extends AbstractDetailViewer
{
	...
	public AttachmentManageMeetingTorViewer() {
	}
	...
	public void load() {
		...
		params.put("attachmentManageMeetingId", getBusinessId());
		DBDataSource.callOperation("NQ_AttachmentManageMeetingTor", "find", new DSCallback() {
			@Override
