package com.pomplatform.client.splateintegralsumrecordpysor.form;
...
import com.pomplatform.client.splateintegralsumrecordpysor.datasource.CDSplateintegralsumrecordpysor;

public class SplateintegralsumrecordpysorSearchForm extends SearchForm
{
	...
	public SplateintegralsumrecordpysorSearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDSplateintegralsumrecordpysor.getInstance());
