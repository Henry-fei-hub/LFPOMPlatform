package com.pomplatform.client.knowattachmentapproval.form;
...
import com.pomplatform.client.knowattachmentapproval.datasource.CDKnowAttachmentApproval;

public class KnowAttachmentApprovalSearchForm extends SearchForm
{
	...
	public KnowAttachmentApprovalSearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDKnowAttachmentApproval.getInstance());
