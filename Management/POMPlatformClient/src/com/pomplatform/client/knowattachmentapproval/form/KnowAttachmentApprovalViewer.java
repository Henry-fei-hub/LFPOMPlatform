...
public class KnowAttachmentApprovalViewer extends AbstractDetailViewer
{
	...
	public KnowAttachmentApprovalViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_KnowAttachmentApproval", "find", new DSCallback() {
			@Override
