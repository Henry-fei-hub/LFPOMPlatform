...
public class CDKnowAttachmentApproval extends DataSource
{


	public static CDKnowAttachmentApproval instance = null;

	public static CDKnowAttachmentApproval getInstance() {
		if(instance == null) {
			instance = new CDKnowAttachmentApproval("CDKnowAttachmentApproval");
		}
		return instance;
	}
	...
	public CDKnowAttachmentApproval(String dataSourceID) {
