...
public class AttachmentApprovalAlreadyViewer extends AbstractDetailViewer
{
	...
	public AttachmentApprovalAlreadyViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_AttachmentApprovalAlready", "find", new DSCallback() {
			@Override
