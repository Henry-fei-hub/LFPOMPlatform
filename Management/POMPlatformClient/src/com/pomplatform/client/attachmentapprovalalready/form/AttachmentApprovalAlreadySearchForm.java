package com.pomplatform.client.attachmentapprovalalready.form;
...
import com.pomplatform.client.attachmentapprovalalready.datasource.CDAttachmentApprovalAlready;

public class AttachmentApprovalAlreadySearchForm extends SearchForm
{
	...
	public AttachmentApprovalAlreadySearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDAttachmentApprovalAlready.getInstance());
