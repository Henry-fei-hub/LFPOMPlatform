...
public class DSAttachmentApprovalAlready extends DBDataSource
{


	public static DSAttachmentApprovalAlready instance = null;

	public static DSAttachmentApprovalAlready getInstance() {
		if(instance == null) {
			instance = new DSAttachmentApprovalAlready("DSAttachmentApprovalAlready");
		}
		return instance;
	}
	...
	public DSAttachmentApprovalAlready(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("AttachmentApprovalAlready");
