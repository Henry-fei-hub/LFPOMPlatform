package com.pomplatform.client.attachmentapprovalalready.datasource;

import com.smartgwt.client.data.DataSource;
import com.smartgwt.client.data.fields.*;
import com.delicacy.client.data.KeyValueManager;

public class CDAttachmentApprovalAlready extends DataSource
{


	public static CDAttachmentApprovalAlready instance = null;

	public static CDAttachmentApprovalAlready getInstance() {
		if(instance == null) {
			instance = new CDAttachmentApprovalAlready("CDAttachmentApprovalAlready");
		}
		return instance;
	}
	...
	public CDAttachmentApprovalAlready(String dataSourceID) {
		...
		setFields(processTypeField, statusField, employeeIdField, budgetManagementIdField, attachmentNameField, uploadEmployeeIdField, uploadTimeField, uploadRemarkField, projectIdField, bddTypeField, isApprovalField, departmentIdField, currentPageField, pageLinesField);
