package com.pomplatform.client.cardmanagecdcor.panel;
...
import com.pomplatform.client.cardmanagecdcor.form.ScardmanagecdcorSearchForm;
import com.pomplatform.client.cardmanagecdcor.form.ScardmanagecdcorViewer;
import com.pomplatform.client.cardmanagecdcor.form.UpdateScardmanagecdcorForm;
...
public class ScardmanagecdcorPanel extends AbstractSearchPanel {
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			ScardmanagecdcorPanel cm = new ScardmanagecdcorPanel();
			id = cm.getID();
			return cm;
		}
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateScardmanagecdcorForm detailForm = new UpdateScardmanagecdcorForm();
...
//		controlLayout.addMember(removeButton);
		...
		removeButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				DBDataSource.callOperation("ST_Scardmanagecdcor", "delete", selected.toMap(), new DSCallback() {
					@Override
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setWidth100();
				detail.setHeight100();
				ScardmanagecdcorViewer detailForm = new ScardmanagecdcorViewer();
	...
	public boolean checkSearchCriteria(Map criteria) {
		...
		criteria.put("objectType", 2);
		return true;
	}

	@Override
	public SearchForm generateSearchForm() {
		return new ScardmanagecdcorSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSScardmanagecdcor.getInstance();
	}
