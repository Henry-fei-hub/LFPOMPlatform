...
public class ScardmanagecdcorViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		params.put("cardManageId", getBusinessId());
		DBDataSource.callOperation("NQ_Scardmanagecdcor", "find", new DSCallback() {
			@Override
