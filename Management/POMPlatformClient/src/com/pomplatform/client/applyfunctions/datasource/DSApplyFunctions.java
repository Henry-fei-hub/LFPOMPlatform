...
public class DSApplyFunctions extends DBDataSource
{


	public static DSApplyFunctions instance = null;

	public static DSApplyFunctions getInstance() {
		if(instance == null) {
			instance = new DSApplyFunctions("DSApplyFunctions");
		}
		return instance;
	}
	...
	public DSApplyFunctions(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("ApplyFunctions");
