package com.pomplatform.client.applyfunctions.datasource;

import com.smartgwt.client.data.DataSource;
import com.smartgwt.client.data.fields.*;
import com.delicacy.client.data.KeyValueManager;

public class CDApplyFunctions extends DataSource
{


	public static CDApplyFunctions instance = null;

	public static CDApplyFunctions getInstance() {
		if(instance == null) {
			instance = new CDApplyFunctions("CDApplyFunctions");
		}
		return instance;
	}
	...
	public CDApplyFunctions(String dataSourceID) {
