...
import com.pomplatform.client.applyfunctions.form.ApplyFunctionsSearchForm;
import com.pomplatform.client.applyfunctions.form.ApplyFunctionsViewer;
import com.pomplatform.client.applyfunctions.form.NewApplyFunctionsForm;
import com.pomplatform.client.applyfunctions.form.UpdateApplyFunctionsForm;
...
public class ApplyFunctionsPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			ApplyFunctionsPanel cm = new ApplyFunctionsPanel();
			id = cm.getID();
			return cm;
		}
	...
	public void initComponents() {
		...
		IButton operation1Button = new IButton("新增");
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						NewApplyFunctionsForm detailForm = new NewApplyFunctionsForm();
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateApplyFunctionsForm detailForm = new UpdateApplyFunctionsForm();
		...
		removeButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				DBDataSource.callOperation("ST_ApplyFunctions", "delete", selected.toMap(), new DSCallback() {
					@Override
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("ApplyFunctions"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				ApplyFunctionsViewer detailForm = new ApplyFunctionsViewer();
	...
	public SearchForm generateSearchForm() {
		return new ApplyFunctionsSearchForm();
	}
