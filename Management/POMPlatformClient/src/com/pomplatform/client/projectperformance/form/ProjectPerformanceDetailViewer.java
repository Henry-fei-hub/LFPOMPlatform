...
public class ProjectPerformanceDetailViewer extends AbstractDetailViewer
{
	...
	public ProjectPerformanceDetailViewer() {
	}
	...
	public void load() {
		...
		params.put("projectPerformanceId", getBusinessId());
		DBDataSource.callOperation("NQ_ProjectPerformanceDetail", "find", new DSCallback() {
			@Override
