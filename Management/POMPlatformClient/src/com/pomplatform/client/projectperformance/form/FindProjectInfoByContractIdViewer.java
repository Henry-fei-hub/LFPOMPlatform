...
public class FindProjectInfoByContractIdViewer extends AbstractDetailViewer
{
	...
	public FindProjectInfoByContractIdViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_FindProjectInfoByContractId", "find", new DSCallback() {
			@Override
