...
import com.pomplatform.client.k3code.form.NewSpecificK3CodeForm;
import com.pomplatform.client.k3code.form.SpecificK3CodeSearchForm;
import com.pomplatform.client.k3code.form.UpdateSpecificK3CodeForm;
...
public class SpecificK3CodePanel extends AbstractSearchPanel {
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			SpecificK3CodePanel cm = new SpecificK3CodePanel();
			id = cm.getID();
			return cm;
		}
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						NewSpecificK3CodeForm detailForm = new NewSpecificK3CodeForm();
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateSpecificK3CodeForm detailForm = new UpdateSpecificK3CodeForm();
	...
	public boolean checkSearchCriteria(Map criteria) {
		...
		criteria.put("type", ClientStaticUtils.K3_CODE_TYPE_0);
		return true;
	}

	@Override
	public SearchForm generateSearchForm() {
		return new SpecificK3CodeSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSSpecificK3Code.getInstance();
	}
