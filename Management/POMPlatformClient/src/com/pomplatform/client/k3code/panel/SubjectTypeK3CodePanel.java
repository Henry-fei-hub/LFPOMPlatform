...
import com.pomplatform.client.k3code.form.NewSubjectTypeK3CodeForm;
import com.pomplatform.client.k3code.form.SubjectTypeK3CodeSearchForm;
import com.pomplatform.client.k3code.form.SubjectTypeK3CodeViewer;
...
public class SubjectTypeK3CodePanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			SubjectTypeK3CodePanel cm = new SubjectTypeK3CodePanel();
			id = cm.getID();
			return cm;
		}
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						NewSubjectTypeK3CodeForm detailForm = new NewSubjectTypeK3CodeForm();
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateSubjectTypeK3CodeForm detailForm = new UpdateSubjectTypeK3CodeForm();
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("科目K3代码"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				SubjectTypeK3CodeViewer detailForm = new SubjectTypeK3CodeViewer();
	...
	public SearchForm generateSearchForm() {
		return new SubjectTypeK3CodeSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSSubjectTypeK3Code.getInstance();
	}
