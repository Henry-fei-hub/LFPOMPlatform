...
import com.pomplatform.client.k3code.form.DepartmentK3CodeSearchForm;
import com.pomplatform.client.k3code.form.DepartmentK3CodeViewer;
import com.pomplatform.client.k3code.form.NewDepartmentK3CodeForm;
import com.pomplatform.client.k3code.form.UpdateDepartmentK3CodeForm;
...
public class DepartmentK3CodePanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			DepartmentK3CodePanel cm = new DepartmentK3CodePanel();
			id = cm.getID();
			return cm;
		}
...
//				showDetail();
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						NewDepartmentK3CodeForm detailForm = new NewDepartmentK3CodeForm();
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateDepartmentK3CodeForm detailForm = new UpdateDepartmentK3CodeForm();
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("部门K3代码维护"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				DepartmentK3CodeViewer detailForm = new DepartmentK3CodeViewer();
	...
	public SearchForm generateSearchForm() {
		return new DepartmentK3CodeSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSDepartmentK3Code.getInstance();
	}
