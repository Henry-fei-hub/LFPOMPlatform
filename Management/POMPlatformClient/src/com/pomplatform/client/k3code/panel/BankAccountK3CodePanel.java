...
import com.pomplatform.client.k3code.form.BankAccountK3CodeSearchForm;
import com.pomplatform.client.k3code.form.BankAccountK3CodeViewer;
import com.pomplatform.client.k3code.form.NewBankAccountK3CodeForm;
...
public class BankAccountK3CodePanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			BankAccountK3CodePanel cm = new BankAccountK3CodePanel();
			id = cm.getID();
			return cm;
		}
...
//				showDetail();
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						NewBankAccountK3CodeForm detailForm = new NewBankAccountK3CodeForm();
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateBankAccountK3CodeForm detailForm = new UpdateBankAccountK3CodeForm();
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("银行账号K3代码维护"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				BankAccountK3CodeViewer detailForm = new BankAccountK3CodeViewer();
	...
	public SearchForm generateSearchForm() {
		return new BankAccountK3CodeSearchForm();
	}
