...
import com.pomplatform.client.k3code.form.CompanyK3CodeSearchForm;
import com.pomplatform.client.k3code.form.NewCompanyK3CodeForm;
...
public class CompanyK3CodePanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			CompanyK3CodePanel cm = new CompanyK3CodePanel();
			id = cm.getID();
			return cm;
		}
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						NewCompanyK3CodeForm detailForm = new NewCompanyK3CodeForm();
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateCompanyK3CodeForm detailForm = new UpdateCompanyK3CodeForm();
	...
	public SearchForm generateSearchForm() {
		return new CompanyK3CodeSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSCompanyK3Code.getInstance();
	}
