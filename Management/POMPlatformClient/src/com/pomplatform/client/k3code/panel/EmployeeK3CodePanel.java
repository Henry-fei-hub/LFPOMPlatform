...
import com.pomplatform.client.k3code.form.EmployeeK3CodeSearchForm;
import com.pomplatform.client.k3code.form.EmployeeK3CodeViewer;
import com.pomplatform.client.k3code.form.NewEmployeeK3CodeForm;
...
public class EmployeeK3CodePanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			EmployeeK3CodePanel cm = new EmployeeK3CodePanel();
			id = cm.getID();
			return cm;
		}
...
//				showDetail();
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						NewEmployeeK3CodeForm detailForm = new NewEmployeeK3CodeForm();
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateEmployeeK3CodeForm detailForm = new UpdateEmployeeK3CodeForm();
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("员工K3代码维护"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				EmployeeK3CodeViewer detailForm = new EmployeeK3CodeViewer();
	...
	public SearchForm generateSearchForm() {
		return new EmployeeK3CodeSearchForm();
	}
