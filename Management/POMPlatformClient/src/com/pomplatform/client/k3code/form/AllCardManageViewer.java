...
public class AllCardManageViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_AllCardManage", "find", new DSCallback() {
			@Override
