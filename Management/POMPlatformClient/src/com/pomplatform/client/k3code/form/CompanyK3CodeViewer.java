...
public class CompanyK3CodeViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_CompanyK3Code", "find", new DSCallback() {
			@Override
