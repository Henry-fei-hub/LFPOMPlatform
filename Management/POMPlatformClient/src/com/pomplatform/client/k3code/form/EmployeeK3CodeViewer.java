...
public class EmployeeK3CodeViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_EmployeeK3Code", "find", new DSCallback() {
			@Override
	...
	public DataSource getMainDataSource() {
		return DSEmployeeK3Code.getInstance();
	}
