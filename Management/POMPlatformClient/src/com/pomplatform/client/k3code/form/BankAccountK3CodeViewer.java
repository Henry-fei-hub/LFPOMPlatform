...
public class BankAccountK3CodeViewer extends AbstractDetailViewer
{
	...
	public BankAccountK3CodeViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_BankAccountK3Code", "find", new DSCallback() {
			@Override
	...
	public DataSource getMainDataSource() {
		return DSBankAccountK3Code.getInstance();
	}
