...
public class DepartmentK3CodeViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_DepartmentK3Code", "find", new DSCallback() {
			@Override
