...
public class SubjectTypeK3CodeViewer extends AbstractDetailViewer
{
	...
	public SubjectTypeK3CodeViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_SubjectTypeK3Code", "find", new DSCallback() {
			@Override
