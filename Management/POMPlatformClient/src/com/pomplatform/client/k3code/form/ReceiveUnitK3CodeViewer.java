...
public class ReceiveUnitK3CodeViewer extends AbstractDetailViewer
{
	...
	public ReceiveUnitK3CodeViewer() {
	}
	...
	public void load() {
		...
		params.put("k3CodeId", getBusinessId());
		DBDataSource.callOperation("NQ_ReceiveUnitK3Code", "find", new DSCallback() {
			@Override
	...
	public DataSource getMainDataSource() {
		return DSReceiveUnitK3Code.getInstance();
	}
