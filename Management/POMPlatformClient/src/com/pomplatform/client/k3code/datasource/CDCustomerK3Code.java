...
public class CDCustomerK3Code extends DataSource
{


	public static CDCustomerK3Code instance = null;

	public static CDCustomerK3Code getInstance() {
		if(instance == null) {
			instance = new CDCustomerK3Code("CDCustomerK3Code");
		}
		return instance;
	}
	...
	public CDCustomerK3Code(String dataSourceID) {
