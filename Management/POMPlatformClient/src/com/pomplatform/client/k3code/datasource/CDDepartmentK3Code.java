...
public class CDDepartmentK3Code extends DataSource
{


	public static CDDepartmentK3Code instance = null;

	public static CDDepartmentK3Code getInstance() {
		if(instance == null) {
			instance = new CDDepartmentK3Code("CDDepartmentK3Code");
		}
		return instance;
	}
	...
	public CDDepartmentK3Code(String dataSourceID) {
