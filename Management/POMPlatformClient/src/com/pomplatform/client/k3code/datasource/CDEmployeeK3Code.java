...
public class CDEmployeeK3Code extends DataSource
{


	public static CDEmployeeK3Code instance = null;

	public static CDEmployeeK3Code getInstance() {
		if(instance == null) {
			instance = new CDEmployeeK3Code("CDEmployeeK3Code");
		}
		return instance;
	}
	...
	public CDEmployeeK3Code(String dataSourceID) {
