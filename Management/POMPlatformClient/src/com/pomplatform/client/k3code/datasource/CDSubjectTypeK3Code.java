...
public class CDSubjectTypeK3Code extends DataSource
{


	public static CDSubjectTypeK3Code instance = null;

	public static CDSubjectTypeK3Code getInstance() {
		if(instance == null) {
			instance = new CDSubjectTypeK3Code("CDSubjectTypeK3Code");
		}
		return instance;
	}
	...
	public CDSubjectTypeK3Code(String dataSourceID) {
		...
		setFields(businessIdField, departmentTypeField, k3CodeField, currentPageField, pageLinesField);
