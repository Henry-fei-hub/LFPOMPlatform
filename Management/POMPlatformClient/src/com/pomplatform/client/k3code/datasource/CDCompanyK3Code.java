...
public class CDCompanyK3Code extends DataSource
{


	public static CDCompanyK3Code instance = null;

	public static CDCompanyK3Code getInstance() {
		if(instance == null) {
			instance = new CDCompanyK3Code("CDCompanyK3Code");
		}
		return instance;
	}
	...
	public CDCompanyK3Code(String dataSourceID) {
