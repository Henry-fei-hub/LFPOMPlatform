...
public class DSDepartmentK3Code extends DBDataSource
{


	public static DSDepartmentK3Code instance = null;

	public static DSDepartmentK3Code getInstance() {
		if(instance == null) {
			instance = new DSDepartmentK3Code("DSDepartmentK3Code");
		}
		return instance;
	}
	...
	public DSDepartmentK3Code(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("DepartmentK3Code");
		...
		setFields(k3CodeIdField, typeField, businessIdField, k3CodeField, k3NameField);
	}
