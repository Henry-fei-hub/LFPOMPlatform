...
public class DSSubjectTypeK3Code extends DBDataSource
{


	public static DSSubjectTypeK3Code instance = null;

	public static DSSubjectTypeK3Code getInstance() {
		if(instance == null) {
			instance = new DSSubjectTypeK3Code("DSSubjectTypeK3Code");
		}
		return instance;
	}
	...
	public DSSubjectTypeK3Code(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("SubjectTypeK3Code");
		...
		businessIdField = new DataSourceIntegerField("businessId", "科目");
		businessIdField.setLength(11);
		businessIdField.setRequired(false);
		businessIdField.setHidden(false);
//		businessIdField.setValueMap(KeyValueManager.getValueMap("subject_types"));
		KeyValueManager.loadValueMap("subject_types",businessIdField );
		...
		setFields(k3CodeIdField, typeField, departmentTypeField, businessIdField, k3CodeField, k3NameField);
	}
