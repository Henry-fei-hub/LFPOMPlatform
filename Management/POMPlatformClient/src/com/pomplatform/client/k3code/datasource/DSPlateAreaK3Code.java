...
public class DSPlateAreaK3Code extends DBDataSource {

	public static DSPlateAreaK3Code instance = null;

	public static DSPlateAreaK3Code getInstance() {
		if (instance == null) {
			instance = new DSPlateAreaK3Code("DSPlateAreaK3Code");
		}
		return instance;
	}
	...
	public DSPlateAreaK3Code(String dataSourceID) {
		...
		businessIdField = new DataSourceIntegerField("businessId", "业务类别");
		businessIdField.setLength(11);
		businessIdField.setRequired(false);
		businessIdField.setHidden(false);
		businessIdField.setValueMap(KeyValueManager.getValueMap("production_value_coefficient_type"));
