...
public class DSCustomerK3Code extends DBDataSource
{


	public static DSCustomerK3Code instance = null;

	public static DSCustomerK3Code getInstance() {
		if(instance == null) {
			instance = new DSCustomerK3Code("DSCustomerK3Code");
		}
		return instance;
	}
	...
	public DSCustomerK3Code(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("CustomerK3Code");
		...
		typeField = new DataSourceIntegerField("type", " 8收款单位");
		typeField.setLength(11);
		typeField.setRequired(false);
		typeField.setHidden(true);


		businessIdField = new DataSourceIntegerField("businessId", "客户");
		businessIdField.setLength(11);
		businessIdField.setRequired(false);
		businessIdField.setHidden(false);
//		businessIdField.setValueMap(KeyValueManager.getValueMap("customers"));
		KeyValueManager.loadValueMap("customers",businessIdField);
