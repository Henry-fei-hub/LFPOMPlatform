...
public class ContractIncomeLedgerListViewer extends AbstractDetailViewer
{
	...
	public ContractIncomeLedgerListViewer() {
	}
	...
	public void load() {
		...
		params.put("contractIncomeLedgerId", getBusinessId());
		DBDataSource.callOperation("NQ_ContractIncomeLedgerList", "find", new DSCallback() {
			@Override
