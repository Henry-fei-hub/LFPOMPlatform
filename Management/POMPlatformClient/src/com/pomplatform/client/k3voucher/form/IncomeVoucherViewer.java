...
public class IncomeVoucherViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_IncomeVoucher", "find", new DSCallback() {
			@Override
