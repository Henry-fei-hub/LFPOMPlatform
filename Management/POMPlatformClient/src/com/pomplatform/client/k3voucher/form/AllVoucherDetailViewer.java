...
public class AllVoucherDetailViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_AllVoucherDetail", "find", new DSCallback() {
			@Override
