...
public class GenerateCapitalVoucherViewer extends AbstractDetailViewer
{
	...
	public GenerateCapitalVoucherViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_GenerateCapitalVoucher", "find", new DSCallback() {
			@Override
