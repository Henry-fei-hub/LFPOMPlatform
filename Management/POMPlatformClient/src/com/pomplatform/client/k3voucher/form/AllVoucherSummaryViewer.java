...
public class AllVoucherSummaryViewer extends AbstractDetailViewer
{
	...
	public AllVoucherSummaryViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_AllVoucherSummary", "find", new DSCallback() {
			@Override
