...
public class InsuranceAndHousingFundK3VoucherViewer extends AbstractDetailViewer
{
	...
	public InsuranceAndHousingFundK3VoucherViewer() {
	}
	...
	public void load() {
		...
		params.put("k3VoucherId", getBusinessId());
		DBDataSource.callOperation("NQ_InsuranceAndHousingFundK3Voucher", "find", new DSCallback() {
			@Override
