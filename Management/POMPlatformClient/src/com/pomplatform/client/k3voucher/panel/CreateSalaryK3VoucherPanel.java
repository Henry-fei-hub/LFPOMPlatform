...
public class CreateSalaryK3VoucherPanel extends AbstractWizadPage implements HasHandlers{
	...
	public CreateSalaryK3VoucherPanel(){
				...
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						if(checkData()){
							...
							params.put("optType", "createSalaryK3Voucher");
