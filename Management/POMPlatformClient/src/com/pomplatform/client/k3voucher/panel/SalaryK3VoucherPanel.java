...
import com.pomplatform.client.k3voucher.form.SalaryK3VoucherSearchForm;
...
public class SalaryK3VoucherPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			SalaryK3VoucherPanel cm = new SalaryK3VoucherPanel();
			id = cm.getID();
			return cm;
		}
	...
	public SearchForm generateSearchForm() {
		SalaryK3VoucherSearchForm form = new SalaryK3VoucherSearchForm();
