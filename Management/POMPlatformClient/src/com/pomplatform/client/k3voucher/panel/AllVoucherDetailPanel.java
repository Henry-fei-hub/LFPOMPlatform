...
import com.pomplatform.client.k3voucher.form.AllVoucherDetailSearchForm;
...
public class AllVoucherDetailPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			AllVoucherDetailPanel cm = new AllVoucherDetailPanel();
			id = cm.getID();
			return cm;
		}
	...
	public SearchForm generateSearchForm() {
		return new AllVoucherDetailSearchForm();
	}
