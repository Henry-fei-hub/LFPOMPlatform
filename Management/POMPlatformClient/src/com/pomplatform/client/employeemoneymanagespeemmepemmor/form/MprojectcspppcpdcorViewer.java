...
public class MprojectcspppcpdcorViewer extends AbstractDetailViewer
{
	...
	public MprojectcspppcpdcorViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Mprojectcspppcpdcor", "find", new DSCallback() {
			@Override
