...
public class MemployeepsrreereeedporViewer extends AbstractDetailViewer
{
	...
	public MemployeepsrreereeedporViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Memployeepsrreereeedpor", "find", new DSCallback() {
			@Override
