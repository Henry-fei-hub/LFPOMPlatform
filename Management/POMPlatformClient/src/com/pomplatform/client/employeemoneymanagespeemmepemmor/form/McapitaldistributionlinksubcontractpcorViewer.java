...
public class McapitaldistributionlinksubcontractpcorViewer extends AbstractDetailViewer
{
	...
	public McapitaldistributionlinksubcontractpcorViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Mcapitaldistributionlinksubcontractpcor", "find", new DSCallback() {
			@Override
