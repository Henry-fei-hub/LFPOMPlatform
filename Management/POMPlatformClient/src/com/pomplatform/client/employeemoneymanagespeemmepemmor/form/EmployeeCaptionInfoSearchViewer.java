...
public class EmployeeCaptionInfoSearchViewer extends AbstractDetailViewer
{
	...
	public EmployeeCaptionInfoSearchViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_EmployeeCaptionInfoSearch", "find", new DSCallback() {
			@Override
