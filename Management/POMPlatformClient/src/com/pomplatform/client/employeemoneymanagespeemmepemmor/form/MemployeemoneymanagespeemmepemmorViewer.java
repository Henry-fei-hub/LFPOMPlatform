...
public class MemployeemoneymanagespeemmepemmorViewer extends AbstractDetailViewer
{
	...
	public MemployeemoneymanagespeemmepemmorViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Memployeemoneymanagespeemmepemmor", "find", new DSCallback() {
			@Override
