...
public class McapitaldistributionlinkdepartmentdcorViewer extends AbstractDetailViewer
{
	...
	public McapitaldistributionlinkdepartmentdcorViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Mcapitaldistributionlinkdepartmentdcor", "find", new DSCallback() {
			@Override
