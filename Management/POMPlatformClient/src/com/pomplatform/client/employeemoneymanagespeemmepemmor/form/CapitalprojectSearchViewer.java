...
public class CapitalprojectSearchViewer extends AbstractDetailViewer
{
	...
	public CapitalprojectSearchViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_CapitalprojectSearch", "find", new DSCallback() {
			@Override
