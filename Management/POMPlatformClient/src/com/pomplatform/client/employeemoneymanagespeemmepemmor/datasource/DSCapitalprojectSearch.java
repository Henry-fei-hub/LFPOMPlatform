...
public class DSCapitalprojectSearch extends DBDataSource
{


	public static DSCapitalprojectSearch instance = null;

	public static DSCapitalprojectSearch getInstance() {
		if(instance == null) {
			instance = new DSCapitalprojectSearch("DSCapitalprojectSearch");
		}
		return instance;
	}
	...
	public DSCapitalprojectSearch(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("CapitalprojectSearch");
