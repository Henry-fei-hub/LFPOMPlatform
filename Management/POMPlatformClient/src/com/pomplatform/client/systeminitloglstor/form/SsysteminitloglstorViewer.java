...
public class SsysteminitloglstorViewer extends AbstractDetailViewer
{
	...
	public SsysteminitloglstorViewer() {
	}
	...
	public void load() {
		...
		params.put("systemInitLogId", getBusinessId());
		DBDataSource.callOperation("NQ_Ssysteminitloglstor", "find", new DSCallback() {
			@Override
