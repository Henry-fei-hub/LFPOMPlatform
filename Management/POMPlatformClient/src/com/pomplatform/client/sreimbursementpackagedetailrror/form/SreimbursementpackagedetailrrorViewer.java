...
public class SreimbursementpackagedetailrrorViewer extends AbstractDetailViewer
{
	...
	public SreimbursementpackagedetailrrorViewer() {
	}
	...
	public void load() {
		...
		params.put("reimbursementPackageDetailId", getBusinessId());
		DBDataSource.callOperation("NQ_Sreimbursementpackagedetailrror", "find", new DSCallback() {
			@Override
