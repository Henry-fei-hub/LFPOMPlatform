...
public class MclientctractorViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		params.put("clientId", getBusinessId());
		DBDataSource.callOperation("NQ_Mclientctractor", "find", new DSCallback() {
			@Override
