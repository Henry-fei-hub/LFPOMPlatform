...
public class CDBonusPaymentRecordWithB extends DataSource
{


	public static CDBonusPaymentRecordWithB instance = null;

	public static CDBonusPaymentRecordWithB getInstance() {
		if(instance == null) {
			instance = new CDBonusPaymentRecordWithB("CDBonusPaymentRecordWithB");
		}
		return instance;
	}
	...
	public CDBonusPaymentRecordWithB(String dataSourceID) {
		...
		setFields(bonusPaymentRecordIdField, plateIdField, applicantField, stateField, auditorField, currentPageField, pageLinesField);
