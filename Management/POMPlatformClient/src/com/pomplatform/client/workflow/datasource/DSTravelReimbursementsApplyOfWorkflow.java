...
public class DSTravelReimbursementsApplyOfWorkflow extends DBDataSource
{


	public static DSTravelReimbursementsApplyOfWorkflow instance = null;

	public static DSTravelReimbursementsApplyOfWorkflow getInstance() {
		if(instance == null) {
			instance = new DSTravelReimbursementsApplyOfWorkflow("DSTravelReimbursementsApplyOfWorkflow");
		}
		return instance;
	}
	...
	public DSTravelReimbursementsApplyOfWorkflow(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("TravelReimbursementsApplyOfWorkflow");
		...
		setFields(processInstanceIdField, processTypeField, businessIdField, businessNameField, processIdField, processInstanceActivityIdField, codeField, applicantField, departmentIdField, amountField, companyIdField, titleField, processStatusField, createTimeField, completeTimeField);
	}
