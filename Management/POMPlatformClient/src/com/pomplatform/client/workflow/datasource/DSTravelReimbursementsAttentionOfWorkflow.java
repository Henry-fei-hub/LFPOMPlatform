...
public class DSTravelReimbursementsAttentionOfWorkflow extends DBDataSource
{


	public static DSTravelReimbursementsAttentionOfWorkflow instance = null;

	public static DSTravelReimbursementsAttentionOfWorkflow getInstance() {
		if(instance == null) {
			instance = new DSTravelReimbursementsAttentionOfWorkflow("DSTravelReimbursementsAttentionOfWorkflow");
		}
		return instance;
	}
	...
	public DSTravelReimbursementsAttentionOfWorkflow(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("TravelReimbursementsAttentionOfWorkflow");
		...
		businessIdField.setForeignKey("DSTravelReimbursementsAttentionOfWorkflow.businessId");
