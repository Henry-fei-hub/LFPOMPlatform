...
public class CDAuditedNormalReimbursement extends DataSource
{


	public static CDAuditedNormalReimbursement instance = null;

	public static CDAuditedNormalReimbursement getInstance() {
		if(instance == null) {
			instance = new CDAuditedNormalReimbursement("CDAuditedNormalReimbursement");
		}
		return instance;
	}
	...
	public CDAuditedNormalReimbursement(String dataSourceID) {
