...
public class CDEmployeeMoneyPoolOfWorkflow extends DataSource
{


	public static CDEmployeeMoneyPoolOfWorkflow instance = null;

	public static CDEmployeeMoneyPoolOfWorkflow getInstance() {
		if(instance == null) {
			instance = new CDEmployeeMoneyPoolOfWorkflow("CDEmployeeMoneyPoolOfWorkflow");
		}
		return instance;
	}
	...
	public CDEmployeeMoneyPoolOfWorkflow(String dataSourceID) {
		...
		setFields(statusField, employeeIdField, drafterField, companyIdField, departmentIdField, codeField, currentPageField, pageLinesField);
