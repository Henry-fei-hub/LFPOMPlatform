...
public class CDAuditedTravelReimbursement extends DataSource
{


	public static CDAuditedTravelReimbursement instance = null;

	public static CDAuditedTravelReimbursement getInstance() {
		if(instance == null) {
			instance = new CDAuditedTravelReimbursement("CDAuditedTravelReimbursement");
		}
		return instance;
	}
	...
	public CDAuditedTravelReimbursement(String dataSourceID) {
