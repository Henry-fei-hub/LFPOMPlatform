...
public class DSEmployeeMoneyPoolOfWorkflow extends DBDataSource
{


	public static DSEmployeeMoneyPoolOfWorkflow instance = null;

	public static DSEmployeeMoneyPoolOfWorkflow getInstance() {
		if(instance == null) {
			instance = new DSEmployeeMoneyPoolOfWorkflow("DSEmployeeMoneyPoolOfWorkflow");
		}
		return instance;
	}
	...
	public DSEmployeeMoneyPoolOfWorkflow(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("EmployeeMoneyPoolOfWorkflow");
		...
		setFields(processPooledTaskIdField, processInstanceIdField, businessIdField, businessNameField, processActivityIdField, processIdField, backViewNameField, activityTypeField, nodeTypeField, activityIdField, instanceActivityCreateTimeField, instanceActivityStartTimeField, statusField, processTypeField, codeField, employeeIdField, departmentIdField, borrowMoneyField, companyIdField, operateTimeField, processCommentField, reasonField);
	}
