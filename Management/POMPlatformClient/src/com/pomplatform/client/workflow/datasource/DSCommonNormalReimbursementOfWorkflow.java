...
public class DSCommonNormalReimbursementOfWorkflow extends DBDataSource
{


	public static DSCommonNormalReimbursementOfWorkflow instance = null;

	public static DSCommonNormalReimbursementOfWorkflow getInstance() {
		if(instance == null) {
			instance = new DSCommonNormalReimbursementOfWorkflow("DSProjectNormalReimbursementOfWorkflow");
		}
		return instance;
	}
	...
	public DSCommonNormalReimbursementOfWorkflow(String dataSourceID) {
		...
		reimbursementNameField.setLength(64);
		...
		setFields(projectNormalReimbursementIdField, projectNormalReimbursementNoField, processInstanceIdField, codeField, applyEmployeeIdField, employeeIdField, departmentIdField, reimbursementNameField, companyIdField, reimbursementTimeField, statusField, amountField, applyTimeField, completeTimeField, remarkField, strikeABalanceField, attachmentField, attachmentNumberField, detailProjectNormalReimbursementDetail);
	}
