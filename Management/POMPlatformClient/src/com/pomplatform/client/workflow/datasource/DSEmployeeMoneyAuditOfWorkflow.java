...
public class DSEmployeeMoneyAuditOfWorkflow extends DBDataSource
{


	public static DSEmployeeMoneyAuditOfWorkflow instance = null;

	public static DSEmployeeMoneyAuditOfWorkflow getInstance() {
		if(instance == null) {
			instance = new DSEmployeeMoneyAuditOfWorkflow("DSEmployeeMoneyAuditOfWorkflow");
		}
		return instance;
	}
	...
	public DSEmployeeMoneyAuditOfWorkflow(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("EmployeeMoneyAuditOfWorkflow");
