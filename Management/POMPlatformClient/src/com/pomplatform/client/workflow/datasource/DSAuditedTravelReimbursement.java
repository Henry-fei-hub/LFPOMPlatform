...
public class DSAuditedTravelReimbursement extends DBDataSource
{


	public static DSAuditedTravelReimbursement instance = null;

	public static DSAuditedTravelReimbursement getInstance() {
		if(instance == null) {
			instance = new DSAuditedTravelReimbursement("DSAuditedTravelReimbursement");
		}
		return instance;
	}
	...
	public DSAuditedTravelReimbursement(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("AuditedTravelReimbursement");
		...
		setFields(processInstanceActivityIdField, businessIdField, businessNameField, processActivityIdField, processIdField, processInstanceIdField, nodeTypeField, activityIdField, nextActivityIdField, mainActivityIdField, instanceActivityCreateTimeField, instanceActivityStartTimeField, processTypeField, codeField, applicantField, departmentIdField, amountField, companyIdField, titleField, operateTimeField, statusField, processCommentField, activityTypeField, backViewNameField);
	}
