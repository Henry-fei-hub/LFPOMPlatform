...
public class DSNormalReimbursementsAttentionOfWorkflow extends DBDataSource
{


	public static DSNormalReimbursementsAttentionOfWorkflow instance = null;

	public static DSNormalReimbursementsAttentionOfWorkflow getInstance() {
		if(instance == null) {
			instance = new DSNormalReimbursementsAttentionOfWorkflow("DSNormalReimbursementsAttentionOfWorkflow");
		}
		return instance;
	}
	...
	public DSNormalReimbursementsAttentionOfWorkflow(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("NormalReimbursementsAttentionOfWorkflow");
		...
		businessIdField.setForeignKey("DSNormalReimbursementsAttentionOfWorkflow.businessId");
