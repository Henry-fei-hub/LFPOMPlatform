...
public class CDPayMoneyPoolOfWorkflow extends DataSource
{


	public static CDPayMoneyPoolOfWorkflow instance = null;

	public static CDPayMoneyPoolOfWorkflow getInstance() {
		if(instance == null) {
			instance = new CDPayMoneyPoolOfWorkflow("CDPayMoneyPoolOfWorkflow");
		}
		return instance;
	}
	...
	public CDPayMoneyPoolOfWorkflow(String dataSourceID) {
