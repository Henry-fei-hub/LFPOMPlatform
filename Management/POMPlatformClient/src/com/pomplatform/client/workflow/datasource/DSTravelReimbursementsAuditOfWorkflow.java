...
public class DSTravelReimbursementsAuditOfWorkflow extends DBDataSource
{


	public static DSTravelReimbursementsAuditOfWorkflow instance = null;

	public static DSTravelReimbursementsAuditOfWorkflow getInstance() {
		if(instance == null) {
			instance = new DSTravelReimbursementsAuditOfWorkflow("DSTravelReimbursementsAuditOfWorkflow");
		}
		return instance;
	}
	...
	public DSTravelReimbursementsAuditOfWorkflow(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("TravelReimbursementsAuditOfWorkflow");
		...
		businessIdField.setForeignKey("DSTravelReimbursementsAuditOfWorkflow.businessId");
