...
public class DSNormalReimbursementsPoolOfWorkflow extends DBDataSource
{


	public static DSNormalReimbursementsPoolOfWorkflow instance = null;

	public static DSNormalReimbursementsPoolOfWorkflow getInstance() {
		if(instance == null) {
			instance = new DSNormalReimbursementsPoolOfWorkflow("DSNormalReimbursementsPoolOfWorkflow");
		}
		return instance;
	}
	...
	public DSNormalReimbursementsPoolOfWorkflow(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("NormalReimbursementsPoolOfWorkflow");
		...
		setFields(processPooledTaskIdField, processInstanceIdField, businessIdField, businessNameField, processActivityIdField, processIdField, backViewNameField, activityTypeField, nodeTypeField, activityIdField, instanceActivityCreateTimeField, instanceActivityStartTimeField, statusField, processTypeField, codeField, employeeIdField, departmentIdField, amountField, companyIdField, titleField, operateTimeField, processCommentField);
	}
