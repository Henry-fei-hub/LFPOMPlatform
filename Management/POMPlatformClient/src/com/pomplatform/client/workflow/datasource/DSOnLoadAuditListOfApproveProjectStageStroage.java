...
public class DSOnLoadAuditListOfApproveProjectStageStroage extends DBDataSource
{


	public static DSOnLoadAuditListOfApproveProjectStageStroage instance = null;

	public static DSOnLoadAuditListOfApproveProjectStageStroage getInstance() {
		if(instance == null) {
			instance = new DSOnLoadAuditListOfApproveProjectStageStroage("DSOnLoadAuditListOfApproveProjectStageStroage");
		}
		return instance;
	}
	...
	public DSOnLoadAuditListOfApproveProjectStageStroage(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("OnLoadAuditListOfApproveProjectStageStroage");
		...
		setFields(processInstanceActivityIdField, approveProjectStageStorageIdField, businessIdField, businessNameField, processActivityIdField, processIdField, processInstanceIdField, nodeTypeField, activityIdField, nextActivityIdField, mainActivityIdField, instanceActivityCreateTimeField, instanceActivityStartTimeField, operateTimeField, processCommentField, activityTypeField, backViewNameField, projectIdField, contractCodeField, projectCodeField, projectNameField, projectTypeField, plateIdField, projectManageIdField, plateManagerIdField, departmentManagerIdField, processTypeField, deleteFlagField, createTimeField, employeeIdField, empStatusField, statusField);
	}
