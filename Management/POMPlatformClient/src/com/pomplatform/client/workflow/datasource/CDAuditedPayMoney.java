...
public class CDAuditedPayMoney extends DataSource
{


	public static CDAuditedPayMoney instance = null;

	public static CDAuditedPayMoney getInstance() {
		if(instance == null) {
			instance = new CDAuditedPayMoney("CDAuditedPayMoney");
		}
		return instance;
	}
	...
	public CDAuditedPayMoney(String dataSourceID) {
