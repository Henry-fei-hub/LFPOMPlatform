...
public class DSOnLoadAttentionListOfApproveProjectStageStroage extends DBDataSource
{


	public static DSOnLoadAttentionListOfApproveProjectStageStroage instance = null;

	public static DSOnLoadAttentionListOfApproveProjectStageStroage getInstance() {
		if(instance == null) {
			instance = new DSOnLoadAttentionListOfApproveProjectStageStroage("DSOnLoadAttentionListOfApproveProjectStageStroage");
		}
		return instance;
	}
	...
	public DSOnLoadAttentionListOfApproveProjectStageStroage(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("OnLoadAttentionListOfApproveProjectStageStroage");
