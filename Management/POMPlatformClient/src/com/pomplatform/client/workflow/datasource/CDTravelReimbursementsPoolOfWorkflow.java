...
public class CDTravelReimbursementsPoolOfWorkflow extends DataSource
{


	public static CDTravelReimbursementsPoolOfWorkflow instance = null;

	public static CDTravelReimbursementsPoolOfWorkflow getInstance() {
		if(instance == null) {
			instance = new CDTravelReimbursementsPoolOfWorkflow("CDTravelReimbursementsPoolOfWorkflow");
		}
		return instance;
	}
	...
	public CDTravelReimbursementsPoolOfWorkflow(String dataSourceID) {
