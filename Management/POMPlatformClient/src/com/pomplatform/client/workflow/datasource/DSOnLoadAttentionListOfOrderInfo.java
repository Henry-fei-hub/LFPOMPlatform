...
public class DSOnLoadAttentionListOfOrderInfo extends DBDataSource
{


	public static DSOnLoadAttentionListOfOrderInfo instance = null;

	public static DSOnLoadAttentionListOfOrderInfo getInstance() {
		if(instance == null) {
			instance = new DSOnLoadAttentionListOfOrderInfo("DSOnLoadAttentionListOfOrderInfo");
		}
		return instance;
	}
	...
	public DSOnLoadAttentionListOfOrderInfo(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("OnLoadAttentionListOfOrderInfo");
		...
		setFields(contractIdField, contractCodeField, contractNameField,infoCodeField,systemProcessAttentionIdField, businessIdField, businessNameField, processActivityIdField, processIdField, processInstanceIdField, backViewNameField, instanceActivityIdField, instanceActivityCreateTimeField, instanceActivityStartTimeField, statusField, operateTimeField, processCommentField, employeeIdField);
	}
