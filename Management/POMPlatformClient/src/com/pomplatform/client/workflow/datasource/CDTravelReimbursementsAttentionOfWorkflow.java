...
public class CDTravelReimbursementsAttentionOfWorkflow extends DataSource
{


	public static CDTravelReimbursementsAttentionOfWorkflow instance = null;

	public static CDTravelReimbursementsAttentionOfWorkflow getInstance() {
		if(instance == null) {
			instance = new CDTravelReimbursementsAttentionOfWorkflow("CDTravelReimbursementsAttentionOfWorkflow");
		}
		return instance;
	}
	...
	public CDTravelReimbursementsAttentionOfWorkflow(String dataSourceID) {
		...
		setFields(statusField, processTypeField, employeeIdField, drafterField, companyIdField, departmentIdField, codeField, currentPageField, pageLinesField);
