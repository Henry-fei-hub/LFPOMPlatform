...
public class DSPayMoneyPoolOfWorkflow extends DBDataSource
{


	public static DSPayMoneyPoolOfWorkflow instance = null;

	public static DSPayMoneyPoolOfWorkflow getInstance() {
		if(instance == null) {
			instance = new DSPayMoneyPoolOfWorkflow("DSPayMoneyPoolOfWorkflow");
		}
		return instance;
	}
	...
	public DSPayMoneyPoolOfWorkflow(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("PayMoneyPoolOfWorkflow");
		...
		setFields(processPooledTaskIdField, processInstanceIdField, businessIdField, businessNameField, processActivityIdField, processIdField, backViewNameField, activityTypeField, nodeTypeField, activityIdField, instanceActivityCreateTimeField, instanceActivityStartTimeField, statusField, processTypeField, codeField, employeeIdField, departmentIdField, payAmountField, companyIdField, reasonField, operateTimeField, processCommentField);
	}
