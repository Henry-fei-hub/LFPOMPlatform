...
public class DSMyAuditListOfApproveProjectStageStroage extends DBDataSource
{


	public static DSMyAuditListOfApproveProjectStageStroage instance = null;

	public static DSMyAuditListOfApproveProjectStageStroage getInstance() {
		if(instance == null) {
			instance = new DSMyAuditListOfApproveProjectStageStroage("DSMyAuditListOfApproveProjectStageStroage");
		}
		return instance;
	}
	...
	public DSMyAuditListOfApproveProjectStageStroage(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("MyAuditListOfApproveProjectStageStroage");
		...
		setFields(processInstanceActivityIdField, approveProjectStageStorageIdField, businessIdField, businessNameField, processActivityIdField, processIdField, processInstanceIdField, nodeTypeField, activityIdField, nextActivityIdField, mainActivityIdField, instanceActivityCreateTimeField, instanceActivityStartTimeField, operateTimeField, processCommentField, statusField, projectIdField, contractCodeField, projectCodeField, projectNameField, projectTypeField, plateIdField, projectManageIdField, plateManagerIdField, departmentManagerIdField, processTypeField, deleteFlagField, createTimeField, employeeIdField, empStatusField, backViewNameField);
	}
