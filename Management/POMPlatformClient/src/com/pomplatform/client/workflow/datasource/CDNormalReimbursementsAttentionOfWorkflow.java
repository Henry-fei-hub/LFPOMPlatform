...
public class CDNormalReimbursementsAttentionOfWorkflow extends DataSource
{


	public static CDNormalReimbursementsAttentionOfWorkflow instance = null;

	public static CDNormalReimbursementsAttentionOfWorkflow getInstance() {
		if(instance == null) {
			instance = new CDNormalReimbursementsAttentionOfWorkflow("CDNormalReimbursementsAttentionOfWorkflow");
		}
		return instance;
	}
	...
	public CDNormalReimbursementsAttentionOfWorkflow(String dataSourceID) {
