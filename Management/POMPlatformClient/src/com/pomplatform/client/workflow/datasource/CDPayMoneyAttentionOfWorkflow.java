...
public class CDPayMoneyAttentionOfWorkflow extends DataSource
{


	public static CDPayMoneyAttentionOfWorkflow instance = null;

	public static CDPayMoneyAttentionOfWorkflow getInstance() {
		if(instance == null) {
			instance = new CDPayMoneyAttentionOfWorkflow("CDPayMoneyAttentionOfWorkflow");
		}
		return instance;
	}
	...
	public CDPayMoneyAttentionOfWorkflow(String dataSourceID) {
