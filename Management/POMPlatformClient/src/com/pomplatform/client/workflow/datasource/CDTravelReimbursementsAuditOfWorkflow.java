...
public class CDTravelReimbursementsAuditOfWorkflow extends DataSource
{


	public static CDTravelReimbursementsAuditOfWorkflow instance = null;

	public static CDTravelReimbursementsAuditOfWorkflow getInstance() {
		if(instance == null) {
			instance = new CDTravelReimbursementsAuditOfWorkflow("CDTravelReimbursementsAuditOfWorkflow");
		}
		return instance;
	}
	...
	public CDTravelReimbursementsAuditOfWorkflow(String dataSourceID) {
		...
		setFields(processTypeField, statusField, employeeIdField, drafterField, companyIdField, departmentIdField, codeField, currentPageField, pageLinesField);
