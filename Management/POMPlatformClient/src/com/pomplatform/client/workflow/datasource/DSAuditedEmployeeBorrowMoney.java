...
public class DSAuditedEmployeeBorrowMoney extends DBDataSource
{


	public static DSAuditedEmployeeBorrowMoney instance = null;

	public static DSAuditedEmployeeBorrowMoney getInstance() {
		if(instance == null) {
			instance = new DSAuditedEmployeeBorrowMoney("DSAuditedEmployeeBorrowMoney");
		}
		return instance;
	}
	...
	public DSAuditedEmployeeBorrowMoney(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("AuditedEmployeeBorrowMoney");
		...
		setFields(processInstanceActivityIdField, processTypeField, codeField, employeeIdField, departmentIdField, borrowMoneyField, companyIdField, titleField, businessIdField, businessNameField, processActivityIdField, processIdField, processInstanceIdField, nodeTypeField, activityIdField, nextActivityIdField, mainActivityIdField, instanceActivityCreateTimeField, instanceActivityStartTimeField, operateTimeField, statusField, processCommentField, activityTypeField, backViewNameField, reasonField);
	}
