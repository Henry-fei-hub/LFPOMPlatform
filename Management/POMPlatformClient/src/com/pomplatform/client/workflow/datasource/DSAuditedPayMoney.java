...
public class DSAuditedPayMoney extends DBDataSource
{


	public static DSAuditedPayMoney instance = null;

	public static DSAuditedPayMoney getInstance() {
		if(instance == null) {
			instance = new DSAuditedPayMoney("DSAuditedPayMoney");
		}
		return instance;
	}
	...
	public DSAuditedPayMoney(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("AuditedPayMoney");
		...
		setFields(processInstanceActivityIdField, processTypeField, businessIdField, businessNameField, processActivityIdField, processIdField, processInstanceIdField, nodeTypeField, activityIdField, nextActivityIdField, mainActivityIdField, instanceActivityCreateTimeField, instanceActivityStartTimeField, codeField, employeeIdField, departmentIdField, payAmountField, companyIdField, titleField, reasonField, activityTypeField, backViewNameField, operateTimeField, statusField, processCommentField);
	}
