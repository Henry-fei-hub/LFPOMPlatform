...
public class CDNormalReimbursementsAuditOfWorkflow extends DataSource
{


	public static CDNormalReimbursementsAuditOfWorkflow instance = null;

	public static CDNormalReimbursementsAuditOfWorkflow getInstance() {
		if(instance == null) {
			instance = new CDNormalReimbursementsAuditOfWorkflow("CDNormalReimbursementsAuditOfWorkflow");
		}
		return instance;
	}
	...
	public CDNormalReimbursementsAuditOfWorkflow(String dataSourceID) {
