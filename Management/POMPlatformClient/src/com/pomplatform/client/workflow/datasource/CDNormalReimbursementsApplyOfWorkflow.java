...
public class CDNormalReimbursementsApplyOfWorkflow extends DataSource
{


	public static CDNormalReimbursementsApplyOfWorkflow instance = null;

	public static CDNormalReimbursementsApplyOfWorkflow getInstance() {
		if(instance == null) {
			instance = new CDNormalReimbursementsApplyOfWorkflow("CDNormalReimbursementsApplyOfWorkflow");
		}
		return instance;
	}
	...
	public CDNormalReimbursementsApplyOfWorkflow(String dataSourceID) {
