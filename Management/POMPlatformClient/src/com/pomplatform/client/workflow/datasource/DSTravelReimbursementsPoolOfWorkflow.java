...
public class DSTravelReimbursementsPoolOfWorkflow extends DBDataSource
{


	public static DSTravelReimbursementsPoolOfWorkflow instance = null;

	public static DSTravelReimbursementsPoolOfWorkflow getInstance() {
		if(instance == null) {
			instance = new DSTravelReimbursementsPoolOfWorkflow("DSTravelReimbursementsPoolOfWorkflow");
		}
		return instance;
	}
	...
	public DSTravelReimbursementsPoolOfWorkflow(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("TravelReimbursementsPoolOfWorkflow");
		...
		setFields(processPooledTaskIdField, processInstanceIdField, businessIdField, businessNameField, processActivityIdField, processIdField, backViewNameField, activityTypeField, nodeTypeField, activityIdField, instanceActivityCreateTimeField, instanceActivityStartTimeField, statusField, processTypeField, codeField, applicantField, departmentIdField, amountField, companyIdField, titleField, operateTimeField, processCommentField);
	}
