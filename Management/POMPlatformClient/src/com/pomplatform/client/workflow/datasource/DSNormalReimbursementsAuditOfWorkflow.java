...
public class DSNormalReimbursementsAuditOfWorkflow extends DBDataSource
{


	public static DSNormalReimbursementsAuditOfWorkflow instance = null;

	public static DSNormalReimbursementsAuditOfWorkflow getInstance() {
		if(instance == null) {
			instance = new DSNormalReimbursementsAuditOfWorkflow("DSNormalReimbursementsAuditOfWorkflow");
		}
		return instance;
	}
	...
	public DSNormalReimbursementsAuditOfWorkflow(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("NormalReimbursementsAuditOfWorkflow");
