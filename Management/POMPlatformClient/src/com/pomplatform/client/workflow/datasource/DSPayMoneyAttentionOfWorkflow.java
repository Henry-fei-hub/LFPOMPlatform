...
public class DSPayMoneyAttentionOfWorkflow extends DBDataSource
{


	public static DSPayMoneyAttentionOfWorkflow instance = null;

	public static DSPayMoneyAttentionOfWorkflow getInstance() {
		if(instance == null) {
			instance = new DSPayMoneyAttentionOfWorkflow("DSPayMoneyAttentionOfWorkflow");
		}
		return instance;
	}
	...
	public DSPayMoneyAttentionOfWorkflow(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("PayMoneyAttentionOfWorkflow");
