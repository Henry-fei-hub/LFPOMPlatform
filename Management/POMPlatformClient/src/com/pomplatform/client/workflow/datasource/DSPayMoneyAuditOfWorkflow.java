...
public class DSPayMoneyAuditOfWorkflow extends DBDataSource
{


	public static DSPayMoneyAuditOfWorkflow instance = null;

	public static DSPayMoneyAuditOfWorkflow getInstance() {
		if(instance == null) {
			instance = new DSPayMoneyAuditOfWorkflow("DSPayMoneyAuditOfWorkflow");
		}
		return instance;
	}
	...
	public DSPayMoneyAuditOfWorkflow(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("PayMoneyAuditOfWorkflow");
		...
		reasonField= new DataSourceTextField("reason", "申请理由");
		reasonField.setLength(512);
		reasonField.setRequired(false);
		reasonField.setHidden(false);

		setFields(processInstanceIdField, processInstanceActivityIdField, processTypeField, businessIdField, businessNameField, processActivityIdField, processIdField, nodeTypeField, activityIdField, nextActivityIdField, mainActivityIdField, instanceActivityCreateTimeField, instanceActivityStartTimeField, statusField, codeField, employeeIdField, departmentIdField, payAmountField, companyIdField, reasonField, titleField, operateTimeField, processCommentField,activityTypeField);
	}
