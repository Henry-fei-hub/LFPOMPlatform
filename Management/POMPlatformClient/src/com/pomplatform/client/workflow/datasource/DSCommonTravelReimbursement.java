...
public class DSCommonTravelReimbursement extends DBDataSource
{


	public static DSCommonTravelReimbursement instance = null;

	public static DSCommonTravelReimbursement getInstance() {
		if(instance == null) {
			instance = new DSCommonTravelReimbursement("DSProjectTravelReimbursement");
		}
		return instance;
	}
	...
	public DSCommonTravelReimbursement(String dataSourceID) {
		...
		setFields(travelReimbursementIdField, travelReimbursementNoField, processInstanceIdField, codeField, titleField, applicantField, drafterField, departmentIdField, companyIdField, projectIdField, reimbursementTimeField, startDateField, endDateField, amountField, strikeABalanceField, remarkField, applyTimeField, completeTimeField, attachmentField, attachmentNumberField, statusField, detailTravelReimbursementDetail);
	}
