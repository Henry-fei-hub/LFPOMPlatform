...
public class CDEmployeeMoneyApplyOfWorkflow extends DataSource
{


	public static CDEmployeeMoneyApplyOfWorkflow instance = null;

	public static CDEmployeeMoneyApplyOfWorkflow getInstance() {
		if(instance == null) {
			instance = new CDEmployeeMoneyApplyOfWorkflow("CDEmployeeMoneyApplyOfWorkflow");
		}
		return instance;
	}
	...
	public CDEmployeeMoneyApplyOfWorkflow(String dataSourceID) {
