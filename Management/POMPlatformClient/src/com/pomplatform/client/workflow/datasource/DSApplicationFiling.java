...
public class DSApplicationFiling extends DBDataSource
{


	public static DSApplicationFiling instance = null;

	public static DSApplicationFiling getInstance() {
		if(instance == null) {
			instance = new DSApplicationFiling("DSApplicationFiling");
		}
		return instance;
	}
	...
	public DSApplicationFiling(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("ApplicationFiling");
		...
		nextAuditorField = new DataSourceIntegerField("attachment", "调档人");
		nextAuditorField.setLength(255);
		...
		cardField = new DataSourceTextField("card", "调档人");
		...
		monthPayField = new DataSourceTextField("monthPay", "调档人");
