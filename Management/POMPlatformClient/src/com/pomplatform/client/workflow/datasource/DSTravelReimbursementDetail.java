...
public class DSTravelReimbursementDetail extends DBDataSource {
	...
	public DSTravelReimbursementDetail(String dataSourceID) {
		...
		travelReimbursementDetailIdField = new DataSourceIntegerField("travelReimbursementDetailId", "差旅报销明细ID");
		...
		travelReimbursementIdField = new DataSourceIntegerField("travelReimbursementId", "差旅主表ID");
		...
		setFields(travelReimbursementDetailIdField, travelReimbursementIdField, startDateField, endDateField,
				startAddressField, arrivingAddressField, travelDaysField, airfareField, carBoatFeeField,
				cityTransportationField, shippingFeeField, accommodationFeeField, drivingFeeField, travelAllowanceField,
				sumField, remarkField);
	}
