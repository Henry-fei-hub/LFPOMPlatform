...
public class CDAuditedEmployeeBorrowMoney extends DataSource
{


	public static CDAuditedEmployeeBorrowMoney instance = null;

	public static CDAuditedEmployeeBorrowMoney getInstance() {
		if(instance == null) {
			instance = new CDAuditedEmployeeBorrowMoney("CDAuditedEmployeeBorrowMoney");
		}
		return instance;
	}
	...
	public CDAuditedEmployeeBorrowMoney(String dataSourceID) {
