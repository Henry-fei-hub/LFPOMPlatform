...
public class TravelReimbursementLinkDepartmentViewer extends AbstractDetailViewer
{




	public TravelReimbursementLinkDepartmentViewer() {
	}
	...
	public void load() {
		...
		params.put("travelReimbursementLinkDepartmentId", getBusinessId());
		DBDataSource.callOperation("ST_TravelReimbursementLinkDepartment", "find", new DSCallback() {
			@Override
