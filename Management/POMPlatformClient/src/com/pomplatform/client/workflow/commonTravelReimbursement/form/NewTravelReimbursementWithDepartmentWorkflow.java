...
public class NewTravelReimbursementWithDepartmentWorkflow extends AbstractProcessPanel
{
private static final Logger logger = Logger.getLogger("");
	...
	public List<AbstractWizadPage> getPages(){
		...
		final TravelReimbursementWithDepartmentNewForm main = new TravelReimbursementWithDepartmentNewForm();
		...
		res.add(detail);
		final TravelReimbursementLinkDepartmentDetail link = new TravelReimbursementLinkDepartmentDetail(true, null);
