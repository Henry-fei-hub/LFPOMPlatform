...
public class DSTravelReimbursementWithDepartment extends DBDataSource
{


	public static DSTravelReimbursementWithDepartment instance = null;

	public static DSTravelReimbursementWithDepartment getInstance() {
		if(instance == null) {
			instance = new DSTravelReimbursementWithDepartment("DSTravelReimbursementWithDepartment");
		}
		return instance;
	}
	...
	private final DataSourceField detailTravelReimbursementLinkDepartment;
	...
	public DSTravelReimbursementWithDepartment(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("TravelReimbursementWithDepartment");
		...
		detailTravelReimbursementLinkDepartment = new DataSourceField("detailTravelReimbursementLinkDepartment", FieldType.ANY);
		detailTravelReimbursementLinkDepartment.setChildrenProperty(true);
		detailTravelReimbursementLinkDepartment.setChildTagName("TravelReimbursementLinkDepartment");
		detailTravelReimbursementLinkDepartment.setRequired(false);
		detailTravelReimbursementLinkDepartment.setHidden(true);

		setFields(travelReimbursementIdField, codeField, processInstanceIdField, titleField, applicantField, drafterField, departmentIdField, companyIdField, reimbursementTimeField, startDateField, endDateField, amountField, currencyField, exchangeRateField, strikeABalanceField, remarkField, applyTimeField, completeTimeField, attachmentNameField, attachmentField, attachmentIdField, attachmentNumberField, statusField, isProjectField, detailTravelReimbursementDetail, detailTravelReimbursementLinkDepartment,whiteStripField,relatedToContractField,contractAmountField,receiveUnitIdField,purchaserDepartmentField,purchaserField,purchasingCategoryField);
	}
