...
public class TravelReimbursementWithDepartmentUpdateForm extends AbstractWizadPage
{
	...
	public TravelReimbursementWithDepartmentUpdateForm() {
		...
		isProjectItem = new CheckboxItem("isProject", "是否跟项目有关");
