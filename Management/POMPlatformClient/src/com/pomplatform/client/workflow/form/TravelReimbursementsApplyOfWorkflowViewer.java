...
public class TravelReimbursementsApplyOfWorkflowViewer extends AbstractDetailViewer
{
	...
	public TravelReimbursementsApplyOfWorkflowViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_TravelReimbursementsApplyOfWorkflow", "find", new DSCallback() {
			@Override
