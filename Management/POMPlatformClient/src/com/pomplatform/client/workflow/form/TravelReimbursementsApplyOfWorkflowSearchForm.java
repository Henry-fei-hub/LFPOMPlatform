...
import com.pomplatform.client.workflow.datasource.CDTravelReimbursementsApplyOfWorkflow;
...
public class TravelReimbursementsApplyOfWorkflowSearchForm extends SearchForm
{
	...
	public TravelReimbursementsApplyOfWorkflowSearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDTravelReimbursementsApplyOfWorkflow.getInstance());
		...
		setItems(processTypeItem, employeeIdItem, companyIdItem, isProjectItem, departmentIdItem, codeItem);
