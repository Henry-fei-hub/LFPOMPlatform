...
public class PayMoneyManageOfWorkflowViewer extends AbstractDetailViewer {
	...
	public PayMoneyManageOfWorkflowViewer() {
	}
...
//		aFields[a].setValueMap(KeyValueManager.getValueMap("projects"));
	...
	public void viewDetailData() {
		...
		condition.put("businessId", selected.getAttributeAsString("payMoneyManageId"));
