...
public class UpdateCommonTravelReimbursementWorkflow extends AbstractProcessPanel
{
	...
	public List<AbstractWizadPage> getPages(){
		...
		final CommonTravelReimbursementUpdateForm main = new CommonTravelReimbursementUpdateForm();
