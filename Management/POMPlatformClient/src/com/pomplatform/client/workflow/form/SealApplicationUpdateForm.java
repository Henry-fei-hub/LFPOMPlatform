...
public class SealApplicationUpdateForm extends AbstractWizadPage
{
...
//	private final TextItem attachmentNameItem;
	...
	public SealApplicationUpdateForm() {
...
//		__formItems.add(remarkItem);
		...
		salary1Item = new PickTreeItem("salary1",   "请选择印章种类");
...
//		addressItem.setValueField("treeId");
		...
		salary2Item = new TextItem("salary2", "盖章内容");
		salary2Item.setWidth("*");
		salary2Item.setTextBoxStyle("customInputTextStyle");
...
//		__formItems.add(feeItem);
		unitItem = new TextItem("unit", "盖章内容扫描件");
		unitItem.setWidth("*");
		unitItem.setCanEdit(false);
...
//		__formItems.add(deleteFlagItem);
		nextAuditorItem = new TextItem("nextAuditor", "盖章类型");
		nextAuditorItem.setWidth("*");
		nextAuditorItem.setTextBoxStyle("customInputTextStyle");
...
//		__formItems.add(projectTypeItem);
		projectIdItem = new TextItem("projectId", "盖章项目");
...
//		__formItems.add(drafterItem);
		cardItem = new TextItem("card", "盖章内容");
		cardItem.setWidth("*");
