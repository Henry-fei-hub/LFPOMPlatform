...
public class OrderPlacementUpdateForm extends AbstractWizadPage {
    ...
    public OrderPlacementUpdateForm() {
        DSOrderPlacement ds = DSOrderPlacement.getInstance();
        __form.setWidth100();
        __form.setHeight100();
        orderInfoIdItem = new TextItem("orderInfoId", "订单信息编码");
        orderInfoIdItem.setDisabled(true);
        orderInfoIdItem.setRequired(true);
        IsIntegerValidator orderInfoIdValidator = new IsIntegerValidator();
        orderInfoIdItem.setValidators(orderInfoIdValidator);
        __formItems.add(orderInfoIdItem);
        ...
        flowStatusItem = new TextItem("flowStatus", "流转状态");
