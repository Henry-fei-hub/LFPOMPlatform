...
public class NewSealApplicationWorkflow extends AbstractProcessPanel
{
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_SealApplication", "find", new DSCallback() {
			@Override
	...
	public List<AbstractWizadPage> getPages(){
		...
		res.add(new SealApplicationNewForm());
		return res;
	}
