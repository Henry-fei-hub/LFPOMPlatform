...
import com.pomplatform.client.workflow.datasource.CDAuditedPayMoney;
...
public class AuditedPayMoneySearchForm extends SearchForm
{
	...
	public AuditedPayMoneySearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDAuditedPayMoney.getInstance());
