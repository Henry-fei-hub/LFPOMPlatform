...
public class OnLoadAuditListOfApproveProjectStageStroageViewer extends AbstractDetailViewer
{
	...
	public OnLoadAuditListOfApproveProjectStageStroageViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadAuditListOfApproveProjectStageStroage", "find", new DSCallback() {
			@Override
