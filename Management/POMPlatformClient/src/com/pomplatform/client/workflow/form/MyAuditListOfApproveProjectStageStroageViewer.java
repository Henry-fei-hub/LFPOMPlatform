...
public class MyAuditListOfApproveProjectStageStroageViewer extends AbstractDetailViewer
{
	...
	public MyAuditListOfApproveProjectStageStroageViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_MyAuditListOfApproveProjectStageStroage", "find", new DSCallback() {
			@Override
