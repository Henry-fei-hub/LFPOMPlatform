...
import com.pomplatform.client.workflow.datasource.CDEmployeeMoneyPoolOfWorkflow;
...
public class EmployeeMoneyPoolOfWorkflowSearchForm extends SearchForm
{
	...
	public EmployeeMoneyPoolOfWorkflowSearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDEmployeeMoneyPoolOfWorkflow.getInstance());
