...
public class UpdateCommonNormalReimbursementOfWorkflowWorkflow extends AbstractProcessPanel
{
	...
	public List<AbstractWizadPage> getPages(){
		...
		final CommonNormalReimbursementOfWorkflowUpdateForm main = new CommonNormalReimbursementOfWorkflowUpdateForm();
