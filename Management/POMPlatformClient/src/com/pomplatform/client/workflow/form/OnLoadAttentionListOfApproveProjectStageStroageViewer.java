...
public class OnLoadAttentionListOfApproveProjectStageStroageViewer extends AbstractDetailViewer
{
	...
	public OnLoadAttentionListOfApproveProjectStageStroageViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadAttentionListOfApproveProjectStageStroage", "find", new DSCallback() {
			@Override
