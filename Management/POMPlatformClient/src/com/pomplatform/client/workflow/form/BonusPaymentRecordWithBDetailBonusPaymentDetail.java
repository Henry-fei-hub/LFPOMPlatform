...
public class BonusPaymentRecordWithBDetailBonusPaymentDetail extends AbstractWizadPage
{
	...
	private BonusPaymentRecordWithBNewForm bonusPaymentRecordWithBNewForm =null;
	private Date payDate = new Date();
	
	public BonusPaymentRecordWithBDetailBonusPaymentDetail(){
...
//		});
		grid.addEditCompleteHandler(new EditCompleteHandler() {
			...
			public void onEditComplete(EditCompleteEvent event) {
				...
				SelectItem plateIdItem = bonusPaymentRecordWithBNewForm.getPlateIdItem();
				DateItem payDateItem = bonusPaymentRecordWithBNewForm.getPayDateItem();
				TextItem payIntegralItem = bonusPaymentRecordWithBNewForm.getPayIntegralItem();
...
//		bonusPaymentDetailsControls.addMember(totalButton);
	...
	public BonusPaymentRecordWithBNewForm getBonusPaymentRecordWithBNewForm() {
		return bonusPaymentRecordWithBNewForm;
	}

	public void setBonusPaymentRecordWithBNewForm(BonusPaymentRecordWithBNewForm bonusPaymentRecordWithBNewForm) {
		this.bonusPaymentRecordWithBNewForm = bonusPaymentRecordWithBNewForm;
	}
	...
	public void load() {
		...
		if (null != payDate && null == payDateItem.getValue()) {
			payDateItem.setDefaultValue(payDate);
		}
