...
public class UpdateActivityEmployeeViewer extends AbstractDetailViewer
{
	...
	public UpdateActivityEmployeeViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_UpdateActivityEmployee", "find", new DSCallback() {
			@Override
	...
	public DataSource getMainDataSource() {
		return DSUpdateActivityEmployee.getInstance();
	}
