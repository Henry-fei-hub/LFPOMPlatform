...
public class OnLoadApplyListOfApproveProjectStageStroageViewer extends AbstractDetailViewer
{
	...
	public OnLoadApplyListOfApproveProjectStageStroageViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadApplyListOfApproveProjectStageStroage", "find", new DSCallback() {
			@Override
