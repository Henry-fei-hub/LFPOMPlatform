...
public class ApplicationFilingViewer extends AbstractDetailViewer
{
	...
	public ApplicationFilingViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ApplicationFiling", "find", new DSCallback() {
			@Override
