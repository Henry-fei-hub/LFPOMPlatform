...
public class EmployeeContractViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_EmployeeContract", "find", new DSCallback() {
			@Override
