...
public class EmployeeBorrowMoneyByWorkflowUpdateForm extends AbstractWizadPage
{

	private final Logger __logger = Logger.getLogger("");
	private final TextItem employeeMoneyManageIdItem;
	...
	public EmployeeBorrowMoneyByWorkflowUpdateForm() {
...
//		__form.setGroupLabelStyleName("groupTitleStyle");
		...
		employeeMoneyManageIdItem = new TextItem("employeeMoneyManageId", "主键编码");
		employeeMoneyManageIdItem.setDisabled(true);
		employeeMoneyManageIdItem.setRequired(true);
		employeeMoneyManageIdItem.hide();
		IsIntegerValidator employeeMoneyManageIdValidator = new IsIntegerValidator();
		employeeMoneyManageIdItem.setValidators(employeeMoneyManageIdValidator);
		__formItems.add(employeeMoneyManageIdItem);
		...
		borrowMoneyItem.setDefaultValue(0);
...
//					setCanBorrowMoney(canBorrowMoneyValue);
	...
	public void startEdit() {
		...
		if(!BaseHelpUtils.isNullOrEmpty(attachmentItem.getValue())) {
			attachmentItem.setLinkTitle("文件预览");
		}
