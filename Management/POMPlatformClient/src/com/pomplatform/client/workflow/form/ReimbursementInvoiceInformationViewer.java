...
public class ReimbursementInvoiceInformationViewer extends AbstractDetailViewer
{




	public ReimbursementInvoiceInformationViewer() {
	}
	...
	public void load() {
		...
		params.put("reimbursementInvoiceInformationId", getBusinessId());
		DBDataSource.callOperation("ST_ReimbursementInvoiceInformation", "find", new DSCallback() {
			@Override
