...
import com.pomplatform.client.workflow.datasource.CDOnLoadApproveContractRunDry;

public class OnLoadApproveContractRunDrySearchForm extends SearchForm
{
...
//	private final TextItem contractIdItem;
	...
	public OnLoadApproveContractRunDrySearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDOnLoadApproveContractRunDry.getInstance());
