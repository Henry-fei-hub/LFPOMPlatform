...
public class TravelReimbursementsAttentionOfWorkflowViewer extends AbstractDetailViewer
{
	...
	public TravelReimbursementsAttentionOfWorkflowViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_TravelReimbursementsAttentionOfWorkflow", "find", new DSCallback() {
			@Override
