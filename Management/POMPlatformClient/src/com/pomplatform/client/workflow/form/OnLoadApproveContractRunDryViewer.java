...
public class OnLoadApproveContractRunDryViewer extends AbstractDetailViewer
{
	...
	public OnLoadApproveContractRunDryViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadApproveContractRunDry", "find", new DSCallback() {
			@Override
