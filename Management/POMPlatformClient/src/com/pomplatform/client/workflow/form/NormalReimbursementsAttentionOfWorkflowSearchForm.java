...
import com.pomplatform.client.workflow.datasource.CDNormalReimbursementsAttentionOfWorkflow;
...
public class NormalReimbursementsAttentionOfWorkflowSearchForm extends SearchForm
{
	...
	public NormalReimbursementsAttentionOfWorkflowSearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDNormalReimbursementsAttentionOfWorkflow.getInstance());
