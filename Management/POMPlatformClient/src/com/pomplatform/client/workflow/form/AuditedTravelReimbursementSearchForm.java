...
import com.pomplatform.client.workflow.datasource.CDAuditedTravelReimbursement;
...
public class AuditedTravelReimbursementSearchForm extends SearchForm
{
	...
	public AuditedTravelReimbursementSearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDAuditedTravelReimbursement.getInstance());
