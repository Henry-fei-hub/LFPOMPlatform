...
import com.pomplatform.client.workflow.datasource.CDPayMoneyAttentionOfWorkflow;
...
public class PayMoneyAttentionOfWorkflowSearchForm extends SearchForm
{
	...
	public PayMoneyAttentionOfWorkflowSearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDPayMoneyAttentionOfWorkflow.getInstance());
