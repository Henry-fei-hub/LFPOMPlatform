...
public class UpdateProjectNormalReimbursementOfWorkflowWorkflow extends AbstractProcessPanel
{
	...
	public List<AbstractWizadPage> getPages(){
		...
		final ProjectNormalReimbursementOfWorkflowUpdateForm main = new ProjectNormalReimbursementOfWorkflowUpdateForm();
