...
public class NewCommonTravelReimbursementWorkflow extends AbstractProcessPanel {
	...
	public List<AbstractWizadPage> getPages() {
		...
		final CommonTravelReimbursementNewForm main = new CommonTravelReimbursementNewForm();
