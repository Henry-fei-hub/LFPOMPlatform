...
public class OnLoadPersonnelFlowDetailViewer extends AbstractDetailViewer
{
	...
	public OnLoadPersonnelFlowDetailViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadPersonnelFlowDetail", "find", new DSCallback() {
			@Override
