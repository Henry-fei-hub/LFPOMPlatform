...
public class ReimbursementInvoiceInformationUpdateForm extends AbstractWizadPage
{


	private final TextItem reimbursementInvoiceInformationIdItem;
	...
	public ReimbursementInvoiceInformationUpdateForm() {
		DSReimbursementInvoiceInformation ds = DSReimbursementInvoiceInformation.getInstance();
		__form.setWidth100();
		__form.setHeight100();
		reimbursementInvoiceInformationIdItem = new TextItem("reimbursementInvoiceInformationId", "主键");
		reimbursementInvoiceInformationIdItem.setDisabled(true);
		reimbursementInvoiceInformationIdItem.setRequired(true);
		IsIntegerValidator reimbursementInvoiceInformationIdValidator = new IsIntegerValidator();
		reimbursementInvoiceInformationIdItem.setValidators(reimbursementInvoiceInformationIdValidator);
		__formItems.add(reimbursementInvoiceInformationIdItem);
