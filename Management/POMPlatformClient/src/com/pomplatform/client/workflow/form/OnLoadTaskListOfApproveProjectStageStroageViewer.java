...
public class OnLoadTaskListOfApproveProjectStageStroageViewer extends AbstractDetailViewer
{
	...
	public OnLoadTaskListOfApproveProjectStageStroageViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadTaskListOfApproveProjectStageStroage", "find", new DSCallback() {
			@Override
