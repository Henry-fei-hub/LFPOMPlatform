...
public class EmployeeMoneyApplyOfWorkflowViewer extends AbstractDetailViewer
{
	...
	public EmployeeMoneyApplyOfWorkflowViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_EmployeeMoneyApplyOfWorkflow", "find", new DSCallback() {
			@Override
