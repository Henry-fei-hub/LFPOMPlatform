...
public class PayMoneyApplyOfWorkflowViewer extends AbstractDetailViewer
{
	...
	public PayMoneyApplyOfWorkflowViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_PayMoneyApplyOfWorkflow", "find", new DSCallback() {
			@Override
