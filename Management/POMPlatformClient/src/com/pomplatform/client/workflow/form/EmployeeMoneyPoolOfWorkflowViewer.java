...
public class EmployeeMoneyPoolOfWorkflowViewer extends AbstractDetailViewer
{
	...
	public EmployeeMoneyPoolOfWorkflowViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_EmployeeMoneyPoolOfWorkflow", "find", new DSCallback() {
			@Override
