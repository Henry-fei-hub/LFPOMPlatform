...
public class ProjectEmployeeProcessApplicationViewer extends AbstractDetailViewer
{
	...
	public ProjectEmployeeProcessApplicationViewer() {
	}

	@Override
	public void initComponents() {
		super.initComponents();
		projectEmployeesGrid.setDataSource(DSOnLoadProjectEmpByProcess.getInstance());
//		projectEmployeesGrid.addDoubleClickHandler(new DoubleClickHandler(){
//			@Override
//			public void onDoubleClick(DoubleClickEvent event) {
//				GenericViewWindow detail = new GenericViewWindow();
//				detail.setTitle("项目成员");
//				detail.setWidth(700); detail.setHeight(500); 
//				ProjectEmployeeViewer viewer = new ProjectEmployeeViewer();
