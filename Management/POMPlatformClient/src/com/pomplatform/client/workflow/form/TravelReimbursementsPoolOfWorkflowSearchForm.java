...
import com.pomplatform.client.workflow.datasource.CDTravelReimbursementsPoolOfWorkflow;
...
public class TravelReimbursementsPoolOfWorkflowSearchForm extends SearchForm
{
	...
	public TravelReimbursementsPoolOfWorkflowSearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDTravelReimbursementsPoolOfWorkflow.getInstance());
