...
public class UpdateProjectTravelReimbursementWorkflow extends AbstractProcessPanel
{
	...
	public List<AbstractWizadPage> getPages(){
		...
		final ProjectTravelReimbursementUpdateForm main = new ProjectTravelReimbursementUpdateForm();
