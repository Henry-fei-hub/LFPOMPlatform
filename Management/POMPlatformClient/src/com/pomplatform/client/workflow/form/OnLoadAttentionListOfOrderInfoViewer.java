...
public class OnLoadAttentionListOfOrderInfoViewer extends AbstractDetailViewer
{
	...
	public OnLoadAttentionListOfOrderInfoViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadAttentionListOfOrderInfo", "find", new DSCallback() {
			@Override
