...
public class OnLoadApplyListOfOrderInfoViewer extends AbstractDetailViewer
{
	...
	public OnLoadApplyListOfOrderInfoViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadApplyListOfOrderInfo", "find", new DSCallback() {
			@Override
