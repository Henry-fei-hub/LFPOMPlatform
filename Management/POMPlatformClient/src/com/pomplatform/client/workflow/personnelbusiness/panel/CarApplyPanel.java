...
import com.pomplatform.client.workflow.personnelbusiness.form.CarApplySearchForm;
import com.pomplatform.client.workflow.personnelbusiness.form.CarApplyViewer;
import com.pomplatform.client.workflow.personnelbusiness.form.NewCarApplyForm;
import com.pomplatform.client.workflow.personnelbusiness.form.UpdateCarApplyForm;
...
public class CarApplyPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			CarApplyPanel cm = new CarApplyPanel();
			id = cm.getID();
			return cm;
		}
	...
	public void initComponents() {
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						NewCarApplyForm detailForm = new NewCarApplyForm();
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateCarApplyForm detailForm = new UpdateCarApplyForm();
		...
		removeButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				DBDataSource.callOperation("ST_CarApply", "delete", selected.toMap(), new DSCallback() {
					@Override
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("用车申请"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				CarApplyViewer detailForm = new CarApplyViewer();
