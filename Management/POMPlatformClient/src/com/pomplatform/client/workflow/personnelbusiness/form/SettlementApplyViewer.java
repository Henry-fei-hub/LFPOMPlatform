...
public class SettlementApplyViewer extends AbstractDetailViewer
{

	private VLayout mainLayout;
	private SettlementApplyUpdateForm form;

	private static final Logger logger = Logger.getLogger("");

	public SettlementApplyViewer() {
	}
	...
	public void initComponents() {
		...
		form = new SettlementApplyUpdateForm();
		form.setWidth100();
		form.setHeight100();
	...
	public void viewRecord(Record r, boolean includeDetail) {
		...
		if(r.toMap().toString().length() > 2){
			form.setRecord(r);
			form.startEdit();
			FormItem[] items = form.getForm().getFields();
	...
	public DataSource getMainDataSource() {
		return DSSettlementApply.getInstance();
	}
