...
public class GoodsApplyViewer extends AbstractDetailViewer
{


	private final DelicacyListGrid personnelBusinessLinkEquipmentsGrid = new DelicacyListGrid();
	private SearchForm __parentSearchForm;


	public GoodsApplyViewer() {
	}

	@Override
	public void initComponents() {
		super.initComponents();
		personnelBusinessLinkEquipmentsGrid.setDataSource(DSPersonnelBusinessLinkEquipment.getInstance());
		...
		personnelBusinessLinkEquipmentsGrid.setFields(fields);
		personnelBusinessLinkEquipmentsGrid.addDoubleClickHandler(new DoubleClickHandler(){
			@Override
			public void onDoubleClick(DoubleClickEvent event) {
				GenericViewWindow detail = new GenericViewWindow();
				detail.setTitle("");
				detail.setWidth(700); detail.setHeight(500); 
				PersonnelBusinessLinkEquipmentViewer viewer = new PersonnelBusinessLinkEquipmentViewer();
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_GoodsApply", "find", new DSCallback() {
			@Override
	...
	public void viewDetailData(){
		...
		condition.put("parentId", selected.getAttributeAsString("personnelBusinessId"));
		condition.put("processType", selected.getAttributeAsString("processType"));
		DBDataSource.callOperation("ST_PersonnelBusinessLinkEquipment", "find", condition, new DSCallback(){
			@Override
			public void execute(DSResponse dsResponse, Object data, DSRequest dsRequest) {
				if(dsResponse.getStatus() >= 0){
					personnelBusinessLinkEquipmentsGrid.setData(dsResponse.getData());
				}
			}
		});
	}
	...
	public DataSource getMainDataSource() {
		return DSGoodsApply.getInstance();
	}
	...
	public List<ListGrid> getDetailListGrids() {
		...
		personnelBusinessLinkEquipmentsGrid.setAutoFitFieldWidths(false);
		res.add(personnelBusinessLinkEquipmentsGrid);
		return res;
	}
