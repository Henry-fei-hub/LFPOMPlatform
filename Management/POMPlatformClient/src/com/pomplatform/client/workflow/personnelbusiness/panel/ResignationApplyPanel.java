...
import com.pomplatform.client.workflow.personnelbusiness.form.ResignationApplySearchForm;
import com.pomplatform.client.workflow.personnelbusiness.form.ResignationApplyViewer;
import com.pomplatform.client.workflow.personnelbusiness.form.NewResignationApplyForm;
import com.pomplatform.client.workflow.personnelbusiness.form.UpdateResignationApplyForm;
...
public class ResignationApplyPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			ResignationApplyPanel cm = new ResignationApplyPanel();
			id = cm.getID();
			return cm;
		}
	...
	public void initComponents() {
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						NewResignationApplyForm detailForm = new NewResignationApplyForm();
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateResignationApplyForm detailForm = new UpdateResignationApplyForm();
		...
		removeButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				DBDataSource.callOperation("ST_ResignationApply", "delete", selected.toMap(), new DSCallback() {
					@Override
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("离职申请"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				ResignationApplyViewer detailForm = new ResignationApplyViewer("");
	...
	public SearchForm generateSearchForm() {
		return new ResignationApplySearchForm();
	}
