...
import com.pomplatform.client.workflow.personnelbusiness.form.ReturnOfItemsSearchForm;
import com.pomplatform.client.workflow.personnelbusiness.form.ReturnOfItemsViewer;
import com.pomplatform.client.workflow.personnelbusiness.form.UpdateReturnOfItemsForm;
import com.pomplatform.client.workflow.personnelbusiness.form.NewReturnOfItemsForm;
...
public class ReturnOfItemsPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			ReturnOfItemsPanel cm = new ReturnOfItemsPanel();
			id = cm.getID();
			return cm;
		}
	...
	public void initComponents() {
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateReturnOfItemsForm detailForm = new UpdateReturnOfItemsForm();
		...
		operation3Button.addClickHandler(new ClickHandler(){
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					@Override
					public void onSuccess() {
						NewReturnOfItemsForm detailForm = new NewReturnOfItemsForm();
		...
		removeButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				DBDataSource.callOperation("ST_ReturnOfItems", "delete", selected.toMap(), new DSCallback() {
					@Override
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("ReturnOfItems"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				ReturnOfItemsViewer detailForm = new ReturnOfItemsViewer();
	...
	public SearchForm generateSearchForm() {
		return new ReturnOfItemsSearchForm();
	}
