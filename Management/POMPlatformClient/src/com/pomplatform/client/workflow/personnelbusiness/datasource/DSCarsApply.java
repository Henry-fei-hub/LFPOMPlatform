...
public class DSCarsApply extends DBDataSource
{


	public static DSCarsApply instance = null;

	public static DSCarsApply getInstance() {
		if(instance == null) {
			instance = new DSCarsApply("DSCarsApply");
		}
		return instance;
	}
	...
	public DSCarsApply(String dataSourceID) {
