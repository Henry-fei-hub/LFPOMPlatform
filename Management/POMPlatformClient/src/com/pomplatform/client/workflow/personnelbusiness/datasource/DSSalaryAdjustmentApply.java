...
public class DSSalaryAdjustmentApply extends DBDataSource
{


	public static DSSalaryAdjustmentApply instance = null;

	public static DSSalaryAdjustmentApply getInstance() {
		if(instance == null) {
			instance = new DSSalaryAdjustmentApply("DSSalaryAdjustmentApply");
		}
		return instance;
	}
	...
	private final DataSourceIntegerField paymentChangeTypeField;
	...
	public DSSalaryAdjustmentApply(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("RegularEmployeeApply");
...
//		parentIdField.setValueMap(KeyValueManager.getValueMap("contracts_1"));
		...
		basicProportionStrField.setLength(255);
