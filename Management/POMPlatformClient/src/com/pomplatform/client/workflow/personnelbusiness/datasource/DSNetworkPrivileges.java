...
public class DSNetworkPrivileges extends DBDataSource
{


	public static DSNetworkPrivileges instance = null;

	public static DSNetworkPrivileges getInstance() {
		if(instance == null) {
			instance = new DSNetworkPrivileges("DSNetworkPrivileges");
		}
		return instance;
	}
	...
	public DSNetworkPrivileges(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("NetworkPrivileges");
