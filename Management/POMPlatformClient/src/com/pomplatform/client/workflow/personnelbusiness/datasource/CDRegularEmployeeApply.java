...
public class CDRegularEmployeeApply extends DataSource
{


	public static CDRegularEmployeeApply instance = null;

	public static CDRegularEmployeeApply getInstance() {
		if(instance == null) {
			instance = new CDRegularEmployeeApply("CDRegularEmployeeApply");
		}
		return instance;
	}
	...
	public CDRegularEmployeeApply(String dataSourceID) {
