...
public class DSResignationApply extends DBDataSource
{


	public static DSResignationApply instance = null;

	public static DSResignationApply getInstance() {
		if(instance == null) {
			instance = new DSResignationApply("DSResignationApply");
		}
		return instance;
	}
	...
	public DSResignationApply(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("ResignationApply");
		...
		employeeIdField = new DataSourceIntegerField("employeeId", "辞职员工姓名");
		...
		employeeNoField = new DataSourceTextField("employeeNo", "辞职员工工号");
		employeeNoField.setLength(32);
		employeeNoField.setRequired(false);
		employeeNoField.setHidden(false);


		departmentIdField = new DataSourceIntegerField("departmentId", "辞职员工部门");
		...
		companyIdField = new DataSourceIntegerField("companyId", "辞职员工归属公司");
		...
		typeField = new DataSourceIntegerField("type", "辞职类型");
		...
		endDateField = new DataSourceDateTimeField("endDate", "辞职日期");
