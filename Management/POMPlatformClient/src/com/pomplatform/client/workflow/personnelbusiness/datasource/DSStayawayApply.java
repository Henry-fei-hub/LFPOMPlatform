...
public class DSStayawayApply extends DBDataSource
{


	public static DSStayawayApply instance = null;

	public static DSStayawayApply getInstance() {
		if(instance == null) {
			instance = new DSStayawayApply("DSStayawayApply");
		}
		return instance;
	}
	...
	public DSStayawayApply(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("StayawayApply");
		...
		startDateField = new DataSourceDateField("startDate", "外出日期");
		startDateField.setRequired(false);
		startDateField.setHidden(false);


		startDateDetailField = new DataSourceIntegerField("startDateDetail", "外出时段");
		...
		endDateField = new DataSourceDateField("endDate", "预期返回日期");
		endDateField.setRequired(false);
		endDateField.setHidden(false);


		endDateDetailField = new DataSourceIntegerField("endDateDetail", "预期返回时段");
		...
		daysField = new DataSourceFloatField("days", "外出小时数");
		...
		addressField = new DataSourceTextField("address", "外访地址");
		...
		contactPersonField = new DataSourceTextField("contactPerson", "外访联系人");
		...
		setFields(personnelBusinessIdField, processTypeField, employeeIdField, employeeNoField, departmentIdField, companyIdField, typeField, startDateField, startDateDetailField, endDateField, endDateDetailField, daysField, projectCodeField, projectNameField, unitField, contactPersonField, addressField, reasonField, remarkField, planField, transportationField, feeField, createTimeField, deleteFlagField, projectIdField, drafterField, nextAuditorField, numberOfBabyField);
	}
