...
import com.pomplatform.client.workflow.personnelbusiness.form.LeaveApplyViewer;
import com.pomplatform.client.workflow.personnelbusiness.form.NewLeaveApplyForm;
import com.pomplatform.client.workflow.personnelbusiness.form.UpdateLeaveApplyForm;
...
public class LeaveApplyPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			LeaveApplyPanel cm = new LeaveApplyPanel();
			id = cm.getID();
			return cm;
		}
	...
	public void initComponents() {
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						NewLeaveApplyForm detailForm = new NewLeaveApplyForm();
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateLeaveApplyForm detailForm = new UpdateLeaveApplyForm();
		...
		removeButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				DBDataSource.callOperation("ST_LeaveApply", "delete", selected.toMap(), new DSCallback() {
					@Override
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("请假申请"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				LeaveApplyViewer detailForm = new LeaveApplyViewer();
