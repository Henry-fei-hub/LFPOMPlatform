...
public class DelayUpdateBusinessTripApplyWorkflow extends AbstractProcessPanel {
	...
	public List<AbstractWizadPage> getPages() {
		...
		DelayBusinessTripApplyUpdateForm mainForm = new DelayBusinessTripApplyUpdateForm(getProcessType());
		res.add(mainForm);
		return res;
	}
