...
public class DelayBusinessTripApplyNewForm extends AbstractWizadPage {
	...
	public DelayBusinessTripApplyNewForm(int processType) {
		this.processType = processType;
		isChangeAdress = processType == 20 ? true : false;
		...
		reasonItem = new TextAreaItem("reason", shouldNotBeNull + titleText + "申请缘由");
			...
			public void execute(DSResponse dsResponse, Object data, DSRequest dsRequest) {
				if (dsResponse.getStatus() > 0) {
					...
					if(!isChangeAdress){
						...
						startDateDetailItem.setValue(parentData.getAttribute("endDateDetail"));
					}
				}
