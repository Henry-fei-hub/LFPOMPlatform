...
public class NetworkPrivilegesViewer extends AbstractDetailViewer
{

	private VLayout mainLayout;
	private NetworkPrivilegesUpdateForm form;
	private SearchForm __parentSearchForm;


	public NetworkPrivilegesViewer() {
	}
	...
	public void initComponents() {
		...
		form = new NetworkPrivilegesUpdateForm();
		form.setWidth100();
		form.setHeight100();
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_NetworkPrivileges", "find", new DSCallback() {
			@Override
	...
	public DataSource getMainDataSource() {
		return DSNetworkPrivileges.getInstance();
	}
