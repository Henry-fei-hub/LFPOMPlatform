...
public class DSDelaySpersonnelbusinesppor extends DBDataSource {

	public static DSDelaySpersonnelbusinesppor instance = null;

	public static DSDelaySpersonnelbusinesppor getInstance() {
		if (instance == null) {
			instance = new DSDelaySpersonnelbusinesppor("DSSpersonnelbusinesppor");
		}
		return instance;
	}
	...
	public DSDelaySpersonnelbusinesppor(String dataSourceID) {
		...
		processTypeField = new DataSourceIntegerField("processType", "申请类型 ");
		...
		startDateField = new DataSourceDateTimeField("startDate", "驻场开始日期");
		...
		daysField = new DataSourceFloatField("days", "调休天数");
		...
		hoursField = new DataSourceFloatField("hours", "调休小时");
