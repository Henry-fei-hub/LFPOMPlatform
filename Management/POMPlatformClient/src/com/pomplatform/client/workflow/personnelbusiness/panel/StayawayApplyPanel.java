...
import com.pomplatform.client.workflow.personnelbusiness.form.StayawayApplyViewer;
import com.pomplatform.client.workflow.personnelbusiness.form.UpdateStayawayApplyForm;
import com.pomplatform.client.workflow.personnelbusiness.form.NewStayawayApplyForm;
...
public class StayawayApplyPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			StayawayApplyPanel cm = new StayawayApplyPanel();
			id = cm.getID();
			return cm;
		}
	...
	public void initComponents() {
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateStayawayApplyForm detailForm = new UpdateStayawayApplyForm();
		...
		operation3Button.addClickHandler(new ClickHandler(){
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					@Override
					public void onSuccess() {
						NewStayawayApplyForm detailForm = new NewStayawayApplyForm();
		...
		removeButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				DBDataSource.callOperation("ST_StayawayApply", "delete", selected.toMap(), new DSCallback() {
					@Override
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("外出申请"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				StayawayApplyViewer detailForm = new StayawayApplyViewer();
	...
	public DataSource getDataSource() {
		return DSStayawayApply.getInstance();
	}
