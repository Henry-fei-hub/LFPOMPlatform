...
public class SalaryAdjustmentApplyViewer extends AbstractDetailViewer
{

	private VLayout mainLayout;
	private SalaryAdjustmentApplyUpdateForm form;
	private SearchForm __parentSearchForm;
	private String processName;


	public SalaryAdjustmentApplyViewer() {
	}
	...
	public void initComponents() {
		...
		form = new SalaryAdjustmentApplyUpdateForm();
		form.setWidth100();
		form.setHeight100();
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_SalaryAdjustmentApply", "find", new DSCallback() {
			@Override
	...
	public DataSource getMainDataSource() {
		return DSSalaryAdjustmentApply.getInstance();
	}
