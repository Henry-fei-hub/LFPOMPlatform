...
public class DSOutputDrawing extends DBDataSource
{


	public static DSOutputDrawing instance = null;

	public static DSOutputDrawing getInstance() {
		if(instance == null) {
			instance = new DSOutputDrawing("DSOutputDrawing");
		}
		return instance;
	}
	...
	public DSOutputDrawing(String dataSourceID) {
