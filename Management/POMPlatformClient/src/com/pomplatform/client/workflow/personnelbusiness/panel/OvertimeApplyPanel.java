...
import com.pomplatform.client.workflow.personnelbusiness.form.OvertimeApplyViewer;
import com.pomplatform.client.workflow.personnelbusiness.form.UpdateOvertimeApplyForm;
import com.pomplatform.client.workflow.personnelbusiness.form.NewOvertimeApplyForm;
...
public class OvertimeApplyPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			OvertimeApplyPanel cm = new OvertimeApplyPanel();
			id = cm.getID();
			return cm;
		}
	...
	public void initComponents() {
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateOvertimeApplyForm detailForm = new UpdateOvertimeApplyForm();
		...
		operation3Button.addClickHandler(new ClickHandler(){
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					@Override
					public void onSuccess() {
						NewOvertimeApplyForm detailForm = new NewOvertimeApplyForm();
		...
		removeButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				DBDataSource.callOperation("ST_OvertimeApply", "delete", selected.toMap(), new DSCallback() {
					@Override
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("加班申请"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				OvertimeApplyViewer detailForm = new OvertimeApplyViewer();
