...
public class DSReturnOfItems extends DBDataSource
{


	public static DSReturnOfItems instance = null;

	public static DSReturnOfItems getInstance() {
		if(instance == null) {
			instance = new DSReturnOfItems("DSReturnOfItems");
		}
		return instance;
	}
	...
	public DSReturnOfItems(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("ReturnOfItems");
