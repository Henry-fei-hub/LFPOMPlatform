...
public class CarsApplyViewer extends AbstractDetailViewer
{

	private VLayout mainLayout;
	private CarsApplyUpdateForm form;
	private SearchForm __parentSearchForm;


	public CarsApplyViewer() {
	}
	...
	public DataSource getMainDataSource() {
		return DSCarsApply.getInstance();
	}
