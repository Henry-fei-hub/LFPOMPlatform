...
public class OnLoadAttentionListOfSalaryAdjustmentViewer extends AbstractDetailViewer
{
	...
	public OnLoadAttentionListOfSalaryAdjustmentViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadAttentionListOfSalaryAdjustment", "find", new DSCallback() {
			@Override
