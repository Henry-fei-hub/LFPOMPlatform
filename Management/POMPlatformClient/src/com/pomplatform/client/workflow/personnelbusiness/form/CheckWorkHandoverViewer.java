...
public class CheckWorkHandoverViewer extends AbstractDetailViewer
{
	...
	public CheckWorkHandoverViewer() {
	}
	...
	public void load() {
		...
		params.put("workHandoverId", getBusinessId());
		DBDataSource.callOperation("NQ_CheckWorkHandover", "find", new DSCallback() {
			@Override
