...
public class CDPlateSalaryAdjustment extends DataSource
{


	public static CDPlateSalaryAdjustment instance = null;

	public static CDPlateSalaryAdjustment getInstance() {
		if(instance == null) {
			instance = new CDPlateSalaryAdjustment("CDPlateSalaryAdjustment");
		}
		return instance;
	}
	...
	public CDPlateSalaryAdjustment(String dataSourceID) {
