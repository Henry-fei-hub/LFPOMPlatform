...
public class SpersonnelbusinespporUpdateForm extends AbstractWizadPage {
...
//	private final FloatItem housingFinanceItem;
	...
	public SpersonnelbusinespporUpdateForm() {
		...
		projectIdItem = new ComboBoxItem("projectId", shouldNotBeNull + "选择派驻项目");
...
//		mainLayout.addMember(label);
	...
	public void startEdit() {
		if (getRecord() != null){
			...
			ct1.addCriteria("employeeId", getRecord().getAttribute("employeeId"));
			projectIdItem.setPickListCriteria(ct1);
	...
	public java.util.Map getValuesAsMap() {
		...
		if(null != projectIdItem.getValue()){
			...
			map.put("projectCode", record.getAttribute("contractCode"));
		}
		return map;
	}
