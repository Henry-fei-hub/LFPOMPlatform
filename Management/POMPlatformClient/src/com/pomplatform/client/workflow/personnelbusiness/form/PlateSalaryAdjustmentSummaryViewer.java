...
public class PlateSalaryAdjustmentSummaryViewer extends AbstractDetailViewer
{
	...
	public PlateSalaryAdjustmentSummaryViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_PlateSalaryAdjustmentSummary", "find", new DSCallback() {
			@Override
