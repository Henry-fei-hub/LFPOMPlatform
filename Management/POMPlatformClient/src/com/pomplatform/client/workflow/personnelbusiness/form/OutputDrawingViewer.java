...
public class OutputDrawingViewer extends AbstractDetailViewer
{

	private VLayout mainLayout;
	private OutputDrawingUpdateForm form;

	private static final Logger logger = Logger.getLogger("");

	public OutputDrawingViewer() {
	}
	...
	public void initComponents() {
		...
		form = new OutputDrawingUpdateForm();
		form.setWidth100();
		form.setHeight100();
	...
	public DataSource getMainDataSource() {
		return DSOutputDrawing.getInstance();
	}
