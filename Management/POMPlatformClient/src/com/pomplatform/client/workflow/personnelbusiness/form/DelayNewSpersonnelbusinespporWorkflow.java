...
public class DelayNewSpersonnelbusinespporWorkflow extends AbstractProcessPanel {
	...
	public List<AbstractWizadPage> getPages() {
		...
		DelaySpersonnelbusinespporNewForm mainForm = new DelaySpersonnelbusinespporNewForm(getProcessType());
		mainForm.initData(getData());
		res.add(mainForm);
		return res;
	}
