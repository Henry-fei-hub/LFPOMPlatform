...
public class BusinessCardApplyViewer extends AbstractDetailViewer
{

	private VLayout mainLayout;
	private BusinessCardApplyUpdateForm form;
	private SearchForm __parentSearchForm;


	public BusinessCardApplyViewer() {
	}
	...
	public void initComponents() {
		...
		form = new BusinessCardApplyUpdateForm();
		form.setWidth100();
		form.setHeight100();
	...
	public DataSource getMainDataSource() {
		return DSBusinessCardApply.getInstance();
	}
