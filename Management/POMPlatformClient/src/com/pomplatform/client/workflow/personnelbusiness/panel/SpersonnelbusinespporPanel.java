...
import com.pomplatform.client.workflow.personnelbusiness.form.SpersonnelbusinespporSearchForm;
import com.pomplatform.client.workflow.personnelbusiness.form.SpersonnelbusinespporViewer;
import com.pomplatform.client.workflow.personnelbusiness.form.UpdateSpersonnelbusinespporForm;
import com.pomplatform.client.workflow.personnelbusiness.form.NewSpersonnelbusinespporForm;
...
public class SpersonnelbusinespporPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			SpersonnelbusinespporPanel cm = new SpersonnelbusinespporPanel();
			id = cm.getID();
			return cm;
		}
	...
	public void initComponents() {
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateSpersonnelbusinespporForm detailForm = new UpdateSpersonnelbusinespporForm();
		...
		operation3Button.addClickHandler(new ClickHandler(){
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					@Override
					public void onSuccess() {
						NewSpersonnelbusinespporForm detailForm = new NewSpersonnelbusinespporForm();
		...
		removeButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				DBDataSource.callOperation("ST_Spersonnelbusinesppor", "delete", selected.toMap(), new DSCallback() {
					@Override
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("Spersonnelbusinesppor"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				SpersonnelbusinespporViewer detailForm = new SpersonnelbusinespporViewer();
	...
	public SearchForm generateSearchForm() {
		return new SpersonnelbusinespporSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSSpersonnelbusinesppor.getInstance();
	}
