...
public class ApplyForTransferNewForm extends AbstractWizadPage {

	private final TextItem employeeIdItem;
	private final TextItem employeeNoItem;
	private final TextItem departmentIdItem;
	private final SelectItem oriCompanyIdItem;
	...
	public ApplyForTransferNewForm() {
		...
		oriCompanyIdItem= new SelectItem("oriCompanyId", "原归属公司");
		oriCompanyIdItem.setValueMap(KeyValueManager.getValueMap("system_dictionary_26"));
		oriCompanyIdItem.setDefaultValue(ClientUtil.getCompanyId());
		oriCompanyIdItem.setDisabled(true);
		oriCompanyIdItem.setWidth("*");
		__formItems.add(oriCompanyIdItem);
