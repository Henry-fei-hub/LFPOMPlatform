...
public class DelayUpdateSpersonnelbusinespporWorkflow extends AbstractProcessPanel {
	...
	public List<AbstractWizadPage> getPages() {
		...
		DelaySpersonnelbusinespporUpdateForm mainForm = new DelaySpersonnelbusinespporUpdateForm(getProcessType(), getProcessName());
		res.add(mainForm);
		return res;
	}
