...
public class DSCarCostAllocationProject extends DBDataSource
{


	public static DSCarCostAllocationProject instance = null;

	public static DSCarCostAllocationProject getInstance() {
		if(instance == null) {
			instance = new DSCarCostAllocationProject("DSCarCostAllocation");
		}
		return instance;
	}
	...
	public DSCarCostAllocationProject(String dataSourceID) {
