...
import com.pomplatform.client.workflow.personnelbusiness.datasource.DSDelaySpersonnelbusinesppor;
...
public class DelaySpersonnelbusinespporViewer extends AbstractDetailViewer {
	...
	public DelaySpersonnelbusinespporViewer() {
	}

	@Override
	public void initComponents() {
		Label leftLabel = new Label((this.processType == 22 ? "延期" : "加班") + "申请信息");
...
//		setLayoutMargin(5);
	...
	public DataSource getMainDataSource() {
		DSDelaySpersonnelbusinesppor ds = DSDelaySpersonnelbusinesppor.getInstance();
		if(this.processType == 22){
			ds.getField("startDate").setHidden(false);
			ds.getField("startDateDetail").setHidden(false);
			ds.getField("endDate").setHidden(false);
			ds.getField("endDateDetail").setHidden(false);
			ds.getField("address").setHidden(false);
			ds.getField("fee").setHidden(false);
		}else{
			ds.getField("startDate").setHidden(true);
			ds.getField("startDateDetail").setHidden(true);
			ds.getField("endDate").setHidden(true);
			ds.getField("endDateDetail").setHidden(true);
			ds.getField("address").setHidden(true);
			ds.getField("fee").setHidden(true);
		}
		return ds;
	}
