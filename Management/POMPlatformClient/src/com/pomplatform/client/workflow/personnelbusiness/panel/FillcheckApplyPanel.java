...
import com.pomplatform.client.workflow.personnelbusiness.form.FillcheckApplyViewer;
import com.pomplatform.client.workflow.personnelbusiness.form.UpdateFillcheckApplyForm;
import com.pomplatform.client.workflow.personnelbusiness.form.NewFillcheckApplyForm;
...
public class FillcheckApplyPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			FillcheckApplyPanel cm = new FillcheckApplyPanel();
			id = cm.getID();
			return cm;
		}
	...
	public void initComponents() {
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateFillcheckApplyForm detailForm = new UpdateFillcheckApplyForm();
		...
		operation3Button.addClickHandler(new ClickHandler(){
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					@Override
					public void onSuccess() {
						NewFillcheckApplyForm detailForm = new NewFillcheckApplyForm();
		...
		removeButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				DBDataSource.callOperation("ST_FillcheckApply", "delete", selected.toMap(), new DSCallback() {
					@Override
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("打卡申请"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				FillcheckApplyViewer detailForm = new FillcheckApplyViewer();
	...
	public DataSource getDataSource() {
		return DSFillcheckApply.getInstance();
	}
