...
import com.pomplatform.client.workflow.personnelbusiness.form.RegularEmployeeApplySearchForm;
import com.pomplatform.client.workflow.personnelbusiness.form.RegularEmployeeApplyViewer;
import com.pomplatform.client.workflow.personnelbusiness.form.UpdateRegularEmployeeApplyForm;
import com.pomplatform.client.workflow.personnelbusiness.form.NewRegularEmployeeApplyForm;
...
public class RegularEmployeeApplyPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			RegularEmployeeApplyPanel cm = new RegularEmployeeApplyPanel();
			id = cm.getID();
			return cm;
		}
	...
	public void initComponents() {
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateRegularEmployeeApplyForm detailForm = new UpdateRegularEmployeeApplyForm();
		...
		operation3Button.addClickHandler(new ClickHandler(){
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					@Override
					public void onSuccess() {
						NewRegularEmployeeApplyForm detailForm = new NewRegularEmployeeApplyForm();
		...
		removeButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				DBDataSource.callOperation("ST_RegularEmployeeApply", "delete", selected.toMap(), new DSCallback() {
					@Override
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("转正申请"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				RegularEmployeeApplyViewer detailForm = new RegularEmployeeApplyViewer();
	...
	public SearchForm generateSearchForm() {
		return new RegularEmployeeApplySearchForm();
	}
