...
public class NewEmployeeRepaymentWorkflow extends AbstractProcessPanel {
	...
	public List<AbstractWizadPage> getPages() {
		...
		Record budgetRecord=getData();
		List<AbstractWizadPage> res = new ArrayList<>();
		EmployeeRepaymentNewForm panel=new EmployeeRepaymentNewForm();
