...
public class DSStampCarvingApply extends DBDataSource
{


	public static DSStampCarvingApply instance = null;

	public static DSStampCarvingApply getInstance() {
		if(instance == null) {
			instance = new DSStampCarvingApply("DSStampCarvingApply");
		}
		return instance;
	}
	...
	public DSStampCarvingApply(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("StampCarvingApply");
