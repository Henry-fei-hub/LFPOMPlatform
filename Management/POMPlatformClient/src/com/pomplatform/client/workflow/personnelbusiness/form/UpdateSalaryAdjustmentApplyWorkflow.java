...
public class UpdateSalaryAdjustmentApplyWorkflow extends AbstractProcessPanel
{
	...
	public List<AbstractWizadPage> getPages(){
		...
		SalaryAdjustmentApplyUpdateForm panel = new SalaryAdjustmentApplyUpdateForm();
