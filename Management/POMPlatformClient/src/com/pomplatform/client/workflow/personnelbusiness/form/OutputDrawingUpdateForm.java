...
public class OutputDrawingUpdateForm extends AbstractWizadPage
{
	...
	public OutputDrawingUpdateForm() {
		...
		personnelBusinessIdItem = new TextItem("personnelBusinessId", "主键");
...
//		subTypeItem.setTextBoxStyle("customInputTextStyle");
		...
		subTypeStrItem = new TextItem("subTypeStr",  shouldNotBeNull +"替换原变更号");
