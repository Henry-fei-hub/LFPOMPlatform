...
public class CDOnLoadTaskListOfSalaryAdjustment extends DataSource
{


	public static CDOnLoadTaskListOfSalaryAdjustment instance = null;

	public static CDOnLoadTaskListOfSalaryAdjustment getInstance() {
		if(instance == null) {
			instance = new CDOnLoadTaskListOfSalaryAdjustment("CDOnLoadTaskListOfSalaryAdjustment");
		}
		return instance;
	}
	...
	public CDOnLoadTaskListOfSalaryAdjustment(String dataSourceID) {
