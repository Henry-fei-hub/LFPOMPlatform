...
public class AttachmentLinkInvoicesPanel extends AbstractWizadPage {
	...
	public AttachmentLinkInvoicesPanel() {
		initPanel();
	}
...
//		idx++;
		...
		useInvoiceButton.addClickHandler(new ClickHandler() {
			...
			@Override
			public void onClick(ClickEvent event) {
				FormItem projectItem = mainInfoPage.findNamedItem("projectId");
				Object contractId = projectItem.getValue();
				if(null == contractId){
					SC.say("请先选择合同");
					return;
				}
	...
	public void reloadDetailTableData() {
		...
		DBDataSource.callOperation("NQ_OnAttachmentLinkInvoices", "find", condition, new DSCallback() {
			@Override
