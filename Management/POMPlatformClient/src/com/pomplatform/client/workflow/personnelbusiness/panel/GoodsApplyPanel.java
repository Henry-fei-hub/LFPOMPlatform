...
import com.pomplatform.client.workflow.personnelbusiness.form.GoodsApplySearchForm;
import com.pomplatform.client.workflow.personnelbusiness.form.GoodsApplyViewer;
import com.pomplatform.client.workflow.personnelbusiness.form.NewGoodsApplyForm;
import com.pomplatform.client.workflow.personnelbusiness.form.UpdateGoodsApplyForm;
...
public class GoodsApplyPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			GoodsApplyPanel cm = new GoodsApplyPanel();
			id = cm.getID();
			return cm;
		}
	...
	public void initComponents() {
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						NewGoodsApplyForm detailForm = new NewGoodsApplyForm();
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateGoodsApplyForm detailForm = new UpdateGoodsApplyForm();
		...
		removeButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				DBDataSource.callOperation("ST_GoodsApply", "delete", selected.toMap(), new DSCallback() {
					@Override
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("物品申请"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				GoodsApplyViewer detailForm = new GoodsApplyViewer();
	...
	public SearchForm generateSearchForm() {
		return new GoodsApplySearchForm();
	}
