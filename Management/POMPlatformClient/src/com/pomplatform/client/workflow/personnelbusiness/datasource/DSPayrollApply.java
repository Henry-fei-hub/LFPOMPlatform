...
public class DSPayrollApply extends DBDataSource {

	public static DSPayrollApply instance = null;

	public static DSPayrollApply getInstance() {
		if (instance == null) {
			instance = new DSPayrollApply("DSPayrollApply");
		}
		return instance;
	}
	...
	public DSPayrollApply(String dataSourceID) {
		...
		typeField = new DataSourceIntegerField("type", "发放类型");
		typeField.setLength(11);
		typeField.setRequired(false);
		typeField.setHidden(false);
		typeField.setValueMap(KeyValueManager.getValueMap("system_dictionary_127"));
		...
		companyProvinceField = new DataSourceIntegerField("companyProvince", "年份");
		companyProvinceField.setLength(11);
		companyProvinceField.setRequired(false);
		companyProvinceField.setHidden(false);

		targetProvinceField = new DataSourceIntegerField("targetProvince", "月份");
		...
		setFields( personnelBusinessIdField, processTypeField,
				...
				empStatusField, cardField, reasonField, remarkField, createTimeField, deleteFlagField);
	}
