...
public class CarCostAllocationViewer extends AbstractDetailViewer
{




	public CarCostAllocationViewer() {
	}
	...
	public void load() {
		...
		params.put("carCostAllocationId", getBusinessId());
		DBDataSource.callOperation("ST_CarCostAllocation", "find", new DSCallback() {
			@Override
	...
	public DataSource getMainDataSource() {
		return DSCarCostAllocation.getInstance();
	}
