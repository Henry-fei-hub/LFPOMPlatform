...
public class StampCarvingApplyViewer extends AbstractDetailViewer
{

	private VLayout mainLayout;
	private StampCarvingApplyUpdateForm form;
	private SearchForm __parentSearchForm;


	public StampCarvingApplyViewer() {
	}
	...
	public void initComponents() {
		...
		form = new StampCarvingApplyUpdateForm();
		form.setWidth100();
		form.setHeight100();
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_StampCarvingApply", "find", new DSCallback() {
			@Override
	...
	public DataSource getMainDataSource() {
		return DSStampCarvingApply.getInstance();
	}
