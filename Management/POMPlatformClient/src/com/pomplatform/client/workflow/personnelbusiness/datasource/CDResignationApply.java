...
public class CDResignationApply extends DataSource
{


	public static CDResignationApply instance = null;

	public static CDResignationApply getInstance() {
		if(instance == null) {
			instance = new CDResignationApply("CDResignationApply");
		}
		return instance;
	}
	...
	public CDResignationApply(String dataSourceID) {
