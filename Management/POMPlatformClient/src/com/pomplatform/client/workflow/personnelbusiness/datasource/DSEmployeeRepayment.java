...
public class DSEmployeeRepayment extends DBDataSource {

	public static DSEmployeeRepayment instance = null;

	public static DSEmployeeRepayment getInstance() {
		if (instance == null) {
			instance = new DSEmployeeRepayment("DSSpersonnelbusinesppor");
		}
		return instance;
	}
	...
	public DSEmployeeRepayment(String dataSourceID) {
		...
		parentIdField = new DataSourceIntegerField("parentId", "付款人");
		parentIdField.setLength(11);
		parentIdField.setRequired(false);
		parentIdField.setHidden(false);
		parentIdField.setValueMap(KeyValueManager.getValueMap("employees"));
