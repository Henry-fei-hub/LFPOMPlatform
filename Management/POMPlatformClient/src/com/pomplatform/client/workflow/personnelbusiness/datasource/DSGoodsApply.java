...
public class DSGoodsApply extends DBDataSource
{


	public static DSGoodsApply instance = null;

	public static DSGoodsApply getInstance() {
		if(instance == null) {
			instance = new DSGoodsApply("DSGoodsApply");
		}
		return instance;
	}
	...
	public DSGoodsApply(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("GoodsApply");
