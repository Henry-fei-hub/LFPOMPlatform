...
import com.pomplatform.client.workflow.personnelbusiness.form.BusinessTripApplyViewer;
import com.pomplatform.client.workflow.personnelbusiness.form.UpdateBusinessTripApplyForm;
import com.pomplatform.client.workflow.personnelbusiness.form.NewBusinessTripApplyForm;
...
public class BusinessTripApplyPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			BusinessTripApplyPanel cm = new BusinessTripApplyPanel();
			id = cm.getID();
			return cm;
		}
	...
	public void initComponents() {
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateBusinessTripApplyForm detailForm = new UpdateBusinessTripApplyForm();
		...
		operation3Button.addClickHandler(new ClickHandler(){
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					@Override
					public void onSuccess() {
						NewBusinessTripApplyForm detailForm = new NewBusinessTripApplyForm();
		...
		removeButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				DBDataSource.callOperation("ST_BusinessTripApply", "delete", selected.toMap(), new DSCallback() {
					@Override
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("出差申请"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				BusinessTripApplyViewer detailForm = new BusinessTripApplyViewer();
	...
	public DataSource getDataSource() {
		return DSBusinessTripApply.getInstance();
	}
