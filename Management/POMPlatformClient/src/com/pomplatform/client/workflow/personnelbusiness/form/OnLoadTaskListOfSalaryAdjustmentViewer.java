...
public class OnLoadTaskListOfSalaryAdjustmentViewer extends AbstractDetailViewer
{
	...
	public OnLoadTaskListOfSalaryAdjustmentViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadTaskListOfSalaryAdjustment", "find", new DSCallback() {
			@Override
