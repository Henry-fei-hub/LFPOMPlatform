...
public class DelayNewBusinessTripApplyWorkflow extends AbstractProcessPanel {
	...
	public List<AbstractWizadPage> getPages() {
		...
		DelayBusinessTripApplyNewForm mainForm = new DelayBusinessTripApplyNewForm(getProcessType());
