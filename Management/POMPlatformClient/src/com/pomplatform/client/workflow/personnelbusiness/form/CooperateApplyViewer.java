...
public class CooperateApplyViewer extends AbstractDetailViewer
{

	private VLayout mainLayout;
	private CooperateApplyUpdateForm form;

	private static final Logger logger = Logger.getLogger("");

	public CooperateApplyViewer() {
	}
	...
	public void initComponents() {
		...
		form = new CooperateApplyUpdateForm();
		form.setWidth100();
		form.setHeight100();
	...
	public DataSource getMainDataSource() {
		return DSCooperateApply.getInstance();
	}
