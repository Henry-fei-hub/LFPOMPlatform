...
public class DSSpersonnelbusinesppor extends DBDataSource {

	public static DSSpersonnelbusinesppor instance = null;

	public static DSSpersonnelbusinesppor getInstance() {
		if (instance == null) {
			instance = new DSSpersonnelbusinesppor("DSSpersonnelbusinesppor");
		}
		return instance;
	}
	...
	public DSSpersonnelbusinesppor(String dataSourceID) {
