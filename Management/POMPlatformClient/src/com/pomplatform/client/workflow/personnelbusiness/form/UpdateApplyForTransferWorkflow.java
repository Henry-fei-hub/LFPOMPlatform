...
public class UpdateApplyForTransferWorkflow extends AbstractProcessPanel {
...
//				SC.say("请您按系统提示填好信息。");
	...
	public List<AbstractWizadPage> getPages() {
		...
		ApplyForTransferUpdateForm panel = new ApplyForTransferUpdateForm(getProcessName());
		panel.setPageMode(AbstractWizadPage.PAGE_MODE_UPDATE);
		res.add(panel);
		panel2 = new WorkHandoverPanel(2);
