...
public class UpdateCarApplyWorkflow extends AbstractProcessPanel
{
	...
	public List<AbstractWizadPage> getPages(){
		...
		CarApplyUpdateForm panel1 = new CarApplyUpdateForm();
		PersonnelBusinesDetailCarCostAllocation panel2 = new PersonnelBusinesDetailCarCostAllocation();
		panel2.setPageMode(AbstractWizadPage.PAGE_MODE_UPDATE);
		panel1.setPanel(panel2);
		panel1.setProcessName(processName);
		res.add(panel1);
		res.add(panel2);
		return res;
	}
