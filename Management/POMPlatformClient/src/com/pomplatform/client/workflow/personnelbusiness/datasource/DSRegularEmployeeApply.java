...
public class DSRegularEmployeeApply extends DBDataSource
{


	public static DSRegularEmployeeApply instance = null;

	public static DSRegularEmployeeApply getInstance() {
		if(instance == null) {
			instance = new DSRegularEmployeeApply("DSRegularEmployeeApply");
		}
		return instance;
	}
	...
	public DSRegularEmployeeApply(String dataSourceID) {
