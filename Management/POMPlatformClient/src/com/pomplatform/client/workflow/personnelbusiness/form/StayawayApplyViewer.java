...
public class StayawayApplyViewer extends AbstractDetailViewer
{
	private VLayout mainLayout;
	private StayawayApplyUpdateForm form;
	
	public StayawayApplyViewer() {
	}
	...
	public void initComponents() {
		...
		form = new StayawayApplyUpdateForm();
		form.setWidth100();
		form.setHeight100();
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_StayawayApply", "find", new DSCallback() {
			@Override
