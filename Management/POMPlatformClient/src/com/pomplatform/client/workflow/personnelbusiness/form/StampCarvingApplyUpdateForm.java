...
public class StampCarvingApplyUpdateForm extends AbstractWizadPage
{
	...
	public StampCarvingApplyUpdateForm() {
		...
		addressItem = new PickTreeItem("address", shouldNotBeNull + "印章种类");
