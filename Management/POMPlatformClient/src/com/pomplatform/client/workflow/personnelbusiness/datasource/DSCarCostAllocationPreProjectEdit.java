...
public class DSCarCostAllocationPreProjectEdit extends DBDataSource
{


	public static DSCarCostAllocationPreProjectEdit instance = null;

	public static DSCarCostAllocationPreProjectEdit getInstance() {
		if(instance == null) {
			instance = new DSCarCostAllocationPreProjectEdit("DSCarCostAllocation");
		}
		return instance;
	}
	...
	public DSCarCostAllocationPreProjectEdit(String dataSourceID) {
		...
		idField = new DataSourceIntegerField("id", "请选择前期项目");
		...
		ComboBoxItem preProjectSelectItem = new ComboBoxItem();
		...
		preProjectSelectItem.setPickListWidth(800);
		
		idField.setEditorProperties(preProjectSelectItem);
