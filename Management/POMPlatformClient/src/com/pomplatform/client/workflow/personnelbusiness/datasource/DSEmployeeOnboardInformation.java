...
//		roleIdField.setValueMap(KeyValueManager.getValueMap("roles"));
		...
		homePhoneField = new DataSourceTextField("homePhone", "护照号");
		...
		employeeShiftField.setValueMap(KeyValueManager.getValueMap("system_dictionary_83"));
		...
		onboardStatusField = new DataSourceIntegerField("onboardStatus", "入职员工状态");
		...
		workYearTypeField = new DataSourceTextField("workYearType","工龄工资状态");
		workYearTypeField.setLength(11);
		workYearTypeField.setRequired(true);

		photoIdField = new DataSourceIntegerField("photoId", "头像ID");
