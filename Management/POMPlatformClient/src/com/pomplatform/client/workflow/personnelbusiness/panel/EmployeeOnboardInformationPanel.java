...
import com.pomplatform.client.workflow.personnelbusiness.form.EmployeeOnboardInformationViewer;
import com.pomplatform.client.workflow.personnelbusiness.form.UpdateEmployeeOnboardInformationForm;
import com.pomplatform.client.workflow.personnelbusiness.form.NewEmployeeOnboardInformationForm;
...
public class EmployeeOnboardInformationPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			EmployeeOnboardInformationPanel cm = new EmployeeOnboardInformationPanel();
			id = cm.getID();
			return cm;
		}
	...
	public void initComponents() {
		...
		detailButton.setIcon("[SKIN]/actions/view.png");
		...
		updateButton.setIcon("[SKIN]/actions/edit.png");
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateEmployeeOnboardInformationForm detailForm = new UpdateEmployeeOnboardInformationForm();
		...
		newButton.addClickHandler(new ClickHandler(){
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					@Override
					public void onSuccess() {
						NewEmployeeOnboardInformationForm detailForm = new NewEmployeeOnboardInformationForm();
		...
		removeButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				DBDataSource.callOperation("ST_EmployeeOnboardInformation", "delete", selected.toMap(), new DSCallback() {
					@Override
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("EmployeeOnboardInformation"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				EmployeeOnboardInformationViewer detailForm = new EmployeeOnboardInformationViewer();
