...
public class OnLoadApplyListOfSalaryAdjustmentViewer extends AbstractDetailViewer
{
	...
	public OnLoadApplyListOfSalaryAdjustmentViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadApplyListOfSalaryAdjustment", "find", new DSCallback() {
			@Override
