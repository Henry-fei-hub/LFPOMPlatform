...
public class OnLoadAuditListOfProfessionalApprovalViewer extends AbstractDetailViewer
{
	...
	public OnLoadAuditListOfProfessionalApprovalViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadAuditListOfProfessionalApproval", "find", new DSCallback() {
			@Override
