...
public class OnLoadAttentionListOfProfessionalApprovalUpdateForm extends AbstractWizadPage
{


	private final TextItem systemProcessAttentionIdItem;
	...
	private final TextItem instanceActivityIdItem;
	...
	public OnLoadAttentionListOfProfessionalApprovalUpdateForm() {
		DSOnLoadAttentionListOfProfessionalApproval ds = DSOnLoadAttentionListOfProfessionalApproval.getInstance();
		__form.setWidth100();
		__form.setHeight100();
		systemProcessAttentionIdItem = new TextItem("systemProcessAttentionId", "主键编码");
		systemProcessAttentionIdItem.setDisabled(true);
		systemProcessAttentionIdItem.setRequired(true);
		IsIntegerValidator systemProcessAttentionIdValidator = new IsIntegerValidator();
		systemProcessAttentionIdItem.setValidators(systemProcessAttentionIdValidator);
		__formItems.add(systemProcessAttentionIdItem);
		...
		instanceActivityIdItem = new TextItem("instanceActivityId", "流程实例节点编码");
		__formItems.add(instanceActivityIdItem);
	...
	public void setValueManage(ValuesManager manager) {
		manager.setDataSource(DSOnLoadAttentionListOfProfessionalApproval.getInstance());
