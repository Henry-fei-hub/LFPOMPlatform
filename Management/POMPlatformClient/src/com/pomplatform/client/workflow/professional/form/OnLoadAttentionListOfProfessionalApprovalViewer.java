...
public class OnLoadAttentionListOfProfessionalApprovalViewer extends AbstractDetailViewer
{
	...
	public OnLoadAttentionListOfProfessionalApprovalViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadAttentionListOfProfessionalApproval", "find", new DSCallback() {
			@Override
