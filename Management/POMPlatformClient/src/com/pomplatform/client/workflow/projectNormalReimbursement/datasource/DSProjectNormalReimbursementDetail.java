...
public class DSProjectNormalReimbursementDetail extends DBDataSource
{
	...
	private final DataSourceTextField identificationField;
...
//		subItemIdField.setValueMap(KeyValueManager.getValueMap("subject_types"));
		...
		identificationField = new DataSourceTextField("identification","标识");
		identificationField.setLength(18);
		identificationField.setHidden(false);
		
		
		setFields(projectNormalReimbursementDetailIdField, projectNormalReimbursementIdField, mainItemIdField, subItemIdField, amountField, reimbursementTimeField, statusField, remarkField ,identificationField);
	}
