...
public class ProjectNormalReimbursementDetailViewer extends AbstractDetailViewer
{




	public ProjectNormalReimbursementDetailViewer() {
	}
	...
	public void load() {
		...
		params.put("projectNormalReimbursementDetailId", getBusinessId());
		DBDataSource.callOperation("ST_ProjectNormalReimbursementDetail", "find", new DSCallback() {
			@Override
	...
	public DataSource getMainDataSource() {
		return DSProjectNormalReimbursementDetail.getInstance();
	}
