...
public class NormalReimbursementLinkProjectViewer extends AbstractDetailViewer
{




	public NormalReimbursementLinkProjectViewer() {
	}
	...
	public void load() {
		...
		params.put("normalReimbursementLinkProjectId", getBusinessId());
		DBDataSource.callOperation("ST_NormalReimbursementLinkProject", "find", new DSCallback() {
			@Override
