...
public class UpdateNormalReimbursementWithProjectWorkflow extends AbstractProcessPanel
{
	...
	public List<AbstractWizadPage> getPages(){
		...
		final NormalReimbursementWithProjectUpdateForm main = new NormalReimbursementWithProjectUpdateForm();
        ...
        NormalReimbursementLinkProjectPanel link = null;
        if(null == processName){
        	link = new NormalReimbursementLinkProjectPanel(true, processName);
        }else{
        	//编辑进项税和成本的面板
        	link = new NormalReimbursementLinkProjectPanel(true, processName);
        }
        link.setProcessId(getProcessId());
        link.setProcessType(2);
