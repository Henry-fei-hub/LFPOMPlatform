...
public class NewNormalReimbursementWithProjectForm extends GenericWizadWindow
{
	...
	public List<AbstractWizadPage> getPages(){
		...
		res.add(new NormalReimbursementWithProjectNewForm());
		res.add(new ProjectNormalReimbursementDetailPanel());
		res.add(new NormalReimbursementLinkProjectPanel());
		return res;
	}
