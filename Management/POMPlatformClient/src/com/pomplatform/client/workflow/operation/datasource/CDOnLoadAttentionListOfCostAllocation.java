...
public class CDOnLoadAttentionListOfCostAllocation extends DataSource
{


	public static CDOnLoadAttentionListOfCostAllocation instance = null;

	public static CDOnLoadAttentionListOfCostAllocation getInstance() {
		if(instance == null) {
			instance = new CDOnLoadAttentionListOfCostAllocation("CDOnLoadAttentionListOfCostAllocation");
		}
		return instance;
	}
	...
	public CDOnLoadAttentionListOfCostAllocation(String dataSourceID) {
