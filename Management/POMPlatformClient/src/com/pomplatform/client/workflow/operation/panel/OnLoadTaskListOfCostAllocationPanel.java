...
import com.pomplatform.client.workflow.operation.datasource.DSOnLoadTaskListOfCostAllocation;
import com.pomplatform.client.workflow.operation.form.OnLoadTaskListOfCostAllocationSearchForm;
...
public class OnLoadTaskListOfCostAllocationPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			OnLoadTaskListOfCostAllocationPanel cm = new OnLoadTaskListOfCostAllocationPanel();
			id = cm.getID();
			return cm;
		}
		...
		public String getDescription() {
			return "OnLoadTaskListOfCostAllocation";
		}
	...
	public SearchForm generateSearchForm() {
		return new OnLoadTaskListOfCostAllocationSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSOnLoadTaskListOfCostAllocation.getInstance();
	}
