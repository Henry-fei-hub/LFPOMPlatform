...
public class OnLoadAttentionListOfCostAllocationViewer extends AbstractDetailViewer
{
	...
	public OnLoadAttentionListOfCostAllocationViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadAttentionListOfCostAllocation", "find", new DSCallback() {
			@Override
