...
public class OnLoadAuditListOfCostAllocationViewer extends AbstractDetailViewer
{
	...
	public OnLoadAuditListOfCostAllocationViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadAuditListOfCostAllocation", "find", new DSCallback() {
			@Override
