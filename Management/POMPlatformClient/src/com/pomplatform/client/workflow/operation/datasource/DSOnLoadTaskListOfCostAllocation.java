...
public class DSOnLoadTaskListOfCostAllocation extends DBDataSource
{


	public static DSOnLoadTaskListOfCostAllocation instance = null;

	public static DSOnLoadTaskListOfCostAllocation getInstance() {
		if(instance == null) {
			instance = new DSOnLoadTaskListOfCostAllocation("DSOnLoadTaskListOfCostAllocation");
		}
		return instance;
	}
	...
	public DSOnLoadTaskListOfCostAllocation(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("OnLoadTaskListOfCostAllocation");
		...
		setFields(processPooledTaskIdField, businessIdField, businessNameField, processActivityIdField, processIdField, processInstanceIdField, backViewNameField, activityTypeField, nodeTypeField, activityIdField, instanceActivityCreateTimeField, instanceActivityStartTimeField, statusField, processTypeField, drafterField, costTypeField, codeField, nameField, costField, reasonField, operateTimeField, processCommentField);
	}
