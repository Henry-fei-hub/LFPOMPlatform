...
public class DSOnLoadRefuseListOfCostAllocation extends DBDataSource
{


	public static DSOnLoadRefuseListOfCostAllocation instance = null;

	public static DSOnLoadRefuseListOfCostAllocation getInstance() {
		if(instance == null) {
			instance = new DSOnLoadRefuseListOfCostAllocation("DSOnLoadRefuseListOfCostAllocation");
		}
		return instance;
	}
	...
	public DSOnLoadRefuseListOfCostAllocation(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("OnLoadRefuseListOfCostAllocation");
