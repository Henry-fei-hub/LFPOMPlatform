...
public class DSOnLoadAuditListOfCostAllocation extends DBDataSource
{


	public static DSOnLoadAuditListOfCostAllocation instance = null;

	public static DSOnLoadAuditListOfCostAllocation getInstance() {
		if(instance == null) {
			instance = new DSOnLoadAuditListOfCostAllocation("DSOnLoadAuditListOfCostAllocation");
		}
		return instance;
	}
	...
	public DSOnLoadAuditListOfCostAllocation(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("OnLoadAuditListOfCostAllocation");
		...
		setFields(processInstanceActivityIdField, businessIdField, businessNameField, processActivityIdField, processIdField, processInstanceIdField, nodeTypeField, activityIdField, nextActivityIdField, mainActivityIdField, instanceActivityCreateTimeField, instanceActivityStartTimeField, drafterField, costTypeField, codeField, nameField, costField, reasonField, operateTimeField, statusField, processTypeField, processCommentField, activityTypeField, backViewNameField);
	}
