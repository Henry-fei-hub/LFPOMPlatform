...
import com.pomplatform.client.workflow.operation.datasource.DSOnLoadApplyListOfCostAllocationNew;
import com.pomplatform.client.workflow.operation.form.OnLoadApplyListOfCostAllocationNewSearchForm;
import com.pomplatform.client.workflow.operation.form.OnLoadApplyListOfCostAllocationNewViewer;
...
public class OnLoadApplyListOfCostAllocationNewPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			OnLoadApplyListOfCostAllocationNewPanel cm = new OnLoadApplyListOfCostAllocationNewPanel();
			id = cm.getID();
			return cm;
		}
		...
		public String getDescription() {
			return "OnLoadApplyListOfCostAllocationNew";
		}
	...
	public boolean checkSearchCriteria(Map criteria) {
		...
		DBDataSource.callOperation("NQ_OnLoadApplyListOfCostAllocationSerchEmplyeeID", "find", params, new DSCallback(){
			@Override
			public void execute(DSResponse dsResponse, Object data, DSRequest dsRequest) {
				if(dsResponse.getStatus() >= 0) {
					Record[] records = dsResponse.getData();
					for(int i = 0;i < records.length;i++) {
						employeeId=BaseHelpUtils.getIntValue(records[i].getAttribute("employeeId"));
					}
	...
	public DataSource getDataSource() {
		return DSOnLoadApplyListOfCostAllocationNew.getInstance();
	}
