...
import com.pomplatform.client.workflow.datasource.DSPayMoneyAttentionOfWorkflow;
import com.pomplatform.client.workflow.form.PayMoneyAttentionOfWorkflowSearchForm;
...
public class PayMoneyAttentionOfWorkflowPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			PayMoneyAttentionOfWorkflowPanel cm = new PayMoneyAttentionOfWorkflowPanel();
			id = cm.getID();
			return cm;
		}
		...
		public String getDescription() {
			return "PayMoneyAttentionOfWorkflow";
		}
	...
	public SearchForm generateSearchForm() {
		return new PayMoneyAttentionOfWorkflowSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSPayMoneyAttentionOfWorkflow.getInstance();
	}
