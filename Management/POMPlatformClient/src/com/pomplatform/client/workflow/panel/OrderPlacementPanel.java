...
import com.pomplatform.client.workflow.form.OrderPlacementSearchForm;
import com.pomplatform.client.workflow.form.OrderPlacementViewer;
import com.pomplatform.client.workflow.form.NewOrderPlacementForm;
import com.pomplatform.client.workflow.form.UpdateOrderPlacementForm;
...
public class OrderPlacementPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			OrderPlacementPanel cm = new OrderPlacementPanel();
			id = cm.getID();
			return cm;
		}
	...
	public void initComponents() {
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						NewOrderPlacementForm detailForm = new NewOrderPlacementForm();
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateOrderPlacementForm detailForm = new UpdateOrderPlacementForm();
		...
		removeButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				DBDataSource.callOperation("ST_OrderPlacement", "delete", selected.toMap(), new DSCallback() {
					@Override
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("OrderPlacementOfWorkflow"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				OrderPlacementViewer detailForm = new OrderPlacementViewer();
	...
	public boolean checkSearchCriteria(Map criteria) {
		criteria.put("addtionalCondition", "order by order_info_id");
		return true;
	}
	...
	public SearchForm generateSearchForm() {
		return new OrderPlacementSearchForm();
	}
