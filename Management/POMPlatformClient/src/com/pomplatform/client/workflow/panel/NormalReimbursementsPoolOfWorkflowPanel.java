...
import com.pomplatform.client.workflow.datasource.DSNormalReimbursementsPoolOfWorkflow;
import com.pomplatform.client.workflow.form.NormalReimbursementsPoolOfWorkflowSearchForm;
...
public class NormalReimbursementsPoolOfWorkflowPanel extends AbstractSearchPanel {
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			NormalReimbursementsPoolOfWorkflowPanel cm = new NormalReimbursementsPoolOfWorkflowPanel();
			id = cm.getID();
			return cm;
		}
		...
		public String getDescription() {
			return "NormalReimbursementsPoolOfWorkflow";
		}
	...
	public SearchForm generateSearchForm() {
		return new NormalReimbursementsPoolOfWorkflowSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSNormalReimbursementsPoolOfWorkflow.getInstance();
	}
