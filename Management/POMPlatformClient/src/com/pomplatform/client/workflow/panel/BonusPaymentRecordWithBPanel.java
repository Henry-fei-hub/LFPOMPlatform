...
import com.pomplatform.client.workflow.form.BonusPaymentRecordWithBSearchForm;
import com.pomplatform.client.workflow.form.BonusPaymentRecordWithBViewer;
import com.pomplatform.client.workflow.form.NewBonusPaymentRecordWithBForm;
import com.pomplatform.client.workflow.form.UpdateBonusPaymentRecordWithBForm;
...
public class BonusPaymentRecordWithBPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			BonusPaymentRecordWithBPanel cm = new BonusPaymentRecordWithBPanel();
			id = cm.getID();
			return cm;
		}
		...
		public String getDescription() {
			return "BonusPaymentRecordWithB";
		}
	...
	public void initComponents() {
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						NewBonusPaymentRecordWithBForm detailForm = new NewBonusPaymentRecordWithBForm();
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateBonusPaymentRecordWithBForm detailForm = new UpdateBonusPaymentRecordWithBForm();
		...
		removeButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				DBDataSource.callOperation("ST_BonusPaymentRecordWithB", "delete", selected.toMap(), new DSCallback() {
					@Override
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("BonusApplication"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				BonusPaymentRecordWithBViewer detailForm = new BonusPaymentRecordWithBViewer();
	...
	public boolean checkSearchCriteria(Map criteria) {
		criteria.put("addtionalCondition", "order by bonus_payment_record_id");
		return true;
	}
	...
	public SearchForm generateSearchForm() {
		return new BonusPaymentRecordWithBSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSBonusPaymentRecordWithB.getInstance();
	}
