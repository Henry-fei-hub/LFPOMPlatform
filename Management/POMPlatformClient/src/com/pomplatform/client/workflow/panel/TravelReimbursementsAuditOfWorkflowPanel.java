...
import com.pomplatform.client.personnel.form.OnLoadFlowTravelReimbursementsApplyBuisnessDataSearchForm;
import com.pomplatform.client.preprojecttravelreimbursement.datasource.DSTravelReimbursementLinkMainProjectOne;
import com.pomplatform.client.workflow.commonTravelReimbursement.datasource.DSTravelReimbursementLinkDepartmentOne;
import com.pomplatform.client.workflow.projectTravelReimbursement.datasource.DSTravelReimbursementLinkProjectOne;
...
public class TravelReimbursementsAuditOfWorkflowPanel extends AbstractExpansionRelatedPage
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			TravelReimbursementsAuditOfWorkflowPanel cm = new TravelReimbursementsAuditOfWorkflowPanel();
			id = cm.getID();
			return cm;
		}
		...
		public String getDescription() {
			return "TravelReimbursementsAuditOfWorkflow";
		}
	...
	public void submit(ListGridRecord[] records, int approvalment) {
		if(null != records){
			...
			for(ListGridRecord record: records){
				...
				record.setAttribute("travelReimbursementId", record.getAttribute("businessId"));
...
//		return new TravelReimbursementsAuditOfWorkflowSearchForm();
		return new OnLoadFlowTravelReimbursementsApplyBuisnessDataSearchForm();
	}

	@Override
	public DataSource getDataSource() {
//		return DSTravelReimbursementsAuditOfWorkflow.getInstance();
//		return DSOnLoadFlowTravelReimbursementsBuisnessData.getInstance();
		return DSOnLoadFlowTravelReimbursementsApplyBuisnessData.getInstance();
	}
	...
	public DataSource getChildDataSource() {
		...
		case 4://项目差旅
			return DSTravelReimbursementLinkProjectOne.getInstance();
		case 5://普通差旅
			return DSTravelReimbursementLinkDepartmentOne.getInstance();
		case 9://前期项目差旅
			return DSTravelReimbursementLinkMainProjectOne.getInstance();
		default:
			break;
		}
		}
