...
import com.pomplatform.client.personnel.datasource.DSOnLoadFlowEmployeeMoneyApplyBuisnessData;
import com.pomplatform.client.personnel.form.OnLoadFlowEmployeeMoneyApplyBuisnessDataSearchForm;
...
public class EmployeeMoneyAuditOfWorkflowPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			EmployeeMoneyAuditOfWorkflowPanel cm = new EmployeeMoneyAuditOfWorkflowPanel();
			id = cm.getID();
			return cm;
		}
		...
		public String getDescription() {
			return "EmployeeMoneyAuditOfWorkflow";
		}
...
//		criteria.put("addtionalCondition", "order by process_instance_id");
	...
	public SearchForm generateSearchForm() {
		return new OnLoadFlowEmployeeMoneyApplyBuisnessDataSearchForm();
//		return new EmployeeMoneyAuditOfWorkflowSearchForm();
	}

	@Override
	public DataSource getDataSource() {
//		return DSEmployeeMoneyAuditOfWorkflow.getInstance();
		return DSOnLoadFlowEmployeeMoneyApplyBuisnessData.getInstance();
	}
	private String code;
	private int status;
