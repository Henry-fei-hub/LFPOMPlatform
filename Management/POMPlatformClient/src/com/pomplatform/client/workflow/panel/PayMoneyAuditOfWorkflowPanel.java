...
public class PayMoneyAuditOfWorkflowPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			PayMoneyAuditOfWorkflowPanel cm = new PayMoneyAuditOfWorkflowPanel();
			id = cm.getID();
			return cm;
		}
		...
		public String getDescription() {
			return "PayMoneyAuditOfWorkflow";
		}
	...
	public void submit(ListGridRecord[] records, int approvalment) {
		if(null != records){
			...
			for(ListGridRecord record: records){
				...
				record.setAttribute("payMoneyManageId", record.getAttribute("businessId"));
...
//		return new PayMoneyAuditOfWorkflowSearchForm();
...
//		return DSPayMoneyAuditOfWorkflow.getInstance();
	}
