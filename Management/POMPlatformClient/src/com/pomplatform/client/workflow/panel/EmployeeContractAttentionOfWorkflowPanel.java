...
import com.pomplatform.client.workflow.datasource.DSEmployeeContractAttentionOfWorkflow;
import com.pomplatform.client.workflow.form.EmployeeContractAttentionOfWorkflowSearchForm;
...
public class EmployeeContractAttentionOfWorkflowPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			EmployeeContractAttentionOfWorkflowPanel cm = new EmployeeContractAttentionOfWorkflowPanel();
			id = cm.getID();
			return cm;
		}
		...
		public String getDescription() {
			return "EmployeeContractAttentionOfWorkflow";
		}
	...
	public boolean checkSearchCriteria(Map criteria) {
		if (null != criteria.get("employeeId")) {
			criteria.put("employeeName", criteria.get("employeeId"));
		}
	...
	public SearchForm generateSearchForm() {
		return new EmployeeContractAttentionOfWorkflowSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSEmployeeContractAttentionOfWorkflow.getInstance();
	}
