...
public class TravelReimbursementsPrePrintPanel extends AbstractPrint {
	...
	public static final String MAIN_TITLE = "前期项目差旅报销";
	...
	public HTML generatePrintHTML() {
		...
		List<Map> childTwo = (List<Map>) map.get("detailTravelReimbursementLinkMainProject");
