...
import com.pomplatform.client.workflow.form.ApplicationFilingSearchForm;
import com.pomplatform.client.workflow.form.ApplicationFilingViewer;
import com.pomplatform.client.workflow.form.NewApplicationFilingForm;
import com.pomplatform.client.workflow.form.UpdateApplicationFilingForm;
...
public class ApplicationFilingPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			ApplicationFilingPanel cm = new ApplicationFilingPanel();
			id = cm.getID();
			return cm;
		}
	...
	public void initComponents() {
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						NewApplicationFilingForm detailForm = new NewApplicationFilingForm();
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateApplicationFilingForm detailForm = new UpdateApplicationFilingForm();
		...
		removeButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				DBDataSource.callOperation("ST_ApplicationFiling", "delete", selected.toMap(), new DSCallback() {
					@Override
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("ApplicationFiling"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				ApplicationFilingViewer detailForm = new ApplicationFilingViewer();
	...
	public SearchForm generateSearchForm() {
		return new ApplicationFilingSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSApplicationFiling.getInstance();
	}
