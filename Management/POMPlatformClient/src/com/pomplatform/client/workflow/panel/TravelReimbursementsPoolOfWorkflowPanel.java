...
import com.pomplatform.client.workflow.datasource.DSTravelReimbursementsPoolOfWorkflow;
import com.pomplatform.client.workflow.form.TravelReimbursementsPoolOfWorkflowSearchForm;
...
public class TravelReimbursementsPoolOfWorkflowPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			TravelReimbursementsPoolOfWorkflowPanel cm = new TravelReimbursementsPoolOfWorkflowPanel();
			id = cm.getID();
			return cm;
		}
		...
		public String getDescription() {
			return "TravelReimbursementsPoolOfWorkflow";
		}
	...
	public SearchForm generateSearchForm() {
		return new TravelReimbursementsPoolOfWorkflowSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSTravelReimbursementsPoolOfWorkflow.getInstance();
	}
