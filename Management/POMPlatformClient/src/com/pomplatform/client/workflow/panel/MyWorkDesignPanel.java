...
public class MyWorkDesignPanel extends AbstractWizadPage {
	...
	//定义模块类型
  	...
  	//定义流程类型
  	public static final int PROCESS_TYPE_78 = 78;//我的出图
  	public static final int PROCESS_TYPE_81 = 81;//配合申请
  	public static final int PROCESS_TYPE_82 = 82;//结算申请
...
//    	myBackLayout.addMember(myBackGrid);
    ...
    public void startEdit() {
    	...
    	param.put("parentProcessTypeId",PomPlatformClientUtil.PARENT_PROCESS_TYPE_5);
...
/*    	Record[] mybackData = new Record[myBackMap.size()];
    ...
    public void operPanel(int activityType,int processType,String code){
        ...
        switch(processType){
        case PROCESS_TYPE_78://我的出图
        	popupWindow.setTitle("我的出图");
        	break;
        case PROCESS_TYPE_81://配合申请
        	popupWindow.setTitle("配合申请");
        	break;
		case PROCESS_TYPE_82://结算申请
        	popupWindow.setTitle("结算申请");
        	break;
        default:
        	break;
        }
    	if(ACTIVITY_TYPE_1 == activityType ){
        	...
        	auditPanel.setParentProcessType("spt.parent_process_type_id = 77");
    ...
    public void getViewPanel() {
		Map<String,String> processIdMap = PomPlatformClientUtil.getUserProcessId(PomPlatformClientUtil.PARENT_PROCESS_TYPE_5);
		Map<String,String> processIconMap = PomPlatformClientUtil.getUserProcessIcon(PomPlatformClientUtil.PARENT_PROCESS_TYPE_5);
