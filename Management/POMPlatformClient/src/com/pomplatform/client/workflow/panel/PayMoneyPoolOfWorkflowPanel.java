...
import com.pomplatform.client.workflow.datasource.DSPayMoneyPoolOfWorkflow;
import com.pomplatform.client.workflow.form.PayMoneyPoolOfWorkflowSearchForm;
...
public class PayMoneyPoolOfWorkflowPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			PayMoneyPoolOfWorkflowPanel cm = new PayMoneyPoolOfWorkflowPanel();
			id = cm.getID();
			return cm;
		}
	...
	public SearchForm generateSearchForm() {
		return new PayMoneyPoolOfWorkflowSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSPayMoneyPoolOfWorkflow.getInstance();
	}
