...
public class UpdateCompanyNormalReimbursementForm extends GenericWizadWindow
{
	...
	public List<AbstractWizadPage> getPages(){
		...
		res.add(new CompanyNormalReimbursementUpdateForm());
		...
		CompanyNormalReimbursementLinkDepartmentPanel normalreimbursementlinkdepartment = new CompanyNormalReimbursementLinkDepartmentPanel();
