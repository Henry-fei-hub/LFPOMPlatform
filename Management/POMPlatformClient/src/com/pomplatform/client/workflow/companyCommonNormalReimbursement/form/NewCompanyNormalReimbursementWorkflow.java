...
public class NewCompanyNormalReimbursementWorkflow extends AbstractProcessPanel
{
	...
	public List<AbstractWizadPage> getPages(){
		...
		final CompanyNormalReimbursementNewForm main = new CompanyNormalReimbursementNewForm();
        main.setProcessId(getProcessId());
        res.add(main);
		final CompanyProjectNormalReimbursementDetailPanel detail = new CompanyProjectNormalReimbursementDetailPanel();
