...
public class CompanyNormalReimbursementLinkDepartmentViewer extends AbstractDetailViewer
{




	public CompanyNormalReimbursementLinkDepartmentViewer() {
	}
	...
	public void load() {
		...
		params.put("normalReimbursementLinkDepartmentId", getBusinessId());
		DBDataSource.callOperation("ST_NormalReimbursementLinkDepartment", "find", new DSCallback() {
			@Override
