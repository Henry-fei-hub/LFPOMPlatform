...
public class CompanyNormalReimbursementPrintPanel extends AbstractPrint {

	private static final Logger __LOGGER = Logger.getLogger("");
	
	public static final String[] HEAD_ABELS = {"付款单位:", "报销单号:", "部&nbsp;&nbsp;门:", "申请日期:", "报 销 人:", "单位:"};

	public static final String[] MAIN_ABELS = { "起草人", "主题", "收款单位", "报销金额", "冲账金额", "实付金额" };
	...
	public HTML generatePrintHTML() {
		...
		List<Map> childTwo = (List<Map>) map.get("detailNormalReimbursementLinkDepartment");
...
//		}
	...
	public static VerticalPanel generateMianData(Map map) {
		...
		String receiveUnitManageId = ClientUtil.getStringFromMapNotNull(map,"receiveUnitManageId");
		...
		orderItemContent.setText(count, 2, KeyValueManager.getValueMap("receive_unit_manages_company").get(receiveUnitManageId));
		orderItemContent.setText(count, 3, __NF.format(amount));
//		orderItemContent.setText(count, 4, "true".equals(map.get("strikeABalance").toString()) ? "是" : "否");
		orderItemContent.setText(count, 4, __NF.format(balanceAmount));
		orderItemContent.setText(count, 5, __NF.format(amount - balanceAmount));
		vl.add(orderItemContent);
