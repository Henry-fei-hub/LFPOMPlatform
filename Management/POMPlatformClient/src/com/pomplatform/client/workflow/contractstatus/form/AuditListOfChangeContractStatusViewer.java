...
public class AuditListOfChangeContractStatusViewer extends AbstractDetailViewer
{
	...
	public AuditListOfChangeContractStatusViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_AuditListOfChangeContractStatus", "find", new DSCallback() {
			@Override
