...
public class AttentionListOfChangeContractStatusViewer extends AbstractDetailViewer
{
	...
	public AttentionListOfChangeContractStatusViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_AttentionListOfChangeContractStatus", "find", new DSCallback() {
			@Override
