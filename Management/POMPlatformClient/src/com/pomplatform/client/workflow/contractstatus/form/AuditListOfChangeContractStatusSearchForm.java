...
import com.pomplatform.client.workflow.contractstatus.datasource.CDAuditListOfChangeContractStatus;
...
public class AuditListOfChangeContractStatusSearchForm extends SearchForm
{
	...
	public AuditListOfChangeContractStatusSearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDAuditListOfChangeContractStatus.getInstance());
		...
		setItems(employeeIdItem, statusItem, processTypeItem, contractCodeItem, contractNameItem, operatorItem, contentItem);
