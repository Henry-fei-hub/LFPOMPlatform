...
public class ApplyListOfChangeContractStatusViewer extends AbstractDetailViewer
{
	...
	public ApplyListOfChangeContractStatusViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ApplyListOfChangeContractStatus", "find", new DSCallback() {
			@Override
