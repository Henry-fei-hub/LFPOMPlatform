...
public class AuditListOfEmployeeOnboardSearchForm extends SearchForm
{
	...
	public AuditListOfEmployeeOnboardSearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDAuditListOfEmployeeOnboard.getInstance());
