...
public class DSAuditListOfEmployeeOnboard extends DBDataSource
{


	public static DSAuditListOfEmployeeOnboard instance = null;

	public static DSAuditListOfEmployeeOnboard getInstance() {
		if(instance == null) {
			instance = new DSAuditListOfEmployeeOnboard("DSAuditListOfEmployeeOnboard");
		}
		return instance;
	}
	...
	public DSAuditListOfEmployeeOnboard(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("AuditListOfEmployeeOnboard");
		...
		setFields(processInstanceIdField, processInstanceActivityIdField, businessIdField, businessNameField, processActivityIdField, processIdField, nodeTypeField, activityIdField, nextActivityIdField, mainActivityIdField, instanceActivityCreateTimeField, instanceActivityStartTimeField, processTypeField, employeeNoField, employeeNameField, onboardDateField, ownedCompanyField, departmentIdField, dutyIdField,applyEmployeeIdField, operateTimeField, statusField, processCommentField, activityTypeField, backViewNameField);
	}
