...
public class OnLoadRefuseListOfPersonnelViewer extends AbstractDetailViewer
{
	...
	public OnLoadRefuseListOfPersonnelViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadRefuseListOfPersonnel", "find", new DSCallback() {
			@Override
