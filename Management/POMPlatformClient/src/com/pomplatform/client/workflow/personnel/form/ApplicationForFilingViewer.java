...
public class ApplicationForFilingViewer extends AbstractDetailViewer
{

	private SearchForm __parentSearchForm;


	public ApplicationForFilingViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ApplicationForFiling", "find", new DSCallback() {
			@Override
