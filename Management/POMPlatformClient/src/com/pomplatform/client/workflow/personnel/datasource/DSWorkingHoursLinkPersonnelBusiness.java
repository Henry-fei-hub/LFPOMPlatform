...
public class DSWorkingHoursLinkPersonnelBusiness extends DBDataSource
{


	public static DSWorkingHoursLinkPersonnelBusiness instance = null;

	public static DSWorkingHoursLinkPersonnelBusiness getInstance() {
		if(instance == null) {
			instance = new DSWorkingHoursLinkPersonnelBusiness("DSWorkingHoursLinkPersonnelBusiness");
		}
		return instance;
	}
	...
	public DSWorkingHoursLinkPersonnelBusiness(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("WorkingHoursLinkPersonnelBusiness");
