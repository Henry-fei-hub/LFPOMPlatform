...
public class DSOnLoadTaskListOfPersonnel extends DBDataSource {

	public static DSOnLoadTaskListOfPersonnel instance = null;

	public static DSOnLoadTaskListOfPersonnel getInstance() {
		if (instance == null) {
			instance = new DSOnLoadTaskListOfPersonnel("DSOnLoadTaskListOfPersonnel");
		}
		return instance;
	}
	...
	public DSOnLoadTaskListOfPersonnel(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("OnLoadTaskListOfPersonnel");
		...
		activityTypeField = new DataSourceIntegerField("activityType", "");
		...
		setFields(processPooledTaskIdField, businessIdField, businessNameField, processActivityIdField, processIdField,
				processInstanceIdField, backViewNameField, nodeTypeField, activityIdField,
				...
				provideAccommodationField, livingExpensesField, housingFinanceField, empStatusField, activityTypeField,
				cardField, reasonField, remarkField, createTimeField);
	}
