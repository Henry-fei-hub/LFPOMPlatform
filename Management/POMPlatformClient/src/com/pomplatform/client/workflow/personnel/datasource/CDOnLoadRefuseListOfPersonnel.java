...
public class CDOnLoadRefuseListOfPersonnel extends DataSource
{


	public static CDOnLoadRefuseListOfPersonnel instance = null;

	public static CDOnLoadRefuseListOfPersonnel getInstance() {
		if(instance == null) {
			instance = new CDOnLoadRefuseListOfPersonnel("CDOnLoadRefuseListOfPersonnel");
		}
		return instance;
	}
	...
	public CDOnLoadRefuseListOfPersonnel(String dataSourceID) {
		...
		statusField = new DataSourceIntegerField("status", "流程状态");
