...
public class DSMyAuditListOfPersonnel extends DBDataSource {

	public static DSMyAuditListOfPersonnel instance = null;

	public static DSMyAuditListOfPersonnel getInstance() {
		if (instance == null) {
			instance = new DSMyAuditListOfPersonnel("DSMyAuditListOfPersonnel");
		}
		return instance;
	}
	...
	public DSMyAuditListOfPersonnel(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("MyAuditListOfPersonnel");
		...
		statusField = new DataSourceIntegerField("status", "审批结果");
		...
		parentIdField = new DataSourceIntegerField("parentId", "");
		...
		setFields(processInstanceActivityIdField, businessIdField, businessNameField, processActivityIdField,
				processIdField, processInstanceIdField, nodeTypeField, activityIdField, nextActivityIdField,
				mainActivityIdField, instanceActivityCreateTimeField, instanceActivityStartTimeField, operateTimeField,
				processCommentField, statusField, personnelBusinessIdField, processTypeField, employeeIdField,
				employeeNoField, departmentIdField, companyIdField, typeField, startDateField, startDateDetailField,
				endDateField, endDateDetailField, daysField, addressField, planField, transportationField, feeField,
				unitField, contactPersonField, deleteFlagField, nextAuditorField, subTypeField, hoursField,
				companyProvinceField, targetProvinceField, numberOfBabyField, attachmentField, isCompletedField,
				subTypeStrField, projectTypeField, projectIdField, projectNameField, projectCodeField, parentIdField,
				isRemoteCityField, provideAccommodationField, livingExpensesField, housingFinanceField, empStatusField,
				backViewNameField, cardField, reasonField, remarkField, createTimeField);
	}
