...
import com.pomplatform.client.workflow.personnel.datasource.DSOnLoadTaskListOfPersonnel;
import com.pomplatform.client.workflow.personnel.form.OnLoadTaskListOfPersonnelSearchForm;
...
public class OnLoadTaskListOfPersonnelPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			OnLoadTaskListOfPersonnelPanel cm = new OnLoadTaskListOfPersonnelPanel();
			id = cm.getID();
			return cm;
		}
		...
		public String getDescription() {
			return "OnLoadTaskListOfPersonnel";
		}
	...
	public SearchForm generateSearchForm() {
		return new OnLoadTaskListOfPersonnelSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSOnLoadTaskListOfPersonnel.getInstance();
	}
	...
	public void afterDataReceived(Record[] data) {
		...
		case MyPersonnelFlowDesignPanel.PROCESS_TYPE_14://出差申请
			showFields = "employeeIdField, employeeNoField, departmentIdField, companyIdField, startDateField, endDateField, daysField,"
					+ "reasonField, remarkField, addressField, planField, transportationField, createTimeField, empStatusField";
		...
		case MyPersonnelFlowDesignPanel.PROCESS_TYPE_16://外出申请
			showFields = "employeeIdField, employeeNoField, departmentIdField, companyIdField, contactPersonField, startDateField, endDateField, daysField,"
					+ "reasonField, remarkField, addressField, planField, transportationField, feeField, unitField, createTimeField, empStatusField";
			ClientUtil.formatDateTime(resultGrid, "startDateField,endDateField", 1);
			break;
		...
		case MyPersonnelFlowDesignPanel.PROCESS_TYPE_21://项目派驻申请
			showFields = "employeeIdField, employeeNoField, departmentIdField, companyIdField, startDateField, endDateField, reasonField, remarkField,"
					+ "createTimeField, projectNameField, projectCodeField";
			break;
		...
		case MyPersonnelFlowDesignPanel.PROCESS_TYPE_23://项目派驻确认申请
			showFields = "employeeIdField, employeeNoField, departmentIdField, companyIdField, startDateField, endDateField, remarkField,"
					+ "attachmentField, projectNameField, projectCodeField, createTimeField";
			break;
		...
		case MyPersonnelFlowDesignPanel.PROCESS_TYPE_27://确认函申请
			showFields = "employeeIdField, employeeNoField, departmentIdField, companyIdField, reasonField, attachmentField, feeField, planField,"
