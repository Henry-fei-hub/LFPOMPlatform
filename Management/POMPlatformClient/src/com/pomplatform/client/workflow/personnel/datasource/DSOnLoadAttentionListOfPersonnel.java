...
public class DSOnLoadAttentionListOfPersonnel extends DBDataSource {

	public static DSOnLoadAttentionListOfPersonnel instance = null;

	public static DSOnLoadAttentionListOfPersonnel getInstance() {
		if (instance == null) {
			instance = new DSOnLoadAttentionListOfPersonnel("DSOnLoadAttentionListOfPersonnel");
		}
		return instance;
	}
	...
	public DSOnLoadAttentionListOfPersonnel(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("OnLoadAttentionListOfPersonnel");
		...
		setFields(systemProcessAttentionIdField, businessIdField, businessNameField, processActivityIdField,
				...
				instanceActivityCreateTimeField, instanceActivityStartTimeField, statusField, operateTimeField,
				processCommentField, personnelBusinessIdField, processTypeField, employeeIdField, employeeNoField,
				departmentIdField, companyIdField, typeField, startDateField, startDateDetailField, endDateField,
				endDateDetailField, daysField, addressField, planField, transportationField, feeField, unitField,
				...
				provideAccommodationField, livingExpensesField, housingFinanceField, empStatusField, cardField,
