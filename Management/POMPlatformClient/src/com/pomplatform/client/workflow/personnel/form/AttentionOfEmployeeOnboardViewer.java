...
public class AttentionOfEmployeeOnboardViewer extends AbstractDetailViewer
{
	...
	public AttentionOfEmployeeOnboardViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_AttentionOfEmployeeOnboard", "find", new DSCallback() {
			@Override
