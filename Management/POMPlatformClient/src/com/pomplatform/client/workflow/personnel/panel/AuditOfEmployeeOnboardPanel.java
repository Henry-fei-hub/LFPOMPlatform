...
import com.pomplatform.client.workflow.personnel.datasource.DSAuditListOfEmployeeOnboard;
import com.pomplatform.client.workflow.personnel.datasource.DSAuditOfEmployeeOnboard;
import com.pomplatform.client.workflow.personnel.form.AuditOfEmployeeOnboardSearchForm;
...
public class AuditOfEmployeeOnboardPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			AuditOfEmployeeOnboardPanel cm = new AuditOfEmployeeOnboardPanel();
			id = cm.getID();
			return cm;
		}
