...
public class OnLoadAttentionListOfPersonnelSearchForm extends SearchForm
{
	...
	public OnLoadAttentionListOfPersonnelSearchForm() {
		setWidth100();
		setHeight100();
		...
		setItems(statusItem, processTypeItem, employeeIdItem, companyIdItem, employeeNameItem, employeeNoItem, departmentIdItem);
