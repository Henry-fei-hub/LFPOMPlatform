...
public class ApplicationInForFilingViewer extends AbstractDetailViewer
{
	...
	public ApplicationInForFilingViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ApplicationInForFiling", "find", new DSCallback() {
			@Override
