...
public class OnLoadAttentionListOfPersonnelViewer extends AbstractDetailViewer
{
	...
	public OnLoadAttentionListOfPersonnelViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadAttentionListOfPersonnel", "find", new DSCallback() {
			@Override
