...
public class OnLoadApplyListOfPersonnelViewer extends AbstractDetailViewer
{
	...
	public OnLoadApplyListOfPersonnelViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadApplyListOfPersonnel", "find", new DSCallback() {
			@Override
