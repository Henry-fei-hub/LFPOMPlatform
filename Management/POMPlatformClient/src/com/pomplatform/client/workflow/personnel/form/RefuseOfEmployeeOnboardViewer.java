...
public class RefuseOfEmployeeOnboardViewer extends AbstractDetailViewer
{
	...
	public RefuseOfEmployeeOnboardViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_RefuseOfEmployeeOnboard", "find", new DSCallback() {
			@Override
