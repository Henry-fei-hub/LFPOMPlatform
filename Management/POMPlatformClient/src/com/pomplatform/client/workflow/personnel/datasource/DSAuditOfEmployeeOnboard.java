...
public class DSAuditOfEmployeeOnboard extends DBDataSource
{


	public static DSAuditOfEmployeeOnboard instance = null;

	public static DSAuditOfEmployeeOnboard getInstance() {
		if(instance == null) {
			instance = new DSAuditOfEmployeeOnboard("DSAuditOfEmployeeOnboard");
		}
		return instance;
	}
	...
	public DSAuditOfEmployeeOnboard(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("AuditOfEmployeeOnboard");
