...
public class TaskOfEmployeeOnboardViewer extends AbstractDetailViewer
{
	...
	public TaskOfEmployeeOnboardViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_TaskOfEmployeeOnboard", "find", new DSCallback() {
			@Override
