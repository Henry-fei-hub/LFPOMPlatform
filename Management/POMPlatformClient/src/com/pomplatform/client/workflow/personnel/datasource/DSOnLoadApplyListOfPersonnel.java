...
public class DSOnLoadApplyListOfPersonnel extends DBDataSource {

	public static DSOnLoadApplyListOfPersonnel instance = null;

	public static DSOnLoadApplyListOfPersonnel getInstance() {
		if (instance == null) {
			instance = new DSOnLoadApplyListOfPersonnel("DSOnLoadApplyListOfPersonnel");
		}
		return instance;
	}
	...
	public DSOnLoadApplyListOfPersonnel(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("OnLoadApplyListOfPersonnel");
		...
		setFields(processInstanceIdField, personnelBusinessIdField, businessIdField, businessNameField, processIdField,
				processInstanceActivityIdField, processStatusField, completeTimeField, processTypeField,
				employeeIdField, employeeNoField, empStatusField, departmentIdField, companyIdField, typeField,
				subTypeField, subTypeStrField, startDateField, startDateDetailField, endDateField, endDateDetailField,
				daysField, hoursField, projectIdField, companyProvinceField, targetProvinceField, numberOfBabyField,
				attachmentField, addressField, planField, transportationField, feeField, unitField, contactPersonField,
				deleteFlagField, nextAuditorField, projectTypeField, projectNameField, projectCodeField, parentIdField,
				isRemoteCityField, provideAccommodationField, livingExpensesField, housingFinanceField, cardField,
