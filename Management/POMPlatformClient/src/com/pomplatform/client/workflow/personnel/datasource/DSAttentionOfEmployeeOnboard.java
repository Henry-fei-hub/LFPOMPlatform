...
public class DSAttentionOfEmployeeOnboard extends DBDataSource
{


	public static DSAttentionOfEmployeeOnboard instance = null;

	public static DSAttentionOfEmployeeOnboard getInstance() {
		if(instance == null) {
			instance = new DSAttentionOfEmployeeOnboard("DSAttentionOfEmployeeOnboard");
		}
		return instance;
	}
	...
	public DSAttentionOfEmployeeOnboard(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("AttentionOfEmployeeOnboard");
		...
		setFields(systemProcessAttentionIdField, processTypeField, businessIdField, businessNameField, processActivityIdField, processIdField, processInstanceIdField, backViewNameField, instanceActivityIdField, instanceActivityCreateTimeField, instanceActivityStartTimeField, operateTimeField, employeeNoField, employeeNameField, onboardDateField, ownedCompanyField, departmentIdField, dutyIdField, applyEmployeeIdField, empStatusField, statusField, processCommentField);
	}
