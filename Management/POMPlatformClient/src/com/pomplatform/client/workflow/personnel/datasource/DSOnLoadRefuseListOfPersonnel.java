...
public class DSOnLoadRefuseListOfPersonnel extends DBDataSource {

	public static DSOnLoadRefuseListOfPersonnel instance = null;

	public static DSOnLoadRefuseListOfPersonnel getInstance() {
		if (instance == null) {
			instance = new DSOnLoadRefuseListOfPersonnel("DSOnLoadRefuseListOfPersonnel");
		}
		return instance;
	}
	...
	public DSOnLoadRefuseListOfPersonnel(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("OnLoadRefuseListOfPersonnel");
		...
		setFields(processStatusField,processInstanceIdField, businessIdField, businessNameField, processIdField,
				processInstanceActivityIdField,  completeTimeField, personnelBusinessIdField,
				processTypeField, employeeIdField, employeeNoField, departmentIdField, companyIdField, typeField,
				startDateField, startDateDetailField, endDateField, endDateDetailField, daysField, addressField,
				planField, transportationField, feeField, unitField, contactPersonField, deleteFlagField,
				nextAuditorField, subTypeField, hoursField, companyProvinceField, targetProvinceField,
				numberOfBabyField, attachmentField, isCompletedField, subTypeStrField, projectTypeField, projectIdField,
				projectNameField, projectCodeField, parentIdField, isRemoteCityField, provideAccommodationField,
				livingExpensesField, housingFinanceField, empStatusField, cardField, reasonField, remarkField,
				createTimeField);
	}
