...
public class DSOnLoadAuditListOfPersonnel extends DBDataSource {

	public static DSOnLoadAuditListOfPersonnel instance = null;

	public static DSOnLoadAuditListOfPersonnel getInstance() {
		if (instance == null) {
			instance = new DSOnLoadAuditListOfPersonnel("DSOnLoadAuditListOfPersonnel");
		}
		return instance;
	}
	...
	public DSOnLoadAuditListOfPersonnel(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("OnLoadAuditListOfPersonnel");
		...
		setFields(processInstanceActivityIdField, businessIdField, businessNameField, processActivityIdField,
				...
				processCommentField, statusField, activityTypeField, personnelBusinessIdField, processTypeField,
				employeeIdField, employeeNoField, departmentIdField, companyIdField, typeField, startDateField,
				startDateDetailField, endDateField, endDateDetailField, daysField, addressField, planField,
				transportationField, feeField, unitField, contactPersonField, nextAuditorField, subTypeField,
				hoursField, companyProvinceField, targetProvinceField, numberOfBabyField, attachmentField,
				isCompletedField, subTypeStrField, projectTypeField, projectIdField, projectNameField, projectCodeField,
				parentIdField, isRemoteCityField, provideAccommodationField, livingExpensesField, housingFinanceField,
				empStatusField, cardField, reasonField, remarkField, createTimeField, deleteFlagField, stageIdField);
	}
