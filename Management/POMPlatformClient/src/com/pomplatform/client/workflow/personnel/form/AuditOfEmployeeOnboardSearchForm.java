...
import com.pomplatform.client.workflow.personnel.datasource.CDAuditOfEmployeeOnboard;

public class AuditOfEmployeeOnboardSearchForm extends SearchForm
{
	...
	public AuditOfEmployeeOnboardSearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDAuditOfEmployeeOnboard.getInstance());
