...
public class OnLoadApplyListOfPersonnelSearchForm extends SearchForm
{
	...
	public OnLoadApplyListOfPersonnelSearchForm() {
		setWidth100();
		setHeight100();
		...
		setItems(processTypeItem, employeeIdItem, companyIdItem, employeeNameItem, employeeNoItem, departmentIdItem);
