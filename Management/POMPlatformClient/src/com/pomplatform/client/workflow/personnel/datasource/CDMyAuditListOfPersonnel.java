...
public class CDMyAuditListOfPersonnel extends DataSource
{


	public static CDMyAuditListOfPersonnel instance = null;

	public static CDMyAuditListOfPersonnel getInstance() {
		if(instance == null) {
			instance = new CDMyAuditListOfPersonnel("CDMyAuditListOfPersonnel");
		}
		return instance;
	}
	...
	public CDMyAuditListOfPersonnel(String dataSourceID) {
