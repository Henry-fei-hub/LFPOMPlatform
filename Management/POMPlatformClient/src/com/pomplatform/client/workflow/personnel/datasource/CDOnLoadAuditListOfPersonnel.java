...
public class CDOnLoadAuditListOfPersonnel extends DataSource
{


	public static CDOnLoadAuditListOfPersonnel instance = null;

	public static CDOnLoadAuditListOfPersonnel getInstance() {
		if(instance == null) {
			instance = new CDOnLoadAuditListOfPersonnel("CDOnLoadAuditListOfPersonnel");
		}
		return instance;
	}
	...
	public CDOnLoadAuditListOfPersonnel(String dataSourceID) {
