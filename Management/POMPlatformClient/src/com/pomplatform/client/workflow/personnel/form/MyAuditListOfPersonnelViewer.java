...
public class MyAuditListOfPersonnelViewer extends AbstractDetailViewer
{
	...
	public MyAuditListOfPersonnelViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_MyAuditListOfPersonnel", "find", new DSCallback() {
			@Override
