...
import com.pomplatform.client.workflow.personnel.datasource.DSApplyOfEmployeeOnboard;
import com.pomplatform.client.workflow.personnel.form.ApplyOfEmployeeOnboardSearchForm;
...
public class ApplyOfEmployeeOnboardPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			ApplyOfEmployeeOnboardPanel cm = new ApplyOfEmployeeOnboardPanel();
			id = cm.getID();
			return cm;
		}
...
//		commonQuery();
	...
	public boolean checkSearchCriteria(Map criteria) {
		criteria.put("applyEmployeeId", ClientUtil.getUserId());
	...
	public SearchForm generateSearchForm() {
		return new ApplyOfEmployeeOnboardSearchForm();
	}
	...
	public DataSource getDataSource() {
		...
		return DSApplyOfEmployeeOnboard.getInstance();
	}
