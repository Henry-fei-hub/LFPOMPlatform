...
public class CDAuditListOfEmployeeOnboard extends DataSource
{


	public static CDAuditListOfEmployeeOnboard instance = null;

	public static CDAuditListOfEmployeeOnboard getInstance() {
		if(instance == null) {
			instance = new CDAuditListOfEmployeeOnboard("CDAuditListOfEmployeeOnboard");
		}
		return instance;
	}
	...
	public CDAuditListOfEmployeeOnboard(String dataSourceID) {
		...
		setFields(processTypeField, statusField, employeeIdField, ownedCompanyField, departmentIdField, employeeNameField, employeeNoField, currentPageField, pageLinesField);
