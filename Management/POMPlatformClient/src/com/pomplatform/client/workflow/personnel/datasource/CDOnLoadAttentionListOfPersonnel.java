...
public class CDOnLoadAttentionListOfPersonnel extends DataSource
{


	public static CDOnLoadAttentionListOfPersonnel instance = null;

	public static CDOnLoadAttentionListOfPersonnel getInstance() {
		if(instance == null) {
			instance = new CDOnLoadAttentionListOfPersonnel("CDOnLoadAttentionListOfPersonnel");
		}
		return instance;
	}
	...
	public CDOnLoadAttentionListOfPersonnel(String dataSourceID) {
