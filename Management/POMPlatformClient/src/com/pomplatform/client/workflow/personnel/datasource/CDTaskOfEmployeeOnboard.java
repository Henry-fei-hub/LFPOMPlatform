...
public class CDTaskOfEmployeeOnboard extends DataSource
{


	public static CDTaskOfEmployeeOnboard instance = null;

	public static CDTaskOfEmployeeOnboard getInstance() {
		if(instance == null) {
			instance = new CDTaskOfEmployeeOnboard("CDTaskOfEmployeeOnboard");
		}
		return instance;
	}
	...
	public CDTaskOfEmployeeOnboard(String dataSourceID) {
