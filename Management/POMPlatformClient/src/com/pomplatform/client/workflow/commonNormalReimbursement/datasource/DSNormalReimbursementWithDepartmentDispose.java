...
//订单下达审批流程处理节点使用
public class DSNormalReimbursementWithDepartmentDispose extends DBDataSource
{


	public static DSNormalReimbursementWithDepartmentDispose instance = null;

	public static DSNormalReimbursementWithDepartmentDispose getInstance() {
		if(instance == null) {
			instance = new DSNormalReimbursementWithDepartmentDispose("DSNormalReimbursementWithDepartment");
		}
		return instance;
	}
	...
	public DSNormalReimbursementWithDepartmentDispose(String dataSourceID) {
		...
		reimbursementTypeField.setValueMap(KeyValueManager.getValueMap("system_dictionary_246"));
		...
		attachmentNameField = new DataSourceTextField("fileName", "附件名称");
		...
		feeTypeField = new DataSourceIntegerField("feeType", "报销费用类型");
		feeTypeField.setLength(11);
		feeTypeField.setRequired(false);
		feeTypeField.setHidden(false);
		feeTypeField.setValueMap(KeyValueManager.getValueMap("system_dictionary_86"));
		...
		setFields(projectNormalReimbursementIdField, codeField, reimbursementNameField, processInstanceIdField, applyEmployeeIdField, employeeIdField, departmentIdField, companyIdField, reimbursementTimeField, statusField, amountField, whiteStripField,currencyField, exchangeRateField, feeTypeField, applyTimeField, completeTimeField,reimbursementTypeField, remarkField, strikeABalanceField, attachmentNameField, attachmentField, attachmentNumberField, attachmentIdField, isProjectField, detailProjectNormalReimbursementDetail, detailNormalReimbursementLinkDepartment,relatedToContractField,contractAmountField,receiveUnitIdField,purchaserDepartmentField,purchaserField,purchasingCategoryField);
	}
