...
public class UpdateNormalReimbursementWithDepartmentWorkflow extends AbstractProcessPanel {
	...
	public List<AbstractWizadPage> getPages() {
		...
		NormalReimbursementWithDepartmentUpdateForm main = new NormalReimbursementWithDepartmentUpdateForm();
		...
		NormalReimbursementLinkDepartmentPanel link = null;
		if (null == processName) {
			link = new NormalReimbursementLinkDepartmentPanel(true, processName);
		} else {
			// 编辑进项税和成本的面板
			link = new NormalReimbursementLinkDepartmentPanel(true, processName);
		}
		link.setProcessType(3);
