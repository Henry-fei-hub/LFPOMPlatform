...
public class DSNormalReimbursementWithDepartment extends DBDataSource
{


	public static DSNormalReimbursementWithDepartment instance = null;

	public static DSNormalReimbursementWithDepartment getInstance() {
		if(instance == null) {
			instance = new DSNormalReimbursementWithDepartment("DSNormalReimbursementWithDepartment");
		}
		return instance;
	}
	...
	public DSNormalReimbursementWithDepartment(String dataSourceID) {
