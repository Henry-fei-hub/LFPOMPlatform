...
public class NewNormalReimbursementWithDepartmentForm extends GenericWizadWindow
{
	...
	public List<AbstractWizadPage> getPages(){
		...
		res.add(new NormalReimbursementWithDepartmentNewForm());
		res.add(new ProjectNormalReimbursementDetailPanel());
		res.add(new NormalReimbursementLinkDepartmentPanel());
		return res;
	}
