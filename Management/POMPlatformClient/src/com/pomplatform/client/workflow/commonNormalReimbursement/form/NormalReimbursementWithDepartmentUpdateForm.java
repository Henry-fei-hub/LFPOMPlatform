...
public class NormalReimbursementWithDepartmentUpdateForm extends AbstractWizadPage
{
	...
	public NormalReimbursementWithDepartmentUpdateForm() {
		...
		reimbursementTypeItem.setDefaultValue(0);
