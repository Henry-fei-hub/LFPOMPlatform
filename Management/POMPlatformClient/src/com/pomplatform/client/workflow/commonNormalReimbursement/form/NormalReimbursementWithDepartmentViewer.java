...
public class NormalReimbursementWithDepartmentViewer extends AbstractDetailViewer
{
	...
	public NormalReimbursementWithDepartmentViewer() {
	}
	...
	public void initComponents() {
		...
		normalReimbursementLinkDepartmentsGrid.addDoubleClickHandler(new DoubleClickHandler(){
			...
			public void onDoubleClick(DoubleClickEvent event) {
				...
				detail.setTitle("");
				detail.setWidth(700); detail.setHeight(500); 
				NormalReimbursementLinkDepartmentViewer viewer = new NormalReimbursementLinkDepartmentViewer();
				viewer.setLayoutMode(AbstractDetailViewer.COMPONENT_LAYOUT_NORMAL);
				viewer.initComponents();
				viewer.viewSelectedData((ListGrid)event.getSource());
				detail.setContent(viewer);
