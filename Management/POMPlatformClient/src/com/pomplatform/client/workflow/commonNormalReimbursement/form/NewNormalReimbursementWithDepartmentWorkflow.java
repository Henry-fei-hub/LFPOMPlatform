...
public class NewNormalReimbursementWithDepartmentWorkflow extends AbstractProcessPanel
{
	...
	public List<AbstractWizadPage> getPages(){
		...
		final NormalReimbursementWithDepartmentNewForm main = new NormalReimbursementWithDepartmentNewForm();
        if(initData!=null) {
        ...
        detail.setTitle("普通日常报销费用清单");
        res.add(detail);
        final NormalReimbursementLinkDepartmentPanel link = new NormalReimbursementLinkDepartmentPanel(true, null);
        if(initData!=null) {
        ...
        if(initData!=null) {
            ...
            initData.setAttribute("processType", 3);
            pblPanel.setBudgetRecord(initData);
