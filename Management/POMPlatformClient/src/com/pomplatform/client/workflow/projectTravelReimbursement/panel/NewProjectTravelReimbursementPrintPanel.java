...
public class NewProjectTravelReimbursementPrintPanel extends AbstractPrint {
	...
	public static final String MAIN_TITLE = "项目差旅报销";
...
//		Record record = getProcessInformation();
		...
		List<Map> childTwo = (List<Map>) map.get("detailTravelReimbursementLinkProject");
