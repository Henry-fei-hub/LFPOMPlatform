...
public class UpdateNewProjectTravelReimbursementWorkflow extends AbstractProcessPanel
{
	...
	public List<AbstractWizadPage> getPages(){
		...
		final NewProjectTravelReimbursementUpdateForm main = new NewProjectTravelReimbursementUpdateForm();
		...
		res.add(detail);
		TravelReimbursementLinkProjectDetail link = null;
		if(null == processName){
			link = new TravelReimbursementLinkProjectDetail(true, processName);
		}else{
			link = new TravelReimbursementLinkProjectDetail(true, processName);
		}
		link.setProcessType(4);
