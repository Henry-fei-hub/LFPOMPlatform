...
public class TravelReimbursementDetailViewer extends AbstractDetailViewer
{




	public TravelReimbursementDetailViewer() {
	}
	...
	public void load() {
		...
		params.put("travelReimbursementDetailId", getBusinessId());
		DBDataSource.callOperation("ST_TravelReimbursementDetail", "find", new DSCallback() {
			@Override
	...
	public DataSource getMainDataSource() {
		return DSTravelReimbursementDetail.getInstance();
	}
