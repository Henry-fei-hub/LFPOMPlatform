...
public class NewProjectTravelReimbursementUpdateForm extends AbstractWizadPage
{
	...
	public NewProjectTravelReimbursementUpdateForm() {
		String employeeId = ClientUtil.getUserId();
		Map<String,String> map = new HashMap<>();
		map.put("employeeId", employeeId);
		
		DSNewProjectTravelReimbursement ds = DSNewProjectTravelReimbursement.getInstance();
		__form.setWidth100();
		__form.setHeight100();
		...
		projectIdItem = new SelectItem("projectId", "报销项目");
...
//		KeyValueManager.loadValueMap("projects",projectIdItem);
		...
		payseqIButItem=new ButtonItem("付款序列");
		payseqIButItem.hide();
		payseqIButItem.addClickHandler(new com.smartgwt.client.widgets.form.fields.events.ClickHandler() {
			...
			public void onClick(com.smartgwt.client.widgets.form.fields.events.ClickEvent event) {
				...
				payseqPanel.setRecord(getRecord());
				payseqPanel.init();
		...
		purchaserDepartmentItem = new PickTreeItem("departmentTree", "报销部门");
	...
	public void setValueManage(ValuesManager manager) {
		manager.setDataSource(DSNewProjectTravelReimbursement.getInstance());
