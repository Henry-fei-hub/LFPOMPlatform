...
public class TravelReimbursementLinkProjectViewer extends AbstractDetailViewer
{




	public TravelReimbursementLinkProjectViewer() {
	}
	...
	public void load() {
		...
		params.put("travelReimbursementLinkProjectId", getBusinessId());
		DBDataSource.callOperation("ST_TravelReimbursementLinkProject", "find", new DSCallback() {
			@Override
