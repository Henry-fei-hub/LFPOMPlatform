...
public class NewBudgetManagementWorkFlowWorkflow extends AbstractProcessPanel
{
	...
	public List<AbstractWizadPage> getPages(){
		...
		BudgetManagementWorkFlowNewForm panel=new BudgetManagementWorkFlowNewForm();
		...
		BudgetManagementLinkProcessPanel alrPanel = new BudgetManagementLinkProcessPanel(true);
		alrPanel.setMainPanel(panel);
		res.add(panel);
		res.add(alrPanel);
		return res;
	}
	...
	public Map getValues() {
		...
		for (AbstractWizadPage p : __pages) {
			...
			Object mainValue = map.get("mainValue");
			Object detailBudgetManagementDetail = map.get("detailBudgetManagementDetail");
			Object detailBudgetProess = map.get("detailBudgetProess");
			if(!BaseHelpUtils.isNullOrEmpty(detailBudgetManagementDetail)){
				values.put("detailBudgetManagementDetail", detailBudgetManagementDetail);
			}
			if(!BaseHelpUtils.isNullOrEmpty(detailBudgetProess)){
				values.put("detailBudgetProess", detailBudgetProess);
			}
			if(!BaseHelpUtils.isNullOrEmpty(mainValue)){
				values.put("mainValue", mainValue);
			}
		}
		return values;
	}
