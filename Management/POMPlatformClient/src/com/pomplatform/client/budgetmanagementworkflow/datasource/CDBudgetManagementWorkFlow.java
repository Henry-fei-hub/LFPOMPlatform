...
public class CDBudgetManagementWorkFlow extends DataSource
{


	public static CDBudgetManagementWorkFlow instance = null;

	public static CDBudgetManagementWorkFlow getInstance() {
		if(instance == null) {
			instance = new CDBudgetManagementWorkFlow("CDBudgetManagementWorkFlow");
		}
		return instance;
	}
	...
	public CDBudgetManagementWorkFlow(String dataSourceID) {
		...
		bdUseAmountField.setRequired(true);
		...
		bdRestAmountField.setRequired(true);
		...
		projectIdField = new DataSourceIntegerField("projectId", "项目编号");
		...
		setFields(bdCodeField, bdTypeField, bdTotalAmountField, bdUseAmountField, bdRestAmountField, bdApplyEmployeeIdField, bdApplyTimeField, bdEstimatecloseTimeField, bdStatusField, projectIdField, bdRemarkField, inputTaxInvoiceIdField, departmentIdField, companyIdField, currentPageField, pageLinesField);
