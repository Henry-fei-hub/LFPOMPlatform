...
import com.pomplatform.client.websitenews.form.SwebsitenewntforSearchForm;
import com.pomplatform.client.websitenews.form.SwebsitenewntforViewer;
import com.pomplatform.client.websitenews.form.UpdateSwebsitenewntforForm;
import com.pomplatform.client.websitenews.form.NewSwebsitenewntforForm;
...
public class SwebsitenewntforPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			SwebsitenewntforPanel cm = new SwebsitenewntforPanel();
			id = cm.getID();
			return cm;
		}
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateSwebsitenewntforForm detailForm = new UpdateSwebsitenewntforForm();
...
//								DBDataSource.copyRecord(event.getData(), selected1);
		...
		operation3Button.addClickHandler(new ClickHandler(){
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					@Override
					public void onSuccess() {
						NewSwebsitenewntforForm detailForm = new NewSwebsitenewntforForm();
		...
		removeButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				DBDataSource.callOperation("ST_WebsiteNew", "update", map, new DSCallback() {
					@Override
...
//							resultGrid.selectSingleRecord(indexNum);
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("Swebsitenewntfor"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				SwebsitenewntforViewer detailForm = new SwebsitenewntforViewer();
	...
	public boolean checkSearchCriteria(Map criteria) {
		criteria.put("addtionalCondition", "order by website_new_id");
		return true;
	}
	...
	public SearchForm generateSearchForm() {
		return new SwebsitenewntforSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSSwebsitenewntfor.getInstance();
	}
