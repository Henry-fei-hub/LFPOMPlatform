...
import com.pomplatform.client.websitenews.datasource.DSSNewsMedia;
import com.pomplatform.client.websitenews.form.NewsMediaSearchForm;
...
public class NewsMediaPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			NewsMediaPanel cm = new NewsMediaPanel();
			id = cm.getID();
			return cm;
		}
	...
	public Canvas getViewPanel() {
        ...
        IButton buttonOne = new IButton("动态新闻");
        ...
        IButton buttonTwo = new IButton("出版作品");
	...
	public SearchForm generateSearchForm() {
		return new NewsMediaSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSSNewsMedia.getInstance();
	}

	private static int type = 2;
	private static int typeDetail = 1;
	private static String url = "http://119.23.124.241/?root=newsMedia";
	...
	public static void setTypeDetail(int typeDetail) {
		NewsMediaPanel.typeDetail = typeDetail;
	}
