...
public class SwebsitenewntforViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		params.put("websiteNewId", getBusinessId());
		DBDataSource.callOperation("NQ_Swebsitenewntfor", "find", new DSCallback() {
			@Override
