...
public class SupplierComeInDetailSupplierDetail extends AbstractWizadPage
{
	...
	public SupplierComeInDetailSupplierDetail(){
		...
		supplierNameItem.addChangedHandler(new ChangedHandler() {
			...
			public void onChanged(ChangedEvent event) {
				...
				SupplierComeInDetailSupplierCooperation nextPanel = getMainInfoPage();
	...
	public SupplierComeInDetailSupplierCooperation getMainInfoPage() {
		return mainInfoPage;
	}

	public void setMainInfoPage(SupplierComeInDetailSupplierCooperation mainInfoPage) {
	...
	public Map getValuesAsMap() {
		...
		valueMap.put("supplierId", BaseHelpUtils.getIntValue(getRecord().getAttribute("supplierId")));
		if(fileId>0) {
