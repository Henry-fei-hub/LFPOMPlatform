...
public class SupplierCooperationViewer extends AbstractDetailViewer
{




	public SupplierCooperationViewer() {
	}
	...
	public void load() {
		...
		params.put("supplierCooperationId", getBusinessId());
		DBDataSource.callOperation("ST_SupplierCooperation", "find", new DSCallback() {
			@Override
	...
	public DataSource getMainDataSource() {
		return DSSupplierCooperation.getInstance();
	}
