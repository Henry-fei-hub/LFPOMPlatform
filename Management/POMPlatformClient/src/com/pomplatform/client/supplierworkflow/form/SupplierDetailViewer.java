...
public class SupplierDetailViewer extends AbstractDetailViewer
{




	public SupplierDetailViewer() {
	}
	...
	public void load() {
		...
		params.put("supplierDetailId", getBusinessId());
		DBDataSource.callOperation("ST_SupplierDetail", "find", new DSCallback() {
			@Override
	...
	public DataSource getMainDataSource() {
		return DSSupplierDetail.getInstance();
	}
