...
import com.pomplatform.client.supplierworkflow.datasource.CDSupplierComeIn;

public class SupplierComeInSearchForm extends SearchForm
{
	...
	public SupplierComeInSearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDSupplierComeIn.getInstance());
