...
import com.pomplatform.client.supplierworkflow.form.SupplierComeInSearchForm;
import com.pomplatform.client.supplierworkflow.form.SupplierComeInViewer;
import com.pomplatform.client.supplierworkflow.form.UpdateSupplierComeInForm;
import com.pomplatform.client.supplierworkflow.form.NewSupplierComeInForm;
...
public class SupplierComeInPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			SupplierComeInPanel cm = new SupplierComeInPanel();
			id = cm.getID();
			return cm;
		}
	...
	public void initComponents() {
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateSupplierComeInForm detailForm = new UpdateSupplierComeInForm();
		...
		operation3Button.addClickHandler(new ClickHandler(){
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					@Override
					public void onSuccess() {
						NewSupplierComeInForm detailForm = new NewSupplierComeInForm();
		...
		removeButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				DBDataSource.callOperation("ST_SupplierComeIn", "delete", selected.toMap(), new DSCallback() {
					@Override
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setWidth100(); 
				detail.setHeight100(); 
				SupplierComeInViewer detailForm = new SupplierComeInViewer();
	...
	public SearchForm generateSearchForm() {
		return new SupplierComeInSearchForm();
	}
