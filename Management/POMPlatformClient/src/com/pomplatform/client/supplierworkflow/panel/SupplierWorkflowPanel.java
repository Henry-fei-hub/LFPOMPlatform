package com.pomplatform.client.supplierworkflow.panel;
...
import com.pomplatform.client.supplierworkflow.form.SupplierWorkflowSearchForm;
import com.pomplatform.client.supplierworkflow.form.SupplierWorkflowViewer;
import com.pomplatform.client.supplierworkflow.form.NewSupplierWorkflowForm;
import com.pomplatform.client.supplierworkflow.form.UpdateSupplierWorkflowForm;
...
public class SupplierWorkflowPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			SupplierWorkflowPanel cm = new SupplierWorkflowPanel();
			id = cm.getID();
			return cm;
		}
	...
	public void initComponents() {
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						NewSupplierWorkflowForm detailForm = new NewSupplierWorkflowForm();
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateSupplierWorkflowForm detailForm = new UpdateSupplierWorkflowForm();
		...
		removeButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				DBDataSource.callOperation("ST_SupplierWorkflow", "delete", selected.toMap(), new DSCallback() {
					@Override
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("SupplierWorkflow"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				SupplierWorkflowViewer detailForm = new SupplierWorkflowViewer();
	...
	public boolean checkSearchCriteria(Map criteria) {
		criteria.put("addtionalCondition", "order by receive_unit_manage_id");
		return true;
	}
	...
	public SearchForm generateSearchForm() {
		return new SupplierWorkflowSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSSupplierWorkflow.getInstance();
	}
