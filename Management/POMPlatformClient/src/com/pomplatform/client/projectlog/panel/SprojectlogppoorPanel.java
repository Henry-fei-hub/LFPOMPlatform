package com.pomplatform.client.projectlog.panel;
...
import com.pomplatform.client.projectlog.form.SprojectlogppoorSearchForm;
import com.pomplatform.client.projectlog.form.SprojectlogppoorViewer;
import com.pomplatform.client.projectlog.form.NewSprojectlogppoorForm;
import com.pomplatform.client.projectlog.form.UpdateSprojectlogppoorForm;
...
public class SprojectlogppoorPanel extends AbstractSearchPanel {
    ...
    public static class Factory implements PanelFactory {
        ...
        public Canvas create() {
            SprojectlogppoorPanel cm = new SprojectlogppoorPanel();
            id = cm.getID();
            return cm;
        }
...
//        operation1Button.setIcon("[SKIN]/actions/view.png");
            ...
            public void onClick(ClickEvent event) {
                GWT.runAsync(new RunAsyncCallback() {
                    ...
                    public void onSuccess() {
                        NewSprojectlogppoorForm detailForm = new NewSprojectlogppoorForm();
            ...
            public void onClick(ClickEvent event) {
                GWT.runAsync(new RunAsyncCallback() {
                    ...
                    public void onSuccess() {
                        ...
                        UpdateSprojectlogppoorForm detailForm = new UpdateSprojectlogppoorForm();
                        ...
                        detailForm.addDataEditedHandler(new DataEditedHandler() {
                            ...
                            public void onDataEdited(DataEditEvent event) {
                                ...
                                params.put("projectLogId", event.getData().getAttribute("projectLogId"));
    ...
    public void showDetail() {
        GWT.runAsync(new RunAsyncCallback() {
            ...
            public void onSuccess() {
                ...
                detail.setTitle("项目日志");
                detail.setWidth100();
                detail.setHeight100();
                SprojectlogppoorViewer detailForm = new SprojectlogppoorViewer();
    ...
    public SearchForm generateSearchForm() {
        return new SprojectlogppoorSearchForm();
    }

    @Override
    public DataSource getDataSource() {
        return DSSprojectlogppoor.getInstance();
    }
