...
public class SprojectlogppoorUpdateForm extends AbstractWizadPage
{
	...
	public SprojectlogppoorUpdateForm() {
		...
		projectLogIdItem.setDisabled(true);
		projectLogIdItem.setRequired(true);
		IsIntegerValidator projectLogIdValidator = new IsIntegerValidator();
		projectLogIdItem.setValidators(projectLogIdValidator);
		...
		__form.setItems(projectLogIdItem, projectIdItem, operateIdItem, departmentIdItem, managerIdItem, designPhaseItem, operateTimeItem, logTypeItem, logContentItem, alternateField1Item, alternateField2Item, alternateField3Item, statusItem);
	...
	public Map<String, FormItem> getItems() {
		...
		res.put("projectLogId", projectLogIdItem);
