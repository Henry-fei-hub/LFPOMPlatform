...
public class PreProjectMyRecordsViewer extends AbstractDetailViewer
{
	...
	public PreProjectMyRecordsViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_PreProjectMyRecords", "find", new DSCallback() {
			@Override
