...
public class StageModelTreeViewer extends AbstractDetailViewer
{




	public StageModelTreeViewer() {
	}
	...
	public void load() {
		...
		params.put("stageModelId", getBusinessId());
		DBDataSource.callOperation("ST_StageModelTree", "find", new DSCallback() {
			@Override
