...
public class ContractStageAuditViewer extends AbstractDetailViewer
{
	...
	public ContractStageAuditViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ContractStageAudit", "find", new DSCallback() {
			@Override
