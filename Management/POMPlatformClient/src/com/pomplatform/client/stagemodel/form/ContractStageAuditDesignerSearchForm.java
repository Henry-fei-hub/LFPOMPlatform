...
import com.pomplatform.client.stagemodel.datasource.CDContractStageAuditDesigner;

public class ContractStageAuditDesignerSearchForm extends SearchForm
{
	...
	public ContractStageAuditDesignerSearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDContractStageAuditDesigner.getInstance());
		
		employeeIdItem = new TextItem("employeeId", "职员");
		employeeIdItem.hide();
