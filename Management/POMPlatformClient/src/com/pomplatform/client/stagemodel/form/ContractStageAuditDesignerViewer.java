...
public class ContractStageAuditDesignerViewer extends AbstractDetailViewer
{
	...
	public ContractStageAuditDesignerViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ContractStageAuditDesigner", "find", new DSCallback() {
			@Override
