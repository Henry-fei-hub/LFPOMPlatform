...
public class ContractStageAuditManagerViewer extends AbstractDetailViewer
{
	...
	public ContractStageAuditManagerViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ContractStageAuditManager", "find", new DSCallback() {
			@Override
