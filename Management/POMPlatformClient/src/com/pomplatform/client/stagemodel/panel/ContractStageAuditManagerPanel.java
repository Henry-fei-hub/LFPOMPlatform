...
import com.pomplatform.client.stagemodel.form.ContractStageAuditManagerSearchForm;
import com.pomplatform.client.stagemodel.form.ContractStageAuditManagerViewer;
import com.pomplatform.client.stagemodel.form.UpdateContractStageAuditManagerForm;
...
public class ContractStageAuditManagerPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			ContractStageAuditManagerPanel cm = new ContractStageAuditManagerPanel();
			id = cm.getID();
			return cm;
		}
		...
		public String getDescription() {
			return "ContractStageAuditManager";
		}
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateContractStageAuditManagerForm detailForm = new UpdateContractStageAuditManagerForm();
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("合同小节点项目经理审批"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				ContractStageAuditManagerViewer detailForm = new ContractStageAuditManagerViewer();
	...
	public boolean checkSearchCriteria(Map criteria) {
		...
		if (!BaseHelpUtils.isNullOrEmpty(criteria.get("auditStatus"))) {
			...
			if(value.equals(ClientStaticUtils.CONTRACT_STAGE_AUDIT_STATUS_1)){
				...
				keyvalues.add(kv);
			}else if(value.equals(ClientStaticUtils.CONTRACT_STAGE_AUDIT_STATUS_2)){
				Map<String, Object> kv = new HashMap<>();
				kv.put("key", "a.need_manager_audit = true and a.manager_id");
	...
	public SearchForm generateSearchForm() {
		return new ContractStageAuditManagerSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSContractStageAuditManager.getInstance();
	}
