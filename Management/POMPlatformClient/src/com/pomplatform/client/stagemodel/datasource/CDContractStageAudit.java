...
public class CDContractStageAudit extends DataSource
{


	public static CDContractStageAudit instance = null;

	public static CDContractStageAudit getInstance() {
		if(instance == null) {
			instance = new CDContractStageAudit("CDContractStageAudit");
		}
		return instance;
	}
	...
	public CDContractStageAudit(String dataSourceID) {
