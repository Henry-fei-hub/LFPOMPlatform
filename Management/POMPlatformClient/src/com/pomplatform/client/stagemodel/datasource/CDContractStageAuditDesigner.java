...
public class CDContractStageAuditDesigner extends DataSource
{


	public static CDContractStageAuditDesigner instance = null;

	public static CDContractStageAuditDesigner getInstance() {
		if(instance == null) {
			instance = new CDContractStageAuditDesigner("CDContractStageAuditDesigner");
		}
		return instance;
	}
	...
	public CDContractStageAuditDesigner(String dataSourceID) {
		...
		setFields(employeeIdField, contractIdField, contractCodeField, contractNameField, lockedField, auditStatusField, currentPageField, pageLinesField);
