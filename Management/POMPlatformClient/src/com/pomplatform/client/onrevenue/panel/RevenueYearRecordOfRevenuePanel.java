...
public class RevenueYearRecordOfRevenuePanel extends AbstractExpansionRelatedPage
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			RevenueYearRecordOfRevenuePanel cm = new RevenueYearRecordOfRevenuePanel();
			id = cm.getID();
			return cm;
		}
	...
	public void initComponents() {
		...
		exportButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				DBDataSource.downloadFile("DW_RevenueYearRecordOfRevenue", condition);
			}
		});
