...
public class DSBusinessStateOtherRecord extends DBDataSource
{


	public static DSBusinessStateOtherRecord instance = null;

	public static DSBusinessStateOtherRecord getInstance() {
		if(instance == null) {
			instance = new DSBusinessStateOtherRecord("DSBusinessStateRecord");
		}
		return instance;
	}
	...
	private final DataSourceTextField finishPercentDetailField;

	public DSBusinessStateOtherRecord(String dataSourceID) {
		...
		beforeContractTotalField.setFormat("#,###,###,###,##0.00");
		...
		businessIntegralField.setFormat("#,###,###,###,##0.00");
		...
		finishPercentDetailField = new DataSourceTextField("finishPercentDetail", "订单完工比明细");
		finishPercentDetailField.setLength(64);
		finishPercentDetailField.setRequired(false);
		finishPercentDetailField.setHidden(true);
