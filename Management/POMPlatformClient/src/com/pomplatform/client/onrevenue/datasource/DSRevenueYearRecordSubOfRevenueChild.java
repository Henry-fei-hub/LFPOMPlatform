...
public class DSRevenueYearRecordSubOfRevenueChild extends DBDataSource
{


	public static DSRevenueYearRecordSubOfRevenueChild instance = null;

	public static DSRevenueYearRecordSubOfRevenueChild getInstance() {
		if(instance == null) {
			instance = new DSRevenueYearRecordSubOfRevenueChild("DSRevenueYearRecordSubOfRevenueChild");
		}
		return instance;
	}
	...
	public DSRevenueYearRecordSubOfRevenueChild(String dataSourceID) {
		...
		parentIdField.setForeignKey("DSRevenueYearRecordSubOfRevenue.contractId");
