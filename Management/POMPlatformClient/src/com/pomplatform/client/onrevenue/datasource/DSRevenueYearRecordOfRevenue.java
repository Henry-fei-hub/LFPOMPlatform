...
public class DSRevenueYearRecordOfRevenue extends DBDataSource
{


	public static DSRevenueYearRecordOfRevenue instance = null;

	public static DSRevenueYearRecordOfRevenue getInstance() {
		if(instance == null) {
			instance = new DSRevenueYearRecordOfRevenue("DSRevenueYearRecordOfRevenue");
		}
		return instance;
	}
	...
	public DSRevenueYearRecordOfRevenue(String dataSourceID) {
		...
		contractIdField.setForeignKey("DSRevenueYearRecordOfRevenue.contractId");
