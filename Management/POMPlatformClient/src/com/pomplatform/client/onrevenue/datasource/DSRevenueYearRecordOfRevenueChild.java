...
public class DSRevenueYearRecordOfRevenueChild extends DBDataSource
{


	public static DSRevenueYearRecordOfRevenueChild instance = null;

	public static DSRevenueYearRecordOfRevenueChild getInstance() {
		if(instance == null) {
			instance = new DSRevenueYearRecordOfRevenueChild("DSRevenueYearRecordOfRevenueChild");
		}
		return instance;
	}
	...
	public DSRevenueYearRecordOfRevenueChild(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("RevenueYearRecordOfRevenue");
		...
		parentIdField.setForeignKey("DSRevenueYearRecordOfRevenue.contractId");
