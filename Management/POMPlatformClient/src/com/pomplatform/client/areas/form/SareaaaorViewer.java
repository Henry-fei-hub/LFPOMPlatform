...
public class SareaaaorViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		params.put("areaId", getBusinessId());
		DBDataSource.callOperation("NQ_Sareaaaor", "find", new DSCallback() {
			@Override
