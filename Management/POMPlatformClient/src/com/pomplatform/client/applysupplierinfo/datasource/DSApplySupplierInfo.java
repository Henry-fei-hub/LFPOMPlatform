...
public class DSApplySupplierInfo extends DBDataSource
{


	public static DSApplySupplierInfo instance = null;

	public static DSApplySupplierInfo getInstance() {
		if(instance == null) {
			instance = new DSApplySupplierInfo("DSApplySupplierInfo");
		}
		return instance;
	}
	...
	public DSApplySupplierInfo(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("ApplySupplierInfo");
		...
		supplierNameField.setLength(230);
		...
		supplierPhoneField.setLength(64);
