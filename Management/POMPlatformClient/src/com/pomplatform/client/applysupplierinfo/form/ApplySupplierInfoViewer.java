...
public class ApplySupplierInfoViewer extends AbstractDetailViewer
{
	...
	public ApplySupplierInfoViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ApplySupplierInfo", "find", new DSCallback() {
			@Override
