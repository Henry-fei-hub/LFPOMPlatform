...
public abstract class GenericWizadWindowForSaveProject extends GenericWizadWindow {
	...
	public GenericWizadWindowForSaveProject() {
	}
	...
	public void initComponents() {
		...
		saveButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				condition.put("opt_type", "checkCodeExist");
				condition.put("contractCode", values.get("contractCode"));
				DBDataSource.callOperation("EP_CustomProjectManagerProcess", condition, new DSCallback() {
					...
					public void execute(DSResponse dsResponse, Object data, DSRequest dsRequest) {
						if(dsResponse.getStatus() < 0){
							...
							SC.ask("提示", "该项目是630项目吗？", new BooleanCallback() {
								@Override
	...
	/**
	 * @param __continueMessage
	 *            the __continueMessage to set
	 */
