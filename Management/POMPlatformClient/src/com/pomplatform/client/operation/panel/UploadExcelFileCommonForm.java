...
public final class UploadExcelFileCommonForm extends PopupWindow implements HasHandlers {

    public UploadExcelFileCommonForm() {
        super("文件上传");
        setWidth("50%");
        setHeight("50%");
        centerInPage();
...
//                        SC.say("项目经费导入成功");
        ...
        vertical.setHTML(3, 0, "<span><b>注:支持上传文件包括(.xls .xlsx)</b></span>");
        ...
        uploadButton.addClickHandler(new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                ...
                formPanel.setAction(DBDataSource.getServerURL("UP_UploadFileCommon"));
                formPanel.submit();
            }
        });
    }
