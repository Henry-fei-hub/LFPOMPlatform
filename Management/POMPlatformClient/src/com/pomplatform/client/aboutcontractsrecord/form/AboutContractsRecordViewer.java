...
public class AboutContractsRecordViewer extends AbstractDetailViewer
{
	...
	public AboutContractsRecordViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_AboutContractsRecord", "find", new DSCallback() {
			@Override
