...
public class DSAboutContractsRecord extends DBDataSource
{


	public static DSAboutContractsRecord instance = null;

	public static DSAboutContractsRecord getInstance() {
		if(instance == null) {
			instance = new DSAboutContractsRecord("DSAboutContractsRecord");
		}
		return instance;
	}
	...
	public DSAboutContractsRecord(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("AboutContractsRecord");
		...
		setFields(contractsRecordsIdField, infoCodeField, projectNameField, contractIdField, contractNameField, contractCodeField,trackTypeField,customerNameField,contractAmountField, contractStatusField, contractDateField, sendingDateField,remarkField, trackDateField, registerEmployeeField, registerDateField, relevantEmployeesField, relevantEmployeesNameField);
		
		//setFields(contractsRecordsIdField, projectNameField, contractIdField, contractNameField, contractAmountField, contractStatusField, remarkField, trackDateField, registerEmployeeField, registerDateField, relevantEmployeesField, relevantEmployeesNameField, customerNameField, contractCodeField, contractDateField, sendingDateField, trackTypeField, infoCodeField);
	}
