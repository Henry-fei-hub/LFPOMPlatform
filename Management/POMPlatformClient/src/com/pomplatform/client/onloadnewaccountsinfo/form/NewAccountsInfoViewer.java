...
public class NewAccountsInfoViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_NewAccountsInfo", "find", new DSCallback() {
			@Override
