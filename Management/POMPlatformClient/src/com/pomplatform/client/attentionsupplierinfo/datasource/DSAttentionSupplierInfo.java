...
public class DSAttentionSupplierInfo extends DBDataSource
{


	public static DSAttentionSupplierInfo instance = null;

	public static DSAttentionSupplierInfo getInstance() {
		if(instance == null) {
			instance = new DSAttentionSupplierInfo("DSAttentionSupplierInfo");
		}
		return instance;
	}
	...
	public DSAttentionSupplierInfo(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("AttentionSupplierInfo");
