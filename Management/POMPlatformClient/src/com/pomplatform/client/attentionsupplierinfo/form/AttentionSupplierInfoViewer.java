...
public class AttentionSupplierInfoViewer extends AbstractDetailViewer
{
	...
	public AttentionSupplierInfoViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_AttentionSupplierInfo", "find", new DSCallback() {
			@Override
