...
public class MemployeemoneymanageeeedcieftrcvmmorViewer extends AbstractDetailViewer
{
	...
	public MemployeemoneymanageeeedcieftrcvmmorViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Memployeemoneymanageeeedcieftrcvmmor", "find", new DSCallback() {
			@Override
