 ...
 *
 * @author: xiaolong
 * @Date: 2019/8/11 18:56
 */
public class MeetingAppointmentTimePanel extends DelicacyPanel implements HasHandlers {

    private static final Logger __LOGGER = Logger.getLogger("MeetingAppointmentTimePanel的返回值");
    ...
    public void MeetingRoomRecord(int status, int meetingStatus, int meetingRelevanceId, int meetingRoomId,
                                  String meetingTheme, int startTime, int endTime, Date recordDate) {

        meetingRelevanceIds = meetingRelevanceId;
        mstatus = status;
        meetingRoomNameItem.setValue(meetingRoomId);
        meetingThemeItem.setValue(meetingTheme);
        dayTimeItem.setValue(recordDate);
        wmStartTimeItem.setValue(startTime);
        wmEndTimeItem.setValue(endTime);
    ...
    public Canvas getViewPanel() {
        ...
        saveButton.addClickHandler(new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                ...
                __LOGGER.info("会议室" + meetingRoomNameItem.getValue() + "会议主题" + meetingThemeItem.getValue() +
                        "开始时间" + wmStartTimeItem.getValue() +
                        "结束时间" + wmEndTimeItem.getValue() +
                        "操作日期" + dayTimeItem.getValue());
    ...
    public class Factory implements PanelFactory {
        ...
        public Canvas create() {
            MeetingAppointmentTimePanel cm = new MeetingAppointmentTimePanel();
            id = cm.getID();
            return cm;
        }
