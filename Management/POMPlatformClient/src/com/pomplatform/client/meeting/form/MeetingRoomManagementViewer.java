...
public class MeetingRoomManagementViewer extends AbstractDetailViewer
{
	...
	public MeetingRoomManagementViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_MeetingRoomManagement", "find", new DSCallback() {
			@Override
