...
public class MeetingRoomReservaTionRecordPaymentBaseViewer extends AbstractDetailViewer {
    private SearchForm __parentSearchForm;

    public MeetingRoomReservaTionRecordPaymentBaseViewer() {
    }
    ...
    public void load() {
        ...
        params.put("meetingRoomId", getBusinessId());
        DBDataSource.callOperation("NQ_MeetingRoomReservaTionRecordPaymentBase", "find", new DSCallback() {
            @Override
