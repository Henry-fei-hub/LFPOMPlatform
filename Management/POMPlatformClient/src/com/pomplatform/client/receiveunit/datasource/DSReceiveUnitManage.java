...
public class DSReceiveUnitManage extends DBDataSource
{


	public static DSReceiveUnitManage instance = null;

	public static DSReceiveUnitManage getInstance() {
		if(instance == null) {
			instance = new DSReceiveUnitManage("DSReceiveUnitManage");
		}
		return instance;
	}
	...
	public DSReceiveUnitManage(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_TABLE);
		setActionName("ReceiveUnitManage");
		...
		setFields(receiveUnitManageIdField, receiveUnitField, bankAccountField, bankNameField, receiveUnitAddressField, operateEmployeeIdField, operateTimeField);
	}
