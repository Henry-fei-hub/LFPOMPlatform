...
public class MemployeeProcessbilllistsmmeorPanel extends AbstractSearchPanel {
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			MemployeeProcessbilllistsmmeorPanel cm = new MemployeeProcessbilllistsmmeorPanel();
			id = cm.getID();
			return cm;
		}
...
//                 }  
	...
	public void initComponents() {
		...
		IButton excludeDataBtn = new IButton("排除冲>=付");
		excludeDataBtn.addClickHandler(new ClickHandler() {
		...
		controlLayout.addMember(excludeDataBtn);
		
		IButton viewAllBtn = new IButton("显示全部");
		viewAllBtn.addClickHandler(new ClickHandler() {
		...
		controlLayout.addMember(viewAllBtn);
		
		IButton groupBtn = new IButton("分组设置");
		...
		controlLayout.addMember(groupBtn);
...
//		resultGrid.setGroupStartOpen(GroupStartOpen.ALL);
	...
	public boolean checkSearchCriteria(Map criteria) {
		...
		if(null == criteria.get("employeeId")){
			SC.say("请从左边数据栏双击选择需要查看的员工");
			return false;
		}
		criteria.put("searchType", searchType);
