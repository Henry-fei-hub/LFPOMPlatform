...
public class MreceiveunitmanagepsrbborViewer extends AbstractDetailViewer
{
	...
	public MreceiveunitmanagepsrbborViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Mreceiveunitmanagepsrbbor", "find", new DSCallback() {
			@Override
