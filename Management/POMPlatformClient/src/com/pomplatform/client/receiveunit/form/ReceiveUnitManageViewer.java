...
public class ReceiveUnitManageViewer extends AbstractDetailViewer
{




	public ReceiveUnitManageViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("ST_ReceiveUnitManage", "find", new DSCallback() {
			@Override
