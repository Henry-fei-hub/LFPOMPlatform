...
import com.pomplatform.client.plateintegralassignrecord.datasource.CDPlateIntegralAssignRecord;
...
public class PlateIntegralAssignRecordSearchForm extends SearchForm {
	...
	public PlateIntegralAssignRecordSearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDPlateIntegralAssignRecord.getInstance());
