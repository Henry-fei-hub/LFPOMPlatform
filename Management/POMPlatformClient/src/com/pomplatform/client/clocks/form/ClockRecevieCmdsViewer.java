...
public class ClockRecevieCmdsViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		params.put("clockRecevieCmdId", getBusinessId());
		DBDataSource.callOperation("NQ_ClockRecevieCmds", "find", new DSCallback() {
			@Override
