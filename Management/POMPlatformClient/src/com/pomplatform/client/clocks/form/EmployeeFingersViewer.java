...
public class EmployeeFingersViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		params.put("hrEmpFingerId", getBusinessId());
		DBDataSource.callOperation("NQ_employeeFingers", "find", new DSCallback() {
			@Override
