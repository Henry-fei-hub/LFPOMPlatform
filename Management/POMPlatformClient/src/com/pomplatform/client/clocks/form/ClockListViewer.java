...
public class ClockListViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		params.put("clockId", getBusinessId());
		DBDataSource.callOperation("NQ_ClockList", "find", new DSCallback() {
			@Override
