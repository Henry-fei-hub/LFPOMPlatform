...
public class DSMcontractreceivablecipcor extends DBDataSource
{


	public static DSMcontractreceivablecipcor instance = null;

	public static DSMcontractreceivablecipcor getInstance() {
		if(instance == null) {
			instance = new DSMcontractreceivablecipcor("DSMcontractreceivablecipcor");
		}
		return instance;
	}
	...
	public DSMcontractreceivablecipcor(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("Mcontractreceivablecipcor");
...
//		parentIdField.setValueMap(KeyValueManager.getValueMap("project_types"));
		...
		signingMoneySumField = new DataSourceFloatField("signingMoneySum", "签约总金额(单位:元)");
