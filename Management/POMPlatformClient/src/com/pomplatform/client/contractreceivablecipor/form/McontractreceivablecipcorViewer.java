...
public class McontractreceivablecipcorViewer extends AbstractDetailViewer
{
	...
	public McontractreceivablecipcorViewer() {
	}
	...
	public void load() {
		...
		params.put("contractReceivableId", getBusinessId());
		DBDataSource.callOperation("NQ_Mcontractreceivablecipcor", "find", new DSCallback() {
			@Override
