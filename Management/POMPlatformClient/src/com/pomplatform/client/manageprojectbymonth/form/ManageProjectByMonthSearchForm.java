package com.pomplatform.client.manageprojectbymonth.form;
...
import com.pomplatform.client.manageprojectbymonth.datasource.CDManageProjectByMonth;

public class ManageProjectByMonthSearchForm extends SearchForm
{
	...
	public ManageProjectByMonthSearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDManageProjectByMonth.getInstance());
