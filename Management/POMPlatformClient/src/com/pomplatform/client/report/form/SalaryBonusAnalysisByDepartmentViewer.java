...
public class SalaryBonusAnalysisByDepartmentViewer extends AbstractDetailViewer
{
	...
	public SalaryBonusAnalysisByDepartmentViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_SalaryBonusAnalysisByDepartment", "find", new DSCallback() {
			@Override
