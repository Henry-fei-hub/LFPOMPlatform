...
public class ReportOfEmployeeCostAnalysisViewer extends AbstractDetailViewer
{
	...
	public ReportOfEmployeeCostAnalysisViewer() {
	}
	...
	public void load() {
		...
		params.put("employeeCostAnalysisId", getBusinessId());
		DBDataSource.callOperation("NQ_ReportOfEmployeeCostAnalysis", "find", new DSCallback() {
			@Override
