...
public class ReportOfSalaryTotalViewer extends AbstractDetailViewer
{
	...
	public ReportOfSalaryTotalViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ReportOfSalaryTotal", "find", new DSCallback() {
			@Override
