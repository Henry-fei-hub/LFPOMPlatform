...
public class ReportOnEmployeeGradeTotalViewer extends AbstractDetailViewer
{
	...
	public ReportOnEmployeeGradeTotalViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ReportOnEmployeeGradeTotal", "find", new DSCallback() {
			@Override
