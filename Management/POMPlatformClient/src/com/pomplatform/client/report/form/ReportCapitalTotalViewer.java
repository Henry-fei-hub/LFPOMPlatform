...
public class ReportCapitalTotalViewer extends AbstractDetailViewer
{
	...
	public ReportCapitalTotalViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ReportCapitalTotal", "find", new DSCallback() {
			@Override
