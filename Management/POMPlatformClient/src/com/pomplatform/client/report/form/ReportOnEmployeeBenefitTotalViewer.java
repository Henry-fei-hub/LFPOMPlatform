...
public class ReportOnEmployeeBenefitTotalViewer extends AbstractDetailViewer
{
	...
	public ReportOnEmployeeBenefitTotalViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ReportOnEmployeeBenefitTotal", "find", new DSCallback() {
			@Override
