...
public class SalaryBonusAnalysisByEmployeeViewer extends AbstractDetailViewer
{
	...
	public SalaryBonusAnalysisByEmployeeViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_SalaryBonusAnalysisByEmployee", "find", new DSCallback() {
			@Override
