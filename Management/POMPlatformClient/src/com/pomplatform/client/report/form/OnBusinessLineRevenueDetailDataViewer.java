...
public class OnBusinessLineRevenueDetailDataViewer extends AbstractDetailViewer
{
	...
	public OnBusinessLineRevenueDetailDataViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnBusinessLineRevenueDetailData", "find", new DSCallback() {
			@Override
