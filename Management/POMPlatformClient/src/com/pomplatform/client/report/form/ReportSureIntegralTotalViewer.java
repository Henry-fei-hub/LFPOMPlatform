...
public class ReportSureIntegralTotalViewer extends AbstractDetailViewer
{
	...
	public ReportSureIntegralTotalViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ReportSureIntegralTotal", "find", new DSCallback() {
			@Override
