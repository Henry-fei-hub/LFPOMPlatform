...
public class CollectionrevenueanalysisViewer extends AbstractDetailViewer
{
	...
	public CollectionrevenueanalysisViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Collectionrevenueanalysis", "find", new DSCallback() {
			@Override
