...
public class ReportCapitaProjectDetailViewer extends AbstractDetailViewer
{
	...
	public ReportCapitaProjectDetailViewer() {
	}
	...
	public String getName() {
		return "ReportCapitaProjectDetail";
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ReportCapitaProjectDetail", "find", new DSCallback() {
			@Override
	...
	public DataSource getMainDataSource() {
		return DSReportCapitaProjectDetail.getInstance();
	}
