...
public class ReportOnEmployeeAgeTotalViewer extends AbstractDetailViewer
{
	...
	public ReportOnEmployeeAgeTotalViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ReportOnEmployeeAgeTotal", "find", new DSCallback() {
			@Override
