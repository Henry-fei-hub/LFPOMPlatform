...
public class ReportOnEmployeeNumTotalViewer extends AbstractDetailViewer
{
	...
	public ReportOnEmployeeNumTotalViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ReportOnEmployeeNumTotal", "find", new DSCallback() {
			@Override
