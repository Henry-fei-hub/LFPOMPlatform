...
public class ReportOfGenderAnalysisByDepartmentViewer extends AbstractDetailViewer
{
	...
	public ReportOfGenderAnalysisByDepartmentViewer() {
	}
	...
	public void load() {
		...
		params.put("genderProportionId", getBusinessId());
		DBDataSource.callOperation("NQ_ReportOfGenderAnalysisByDepartment", "find", new DSCallback() {
			@Override
