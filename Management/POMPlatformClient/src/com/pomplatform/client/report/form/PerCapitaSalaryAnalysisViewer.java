...
public class PerCapitaSalaryAnalysisViewer extends AbstractDetailViewer
{
	...
	public PerCapitaSalaryAnalysisViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_PerCapitaSalaryAnalysis", "find", new DSCallback() {
			@Override
