...
import com.pomplatform.client.report.datasource.CDReportOnEmployeeBenefitTotal;

public class ReportOnEmployeeBenefitTotalSearchForm extends SearchForm
{
	...
	public ReportOnEmployeeBenefitTotalSearchForm() {
		setWidth100();
		setHeight100();
