...
public class EmployeesOrdersViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_EmployeesOrders", "find", new DSCallback() {
			@Override
