...
public class ReportOfGenderPlateMonthViewer extends AbstractDetailViewer
{
	...
	public ReportOfGenderPlateMonthViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ReportOfGenderPlateMonth", "find", new DSCallback() {
			@Override
	...
	public DataSource getMainDataSource() {
		return DSReportOfGenderPlateMonth.getInstance();
	}
