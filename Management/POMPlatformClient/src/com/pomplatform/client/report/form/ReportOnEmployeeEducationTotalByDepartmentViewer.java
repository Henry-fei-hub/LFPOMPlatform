...
public class ReportOnEmployeeEducationTotalByDepartmentViewer extends AbstractDetailViewer
{
	...
	public ReportOnEmployeeEducationTotalByDepartmentViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ReportOnEmployeeEducationTotalByDepartment", "find", new DSCallback() {
			@Override
