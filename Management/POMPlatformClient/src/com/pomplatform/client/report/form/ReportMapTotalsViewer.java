...
public class ReportMapTotalsViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ReportMapTotals", "find", new DSCallback() {
			@Override
