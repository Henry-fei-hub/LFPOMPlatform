...
public class ReportOnEmployeeNumTotalByDepartmentViewer extends AbstractDetailViewer
{
	...
	public ReportOnEmployeeNumTotalByDepartmentViewer() {
	}
	...
	public String getName() {
		return "ReportOnEmployeeNumTotalByDepartment";
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ReportOnEmployeeNumTotalByDepartment", "find", new DSCallback() {
			@Override
