...
public class ReportCostDetailViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ReportCostDetail", "find", new DSCallback() {
			@Override
