...
public class DepartmentIncomeReportViewer extends AbstractDetailViewer
{
	...
	public DepartmentIncomeReportViewer() {
	}
	...
	public void load() {
		...
		params.put("plateIncomeAndExpenditureId", getBusinessId());
		DBDataSource.callOperation("NQ_DepartmentIncomeReport", "find", new DSCallback() {
			@Override
