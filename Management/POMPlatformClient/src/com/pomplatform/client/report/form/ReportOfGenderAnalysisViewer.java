...
public class ReportOfGenderAnalysisViewer extends AbstractDetailViewer
{
	...
	public ReportOfGenderAnalysisViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ReportOfGenderAnalysis", "find", new DSCallback() {
			@Override
