...
public class ReportOnEmployeeSeniorityTotalByDepartmentViewer extends AbstractDetailViewer
{
	...
	public ReportOnEmployeeSeniorityTotalByDepartmentViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ReportOnEmployeeSeniorityTotalByDepartment", "find", new DSCallback() {
			@Override
