...
public class ReportOnEmployeeTurnoverTotalViewer extends AbstractDetailViewer
{
	...
	public ReportOnEmployeeTurnoverTotalViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ReportOnEmployeeTurnoverTotal", "find", new DSCallback() {
			@Override
