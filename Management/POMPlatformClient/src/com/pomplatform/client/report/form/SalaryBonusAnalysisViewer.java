...
public class SalaryBonusAnalysisViewer extends AbstractDetailViewer
{
	...
	public SalaryBonusAnalysisViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_SalaryBonusAnalysis", "find", new DSCallback() {
			@Override
