...
public class ReportOnEmployeeGradeTotalByDepartmentViewer extends AbstractDetailViewer
{
	...
	public ReportOnEmployeeGradeTotalByDepartmentViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ReportOnEmployeeGradeTotalByDepartment", "find", new DSCallback() {
			@Override
