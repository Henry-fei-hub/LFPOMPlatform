...
import com.pomplatform.client.report.datasource.CDReportOnEmployeeTurnoverTotal;

public class ReportOnEmployeeTurnoverTotalSearchForm extends SearchForm
{
	...
	public ReportOnEmployeeTurnoverTotalSearchForm() {
		setWidth100();
		setHeight100();
