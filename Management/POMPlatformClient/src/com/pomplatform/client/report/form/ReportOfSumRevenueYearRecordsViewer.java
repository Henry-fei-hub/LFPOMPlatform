...
public class ReportOfSumRevenueYearRecordsViewer extends AbstractDetailViewer
{
	...
	public ReportOfSumRevenueYearRecordsViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ReportOfSumRevenueYearRecords", "find", new DSCallback() {
			@Override
