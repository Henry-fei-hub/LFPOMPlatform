...
public class ReportCostTotalViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ReportCostTotal", "find", new DSCallback() {
			@Override
