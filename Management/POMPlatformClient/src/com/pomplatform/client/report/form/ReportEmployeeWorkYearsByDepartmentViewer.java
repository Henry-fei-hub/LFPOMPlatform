...
public class ReportEmployeeWorkYearsByDepartmentViewer extends AbstractDetailViewer
{
	...
	public ReportEmployeeWorkYearsByDepartmentViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ReportEmployeeWorkYearsByDepartment", "find", new DSCallback() {
			@Override
