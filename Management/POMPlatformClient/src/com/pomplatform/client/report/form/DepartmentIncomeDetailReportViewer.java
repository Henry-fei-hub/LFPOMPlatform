...
public class DepartmentIncomeDetailReportViewer extends AbstractDetailViewer
{
	...
	public DepartmentIncomeDetailReportViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_DepartmentIncomeDetailReport", "find", new DSCallback() {
			@Override
