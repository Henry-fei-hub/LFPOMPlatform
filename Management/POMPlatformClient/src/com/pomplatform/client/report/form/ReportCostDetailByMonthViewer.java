...
public class ReportCostDetailByMonthViewer extends AbstractDetailViewer
{
	...
	public ReportCostDetailByMonthViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_ReportCostDetailByMonth", "find", new DSCallback() {
			@Override
