...
import com.pomplatform.client.report.datasource.DSReportOnEmployeeSeniorityTotal;
import com.pomplatform.client.report.form.ReportOnEmployeeSeniorityTotalSearchForm;
import com.pomplatform.client.report.form.ReportOnEmployeeSeniorityTotalViewer;
...
public class ReportOnEmployeeSeniorityTotalPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			ReportOnEmployeeSeniorityTotalPanel cm = new ReportOnEmployeeSeniorityTotalPanel();
			id = cm.getID();
			return cm;
		}
		...
		public String getDescription() {
			return "ReportOnEmployeeSeniorityTotal";
		}
	...
	public void initComponents() {
		...
		resultGrid.addDoubleClickHandler(new DoubleClickHandler() {
			...
			public void onDoubleClick(DoubleClickEvent event) {
				...
				ReportOnEmployeeSeniorityTotalByDepartmentPanel panel = new ReportOnEmployeeSeniorityTotalByDepartmentPanel();
				pw.addItem(panel);
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("ReportOnEmployeeSeniorityTotal"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				ReportOnEmployeeSeniorityTotalViewer detailForm = new ReportOnEmployeeSeniorityTotalViewer();
	...
	public SearchForm generateSearchForm() {
		return new ReportOnEmployeeSeniorityTotalSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSReportOnEmployeeSeniorityTotal.getInstance();
	}
