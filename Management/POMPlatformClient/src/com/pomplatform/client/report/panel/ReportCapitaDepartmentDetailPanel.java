...
import com.pomplatform.client.report.datasource.DSReportCapitaDepartmentDetail;
...
public class ReportCapitaDepartmentDetailPanel extends AbstractWizadPage {
	...
	public ReportCapitaDepartmentDetailPanel() {
    	...
    	departmentIdItem = new IPickTreeItem("departmentId", "报销部门");
    	...
    	__infoForm.setItems(departmentIdItem);
    	...
    	summaryGrid.setDataSource(DSReportCapitaDepartmentDetail.getInstance());
    ...
    public void startEdit() {
    	...
    	DBDataSource.callOperation("NQ_ReportCapitaDepartmentDetail", param, new DSCallback() {
