...
public class ReportSureIntegralDetailPanel extends AbstractWizadPage {
	...
	public ReportSureIntegralDetailPanel() {
    	...
    	summaryGrid.setDataSource(DSReportSureIntegralDetail.getInstance());
    ...
    public void startEdit() {
    	...
    	DBDataSource.callOperation("NQ_ReportSureIntegralDetail", param, new DSCallback() {
