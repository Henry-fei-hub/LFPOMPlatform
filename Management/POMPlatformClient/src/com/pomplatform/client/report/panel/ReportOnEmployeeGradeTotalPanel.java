...
import com.pomplatform.client.report.form.ReportOnEmployeeGradeTotalSearchForm;
import com.pomplatform.client.report.form.ReportOnEmployeeGradeTotalViewer;
...
public class ReportOnEmployeeGradeTotalPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			ReportOnEmployeeGradeTotalPanel cm = new ReportOnEmployeeGradeTotalPanel();
			id = cm.getID();
			return cm;
		}
		...
		public String getDescription() {
			return "ReportOnEmployeeGradeTotal";
		}
	...
	public void initComponents() {
        ...
        fields[idx].setShowGridSummary(true);
        idx++;
        resultGrid.setDataSource(DSReportOnEmployeeGradeTotal.getInstance());
		...
		resultGrid.addDoubleClickHandler(new DoubleClickHandler() {
			...
			public void onDoubleClick(DoubleClickEvent event) {
				...
				ReportOnEmployeeGradeTotalByDepartmentPanel panel = new ReportOnEmployeeGradeTotalByDepartmentPanel();
				pw.addItem(panel);
				...
				panel.commonQuery();
				pw.setTitle("业务部门(" + plateName + ")下的职级结构分析");
				pw.setWidth100();
				pw.setHeight100();
				pw.centerInPage();
				pw.show();
	...
	public SearchForm generateSearchForm() {
		return new ReportOnEmployeeGradeTotalSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSReportOnEmployeeGradeTotal.getInstance();
	}
