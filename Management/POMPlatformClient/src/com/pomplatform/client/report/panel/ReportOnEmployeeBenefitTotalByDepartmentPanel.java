...
import com.pomplatform.client.report.datasource.DSReportOnEmployeeBenefitTotalByDepartment;
import com.pomplatform.client.report.form.ReportOnEmployeeBenefitTotalByDepartmentSearchForm;
import com.pomplatform.client.report.form.ReportOnEmployeeBenefitTotalByDepartmentViewer;
...
public class ReportOnEmployeeBenefitTotalByDepartmentPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			ReportOnEmployeeBenefitTotalByDepartmentPanel cm = new ReportOnEmployeeBenefitTotalByDepartmentPanel();
			id = cm.getID();
			return cm;
		}
		...
		public String getDescription() {
			return "ReportOnEmployeeBenefitTotalByDepartment";
		}
	...
	public void initComponents() {
		...
		resultGrid.setFields(departmentId, year, oneNum1, twoNum1, totalNum1, oneNum2, twoNum2, totalNum2, oneNum3, twoNum3, totalNum3, oneNum4, twoNum4, totalNum4, oneNum5, twoNum5, totalNum5, oneNum6, twoNum6, totalNum6, oneNum7, twoNum7, totalNum7, oneNum8, twoNum8, totalNum8, oneNum9, twoNum9, totalNum9, oneNum10, twoNum10, totalNum10, oneNum11, twoNum11, totalNum11, oneNum12, twoNum12, totalNum12);
//		commonQuery();
	}
	...
	public DataSource getDataSource() {
		return DSReportOnEmployeeBenefitTotalByDepartment.getInstance();
	}
