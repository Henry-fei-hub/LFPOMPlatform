...
import com.pomplatform.client.report.datasource.DSReportOnEmployeeEducationTotal;
import com.pomplatform.client.report.form.ReportOnEmployeeEducationTotalSearchForm;
import com.pomplatform.client.report.form.ReportOnEmployeeEducationTotalViewer;
...
public class ReportOnEmployeeEducationTotalPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			ReportOnEmployeeEducationTotalPanel cm = new ReportOnEmployeeEducationTotalPanel();
			id = cm.getID();
			return cm;
		}
		...
		public String getDescription() {
			return "ReportOnEmployeeEducationTotal";
		}
	...
	public void initComponents() {
		...
		resultGrid.addDoubleClickHandler(new DoubleClickHandler() {
			...
			public void onDoubleClick(DoubleClickEvent event) {
				...
				ReportOnEmployeeEducationTotalByDepartmentPanel panel = new ReportOnEmployeeEducationTotalByDepartmentPanel();
				pw.addItem(panel);
	...
	public SearchForm generateSearchForm() {
		return new ReportOnEmployeeEducationTotalSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSReportOnEmployeeEducationTotal.getInstance();
	}
