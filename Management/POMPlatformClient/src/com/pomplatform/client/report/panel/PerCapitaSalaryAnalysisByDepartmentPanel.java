...
import com.pomplatform.client.report.datasource.DSPerCapitaSalaryAnalysisByDepartment;
import com.pomplatform.client.report.form.PerCapitaSalaryAnalysisByDepartmentSearchForm;
import com.pomplatform.client.report.form.PerCapitaSalaryAnalysisByDepartmentViewer;
...
public class PerCapitaSalaryAnalysisByDepartmentPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			PerCapitaSalaryAnalysisByDepartmentPanel cm = new PerCapitaSalaryAnalysisByDepartmentPanel();
			id = cm.getID();
			return cm;
		}
		...
		public String getDescription() {
			return "PerCapitaSalaryAnalysisByDepartment";
		}
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("PerCapitaSalaryAnalysisByDepartment"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				PerCapitaSalaryAnalysisByDepartmentViewer detailForm = new PerCapitaSalaryAnalysisByDepartmentViewer();
...
//		return new PerCapitaSalaryAnalysisByDepartmentSearchForm();
		return null;
	}

	@Override
	public DataSource getDataSource() {
		return DSPerCapitaSalaryAnalysisByDepartment.getInstance();
	}
