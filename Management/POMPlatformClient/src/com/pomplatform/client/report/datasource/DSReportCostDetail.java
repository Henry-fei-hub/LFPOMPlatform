...
public class DSReportCostDetail extends DBDataSource
{


	public static DSReportCostDetail instance = null;

	public static DSReportCostDetail getInstance() {
		if(instance == null) {
			instance = new DSReportCostDetail("DSReportCostDetail");
		}
		return instance;
	}
	...
	public DSReportCostDetail(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("ReportCostDetail");
