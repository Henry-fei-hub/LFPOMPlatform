...
public class DSReportCapitalTotal extends DBDataSource
{


	public static DSReportCapitalTotal instance = null;

	public static DSReportCapitalTotal getInstance() {
		if(instance == null) {
			instance = new DSReportCapitalTotal("DSReportCapitalTotal");
		}
		return instance;
	}
	...
	public DSReportCapitalTotal(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("ReportCapitalTotal");
