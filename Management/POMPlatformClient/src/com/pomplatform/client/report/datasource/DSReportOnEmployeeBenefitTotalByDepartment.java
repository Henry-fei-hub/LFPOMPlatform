...
public class DSReportOnEmployeeBenefitTotalByDepartment extends DBDataSource
{


	public static DSReportOnEmployeeBenefitTotalByDepartment instance = null;

	public static DSReportOnEmployeeBenefitTotalByDepartment getInstance() {
		if(instance == null) {
			instance = new DSReportOnEmployeeBenefitTotalByDepartment("DSReportOnEmployeeBenefitTotalByDepartment");
		}
		return instance;
	}
	...
	public DSReportOnEmployeeBenefitTotalByDepartment(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("ReportOnEmployeeBenefitTotalByDepartment");
