...
public class DSDepartmentIncomeDetailReport extends DBDataSource
{


	public static DSDepartmentIncomeDetailReport instance = null;

	public static DSDepartmentIncomeDetailReport getInstance() {
		if(instance == null) {
			instance = new DSDepartmentIncomeDetailReport("DSDepartmentIncomeDetailReport");
		}
		return instance;
	}

	private final DataSourceTextField detailsField;
	...
	public DSDepartmentIncomeDetailReport(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("DepartmentIncomeDetailReport");


		detailsField = new DataSourceTextField("details", "详情");
		detailsField.setLength(18);
		...
		plateIdField.setForeignKey("DSDepartmentIncomeDetailReport.plateId");
		...
		setFields(detailsField, plateIdField, januaryField, februaryField, marchField, aprilField, mayField, juneField, julyField, augustField, septemberField, octoberField, novemberField, decemberField);
	}
