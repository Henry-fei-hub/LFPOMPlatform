...
public class DSReportSureIntegralTotal extends DBDataSource
{


	public static DSReportSureIntegralTotal instance = null;

	public static DSReportSureIntegralTotal getInstance() {
		if(instance == null) {
			instance = new DSReportSureIntegralTotal("DSReportSureIntegralTotal");
		}
		return instance;
	}
	...
	public DSReportSureIntegralTotal(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("ReportSureIntegralTotal");
		...
		setFields(plateIdField, yearField, januaryRevenueField, februaryRevenueField, marchRevenueField, aprilRevenueField, mayRevenueField, juneRevenueField, julyRevenueField, augustRevenueField, septemberRevenueField, octoberRevenueField, novemberRevenueField, decemberRevenueField, plateJanuaryRevenueField, plateFebruaryRevenueField, plateMarchRevenueField, plateAprilRevenueField, plateMayRevenueField, plateJuneRevenueField, plateJulyRevenueField, plateAugustRevenueField, plateSeptemberRevenueField, plateOctoberRevenueField, plateNovemberRevenueField, plateDecemberRevenueField);
	}
