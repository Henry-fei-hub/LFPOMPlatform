...
public class DSReportOnEmployeeNumTotal extends DBDataSource
{


	public static DSReportOnEmployeeNumTotal instance = null;

	public static DSReportOnEmployeeNumTotal getInstance() {
		if(instance == null) {
			instance = new DSReportOnEmployeeNumTotal("DSReportOnEmployeeNumTotal");
		}
		return instance;
	}
	...
	public DSReportOnEmployeeNumTotal(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("ReportOnEmployeeNumTotal");
