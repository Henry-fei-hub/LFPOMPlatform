...
public class DSReportOfSumRevenueYearRecordDetail extends DBDataSource
{


	public static DSReportOfSumRevenueYearRecordDetail instance = null;

	public static DSReportOfSumRevenueYearRecordDetail getInstance() {
		if(instance == null) {
			instance = new DSReportOfSumRevenueYearRecordDetail("DSReportOfSumRevenueYearRecordDetail");
		}
		return instance;
	}
	private final DataSourceTextField revenuePlateIdField;
	...
	private final DataSourceFloatField beforeRevenueField;
	private final DataSourceFloatField totalField;

	public DSReportOfSumRevenueYearRecordDetail(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("ReportOfSumRevenueYearRecordDetail");

		revenuePlateIdField = new DataSourceTextField("revenuePlateId", "业务部门");
		revenuePlateIdField.setLength(11);
		revenuePlateIdField.setRequired(false);
		revenuePlateIdField.setHidden(false);
		revenuePlateIdField.setValueMap(KeyValueManager.getValueMap("plate_records"));
		...
		beforeRevenueField = new DataSourceFloatField("beforeRevenue", "期初累计营收");
		beforeRevenueField.setLength(18);
		beforeRevenueField.setDecimalPad(2);
		beforeRevenueField.setFormat("#,###,###,###,###,##0.00");
		beforeRevenueField.setRequired(true);
		beforeRevenueField.setHidden(false);
		...
		setFields(revenuePlateIdField,yearField, projectIdField, contractCodeField, projectNameField, sheetAmountField, beforeRevenueField, januaryRevenueField, februaryRevenueField, marchRevenueField, aprilRevenueField, mayRevenueField, juneRevenueField, julyRevenueField, augustRevenueField, septemberRevenueField, octoberRevenueField, novemberRevenueField, decemberRevenueField, totalField);
	}
