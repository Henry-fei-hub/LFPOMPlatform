...
public class DSReportNewContractTotal extends DBDataSource
{


	public static DSReportNewContractTotal instance = null;

	public static DSReportNewContractTotal getInstance() {
		if(instance == null) {
			instance = new DSReportNewContractTotal("DSReportNewContractTotal");
		}
		return instance;
	}
	...
	public DSReportNewContractTotal(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("ReportNewContractTotal");
