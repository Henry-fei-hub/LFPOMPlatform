...
public class DSReportOfSalaryTotal extends DBDataSource
{


	public static DSReportOfSalaryTotal instance = null;

	public static DSReportOfSalaryTotal getInstance() {
		if(instance == null) {
			instance = new DSReportOfSalaryTotal("DSReportOfSalaryTotal");
		}
		return instance;
	}
	...
	public DSReportOfSalaryTotal(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("ReportOfSalaryTotal");
		...
		januaryField = new DataSourceFloatField("january", "1月");
		...
		februaryField = new DataSourceFloatField("february", "2月");
		...
		marchField = new DataSourceFloatField("march", "3月");
		...
		aprilField = new DataSourceFloatField("april", "4月");
		...
		mayField = new DataSourceFloatField("may", "5月");
		...
		juneField = new DataSourceFloatField("june", "6月");
		...
		julyField = new DataSourceFloatField("july", "7月");
		...
		augustField = new DataSourceFloatField("august", "8月");
		...
		septemberField = new DataSourceFloatField("september", "9月");
		...
		octoberField = new DataSourceFloatField("october", "10月");
		...
		novemberField = new DataSourceFloatField("november", "11月");
		...
		decemberField = new DataSourceFloatField("december", "12月");
		...
		setFields(plateIdField, yearField, januaryField, februaryField, marchField, aprilField, mayField, juneField, julyField, augustField, septemberField, octoberField, novemberField, decemberField, totalField);
	}
