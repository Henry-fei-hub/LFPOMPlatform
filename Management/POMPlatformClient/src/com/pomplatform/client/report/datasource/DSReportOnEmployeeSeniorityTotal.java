...
public class DSReportOnEmployeeSeniorityTotal extends DBDataSource
{


	public static DSReportOnEmployeeSeniorityTotal instance = null;

	public static DSReportOnEmployeeSeniorityTotal getInstance() {
		if(instance == null) {
			instance = new DSReportOnEmployeeSeniorityTotal("DSReportOnEmployeeSeniorityTotal");
		}
		return instance;
	}
	...
	public DSReportOnEmployeeSeniorityTotal(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("ReportOnEmployeeSeniorityTotal");
