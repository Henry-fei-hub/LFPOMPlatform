...
public class DSReportOnEmployeeAgeTotal extends DBDataSource
{


	public static DSReportOnEmployeeAgeTotal instance = null;

	public static DSReportOnEmployeeAgeTotal getInstance() {
		if(instance == null) {
			instance = new DSReportOnEmployeeAgeTotal("DSReportOnEmployeeAgeTotal");
		}
		return instance;
	}
	...
	public DSReportOnEmployeeAgeTotal(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("ReportOnEmployeeAgeTotal");
