...
public class DSReportOnEmployeeEducationTotal extends DBDataSource
{


	public static DSReportOnEmployeeEducationTotal instance = null;

	public static DSReportOnEmployeeEducationTotal getInstance() {
		if(instance == null) {
			instance = new DSReportOnEmployeeEducationTotal("DSReportOnEmployeeEducationTotal");
		}
		return instance;
	}
	...
	public DSReportOnEmployeeEducationTotal(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("ReportOnEmployeeEducationTotal");
