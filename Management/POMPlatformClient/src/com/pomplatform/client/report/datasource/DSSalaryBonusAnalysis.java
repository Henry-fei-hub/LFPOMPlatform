...
public class DSSalaryBonusAnalysis extends DBDataSource
{


	public static DSSalaryBonusAnalysis instance = null;

	public static DSSalaryBonusAnalysis getInstance() {
		if(instance == null) {
			instance = new DSSalaryBonusAnalysis("DSSalaryBonusAnalysis");
		}
		return instance;
	}
	...
	public DSSalaryBonusAnalysis(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("SalaryBonusAnalysis");
		...
		setFields(plateIdField, yearField, firstQuarterField, firstPayIntegralField, oneField, secondQuarterField, secondPayIntegralField, twoField, thirdQuarterField, thirdPayIntegralField, threeField, fourthQuarterField, fourthPayIntegralField, fourField, totalQuarterField, totalPayIntegralField, totalField);
		}
