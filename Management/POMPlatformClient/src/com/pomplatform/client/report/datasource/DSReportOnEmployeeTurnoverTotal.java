...
public class DSReportOnEmployeeTurnoverTotal extends DBDataSource
{


	public static DSReportOnEmployeeTurnoverTotal instance = null;

	public static DSReportOnEmployeeTurnoverTotal getInstance() {
		if(instance == null) {
			instance = new DSReportOnEmployeeTurnoverTotal("DSReportOnEmployeeTurnoverTotal");
		}
		return instance;
	}
	...
	public DSReportOnEmployeeTurnoverTotal(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("ReportOnEmployeeTurnoverTotal");
