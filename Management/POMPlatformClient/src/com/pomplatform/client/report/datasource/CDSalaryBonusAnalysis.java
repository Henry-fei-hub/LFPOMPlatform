...
public class CDSalaryBonusAnalysis extends DataSource
{


	public static CDSalaryBonusAnalysis instance = null;

	public static CDSalaryBonusAnalysis getInstance() {
		if(instance == null) {
			instance = new CDSalaryBonusAnalysis("CDSalaryBonusAnalysis");
		}
		return instance;
	}
	...
	public CDSalaryBonusAnalysis(String dataSourceID) {
