...
public class CDPerCapitaSalaryAnalysis extends DataSource
{


	public static CDPerCapitaSalaryAnalysis instance = null;

	public static CDPerCapitaSalaryAnalysis getInstance() {
		if(instance == null) {
			instance = new CDPerCapitaSalaryAnalysis("CDPerCapitaSalaryAnalysis");
		}
		return instance;
	}
	...
	public CDPerCapitaSalaryAnalysis(String dataSourceID) {
		...
		setFields(plateIdField, yearField, firstStartField, firstEndField, secondStartField, secondEndField, thirdStartField, thirdEndField, fourthStartField, fourthEndField, currentPageField, pageLinesField);
