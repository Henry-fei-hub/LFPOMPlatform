...
public class DSReportOfGenderAnalysis extends DBDataSource
{


	public static DSReportOfGenderAnalysis instance = null;

	public static DSReportOfGenderAnalysis getInstance() {
		if(instance == null) {
			instance = new DSReportOfGenderAnalysis("DSReportOfGenderAnalysis");
		}
		return instance;
	}
	...
	public DSReportOfGenderAnalysis(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("ReportOfGenderAnalysis");
