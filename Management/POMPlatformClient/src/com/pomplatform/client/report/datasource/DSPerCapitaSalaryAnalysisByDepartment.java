...
public class DSPerCapitaSalaryAnalysisByDepartment extends DBDataSource
{


	public static DSPerCapitaSalaryAnalysisByDepartment instance = null;

	public static DSPerCapitaSalaryAnalysisByDepartment getInstance() {
		if(instance == null) {
			instance = new DSPerCapitaSalaryAnalysisByDepartment("DSPerCapitaSalaryAnalysisByDepartment");
		}
		return instance;
	}
	...
	public DSPerCapitaSalaryAnalysisByDepartment(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("PerCapitaSalaryAnalysisByDepartment");
