...
public class DSReportEmployeeWorkYearsByDepartment extends DBDataSource
{


	public static DSReportEmployeeWorkYearsByDepartment instance = null;

	public static DSReportEmployeeWorkYearsByDepartment getInstance() {
		if(instance == null) {
			instance = new DSReportEmployeeWorkYearsByDepartment("DSReportEmployeeWorkYearsByDepartment");
		}
		return instance;
	}
	...
	public DSReportEmployeeWorkYearsByDepartment(String dataSourceID) {
		super();
		setID(dataSourceID);
