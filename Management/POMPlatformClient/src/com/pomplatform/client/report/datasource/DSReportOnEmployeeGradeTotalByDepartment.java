...
public class DSReportOnEmployeeGradeTotalByDepartment extends DBDataSource
{


	public static DSReportOnEmployeeGradeTotalByDepartment instance = null;

	public static DSReportOnEmployeeGradeTotalByDepartment getInstance() {
		if(instance == null) {
			instance = new DSReportOnEmployeeGradeTotalByDepartment("DSReportOnEmployeeGradeTotalByDepartment");
		}
		return instance;
	}
	...
	public DSReportOnEmployeeGradeTotalByDepartment(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("ReportOnEmployeeGradeTotalByDepartment");
