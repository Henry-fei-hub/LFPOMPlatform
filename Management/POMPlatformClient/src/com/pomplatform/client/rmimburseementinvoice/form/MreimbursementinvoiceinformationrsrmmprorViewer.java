...
public class MreimbursementinvoiceinformationrsrmmprorViewer extends AbstractDetailViewer
{
	...
	public MreimbursementinvoiceinformationrsrmmprorViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_Mreimbursementinvoiceinformationrsrmmpror", "find", new DSCallback() {
			@Override
