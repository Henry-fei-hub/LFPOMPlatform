...
import com.pomplatform.client.reimbursementpackage.datasource.CDBorrowMoneyStatus2;

public class BorrowMoneyStatus2SearchForm extends SearchForm
{
	...
	public BorrowMoneyStatus2SearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDBorrowMoneyStatus2.getInstance());
