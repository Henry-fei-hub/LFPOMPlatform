...
import com.pomplatform.client.reimbursementpackage.datasource.CDPayMoneyStatus2;

public class PayMoneyStatus2SearchForm extends SearchForm
{
	...
	public PayMoneyStatus2SearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDPayMoneyStatus2.getInstance());
