...
public class CDNewReimbursementPackage extends DataSource
{


	public static CDNewReimbursementPackage instance = null;

	public static CDNewReimbursementPackage getInstance() {
		if(instance == null) {
			instance = new CDNewReimbursementPackage("CDNewReimbursementPackage");
		}
		return instance;
	}
	...
	public CDNewReimbursementPackage(String dataSourceID) {
