...
public class DSNormalReimbursementStatus2 extends DBDataSource
{


	public static DSNormalReimbursementStatus2 instance = null;

	public static DSNormalReimbursementStatus2 getInstance() {
		if(instance == null) {
			instance = new DSNormalReimbursementStatus2("DSNormalReimbursementStatus2");
		}
		return instance;
	}
	...
	public DSNormalReimbursementStatus2(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("NormalReimbursementStatus2");
