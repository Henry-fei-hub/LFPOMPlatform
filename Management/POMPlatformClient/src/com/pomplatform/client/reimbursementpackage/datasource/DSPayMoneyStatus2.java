...
public class DSPayMoneyStatus2 extends DBDataSource
{


	public static DSPayMoneyStatus2 instance = null;

	public static DSPayMoneyStatus2 getInstance() {
		if(instance == null) {
			instance = new DSPayMoneyStatus2("DSPayMoneyStatus2");
		}
		return instance;
	}
	...
	public DSPayMoneyStatus2(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("PayMoneyStatus2");
