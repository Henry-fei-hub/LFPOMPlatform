...
public class CDBorrowMoneyStatus2 extends DataSource
{


	public static CDBorrowMoneyStatus2 instance = null;

	public static CDBorrowMoneyStatus2 getInstance() {
		if(instance == null) {
			instance = new CDBorrowMoneyStatus2("CDBorrowMoneyStatus2");
		}
		return instance;
	}
	...
	public CDBorrowMoneyStatus2(String dataSourceID) {
