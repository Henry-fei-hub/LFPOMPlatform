...
public class CDNormalReimbursementStatus2 extends DataSource
{


	public static CDNormalReimbursementStatus2 instance = null;

	public static CDNormalReimbursementStatus2 getInstance() {
		if(instance == null) {
			instance = new CDNormalReimbursementStatus2("CDNormalReimbursementStatus2");
		}
		return instance;
	}
	...
	public CDNormalReimbursementStatus2(String dataSourceID) {
