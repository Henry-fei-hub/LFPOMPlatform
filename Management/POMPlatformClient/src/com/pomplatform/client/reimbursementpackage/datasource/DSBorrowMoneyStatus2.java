...
public class DSBorrowMoneyStatus2 extends DBDataSource
{


	public static DSBorrowMoneyStatus2 instance = null;

	public static DSBorrowMoneyStatus2 getInstance() {
		if(instance == null) {
			instance = new DSBorrowMoneyStatus2("DSBorrowMoneyStatus2");
		}
		return instance;
	}
	...
	public DSBorrowMoneyStatus2(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("BorrowMoneyStatus2");
