...
public class DSNewReimbursementPackage extends DBDataSource
{


	public static DSNewReimbursementPackage instance = null;

	public static DSNewReimbursementPackage getInstance() {
		if(instance == null) {
			instance = new DSNewReimbursementPackage("DSNewReimbursementPackage");
		}
		return instance;
	}
	...
	public DSNewReimbursementPackage(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("MnewReimbursementPackagepecdcbor");
