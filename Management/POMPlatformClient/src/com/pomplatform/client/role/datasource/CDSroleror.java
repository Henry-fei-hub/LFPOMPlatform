...
public class CDSroleror extends DataSource
{


	public static CDSroleror instance = null;

	public static CDSroleror getInstance() {
		if(instance == null) {
			instance = new CDSroleror("CDSroleror");
		}
		return instance;
	}
	...
	public CDSroleror(String dataSourceID) {
