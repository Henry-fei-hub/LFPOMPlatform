...
public class ScontractreceivabletemplaterrcorViewer extends AbstractDetailViewer
{
	...
	public ScontractreceivabletemplaterrcorViewer() {
	}
	...
	public void load() {
		...
		params.put("contractReceivableTemplateId", getBusinessId());
		DBDataSource.callOperation("NQ_Scontractreceivabletemplaterrcor", "find", new DSCallback() {
			@Override
