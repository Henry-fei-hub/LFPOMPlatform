...
public class NewScontractreceivabletemplaterrcorForm extends GenericWizadWindow
{
	...
	public String getActionName(){
		// 需要根据实际业务修改
		return "ST_ContractReceivableTemplate";
	}
	...
	public List<AbstractWizadPage> getPages(){
		...
		res.add(new ScontractreceivabletemplaterrcorNewForm());
		return res;
	}
