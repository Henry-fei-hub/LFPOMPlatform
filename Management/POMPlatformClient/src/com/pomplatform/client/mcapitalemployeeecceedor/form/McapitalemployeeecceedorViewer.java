...
public class McapitalemployeeecceedorViewer extends AbstractDetailViewer
{
	...
	public McapitalemployeeecceedorViewer() {
	}
	...
	public void load() {
		...
		params.put("capitalEmployeeId", getBusinessId());
		DBDataSource.callOperation("NQ_Mcapitalemployeeecceedor", "find", new DSCallback() {
			@Override
