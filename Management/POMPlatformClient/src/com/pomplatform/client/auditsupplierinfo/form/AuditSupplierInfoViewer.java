...
public class AuditSupplierInfoViewer extends AbstractDetailViewer
{
	...
	public AuditSupplierInfoViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_AuditSupplierInfo", "find", new DSCallback() {
			@Override
