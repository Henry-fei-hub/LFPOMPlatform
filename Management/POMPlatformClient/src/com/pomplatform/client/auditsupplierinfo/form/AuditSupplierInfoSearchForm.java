package com.pomplatform.client.auditsupplierinfo.form;
...
import com.pomplatform.client.auditsupplierinfo.datasource.CDAuditSupplierInfo;

public class AuditSupplierInfoSearchForm extends SearchForm
{
	...
	public AuditSupplierInfoSearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDAuditSupplierInfo.getInstance());
		...
		setItems(supplierNameItem,areasExpertiseItem,createTimeStartItem, createTimeEndItem, employeeIdItem,processStatusItem);
		setNumCols(10);
