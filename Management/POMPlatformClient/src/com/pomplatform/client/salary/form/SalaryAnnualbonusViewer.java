...
public class SalaryAnnualbonusViewer extends AbstractDetailViewer
{
	...
	public SalaryAnnualbonusViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_SalaryAnnualbonus", "find", new DSCallback() {
			@Override
