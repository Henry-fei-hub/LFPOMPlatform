...
public class SalaryOfWorkYearsViewer extends AbstractDetailViewer
{
	...
	public SalaryOfWorkYearsViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_SalaryOfWorkYears", "find", new DSCallback() {
			@Override
