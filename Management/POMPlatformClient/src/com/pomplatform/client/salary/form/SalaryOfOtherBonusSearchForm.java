...
import com.pomplatform.client.salary.datasource.CDSalaryOfOtherBonus;

public class SalaryOfOtherBonusSearchForm extends SearchForm
{
	...
	public SalaryOfOtherBonusSearchForm() {
		setWidth100();
		setHeight100();
