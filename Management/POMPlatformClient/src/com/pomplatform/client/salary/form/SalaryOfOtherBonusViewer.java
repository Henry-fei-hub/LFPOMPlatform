...
public class SalaryOfOtherBonusViewer extends AbstractDetailViewer
{
	...
	public SalaryOfOtherBonusViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_SalaryOfOtherBonus", "find", new DSCallback() {
			@Override
