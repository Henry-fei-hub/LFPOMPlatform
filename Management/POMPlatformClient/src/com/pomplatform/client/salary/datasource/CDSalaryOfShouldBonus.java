...
public class CDSalaryOfShouldBonus extends DataSource
{


	public static CDSalaryOfShouldBonus instance = null;

	public static CDSalaryOfShouldBonus getInstance() {
		if(instance == null) {
			instance = new CDSalaryOfShouldBonus("CDSalaryOfShouldBonus");
		}
		return instance;
	}
	...
	public CDSalaryOfShouldBonus(String dataSourceID) {
