...
public class CDSalaryOfOtherBonus extends DataSource
{


	public static CDSalaryOfOtherBonus instance = null;

	public static CDSalaryOfOtherBonus getInstance() {
		if(instance == null) {
			instance = new CDSalaryOfOtherBonus("CDSalaryOfOtherBonus");
		}
		return instance;
	}
	...
	public CDSalaryOfOtherBonus(String dataSourceID) {
