...
import com.pomplatform.client.salary.datasource.DSSalaryOfShouldBonus;
import com.pomplatform.client.salary.form.SalaryOfShouldBonusSearchForm;
import com.pomplatform.client.salary.form.SalaryOfShouldBonusViewer;
...
public class SalaryOfShouldBonusPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			SalaryOfShouldBonusPanel cm = new SalaryOfShouldBonusPanel();
			id = cm.getID();
			return cm;
		}
	...
	public void initComponents() {
		...
		downloadTemplate.addClickHandler(new ClickHandler() {
            @Override
            public void onClick(ClickEvent event) {
            	DownloadFileByUrl.download("/files/shouldBonus.xlsx");
            }
        });
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("SalaryOfShouldBonus"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				SalaryOfShouldBonusViewer detailForm = new SalaryOfShouldBonusViewer();
	...
	public SearchForm generateSearchForm() {
		return new SalaryOfShouldBonusSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSSalaryOfShouldBonus.getInstance();
	}
