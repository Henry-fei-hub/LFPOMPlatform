...
public class AboutReimbursementPayseqViewer extends AbstractDetailViewer
{
	...
	public AboutReimbursementPayseqViewer() {
	}
	...
	public void load() {
		...
		params.put("budgetAttachmentId", getBusinessId());
		DBDataSource.callOperation("NQ_AboutReimbursementPayseq", "find", new DSCallback() {
			@Override
