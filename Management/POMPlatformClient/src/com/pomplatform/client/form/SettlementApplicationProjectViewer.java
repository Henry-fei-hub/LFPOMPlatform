...
public class SettlementApplicationProjectViewer extends AbstractDetailViewer
{
	...
	public SettlementApplicationProjectViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_SettlementApplicationProject", "find", new DSCallback() {
			@Override
	...
	public DataSource getMainDataSource() {
		return DSSettlementApplicationProject.getInstance();
	}
