package com.pomplatform.client.sprojectintegralsumrecordpysor.panel;
...
import com.pomplatform.client.sprojectintegralsumrecordpysor.form.SprojectintegralsumrecordpysorViewer;
import com.google.gwt.core.client.GWT;
import com.google.gwt.core.client.RunAsyncCallback;
import com.pomplatform.client.common.CommonFormat;
import com.pomplatform.client.sprojectintegralsumrecordpymor.panel.SprojectintegralsumrecordpymorPanel;
...
public class SprojectintegralsumrecordpysorPanel extends AbstractSearchPanel {
    ...
    public static class Factory implements PanelFactory {
        ...
        public Canvas create() {
            SprojectintegralsumrecordpysorPanel cm = new SprojectintegralsumrecordpysorPanel();
            id = cm.getID();
            return cm;
        }
    ...
    public void initComponents() {
        ...
        resultGrid.addDoubleClickHandler(new DoubleClickHandler() {
            ...
            public void onDoubleClick(DoubleClickEvent event) {
                ...
                SprojectintegralsumrecordpymorPanel panel = new SprojectintegralsumrecordpymorPanel();
                panel.setParamMap(paramMap);
                pw.addItem(panel.getViewPanel());
                pw.setTitle(KeyValueManager.getValue("system_dictionary_1", plateId + "") + "的项目积分汇总明细");
                pw.setWidth100();
                pw.setHeight100();
                pw.centerInPage();
                pw.show();
        ...
        downLoadButton.addClickHandler(new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                ...
                DBDataSource.downloadFile("DW_Sprojectintegralsumrecordpysor", condition);
            }
        });
        commonQuery();
    }
    ...
    public void showDetail() {
        GWT.runAsync(new RunAsyncCallback() {
            ...
            public void onSuccess() {
                ...
                detail.setWidth100();
                detail.setHeight100();
                SprojectintegralsumrecordpysorViewer detailForm = new SprojectintegralsumrecordpysorViewer();
        ...
        DBDataSource.callOperation(operationName, condition, new DSCallback() {
            ...
            public void execute(DSResponse dsResponse, Object data, DSRequest dsRequest) {
                if (dsResponse.getStatus() >= 0) {
                    ...
                    totalItem.setValue("项目总积分:" + CommonFormat.doubleFormat(projectIntegralSum) + "  项目积分:" + CommonFormat.doubleFormat(projectIntegral) + "  预留积分:" + CommonFormat.doubleFormat(reserveIntegral) + "  确认积分:" + CommonFormat.doubleFormat(sureIntegral) + "  成本积分:" + CommonFormat.doubleFormat(projectCost) + "  结算积分:" + CommonFormat.doubleFormat(settlementIntegral));
