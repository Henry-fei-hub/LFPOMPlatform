...
import com.pomplatform.client.salaryemployeeevaluationrmmor.form.NewSsalaryemployeeevaluationrmmorForm;
import com.pomplatform.client.salaryemployeeevaluationrmmor.form.SsalaryemployeeevaluationrmmorSearchForm;
import com.pomplatform.client.salaryemployeeevaluationrmmor.form.SsalaryemployeeevaluationrmmorViewer;
import com.pomplatform.client.salaryemployeeevaluationrmmor.form.UpdateSsalaryemployeeevaluationrmmorForm;
...
public class SsalaryemployeeevaluationrmmorPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			SsalaryemployeeevaluationrmmorPanel cm = new SsalaryemployeeevaluationrmmorPanel();
			id = cm.getID();
			return cm;
		}
		...
		public String getDescription() {
			return "Ssalaryemployeeevaluationrmmor";
		}
	...
	public void initComponents() {
		...
		importBtn.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				param.put("flag", 1);
				UploadSalaryOfBonus uploadXls = new UploadSalaryOfBonus(param, DBDataSource.getServerURL("UP_OnUploadEmployeeEvaluationProcess"));
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					public void onSuccess() {
						...
						UpdateSsalaryemployeeevaluationrmmorForm detailForm = new UpdateSsalaryemployeeevaluationrmmorForm();
		...
		operation3Button.addClickHandler(new ClickHandler(){
			...
			public void onClick(ClickEvent event) {
				GWT.runAsync(new RunAsyncCallback() {
					...
					@Override
					public void onSuccess() {
						NewSsalaryemployeeevaluationrmmorForm detailForm = new NewSsalaryemployeeevaluationrmmorForm();
		...
		removeButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				DBDataSource.callOperation("ST_Ssalaryemployeeevaluationrmmor", "delete", selected.toMap(), new DSCallback() {
					@Override
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setWidth100(); 
				detail.setHeight100(); 
				SsalaryemployeeevaluationrmmorViewer detailForm = new SsalaryemployeeevaluationrmmorViewer();
	...
	public boolean checkSearchCriteria(Map criteria) {
		criteria.put("addtionalCondition", "order by salary_employee_evaluation_id");
		return true;
	}
	...
	public SearchForm generateSearchForm() {
		return new SsalaryemployeeevaluationrmmorSearchForm();
	}

	@Override
	public DataSource getDataSource() {
		return DSSsalaryemployeeevaluationrmmor.getInstance();
	}
