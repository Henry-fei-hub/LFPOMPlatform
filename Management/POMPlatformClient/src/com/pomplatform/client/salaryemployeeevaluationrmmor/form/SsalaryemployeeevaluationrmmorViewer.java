...
public class SsalaryemployeeevaluationrmmorViewer extends AbstractDetailViewer
{
	...
	public SsalaryemployeeevaluationrmmorViewer() {
	}
	...
	public void load() {
		...
		params.put("salaryEmployeeEvaluationId", getBusinessId());
		DBDataSource.callOperation("NQ_Ssalaryemployeeevaluationrmmor", "find", new DSCallback() {
			@Override
