...
public class SsalaryemployeeperformancemmeorViewer extends AbstractDetailViewer
{
	...
	public SsalaryemployeeperformancemmeorViewer() {
	}
	...
	public void load() {
		...
		params.put("salaryEmployeePerformanceId", getBusinessId());
		DBDataSource.callOperation("NQ_Ssalaryemployeeperformancemmeor", "find", new DSCallback() {
			@Override
