...
public class SsalaryemployeeevaluationrmmorUpdateForm extends AbstractWizadPage
{
	...
	public SsalaryemployeeevaluationrmmorUpdateForm() {
		DSSsalaryemployeeevaluationrmmor ds = DSSsalaryemployeeevaluationrmmor.getInstance();
		__form.setWidth100();
		__form.setHeight100();
		salaryEmployeeEvaluationIdItem = new TextItem("salaryEmployeeEvaluationId", "salary_employee_evaluation_id");
		salaryEmployeeEvaluationIdItem.setDisabled(true);
		salaryEmployeeEvaluationIdItem.setRequired(true);
		IsIntegerValidator salaryEmployeeEvaluationIdValidator = new IsIntegerValidator();
		salaryEmployeeEvaluationIdItem.setValidators(salaryEmployeeEvaluationIdValidator);
		__formItems.add(salaryEmployeeEvaluationIdItem);
