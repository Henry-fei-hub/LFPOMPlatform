...
public class OutTempletViewer extends AbstractDetailViewer
{
	...
	public List<GroupColumn> getGroupColumnNames() {
		...
		GroupColumn gc;
		gc = new GroupColumn();
		gc.setGroupName("模板基本信息");
		gc.setGroupCaption("Newgroup1");
		gc.getColumnNames().add("businessType");
		gc.getColumnNames().add("templetName");
		gc.getColumnNames().add("createTime");
		gc.getColumnNames().add("defaultTemplet");
		gcs.add(gc);
		return gcs;
	}
