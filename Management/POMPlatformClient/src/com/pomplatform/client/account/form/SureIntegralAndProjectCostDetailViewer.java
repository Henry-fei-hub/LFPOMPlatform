...
public class SureIntegralAndProjectCostDetailViewer extends AbstractDetailViewer
{
	...
	public SureIntegralAndProjectCostDetailViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_SureIntegralAndProjectCostDetail", "find", new DSCallback() {
			@Override
