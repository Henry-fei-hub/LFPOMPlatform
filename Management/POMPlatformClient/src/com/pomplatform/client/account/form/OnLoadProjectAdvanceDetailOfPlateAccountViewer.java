...
public class OnLoadProjectAdvanceDetailOfPlateAccountViewer extends AbstractDetailViewer
{
	...
	public OnLoadProjectAdvanceDetailOfPlateAccountViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadProjectAdvanceDetailOfPlateAccount", "find", new DSCallback() {
			@Override
