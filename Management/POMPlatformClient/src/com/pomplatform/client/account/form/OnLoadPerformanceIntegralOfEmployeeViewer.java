...
public class OnLoadPerformanceIntegralOfEmployeeViewer extends AbstractDetailViewer
{
	...
	public OnLoadPerformanceIntegralOfEmployeeViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadPerformanceIntegralOfEmployee", "find", new DSCallback() {
			@Override
