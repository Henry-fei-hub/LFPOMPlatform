...
public class OnLoadOtherProjectDetailOfPlateAccountViewer extends AbstractDetailViewer
{
	...
	public OnLoadOtherProjectDetailOfPlateAccountViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadOtherProjectDetailOfPlateAccount", "find", new DSCallback() {
			@Override
