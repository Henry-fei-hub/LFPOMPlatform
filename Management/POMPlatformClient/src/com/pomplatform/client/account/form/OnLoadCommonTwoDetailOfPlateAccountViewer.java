...
public class OnLoadCommonTwoDetailOfPlateAccountViewer extends AbstractDetailViewer
{
	...
	public OnLoadCommonTwoDetailOfPlateAccountViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLoadCommonTwoDetailOfPlateAccount", "find", new DSCallback() {
			@Override
