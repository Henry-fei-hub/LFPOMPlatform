...
public class CollaborativeFeeDetailOfPlateAccountViewer extends AbstractDetailViewer
{
	...
	public CollaborativeFeeDetailOfPlateAccountViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_CollaborativeFeeDetailOfPlateAccount", "find", new DSCallback() {
			@Override
