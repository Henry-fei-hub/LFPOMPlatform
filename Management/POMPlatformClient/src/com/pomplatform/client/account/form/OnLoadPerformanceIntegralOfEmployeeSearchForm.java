...
import com.pomplatform.client.account.datasource.CDOnLoadPerformanceIntegralOfEmployee;

public class OnLoadPerformanceIntegralOfEmployeeSearchForm extends SearchForm
{
	...
	public OnLoadPerformanceIntegralOfEmployeeSearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDOnLoadPerformanceIntegralOfEmployee.getInstance());
