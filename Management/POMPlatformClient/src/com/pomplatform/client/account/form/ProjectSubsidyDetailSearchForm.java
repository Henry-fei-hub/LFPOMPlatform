...
import com.pomplatform.client.account.datasource.CDProjectSubsidyDetail;

public class ProjectSubsidyDetailSearchForm extends SearchForm
{
	...
	public ProjectSubsidyDetailSearchForm() {
		setWidth100();
		setHeight100();
		setDataSource(CDProjectSubsidyDetail.getInstance());
