...
public class DSOnLoadQualityFundDetailData extends DBDataSource
{


	public static DSOnLoadQualityFundDetailData instance = null;

	public static DSOnLoadQualityFundDetailData getInstance() {
		if(instance == null) {
			instance = new DSOnLoadQualityFundDetailData("DSOnLoadQualityFundDetailData");
		}
		return instance;
	}
	...
	public DSOnLoadQualityFundDetailData(String dataSourceID) {
