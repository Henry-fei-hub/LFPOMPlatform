...
public class CDAllOtherDetail extends DataSource
{


	public static CDAllOtherDetail instance = null;

	public static CDAllOtherDetail getInstance() {
		if(instance == null) {
			instance = new CDAllOtherDetail("CDAllOtherDetail");
		}
		return instance;
	}
	...
	public CDAllOtherDetail(String dataSourceID) {
