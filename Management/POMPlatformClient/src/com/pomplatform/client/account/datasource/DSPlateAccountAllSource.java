...
public class DSPlateAccountAllSource extends DBDataSource {

	public static DSPlateAccountAllSource instance = null;

	public static DSPlateAccountAllSource getInstance() {
		if (instance == null) {
			instance = new DSPlateAccountAllSource("DSPlateAccountAllSource");
		}
		return instance;
	}
	...
	public DSPlateAccountAllSource(String dataSourceID) {
