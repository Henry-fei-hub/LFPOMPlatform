...
public class DSIntegralAdvance extends DBDataSource
{


	public static DSIntegralAdvance instance = null;

	public static DSIntegralAdvance getInstance() {
		if(instance == null) {
			instance = new DSIntegralAdvance("DSIntegralAdvance");
		}
		return instance;
	}
	...
	public DSIntegralAdvance(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("OnLoadIntegralAdvanceOfAccount");
