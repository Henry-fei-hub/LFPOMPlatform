...
public class CDOnLoadOtherProjectDetailOfPlateAccount extends DataSource
{


	public static CDOnLoadOtherProjectDetailOfPlateAccount instance = null;

	public static CDOnLoadOtherProjectDetailOfPlateAccount getInstance() {
		if(instance == null) {
			instance = new CDOnLoadOtherProjectDetailOfPlateAccount("CDOnLoadOtherProjectDetailOfPlateAccount");
		}
		return instance;
	}
	...
	public CDOnLoadOtherProjectDetailOfPlateAccount(String dataSourceID) {
