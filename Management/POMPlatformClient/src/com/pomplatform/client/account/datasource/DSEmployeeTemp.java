...
public class DSEmployeeTemp extends DBDataSource
{


	public static DSEmployeeTemp instance = null;

	public static DSEmployeeTemp getInstance() {
		if(instance == null) {
			instance = new DSEmployeeTemp("DSEmployeeTemp");
		}
		return instance;
	}
	...
	public DSEmployeeTemp(String dataSourceID) {

		super();
		setID(dataSourceID);
		setActionMode(ACTION_MODE_QUERY);
		setActionName("EmployeeTemp");
