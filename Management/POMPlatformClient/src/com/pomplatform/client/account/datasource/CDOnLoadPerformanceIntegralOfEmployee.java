...
public class CDOnLoadPerformanceIntegralOfEmployee extends DataSource
{


	public static CDOnLoadPerformanceIntegralOfEmployee instance = null;

	public static CDOnLoadPerformanceIntegralOfEmployee getInstance() {
		if(instance == null) {
			instance = new CDOnLoadPerformanceIntegralOfEmployee("CDOnLoadPerformanceIntegralOfEmployee");
		}
		return instance;
	}
	...
	public CDOnLoadPerformanceIntegralOfEmployee(String dataSourceID) {
