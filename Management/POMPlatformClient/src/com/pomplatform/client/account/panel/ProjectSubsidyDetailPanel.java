...
import com.pomplatform.client.account.datasource.DSProjectSubsidyDetail;
import com.pomplatform.client.account.form.ProjectSubsidyDetailViewer;
...
public class ProjectSubsidyDetailPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			ProjectSubsidyDetailPanel cm = new ProjectSubsidyDetailPanel();
			id = cm.getID();
			return cm;
		}
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setTitle("奖金补贴"); 
				detail.setWidth100(); 
				detail.setHeight100(); 
				ProjectSubsidyDetailViewer detailForm = new ProjectSubsidyDetailViewer();
...
//		return new ProjectSubsidyDetailSearchForm();
		return null;
	}

	@Override
	public DataSource getDataSource() {
		return DSProjectSubsidyDetail.getInstance();
	}
