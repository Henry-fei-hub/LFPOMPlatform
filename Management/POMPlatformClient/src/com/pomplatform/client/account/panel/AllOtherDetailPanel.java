...
import com.pomplatform.client.account.form.AllOtherDetailViewer;
...
public class AllOtherDetailPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			AllOtherDetailPanel cm = new AllOtherDetailPanel();
			id = cm.getID();
			return cm;
		}
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setWidth100(); 
				detail.setHeight100(); 
				AllOtherDetailViewer detailForm = new AllOtherDetailViewer();
...
//		return new AllOtherDetailSearchForm();
		return null;
	}
