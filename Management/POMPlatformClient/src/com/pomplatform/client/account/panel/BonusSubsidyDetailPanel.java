...
import com.pomplatform.client.account.datasource.DSBonusSubsidyDetail;
import com.pomplatform.client.account.form.BonusSubsidyDetailViewer;
...
public class BonusSubsidyDetailPanel extends AbstractSearchPanel
{
	...
	public static class Factory implements PanelFactory {
		...
		public Canvas create() {
			BonusSubsidyDetailPanel cm = new BonusSubsidyDetailPanel();
			id = cm.getID();
			return cm;
		}
	...
	public void showDetail() {
		GWT.runAsync(new RunAsyncCallback() {
			...
			public void onSuccess() {
				...
				detail.setWidth100(); 
				detail.setHeight100(); 
				BonusSubsidyDetailViewer detailForm = new BonusSubsidyDetailViewer();
...
//		return new BonusSubsidyDetailSearchForm();
		return null;
	}

	@Override
	public DataSource getDataSource() {
		return DSBonusSubsidyDetail.getInstance();
	}
