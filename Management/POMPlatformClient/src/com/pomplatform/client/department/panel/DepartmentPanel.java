...
import com.pomplatform.client.department.datasource.DSDepartment;
...
public class DepartmentPanel extends AbstractSearchTree {
    private static final Logger __logger = Logger.getLogger("DepartmentPanel");
    ...
    public void initComponents() {
        ...
        resultGrid.addDropCompleteHandler(new DropCompleteHandler() {
            ...
            public void onDropComplete(DropCompleteEvent event) {
                ...
                for (Record r : rs) {
                    DBDataSource.callOperation("ST_Department", "update", r.toMap(), new DSCallback() {
                        @Override
        ...
        resultGrid.addEditCompleteHandler(new EditCompleteHandler() {
            ...
            public void onEditComplete(EditCompleteEvent event) {
                ...
                DBDataSource.callOperation("ST_Department", "saveOrUpdate", params, new DSCallback() {
                    @Override
                    public void execute(DSResponse dsResponse, Object data, DSRequest dsRequest) {
                        if (dsResponse.getStatus() < 0) {
                            ClientUtil.displayErrorMessage(dsResponse);
...
//        controlLayout.addMember(removeButton);
        removeButton.addClickHandler(new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                ...
                DBDataSource.callOperation("ST_Department", "delete", selected.toMap(), new DSCallback() {
                    @Override
                    public void execute(DSResponse dsResponse, Object data, DSRequest dsRequest) {
                        if (dsResponse.getStatus() < 0) {
                            ClientUtil.displayErrorMessage(dsResponse);
