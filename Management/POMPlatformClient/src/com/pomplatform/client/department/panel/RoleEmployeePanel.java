...
import com.pomplatform.client.department.datasource.DSRoleEmployee;
import com.smartgwt.client.data.*;
import com.smartgwt.client.widgets.form.SearchForm;
import java.util.Map;
import java.util.logging.Logger;

public class RoleEmployeePanel extends AbstractSearchTree {
    ...
    public static class Factory implements PanelFactory {
        ...
        public Canvas create() {
            RoleEmployeePanel cm = new RoleEmployeePanel();
            id = cm.getID();
            return cm;
        }
    ...
    public void initComponents() {
        ...
        resultGrid.addEditCompleteHandler(new EditCompleteHandler() {
            ...
            public void onEditComplete(EditCompleteEvent event) {
                ...
                DBDataSource.callOperation("ST_DSRoleEmployee", "saveOrUpdate", params, new DSCallback() {
                    @Override
...
//        controlLayout.addMember(removeButton);
        removeButton.addClickHandler(new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                ...
                DBDataSource.callOperation("ST_DSRoleEmployee", "delete", selected.toMap(), new DSCallback() {
                    @Override
                    public void execute(DSResponse dsResponse, Object data, DSRequest dsRequest) {
                        if (dsResponse.getStatus() < 0) {
                            ClientUtil.displayErrorMessage(dsResponse);
...
//            __logger.info(parentId + "====" + response.getData()[i].getAttribute("departmentName"));
    ...
    public DataSource getDataSource() {
        return DSRoleEmployee.getInstance();
    }
    @Override
