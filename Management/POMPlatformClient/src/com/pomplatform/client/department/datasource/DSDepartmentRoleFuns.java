...
public class DSDepartmentRoleFuns extends DBDataSource {

    public static DSDepartmentRoleFuns instance = null;

    public static DSDepartmentRoleFuns getInstance() {
        if (instance == null) {
            instance = new DSDepartmentRoleFuns("DSDepartment");
        }
        return instance;
    }
    ...
    public DSDepartmentRoleFuns(String dataSourceID) {

        super();
        setID(dataSourceID);
        setActionMode(ACTION_MODE_CUSTOM);
        setActionName("DepartmentRoleFuns");
