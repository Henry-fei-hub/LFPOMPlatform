...
public class DSRoleFuns extends DBDataSource {

    public static DSRoleFuns instance = null;

    public static DSRoleFuns getInstance() {
        if (instance == null) {
            instance = new DSRoleFuns("DSDepartment");
        }
        return instance;
    }
    ...
    public DSRoleFuns(String dataSourceID) {

        super();
        setID(dataSourceID);
        setActionMode(ACTION_MODE_CUSTOM);
        setActionName("RoleFuns");
