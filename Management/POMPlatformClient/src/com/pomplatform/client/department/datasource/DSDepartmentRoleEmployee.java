...
public class DSDepartmentRoleEmployee extends DBDataSource {

    public static DSDepartmentRoleEmployee instance = null;

    public static DSDepartmentRoleEmployee getInstance() {
        if (instance == null) {
            instance = new DSDepartmentRoleEmployee("DSDepartment");
        }
        return instance;
    }
    ...
    public DSDepartmentRoleEmployee(String dataSourceID) {

        super();
        setID(dataSourceID);
        setActionMode(ACTION_MODE_CUSTOM);
        setActionName("DepartmentRoleEmployee");
        ...
        departmentNameField = new DataSourceTextField("departmentName", "角色名称");
