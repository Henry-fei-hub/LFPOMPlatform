...
public class DSRoleEmployee extends DBDataSource {

    public static DSRoleEmployee instance = null;

    public static DSRoleEmployee getInstance() {
        if (instance == null) {
            instance = new DSRoleEmployee("DSDepartment");
        }
        return instance;
    }
    ...
    public DSRoleEmployee(String dataSourceID) {

        super();
        setID(dataSourceID);
        setActionMode(ACTION_MODE_CUSTOM);
        setActionName("RoleEmployee");
