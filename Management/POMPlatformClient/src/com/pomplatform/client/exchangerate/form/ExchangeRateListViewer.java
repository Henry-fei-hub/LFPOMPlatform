...
public class ExchangeRateListViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		params.put("exchangeRateId", getBusinessId());
		DBDataSource.callOperation("NQ_ExchangeRateList", "find", new DSCallback() {
			@Override
	...
	public DataSource getMainDataSource() {
		return DSExchangeRateList.getInstance();
	}
