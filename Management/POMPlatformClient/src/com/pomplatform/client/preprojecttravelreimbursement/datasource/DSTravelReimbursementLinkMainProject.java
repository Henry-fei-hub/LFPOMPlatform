...
public class DSTravelReimbursementLinkMainProject extends DBDataSource {

	public static DSTravelReimbursementLinkMainProject instance = null;

	public static DSTravelReimbursementLinkMainProject getInstance() {
		if (instance == null) {
			instance = new DSTravelReimbursementLinkMainProject("DSTravelReimbursementLinkMainProject");
		}
		return instance;
	}
	...
	public DSTravelReimbursementLinkMainProject(String dataSourceID) {
		...
		travelReimbursementLinkMainProjectIdField = new DataSourceIntegerField("travelReimbursementLinkMainProjectId",
				"主键编码");
			...
			public void execute(DSResponse dsResponse, Object data, DSRequest dsRequest) {
				if (dsResponse.getStatus() < 0) {
					...
					for (Record obj : record) {
						projectMap.put(obj.getAttribute("preProjectReimbursementNumberId"),
		...
		setFields(travelReimbursementLinkMainProjectIdField, travelReimbursementIdField, mainProjectIdField,
				mainProjectNameField, infoCodeField, plateIdField, amountField, remarkField, inputTaxField,
				inputTaxRebateField, finalAmountField, haveElectronicInvoiceField, invoiceLinkKeyField);
	}
