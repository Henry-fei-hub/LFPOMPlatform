...
public class NewPreProjectTravelReimbursementWorkflow extends AbstractProcessPanel
{
	...
	public List<AbstractWizadPage> getPages(){
		...
		final PreProjectTravelReimbursementNewForm main = new PreProjectTravelReimbursementNewForm();
		...
		final TravelReimbursementLinkMainProjectDetail link = new TravelReimbursementLinkMainProjectDetail(null);
