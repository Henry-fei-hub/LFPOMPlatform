...
public class NewPreProjectTravelReimbursementForm extends GenericWizadWindow
{
	...
	public List<AbstractWizadPage> getPages(){
		...
		res.add(new PreProjectTravelReimbursementNewForm());
		res.add(new TravelReimbursementDetailTravelReimbursementDetail());
		res.add(new TravelReimbursementDetailTravelReimbursementLinkMainProject());
		return res;
	}
