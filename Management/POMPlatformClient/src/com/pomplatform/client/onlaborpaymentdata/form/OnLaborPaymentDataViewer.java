...
public class OnLaborPaymentDataViewer extends AbstractDetailViewer
{
	...
	public OnLaborPaymentDataViewer() {
	}
	...
	public void load() {
		...
		DBDataSource.callOperation("NQ_OnLaborPaymentData", "find", new DSCallback() {
			@Override
