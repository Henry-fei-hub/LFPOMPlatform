...
public class JobManagementViewer extends AbstractDetailViewer
{
	...
	public void load() {
		...
		params.put("dutyId", getBusinessId());
		DBDataSource.callOperation("NQ_JobManagement", "find", new DSCallback() {
			@Override
