...
public class HttpClientUtils {
    ...
    public static String post(String url, String body, String mimeType, String charset, Integer connTimeout,
        ...
        String result = "";
        try {
            if (!BaseHelpUtils.isNullOrEmpty(body)) {
    ...
    public static byte[] getBuffer(String url, String charset, Integer connTimeout, Integer readTimeout)
            throws ConnectTimeoutException, SocketTimeoutException, Exception {
        byte[] dataImage = null;
        HttpClient client = null;
        HttpGet get = new HttpGet(url);
        ...
        try {
            ...
            log.error("getBuffer Exception", e);
        } finally {
            get.releaseConnection();
            if (url.startsWith("https") && client != null && client instanceof CloseableHttpClient) {
                ((CloseableHttpClient) client).close();
