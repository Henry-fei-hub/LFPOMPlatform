...
public class BaseProject extends GenericBase implements BaseFactory<BaseProject>, Comparable<BaseProject> 
{
	...
	public final static java.lang.String ALL_CAPTIONS = "项目编码,合同编号,项目编号,项目名称,项目类型,板块,设计类型,归属部门,设计阶段,项目等级,项目状态,专业负责人,预估工时,项目计划开始日期,项目计划结束日期,项目开始日期,项目结束日期,公区面积,后勤面积,核算比例,遗留项目折算,预算,项目总积分,预留积分,项目总金额,项目积分,项目进度,项目大小,项目描述,审核意见,运营负责人,BIM面积,CAD面积,手工计算积分,追加总积分,追加积分,备注,项目完成百分比,父级项目,项目总完成百分比,2配合专业项目),板块负责人,上次结算时的百分比,投诉折算比例,投诉保证金";
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		String strStatus = delicacy.system.executor.SelectValueCache.getSelectValue("_reimbursement_status", String.valueOf(getStatus()));
