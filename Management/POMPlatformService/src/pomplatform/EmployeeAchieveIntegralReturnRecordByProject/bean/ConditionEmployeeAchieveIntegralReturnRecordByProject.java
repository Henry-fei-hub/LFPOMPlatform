...
public class ConditionEmployeeAchieveIntegralReturnRecordByProject extends GenericCondition{

	public ConditionEmployeeAchieveIntegralReturnRecordByProject(){
		setParameterCount(4);
	}
