...
public class QueryPayMoneyManageTrans extends AbstractQuery<BasePayMoneyManageTrans, ConditionPayMoneyManageTrans>
{

	private static final Logger __logger = Logger.getLogger(QueryPayMoneyManageTrans.class);

	public QueryPayMoneyManageTrans() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BasePayMoneyManageTrans> executeQuery( KeyValuePair[] replacements, ConditionPayMoneyManageTrans condition ) throws java.sql.SQLException {
	...
	@Override
	public BasePayMoneyManageTrans generateBase(Object[] __data) throws java.sql.SQLException {
		BasePayMoneyManageTrans __base = new BasePayMoneyManageTrans();
		int count = 0;
		Object val;
