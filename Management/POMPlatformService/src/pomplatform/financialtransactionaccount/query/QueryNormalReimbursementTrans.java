...
public class QueryNormalReimbursementTrans extends AbstractQuery<BaseNormalReimbursementTrans, ConditionNormalReimbursementTrans>
{

	private static final Logger __logger = Logger.getLogger(QueryNormalReimbursementTrans.class);

	public QueryNormalReimbursementTrans() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseNormalReimbursementTrans> executeQuery( KeyValuePair[] replacements, ConditionNormalReimbursementTrans condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseNormalReimbursementTrans generateBase(Object[] __data) throws java.sql.SQLException {
		BaseNormalReimbursementTrans __base = new BaseNormalReimbursementTrans();
		int count = 0;
		Object val;
