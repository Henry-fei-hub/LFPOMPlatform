...
public class QueryEmployeeRepaymentTrans extends AbstractQuery<BaseEmployeeRepaymentTrans, ConditionEmployeeRepaymentTrans>
{

	private static final Logger __logger = Logger.getLogger(QueryEmployeeRepaymentTrans.class);

	public QueryEmployeeRepaymentTrans() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseEmployeeRepaymentTrans> executeQuery( KeyValuePair[] replacements, ConditionEmployeeRepaymentTrans condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseEmployeeRepaymentTrans generateBase(Object[] __data) throws java.sql.SQLException {
		BaseEmployeeRepaymentTrans __base = new BaseEmployeeRepaymentTrans();
		int count = 0;
		Object val;
