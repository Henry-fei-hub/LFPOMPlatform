...
public class BaseTravelReimbursementTrans extends GenericBase implements BaseFactory<BaseTravelReimbursementTrans>, Comparable<BaseTravelReimbursementTrans> 
{


	public static BaseTravelReimbursementTrans newInstance(){
		return new BaseTravelReimbursementTrans();
	}

	@Override
	public BaseTravelReimbursementTrans make(){
		BaseTravelReimbursementTrans b = new BaseTravelReimbursementTrans();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "流程实例ID,流程类型,业务编码,创建时间,流程状态,完成时间,起草人,货币种类,摘要,付款信息ID,收款方类型,员工或者收款单位Id,付款金额,冲账金额,归属公司";
	...
	public void cloneCopy(BaseTravelReimbursementTrans __bean){
	...
	@Override
	public int compareTo(BaseTravelReimbursementTrans o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseTravelReimbursementTrans o = (BaseTravelReimbursementTrans)obj;
