...
public class BasePayMoneyManageTrans extends GenericBase implements BaseFactory<BasePayMoneyManageTrans>, Comparable<BasePayMoneyManageTrans> 
{


	public static BasePayMoneyManageTrans newInstance(){
		return new BasePayMoneyManageTrans();
	}

	@Override
	public BasePayMoneyManageTrans make(){
		BasePayMoneyManageTrans b = new BasePayMoneyManageTrans();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "流程实例ID,流程类型,业务编码,创建时间,流程状态,完成时间,起草者,货币种类,摘要,付款信息ID,收款方类型,员工或者收款单位Id,付款金额,冲账金额,归属公司";
	...
	public void cloneCopy(BasePayMoneyManageTrans __bean){
	...
	@Override
	public int compareTo(BasePayMoneyManageTrans o) {
	...
	public boolean equals(Object obj) {
		...
		final BasePayMoneyManageTrans o = (BasePayMoneyManageTrans)obj;
