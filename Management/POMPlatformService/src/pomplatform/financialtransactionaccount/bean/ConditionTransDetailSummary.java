...
public class ConditionTransDetailSummary extends GenericCondition{

	public ConditionTransDetailSummary(){
	...
	public java.util.Date getInitEndDate() {
		return __init_end_date;
	}

	public void setInitEndDate(java.util.Date __init_end_date) {
		this.__init_end_date = __init_end_date;
	}
