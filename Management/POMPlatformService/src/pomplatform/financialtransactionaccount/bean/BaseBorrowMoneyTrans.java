...
public class BaseBorrowMoneyTrans extends GenericBase implements BaseFactory<BaseBorrowMoneyTrans>, Comparable<BaseBorrowMoneyTrans> 
{


	public static BaseBorrowMoneyTrans newInstance(){
		return new BaseBorrowMoneyTrans();
	}

	@Override
	public BaseBorrowMoneyTrans make(){
		BaseBorrowMoneyTrans b = new BaseBorrowMoneyTrans();
		return b;
	}
	...
	public void cloneCopy(BaseBorrowMoneyTrans __bean){
	...
	@Override
	public int compareTo(BaseBorrowMoneyTrans o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseBorrowMoneyTrans o = (BaseBorrowMoneyTrans)obj;
