...
public class BaseEmployeeRepaymentTrans extends GenericBase implements BaseFactory<BaseEmployeeRepaymentTrans>, Comparable<BaseEmployeeRepaymentTrans> 
{


	public static BaseEmployeeRepaymentTrans newInstance(){
		return new BaseEmployeeRepaymentTrans();
	}

	@Override
	public BaseEmployeeRepaymentTrans make(){
		BaseEmployeeRepaymentTrans b = new BaseEmployeeRepaymentTrans();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,流程类型,业务编码,申请日期,流程状态,完成时间,起草人,货币类型,摘要备注,还款人,原币贷,归属公司";
	...
	public void cloneCopy(BaseEmployeeRepaymentTrans __bean){
	...
	@Override
	public int compareTo(BaseEmployeeRepaymentTrans o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseEmployeeRepaymentTrans o = (BaseEmployeeRepaymentTrans)obj;
