...
public class BaseTransDetailSummary extends GenericBase implements BaseFactory<BaseTransDetailSummary>, Comparable<BaseTransDetailSummary> 
{


	public static BaseTransDetailSummary newInstance(){
		return new BaseTransDetailSummary();
	}

	@Override
	public BaseTransDetailSummary make(){
		BaseTransDetailSummary b = new BaseTransDetailSummary();
		return b;
	}
	...
	public final static java.lang.String CS_ENDING_STANDARD_DEBIT = "ending_standard_debit" ;
	public final static java.lang.String CS_ENDING_STANDARD_CREDIT = "ending_standard_credit" ;

	public final static java.lang.String ALL_CAPTIONS = "归属公司,账户类型,财务编号,名称,账户状态,期初借,期初贷,借方发生额,贷方发生额,期末借,期末贷";
	...
	public java.math.BigDecimal getEndingStandardDebit() {
		return this.__ending_standard_debit;
	}

	public void setEndingStandardDebit( java.math.BigDecimal value ) {
		this.__ending_standard_debit = value;
	}

	public java.math.BigDecimal getEndingStandardCredit() {
		return this.__ending_standard_credit;
	}

	public void setEndingStandardCredit( java.math.BigDecimal value ) {
		this.__ending_standard_credit = value;
	}

	public void cloneCopy(BaseTransDetailSummary __bean){
		...
		__bean.setEndingStandardDebit(getEndingStandardDebit());
		__bean.setEndingStandardCredit(getEndingStandardCredit());
	}
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		sb.append(getEndingStandardDebit() == null ? "" : getEndingStandardDebit());
		sb.append(",");
		sb.append(getEndingStandardCredit() == null ? "" : getEndingStandardCredit());
		return sb.toString();
	}

	@Override
	public int compareTo(BaseTransDetailSummary o) {
	...
	public int hashCode() {
		...
		hash = 97 * hash + Objects.hashCode(this.__ending_standard_debit);
		hash = 97 * hash + Objects.hashCode(this.__ending_standard_credit);
		return hash;
	}
	...
	public boolean equals(Object obj) {
		...
		final BaseTransDetailSummary o = (BaseTransDetailSummary)obj;
		...
		if(!Objects.equals(this.__ending_standard_debit, o.getEndingStandardDebit())) return false;
		if(!Objects.equals(this.__ending_standard_credit, o.getEndingStandardCredit())) return false;
		return true;
	}
	...
	public java.lang.String toJSONString() {
		...
		if(getEndingStandardDebit() != null) sb.append(__wrapDecimal(count++, "endingStandardDebit", getEndingStandardDebit()));
		if(getEndingStandardCredit() != null) sb.append(__wrapDecimal(count++, "endingStandardCredit", getEndingStandardCredit()));
		return sb.toString();
	}
	...
	public Map<String, Object> toMap() {
		...
		if(getEndingStandardDebit() != null) res.put("endingStandardDebit", getEndingStandardDebit());
		if(getEndingStandardCredit() != null) res.put("endingStandardCredit", getEndingStandardCredit());
		return res;
	}
	...
	public void setDataFromMap(Map<String, Object> values){
		...
		if((val = values.get("endingStandardDebit")) != null) setEndingStandardDebit(__getDecimal(val));  
		if((val = values.get("endingStandardCredit")) != null) setEndingStandardCredit(__getDecimal(val));  
	}
	...
	protected java.math.BigDecimal  __ending_standard_debit ;
	protected java.math.BigDecimal  __ending_standard_credit ;
}
