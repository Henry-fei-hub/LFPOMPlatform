...
public class BaseSemployeemonthlycheckymor extends GenericBase implements BaseFactory<BaseSemployeemonthlycheckymor>, Comparable<BaseSemployeemonthlycheckymor> 
{


	public static BaseSemployeemonthlycheckymor newInstance(){
		return new BaseSemployeemonthlycheckymor();
	}

	@Override
	public BaseSemployeemonthlycheckymor make(){
		BaseSemployeemonthlycheckymor b = new BaseSemployeemonthlycheckymor();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "员工号,员工编码,部门,员工类型,入职日期,转正日期,迟到5分钟,迟到10分钟,迟到30分钟,扣款迟到,事假次数,事假小时,事假天数,病假次数,病假天数,病假小时,其他假假类次数,其它假类天数,其它假类小时,应到天数,平时加班天数,周末加班天数,放假加班天数,平时加班小时,周末加班小时,节假日加班小时,矿工天数";
	...
	public void cloneCopy(BaseSemployeemonthlycheckymor __bean){
	...
	@Override
	public int compareTo(BaseSemployeemonthlycheckymor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSemployeemonthlycheckymor o = (BaseSemployeemonthlycheckymor)obj;
