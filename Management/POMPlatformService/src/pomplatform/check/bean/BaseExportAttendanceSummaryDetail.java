...
public class BaseExportAttendanceSummaryDetail extends GenericBase implements BaseFactory<BaseExportAttendanceSummaryDetail>, Comparable<BaseExportAttendanceSummaryDetail> 
{


	public static BaseExportAttendanceSummaryDetail newInstance(){
		return new BaseExportAttendanceSummaryDetail();
	}

	@Override
	public BaseExportAttendanceSummaryDetail make(){
		BaseExportAttendanceSummaryDetail b = new BaseExportAttendanceSummaryDetail();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "员工姓名,员工编码,部门,年,月,考勤日期,班次,上班时间,下班时间,考勤状态,迟到次数,迟到分钟,早退次数,早退分钟,迟到扣款,旷工扣款,平时加班(小时),周末加班(小时),节假日加班(小时),加班餐补(本月),加班餐补,加班补助(本月),加班补助,调休假,年假(天),事假(天),病假(天),其他假类(天),因公外出(次数),应到(天),实到(天),旷工(天)";
	...
	public void cloneCopy(BaseExportAttendanceSummaryDetail __bean){
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		String strShiftManageId = delicacy.system.executor.SelectValueCache.getSelectValue("shift_manages", String.valueOf(getShiftManageId()));
		sb.append(strShiftManageId == null ? "" : strShiftManageId);
		sb.append(",");
	...
	@Override
	public int compareTo(BaseExportAttendanceSummaryDetail o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseExportAttendanceSummaryDetail o = (BaseExportAttendanceSummaryDetail)obj;
	...
	public Map<String, Object> toMap() {
		...
		if(getEmployeeDayCheckId() != null) res.put("employeeDayCheckId", getEmployeeDayCheckId());
		if(getEmployeeId() != null) res.put("employeeId", getEmployeeId());
		if(getYear() != null) res.put("year", getYear());
		if(getMonth() != null) res.put("month", getMonth());
		if(getRecordDate() != null) res.put("recordDate", getRecordDate());
		if(getShiftManageId() != null) res.put("shiftManageId", getShiftManageId());
		if(getCheckin() != null) res.put("checkin", getCheckin());
		if(getCheckout() != null) res.put("checkout", getCheckout());
