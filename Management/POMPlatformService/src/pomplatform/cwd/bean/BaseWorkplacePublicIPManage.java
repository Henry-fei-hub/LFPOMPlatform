...
public class BaseWorkplacePublicIPManage extends GenericBase implements BaseFactory<BaseWorkplacePublicIPManage>, Comparable<BaseWorkplacePublicIPManage> 
{


	public static BaseWorkplacePublicIPManage newInstance(){
		return new BaseWorkplacePublicIPManage();
	}

	@Override
	public BaseWorkplacePublicIPManage make(){
		BaseWorkplacePublicIPManage b = new BaseWorkplacePublicIPManage();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "工作场所编码,工作场所ID,工作场所,公网IP地址,是否有效";
	...
	public void cloneCopy(BaseWorkplacePublicIPManage __bean){
	...
	@Override
	public int compareTo(BaseWorkplacePublicIPManage o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseWorkplacePublicIPManage o = (BaseWorkplacePublicIPManage)obj;
