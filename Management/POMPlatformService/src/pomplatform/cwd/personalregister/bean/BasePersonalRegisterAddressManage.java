...
public class BasePersonalRegisterAddressManage extends GenericBase implements BaseFactory<BasePersonalRegisterAddressManage>, Comparable<BasePersonalRegisterAddressManage> 
{


	public static BasePersonalRegisterAddressManage newInstance(){
		return new BasePersonalRegisterAddressManage();
	}

	@Override
	public BasePersonalRegisterAddressManage make(){
		BasePersonalRegisterAddressManage b = new BasePersonalRegisterAddressManage();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "工作场所编码,员工,公网IP地址,机器MAC地址,工作场所编码, 0 - 未知，1 - 家里，2 - 出差，其他 - 具体公司的工作场所,工作场所名称,注册时间,是否有效";
	...
	public void cloneCopy(BasePersonalRegisterAddressManage __bean){
	...
	@Override
	public int compareTo(BasePersonalRegisterAddressManage o) {
	...
	public boolean equals(Object obj) {
		...
		final BasePersonalRegisterAddressManage o = (BasePersonalRegisterAddressManage)obj;
