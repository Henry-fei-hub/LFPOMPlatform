...
public class BaseMsoftwareoperationlogeoseedor extends GenericBase implements BaseFactory<BaseMsoftwareoperationlogeoseedor>, Comparable<BaseMsoftwareoperationlogeoseedor> 
{


	public static BaseMsoftwareoperationlogeoseedor newInstance(){
		return new BaseMsoftwareoperationlogeoseedor();
	}

	@Override
	public BaseMsoftwareoperationlogeoseedor make(){
		BaseMsoftwareoperationlogeoseedor b = new BaseMsoftwareoperationlogeoseedor();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "员工编号,员工姓名,部门,主键,操作类型,mac地址,ip地址,机器名称,软件类型,本地操作时间,本地请求时间,创建时间,当前系统版本号,当前登录人主键,源版本";
	...
	public void cloneCopy(BaseMsoftwareoperationlogeoseedor __bean){
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		String strOperationType = delicacy.system.executor.SelectValueCache.getSelectValue("", String.valueOf(getOperationType()));
		...
		sb.append(",");
		String strSoftwareType = delicacy.system.executor.SelectValueCache.getSelectValue("", String.valueOf(getSoftwareType()));
		sb.append(strSoftwareType == null ? "" : strSoftwareType);
		sb.append(",");
	...
	@Override
	public int compareTo(BaseMsoftwareoperationlogeoseedor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseMsoftwareoperationlogeoseedor o = (BaseMsoftwareoperationlogeoseedor)obj;
