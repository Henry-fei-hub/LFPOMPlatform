package pomplatform.budgetmanagementapplywork.bean;
...
public class BaseBudgetManagementApplyWork extends GenericBase implements BaseFactory<BaseBudgetManagementApplyWork>, Comparable<BaseBudgetManagementApplyWork> 
{


	public static BaseBudgetManagementApplyWork newInstance(){
		return new BaseBudgetManagementApplyWork();
	}

	@Override
	public BaseBudgetManagementApplyWork make(){
		BaseBudgetManagementApplyWork b = new BaseBudgetManagementApplyWork();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,业务编码,业务名称,流程编码,活动实列编码,流程状态,完成时间,流程类型,主键id,预算编号,预算类型,预算总金额,预算已用金额,预算剩余金额,申请人id,申请时间,预期关闭时间,预算单状态1,已立项，2立项进行中,项目编码,预算备注,发票编码,申请人归属部门,申请人归属公司";
	...
	public void cloneCopy(BaseBudgetManagementApplyWork __bean){
	...
	@Override
	public int compareTo(BaseBudgetManagementApplyWork o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseBudgetManagementApplyWork o = (BaseBudgetManagementApplyWork)obj;
