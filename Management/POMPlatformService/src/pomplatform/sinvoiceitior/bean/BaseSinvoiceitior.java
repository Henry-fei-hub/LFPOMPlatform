...
public class BaseSinvoiceitior extends GenericBase implements BaseFactory<BaseSinvoiceitior>, Comparable<BaseSinvoiceitior> 
{


	public static BaseSinvoiceitior newInstance(){
		return new BaseSinvoiceitior();
	}

	@Override
	public BaseSinvoiceitior make(){
		BaseSinvoiceitior b = new BaseSinvoiceitior();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "发票编码,购票公司,发票类型,发票代码,发票号码,发票入库日期,发票空白作废备注,发票空白作废操作人,发票入库操作人,信息编号,项目编号,合同主编号,客户名称,开票金额,税率,不含税金额,销项税,开票操作人,开票日期,开发票的登记日期,发票状态,原发票代码,原发票号码,收款阶段,发票信息ID,可操作状态,合同主键";
	...
	public void cloneCopy(BaseSinvoiceitior __bean){
	...
	@Override
	public int compareTo(BaseSinvoiceitior o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSinvoiceitior o = (BaseSinvoiceitior)obj;
