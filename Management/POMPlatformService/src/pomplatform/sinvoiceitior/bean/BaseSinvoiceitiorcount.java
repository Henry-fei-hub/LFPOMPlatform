...
public class BaseSinvoiceitiorcount extends GenericBase implements BaseFactory<BaseSinvoiceitiorcount>, Comparable<BaseSinvoiceitiorcount> 
{


	public static BaseSinvoiceitiorcount newInstance(){
		return new BaseSinvoiceitiorcount();
	}

	@Override
	public BaseSinvoiceitiorcount make(){
		BaseSinvoiceitiorcount b = new BaseSinvoiceitiorcount();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "发票编码,购票公司,发票类型,发票代码,发票号码,发票入库日期,发票空白作废备注,发票空白作废操作人,发票入库操作人,信息编号,项目编号,合同主编号,客户名称,开票金额,税率,不含税金额,销项税,开票操作人,开票日期,开发票的登记日期,发票状态,原发票代码,原发票号码,收款阶段,发票信息ID,可操作状态,合同id,主订单名称,是否有凭证";
	...
	public java.lang.Boolean getHaveVoucher() {
		return __have_voucher;
	}

	public void setHaveVoucher(java.lang.Boolean __have_voucher) {
		this.__have_voucher = __have_voucher;
	}

	public void cloneCopy(BaseSinvoiceitiorcount __bean){
	...
	@Override
	public int compareTo(BaseSinvoiceitiorcount o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSinvoiceitiorcount o = (BaseSinvoiceitiorcount)obj;
