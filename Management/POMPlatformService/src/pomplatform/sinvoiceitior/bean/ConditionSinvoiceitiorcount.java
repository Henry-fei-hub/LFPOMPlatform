...
public class ConditionSinvoiceitiorcount extends GenericCondition{

	public ConditionSinvoiceitiorcount(){
		setParameterCount(23);
	}

	public java.lang.Integer getMinSign() {
		return this.__min_sign;
	}

	public void setMinSign( java.lang.Integer value ) {
		this.__min_sign = value;
	}

	public java.lang.Integer getMaxSign() {
		return this.__max_sign;
	}

	public void setMaxSign( java.lang.Integer value ) {
		this.__max_sign = value;
	}
	...
	public java.lang.String toJSONString() {
		...
		if(getMinSign() != null) sb.append(__wrapNumber(1, "minSign", getMinSign()));
		if(getMaxSign() != null) sb.append(__wrapNumber(1, "maxSign", getMaxSign()));
	...
	public void setDataFromMap(Map<String, Object> values){
		...
		Object val;
		if((val = values.get("minSign")) != null) setMinSign(__getInt(val)); 
		if((val = values.get("maxSign")) != null) setMaxSign(__getInt(val)); 
	...
	private java.lang.Integer __min_sign = null;
	private java.lang.Integer __max_sign = null;
