...
public class BaseMEmployeeChangePlateDetail extends GenericBase implements BaseFactory<BaseMEmployeeChangePlateDetail>, Comparable<BaseMEmployeeChangePlateDetail> 
{


	public static BaseMEmployeeChangePlateDetail newInstance(){
		return new BaseMEmployeeChangePlateDetail();
	}

	@Override
	public BaseMEmployeeChangePlateDetail make(){
		BaseMEmployeeChangePlateDetail b = new BaseMEmployeeChangePlateDetail();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "编码,工号,姓名,年份,月份,转出业务部门,转入业务部门,转岗原因,创建时间,修改时间";
	...
	public void cloneCopy(BaseMEmployeeChangePlateDetail __bean){
	...
	@Override
	public int compareTo(BaseMEmployeeChangePlateDetail o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseMEmployeeChangePlateDetail o = (BaseMEmployeeChangePlateDetail)obj;
