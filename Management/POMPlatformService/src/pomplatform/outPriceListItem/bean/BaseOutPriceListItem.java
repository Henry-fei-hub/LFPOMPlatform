...
public class BaseOutPriceListItem extends GenericBase implements BaseFactory<BaseOutPriceListItem>, Comparable<BaseOutPriceListItem> 
{


	public static BaseOutPriceListItem newInstance(){
		return new BaseOutPriceListItem();
	}

	@Override
	public BaseOutPriceListItem make(){
		BaseOutPriceListItem b = new BaseOutPriceListItem();
		return b;
	}
	...
	public final static java.lang.String CS_IS_HAS = "is_has" ;
	public final static java.lang.String CS_TYPE = "type" ;

	public final static java.lang.String ALL_CAPTIONS = "报价单子项编码,信息编号,项目编号,业务类型,项目类型,区域,精简装状态   0精装    1简装,设计面积,设计单价,小计 设计面积总金额,子合同编码,现场配合,服务面积,配合金额,驻场时间(月),驻场价格(元/月),驻场总金额(元),创建时间,修改时间,标记补充协议字段；除0之外，其他都表示第n个补充协议,可操作状态 0可操作,1禁止操作,报价单表编码,备注,内部设计单价,内部设计面积总金额,专项标示为1,子项标示2,操作人(人员id),报价单子项的序号编码记录(用来表示顺序),模板id,新建的报价单名称,最终报价,,类型";
	...
	public java.lang.Integer getIsHas() {
		return this.__is_has;
	}

	public void setIsHas( java.lang.Integer value ) {
		this.__is_has = value;
	}
	...
	public void cloneCopy(BaseOutPriceListItem __bean){
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		sb.append(getIsHas() == null ? "" : getIsHas());
		sb.append(",");
	...
	@Override
	public int compareTo(BaseOutPriceListItem o) {
	...
	public int hashCode() {
		...
		hash = 97 * hash + Objects.hashCode(this.__is_has);
	...
	public boolean equals(Object obj) {
		...
		final BaseOutPriceListItem o = (BaseOutPriceListItem)obj;
		...
		if(!Objects.equals(this.__is_has, o.getIsHas())) return false;
	...
	public java.lang.String toJSONString() {
		...
		if(getIsHas() != null) sb.append(__wrapNumber(count++, "isHas", getIsHas()));
	...
	public void setDataFromMap(Map<String, Object> values){
		...
		if((val = values.get("isHas")) != null) setIsHas(__getInt(val)); 
	...
	protected java.lang.Integer  __is_has ;
