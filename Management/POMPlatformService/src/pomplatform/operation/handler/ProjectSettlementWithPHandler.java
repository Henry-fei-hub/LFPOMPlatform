...
import pomplatform.operation.dao.ProjectSettlementWithP;
...
public class ProjectSettlementWithPHandler implements GenericDao {
	...
	public static boolean isProjectSettlementWithPExists( pomplatform.operation.bean.BaseProjectSettlementWithP bean, String additional ) {
	...
	public static int countProjectSettlementWithP( pomplatform.operation.bean.BaseProjectSettlementWithP bean, String additional ) {
