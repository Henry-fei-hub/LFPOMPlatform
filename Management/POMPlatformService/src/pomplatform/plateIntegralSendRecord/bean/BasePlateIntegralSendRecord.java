...
public class BasePlateIntegralSendRecord extends GenericBase implements BaseFactory<BasePlateIntegralSendRecord>, Comparable<BasePlateIntegralSendRecord> 
{


	public static BasePlateIntegralSendRecord newInstance(){
		return new BasePlateIntegralSendRecord();
	}

	@Override
	public BasePlateIntegralSendRecord make(){
		BasePlateIntegralSendRecord b = new BasePlateIntegralSendRecord();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,业务部门,操作人,员工编号,补贴积分,补贴日期,备注";
	...
	public void cloneCopy(BasePlateIntegralSendRecord __bean){
	...
	@Override
	public int compareTo(BasePlateIntegralSendRecord o) {
	...
	public boolean equals(Object obj) {
		...
		final BasePlateIntegralSendRecord o = (BasePlateIntegralSendRecord)obj;
