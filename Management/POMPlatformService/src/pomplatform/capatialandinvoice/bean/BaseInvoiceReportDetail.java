...
public class BaseInvoiceReportDetail extends GenericBase implements BaseFactory<BaseInvoiceReportDetail>, Comparable<BaseInvoiceReportDetail> 
{


	public static BaseInvoiceReportDetail newInstance(){
		return new BaseInvoiceReportDetail();
	}

	@Override
	public BaseInvoiceReportDetail make(){
		BaseInvoiceReportDetail b = new BaseInvoiceReportDetail();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "开发票 编码,购票公司,发票类型 1专票，2普票 ，3代开,发票代码(10位 每次批量录入是一样),发票号码(8位 规则+1),发票入库日期,发票空白作废备注,发票空白作废操作人,发票入库操作人,信息编号,项目编号,合同id,合同主编号,主订单名称,签约总金额,客户名称,开票金额(如 100),开票操作人,开票日期,开发票的登记日期,3填开作废。当月发票，当月作废。4.负数作废。做了红字，然后又作废。5.空白作废。尚未开具，就直接作废（往往是不慎污染弄脏了，没法使用）,收款阶段id,确认函id,是否有凭证,是否对应回款,回款金额,项目经理编码";
	public final static java.lang.String EXPORT_CAPITIONS = "合同编号 , 合同名称 , 合同金额 , 开票金额 , 开票时间 , 已回款金额 , 项目经理";
	...
	public void cloneCopy(BaseInvoiceReportDetail __bean){
...
//		sb.append(",");
		...
		sb.append(",");
		String projectManagerId = SelectValueCache.getSelectValue("employees", String.valueOf(getProjectManagerId()));
		sb.append(getProjectManagerId() == null ? "" : projectManagerId);
		return sb.toString();
	}

	@Override
	public int compareTo(BaseInvoiceReportDetail o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseInvoiceReportDetail o = (BaseInvoiceReportDetail)obj;
