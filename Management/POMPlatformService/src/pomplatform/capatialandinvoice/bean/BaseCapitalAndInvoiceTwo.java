...
public class BaseCapitalAndInvoiceTwo extends GenericBase implements BaseFactory<BaseCapitalAndInvoiceTwo>, Comparable<BaseCapitalAndInvoiceTwo> 
{
	...
	public final static java.lang.String ALL_CAPTIONS = "开发票 编码,购票公司,发票类型 1专票，2普票 ，3代开,发票代码(10位 每次批量录入是一样),发票号码(8位 规则+1),发票入库日期,发票空白作废备注,发票空白作废操作人,发票入库操作人,信息编号,项目编号,合同id,合同主编号,客户名称,开票金额(如 100),开票操作人,开票日期,开发票的登记日期,3填开作废。当月发票，当月作废。4.负数作废。做了红字，然后又作废。5.空白作废。尚未开具，就直接作废（往往是不慎污染弄脏了，没法使用）,收款阶段id,确认函id,是否有凭证,是否对应回款,回款金额";
