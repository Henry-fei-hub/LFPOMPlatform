...
public class BaseCapitalAndInvoiceOne extends GenericBase implements BaseFactory<BaseCapitalAndInvoiceOne>, Comparable<BaseCapitalAndInvoiceOne> 
{
	...
	public final static java.lang.String ALL_CAPTIONS = "资金表id,信息编号,项目编号,合同id,合同主编号,借（增加）,操作人id,是否绑定了发票,是否绑定了合同阶段付款,有分配回款,流程状态 0 未处于流程  1审批中 2审批完成,回款分配编码,是否对应发票,发生日期";
