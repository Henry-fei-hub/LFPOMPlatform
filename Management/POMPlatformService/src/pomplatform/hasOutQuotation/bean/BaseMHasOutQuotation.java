...
public class BaseMHasOutQuotation extends GenericBase implements BaseFactory<BaseMHasOutQuotation>, Comparable<BaseMHasOutQuotation> 
{


	public static BaseMHasOutQuotation newInstance(){
		return new BaseMHasOutQuotation();
	}

	@Override
	public BaseMHasOutQuotation make(){
		BaseMHasOutQuotation b = new BaseMHasOutQuotation();
		return b;
	}
	...
	public void cloneCopy(BaseMHasOutQuotation __bean){
	...
	@Override
	public int compareTo(BaseMHasOutQuotation o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseMHasOutQuotation o = (BaseMHasOutQuotation)obj;
