package pomplatform.hasOutQuotation.query;
...
public class QueryMHasOutQuotation extends AbstractQuery<BaseMHasOutQuotation, ConditionMHasOutQuotation>
{

	private static final Logger __logger = Logger.getLogger(QueryMHasOutQuotation.class);

	public QueryMHasOutQuotation() throws java.sql.SQLException 
	{
		setParameterNumber(0);
		setConnection(ThreadConnection.getConnection());
		setOrderByFields("distinct mp.main_project_id");
	}

	@Override
	public BaseCollection<BaseMHasOutQuotation> executeQuery( KeyValuePair[] replacements, ConditionMHasOutQuotation condition ) throws java.sql.SQLException {
		return executeQuery(replacements
			);
	}

	@Override
	public BaseMHasOutQuotation generateBase(Object[] __data) throws java.sql.SQLException {
		BaseMHasOutQuotation __base = new BaseMHasOutQuotation();
		int count = 0;
		Object val;
