...
public class QueryProjectNormalRemarkAndAmount extends AbstractQuery<BaseProjectNormalRemarkAndAmount, ConditionProjectNormalRemarkAndAmount>
{

	private static final Logger __logger = Logger.getLogger(QueryProjectNormalRemarkAndAmount.class);

	public QueryProjectNormalRemarkAndAmount() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseProjectNormalRemarkAndAmount> executeQuery( KeyValuePair[] replacements, ConditionProjectNormalRemarkAndAmount condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseProjectNormalRemarkAndAmount generateBase(Object[] __data) throws java.sql.SQLException {
		BaseProjectNormalRemarkAndAmount __base = new BaseProjectNormalRemarkAndAmount();
		int count = 0;
		Object val;
