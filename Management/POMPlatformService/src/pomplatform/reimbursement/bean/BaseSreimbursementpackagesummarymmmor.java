...
public class BaseSreimbursementpackagesummarymmmor extends GenericBase implements BaseFactory<BaseSreimbursementpackagesummarymmmor>, Comparable<BaseSreimbursementpackagesummarymmmor> 
{


	public static BaseSreimbursementpackagesummarymmmor newInstance(){
		return new BaseSreimbursementpackagesummarymmmor();
	}

	@Override
	public BaseSreimbursementpackagesummarymmmor make(){
		BaseSreimbursementpackagesummarymmmor b = new BaseSreimbursementpackagesummarymmmor();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "收款方类型,收款方,付款方(公司),银行名称(付款方),总金额,付款金额,冲账金额,付款时间";
	...
	public void cloneCopy(BaseSreimbursementpackagesummarymmmor __bean){
	...
	public java.lang.String toCSVString() {
		...
		String payForStr = SelectValueCache.getSelectValue("system_dictionary_67", String.valueOf(getPayFor()));
		sb.append(payForStr == null ? "" : payForStr);
		sb.append(",");
		sb.append(getPayeeName() == null ? "" : getPayeeName());
		sb.append(",");
		String otherNameStr = SelectValueCache.getSelectValue("system_dictionary_69", String.valueOf(getOtherName()));
		sb.append(otherNameStr == null ? "" : otherNameStr);
		sb.append(",");
	...
	@Override
	public int compareTo(BaseSreimbursementpackagesummarymmmor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSreimbursementpackagesummarymmmor o = (BaseSreimbursementpackagesummarymmmor)obj;
