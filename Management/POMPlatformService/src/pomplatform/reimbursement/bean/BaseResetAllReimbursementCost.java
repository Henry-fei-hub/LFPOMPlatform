...
public class BaseResetAllReimbursementCost extends GenericBase implements BaseFactory<BaseResetAllReimbursementCost>, Comparable<BaseResetAllReimbursementCost> 
{


	public static BaseResetAllReimbursementCost newInstance(){
		return new BaseResetAllReimbursementCost();
	}

	@Override
	public BaseResetAllReimbursementCost make(){
		BaseResetAllReimbursementCost b = new BaseResetAllReimbursementCost();
		return b;
	}
	...
	public final static java.lang.String CS_RESET_TIMES = "reset_times" ;
	public final static java.lang.String CS_PLATE_ID = "plate_id" ;

//	public final static java.lang.String ALL_CAPTIONS = "报销类型,业务编码,流程编码,流程编码,费用类型,费用承担主体ID,编号,名称,报销编号,报销人,申请时间,流程状态,结算状态,报销金额,进项税,成本,成本是否二次分配过,业务部门";
	public final static java.lang.String ALL_CAPTIONS = "报销类型,报销编号,费用类型,编号,费用承担主体,业务部门,报销人,货币种类,汇率,报销金额,进项税,成本,流程状态,结算状态,申请时间,完成时间";
	...
	public java.lang.Long getResetTimes() {
		return this.__reset_times;
	}

	public void setResetTimes( java.lang.Long value ) {
		this.__reset_times = value;
	}
	...
	public java.util.Date getCompleteTime() {
		return __complete_time;
	}

	public void setCompleteTime(java.util.Date __complete_time) {
		this.__complete_time = __complete_time;
	}

	
	public java.lang.Integer getSubTableId() {
		return __sub_table_id;
	}
	...
	public void setExchangeRate(java.math.BigDecimal __exchange_rate) {
		this.__exchange_rate = __exchange_rate;
	}

	public void cloneCopy(BaseResetAllReimbursementCost __bean){
		...
		__bean.setResetTimes(getResetTimes());
	...
	@Override
	public int compareTo(BaseResetAllReimbursementCost o) {
	...
	public int hashCode() {
		...
		hash = 97 * hash + Objects.hashCode(this.__reset_times);
	...
	public boolean equals(Object obj) {
		...
		final BaseResetAllReimbursementCost o = (BaseResetAllReimbursementCost)obj;
		...
		if(!Objects.equals(this.__reset_times, o.getResetTimes())) return false;
	...
	public java.lang.String toJSONString() {
		...
		if(getResetTimes() != null) sb.append(__wrapNumber(count++, "resetTimes", getResetTimes()));
	...
	public void setDataFromMap(Map<String, Object> values){
		...
		if((val = values.get("resetTimes")) != null) setResetTimes(__getLong(val)); 
	...
	protected java.lang.Long  __reset_times ;
