...
public class BaseK3VoucherList extends GenericBase implements BaseFactory<BaseK3VoucherList>, Comparable<BaseK3VoucherList> 
{


	public static BaseK3VoucherList newInstance(){
		return new BaseK3VoucherList();
	}

	@Override
	public BaseK3VoucherList make(){
		BaseK3VoucherList b = new BaseK3VoucherList();
		return b;
	}
...
//	public final static java.lang.String ALL_CAPTIONS = "主键编码,项目,归属公司,凭证号,凭证内序号,科目类型,科目编码,科目代码,科目名称,辅助核算类型,辅助核算编码,辅助核算代码,辅助核算名称,备注,简化备注,借方,贷方,报销汇总编号,报销金额,进项税,我方银行账号,对方银行账号,需要调整,归属日期,是否锁定,创建时间,修改时间,定稿时间";
	public final static java.lang.String ALL_CAPTIONS = "凭证日期,会计年度,会计期间,凭证字,凭证号,科目代码,科目名称,币别代码,币别名称,原币金额,借方,贷方,制单,审核,核准,出纳,经办,结算方式,结算号,凭证摘要,数量,数量单位,单价,参考信息,业务日期,往来业务编号,附件数,序号,系统模块,业务描述,汇率类型,汇率,分录序号,核算项目,过账,机制凭证,现金流量";
	...
	public void cloneCopy(BaseK3VoucherList __bean){
	...
	@Override
	public int compareTo(BaseK3VoucherList o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseK3VoucherList o = (BaseK3VoucherList)obj;
