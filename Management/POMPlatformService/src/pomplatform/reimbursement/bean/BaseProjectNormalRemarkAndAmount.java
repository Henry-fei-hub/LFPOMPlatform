...
public class BaseProjectNormalRemarkAndAmount extends GenericBase implements BaseFactory<BaseProjectNormalRemarkAndAmount>, Comparable<BaseProjectNormalRemarkAndAmount> 
{


	public static BaseProjectNormalRemarkAndAmount newInstance(){
		return new BaseProjectNormalRemarkAndAmount();
	}

	@Override
	public BaseProjectNormalRemarkAndAmount make(){
		BaseProjectNormalRemarkAndAmount b = new BaseProjectNormalRemarkAndAmount();
		return b;
	}
	...
	public void cloneCopy(BaseProjectNormalRemarkAndAmount __bean){
	...
	@Override
	public int compareTo(BaseProjectNormalRemarkAndAmount o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseProjectNormalRemarkAndAmount o = (BaseProjectNormalRemarkAndAmount)obj;
