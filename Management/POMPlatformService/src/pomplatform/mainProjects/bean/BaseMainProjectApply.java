...
public class BaseMainProjectApply extends GenericBase implements BaseFactory<BaseMainProjectApply>, Comparable<BaseMainProjectApply> 
{


	public static BaseMainProjectApply newInstance(){
		return new BaseMainProjectApply();
	}

	@Override
	public BaseMainProjectApply make(){
		BaseMainProjectApply b = new BaseMainProjectApply();
		return b;
	}
	...
	public void cloneCopy(BaseMainProjectApply __bean){
	...
	@Override
	public int compareTo(BaseMainProjectApply o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseMainProjectApply o = (BaseMainProjectApply)obj;
