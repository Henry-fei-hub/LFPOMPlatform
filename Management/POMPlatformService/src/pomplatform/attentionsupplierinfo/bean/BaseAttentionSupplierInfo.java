...
public class BaseAttentionSupplierInfo extends GenericBase implements BaseFactory<BaseAttentionSupplierInfo>, Comparable<BaseAttentionSupplierInfo> 
{


	public static BaseAttentionSupplierInfo newInstance(){
		return new BaseAttentionSupplierInfo();
	}

	@Override
	public BaseAttentionSupplierInfo make(){
		BaseAttentionSupplierInfo b = new BaseAttentionSupplierInfo();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,业务编码,业务名称,活动编码,流程编码,流程实列编码,返回数据集,流程实例节点编码,流程实例节点创建时间,流程实例节点开始处于活动时间,状态,流程类型,提交意见,供应商编码,供应商名称,供应商联系人,供应商电话,供应商邮箱,供应商类型,供应商主营业务类型,供货范围,社会信用代码,供应商所在(省),供应商所在(市),供应商开户行详细地址,供应商税务登记地址,生产周期,物流周期,供应商法定代表人,合同签订日期,合同周期,合同周期开始时间,合同周期结束时间,操作人,操作时间,供应商来源,供应商状态,供应商是否有效,收款单位主键编码,协议类别,协议签订时间,协议签订地点,附件编码,团队规模,擅长领域,文件名,文件路径";
	...
	public void cloneCopy(BaseAttentionSupplierInfo __bean){
	...
	@Override
	public int compareTo(BaseAttentionSupplierInfo o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseAttentionSupplierInfo o = (BaseAttentionSupplierInfo)obj;
