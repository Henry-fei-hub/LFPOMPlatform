...
public class BaseNotApplyPermissions extends GenericBase implements BaseFactory<BaseNotApplyPermissions>, Comparable<BaseNotApplyPermissions> 
{


	public static BaseNotApplyPermissions newInstance(){
		return new BaseNotApplyPermissions();
	}

	@Override
	public BaseNotApplyPermissions make(){
		BaseNotApplyPermissions b = new BaseNotApplyPermissions();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "功能编码,功能编号,上级功能,功能名称,应用系统,功能类型,数据权限类型,是否有效,function_static_name,,,";
	...
	public void cloneCopy(BaseNotApplyPermissions __bean){
	...
	@Override
	public int compareTo(BaseNotApplyPermissions o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseNotApplyPermissions o = (BaseNotApplyPermissions)obj;
	...
	public Map<String, Object> toMap() {
		...
		if(getEmpFun() != null) res.put("empFun", getEmpFun());
		if(getRoleFun() != null) res.put("roleFun", getRoleFun());
		if(getDepartmentRoleFun() != null) res.put("departmentRoleFun", getDepartmentRoleFun());
		return res;
	}
