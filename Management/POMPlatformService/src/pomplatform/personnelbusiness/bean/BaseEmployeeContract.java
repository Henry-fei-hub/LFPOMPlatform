...
public class BaseEmployeeContract extends GenericBase implements BaseFactory<BaseEmployeeContract>, Comparable<BaseEmployeeContract> 
{


	public static BaseEmployeeContract newInstance(){
		return new BaseEmployeeContract();
	}

	@Override
	public BaseEmployeeContract make(){
		BaseEmployeeContract b = new BaseEmployeeContract();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,员工id,合同名称,存放路径,操作人,操作时间,合同类型,签订类型,开始日期,结束日期,一个月到期(0未到期；1即将到期；2已过期),附件编码,员工编号,归属部门,业务部门,入职日期,职员状态,主键编码,流程类型,业务编码,业务名称,流程编码,活动实列编码,流程状态 0 发起中  1,创建时间,完成时间";
	...
	public void cloneCopy(BaseEmployeeContract __bean){
	...
	@Override
	public int compareTo(BaseEmployeeContract o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseEmployeeContract o = (BaseEmployeeContract)obj;
