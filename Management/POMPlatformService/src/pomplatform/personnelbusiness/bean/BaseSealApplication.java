...
public class BaseSealApplication extends GenericBase implements BaseFactory<BaseSealApplication>, Comparable<BaseSealApplication> 
{


	public static BaseSealApplication newInstance(){
		return new BaseSealApplication();
	}

	@Override
	public BaseSealApplication make(){
		BaseSealApplication b = new BaseSealApplication();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "人事业务编码,类型 13请假  14出差  15打卡  16外出  17加班,员工姓名,工号,部门,归属公司,假期类型,开始日期,0上午   1下午,截止日期,0上午   1下午,天数,申请缘由,备注,请选择印章种类,盖章内容,交通工具,预计费用,盖章内容扫描件,联系人,起草时间,删除状态  0未删除    1已删除,盖章类型,假期类型明细项,小时,所属公司,目标省份,多胞胎假请填写婴儿数量,附件,是否审批通过,假期类型明细项,项目类型 1项目 2前期项目,盖章项目,项目名称,项目编号,父级编码  用于记录是根据哪一条记录进行延期,是否为边远城市,是否提供住宿,生活费用(元/月),住房费用(元/月),起草人,盖章内容,职务,对等号  与  冲账结合实现 借款与冲账与还款,关联表编码,离职补偿金,薪资1,薪资2,现薪资,月薪,基本比例（显示用）,基本比例（计算用）,月基本工资,月绩效工资,工龄工资,其他补贴,全薪,年度绩效,费用归属(1IT人员,2管理人员,3设计人员,4研发人员,5营销人员),领证时间,项目编码,付款序列编码,预算管理编码,预算附件编码,阶段id,附件编码,附件名称";
	...
	public void cloneCopy(BaseSealApplication __bean){
	...
	@Override
	public int compareTo(BaseSealApplication o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSealApplication o = (BaseSealApplication)obj;
