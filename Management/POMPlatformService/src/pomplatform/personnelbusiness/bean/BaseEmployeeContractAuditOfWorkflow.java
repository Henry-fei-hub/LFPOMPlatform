...
public class BaseEmployeeContractAuditOfWorkflow extends GenericBase implements BaseFactory<BaseEmployeeContractAuditOfWorkflow>, Comparable<BaseEmployeeContractAuditOfWorkflow> 
{


	public static BaseEmployeeContractAuditOfWorkflow newInstance(){
		return new BaseEmployeeContractAuditOfWorkflow();
	}

	@Override
	public BaseEmployeeContractAuditOfWorkflow make(){
		BaseEmployeeContractAuditOfWorkflow b = new BaseEmployeeContractAuditOfWorkflow();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "流程类型名称,主键编码,,主键编码,业务编码,业务名称,活动编码,流程编码,流程实列编码,附加节点，说明节点是预定义的节点还是动态加的节点， 0 - 正常定义的节点， 1 - 申请人或者审批人加的处理人或者审批人,当前流程实例节点的内部编码,下一个流程节点的编码,如果是知会节点，所依附的主节点,流程实例节点创建时间,流程实例节点开始处于活动时间,操作时间,提交意见,状态,节点类型 0 - 开始 1 - 结束 2 - 审批 3 - 处理 4 - 知会,返回数据集,流程类型,主键编码,员工id,合同名称,存放路径,操作人,合同类型,签订类型,开始日期,结束日期,一个月到期(0未到期；1即将到期；2已过期),附件编码,员工编号,部门编码,业务部门,入职日期,职员状态";
	...
	public void cloneCopy(BaseEmployeeContractAuditOfWorkflow __bean){
	...
	@Override
	public int compareTo(BaseEmployeeContractAuditOfWorkflow o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseEmployeeContractAuditOfWorkflow o = (BaseEmployeeContractAuditOfWorkflow)obj;
