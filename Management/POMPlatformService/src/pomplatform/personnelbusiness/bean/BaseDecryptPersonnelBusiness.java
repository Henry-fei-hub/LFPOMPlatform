...
public class BaseDecryptPersonnelBusiness extends GenericBase implements BaseFactory<BaseDecryptPersonnelBusiness>, Comparable<BaseDecryptPersonnelBusiness> 
{


	public static BaseDecryptPersonnelBusiness newInstance(){
		return new BaseDecryptPersonnelBusiness();
	}

	@Override
	public BaseDecryptPersonnelBusiness make(){
		BaseDecryptPersonnelBusiness b = new BaseDecryptPersonnelBusiness();
		return b;
	}
	...
	public void cloneCopy(BaseDecryptPersonnelBusiness __bean){
	...
	@Override
	public int compareTo(BaseDecryptPersonnelBusiness o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseDecryptPersonnelBusiness o = (BaseDecryptPersonnelBusiness)obj;
