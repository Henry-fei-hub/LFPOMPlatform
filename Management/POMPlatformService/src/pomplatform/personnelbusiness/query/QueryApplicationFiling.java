...
public class QueryApplicationFiling extends AbstractQuery<BaseApplicationFiling, ConditionApplicationFiling>
{

	private static final Logger __logger = Logger.getLogger(QueryApplicationFiling.class);

	public QueryApplicationFiling() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseApplicationFiling> executeQuery( KeyValuePair[] replacements, ConditionApplicationFiling condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseApplicationFiling generateBase(Object[] __data) throws java.sql.SQLException {
		BaseApplicationFiling __base = new BaseApplicationFiling();
		int count = 0;
		Object val;
	...
	private final static String[] fieldNames = { "department_id", "employee_no"};
}
