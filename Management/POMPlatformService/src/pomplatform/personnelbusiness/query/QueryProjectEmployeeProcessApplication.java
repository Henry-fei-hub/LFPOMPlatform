...
public class QueryProjectEmployeeProcessApplication extends AbstractQuery<BaseProjectEmployeeProcessApplication, ConditionProjectEmployeeProcessApplication>
{

	private static final Logger __logger = Logger.getLogger(QueryProjectEmployeeProcessApplication.class);

	public QueryProjectEmployeeProcessApplication() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseProjectEmployeeProcessApplication> executeQuery( KeyValuePair[] replacements, ConditionProjectEmployeeProcessApplication condition ) throws java.sql.SQLException {
	...
	public BaseCollection<BaseProjectEmployeeProcessApplication> runQuery( KeyValuePair[] replacements, ConditionProjectEmployeeProcessApplication condition ) throws java.sql.SQLException {
	...
	public BaseCollection<BaseProjectEmployeeProcessApplication> execute( KeyValuePair[] replacements, ConditionProjectEmployeeProcessApplication condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseProjectEmployeeProcessApplication generateBase(Object[] __data) throws java.sql.SQLException {
		BaseProjectEmployeeProcessApplication __base = new BaseProjectEmployeeProcessApplication();
		int count = 0;
		Object val;
	...
	private final static String __SQLText = "select pb.personnel_business_id, pb.process_type, pb.employee_id, pb.employee_no, pb.department_id, pb.company_id, pb.type, pb.start_date, pb.start_date_detail, pb.end_date, pb.end_date_detail, pb.days, pb.reason, pb.remark, pb.address, pb.plan, pb.transportation, pb.fee, pb.unit, pb.contact_person, pb.create_time, pb.delete_flag, pb.next_auditor, pb.sub_type, pb.hours, pb.company_province, pb.target_province, pb.number_of_baby, pb.attachment, pb.is_completed, pb.sub_type_str, pb.project_type, pb.project_id, pb.project_name, pb.project_code, pb.parent_id, pb.is_remote_city, pb.provide_accommodation, pb.living_expenses, pb.housing_finance, pb.drafter, pb.card, pb.duty_id, pb.equivalent_number, pb.link_id, pb.severance, pb.salary_1, pb.salary_2, pb.original_pay, pb.month_pay, pb.basic_proportion_str, pb.basic_proportion, pb.month_basic_pay, pb.month_performance_pay, pb.foreman_pay, pb.other_subsidy, pb.total_pay, pb.annual_performance, pb.cost_attribution, pb.certification_time, pb.project_ids, pb.payment_sequence_id, pb.budget_management_id, pb.budget_attachment_id, pb.stage_id, pb.attachment_id, pb.attachment_name from personnel_business pb where pb.personnel_business_id = ? and pb.process_type = ?" ;
	private final static String __originalSQL = "select pb.personnel_business_id, pb.process_type, pb.employee_id, pb.employee_no, pb.department_id, pb.company_id, pb.type, pb.start_date, pb.start_date_detail, pb.end_date, pb.end_date_detail, pb.days, pb.reason, pb.remark, pb.address, pb.plan, pb.transportation, pb.fee, pb.unit, pb.contact_person, pb.create_time, pb.delete_flag, pb.next_auditor, pb.sub_type, pb.hours, pb.company_province, pb.target_province, pb.number_of_baby, pb.attachment, pb.is_completed, pb.sub_type_str, pb.project_type, pb.project_id, pb.project_name, pb.project_code, pb.parent_id, pb.is_remote_city, pb.provide_accommodation, pb.living_expenses, pb.housing_finance, pb.drafter, pb.card, pb.duty_id, pb.equivalent_number, pb.link_id, pb.severance, pb.salary_1, pb.salary_2, pb.original_pay, pb.month_pay, pb.basic_proportion_str, pb.basic_proportion, pb.month_basic_pay, pb.month_performance_pay, pb.foreman_pay, pb.other_subsidy, pb.total_pay, pb.annual_performance, pb.cost_attribution, pb.certification_time, pb.project_ids, pb.payment_sequence_id, pb.budget_management_id, pb.budget_attachment_id, pb.stage_id, pb.attachment_id, pb.attachment_name from personnel_business pb where pb.personnel_business_id = :personnel_business_id and pb.process_type = :process_type";
	private final static String[] __queryConditions = {
		"[{\"fullCondition\": \"pb.personnel_business_id = :personnel_business_id and pb.process_type = :process_type\",\"startIndex\": 1165,\"stopIndex\":1249,\"variableNum\": 0,\"variableCount\": 0,\"isor\":false,\"hasVariable\":false,\"hasBracket\":false,\"isVariableFirst\":false,\"topLevel\":true,\"children\": [{\"fullCondition\": \"pb.personnel_business_id = :personnel_business_id\",\"fullFieldName\":\"pb.personnel_business_id\",\"operationName\":\"=\",\"variableName\":\"personnelBusinessId\",\"startIndex\": 1165,\"stopIndex\":1213,\"variableNum\": 0,\"variableCount\": 1,\"isor\":false,\"hasVariable\":true,\"hasBracket\":false,\"isVariableFirst\":false,\"topLevel\":false,\"children\": []},{\"fullCondition\": \"pb.process_type = :process_type\",\"fullFieldName\":\"pb.process_type\",\"operationName\":\"=\",\"variableName\":\"processType\",\"startIndex\": 1219,\"stopIndex\":1249,\"variableNum\": 1,\"variableCount\": 1,\"isor\":false,\"hasVariable\":true,\"hasBracket\":false,\"isVariableFirst\":false,\"topLevel\":false,\"children\": []}]}]"
	};
