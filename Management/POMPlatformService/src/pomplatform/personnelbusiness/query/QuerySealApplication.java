...
import pomplatform.personnelbusiness.bean.BaseSealApplication;
import pomplatform.personnelbusiness.bean.ConditionSealApplication;

public class QuerySealApplication extends AbstractQuery<BaseSealApplication, ConditionSealApplication>
{

	private static final Logger __logger = Logger.getLogger(QuerySealApplication.class);

	public QuerySealApplication() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseSealApplication> executeQuery( KeyValuePair[] replacements, ConditionSealApplication condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseSealApplication generateBase(Object[] __data) throws java.sql.SQLException {
		BaseSealApplication __base = new BaseSealApplication();
		int count = 0;
		Object val;
	...
	private final static String[] fieldNames = { "personnel_business_id", "department_id", "employee_id"};
}
