...
public class PersonnelBusinesWithPHandler implements GenericDao {
	...
	public static boolean isPersonnelBusinesWithPExists( pomplatform.personnelbusiness.bean.BasePersonnelBusinesWithP bean, String additional ) {
	...
	public static int countPersonnelBusinesWithP( pomplatform.personnelbusiness.bean.BasePersonnelBusinesWithP bean, String additional ) {
