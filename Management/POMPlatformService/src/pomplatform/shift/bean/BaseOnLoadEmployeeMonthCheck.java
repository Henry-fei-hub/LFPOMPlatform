...
public class BaseOnLoadEmployeeMonthCheck extends GenericBase implements BaseFactory<BaseOnLoadEmployeeMonthCheck>, Comparable<BaseOnLoadEmployeeMonthCheck> 
{


	public static BaseOnLoadEmployeeMonthCheck newInstance(){
		return new BaseOnLoadEmployeeMonthCheck();
	}

	@Override
	public BaseOnLoadEmployeeMonthCheck make(){
		BaseOnLoadEmployeeMonthCheck b = new BaseOnLoadEmployeeMonthCheck();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "员工编号,员工姓名,部门,在职状态,年份,月份,迟到次数,迟到分钟,早退次数,早退分钟,迟到扣款,平时加班(小时),周末加班(小时),节假日加班(小时),加班餐补(本月),加班餐补,加班补助(本月),加班补助,调休假,年假(天),事假(天),病假(天),其他假类(天),因公外出(次数),应到(天),实到(天),旷工(天)";
	...
	public java.lang.Long getLateLeave5m() {
		return this.__late_leave_5m;
	}

	public void setLateLeave5m( java.lang.Long value ) {
		this.__late_leave_5m = value;
	}

	public java.lang.Long getLateLeave10m() {
		return this.__late_leave_10m;
	}

	public void setLateLeave10m( java.lang.Long value ) {
		this.__late_leave_10m = value;
	}

	public java.lang.Long getLateLeave30m() {
		return this.__late_leave_30m;
	}

	public void setLateLeave30m( java.lang.Long value ) {
		this.__late_leave_30m = value;
	}

	public java.lang.Long getLateLeave() {
		return this.__late_leave;
	}

	public void setLateLeave( java.lang.Long value ) {
		this.__late_leave = value;
	}

	public java.lang.Long getThingLeaveTimes() {
		return this.__thing_leave_times;
	}

	public void setThingLeaveTimes( java.lang.Long value ) {
	...
	public java.lang.Long getIllLeaveTimes() {
		return this.__ill_leave_times;
	}

	public void setIllLeaveTimes( java.lang.Long value ) {
	...
	public java.lang.Long getOtherLeaveTimes() {
		return this.__other_leave_times;
	}

	public void setOtherLeaveTimes( java.lang.Long value ) {
	...
	public void cloneCopy(BaseOnLoadEmployeeMonthCheck __bean){
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		sb.append(getLeaveForMinutes() ==null ? "" : getNumberOfLeave());
		sb.append(",");
...
//		sb.append(getIsLocked() == null ? "" : getIsLocked());
	...
	@Override
	public int compareTo(BaseOnLoadEmployeeMonthCheck o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseOnLoadEmployeeMonthCheck o = (BaseOnLoadEmployeeMonthCheck)obj;
	...
	public void setDataFromMap(Map<String, Object> values){
		...
		if((val = values.get("lateLeave5m")) != null) setLateLeave5m(__getLong(val)); 
		if((val = values.get("lateLeave10m")) != null) setLateLeave10m(__getLong(val)); 
		if((val = values.get("lateLeave30m")) != null) setLateLeave30m(__getLong(val)); 
		if((val = values.get("lateLeave")) != null) setLateLeave(__getLong(val)); 
		if((val = values.get("thingLeaveTimes")) != null) setThingLeaveTimes(__getLong(val)); 
		...
		if((val = values.get("illLeaveTimes")) != null) setIllLeaveTimes(__getLong(val)); 
		...
		if((val = values.get("otherLeaveTimes")) != null) setOtherLeaveTimes(__getLong(val)); 
	...
	protected java.lang.Long  __late_leave_5m ;
	protected java.lang.Long  __late_leave_10m ;
	protected java.lang.Long  __late_leave_30m ;
	protected java.lang.Long  __late_leave ;
	protected java.lang.Long  __thing_leave_times ;
	protected java.math.BigDecimal  __thing_leave_hours ;
	protected java.math.BigDecimal  __thing_leave_days ;
	protected java.lang.Long  __ill_leave_times ;
	protected java.math.BigDecimal  __ill_leave_hours ;
	protected java.math.BigDecimal  __ill_leave_days ;
	protected java.lang.Long  __other_leave_times ;
