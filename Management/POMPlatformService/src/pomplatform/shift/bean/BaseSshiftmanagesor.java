...
public class BaseSshiftmanagesor extends GenericBase implements BaseFactory<BaseSshiftmanagesor>, Comparable<BaseSshiftmanagesor> 
{


	public static BaseSshiftmanagesor newInstance(){
		return new BaseSshiftmanagesor();
	}

	@Override
	public BaseSshiftmanagesor make(){
		BaseSshiftmanagesor b = new BaseSshiftmanagesor();
		return b;
	}
	...
	public void cloneCopy(BaseSshiftmanagesor __bean){
	...
	@Override
	public int compareTo(BaseSshiftmanagesor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSshiftmanagesor o = (BaseSshiftmanagesor)obj;
