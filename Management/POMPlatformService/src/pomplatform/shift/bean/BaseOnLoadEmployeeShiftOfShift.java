...
public class BaseOnLoadEmployeeShiftOfShift extends GenericBase implements BaseFactory<BaseOnLoadEmployeeShiftOfShift>, Comparable<BaseOnLoadEmployeeShiftOfShift> 
{


	public static BaseOnLoadEmployeeShiftOfShift newInstance(){
		return new BaseOnLoadEmployeeShiftOfShift();
	}

	@Override
	public BaseOnLoadEmployeeShiftOfShift make(){
		BaseOnLoadEmployeeShiftOfShift b = new BaseOnLoadEmployeeShiftOfShift();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "职员编码,员工编号,员工姓名,性别,部门,年份,月份,本月是否考勤,数目";
	...
	public void cloneCopy(BaseOnLoadEmployeeShiftOfShift __bean){
	...
	@Override
	public int compareTo(BaseOnLoadEmployeeShiftOfShift o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseOnLoadEmployeeShiftOfShift o = (BaseOnLoadEmployeeShiftOfShift)obj;
