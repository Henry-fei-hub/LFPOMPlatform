...
public class BaseManageShiftTime extends GenericBase implements BaseFactory<BaseManageShiftTime>, Comparable<BaseManageShiftTime> 
{


	public static BaseManageShiftTime newInstance(){
		return new BaseManageShiftTime();
	}

	@Override
	public BaseManageShiftTime make(){
		BaseManageShiftTime b = new BaseManageShiftTime();
		return b;
	}
	...
	public void cloneCopy(BaseManageShiftTime __bean){
	...
	@Override
	public int compareTo(BaseManageShiftTime o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseManageShiftTime o = (BaseManageShiftTime)obj;
