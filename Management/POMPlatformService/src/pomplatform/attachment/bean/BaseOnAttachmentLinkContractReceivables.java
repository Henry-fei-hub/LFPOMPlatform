...
public class BaseOnAttachmentLinkContractReceivables extends GenericBase implements BaseFactory<BaseOnAttachmentLinkContractReceivables>, Comparable<BaseOnAttachmentLinkContractReceivables> 
{


	public static BaseOnAttachmentLinkContractReceivables newInstance(){
		return new BaseOnAttachmentLinkContractReceivables();
	}

	@Override
	public BaseOnAttachmentLinkContractReceivables make(){
		BaseOnAttachmentLinkContractReceivables b = new BaseOnAttachmentLinkContractReceivables();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "收款阶段编码,阶段名称,收款百分比,收款金额,收款阶段id的父节点,绑定状态";
	...
	public void cloneCopy(BaseOnAttachmentLinkContractReceivables __bean){
	...
	@Override
	public int compareTo(BaseOnAttachmentLinkContractReceivables o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseOnAttachmentLinkContractReceivables o = (BaseOnAttachmentLinkContractReceivables)obj;
