...
public class BaseOnAttachmentLinkInvoices extends GenericBase implements BaseFactory<BaseOnAttachmentLinkInvoices>, Comparable<BaseOnAttachmentLinkInvoices> 
{


	public static BaseOnAttachmentLinkInvoices newInstance(){
		return new BaseOnAttachmentLinkInvoices();
	}

	@Override
	public BaseOnAttachmentLinkInvoices make(){
		BaseOnAttachmentLinkInvoices b = new BaseOnAttachmentLinkInvoices();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "发票编码,发票类型,发票代码(10位 每次批量录入是一样),发票号码(8位 规则+1),购票公司,客户名称,开票金额(如 100),税率(如 6%),no_tax_amount,output_tax,开票日期,绑定状态";
	...
	public void cloneCopy(BaseOnAttachmentLinkInvoices __bean){
	...
	@Override
	public int compareTo(BaseOnAttachmentLinkInvoices o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseOnAttachmentLinkInvoices o = (BaseOnAttachmentLinkInvoices)obj;
