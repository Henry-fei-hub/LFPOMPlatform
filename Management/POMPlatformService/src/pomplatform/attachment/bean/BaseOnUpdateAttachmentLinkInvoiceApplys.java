...
public class BaseOnUpdateAttachmentLinkInvoiceApplys extends GenericBase implements BaseFactory<BaseOnUpdateAttachmentLinkInvoiceApplys>, Comparable<BaseOnUpdateAttachmentLinkInvoiceApplys> 
{


	public static BaseOnUpdateAttachmentLinkInvoiceApplys newInstance(){
		return new BaseOnUpdateAttachmentLinkInvoiceApplys();
	}

	@Override
	public BaseOnUpdateAttachmentLinkInvoiceApplys make(){
		BaseOnUpdateAttachmentLinkInvoiceApplys b = new BaseOnUpdateAttachmentLinkInvoiceApplys();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "发票联系人编码,申请人,发票类型,单位名称,税号,联系人,联系电话,座机,申请备注,operator_remark,,,0/1 是/否删除,注册地址,bank_name,bank_account";
	...
	public void cloneCopy(BaseOnUpdateAttachmentLinkInvoiceApplys __bean){
	...
	@Override
	public int compareTo(BaseOnUpdateAttachmentLinkInvoiceApplys o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseOnUpdateAttachmentLinkInvoiceApplys o = (BaseOnUpdateAttachmentLinkInvoiceApplys)obj;
