...
public class ConditionMcontractAttachmentCapitalCount extends GenericCondition{

	public ConditionMcontractAttachmentCapitalCount(){
	...
	public java.util.Date getBeforeSettlementDate() {
		return this.__before_settlement_date;
	}

	public void setBeforeSettlementDate( java.util.Date value ) {
		this.__before_settlement_date = value;
	}

	public java.util.Date getAfterSettlementDate() {
		return this.__after_settlement_date;
	}

	public void setAfterSettlementDate( java.util.Date value ) {
		this.__after_settlement_date = value;
	}
	...
	public java.lang.String toJSONString() {
		...
		if(getBeforeSettlementDate() != null) sb.append(__wrapDate(1, "beforeSettlementDate", getBeforeSettlementDate()));
		if(getAfterSettlementDate() != null) sb.append(__wrapDate(1, "afterSettlementDate", getAfterSettlementDate()));
	...
	public void setDataFromMap(Map<String, Object> values){
		...
		if((val = values.get("beforeSettlementDate")) != null) setBeforeSettlementDate(__getDate(val)); 
		if((val = values.get("afterSettlementDate")) != null) setAfterSettlementDate(__getDate(val)); 
	...
	private java.util.Date __before_settlement_date = null;
	private java.util.Date __after_settlement_date = null;
