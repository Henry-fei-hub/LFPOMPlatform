...
public class BaseSattachmentmanageaaaor extends GenericBase implements BaseFactory<BaseSattachmentmanageaaaor>, Comparable<BaseSattachmentmanageaaaor> 
{


	public static BaseSattachmentmanageaaaor newInstance(){
		return new BaseSattachmentmanageaaaor();
	}

	@Override
	public BaseSattachmentmanageaaaor make(){
		BaseSattachmentmanageaaaor b = new BaseSattachmentmanageaaaor();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,合同编码,编号,附件名称,附件路径,专业备注,金额,回款金额,收款确认,收款阶段描述,序列号(生成编号的序号),记录日期,操作人,操作时间,备注";
	...
	public java.lang.Integer getSuperProjectManageId() {
		return __super_project_manage_id;
	}
	...
	public void cloneCopy(BaseSattachmentmanageaaaor __bean){
	...
	@Override
	public int compareTo(BaseSattachmentmanageaaaor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSattachmentmanageaaaor o = (BaseSattachmentmanageaaaor)obj;
