...
public class BaseSprojectunitpricepagor extends GenericBase implements BaseFactory<BaseSprojectunitpricepagor>, Comparable<BaseSprojectunitpricepagor> {

	public static BaseSprojectunitpricepagor newInstance() {
		return new BaseSprojectunitpricepagor();
	}

	@Override
	public BaseSprojectunitpricepagor make() {
		BaseSprojectunitpricepagor b = new BaseSprojectunitpricepagor();
		return b;
	}
	...
	public void cloneCopy(BaseSprojectunitpricepagor __bean) {
	...
	@Override
	public int compareTo(BaseSprojectunitpricepagor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSprojectunitpricepagor o = (BaseSprojectunitpricepagor) obj;
		if (!Objects.equals(this.__project_unit_price_id, o.getProjectUnitPriceId())) {
			return false;
		}
		if (!Objects.equals(this.__plate_id, o.getPlateId())) {
			return false;
		}
		if (!Objects.equals(this.__area_id, o.getAreaId())) {
			return false;
		}
		if (!Objects.equals(this.__grade_id, o.getGradeId())) {
			return false;
		}
		if (!Objects.equals(this.__square_id, o.getSquareId())) {
			return false;
		}
		if (!Objects.equals(this.__min_square, o.getMinSquare())) {
			return false;
		}
		if (!Objects.equals(this.__max_square, o.getMaxSquare())) {
			return false;
		}
		if (!Objects.equals(this.__unit_price, o.getUnitPrice())) {
			return false;
		}
		return true;
	}
	...
	public java.lang.String toJSONString() {
		...
		StringBuilder sb = new StringBuilder();
		int count = 0;
		if (getProjectUnitPriceId() != null) {
			sb.append(__wrapNumber(count++, "projectUnitPriceId", getProjectUnitPriceId()));
		}
		if (getPlateId() != null) {
			sb.append(__wrapNumber(count++, "plateId", getPlateId()));
		}
		if (getAreaId() != null) {
			sb.append(__wrapNumber(count++, "areaId", getAreaId()));
		}
		if (getGradeId() != null) {
			sb.append(__wrapNumber(count++, "gradeId", getGradeId()));
		}
		if (getSquareId() != null) {
			sb.append(__wrapNumber(count++, "squareId", getSquareId()));
		}
		if (getMinSquare() != null) {
			sb.append(__wrapDecimal(count++, "minSquare", getMinSquare()));
		}
		if (getMaxSquare() != null) {
			sb.append(__wrapDecimal(count++, "maxSquare", getMaxSquare()));
		}
		if (getUnitPrice() != null) {
			sb.append(__wrapDecimal(count++, "unitPrice", getUnitPrice()));
		}
		return sb.toString();
	}
	...
	public void setDataFromMap(Map<String, Object> values) {
		Object val;
		if ((val = values.get("projectUnitPriceId")) != null) {
			setProjectUnitPriceId(__getInt(val));
		}
		...
		if ((val = values.get("minSquare")) != null) {
			setMinSquare(__getDecimal(val));
		}
		if ((val = values.get("maxSquare")) != null) {
			setMaxSquare(__getDecimal(val));
		}
		if ((val = values.get("unitPrice")) != null) {
			setUnitPrice(__getDecimal(val));
		}
	}
