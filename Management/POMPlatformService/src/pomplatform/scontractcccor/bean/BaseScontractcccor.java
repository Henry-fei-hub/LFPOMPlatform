...
public class BaseScontractcccor extends GenericBase implements BaseFactory<BaseScontractcccor>, Comparable<BaseScontractcccor> 
{


	public static BaseScontractcccor newInstance(){
		return new BaseScontractcccor();
	}

	@Override
	public BaseScontractcccor make(){
		BaseScontractcccor b = new BaseScontractcccor();
		return b;
	}
	...
	public void cloneCopy(BaseScontractcccor __bean){
	...
	@Override
	public int compareTo(BaseScontractcccor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseScontractcccor o = (BaseScontractcccor)obj;
