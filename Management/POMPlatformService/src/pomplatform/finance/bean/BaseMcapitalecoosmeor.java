...
public class BaseMcapitalecoosmeor extends GenericBase implements BaseFactory<BaseMcapitalecoosmeor>, Comparable<BaseMcapitalecoosmeor> 
{


	public static BaseMcapitalecoosmeor newInstance(){
		return new BaseMcapitalecoosmeor();
	}

	@Override
	public BaseMcapitalecoosmeor make(){
		BaseMcapitalecoosmeor b = new BaseMcapitalecoosmeor();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "资金表id,信息编号,项目编号,合同id,合同名称,合同主编号,款项属性,内部公司(收款方),银行名称(收款方),银行账号(收款方),对方名称(付款方),银行名称(付款方),银行账号(付款方),借（增加）,贷（减少）,操作人id,发生日期,登记日期,是否绑定了发票,是否绑定了合同阶段付款,登记人,备注";
	public final static java.lang.String LOCAL_CAPTIONS = "资金表id,合同名称,合同主编号,款项属性,内部公司(收款方),银行名称(收款方),银行账号(收款方),对方名称(付款方),实际客户名称,借（增加）,汇率, 原币金额, 贷（减少）,操作人,发生日期,登记日期,实际到账金额,实际到账日期,是否绑定了发票,是否绑定了合同阶段付款,登记人,备注,出票日期,到期日";
	...
	public java.lang.Boolean getRecordReceiveCapital() {
		return __record_receive_capital;
	}
	...
	public void cloneCopy(BaseMcapitalecoosmeor __bean){
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		String strMoneyAttribute = delicacy.system.executor.SelectValueCache.getSelectValue("system_dictionary_55", String.valueOf(getMoneyAttribute()));
		sb.append(strMoneyAttribute == null ? "" : strMoneyAttribute);
		sb.append(",");
		String strSelfName = delicacy.system.executor.SelectValueCache.getSelectValue("system_dictionary_54", String.valueOf(getSelfName()));
	...
	public java.lang.String toCSVString2() {
		
		java.text.SimpleDateFormat sdf = new java.text.SimpleDateFormat(DATE_FORMAT);
		StringBuilder sb = new StringBuilder();
		sb.append(getCapitalId() == null ? "" : getCapitalId());
		sb.append(",");
		sb.append(getContractName() == null ? "" : setReplaceAll(getContractName()));
		sb.append(",");
		sb.append(getContractCode() == null ? "" : setReplaceAll(getContractCode()));
		sb.append(",");
		String strMoneyAttribute = delicacy.system.executor.SelectValueCache.getSelectValue("system_dictionary_55", String.valueOf(getMoneyAttribute()));
		sb.append(strMoneyAttribute == null ? "" : strMoneyAttribute);
		sb.append(",");
		...
		sb.append(strSelfName == null ? "" : strSelfName);
		sb.append(",");
		sb.append(getSelfBankName() == null ? "" : setReplaceAll(getSelfBankName()));
		sb.append(",");
		sb.append(getSelfBankAccount() == null ? "" : setReplaceAll(getSelfBankAccount()));
		sb.append(",");
		sb.append(getOtherName() == null ? "" : setReplaceAll(getOtherName()));
		sb.append(",");
		sb.append(getReceiveUnit() == null ? "" : setReplaceAll(getReceiveUnit()));
		sb.append(",");
		sb.append(getBorrowMoney() == null ? "" : getBorrowMoney());
		sb.append(",");
		...
		sb.append(getLoanMoney() == null ? "" : getLoanMoney());
		sb.append(",");
		String strOperator = SelectValueCache.getSelectValue("employees", String.valueOf(getOperator()));
		...
		sb.append(",");
		sb.append(getActualReceiveDate() == null ? "" : DateUtil.formatDateString(getActualReceiveDate()));
		sb.append(",");
		sb.append(getHasInvoices() == null ? "" : getHasInvoices());
		sb.append(",");
		sb.append(getHasContractReceivable() == null ? "" : getHasContractReceivable());
		...
		sb.append(getEmployeeName() == null ? "" : getEmployeeName());
		sb.append(",");
		sb.append(getRemark() == null ? "" : setReplaceAll(getRemark()));
		sb.append(",");
		sb.append(getIssueDate() == null ? "" : DateUtil.formatDateString(getIssueDate()));
		sb.append(",");
		sb.append(getExpireDate() == null ? "" : DateUtil.formatDateString(getExpireDate()));
		return sb.toString();
	}
	@Override
	public int compareTo(BaseMcapitalecoosmeor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseMcapitalecoosmeor o = (BaseMcapitalecoosmeor)obj;
