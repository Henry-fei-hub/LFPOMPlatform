...
public class BaseRevenueRecordOfOnRevenue extends GenericBase implements BaseFactory<BaseRevenueRecordOfOnRevenue>, Comparable<BaseRevenueRecordOfOnRevenue> 
{


	public static BaseRevenueRecordOfOnRevenue newInstance(){
		return new BaseRevenueRecordOfOnRevenue();
	}

	@Override
	public BaseRevenueRecordOfOnRevenue make(){
		BaseRevenueRecordOfOnRevenue b = new BaseRevenueRecordOfOnRevenue();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,合同编码,编号,名称,金额,完工比,完工比,营收金额,发票金额,回款金额,父级编码,签约公司,合同是否完成,结算日期,记录月份,2月末计算,操作人,操作时间,完工比明细,完工比明细(显示)";
	...
	public void cloneCopy(BaseRevenueRecordOfOnRevenue __bean){
	...
	@Override
	public int compareTo(BaseRevenueRecordOfOnRevenue o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseRevenueRecordOfOnRevenue o = (BaseRevenueRecordOfOnRevenue)obj;
