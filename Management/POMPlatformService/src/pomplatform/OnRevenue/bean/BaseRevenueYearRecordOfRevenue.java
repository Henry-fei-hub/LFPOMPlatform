...
public class BaseRevenueYearRecordOfRevenue extends GenericBase implements BaseFactory<BaseRevenueYearRecordOfRevenue>, Comparable<BaseRevenueYearRecordOfRevenue> 
{


	public static BaseRevenueYearRecordOfRevenue newInstance(){
		return new BaseRevenueYearRecordOfRevenue();
	}

	@Override
	public BaseRevenueYearRecordOfRevenue make(){
		BaseRevenueYearRecordOfRevenue b = new BaseRevenueYearRecordOfRevenue();
		return b;
	}
	...
	public void cloneCopy(BaseRevenueYearRecordOfRevenue __bean){
	...
	@Override
	public int compareTo(BaseRevenueYearRecordOfRevenue o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseRevenueYearRecordOfRevenue o = (BaseRevenueYearRecordOfRevenue)obj;
