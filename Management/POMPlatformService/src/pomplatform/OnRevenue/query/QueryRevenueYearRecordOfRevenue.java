...
public class QueryRevenueYearRecordOfRevenue extends AbstractQuery<BaseRevenueYearRecordOfRevenue, ConditionRevenueYearRecordOfRevenue>
{

	private static final Logger __logger = Logger.getLogger(QueryRevenueYearRecordOfRevenue.class);

	public QueryRevenueYearRecordOfRevenue() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseRevenueYearRecordOfRevenue> executeQuery( KeyValuePair[] replacements, ConditionRevenueYearRecordOfRevenue condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseRevenueYearRecordOfRevenue generateBase(Object[] __data) throws java.sql.SQLException {
		BaseRevenueYearRecordOfRevenue __base = new BaseRevenueYearRecordOfRevenue();
		int count = 0;
		Object val;
	...
	private final static String __SQLText = "select * from revenue_year_records where flag = 1 and signing_company = ? and is_finish =? and year_revenue = ? and parent_id = ?" ;
