package pomplatform.cardManage.bean;
...
public class BaseEmployeeCardManage extends GenericBase implements BaseFactory<BaseEmployeeCardManage>, Comparable<BaseEmployeeCardManage> 
{


	public static BaseEmployeeCardManage newInstance(){
		return new BaseEmployeeCardManage();
	}

	@Override
	public BaseEmployeeCardManage make(){
		BaseEmployeeCardManage b = new BaseEmployeeCardManage();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "员工编号,员工姓名,部门,4删除),主键编码,对象编码,2单位),开户行,银行账号,开户行所在地,2报销卡),是否为默认卡,是否启用,currency_type,招商银行分行代码,真实收付款,开户行(支行)";
	...
	public void cloneCopy(BaseEmployeeCardManage __bean){
	...
	@Override
	public int compareTo(BaseEmployeeCardManage o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseEmployeeCardManage o = (BaseEmployeeCardManage)obj;
