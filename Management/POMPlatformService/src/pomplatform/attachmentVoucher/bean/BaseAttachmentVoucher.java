...
public class BaseAttachmentVoucher extends GenericBase implements BaseFactory<BaseAttachmentVoucher>, Comparable<BaseAttachmentVoucher> 
{


	public static BaseAttachmentVoucher newInstance(){
		return new BaseAttachmentVoucher();
	}

	@Override
	public BaseAttachmentVoucher make(){
		BaseAttachmentVoucher b = new BaseAttachmentVoucher();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,项目,归属公司,凭证号,凭证内序号,科目类型,科目编码,科目代码,科目名称,辅助核算类型,辅助核算编码,辅助核算代码,辅助核算名称,备注,简化备注,借方,贷方,报销汇总编号,报销金额,进项税,我方银行账号,对方银行账号,需要调整,归属日期,是否锁定,创建时间,修改时间,定稿时间,关联编码,凭证类型 1报销  2发票  3回款 4收入 5确认函,附加的关联编码,附件名称,主键编码,编号";
	...
	public void cloneCopy(BaseAttachmentVoucher __bean){
	...
	@Override
	public int compareTo(BaseAttachmentVoucher o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseAttachmentVoucher o = (BaseAttachmentVoucher)obj;
