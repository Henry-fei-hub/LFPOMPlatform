...
public class BaseGetProjectAndSettlementIntegralByContract extends GenericBase implements BaseFactory<BaseGetProjectAndSettlementIntegralByContract>, Comparable<BaseGetProjectAndSettlementIntegralByContract> 
{


	public static BaseGetProjectAndSettlementIntegralByContract newInstance(){
		return new BaseGetProjectAndSettlementIntegralByContract();
	}

	@Override
	public BaseGetProjectAndSettlementIntegralByContract make(){
		BaseGetProjectAndSettlementIntegralByContract b = new BaseGetProjectAndSettlementIntegralByContract();
		return b;
	}
	...
	public void cloneCopy(BaseGetProjectAndSettlementIntegralByContract __bean){
	...
	@Override
	public int compareTo(BaseGetProjectAndSettlementIntegralByContract o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseGetProjectAndSettlementIntegralByContract o = (BaseGetProjectAndSettlementIntegralByContract)obj;
