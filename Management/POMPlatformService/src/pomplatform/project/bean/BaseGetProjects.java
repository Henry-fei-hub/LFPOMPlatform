...
public class BaseGetProjects extends GenericBase implements BaseFactory<BaseGetProjects>, Comparable<BaseGetProjects> 
{


	public static BaseGetProjects newInstance(){
		return new BaseGetProjects();
	}

	@Override
	public BaseGetProjects make(){
		BaseGetProjects b = new BaseGetProjects();
		return b;
	}
	...
	public void cloneCopy(BaseGetProjects __bean){
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		String strDesignType = delicacy.system.executor.SelectValueCache.getSelectValue("system_dictionary_15", String.valueOf(getDesignType()));
		sb.append(strDesignType == null ? "" : strDesignType);
		sb.append(",");
		...
		sb.append(",");
		String strSubContractId = delicacy.system.executor.SelectValueCache.getSelectValue("sub_contracts", String.valueOf(getSubContractId()));
		sb.append(strSubContractId == null ? "" : strSubContractId);
		sb.append(",");
	...
	@Override
	public int compareTo(BaseGetProjects o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseGetProjects o = (BaseGetProjects)obj;
