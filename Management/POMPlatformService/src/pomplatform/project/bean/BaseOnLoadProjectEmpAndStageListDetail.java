...
public class BaseOnLoadProjectEmpAndStageListDetail extends GenericBase implements BaseFactory<BaseOnLoadProjectEmpAndStageListDetail>, Comparable<BaseOnLoadProjectEmpAndStageListDetail> 
{


	public static BaseOnLoadProjectEmpAndStageListDetail newInstance(){
		return new BaseOnLoadProjectEmpAndStageListDetail();
	}

	@Override
	public BaseOnLoadProjectEmpAndStageListDetail make(){
		BaseOnLoadProjectEmpAndStageListDetail b = new BaseOnLoadProjectEmpAndStageListDetail();
		return b;
	}
	...
	public final static java.lang.String CS_SURE_TOTAL = "sure_total" ;
	public final static java.lang.String CS_PLAN_TOTAL = "plan_total" ;

	public final static java.lang.String ALL_CAPTIONS = "项目组建编码,项目代码,结算操作人,员工编号,员工姓名,项目阶段,,等级,预分配积分,上一次预分配积分,//状态值  1待审批    2同意  3不同意,结算状态";
	...
	public java.math.BigDecimal getSureTotal() {
		return this.__sure_total;
	}
	
	public void setSureTotal( java.math.BigDecimal value ) {
		this.__sure_total = value;
	}
	...
	public java.math.BigDecimal getPlanTotal() {
		return this.__plan_total;
	}
	
	public void setPlanTotal( java.math.BigDecimal value ) {
		this.__plan_total = value;
	}
	...
	public void cloneCopy(BaseOnLoadProjectEmpAndStageListDetail __bean){
		...
		__bean.setSureTotal(getSureTotal());
		__bean.setPlanTotal(getPlanTotal());
	}
	...
	@Override
	public int compareTo(BaseOnLoadProjectEmpAndStageListDetail o) {
	...
	public int hashCode() {
		...
		hash = 97 * hash + Objects.hashCode(this.__sure_total);
		hash = 97 * hash + Objects.hashCode(this.__plan_total);
		return hash;
	}
	...
	public boolean equals(Object obj) {
		...
		final BaseOnLoadProjectEmpAndStageListDetail o = (BaseOnLoadProjectEmpAndStageListDetail)obj;
		...
		if(!Objects.equals(this.__sure_total, o.getSureTotal())) return false;
		if(!Objects.equals(this.__plan_total, o.getPlanTotal())) return false;
		return true;
	}
	...
	public java.lang.String toJSONString() {
		...
		if(getSureTotal() != null) sb.append(__wrapDecimal(count++, "sureTotal", getSureTotal()));
		if(getPlanTotal() != null) sb.append(__wrapDecimal(count++, "planTotal", getPlanTotal()));
		return sb.toString();
	}
	...
	public Map<String, Object> toMap() {
		...
		if(getSureTotal() != null) res.put("sureTotal", getSureTotal());
		if(getPlanTotal() != null) res.put("planTotal", getPlanTotal());
		return res;
	}
	...
	public void setDataFromMap(Map<String, Object> values){
		...
		if((val = values.get("sureTotal")) != null) setSureTotal(__getDecimal(val));  
		if((val = values.get("planTotal")) != null) setPlanTotal(__getDecimal(val));  
	}
	...
	protected java.math.BigDecimal  __sure_total ;
	protected java.math.BigDecimal  __plan_total ;
}
