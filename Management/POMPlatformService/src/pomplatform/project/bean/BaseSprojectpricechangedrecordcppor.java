...
public class BaseSprojectpricechangedrecordcppor extends GenericBase implements BaseFactory<BaseSprojectpricechangedrecordcppor>, Comparable<BaseSprojectpricechangedrecordcppor> 
{


	public static BaseSprojectpricechangedrecordcppor newInstance(){
		return new BaseSprojectpricechangedrecordcppor();
	}

	@Override
	public BaseSprojectpricechangedrecordcppor make(){
		BaseSprojectpricechangedrecordcppor b = new BaseSprojectpricechangedrecordcppor();
		return b;
	}
	...
	public void cloneCopy(BaseSprojectpricechangedrecordcppor __bean){
	...
	@Override
	public int compareTo(BaseSprojectpricechangedrecordcppor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSprojectpricechangedrecordcppor o = (BaseSprojectpricechangedrecordcppor)obj;
