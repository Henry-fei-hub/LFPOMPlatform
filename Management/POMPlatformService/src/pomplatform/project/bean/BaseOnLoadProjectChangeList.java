...
public class BaseOnLoadProjectChangeList extends GenericBase implements BaseFactory<BaseOnLoadProjectChangeList>, Comparable<BaseOnLoadProjectChangeList> 
{


	public static BaseOnLoadProjectChangeList newInstance(){
		return new BaseOnLoadProjectChangeList();
	}

	@Override
	public BaseOnLoadProjectChangeList make(){
		BaseOnLoadProjectChangeList b = new BaseOnLoadProjectChangeList();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "id,名称";
	...
	public void cloneCopy(BaseOnLoadProjectChangeList __bean){
	...
	@Override
	public int compareTo(BaseOnLoadProjectChangeList o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseOnLoadProjectChangeList o = (BaseOnLoadProjectChangeList)obj;
