...
public class BaseOnLoadProjectStageSettlement extends GenericBase implements BaseFactory<BaseOnLoadProjectStageSettlement>, Comparable<BaseOnLoadProjectStageSettlement> 
{


	public static BaseOnLoadProjectStageSettlement newInstance(){
		return new BaseOnLoadProjectStageSettlement();
	}

	@Override
	public BaseOnLoadProjectStageSettlement make(){
		BaseOnLoadProjectStageSettlement b = new BaseOnLoadProjectStageSettlement();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "项目阶段代码,项目代码,项目阶段,占比(%),项目积分,阶段名称,,,,,结算原因,项目阶段模板id （project_templates）,//状态值  1待审批    2同意  3不同意";
	...
	public void setAttachmentNum( java.lang.Integer value ) {
		this.__attachment_num = value;
	}

	public java.lang.Integer getSettlementNum() {
		return this.__settlement_num;
	}

	public void setSettlementNum( java.lang.Integer value ) {
	...
	public void cloneCopy(BaseOnLoadProjectStageSettlement __bean){
	...
	@Override
	public int compareTo(BaseOnLoadProjectStageSettlement o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseOnLoadProjectStageSettlement o = (BaseOnLoadProjectStageSettlement)obj;
	...
	public void setDataFromMap(Map<String, Object> values){
		...
		if((val = values.get("attachmentNum")) != null) setAttachmentNum(__getInt(val)); 
		if((val = values.get("settlementNum")) != null) setSettlementNum(__getInt(val)); 
	...
	protected java.lang.Integer  __attachment_num ;
	protected java.lang.Integer  __settlement_num ;
