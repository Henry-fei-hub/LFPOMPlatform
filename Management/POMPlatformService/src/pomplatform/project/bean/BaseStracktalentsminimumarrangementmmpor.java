...
public class BaseStracktalentsminimumarrangementmmpor extends GenericBase implements BaseFactory<BaseStracktalentsminimumarrangementmmpor>, Comparable<BaseStracktalentsminimumarrangementmmpor> 
{


	public static BaseStracktalentsminimumarrangementmmpor newInstance(){
		return new BaseStracktalentsminimumarrangementmmpor();
	}

	@Override
	public BaseStracktalentsminimumarrangementmmpor make(){
		BaseStracktalentsminimumarrangementmmpor b = new BaseStracktalentsminimumarrangementmmpor();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,业务部门,项目类别,最大金额,最小金额,高级设计师,中级设计师,初级设计师,操作人,操作时间,备注";
	...
	public void cloneCopy(BaseStracktalentsminimumarrangementmmpor __bean){
	...
	@Override
	public int compareTo(BaseStracktalentsminimumarrangementmmpor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseStracktalentsminimumarrangementmmpor o = (BaseStracktalentsminimumarrangementmmpor)obj;
