...
public class BaseProjectOfProjectManager extends GenericBase implements BaseFactory<BaseProjectOfProjectManager>, Comparable<BaseProjectOfProjectManager> 
{


	public static BaseProjectOfProjectManager newInstance(){
		return new BaseProjectOfProjectManager();
	}

	@Override
	public BaseProjectOfProjectManager make(){
		BaseProjectOfProjectManager b = new BaseProjectOfProjectManager();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "项目编码,项目积分,确认积分";
	...
	public void cloneCopy(BaseProjectOfProjectManager __bean){
	...
	@Override
	public int compareTo(BaseProjectOfProjectManager o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseProjectOfProjectManager o = (BaseProjectOfProjectManager)obj;
