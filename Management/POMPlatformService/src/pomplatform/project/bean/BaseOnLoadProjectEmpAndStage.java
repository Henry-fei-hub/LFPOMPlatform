...
public class BaseOnLoadProjectEmpAndStage extends GenericBase implements BaseFactory<BaseOnLoadProjectEmpAndStage>, Comparable<BaseOnLoadProjectEmpAndStage> 
{


	public static BaseOnLoadProjectEmpAndStage newInstance(){
		return new BaseOnLoadProjectEmpAndStage();
	}

	@Override
	public BaseOnLoadProjectEmpAndStage make(){
		BaseOnLoadProjectEmpAndStage b = new BaseOnLoadProjectEmpAndStage();
		return b;
	}
	...
	public void cloneCopy(BaseOnLoadProjectEmpAndStage __bean){
	...
	@Override
	public int compareTo(BaseOnLoadProjectEmpAndStage o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseOnLoadProjectEmpAndStage o = (BaseOnLoadProjectEmpAndStage)obj;
