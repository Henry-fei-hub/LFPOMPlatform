...
public class BaseSprojectpbpor extends GenericBase implements BaseFactory<BaseSprojectpbpor>, Comparable<BaseSprojectpbpor> 
{


	public static BaseSprojectpbpor newInstance(){
		return new BaseSprojectpbpor();
	}

	@Override
	public BaseSprojectpbpor make(){
		BaseSprojectpbpor b = new BaseSprojectpbpor();
		return b;
	}
	...
	public void cloneCopy(BaseSprojectpbpor __bean){
	...
	@Override
	public int compareTo(BaseSprojectpbpor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSprojectpbpor o = (BaseSprojectpbpor)obj;
