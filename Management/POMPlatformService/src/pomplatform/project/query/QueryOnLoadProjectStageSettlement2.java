...
public class QueryOnLoadProjectStageSettlement2 extends AbstractQuery<BaseOnLoadProjectStageSettlement2, ConditionOnLoadProjectStageSettlement2>
{

	private static final Logger __logger = Logger.getLogger(QueryOnLoadProjectStageSettlement2.class);

	public QueryOnLoadProjectStageSettlement2() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseOnLoadProjectStageSettlement2> executeQuery( KeyValuePair[] replacements, ConditionOnLoadProjectStageSettlement2 condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseOnLoadProjectStageSettlement2 generateBase(Object[] __data) throws java.sql.SQLException {
		BaseOnLoadProjectStageSettlement2 __base = new BaseOnLoadProjectStageSettlement2();
		int count = 0;
		Object val;
		...
		if((val = __data[count++]) != null) __base.setAttachmentNum(GenericBase.__getLong(val));
		if((val = __data[count++]) != null) __base.setSettlementNum(GenericBase.__getLong(val));
	...
	private final static String[] fieldNames = { "project_id", "stage_id", "project_id", "check_employee_id"};
}
