 ...
 * @author lxf
 */
public class ProjectIntegralLock implements GenericProcessor {
    ...
    public String execute(String creteria, HttpServletRequest request) throws Exception {
        ...
        for(int i = 0;i<months;i++){
        	...
        	plateReportRecordDao.setIsLock(Boolean.TRUE);
        	...
        	projectReportRecordDao.setIsLock(Boolean.TRUE);
        	...
        	employeeReportRecordDao.setIsLock(Boolean.TRUE);
