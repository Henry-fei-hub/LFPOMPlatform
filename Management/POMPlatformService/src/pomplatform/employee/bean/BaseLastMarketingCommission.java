...
public class BaseLastMarketingCommission extends GenericBase implements BaseFactory<BaseLastMarketingCommission>, Comparable<BaseLastMarketingCommission> 
{


	public static BaseLastMarketingCommission newInstance(){
		return new BaseLastMarketingCommission();
	}

	@Override
	public BaseLastMarketingCommission make(){
		BaseLastMarketingCommission b = new BaseLastMarketingCommission();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "营销提成主表,合同编码,订单编码,提成的时间,提成的系数,累计提成,当天提成,归属部门,结算标识,项目的真实进度,相对进度,总的营收,当天营收";
	...
	public void cloneCopy(BaseLastMarketingCommission __bean){
	...
	@Override
	public int compareTo(BaseLastMarketingCommission o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseLastMarketingCommission o = (BaseLastMarketingCommission)obj;
