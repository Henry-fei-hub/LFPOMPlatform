...
public class BaseSelectEmployee extends GenericBase implements BaseFactory<BaseSelectEmployee>, Comparable<BaseSelectEmployee> 
{


	public static BaseSelectEmployee newInstance(){
		return new BaseSelectEmployee();
	}

	@Override
	public BaseSelectEmployee make(){
		BaseSelectEmployee b = new BaseSelectEmployee();
		return b;
	}
	...
	public void cloneCopy(BaseSelectEmployee __bean){
	...
	@Override
	public int compareTo(BaseSelectEmployee o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSelectEmployee o = (BaseSelectEmployee)obj;
