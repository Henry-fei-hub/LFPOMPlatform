...
import pomplatform.employee.bean.BaseSelectEmployee;
import pomplatform.employee.bean.ConditionSelectEmployee;

public class QuerySelectEmployee extends AbstractQuery<BaseSelectEmployee, ConditionSelectEmployee>
{

	private static final Logger __logger = Logger.getLogger(QuerySelectEmployee.class);

	public QuerySelectEmployee() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseSelectEmployee> executeQuery( KeyValuePair[] replacements, ConditionSelectEmployee condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseSelectEmployee generateBase(Object[] __data) throws java.sql.SQLException {
		BaseSelectEmployee __base = new BaseSelectEmployee();
		int count = 0;
		Object val;
	...
	private final static String[] fieldNames = { "status", "locked", "department_id", "role_id", "plate_id", "duty_id", "company_id", "employee_no", "employee_name", "employee_id"};
}
