...
public class BaseCapitalprojectSearch extends GenericBase implements BaseFactory<BaseCapitalprojectSearch>, Comparable<BaseCapitalprojectSearch> 
{


	public static BaseCapitalprojectSearch newInstance(){
		return new BaseCapitalprojectSearch();
	}

	@Override
	public BaseCapitalprojectSearch make(){
		BaseCapitalprojectSearch b = new BaseCapitalprojectSearch();
		return b;
	}
	...
	public void cloneCopy(BaseCapitalprojectSearch __bean){
	...
	@Override
	public int compareTo(BaseCapitalprojectSearch o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseCapitalprojectSearch o = (BaseCapitalprojectSearch)obj;
