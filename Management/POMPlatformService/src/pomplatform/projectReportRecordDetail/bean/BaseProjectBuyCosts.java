...
public class BaseProjectBuyCosts extends GenericBase implements BaseFactory<BaseProjectBuyCosts>, Comparable<BaseProjectBuyCosts> 
{


	public static BaseProjectBuyCosts newInstance(){
		return new BaseProjectBuyCosts();
	}

	@Override
	public BaseProjectBuyCosts make(){
		BaseProjectBuyCosts b = new BaseProjectBuyCosts();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "项目编码,合同编号,项目名称,客户名称,业务部门,归属部门,设计阶段,项目编号,主订单名称,项目计划开始日期,项目计划结束日期,项目开始日期,项目结束日期,项目状态,公区面积,后勤面积,核算比例,订单额度,预留积分,订单成本,订单剩余额度,项目描述,项目等级,专业负责人,部门经理,事业部负责人";
	...
	public void cloneCopy(BaseProjectBuyCosts __bean){
	...
	@Override
	public int compareTo(BaseProjectBuyCosts o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseProjectBuyCosts o = (BaseProjectBuyCosts)obj;
