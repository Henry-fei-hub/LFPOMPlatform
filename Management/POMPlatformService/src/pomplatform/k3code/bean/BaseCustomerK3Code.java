...
public class BaseCustomerK3Code extends GenericBase implements BaseFactory<BaseCustomerK3Code>, Comparable<BaseCustomerK3Code> 
{


	public static BaseCustomerK3Code newInstance(){
		return new BaseCustomerK3Code();
	}

	@Override
	public BaseCustomerK3Code make(){
		BaseCustomerK3Code b = new BaseCustomerK3Code();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码, 8收款单位,客户,K3代码,K3名称,部门类型";
	...
	public void cloneCopy(BaseCustomerK3Code __bean){
	...
	@Override
	public int compareTo(BaseCustomerK3Code o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseCustomerK3Code o = (BaseCustomerK3Code)obj;
