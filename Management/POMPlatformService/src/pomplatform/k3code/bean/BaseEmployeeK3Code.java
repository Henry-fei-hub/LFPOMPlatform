...
public class BaseEmployeeK3Code extends GenericBase implements BaseFactory<BaseEmployeeK3Code>, Comparable<BaseEmployeeK3Code> 
{


	public static BaseEmployeeK3Code newInstance(){
		return new BaseEmployeeK3Code();
	}

	@Override
	public BaseEmployeeK3Code make(){
		BaseEmployeeK3Code b = new BaseEmployeeK3Code();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "工号,主键编码, 7收款方类型,姓名,K3代码,K3名称";
	...
	public void cloneCopy(BaseEmployeeK3Code __bean){
	...
	@Override
	public int compareTo(BaseEmployeeK3Code o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseEmployeeK3Code o = (BaseEmployeeK3Code)obj;
