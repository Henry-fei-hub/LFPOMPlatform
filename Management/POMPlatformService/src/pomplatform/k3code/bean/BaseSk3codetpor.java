...
public class BaseSk3codetpor extends GenericBase implements BaseFactory<BaseSk3codetpor>, Comparable<BaseSk3codetpor> 
{


	public static BaseSk3codetpor newInstance(){
		return new BaseSk3codetpor();
	}

	@Override
	public BaseSk3codetpor make(){
		BaseSk3codetpor b = new BaseSk3codetpor();
		return b;
	}
	...
	public final static java.lang.String CS_PARENT_ID = "department_type" ;

	public final static java.lang.String ALL_CAPTIONS = "主键编码, 7收款方类型,原有业务表的编码,K3编号,K3名称,部门类型";
	...
	public void cloneCopy(BaseSk3codetpor __bean){
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		String strParentId = delicacy.system.executor.SelectValueCache.getSelectValue("contracts_1", String.valueOf(getDepartmentType()));
		sb.append(strParentId == null ? "" : strParentId);
		return sb.toString();
	}

	@Override
	public int compareTo(BaseSk3codetpor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSk3codetpor o = (BaseSk3codetpor)obj;
	...
	public java.lang.String toJSONString() {
		...
		if(getDepartmentType() != null) sb.append(__wrapNumber(count++, "parentId", getDepartmentType()));
		return sb.toString();
	}
	...
	public void setDataFromMap(Map<String, Object> values){
		...
		if((val = values.get("parentId")) != null) setDepartmentType(__getInt(val)); 
	}
