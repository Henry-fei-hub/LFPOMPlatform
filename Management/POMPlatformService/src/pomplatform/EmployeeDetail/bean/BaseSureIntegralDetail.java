...
public class BaseSureIntegralDetail extends GenericBase implements BaseFactory<BaseSureIntegralDetail>, Comparable<BaseSureIntegralDetail> 
{


	public static BaseSureIntegralDetail newInstance(){
		return new BaseSureIntegralDetail();
	}

	@Override
	public BaseSureIntegralDetail make(){
		BaseSureIntegralDetail b = new BaseSureIntegralDetail();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "人员,员工编号,确认积分,项目";
	...
	public void cloneCopy(BaseSureIntegralDetail __bean){
	...
	@Override
	public int compareTo(BaseSureIntegralDetail o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSureIntegralDetail o = (BaseSureIntegralDetail)obj;
