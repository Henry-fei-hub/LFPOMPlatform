...
public class BaseSalaryAdvanceDetail extends GenericBase implements BaseFactory<BaseSalaryAdvanceDetail>, Comparable<BaseSalaryAdvanceDetail> 
{


	public static BaseSalaryAdvanceDetail newInstance(){
		return new BaseSalaryAdvanceDetail();
	}

	@Override
	public BaseSalaryAdvanceDetail make(){
		BaseSalaryAdvanceDetail b = new BaseSalaryAdvanceDetail();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "员工,工号,人工成本补偿积分,业务部门,日期";
	...
	public void cloneCopy(BaseSalaryAdvanceDetail __bean){
	...
	@Override
	public int compareTo(BaseSalaryAdvanceDetail o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSalaryAdvanceDetail o = (BaseSalaryAdvanceDetail)obj;
