...
import pomplatform.specialDeduction.bean.BaseSpecialDeductionRecordsAuditOfWorkflow;
import pomplatform.specialDeduction.bean.ConditionSpecialDeductionRecordsAuditOfWorkflow;

public class QuerySpecialDeductionRecordsAuditOfWorkflow extends AbstractQuery<BaseSpecialDeductionRecordsAuditOfWorkflow, ConditionSpecialDeductionRecordsAuditOfWorkflow>
{

	private static final Logger __logger = Logger.getLogger(QuerySpecialDeductionRecordsAuditOfWorkflow.class);

	public QuerySpecialDeductionRecordsAuditOfWorkflow() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseSpecialDeductionRecordsAuditOfWorkflow> executeQuery( KeyValuePair[] replacements, ConditionSpecialDeductionRecordsAuditOfWorkflow condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseSpecialDeductionRecordsAuditOfWorkflow generateBase(Object[] __data) throws java.sql.SQLException {
		BaseSpecialDeductionRecordsAuditOfWorkflow __base = new BaseSpecialDeductionRecordsAuditOfWorkflow();
		int count = 0;
		Object val;
