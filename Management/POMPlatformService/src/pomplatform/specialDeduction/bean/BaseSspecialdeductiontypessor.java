...
public class BaseSspecialdeductiontypessor extends GenericBase implements BaseFactory<BaseSspecialdeductiontypessor>, Comparable<BaseSspecialdeductiontypessor> 
{


	public static BaseSspecialdeductiontypessor newInstance(){
		return new BaseSspecialdeductiontypessor();
	}

	@Override
	public BaseSspecialdeductiontypessor make(){
		BaseSspecialdeductiontypessor b = new BaseSspecialdeductiontypessor();
		return b;
	}
	...
	public void cloneCopy(BaseSspecialdeductiontypessor __bean){
	...
	@Override
	public int compareTo(BaseSspecialdeductiontypessor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSspecialdeductiontypessor o = (BaseSspecialdeductiontypessor)obj;
