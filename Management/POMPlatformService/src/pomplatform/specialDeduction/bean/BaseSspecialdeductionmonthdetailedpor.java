...
public class BaseSspecialdeductionmonthdetailedpor extends GenericBase implements BaseFactory<BaseSspecialdeductionmonthdetailedpor>, Comparable<BaseSspecialdeductionmonthdetailedpor> 
{


	public static BaseSspecialdeductionmonthdetailedpor newInstance(){
		return new BaseSspecialdeductionmonthdetailedpor();
	}

	@Override
	public BaseSspecialdeductionmonthdetailedpor make(){
		BaseSspecialdeductionmonthdetailedpor b = new BaseSspecialdeductionmonthdetailedpor();
		return b;
	}
	...
	public void cloneCopy(BaseSspecialdeductionmonthdetailedpor __bean){
	...
	@Override
	public int compareTo(BaseSspecialdeductionmonthdetailedpor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSspecialdeductionmonthdetailedpor o = (BaseSspecialdeductionmonthdetailedpor)obj;
