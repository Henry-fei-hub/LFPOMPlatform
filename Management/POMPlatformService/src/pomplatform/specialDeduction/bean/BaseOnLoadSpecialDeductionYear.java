...
public class BaseOnLoadSpecialDeductionYear extends GenericBase implements BaseFactory<BaseOnLoadSpecialDeductionYear>, Comparable<BaseOnLoadSpecialDeductionYear> 
{


	public static BaseOnLoadSpecialDeductionYear newInstance(){
		return new BaseOnLoadSpecialDeductionYear();
	}

	@Override
	public BaseOnLoadSpecialDeductionYear make(){
		BaseOnLoadSpecialDeductionYear b = new BaseOnLoadSpecialDeductionYear();
		return b;
	}
	...
	public void cloneCopy(BaseOnLoadSpecialDeductionYear __bean){
	...
	@Override
	public int compareTo(BaseOnLoadSpecialDeductionYear o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseOnLoadSpecialDeductionYear o = (BaseOnLoadSpecialDeductionYear)obj;
