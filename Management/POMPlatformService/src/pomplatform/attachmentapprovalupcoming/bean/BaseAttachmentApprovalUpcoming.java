package pomplatform.attachmentapprovalupcoming.bean;
...
public class BaseAttachmentApprovalUpcoming extends GenericBase implements BaseFactory<BaseAttachmentApprovalUpcoming>, Comparable<BaseAttachmentApprovalUpcoming> 
{


	public static BaseAttachmentApprovalUpcoming newInstance(){
		return new BaseAttachmentApprovalUpcoming();
	}

	@Override
	public BaseAttachmentApprovalUpcoming make(){
		BaseAttachmentApprovalUpcoming b = new BaseAttachmentApprovalUpcoming();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,业务编码,业务名称,活动编码,流程编码,流程实列编码,附加节点，说明节点是预定义的节点还是动态加的节点， 0 - 正常定义的节点， 1 - 申请人或者审批人加的处理人或者审批人,当前流程实例节点的内部编码,下一个流程节点的编码,如果是知会节点，所依附的主节点,流程实例节点创建时间,流程实例节点开始处于活动时间,操作时间,提交意见,状态,节点类型 0 - 开始 1 - 结束 2 - 审批 3 - 处理 4 - 知会,返回数据集,文件路径,主键id,预算管理id,附件编码,附件名称,上传人员,上传人员归属部门,上传时间,附件备注,合同金额,合同已付款金额,剩余合同金额,供应商,项目id,发票编码,预算类别  budget_detail_type,是否审批 0.未审批 1.审批进行中,2.已审批";
	...
	public void cloneCopy(BaseAttachmentApprovalUpcoming __bean){
	...
	@Override
	public int compareTo(BaseAttachmentApprovalUpcoming o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseAttachmentApprovalUpcoming o = (BaseAttachmentApprovalUpcoming)obj;
