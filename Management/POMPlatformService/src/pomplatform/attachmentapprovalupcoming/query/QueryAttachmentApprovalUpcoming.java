package pomplatform.attachmentapprovalupcoming.query;
...
public class QueryAttachmentApprovalUpcoming extends AbstractQuery<BaseAttachmentApprovalUpcoming, ConditionAttachmentApprovalUpcoming>
{

	private static final Logger __logger = Logger.getLogger(QueryAttachmentApprovalUpcoming.class);

	public QueryAttachmentApprovalUpcoming() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseAttachmentApprovalUpcoming> executeQuery( KeyValuePair[] replacements, ConditionAttachmentApprovalUpcoming condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseAttachmentApprovalUpcoming generateBase(Object[] __data) throws java.sql.SQLException {
		BaseAttachmentApprovalUpcoming __base = new BaseAttachmentApprovalUpcoming();
		int count = 0;
		Object val;
