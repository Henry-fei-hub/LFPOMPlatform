...
public class ReportCapitalTotalHandler implements GenericQuery,  GenericDownloadProcessor {

	private static final Logger __logger = Logger.getLogger(ReportCapitalTotalHandler.class);

	public static BaseCollection<BaseReportCapitalTotal> executeQueryReportCapitalTotal(ConditionReportCapitalTotal c, KeyValuePair[] replacements ) throws Exception {
	...
	public String find(String creteria) throws Exception {
		...
		BaseCollection<BaseReportCapitalTotal> result = executeQueryReportCapitalTotal(c, c.getKeyValues());
