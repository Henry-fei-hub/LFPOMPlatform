...
public class ReportSureIntegralTotalHandler implements GenericQuery,  GenericDownloadProcessor {

	private static final Logger __logger = Logger.getLogger(ReportSureIntegralTotalHandler.class);

	public static BaseCollection<BaseReportSureIntegralTotal> executeQueryReportSureIntegralTotal(ConditionReportSureIntegralTotal c, KeyValuePair[] replacements ) throws Exception {
	...
	public String find(String creteria) throws Exception {
		...
		BaseCollection<BaseReportSureIntegralTotal> result = executeQueryReportSureIntegralTotal(c, c.getKeyValues());
