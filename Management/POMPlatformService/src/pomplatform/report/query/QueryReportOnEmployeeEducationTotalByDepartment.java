...
public class QueryReportOnEmployeeEducationTotalByDepartment extends AbstractQuery<BaseReportOnEmployeeEducationTotalByDepartment, ConditionReportOnEmployeeEducationTotalByDepartment>
{

	private static final Logger __logger = Logger.getLogger(QueryReportOnEmployeeEducationTotalByDepartment.class);

	public QueryReportOnEmployeeEducationTotalByDepartment() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseReportOnEmployeeEducationTotalByDepartment> executeQuery( KeyValuePair[] replacements, ConditionReportOnEmployeeEducationTotalByDepartment condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseReportOnEmployeeEducationTotalByDepartment generateBase(Object[] __data) throws java.sql.SQLException {
		BaseReportOnEmployeeEducationTotalByDepartment __base = new BaseReportOnEmployeeEducationTotalByDepartment();
		int count = 0;
		Object val;
	...
	private final static String __SQLText = "SELECT AA.department_id, AA.YEAR, SUM ( CASE WHEN AA.MONTH = 1 THEN AA.zero_num ELSE 0 END ) AS zero_num_1, SUM ( CASE WHEN AA.MONTH = 1 THEN AA.one_num ELSE 0 END ) AS one_num_1, SUM ( CASE WHEN AA.MONTH = 1 THEN AA.two_num ELSE 0 END ) AS two_num_1, SUM ( CASE WHEN AA.MONTH = 1 THEN AA.three_num ELSE 0 END ) AS three_num_1, SUM ( CASE WHEN AA.MONTH = 1 THEN AA.four_num ELSE 0 END ) AS four_num_1, SUM ( CASE WHEN AA.MONTH = 1 THEN AA.five_num ELSE 0 END ) AS five_num_1, SUM ( CASE WHEN AA.MONTH = 1 THEN AA.six_num ELSE 0 END ) AS six_num_1, SUM ( CASE WHEN AA.MONTH = 1 THEN AA.total_num ELSE 0 END ) AS total_num_1, SUM ( CASE WHEN AA.MONTH = 2 THEN AA.zero_num ELSE 0 END ) AS zero_num_2, SUM ( CASE WHEN AA.MONTH = 2 THEN AA.one_num ELSE 0 END ) AS one_num_2, SUM ( CASE WHEN AA.MONTH = 2 THEN AA.two_num ELSE 0 END ) AS two_num_2, SUM ( CASE WHEN AA.MONTH = 2 THEN AA.three_num ELSE 0 END ) AS three_num_2, SUM ( CASE WHEN AA.MONTH = 2 THEN AA.four_num ELSE 0 END ) AS four_num_2, SUM ( CASE WHEN AA.MONTH = 2 THEN AA.five_num ELSE 0 END ) AS five_num_2, SUM ( CASE WHEN AA.MONTH = 2 THEN AA.six_num ELSE 0 END ) AS six_num_2, SUM ( CASE WHEN AA.MONTH = 2 THEN AA.total_num ELSE 0 END ) AS total_num_2, SUM ( CASE WHEN AA.MONTH = 3 THEN AA.zero_num ELSE 0 END ) AS zero_num_3, SUM ( CASE WHEN AA.MONTH = 3 THEN AA.one_num ELSE 0 END ) AS one_num_3, SUM ( CASE WHEN AA.MONTH = 3 THEN AA.two_num ELSE 0 END ) AS two_num_3, SUM ( CASE WHEN AA.MONTH = 3 THEN AA.three_num ELSE 0 END ) AS three_num_3, SUM ( CASE WHEN AA.MONTH = 3 THEN AA.four_num ELSE 0 END ) AS four_num_3, SUM ( CASE WHEN AA.MONTH = 3 THEN AA.five_num ELSE 0 END ) AS five_num_3, SUM ( CASE WHEN AA.MONTH = 3 THEN AA.six_num ELSE 0 END ) AS six_num_3, SUM ( CASE WHEN AA.MONTH = 3 THEN AA.total_num ELSE 0 END ) AS total_num_3, SUM ( CASE WHEN AA.MONTH = 4 THEN AA.zero_num ELSE 0 END ) AS zero_num_4, SUM ( CASE WHEN AA.MONTH = 4 THEN AA.one_num ELSE 0 END ) AS one_num_4, SUM ( CASE WHEN AA.MONTH = 4 THEN AA.two_num ELSE 0 END ) AS two_num_4, SUM ( CASE WHEN AA.MONTH = 4 THEN AA.three_num ELSE 0 END ) AS three_num_4, SUM ( CASE WHEN AA.MONTH = 4 THEN AA.four_num ELSE 0 END ) AS four_num_4, SUM ( CASE WHEN AA.MONTH = 4 THEN AA.five_num ELSE 0 END ) AS five_num_4, SUM ( CASE WHEN AA.MONTH = 4 THEN AA.six_num ELSE 0 END ) AS six_num_4, SUM ( CASE WHEN AA.MONTH = 4 THEN AA.total_num ELSE 0 END ) AS total_num_4, SUM ( CASE WHEN AA.MONTH = 5 THEN AA.zero_num ELSE 0 END ) AS zero_num_5, SUM ( CASE WHEN AA.MONTH = 5 THEN AA.one_num ELSE 0 END ) AS one_num_5, SUM ( CASE WHEN AA.MONTH = 5 THEN AA.two_num ELSE 0 END ) AS two_num_5, SUM ( CASE WHEN AA.MONTH = 5 THEN AA.three_num ELSE 0 END ) AS three_num_5, SUM ( CASE WHEN AA.MONTH = 5 THEN AA.four_num ELSE 0 END ) AS four_num_5, SUM ( CASE WHEN AA.MONTH = 5 THEN AA.five_num ELSE 0 END ) AS five_num_5, SUM ( CASE WHEN AA.MONTH = 5 THEN AA.six_num ELSE 0 END ) AS six_num_5, SUM ( CASE WHEN AA.MONTH = 5 THEN AA.total_num ELSE 0 END ) AS total_num_5, SUM ( CASE WHEN AA.MONTH = 6 THEN AA.zero_num ELSE 0 END ) AS zero_num_6, SUM ( CASE WHEN AA.MONTH = 6 THEN AA.one_num ELSE 0 END ) AS one_num_6, SUM ( CASE WHEN AA.MONTH = 6 THEN AA.two_num ELSE 0 END ) AS two_num_6, SUM ( CASE WHEN AA.MONTH = 6 THEN AA.three_num ELSE 0 END ) AS three_num_6, SUM ( CASE WHEN AA.MONTH = 6 THEN AA.four_num ELSE 0 END ) AS four_num_6, SUM ( CASE WHEN AA.MONTH = 6 THEN AA.five_num ELSE 0 END ) AS five_num_6, SUM ( CASE WHEN AA.MONTH = 6 THEN AA.six_num ELSE 0 END ) AS six_num_6, SUM ( CASE WHEN AA.MONTH = 6 THEN AA.total_num ELSE 0 END ) AS total_num_6, SUM ( CASE WHEN AA.MONTH = 7 THEN AA.zero_num ELSE 0 END ) AS zero_num_7, SUM ( CASE WHEN AA.MONTH = 7 THEN AA.one_num ELSE 0 END ) AS one_num_7, SUM ( CASE WHEN AA.MONTH = 7 THEN AA.two_num ELSE 0 END ) AS two_num_7, SUM ( CASE WHEN AA.MONTH = 7 THEN AA.three_num ELSE 0 END ) AS three_num_7, SUM ( CASE WHEN AA.MONTH = 7 THEN AA.four_num ELSE 0 END ) AS four_num_7, SUM ( CASE WHEN AA.MONTH = 7 THEN AA.five_num ELSE 0 END ) AS five_num_7, SUM ( CASE WHEN AA.MONTH = 7 THEN AA.six_num ELSE 0 END ) AS six_num_7, SUM ( CASE WHEN AA.MONTH = 7 THEN AA.total_num ELSE 0 END ) AS total_num_7, SUM ( CASE WHEN AA.MONTH = 8 THEN AA.zero_num ELSE 0 END ) AS zero_num_8, SUM ( CASE WHEN AA.MONTH = 8 THEN AA.one_num ELSE 0 END ) AS one_num_8, SUM ( CASE WHEN AA.MONTH = 8 THEN AA.two_num ELSE 0 END ) AS two_num_8, SUM ( CASE WHEN AA.MONTH = 8 THEN AA.three_num ELSE 0 END ) AS three_num_8, SUM ( CASE WHEN AA.MONTH = 8 THEN AA.four_num ELSE 0 END ) AS four_num_8, SUM ( CASE WHEN AA.MONTH = 8 THEN AA.five_num ELSE 0 END ) AS five_num_8, SUM ( CASE WHEN AA.MONTH = 8 THEN AA.six_num ELSE 0 END ) AS six_num_8, SUM ( CASE WHEN AA.MONTH = 8 THEN AA.total_num ELSE 0 END ) AS total_num_8, SUM ( CASE WHEN AA.MONTH = 9 THEN AA.zero_num ELSE 0 END ) AS zero_num_9, SUM ( CASE WHEN AA.MONTH = 9 THEN AA.one_num ELSE 0 END ) AS one_num_9, SUM ( CASE WHEN AA.MONTH = 9 THEN AA.two_num ELSE 0 END ) AS two_num_9, SUM ( CASE WHEN AA.MONTH = 9 THEN AA.three_num ELSE 0 END ) AS three_num_9, SUM ( CASE WHEN AA.MONTH = 9 THEN AA.four_num ELSE 0 END ) AS four_num_9, SUM ( CASE WHEN AA.MONTH = 9 THEN AA.five_num ELSE 0 END ) AS five_num_9, SUM ( CASE WHEN AA.MONTH = 9 THEN AA.six_num ELSE 0 END ) AS six_num_9, SUM ( CASE WHEN AA.MONTH = 9 THEN AA.total_num ELSE 0 END ) AS total_num_9, SUM ( CASE WHEN AA.MONTH = 10 THEN AA.zero_num ELSE 0 END ) AS zero_num_10, SUM ( CASE WHEN AA.MONTH = 10 THEN AA.one_num ELSE 0 END ) AS one_num_10, SUM ( CASE WHEN AA.MONTH = 10 THEN AA.two_num ELSE 0 END ) AS two_num_10, SUM ( CASE WHEN AA.MONTH = 10 THEN AA.three_num ELSE 0 END ) AS three_num_10, SUM ( CASE WHEN AA.MONTH = 10 THEN AA.four_num ELSE 0 END ) AS four_num_10, SUM ( CASE WHEN AA.MONTH = 10 THEN AA.five_num ELSE 0 END ) AS five_num_10, SUM ( CASE WHEN AA.MONTH = 10 THEN AA.six_num ELSE 0 END ) AS six_num_10, SUM ( CASE WHEN AA.MONTH = 10 THEN AA.total_num ELSE 0 END ) AS total_num_10, SUM ( CASE WHEN AA.MONTH = 11 THEN AA.zero_num ELSE 0 END ) AS zero_num_11, SUM ( CASE WHEN AA.MONTH = 11 THEN AA.one_num ELSE 0 END ) AS one_num_11, SUM ( CASE WHEN AA.MONTH = 11 THEN AA.two_num ELSE 0 END ) AS two_num_11, SUM ( CASE WHEN AA.MONTH = 11 THEN AA.three_num ELSE 0 END ) AS three_num_11, SUM ( CASE WHEN AA.MONTH = 11 THEN AA.four_num ELSE 0 END ) AS four_num_11, SUM ( CASE WHEN AA.MONTH = 11 THEN AA.five_num ELSE 0 END ) AS five_num_11, SUM ( CASE WHEN AA.MONTH = 11 THEN AA.six_num ELSE 0 END ) AS six_num_11, SUM ( CASE WHEN AA.MONTH = 11 THEN AA.total_num ELSE 0 END ) AS total_num_11, SUM ( CASE WHEN AA.MONTH = 12 THEN AA.zero_num ELSE 0 END ) AS zero_num_12, SUM ( CASE WHEN AA.MONTH = 12 THEN AA.one_num ELSE 0 END ) AS one_num_12, SUM ( CASE WHEN AA.MONTH = 12 THEN AA.two_num ELSE 0 END ) AS two_num_12, SUM ( CASE WHEN AA.MONTH = 12 THEN AA.three_num ELSE 0 END ) AS three_num_12, SUM ( CASE WHEN AA.MONTH = 12 THEN AA.four_num ELSE 0 END ) AS four_num_12, SUM ( CASE WHEN AA.MONTH = 12 THEN AA.five_num ELSE 0 END ) AS five_num_12, SUM ( CASE WHEN AA.MONTH = 12 THEN AA.six_num ELSE 0 END ) AS six_num_12, SUM ( CASE WHEN AA.MONTH = 12 THEN AA.total_num ELSE 0 END ) AS total_num_12 FROM ( SELECT B.department_id, A.YEAR, A.MONTH, SUM ( CASE WHEN C.education = '0' OR C.education LIKE'%博士%' THEN 1 ELSE 0 END ) AS zero_num, SUM ( CASE WHEN C.education = '1' OR C.education LIKE'%硕士%' THEN 1 ELSE 0 END ) AS one_num, SUM ( CASE WHEN C.education = '2' OR C.education LIKE'%本科%' THEN 1 ELSE 0 END ) AS two_num, SUM ( CASE WHEN C.education = '3' OR C.education LIKE'%大专%' THEN 1 ELSE 0 END ) AS three_num, SUM ( CASE WHEN C.education = '4' OR C.education LIKE'%中专%' THEN 1 ELSE 0 END ) AS four_num, SUM ( CASE WHEN C.education = '5' OR C.education LIKE'%高中%' THEN 1 ELSE 0 END ) AS five_num, SUM ( CASE WHEN C.education IS NULL OR C.education = '6' OR C.education LIKE'%其他%' THEN 1 ELSE 0 END ) AS six_num, SUM ( 1 ) AS total_num FROM employee_day_plate_records A LEFT JOIN plate_departments B ON B.department_id = A.department_id LEFT JOIN employees C ON A.employee_id = C.employee_id WHERE YEAR =? AND B.plate_id >= 0 AND B.plate_id =? AND record_date = date_trunc( 'day', date_trunc( 'month', record_date + INTERVAL '1 month' ) + INTERVAL '-1 day' ) AND A.onboard_status IN ( 1, 2 ) AND A.record_date <= ( CASE WHEN C.resignation_date IS NULL THEN now() ELSE C.resignation_date END ) GROUP BY B.department_id, A.YEAR, A.MONTH ORDER BY B.department_id, A.YEAR, A.MONTH ) AS AA GROUP BY AA.department_id, AA.YEAR ORDER BY AA.department_id, AA.YEAR" ;
	private final static String RESULTSETFIELDLIST = "department_id,year,zero_num_1,one_num_1,two_num_1,three_num_1,four_num_1,five_num_1,six_num_1,total_num_1,zero_num_2,one_num_2,two_num_2,three_num_2,four_num_2,five_num_2,six_num_2,total_num_2,zero_num_3,one_num_3,two_num_3,three_num_3,four_num_3,five_num_3,six_num_3,total_num_3,zero_num_4,one_num_4,two_num_4,three_num_4,four_num_4,five_num_4,six_num_4,total_num_4,zero_num_5,one_num_5,two_num_5,three_num_5,four_num_5,five_num_5,six_num_5,total_num_5,zero_num_6,one_num_6,two_num_6,three_num_6,four_num_6,five_num_6,six_num_6,total_num_6,zero_num_7,one_num_7,two_num_7,three_num_7,four_num_7,five_num_7,six_num_7,total_num_7,zero_num_8,one_num_8,two_num_8,three_num_8,four_num_8,five_num_8,six_num_8,total_num_8,zero_num_9,one_num_9,two_num_9,three_num_9,four_num_9,five_num_9,six_num_9,total_num_9,zero_num_10,one_num_10,two_num_10,three_num_10,four_num_10,five_num_10,six_num_10,total_num_10,zero_num_11,one_num_11,two_num_11,three_num_11,four_num_11,five_num_11,six_num_11,total_num_11,zero_num_12,one_num_12,two_num_12,three_num_12,four_num_12,five_num_12,six_num_12,total_num_12";
