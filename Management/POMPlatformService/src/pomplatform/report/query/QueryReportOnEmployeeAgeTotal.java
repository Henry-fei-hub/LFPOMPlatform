...
import pomplatform.report.bean.BaseReportOnEmployeeAgeTotal;
import pomplatform.report.bean.ConditionReportOnEmployeeAgeTotal;

public class QueryReportOnEmployeeAgeTotal extends AbstractQuery<BaseReportOnEmployeeAgeTotal, ConditionReportOnEmployeeAgeTotal>
{

	private static final Logger __logger = Logger.getLogger(QueryReportOnEmployeeAgeTotal.class);

	public QueryReportOnEmployeeAgeTotal() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseReportOnEmployeeAgeTotal> executeQuery( KeyValuePair[] replacements, ConditionReportOnEmployeeAgeTotal condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseReportOnEmployeeAgeTotal generateBase(Object[] __data) throws java.sql.SQLException {
		BaseReportOnEmployeeAgeTotal __base = new BaseReportOnEmployeeAgeTotal();
		int count = 0;
		Object val;
