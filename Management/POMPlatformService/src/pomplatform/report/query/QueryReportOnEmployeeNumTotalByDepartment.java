...
public class QueryReportOnEmployeeNumTotalByDepartment extends AbstractQuery<BaseReportOnEmployeeNumTotalByDepartment, ConditionReportOnEmployeeNumTotalByDepartment>
{

	private static final Logger __logger = Logger.getLogger(QueryReportOnEmployeeNumTotalByDepartment.class);

	public QueryReportOnEmployeeNumTotalByDepartment() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseReportOnEmployeeNumTotalByDepartment> executeQuery( KeyValuePair[] replacements, ConditionReportOnEmployeeNumTotalByDepartment condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseReportOnEmployeeNumTotalByDepartment generateBase(Object[] __data) throws java.sql.SQLException {
		BaseReportOnEmployeeNumTotalByDepartment __base = new BaseReportOnEmployeeNumTotalByDepartment();
		int count = 0;
		Object val;
