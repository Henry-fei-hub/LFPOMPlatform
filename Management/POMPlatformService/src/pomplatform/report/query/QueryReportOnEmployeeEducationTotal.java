...
public class QueryReportOnEmployeeEducationTotal extends AbstractQuery<BaseReportOnEmployeeEducationTotal, ConditionReportOnEmployeeEducationTotal>
{

	private static final Logger __logger = Logger.getLogger(QueryReportOnEmployeeEducationTotal.class);

	public QueryReportOnEmployeeEducationTotal() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseReportOnEmployeeEducationTotal> executeQuery( KeyValuePair[] replacements, ConditionReportOnEmployeeEducationTotal condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseReportOnEmployeeEducationTotal generateBase(Object[] __data) throws java.sql.SQLException {
		BaseReportOnEmployeeEducationTotal __base = new BaseReportOnEmployeeEducationTotal();
		int count = 0;
		Object val;
