...
import pomplatform.report.bean.BaseReportOnEmployeeTurnoverTotalByDepartment;
import pomplatform.report.bean.ConditionReportOnEmployeeTurnoverTotalByDepartment;

public class QueryReportOnEmployeeTurnoverTotalByDepartment extends AbstractQuery<BaseReportOnEmployeeTurnoverTotalByDepartment, ConditionReportOnEmployeeTurnoverTotalByDepartment>
{

	private static final Logger __logger = Logger.getLogger(QueryReportOnEmployeeTurnoverTotalByDepartment.class);

	public QueryReportOnEmployeeTurnoverTotalByDepartment() throws java.sql.SQLException 
	{
		setParameterNumber(8);
		setConnection(ThreadConnection.getConnection());
		setOrderByFields("AAA.department_id");
	}

	@Override
	public BaseCollection<BaseReportOnEmployeeTurnoverTotalByDepartment> executeQuery( KeyValuePair[] replacements, ConditionReportOnEmployeeTurnoverTotalByDepartment condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseReportOnEmployeeTurnoverTotalByDepartment generateBase(Object[] __data) throws java.sql.SQLException {
		BaseReportOnEmployeeTurnoverTotalByDepartment __base = new BaseReportOnEmployeeTurnoverTotalByDepartment();
		int count = 0;
		Object val;
