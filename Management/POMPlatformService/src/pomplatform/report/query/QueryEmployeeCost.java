...
public class QueryEmployeeCost extends AbstractQuery<BaseEmployeeCost, ConditionEmployeeCost>
{

	private static final Logger __logger = Logger.getLogger(QueryEmployeeCost.class);

	public QueryEmployeeCost() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseEmployeeCost> executeQuery( KeyValuePair[] replacements, ConditionEmployeeCost condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseEmployeeCost generateBase(Object[] __data) throws java.sql.SQLException {
		BaseEmployeeCost __base = new BaseEmployeeCost();
		int count = 0;
		Object val;
