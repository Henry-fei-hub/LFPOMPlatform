...
public class QueryReportOnEmployeeSeniorityTotalByDepartment extends AbstractQuery<BaseReportOnEmployeeSeniorityTotalByDepartment, ConditionReportOnEmployeeSeniorityTotalByDepartment>
{

	private static final Logger __logger = Logger.getLogger(QueryReportOnEmployeeSeniorityTotalByDepartment.class);

	public QueryReportOnEmployeeSeniorityTotalByDepartment() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseReportOnEmployeeSeniorityTotalByDepartment> executeQuery( KeyValuePair[] replacements, ConditionReportOnEmployeeSeniorityTotalByDepartment condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseReportOnEmployeeSeniorityTotalByDepartment generateBase(Object[] __data) throws java.sql.SQLException {
		BaseReportOnEmployeeSeniorityTotalByDepartment __base = new BaseReportOnEmployeeSeniorityTotalByDepartment();
		int count = 0;
		Object val;
