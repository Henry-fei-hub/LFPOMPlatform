...
public class BasePerCapitaSalaryAnalysisByDepartment extends GenericBase implements BaseFactory<BasePerCapitaSalaryAnalysisByDepartment>, Comparable<BasePerCapitaSalaryAnalysisByDepartment> 
{


	public static BasePerCapitaSalaryAnalysisByDepartment newInstance(){
		return new BasePerCapitaSalaryAnalysisByDepartment();
	}

	@Override
	public BasePerCapitaSalaryAnalysisByDepartment make(){
		BasePerCapitaSalaryAnalysisByDepartment b = new BasePerCapitaSalaryAnalysisByDepartment();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "归属部门,年份,第一季度薪酬,第一季度奖金,第一季度总收入,第一季度平均人数,第一季度人均薪酬,第二季度薪酬,第二季度奖金,第二季度总收入,第二季度平均人数,第二季度人均薪酬,第三季度薪酬,第三季度奖金,第三季度总收入,第三季度平均人数,第三季度人均薪酬,第四季度薪酬,第四季度奖金,第四季度总收入,第四季度平均人数,第四季度人均薪酬,年度薪酬,年度奖金,年度总收入,年度人数,年度人均薪酬";
	...
	public void cloneCopy(BasePerCapitaSalaryAnalysisByDepartment __bean){
	...
	@Override
	public int compareTo(BasePerCapitaSalaryAnalysisByDepartment o) {
	...
	public boolean equals(Object obj) {
		...
		final BasePerCapitaSalaryAnalysisByDepartment o = (BasePerCapitaSalaryAnalysisByDepartment)obj;
