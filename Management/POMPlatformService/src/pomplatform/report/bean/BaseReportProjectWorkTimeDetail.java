...
public class BaseReportProjectWorkTimeDetail extends GenericBase implements BaseFactory<BaseReportProjectWorkTimeDetail>, Comparable<BaseReportProjectWorkTimeDetail> 
{


	public static BaseReportProjectWorkTimeDetail newInstance(){
		return new BaseReportProjectWorkTimeDetail();
	}

	@Override
	public BaseReportProjectWorkTimeDetail make(){
		BaseReportProjectWorkTimeDetail b = new BaseReportProjectWorkTimeDetail();
		return b;
	}
	...
	public final static String ALL_CAPTIONS = "项目编码,员工编码,员工编号,员工姓名,板块,日期,工时,职级系数,统计工时";
	...
	public void cloneCopy(BaseReportProjectWorkTimeDetail __bean){
	...
	@Override
	public int compareTo(BaseReportProjectWorkTimeDetail o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseReportProjectWorkTimeDetail o = (BaseReportProjectWorkTimeDetail)obj;
