...
public class BaseReportOnEmployeeAgeTotalByDepartment extends GenericBase implements BaseFactory<BaseReportOnEmployeeAgeTotalByDepartment>, Comparable<BaseReportOnEmployeeAgeTotalByDepartment> 
{


	public static BaseReportOnEmployeeAgeTotalByDepartment newInstance(){
		return new BaseReportOnEmployeeAgeTotalByDepartment();
	}

	@Override
	public BaseReportOnEmployeeAgeTotalByDepartment make(){
		BaseReportOnEmployeeAgeTotalByDepartment b = new BaseReportOnEmployeeAgeTotalByDepartment();
		return b;
	}
	...
	public void cloneCopy(BaseReportOnEmployeeAgeTotalByDepartment __bean){
	...
	@Override
	public int compareTo(BaseReportOnEmployeeAgeTotalByDepartment o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseReportOnEmployeeAgeTotalByDepartment o = (BaseReportOnEmployeeAgeTotalByDepartment)obj;
