...
public class BaseEmployeeAccountIncome extends GenericBase implements BaseFactory<BaseEmployeeAccountIncome>, Comparable<BaseEmployeeAccountIncome>
{


	public static BaseEmployeeAccountIncome newInstance(){
		return new BaseEmployeeAccountIncome();
	}

	@Override
	public BaseEmployeeAccountIncome make(){
		BaseEmployeeAccountIncome b = new BaseEmployeeAccountIncome();
		return b;
	}
	...
	public void cloneCopy(BaseEmployeeAccountIncome __bean){
	...
	@Override
	public int compareTo(BaseEmployeeAccountIncome o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseEmployeeAccountIncome o = (BaseEmployeeAccountIncome)obj;
