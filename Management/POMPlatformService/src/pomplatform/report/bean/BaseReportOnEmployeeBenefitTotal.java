...
public class BaseReportOnEmployeeBenefitTotal extends GenericBase implements BaseFactory<BaseReportOnEmployeeBenefitTotal>, Comparable<BaseReportOnEmployeeBenefitTotal> 
{


	public static BaseReportOnEmployeeBenefitTotal newInstance(){
		return new BaseReportOnEmployeeBenefitTotal();
	}

	@Override
	public BaseReportOnEmployeeBenefitTotal make(){
		BaseReportOnEmployeeBenefitTotal b = new BaseReportOnEmployeeBenefitTotal();
		return b;
	}
	...
	public void cloneCopy(BaseReportOnEmployeeBenefitTotal __bean){
	...
	@Override
	public int compareTo(BaseReportOnEmployeeBenefitTotal o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseReportOnEmployeeBenefitTotal o = (BaseReportOnEmployeeBenefitTotal)obj;
