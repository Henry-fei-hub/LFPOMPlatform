...
public class BaseOnBusinessLineRevenueDetailData extends GenericBase implements BaseFactory<BaseOnBusinessLineRevenueDetailData>, Comparable<BaseOnBusinessLineRevenueDetailData> 
{


	public static BaseOnBusinessLineRevenueDetailData newInstance(){
		return new BaseOnBusinessLineRevenueDetailData();
	}

	@Override
	public BaseOnBusinessLineRevenueDetailData make(){
		BaseOnBusinessLineRevenueDetailData b = new BaseOnBusinessLineRevenueDetailData();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "项目编码,业务部门,订单编号,订单名称,业务条线,合同金额,年份,1月,2月,3月,4月,5月,6月,7月,8月,9月,10月,11月,12月";
	...
	public void cloneCopy(BaseOnBusinessLineRevenueDetailData __bean){
	...
	@Override
	public int compareTo(BaseOnBusinessLineRevenueDetailData o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseOnBusinessLineRevenueDetailData o = (BaseOnBusinessLineRevenueDetailData)obj;
