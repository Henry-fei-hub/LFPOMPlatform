...
public class BaseSalaryBonusAnalysis extends GenericBase implements BaseFactory<BaseSalaryBonusAnalysis>, Comparable<BaseSalaryBonusAnalysis> 
{


	public static BaseSalaryBonusAnalysis newInstance(){
		return new BaseSalaryBonusAnalysis();
	}

	@Override
	public BaseSalaryBonusAnalysis make(){
		BaseSalaryBonusAnalysis b = new BaseSalaryBonusAnalysis();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "业务部门,年份,第一季度薪酬,第一季度奖金,第一季度固浮比例,第二季度薪酬,第二季度奖金,第二季度固浮比例,第三季度薪酬,第三季度奖金,第三季度固浮比例,第四季度薪酬,第四季度奖金,第四季度固浮比例,薪酬合计,奖金合计,固浮比例";
	...
	public void cloneCopy(BaseSalaryBonusAnalysis __bean){
...
//	BaseHelpUtils.getBigDecimalValue(baseCollectionrevenueanalysis.getJanuaryLeft()).setScale(2, BigDecimal.ROUND_DOWN)+"%";
	...
	@Override
	public int compareTo(BaseSalaryBonusAnalysis o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSalaryBonusAnalysis o = (BaseSalaryBonusAnalysis)obj;
