...
public class BaseReportCostDetailByMonth extends GenericBase implements BaseFactory<BaseReportCostDetailByMonth>, Comparable<BaseReportCostDetailByMonth> 
{


	public static BaseReportCostDetailByMonth newInstance(){
		return new BaseReportCostDetailByMonth();
	}

	@Override
	public BaseReportCostDetailByMonth make(){
		BaseReportCostDetailByMonth b = new BaseReportCostDetailByMonth();
		return b;
	}
...
//	public final static java.lang.String ALL_CAPTIONS = "流程类型,业务编码,流程编码,流程编码,费用类型,,编号,费用承担主体,报销编号,申请人,申请时间,流程状态,结算状态,报销金额,进项税,成本,业务部门,完成时间,子表ID";
	public final static java.lang.String ALL_CAPTIONS = "流程类型,报销编号,费用类型,编号,费用承担主体,业务部门,申请人,报销金额,进项税,成本,流程状态,结算状态,申请时间,完成时间";
	...
	public void cloneCopy(BaseReportCostDetailByMonth __bean){
	...
	@Override
	public int compareTo(BaseReportCostDetailByMonth o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseReportCostDetailByMonth o = (BaseReportCostDetailByMonth)obj;
