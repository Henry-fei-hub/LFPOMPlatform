...
public class BaseReportOnEmployeeSeniorityTotal extends GenericBase implements BaseFactory<BaseReportOnEmployeeSeniorityTotal>, Comparable<BaseReportOnEmployeeSeniorityTotal> 
{


	public static BaseReportOnEmployeeSeniorityTotal newInstance(){
		return new BaseReportOnEmployeeSeniorityTotal();
	}

	@Override
	public BaseReportOnEmployeeSeniorityTotal make(){
		BaseReportOnEmployeeSeniorityTotal b = new BaseReportOnEmployeeSeniorityTotal();
		return b;
	}
	...
	public void cloneCopy(BaseReportOnEmployeeSeniorityTotal __bean){
	...
	@Override
	public int compareTo(BaseReportOnEmployeeSeniorityTotal o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseReportOnEmployeeSeniorityTotal o = (BaseReportOnEmployeeSeniorityTotal)obj;
