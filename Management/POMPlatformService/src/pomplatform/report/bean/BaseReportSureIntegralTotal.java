...
public class BaseReportSureIntegralTotal extends GenericBase implements BaseFactory<BaseReportSureIntegralTotal>, Comparable<BaseReportSureIntegralTotal> 
{


	public static BaseReportSureIntegralTotal newInstance(){
		return new BaseReportSureIntegralTotal();
	}

	@Override
	public BaseReportSureIntegralTotal make(){
		BaseReportSureIntegralTotal b = new BaseReportSureIntegralTotal();
		return b;
	}
	...
	public void cloneCopy(BaseReportSureIntegralTotal __bean){
	...
	@Override
	public int compareTo(BaseReportSureIntegralTotal o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseReportSureIntegralTotal o = (BaseReportSureIntegralTotal)obj;
