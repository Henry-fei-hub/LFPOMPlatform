...
public class BaseReportNewContractTotal extends GenericBase implements BaseFactory<BaseReportNewContractTotal>, Comparable<BaseReportNewContractTotal>
{


	public static BaseReportNewContractTotal newInstance(){
		return new BaseReportNewContractTotal();
	}

	@Override
	public BaseReportNewContractTotal make(){
		BaseReportNewContractTotal b = new BaseReportNewContractTotal();
		return b;
	}
	...
	public void cloneCopy(BaseReportNewContractTotal __bean){
	...
	@Override
	public int compareTo(BaseReportNewContractTotal o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseReportNewContractTotal o = (BaseReportNewContractTotal)obj;
	...
	public Map<String, Object> toMap() {
		...
		if(getJanuaryRevenue() != null) res.put("januaryRevenue", getJanuaryRevenue());
		if(getFebruaryRevenue() != null) res.put("februaryRevenue", getFebruaryRevenue());
		if(getMarchRevenue() != null) res.put("marchRevenue", getMarchRevenue());
		if(getAprilRevenue() != null) res.put("aprilRevenue", getAprilRevenue());
		if(getMayRevenue() != null) res.put("mayRevenue", getMayRevenue());
		if(getJuneRevenue() != null) res.put("juneRevenue", getJuneRevenue());
		if(getJulyRevenue() != null) res.put("julyRevenue", getJulyRevenue());
		if(getAugustRevenue() != null) res.put("augustRevenue", getAugustRevenue());
		if(getSeptemberRevenue() != null) res.put("septemberRevenue", getSeptemberRevenue());
		if(getOctoberRevenue() != null) res.put("octoberRevenue", getOctoberRevenue());
		if(getNovemberRevenue() != null) res.put("novemberRevenue", getNovemberRevenue());
		if(getDecemberRevenue() != null) res.put("decemberRevenue", getDecemberRevenue());
