...
public class BaseReportCapitaDepartmentDetail extends GenericBase implements BaseFactory<BaseReportCapitaDepartmentDetail>, Comparable<BaseReportCapitaDepartmentDetail> 
{


	public static BaseReportCapitaDepartmentDetail newInstance(){
		return new BaseReportCapitaDepartmentDetail();
	}

	@Override
	public BaseReportCapitaDepartmentDetail make(){
		BaseReportCapitaDepartmentDetail b = new BaseReportCapitaDepartmentDetail();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "业务部门,报销部门,年份,1月,2月,3月,4月,5月,6月,7月,8月,9月,10月,11月,12月";
	...
	public void cloneCopy(BaseReportCapitaDepartmentDetail __bean){
	...
	@Override
	public int compareTo(BaseReportCapitaDepartmentDetail o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseReportCapitaDepartmentDetail o = (BaseReportCapitaDepartmentDetail)obj;
