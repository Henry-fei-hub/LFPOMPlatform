...
public class BaseReportOfGenderAnalysis extends GenericBase implements BaseFactory<BaseReportOfGenderAnalysis>, Comparable<BaseReportOfGenderAnalysis> 
{


	public static BaseReportOfGenderAnalysis newInstance(){
		return new BaseReportOfGenderAnalysis();
	}

	@Override
	public BaseReportOfGenderAnalysis make(){
		BaseReportOfGenderAnalysis b = new BaseReportOfGenderAnalysis();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "业务部门,男性理想比例,女性理想比例,男,男性占比(%),女,女性占比(%),合计,男,男性占比(%),女,女性占比(%),合计,男,男性占比(%),女,女性占比(%),合计,男,男性占比(%),女,女性占比(%),合计,男,男性占比(%),女,女性占比(%),合计,男,男性占比(%),女,女性占比(%),合计,男,男性占比(%),女,女性占比(%),合计,男,男性占比(%),女,女性占比(%),合计,男,男性占比(%),女,女性占比(%),合计,男,男性占比(%),女,女性占比(%),合计,男,男性占比(%),女,女性占比(%),合计,男,男性占比(%),女,女性占比(%),合计";
	...
	public void cloneCopy(BaseReportOfGenderAnalysis __bean){
	...
	@Override
	public int compareTo(BaseReportOfGenderAnalysis o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseReportOfGenderAnalysis o = (BaseReportOfGenderAnalysis)obj;
