...
public class BaseReportOnEmployeeTurnoverTotalByDepartment extends GenericBase implements BaseFactory<BaseReportOnEmployeeTurnoverTotalByDepartment>, Comparable<BaseReportOnEmployeeTurnoverTotalByDepartment> 
{


	public static BaseReportOnEmployeeTurnoverTotalByDepartment newInstance(){
		return new BaseReportOnEmployeeTurnoverTotalByDepartment();
	}

	@Override
	public BaseReportOnEmployeeTurnoverTotalByDepartment make(){
		BaseReportOnEmployeeTurnoverTotalByDepartment b = new BaseReportOnEmployeeTurnoverTotalByDepartment();
		return b;
	}
	...
	public void cloneCopy(BaseReportOnEmployeeTurnoverTotalByDepartment __bean){
	...
	@Override
	public int compareTo(BaseReportOnEmployeeTurnoverTotalByDepartment o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseReportOnEmployeeTurnoverTotalByDepartment o = (BaseReportOnEmployeeTurnoverTotalByDepartment)obj;
