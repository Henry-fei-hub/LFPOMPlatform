...
public class BaseReportOnEmployeeTurnoverTotal extends GenericBase implements BaseFactory<BaseReportOnEmployeeTurnoverTotal>, Comparable<BaseReportOnEmployeeTurnoverTotal> 
{


	public static BaseReportOnEmployeeTurnoverTotal newInstance(){
		return new BaseReportOnEmployeeTurnoverTotal();
	}

	@Override
	public BaseReportOnEmployeeTurnoverTotal make(){
		BaseReportOnEmployeeTurnoverTotal b = new BaseReportOnEmployeeTurnoverTotal();
		return b;
	}
	...
	public void cloneCopy(BaseReportOnEmployeeTurnoverTotal __bean){
	...
	@Override
	public int compareTo(BaseReportOnEmployeeTurnoverTotal o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseReportOnEmployeeTurnoverTotal o = (BaseReportOnEmployeeTurnoverTotal)obj;
