...
public class BaseReportSureIntegralDetail extends GenericBase implements BaseFactory<BaseReportSureIntegralDetail>, Comparable<BaseReportSureIntegralDetail> 
{


	public static BaseReportSureIntegralDetail newInstance(){
		return new BaseReportSureIntegralDetail();
	}

	@Override
	public BaseReportSureIntegralDetail make(){
		BaseReportSureIntegralDetail b = new BaseReportSureIntegralDetail();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "业务部门,项目代码,订单编号,订单名称,订单合同金额,年份,项目组,项目组,项目组,项目组,项目组,项目组,项目组,项目组,项目组,项目组,项目组,项目组,部门,部门,部门,部门,部门,部门,部门,部门,部门,部门,部门,部门";
	...
	public void cloneCopy(BaseReportSureIntegralDetail __bean){
	...
	@Override
	public int compareTo(BaseReportSureIntegralDetail o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseReportSureIntegralDetail o = (BaseReportSureIntegralDetail)obj;
