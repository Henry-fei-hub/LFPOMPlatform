...
public class BaseReportOfSalaryTotal extends GenericBase implements BaseFactory<BaseReportOfSalaryTotal>, Comparable<BaseReportOfSalaryTotal> 
{


	public static BaseReportOfSalaryTotal newInstance(){
		return new BaseReportOfSalaryTotal();
	}

	@Override
	public BaseReportOfSalaryTotal make(){
		BaseReportOfSalaryTotal b = new BaseReportOfSalaryTotal();
		return b;
	}
	...
	public void cloneCopy(BaseReportOfSalaryTotal __bean){
	...
	@Override
	public int compareTo(BaseReportOfSalaryTotal o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseReportOfSalaryTotal o = (BaseReportOfSalaryTotal)obj;
