...
public class BaseReportCostTotal extends GenericBase implements BaseFactory<BaseReportCostTotal>, Comparable<BaseReportCostTotal> 
{


	public static BaseReportCostTotal newInstance(){
		return new BaseReportCostTotal();
	}

	@Override
	public BaseReportCostTotal make(){
		BaseReportCostTotal b = new BaseReportCostTotal();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "业务部门,费用类型,一月,二月,三月,四月,五月,六月,七月,八月,九月,十月,十一月,十二月";
	...
	public void cloneCopy(BaseReportCostTotal __bean){
	...
	@Override
	public int compareTo(BaseReportCostTotal o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseReportCostTotal o = (BaseReportCostTotal)obj;
