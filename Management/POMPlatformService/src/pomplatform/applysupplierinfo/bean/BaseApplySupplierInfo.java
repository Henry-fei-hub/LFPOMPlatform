...
public class BaseApplySupplierInfo extends GenericBase implements BaseFactory<BaseApplySupplierInfo>, Comparable<BaseApplySupplierInfo> 
{


	public static BaseApplySupplierInfo newInstance(){
		return new BaseApplySupplierInfo();
	}

	@Override
	public BaseApplySupplierInfo make(){
		BaseApplySupplierInfo b = new BaseApplySupplierInfo();
		return b;
	}
	...
	public void cloneCopy(BaseApplySupplierInfo __bean){
	...
	@Override
	public int compareTo(BaseApplySupplierInfo o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseApplySupplierInfo o = (BaseApplySupplierInfo)obj;
