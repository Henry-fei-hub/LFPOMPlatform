...
public class BaseRefuseSupplierInfo extends GenericBase implements BaseFactory<BaseRefuseSupplierInfo>, Comparable<BaseRefuseSupplierInfo> 
{


	public static BaseRefuseSupplierInfo newInstance(){
		return new BaseRefuseSupplierInfo();
	}

	@Override
	public BaseRefuseSupplierInfo make(){
		BaseRefuseSupplierInfo b = new BaseRefuseSupplierInfo();
		return b;
	}
	...
	public void cloneCopy(BaseRefuseSupplierInfo __bean){
	...
	@Override
	public int compareTo(BaseRefuseSupplierInfo o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseRefuseSupplierInfo o = (BaseRefuseSupplierInfo)obj;
