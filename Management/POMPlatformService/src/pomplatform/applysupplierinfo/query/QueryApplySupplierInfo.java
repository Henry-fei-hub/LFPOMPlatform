...
import pomplatform.applysupplierinfo.bean.BaseApplySupplierInfo;
import pomplatform.applysupplierinfo.bean.ConditionApplySupplierInfo;

public class QueryApplySupplierInfo extends AbstractQuery<BaseApplySupplierInfo, ConditionApplySupplierInfo>
{

	private static final Logger __logger = Logger.getLogger(QueryApplySupplierInfo.class);

	public QueryApplySupplierInfo() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseApplySupplierInfo> executeQuery( KeyValuePair[] replacements, ConditionApplySupplierInfo condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseApplySupplierInfo generateBase(Object[] __data) throws java.sql.SQLException {
		BaseApplySupplierInfo __base = new BaseApplySupplierInfo();
		int count = 0;
		Object val;
	...
	private final static String[] fieldNames = { "process_type", "supplier_name", "create_time_start", "create_time_end", "employee_id", "operate_employee_id", "areas_expertise"};
}
