...
public class ConditionOnSupplierInfo extends GenericCondition{

	public ConditionOnSupplierInfo(){
		setParameterCount(34);
	}
	...
	public java.lang.String getSupplierAddress() {
		return this.__supplier_address == null ? null : (this.__supplier_address.indexOf("%") >= 0 ? this.__supplier_address : "%"+this.__supplier_address+"%");
	}
	...
	public java.lang.String toJSONString() {
		...
		if(getSupplierContact() != null) sb.append(__wrapString(1, "supplierContact", getSupplierContact()));
		if(getSupplierPhone() != null) sb.append(__wrapString(1, "supplierPhone", getSupplierPhone()));
		if(getSupplierEmail() != null) sb.append(__wrapString(1, "supplierEmail", getSupplierEmail()));
		if(getSupplierType() != null) sb.append(__wrapNumber(1, "supplierType", getSupplierType()));
		if(getSupplierMainBusinessType() != null) sb.append(__wrapNumber(1, "supplierMainBusinessType", getSupplierMainBusinessType()));
		if(getSupplierScopeSupply() != null) sb.append(__wrapString(1, "supplierScopeSupply", getSupplierScopeSupply()));
		if(getSocialCreditCode() != null) sb.append(__wrapString(1, "socialCreditCode", getSocialCreditCode()));
		if(getSupplier_province() != null) sb.append(__wrapNumber(1, "supplier_province", getSupplier_province()));
		if(getSupplier_city() != null) sb.append(__wrapNumber(1, "supplier_city", getSupplier_city()));
		if(getSupplierBankAddress() != null) sb.append(__wrapString(1, "supplierBankAddress", getSupplierBankAddress()));
		if(getSupplierAddress() != null) sb.append(__wrapString(1, "supplierAddress", getSupplierAddress()));
		if(getProductionCycle() != null) sb.append(__wrapNumber(1, "productionCycle", getProductionCycle()));
		if(getLogisticsCycle() != null) sb.append(__wrapNumber(1, "logisticsCycle", getLogisticsCycle()));
		if(getSupplierBoss() != null) sb.append(__wrapString(1, "supplierBoss", getSupplierBoss()));
		if(getContractSigningTime() != null) sb.append(__wrapDate(1, "contractSigningTime", getContractSigningTime()));
		if(getContractScopeTime() != null) sb.append(__wrapString(1, "contractScopeTime", getContractScopeTime()));
		if(getContractScopeTimeStart() != null) sb.append(__wrapDate(1, "contractScopeTimeStart", getContractScopeTimeStart()));
		if(getContractScopeTimeEnd() != null) sb.append(__wrapDate(1, "contractScopeTimeEnd", getContractScopeTimeEnd()));
		...
		if(getSupplierOrigin() != null) sb.append(__wrapString(1, "supplierOrigin", getSupplierOrigin()));
		if(getSupplierStatus() != null) sb.append(__wrapNumber(1, "supplierStatus", getSupplierStatus()));
		...
		if(getAgreementType() != null) sb.append(__wrapNumber(1, "agreementType", getAgreementType()));
		if(getAgreementSignTime() != null) sb.append(__wrapDate(1, "agreementSignTime", getAgreementSignTime()));
		if(getAgreementSignAddress() != null) sb.append(__wrapString(1, "agreementSignAddress", getAgreementSignAddress()));
		if(getFileId() != null) sb.append(__wrapNumber(1, "fileId", getFileId()));
		if(getTeamSize() != null) sb.append(__wrapNumber(1, "teamSize", getTeamSize()));
	...
	private java.lang.String __supplier_contact = null;
	private java.lang.String __supplier_phone = null;
	private java.lang.String __supplier_email = null;
	private java.lang.Integer __supplier_type = null;
	private java.lang.Integer __supplier_main_business_type = null;
	private java.lang.String __supplier_scope_supply = null;
	private java.lang.String __social_credit_code = null;
	private java.lang.Integer __supplier__province = null;
	private java.lang.Integer __supplier__city = null;
	private java.lang.String __supplier_bank_address = null;
	private java.lang.String __supplier_address = null;
	private java.lang.Integer __production_cycle = null;
	private java.lang.Integer __logistics_cycle = null;
	private java.lang.String __supplier_boss = null;
	private java.util.Date __contract_signing_time = null;
	private java.lang.String __contract_scope_time = null;
	private java.util.Date __contract_scope_time_start = null;
	private java.util.Date __contract_scope_time_end = null;
	...
	private java.lang.String __supplier_origin = null;
	private java.lang.Integer __supplier_status = null;
	private java.lang.Integer __is_use = null;
	private java.lang.Integer __receive_unit_manage_id = null;
	private java.lang.Integer __agreement_type = null;
	private java.util.Date __agreement_sign_time = null;
	private java.lang.String __agreement_sign_address = null;
	private java.lang.Integer __file_id = null;
	private java.lang.Integer __team_size = null;
