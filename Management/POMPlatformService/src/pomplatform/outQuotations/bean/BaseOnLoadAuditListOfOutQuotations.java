...
public class BaseOnLoadAuditListOfOutQuotations extends GenericBase implements BaseFactory<BaseOnLoadAuditListOfOutQuotations>, Comparable<BaseOnLoadAuditListOfOutQuotations> 
{


	public static BaseOnLoadAuditListOfOutQuotations newInstance(){
		return new BaseOnLoadAuditListOfOutQuotations();
	}

	@Override
	public BaseOnLoadAuditListOfOutQuotations make(){
		BaseOnLoadAuditListOfOutQuotations b = new BaseOnLoadAuditListOfOutQuotations();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,,活动实列编码,业务编码,业务名称,活动编码,流程编码,主键编码,附加节点，说明节点是预定义的节点还是动态加的节点， 0 - 正常定义的节点， 1 - 申请人或者审批人加的处理人或者审批人,当前流程实例节点的内部编码,下一个流程节点的编码,如果是知会节点，所依附的主节点,流程实例节点创建时间,流程实例节点开始处于活动时间,操作时间,提交意见,状态,节点类型 0 - 开始 1 - 结束 2 - 审批 3 - 处理 4 - 知会,返回数据集,流程类型,报价单编码,报价单编号(年月日-1),报价单名称,报价单总金额,,信息编号,项目编号,,业务类型,项目类型,报价单(原附件),报价单的状态 1成功 2不成功 3报价中...,可操作状态 0可操作,1禁止操作,创建人,contract_id,修改时间,新建的报价单名称";
	...
	public void cloneCopy(BaseOnLoadAuditListOfOutQuotations __bean){
	...
	@Override
	public int compareTo(BaseOnLoadAuditListOfOutQuotations o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseOnLoadAuditListOfOutQuotations o = (BaseOnLoadAuditListOfOutQuotations)obj;
