...
public class BaseMoutquotationooor extends GenericBase implements BaseFactory<BaseMoutquotationooor>, Comparable<BaseMoutquotationooor> 
{


	public static BaseMoutquotationooor newInstance(){
		return new BaseMoutquotationooor();
	}

	@Override
	public BaseMoutquotationooor make(){
		BaseMoutquotationooor b = new BaseMoutquotationooor();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "报价单编码,报价单编号(年月日-1),报价单名称,报价单总金额,报价单创建时间,信息编号,项目编号,业务类型,项目类型,报价单(原附件),报价单的状态 1成功 2不成功 3报价中...,可操作状态 0可操作,1禁止操作,操作人(人员id),contract_id,修改时间,新建的报价单名称";
	...
	public void cloneCopy(BaseMoutquotationooor __bean){
	...
	@Override
	public int compareTo(BaseMoutquotationooor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseMoutquotationooor o = (BaseMoutquotationooor)obj;
