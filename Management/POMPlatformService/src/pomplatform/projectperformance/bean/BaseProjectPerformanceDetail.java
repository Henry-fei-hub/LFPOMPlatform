...
public class BaseProjectPerformanceDetail extends GenericBase implements BaseFactory<BaseProjectPerformanceDetail>, Comparable<BaseProjectPerformanceDetail> 
{


	public static BaseProjectPerformanceDetail newInstance(){
		return new BaseProjectPerformanceDetail();
	}

	@Override
	public BaseProjectPerformanceDetail make(){
		BaseProjectPerformanceDetail b = new BaseProjectPerformanceDetail();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,合同编码,项目编码,积分,比例,扣除/奖励积分,职员,日期,客户投诉,原因,是否提交,绩效类型,业务类型,操作人,操作时间,备注,类型";
	...
	public void cloneCopy(BaseProjectPerformanceDetail __bean){
	...
	@Override
	public int compareTo(BaseProjectPerformanceDetail o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseProjectPerformanceDetail o = (BaseProjectPerformanceDetail)obj;
