...
public class BaseFinancialBankAccountReceivables extends GenericBase implements BaseFactory<BaseFinancialBankAccountReceivables>, Comparable<BaseFinancialBankAccountReceivables> 
{


	public static BaseFinancialBankAccountReceivables newInstance(){
		return new BaseFinancialBankAccountReceivables();
	}

	@Override
	public BaseFinancialBankAccountReceivables make(){
		BaseFinancialBankAccountReceivables b = new BaseFinancialBankAccountReceivables();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "内部公司(收款方),款项属性,银行账号(收款方),";
	...
	public void cloneCopy(BaseFinancialBankAccountReceivables __bean){
	...
	@Override
	public int compareTo(BaseFinancialBankAccountReceivables o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseFinancialBankAccountReceivables o = (BaseFinancialBankAccountReceivables)obj;
