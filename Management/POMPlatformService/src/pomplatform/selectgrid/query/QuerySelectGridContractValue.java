...
public class QuerySelectGridContractValue extends AbstractQuery<BaseSelectGridContractValue, ConditionSelectGridContractValue>
{

	private static final Logger __logger = Logger.getLogger(QuerySelectGridContractValue.class);

	public QuerySelectGridContractValue() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseSelectGridContractValue> executeQuery( KeyValuePair[] replacements, ConditionSelectGridContractValue condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseSelectGridContractValue generateBase(Object[] __data) throws java.sql.SQLException {
		BaseSelectGridContractValue __base = new BaseSelectGridContractValue();
		int count = 0;
		Object val;
	...
	private final static String[] fieldNames = { "contract_code", "contract_name", "customer_name", "project_type", "contract_id", "status", "business_type", "flow_status", "project_type", "parent_id", "is_finish"};
}
