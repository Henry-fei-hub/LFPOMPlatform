...
public class QuerySelectGridEmployeeInDepartment extends AbstractQuery<BaseSelectGridEmployeeInDepartment, ConditionSelectGridEmployeeInDepartment>
{

	private static final Logger __logger = Logger.getLogger(QuerySelectGridEmployeeInDepartment.class);

	public QuerySelectGridEmployeeInDepartment() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseSelectGridEmployeeInDepartment> executeQuery( KeyValuePair[] replacements, ConditionSelectGridEmployeeInDepartment condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseSelectGridEmployeeInDepartment generateBase(Object[] __data) throws java.sql.SQLException {
		BaseSelectGridEmployeeInDepartment __base = new BaseSelectGridEmployeeInDepartment();
		int count = 0;
		Object val;
