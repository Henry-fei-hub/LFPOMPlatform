...
public class BaseSelectGridProjectValue extends GenericBase implements BaseFactory<BaseSelectGridProjectValue>, Comparable<BaseSelectGridProjectValue> 
{


	public static BaseSelectGridProjectValue newInstance(){
		return new BaseSelectGridProjectValue();
	}

	@Override
	public BaseSelectGridProjectValue make(){
		BaseSelectGridProjectValue b = new BaseSelectGridProjectValue();
		return b;
	}
	...
	public void cloneCopy(BaseSelectGridProjectValue __bean){
	...
	@Override
	public int compareTo(BaseSelectGridProjectValue o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSelectGridProjectValue o = (BaseSelectGridProjectValue)obj;
