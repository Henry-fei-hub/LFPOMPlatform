...
public class BaseSelectGridContractValue extends GenericBase implements BaseFactory<BaseSelectGridContractValue>, Comparable<BaseSelectGridContractValue> 
{


	public static BaseSelectGridContractValue newInstance(){
		return new BaseSelectGridContractValue();
	}

	@Override
	public BaseSelectGridContractValue make(){
		BaseSelectGridContractValue b = new BaseSelectGridContractValue();
		return b;
	}
	...
	public void cloneCopy(BaseSelectGridContractValue __bean){
	...
	@Override
	public int compareTo(BaseSelectGridContractValue o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSelectGridContractValue o = (BaseSelectGridContractValue)obj;
