...
public class BaseSelectGridInvoiceTypeValue extends GenericBase implements BaseFactory<BaseSelectGridInvoiceTypeValue>, Comparable<BaseSelectGridInvoiceTypeValue> 
{


	public static BaseSelectGridInvoiceTypeValue newInstance(){
		return new BaseSelectGridInvoiceTypeValue();
	}

	@Override
	public BaseSelectGridInvoiceTypeValue make(){
		BaseSelectGridInvoiceTypeValue b = new BaseSelectGridInvoiceTypeValue();
		return b;
	}
	...
	public void cloneCopy(BaseSelectGridInvoiceTypeValue __bean){
	...
	@Override
	public int compareTo(BaseSelectGridInvoiceTypeValue o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSelectGridInvoiceTypeValue o = (BaseSelectGridInvoiceTypeValue)obj;
