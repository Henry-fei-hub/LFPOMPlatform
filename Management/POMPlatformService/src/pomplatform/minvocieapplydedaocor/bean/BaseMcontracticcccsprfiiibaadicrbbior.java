...
public class BaseMcontracticcccsprfiiibaadicrbbior extends GenericBase implements BaseFactory<BaseMcontracticcccsprfiiibaadicrbbior>, Comparable<BaseMcontracticcccsprfiiibaadicrbbior> 
{


	public static BaseMcontracticcccsprfiiibaadicrbbior newInstance(){
		return new BaseMcontracticcccsprfiiibaadicrbbior();
	}

	@Override
	public BaseMcontracticcccsprfiiibaadicrbbior make(){
		BaseMcontracticcccsprfiiibaadicrbbior b = new BaseMcontracticcccsprfiiibaadicrbbior();
		return b;
	}
	...
	public void cloneCopy(BaseMcontracticcccsprfiiibaadicrbbior __bean){
	...
	@Override
	public int compareTo(BaseMcontracticcccsprfiiibaadicrbbior o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseMcontracticcccsprfiiibaadicrbbior o = (BaseMcontracticcccsprfiiibaadicrbbior)obj;
