...
public class BaseMinvocieapplydedaocor extends GenericBase implements BaseFactory<BaseMinvocieapplydedaocor>, Comparable<BaseMinvocieapplydedaocor> 
{


	public static BaseMinvocieapplydedaocor newInstance(){
		return new BaseMinvocieapplydedaocor();
	}

	@Override
	public BaseMinvocieapplydedaocor make(){
		BaseMinvocieapplydedaocor b = new BaseMinvocieapplydedaocor();
		return b;
	}
	...
	public final static java.lang.String CS_APPLICANT_NAME = "applicant_name" ;
	...
	public final static java.lang.String ALL_CAPTIONS = "主键,申请人名称,部门名称,合同,合同编号,单位名称,税号,发票类型,联系人,联系电话,注册地址,开户银行,银行账号,申请日期,申请总金额,备注,操作人,申请状态";
	...
	public void cloneCopy(BaseMinvocieapplydedaocor __bean){
		__bean.setInvoiceApplyId(getInvoiceApplyId());
		__bean.setApplicantId(getApplicantId());
		__bean.setApplicantName(getApplicantName());
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		sb.append(getApplicantName() == null ? "" : getApplicantName());
		sb.append(",");
		...
		sb.append(",");
		String invoiceType = SelectValueCache.getSelectValue("system_dictionary_52", String.valueOf(getInvoiceType()));
		...
		sb.append(",");
		String status = SelectValueCache.getSelectValue("system_dictionary_61", String.valueOf(getInvoiceApplyStatus()));
		sb.append(status == null ? "" : status);
		return sb.toString();
	}

	@Override
	public int compareTo(BaseMinvocieapplydedaocor o) {
	...
	public int hashCode() {
		...
		hash = 97 * hash + Objects.hashCode(this.__applicant_name);
	...
	public boolean equals(Object obj) {
		...
		final BaseMinvocieapplydedaocor o = (BaseMinvocieapplydedaocor)obj;
		...
		if(!Objects.equals(this.__applicant_name, o.getApplicantName())) return false;
	...
	public java.lang.String toJSONString() {
		...
		if(getApplicantName() != null) sb.append(__wrapString(count++, "applicantName", getApplicantName()));
	...
	protected java.lang.String  __applicant_name ;
