package pomplatform.plateIntegralSends.bean;
...
public class BasePlateIntegralSends extends GenericBase implements BaseFactory<BasePlateIntegralSends>, Comparable<BasePlateIntegralSends> 
{


	public static BasePlateIntegralSends newInstance(){
		return new BasePlateIntegralSends();
	}

	@Override
	public BasePlateIntegralSends make(){
		BasePlateIntegralSends b = new BasePlateIntegralSends();
		return b;
	}
	...
	public void cloneCopy(BasePlateIntegralSends __bean){
	...
	@Override
	public int compareTo(BasePlateIntegralSends o) {
	...
	public boolean equals(Object obj) {
		...
		final BasePlateIntegralSends o = (BasePlateIntegralSends)obj;
