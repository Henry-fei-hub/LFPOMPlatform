...
public class BaseCapitalDsitributionemployee extends GenericBase implements BaseFactory<BaseCapitalDsitributionemployee>, Comparable<BaseCapitalDsitributionemployee> 
{


	public static BaseCapitalDsitributionemployee newInstance(){
		return new BaseCapitalDsitributionemployee();
	}

	@Override
	public BaseCapitalDsitributionemployee make(){
		BaseCapitalDsitributionemployee b = new BaseCapitalDsitributionemployee();
		return b;
	}
	...
	public void cloneCopy(BaseCapitalDsitributionemployee __bean){
	...
	@Override
	public int compareTo(BaseCapitalDsitributionemployee o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseCapitalDsitributionemployee o = (BaseCapitalDsitributionemployee)obj;
