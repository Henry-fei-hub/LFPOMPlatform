...
public class BaseSplateProjectOrDepartmentIntegralSumRecordpysor extends GenericBase implements BaseFactory<BaseSplateProjectOrDepartmentIntegralSumRecordpysor>, Comparable<BaseSplateProjectOrDepartmentIntegralSumRecordpysor> 
{


	public static BaseSplateProjectOrDepartmentIntegralSumRecordpysor newInstance(){
		return new BaseSplateProjectOrDepartmentIntegralSumRecordpysor();
	}

	@Override
	public BaseSplateProjectOrDepartmentIntegralSumRecordpysor make(){
		BaseSplateProjectOrDepartmentIntegralSumRecordpysor b = new BaseSplateProjectOrDepartmentIntegralSumRecordpysor();
		return b;
	}

	public final static java.lang.String CS_PLATE_ID = "plate_id" ;
	public final static java.lang.String CS_TYPE_FLAG_NAME = "type_flag_name" ;
	...
	public java.lang.String getTypeFlagName() {
		return this.__type_flag_name;
	}

	public void setTypeFlagName( java.lang.String value ) {
		this.__type_flag_name = value;
	}
	...
	public void cloneCopy(BaseSplateProjectOrDepartmentIntegralSumRecordpysor __bean){
		__bean.setPlateId(getPlateId());
		__bean.setTypeFlagName(getTypeFlagName());
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		sb.append(getTypeFlagName() == null ? "" : getTypeFlagName());
		sb.append(",");
	...
	@Override
	public int compareTo(BaseSplateProjectOrDepartmentIntegralSumRecordpysor o) {
	...
	public int hashCode() {
		...
		hash = 97 * hash + Objects.hashCode(this.__type_flag_name);
	...
	public boolean equals(Object obj) {
		...
		final BaseSplateProjectOrDepartmentIntegralSumRecordpysor o = (BaseSplateProjectOrDepartmentIntegralSumRecordpysor)obj;
		if(!Objects.equals(this.__plate_id, o.getPlateId())) return false;
		if(!Objects.equals(this.__type_flag_name, o.getTypeFlagName())) return false;
	...
	public java.lang.String toJSONString() {
		...
		if(getTypeFlagName() != null) sb.append(__wrapString(count++, "typeFlagName", getTypeFlagName()));
	...
	public void setDataFromMap(Map<String, Object> values){
		...
		if((val = values.get("typeFlagName")) != null) setTypeFlagName(__getString(val));
	...
	protected java.lang.String  __type_flag_name ;
