...
public class BaseGetprojectQuoteAreaRange extends GenericBase implements BaseFactory<BaseGetprojectQuoteAreaRange>, Comparable<BaseGetprojectQuoteAreaRange> 
{


	public static BaseGetprojectQuoteAreaRange newInstance(){
		return new BaseGetprojectQuoteAreaRange();
	}

	@Override
	public BaseGetprojectQuoteAreaRange make(){
		BaseGetprojectQuoteAreaRange b = new BaseGetprojectQuoteAreaRange();
		return b;
	}
	...
	public void cloneCopy(BaseGetprojectQuoteAreaRange __bean){
	...
	@Override
	public int compareTo(BaseGetprojectQuoteAreaRange o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseGetprojectQuoteAreaRange o = (BaseGetprojectQuoteAreaRange)obj;
