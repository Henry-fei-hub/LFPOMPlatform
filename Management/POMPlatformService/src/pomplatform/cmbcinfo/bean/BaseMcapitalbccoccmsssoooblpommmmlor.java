...
public class BaseMcapitalbccoccmsssoooblpommmmlor extends GenericBase implements BaseFactory<BaseMcapitalbccoccmsssoooblpommmmlor>, Comparable<BaseMcapitalbccoccmsssoooblpommmmlor> 
{


	public static BaseMcapitalbccoccmsssoooblpommmmlor newInstance(){
		return new BaseMcapitalbccoccmsssoooblpommmmlor();
	}

	@Override
	public BaseMcapitalbccoccmsssoooblpommmmlor make(){
		BaseMcapitalbccoccmsssoooblpommmmlor b = new BaseMcapitalbccoccmsssoooblpommmmlor();
		return b;
	}
	...
	public void cloneCopy(BaseMcapitalbccoccmsssoooblpommmmlor __bean){
	...
	@Override
	public int compareTo(BaseMcapitalbccoccmsssoooblpommmmlor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseMcapitalbccoccmsssoooblpommmmlor o = (BaseMcapitalbccoccmsssoooblpommmmlor)obj;
