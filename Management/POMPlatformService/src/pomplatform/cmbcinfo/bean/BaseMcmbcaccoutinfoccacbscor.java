...
public class BaseMcmbcaccoutinfoccacbscor extends GenericBase implements BaseFactory<BaseMcmbcaccoutinfoccacbscor>, Comparable<BaseMcmbcaccoutinfoccacbscor> 
{


	public static BaseMcmbcaccoutinfoccacbscor newInstance(){
		return new BaseMcmbcaccoutinfoccacbscor();
	}

	@Override
	public BaseMcmbcaccoutinfoccacbscor make(){
		BaseMcmbcaccoutinfoccacbscor b = new BaseMcmbcaccoutinfoccacbscor();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键,币种(对应cmbc_codes的cmbc_curreny),币种名称,科目代码,分行号,账号,户名,上日余额,联机余额,冻结余额,可用额度,透支额度,状态 A活动 B冻结 C关户,利息码 S子公司虚拟余额,年利率,年利率(I),开户日,到期日,利率类型码 cmbc_codes 利率类型码,存期,创建时间,修改时间,主键编码";
	...
	public void cloneCopy(BaseMcmbcaccoutinfoccacbscor __bean){
	...
	@Override
	public int compareTo(BaseMcmbcaccoutinfoccacbscor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseMcmbcaccoutinfoccacbscor o = (BaseMcmbcaccoutinfoccacbscor)obj;
