...
public class BaseMcmbctransinfolinktattlor extends GenericBase implements BaseFactory<BaseMcmbctransinfolinktattlor>, Comparable<BaseMcmbctransinfolinktattlor> 
{


	public static BaseMcmbctransinfolinktattlor newInstance(){
		return new BaseMcmbctransinfolinktattlor();
	}

	@Override
	public BaseMcmbctransinfolinktattlor make(){
		BaseMcmbctransinfolinktattlor b = new BaseMcmbctransinfolinktattlor();
		return b;
	}
	...
	public final static java.lang.String CS_TRANS_TYPE = "trans_type" ;
	public final static java.lang.String CS_COMPANY_RECORD_ID = "company_record_id" ;
	public final static java.lang.String CS_LINK_NUM = "link_num" ;

	public final static java.lang.String ALL_CAPTIONS = "主键,银行账号(用来标识该条流水是哪个账号),户名,交易日,交易时间(时分秒181211 时才有准确性),交易时间,起息日,交易类型 cmbc_codes trans_code,摘要,借方金额,贷方金额,借贷标记 C贷 D借,余额,流水号,流程实例号,业务名称,用途,业务参考号,业务摘要,其它摘要,收/付方开户地区,收/付方名称,收/付方帐号,收/付方开户行行号,收/付方开户行名,收/付方开户行地址,母/子公司所在地区,母/子公司帐号,母/子公司名称,1表示收方帐号和子公司；为2表示收方帐号和母公司；为3表示原收方帐号和子公司,有否附件信息标志,票据号,冲账标志 *为冲帐 X为补帐,扩展摘要,交易分析码,商务支付订单号,企业识别码,创建时间,修改时间,ERP收支表示  1收  2支,主键编码,";
	...
	public java.lang.Integer getTransType() {
		return this.__trans_type;
	}

	public void setTransType( java.lang.Integer value ) {
		this.__trans_type = value;
	}
	...
	public void cloneCopy(BaseMcmbctransinfolinktattlor __bean){
		...
		__bean.setTransType(getTransType());
		__bean.setCompanyRecordId(getCompanyRecordId());
		__bean.setLinkNum(getLinkNum());
	}
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		sb.append(getTransType() == null ? "" : getTransType());
		sb.append(",");
		sb.append(getCompanyRecordId() == null ? "" : getCompanyRecordId());
		sb.append(",");
		sb.append(getLinkNum() == null ? "" : getLinkNum());
		return sb.toString();
	}

	@Override
	public int compareTo(BaseMcmbctransinfolinktattlor o) {
	...
	public int hashCode() {
		...
		hash = 97 * hash + Objects.hashCode(this.__trans_type);
		hash = 97 * hash + Objects.hashCode(this.__company_record_id);
		hash = 97 * hash + Objects.hashCode(this.__link_num);
		return hash;
	}
	...
	public boolean equals(Object obj) {
		...
		final BaseMcmbctransinfolinktattlor o = (BaseMcmbctransinfolinktattlor)obj;
		...
		if(!Objects.equals(this.__trans_type, o.getTransType())) return false;
		if(!Objects.equals(this.__company_record_id, o.getCompanyRecordId())) return false;
		if(!Objects.equals(this.__link_num, o.getLinkNum())) return false;
		return true;
	}
	...
	public java.lang.String toJSONString() {
		...
		if(getTransType() != null) sb.append(__wrapNumber(count++, "transType", getTransType()));
		if(getCompanyRecordId() != null) sb.append(__wrapNumber(count++, "companyRecordId", getCompanyRecordId()));
		if(getLinkNum() != null) sb.append(__wrapNumber(count++, "linkNum", getLinkNum()));
		return sb.toString();
	}
	...
	public void setDataFromMap(Map<String, Object> values){
		...
		if((val = values.get("transType")) != null) setTransType(__getInt(val)); 
	...
	protected java.lang.Integer  __trans_type ;
	protected java.lang.Integer  __company_record_id ;
	protected java.lang.Integer  __link_num ;
}
