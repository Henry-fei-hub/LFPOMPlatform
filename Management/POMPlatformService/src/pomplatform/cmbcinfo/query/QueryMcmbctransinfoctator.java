...
public class QueryMcmbctransinfoctator extends AbstractQuery<BaseMcmbctransinfoctator, ConditionMcmbctransinfoctator>
{

	private static final Logger __logger = Logger.getLogger(QueryMcmbctransinfoctator.class);

	public QueryMcmbctransinfoctator() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseMcmbctransinfoctator> executeQuery( KeyValuePair[] replacements, ConditionMcmbctransinfoctator condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseMcmbctransinfoctator generateBase(Object[] __data) throws java.sql.SQLException {
		BaseMcmbctransinfoctator __base = new BaseMcmbctransinfoctator();
		int count = 0;
		Object val;
