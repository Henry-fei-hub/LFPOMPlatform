...
public class CreateCMBBankXmlUtil {
	...
	public static String createGetSysInfoXML(Map<String, Object> params){
		...
		dattypElement.addText("2");
		Element lgnnamElement = infoElement.addElement("LGNNAM");
		lgnnamElement.addText(LGNNAM);
	 ...
	 * @return
	 */
	public static String createListModeXML(Map<String, Object> params){
		Document document = DocumentHelper.createDocument();
		document.setXMLEncoding("GBK");
		...
		Element infoElement = rootElement.addElement("INFO");
		Element funnamElement = infoElement.addElement("FUNNAM");
		funnamElement.addText("ListMode");
		Element dattypElement = infoElement.addElement("DATTYP");
		dattypElement.addText("2");
		Element lgnnamElement = infoElement.addElement("LGNNAM");
		lgnnamElement.addText(LGNNAM);
		
		Element sdksyinfxElement = rootElement.addElement("SDKMDLSTX");
	 ...
	 * @return
	 */
	public static String createGetAccInfoXML(List<Map<String, Object>> list){
		Document document = DocumentHelper.createDocument();
		document.setXMLEncoding("GBK");
		...
		for (Map<String, Object> map : list) {
			...
			bbknbrElement.addText(BaseHelpUtils.getStringValue(map, "BBKNBR"));
			Element c_bbknbrElement = sdksyinfxElement.addElement("C_BBKNBR");
			c_bbknbrElement.addText(BaseHelpUtils.getStringValue(map, "C_BBKNBR"));
	 ...
	 * @return
	 */
	public static String createInsidePaymentXML(Map<String, Object> params, List<Map<String, Object>> list){
		Document document = DocumentHelper.createDocument();
		document.setXMLEncoding("GBK");
		...
		for (Map<String, Object> map : list) {
			...
			Element crtaccElement = sdkpaydtxElement.addElement("CRTACC");
			crtaccElement.addText(BaseHelpUtils.getStringValue(map, "CRTACC"));
			Element crtbbkElement = sdkpaydtxElement.addElement("CRTBBK");
			crtbbkElement.addText(BaseHelpUtils.getStringValue(map, "CRTBBK"));
			Element c_crtbbkElement = sdkpaydtxElement.addElement("C_CRTBBK");
			c_crtbbkElement.addText(BaseHelpUtils.getStringValue(map, "C_CRTBBK"));
		}
	...
	public static String createAgentRequestXML(Map<String, Object> params, List<Map<String, Object>> list){
		...
		Element infoElement = rootElement.addElement("INFO");
		Element funnamElement = infoElement.addElement("FUNNAM");
		funnamElement.addText("AgentRequest");
		Element dattypElement = infoElement.addElement("DATTYP");
		dattypElement.addText("2");
		Element lgnnamElement = infoElement.addElement("LGNNAM");
		lgnnamElement.addText(LGNNAM);
	 ...
	 * @return
	 */
	public static String createGetAgentInfoXML(Map<String, Object> params){
		Document document = DocumentHelper.createDocument();
		document.setXMLEncoding("GBK");
	 ...
	 * @return
	 */
	public static String createGetAgentDetailXML(Map<String, Object> params){
		Document document = DocumentHelper.createDocument();
		document.setXMLEncoding("GBK");
