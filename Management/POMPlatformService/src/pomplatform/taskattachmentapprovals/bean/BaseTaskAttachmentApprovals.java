package pomplatform.taskattachmentapprovals.bean;
...
public class BaseTaskAttachmentApprovals extends GenericBase implements BaseFactory<BaseTaskAttachmentApprovals>, Comparable<BaseTaskAttachmentApprovals> 
{


	public static BaseTaskAttachmentApprovals newInstance(){
		return new BaseTaskAttachmentApprovals();
	}

	@Override
	public BaseTaskAttachmentApprovals make(){
		BaseTaskAttachmentApprovals b = new BaseTaskAttachmentApprovals();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,业务编码,业务名称,活动编码,流程编码,流程实列编码,返回数据集,附加节点，说明节点是预定义的节点还是动态加的节点， 0 - 正常定义的节点， 1 - 申请人或者审批人加的处理人或者审批人,当前流程实例节点的内部编码,流程实例节点创建时间,流程实例节点开始处于活动时间,状态,操作时间,提交意见,文件路径,主键id,预算管理id,附件编码,附件名称,上传人员,上传人员归属部门,上传时间,附件备注,合同金额,合同已付款金额,剩余合同金额,供应商,项目id,发票编码,预算类别  budget_detail_type,是否审批 0.未审批 1.审批进行中,2.已审批,is_lock,节点类型 0 - 开始 1 - 结束 2 - 审批 3 - 处理 4 - 知会";
	...
	public void cloneCopy(BaseTaskAttachmentApprovals __bean){
	...
	@Override
	public int compareTo(BaseTaskAttachmentApprovals o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseTaskAttachmentApprovals o = (BaseTaskAttachmentApprovals)obj;
