...
public class BaseSsysteminitloglstor extends GenericBase implements BaseFactory<BaseSsysteminitloglstor>, Comparable<BaseSsysteminitloglstor> 
{


	public static BaseSsysteminitloglstor newInstance(){
		return new BaseSsysteminitloglstor();
	}

	@Override
	public BaseSsysteminitloglstor make(){
		BaseSsysteminitloglstor b = new BaseSsysteminitloglstor();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "system_init_log_id,导入类型  1基础数据 2历史数据,log_msg,create_time,1成功  2失败";
	...
	public void cloneCopy(BaseSsysteminitloglstor __bean){
	...
	@Override
	public int compareTo(BaseSsysteminitloglstor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSsysteminitloglstor o = (BaseSsysteminitloglstor)obj;
