...
public class BaseGContractInfo extends GenericBase implements BaseFactory<BaseGContractInfo>, Comparable<BaseGContractInfo> 
{


	public static BaseGContractInfo newInstance(){
		return new BaseGContractInfo();
	}

	@Override
	public BaseGContractInfo make(){
		BaseGContractInfo b = new BaseGContractInfo();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "合同编码,主合同编号,主合同名称,客户名称,开始日期,结束日期,结算状态,项目编号,合同类别,项目等级,项目总工期,签约总金额,总设计面积,合同单价,项目地点,合同跟进人,备注,合同签订日期,创建时间,修改时间,我方签约公司名称,业务类别,流转状态";
	...
	public void cloneCopy(BaseGContractInfo __bean){
	...
	@Override
	public int compareTo(BaseGContractInfo o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseGContractInfo o = (BaseGContractInfo)obj;
