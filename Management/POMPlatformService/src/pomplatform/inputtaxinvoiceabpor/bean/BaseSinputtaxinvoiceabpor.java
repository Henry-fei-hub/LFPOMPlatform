...
public class BaseSinputtaxinvoiceabpor extends GenericBase implements BaseFactory<BaseSinputtaxinvoiceabpor>, Comparable<BaseSinputtaxinvoiceabpor> 
{


	public static BaseSinputtaxinvoiceabpor newInstance(){
		return new BaseSinputtaxinvoiceabpor();
	}

	@Override
	public BaseSinputtaxinvoiceabpor make(){
		BaseSinputtaxinvoiceabpor b = new BaseSinputtaxinvoiceabpor();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键,发票类型 1专票，2普票 ，3代开,发票代码(10位 每次批量录入是一样),发票号码(8位),开票日期,开票金额(如 100),税率(如 6%),operator,创建时间,备注,其他备注,销方税号,税额,销方名称,年,月,是否勾选";
	...
	public void cloneCopy(BaseSinputtaxinvoiceabpor __bean){
	...
	@Override
	public int compareTo(BaseSinputtaxinvoiceabpor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSinputtaxinvoiceabpor o = (BaseSinputtaxinvoiceabpor)obj;
