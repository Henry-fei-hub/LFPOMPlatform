...
public class ConditionProjectStageAuditInfo extends GenericCondition{

	public ConditionProjectStageAuditInfo(){
		setParameterCount(61);
	}
	...
	public java.lang.String toJSONString() {
		...
		if(getStartDateDetail() != null) sb.append(__wrapNumber(1, "startDateDetail", getStartDateDetail()));
		if(getEndDate() != null) sb.append(__wrapDate(1, "endDate", getEndDate()));
		if(getEndDateDetail() != null) sb.append(__wrapNumber(1, "endDateDetail", getEndDateDetail()));
		if(getDays() != null) sb.append(__wrapNumber(1, "days", getDays()));
		...
		if(getPlan() != null) sb.append(__wrapString(1, "plan", getPlan()));
		if(getTransportation() != null) sb.append(__wrapString(1, "transportation", getTransportation()));
		if(getFee() != null) sb.append(__wrapNumber(1, "fee", getFee()));
		if(getUnit() != null) sb.append(__wrapString(1, "unit", getUnit()));
		if(getContactPerson() != null) sb.append(__wrapString(1, "contactPerson", getContactPerson()));
		...
		if(getSubType() != null) sb.append(__wrapString(1, "subType", getSubType()));
		if(getHours() != null) sb.append(__wrapNumber(1, "hours", getHours()));
		if(getCompanyProvince() != null) sb.append(__wrapNumber(1, "companyProvince", getCompanyProvince()));
		if(getTargetProvince() != null) sb.append(__wrapNumber(1, "targetProvince", getTargetProvince()));
		if(getNumberOfBaby() != null) sb.append(__wrapNumber(1, "numberOfBaby", getNumberOfBaby()));
		if(getAttachment() != null) sb.append(__wrapString(1, "attachment", getAttachment()));
		if(getIsCompleted() != null) sb.append(__wrapBoolean(1, "isCompleted", getIsCompleted()));
		if(getSubTypeStr() != null) sb.append(__wrapString(1, "subTypeStr", getSubTypeStr()));
		...
		if(getIsRemoteCity() != null) sb.append(__wrapBoolean(1, "isRemoteCity", getIsRemoteCity()));
		if(getProvideAccommodation() != null) sb.append(__wrapBoolean(1, "provideAccommodation", getProvideAccommodation()));
		if(getLivingExpenses() != null) sb.append(__wrapNumber(1, "livingExpenses", getLivingExpenses()));
		if(getHousingFinance() != null) sb.append(__wrapNumber(1, "housingFinance", getHousingFinance()));
		...
		if(getSeverance() != null) sb.append(__wrapNumber(1, "severance", getSeverance()));
		if(getSalary1() != null) sb.append(__wrapString(1, "salary1", getSalary1()));
		if(getSalary2() != null) sb.append(__wrapString(1, "salary2", getSalary2()));
		if(getOriginalPay() != null) sb.append(__wrapString(1, "originalPay", getOriginalPay()));
		if(getMonthPay() != null) sb.append(__wrapString(1, "monthPay", getMonthPay()));
		if(getBasicProportionStr() != null) sb.append(__wrapString(1, "basicProportionStr", getBasicProportionStr()));
		if(getBasicProportion() != null) sb.append(__wrapNumber(1, "basicProportion", getBasicProportion()));
		if(getMonthBasicPay() != null) sb.append(__wrapString(1, "monthBasicPay", getMonthBasicPay()));
		if(getMonthPerformancePay() != null) sb.append(__wrapString(1, "monthPerformancePay", getMonthPerformancePay()));
		if(getForemanPay() != null) sb.append(__wrapString(1, "foremanPay", getForemanPay()));
		if(getOtherSubsidy() != null) sb.append(__wrapString(1, "otherSubsidy", getOtherSubsidy()));
		if(getTotalPay() != null) sb.append(__wrapString(1, "totalPay", getTotalPay()));
		if(getAnnualPerformance() != null) sb.append(__wrapString(1, "annualPerformance", getAnnualPerformance()));
		if(getCostAttribution() != null) sb.append(__wrapNumber(1, "costAttribution", getCostAttribution()));
		if(getCertificationTime() != null) sb.append(__wrapDate(1, "certificationTime", getCertificationTime()));
		if(getProjectIds() != null) sb.append(__wrapNumber(1, "projectIds", getProjectIds()));
	...
	private java.lang.Integer __start_date_detail = null;
	private java.util.Date __end_date = null;
	private java.lang.Integer __end_date_detail = null;
	private java.math.BigDecimal __days = null;
	private java.lang.String __reason = null;
	private java.lang.String __remark = null;
	private java.lang.String __address = null;
	private java.lang.String __plan = null;
	private java.lang.String __transportation = null;
	private java.math.BigDecimal __fee = null;
	private java.lang.String __unit = null;
	private java.lang.String __contact_person = null;
	private java.util.Date __create_time = null;
	private java.lang.Integer __delete_flag = null;
	private java.lang.Integer __next_auditor = null;
	private java.lang.String __sub_type = null;
	private java.math.BigDecimal __hours = null;
	private java.lang.Integer __company_province = null;
	private java.lang.Integer __target_province = null;
	private java.lang.Integer __number_of_baby = null;
	private java.lang.String __attachment = null;
	private java.lang.Boolean __is_completed = null;
	private java.lang.String __sub_type_str = null;
	...
	private java.lang.Boolean __is_remote_city = null;
	private java.lang.Boolean __provide_accommodation = null;
	private java.math.BigDecimal __living_expenses = null;
	private java.math.BigDecimal __housing_finance = null;
	private java.lang.Integer __drafter = null;
	private java.lang.String __card = null;
	...
	private java.math.BigDecimal __severance = null;
	private java.lang.String __salary_1 = null;
	private java.lang.String __salary_2 = null;
	private java.lang.String __original_pay = null;
	private java.lang.String __month_pay = null;
	private java.lang.String __basic_proportion_str = null;
	private java.math.BigDecimal __basic_proportion = null;
	private java.lang.String __month_basic_pay = null;
	private java.lang.String __month_performance_pay = null;
	private java.lang.String __foreman_pay = null;
	private java.lang.String __other_subsidy = null;
	private java.lang.String __total_pay = null;
	private java.lang.String __annual_performance = null;
	private java.lang.Integer __cost_attribution = null;
	private java.util.Date __certification_time = null;
	private java.lang.Integer __project_ids = null;
