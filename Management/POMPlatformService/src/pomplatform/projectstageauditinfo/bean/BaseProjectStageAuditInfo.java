...
public class BaseProjectStageAuditInfo extends GenericBase implements BaseFactory<BaseProjectStageAuditInfo>, Comparable<BaseProjectStageAuditInfo> 
{


	public static BaseProjectStageAuditInfo newInstance(){
		return new BaseProjectStageAuditInfo();
	}

	@Override
	public BaseProjectStageAuditInfo make(){
		BaseProjectStageAuditInfo b = new BaseProjectStageAuditInfo();
		return b;
	}
	...
	public void cloneCopy(BaseProjectStageAuditInfo __bean){
	...
	@Override
	public int compareTo(BaseProjectStageAuditInfo o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseProjectStageAuditInfo o = (BaseProjectStageAuditInfo)obj;
