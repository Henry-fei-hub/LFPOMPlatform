...
public class BaseMcontractppspcccfscsiiicpor extends GenericBase implements BaseFactory<BaseMcontractppspcccfscsiiicpor>, Comparable<BaseMcontractppspcccfscsiiicpor> 
{


	public static BaseMcontractppspcccfscsiiicpor newInstance(){
		return new BaseMcontractppspcccfscsiiicpor();
	}

	@Override
	public BaseMcontractppspcccfscsiiicpor make(){
		BaseMcontractppspcccfscsiiicpor b = new BaseMcontractppspcccfscsiiicpor();
		return b;
	}
	...
	public void cloneCopy(BaseMcontractppspcccfscsiiicpor __bean){
	...
	@Override
	public int compareTo(BaseMcontractppspcccfscsiiicpor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseMcontractppspcccfscsiiicpor o = (BaseMcontractppspcccfscsiiicpor)obj;
