...
public class BaseSprojectpcor extends GenericBase implements BaseFactory<BaseSprojectpcor>, Comparable<BaseSprojectpcor> 
{


	public static BaseSprojectpcor newInstance(){
		return new BaseSprojectpcor();
	}

	@Override
	public BaseSprojectpcor make(){
		BaseSprojectpcor b = new BaseSprojectpcor();
		return b;
	}
	...
	public void cloneCopy(BaseSprojectpcor __bean){
	...
	@Override
	public int compareTo(BaseSprojectpcor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSprojectpcor o = (BaseSprojectpcor)obj;
