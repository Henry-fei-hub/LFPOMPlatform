package pomplatform.projectStageStorage.bean;
...
public class BaseSprojectstagestorageor extends GenericBase implements BaseFactory<BaseSprojectstagestorageor>, Comparable<BaseSprojectstagestorageor> 
{


	public static BaseSprojectstagestorageor newInstance(){
		return new BaseSprojectstagestorageor();
	}

	@Override
	public BaseSprojectstagestorageor make(){
		BaseSprojectstagestorageor b = new BaseSprojectstagestorageor();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "id,项目编码,阶段代码,占比(%),项目积分,阶段名称,备注,是否原策划阶段 0是  1否,已确认积分,是否跨阶段 0是  1否";
	...
	public void cloneCopy(BaseSprojectstagestorageor __bean){
	...
	@Override
	public int compareTo(BaseSprojectstagestorageor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSprojectstagestorageor o = (BaseSprojectstagestorageor)obj;
