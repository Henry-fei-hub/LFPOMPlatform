...
public class BaseGetYearTotalContractAndRentMoney extends GenericBase implements BaseFactory<BaseGetYearTotalContractAndRentMoney>, Comparable<BaseGetYearTotalContractAndRentMoney> 
{


	public static BaseGetYearTotalContractAndRentMoney newInstance(){
		return new BaseGetYearTotalContractAndRentMoney();
	}

	@Override
	public BaseGetYearTotalContractAndRentMoney make(){
		BaseGetYearTotalContractAndRentMoney b = new BaseGetYearTotalContractAndRentMoney();
		return b;
	}
	...
	public void cloneCopy(BaseGetYearTotalContractAndRentMoney __bean){
	...
	@Override
	public int compareTo(BaseGetYearTotalContractAndRentMoney o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseGetYearTotalContractAndRentMoney o = (BaseGetYearTotalContractAndRentMoney)obj;
