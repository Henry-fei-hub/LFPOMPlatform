...
public class BaseContractLogList extends GenericBase implements BaseFactory<BaseContractLogList>, Comparable<BaseContractLogList> 
{


	public static BaseContractLogList newInstance(){
		return new BaseContractLogList();
	}

	@Override
	public BaseContractLogList make(){
		BaseContractLogList b = new BaseContractLogList();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "合同编号,合同名称,客户名称,签约总金额,我方签约公司名称,原始合同状态,新合同状态,操作人,操作日期";
	...
	public void cloneCopy(BaseContractLogList __bean){
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		sb.append(getOperateTime() == null ? "" : DateUtil.formatDateString(getOperateTime()));
		return sb.toString();
	}

	@Override
	public int compareTo(BaseContractLogList o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseContractLogList o = (BaseContractLogList)obj;
