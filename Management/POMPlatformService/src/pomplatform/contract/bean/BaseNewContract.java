...
public class BaseNewContract extends GenericBase implements BaseFactory<BaseNewContract>, Comparable<BaseNewContract> 
{


	public static BaseNewContract newInstance(){
		return new BaseNewContract();
	}

	@Override
	public BaseNewContract make(){
		BaseNewContract b = new BaseNewContract();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主订单编码,主订单编号,主订单名称,客户名称,开始日期,结束日期,结算状态,项目编号,合同类别,项目等级,项目总工期,签约总金额,总设计面积,合同单价,项目地点,合同跟进人,备注,合同签订日期,我方签约公司名称,创建时间,修改时间,业务类别,流转状态,流水号,项目类别,建筑面积,配合专业,省份,城市,详细地址,客户地址,服务建议书,立单时间";
	...
	public void cloneCopy(BaseNewContract __bean){
	...
	@Override
	public int compareTo(BaseNewContract o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseNewContract o = (BaseNewContract)obj;
