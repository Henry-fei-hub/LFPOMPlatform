...
public class BaseScontractccor extends GenericBase implements BaseFactory<BaseScontractccor>, Comparable<BaseScontractccor> 
{


	public static BaseScontractccor newInstance(){
		return new BaseScontractccor();
	}

	@Override
	public BaseScontractccor make(){
		BaseScontractccor b = new BaseScontractccor();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "合同编码,合同编号,合同名称,客户名称,开始日期,结束日期,状态";
	...
	public void cloneCopy(BaseScontractccor __bean){
	...
	@Override
	public int compareTo(BaseScontractccor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseScontractccor o = (BaseScontractccor)obj;
