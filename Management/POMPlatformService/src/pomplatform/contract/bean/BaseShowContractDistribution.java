...
public class BaseShowContractDistribution extends GenericBase implements BaseFactory<BaseShowContractDistribution>, Comparable<BaseShowContractDistribution> 
{


	public static BaseShowContractDistribution newInstance(){
		return new BaseShowContractDistribution();
	}

	@Override
	public BaseShowContractDistribution make(){
		BaseShowContractDistribution b = new BaseShowContractDistribution();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,合同,业务部门,业务类别,提成,操作人,创建时间,修改时间,删除状态,合同签订日期,实际参与分配的金额,订单号,部门经理,主订单名称,签约总金额";
	...
	public void cloneCopy(BaseShowContractDistribution __bean){
	...
	@Override
	public int compareTo(BaseShowContractDistribution o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseShowContractDistribution o = (BaseShowContractDistribution)obj;
