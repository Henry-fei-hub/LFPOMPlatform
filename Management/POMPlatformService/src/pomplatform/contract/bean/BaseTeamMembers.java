...
public class BaseTeamMembers extends GenericBase implements BaseFactory<BaseTeamMembers>, Comparable<BaseTeamMembers> 
{


	public static BaseTeamMembers newInstance(){
		return new BaseTeamMembers();
	}

	@Override
	public BaseTeamMembers make(){
		BaseTeamMembers b = new BaseTeamMembers();
		return b;
	}
	...
	public void cloneCopy(BaseTeamMembers __bean){
	...
	@Override
	public int compareTo(BaseTeamMembers o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseTeamMembers o = (BaseTeamMembers)obj;
