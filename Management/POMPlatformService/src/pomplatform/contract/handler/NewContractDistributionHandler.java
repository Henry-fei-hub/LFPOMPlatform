...
public class NewContractDistributionHandler implements GenericQuery,  GenericDownloadProcessor {

	private static final Logger __logger = Logger.getLogger(NewContractDistributionHandler.class);

	public static BaseCollection<BaseNewContractDistribution> executeQueryNewContractDistribution(ConditionNewContractDistribution c, KeyValuePair[] replacements ) throws Exception {
	...
	public String find(String creteria) throws Exception {
		...
		BaseCollection<BaseNewContractDistribution> result = executeQueryNewContractDistribution(c, c.getKeyValues());
	...
	public void execute(String creteria, File downFile, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try(PrintStream ps = new PrintStream(downFile, "GBK")){
			ps.println(BaseNewContractDistribution.ALL_CAPTIONS);
