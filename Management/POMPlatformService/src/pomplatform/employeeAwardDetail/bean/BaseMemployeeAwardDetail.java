...
public class BaseMemployeeAwardDetail extends GenericBase implements BaseFactory<BaseMemployeeAwardDetail>, Comparable<BaseMemployeeAwardDetail> 
{


	public static BaseMemployeeAwardDetail newInstance(){
		return new BaseMemployeeAwardDetail();
	}

	@Override
	public BaseMemployeeAwardDetail make(){
		BaseMemployeeAwardDetail b = new BaseMemployeeAwardDetail();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "头像,项目编码,员工编码,员工姓名,部门,业务部门,年份,月份,预分配积分,确认积分,项目成本,结算积分,价值积分,人工成本";
	...
	public void cloneCopy(BaseMemployeeAwardDetail __bean){
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		String strYears = delicacy.system.executor.SelectValueCache.getSelectValue("system_dictionary_18", String.valueOf(getYears()));
		sb.append(strYears == null ? "" : strYears);
		sb.append(",");
		String strMonths = delicacy.system.executor.SelectValueCache.getSelectValue("system_dictionary_19", String.valueOf(getMonths()));
		sb.append(strMonths == null ? "" : strMonths);
		sb.append(",");
	...
	@Override
	public int compareTo(BaseMemployeeAwardDetail o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseMemployeeAwardDetail o = (BaseMemployeeAwardDetail)obj;
