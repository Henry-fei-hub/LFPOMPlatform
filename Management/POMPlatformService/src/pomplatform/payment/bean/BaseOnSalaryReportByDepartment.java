...
public class BaseOnSalaryReportByDepartment extends GenericBase implements BaseFactory<BaseOnSalaryReportByDepartment>, Comparable<BaseOnSalaryReportByDepartment> 
{


	public static BaseOnSalaryReportByDepartment newInstance(){
		return new BaseOnSalaryReportByDepartment();
	}

	@Override
	public BaseOnSalaryReportByDepartment make(){
		BaseOnSalaryReportByDepartment b = new BaseOnSalaryReportByDepartment();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "归属部门,年份,月份,应付工资,离职补偿,应付奖金,应付合计,代扣个税,代扣社保,代扣公积金,代扣补贴,代扣重疾险,实发工资,工资发放人数,单位社保,单位公积金,应补退税";
	...
	public void cloneCopy(BaseOnSalaryReportByDepartment __bean){
	...
	@Override
	public int compareTo(BaseOnSalaryReportByDepartment o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseOnSalaryReportByDepartment o = (BaseOnSalaryReportByDepartment)obj;
