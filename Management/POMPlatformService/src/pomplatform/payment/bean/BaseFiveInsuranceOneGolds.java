...
public class BaseFiveInsuranceOneGolds extends GenericBase implements BaseFactory<BaseFiveInsuranceOneGolds>, Comparable<BaseFiveInsuranceOneGolds> 
{


	public static BaseFiveInsuranceOneGolds newInstance(){
		return new BaseFiveInsuranceOneGolds();
	}

	@Override
	public BaseFiveInsuranceOneGolds make(){
		BaseFiveInsuranceOneGolds b = new BaseFiveInsuranceOneGolds();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,员工编号,职员姓名,所属部门,业务部门,所属公司,年份,月份,应缴公积金合计,单位公积金合计,个人公积金合计,应缴社保合计,单位社保合计,个人社保合计,养老保险（单位）,医疗保险（单位）,大额医疗保险（单位）,工伤保险（单位）,失业保险（单位）,生育保险（单位）,养老保险（个人）,医疗保险（个人）,大额医疗保险（个人）,大病医疗保险（个人）,失业保险（个人）,采暖（个人）,操作人,操作时间,备注";
	public final static java.lang.String DOWNLOAD_CAPTIONS = "职员姓名,员工编号,所属部门,业务部门,所属公司,年份,月份,单位公积金合计,个人公积金合计,养老保险（单位）,医疗保险（单位）,大额医疗保险（单位）,工伤保险（单位）,失业保险（单位）,生育保险（单位）,残障金（单位）,养老保险（个人）,医疗保险（个人）,大额医疗保险（个人）,大病医疗保险（个人）,失业保险（个人）,采暖（个人）";
	...
	public void cloneCopy(BaseFiveInsuranceOneGolds __bean){
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		String companyId = delicacy.system.executor.SelectValueCache.getSelectValue("company_records",String.valueOf(getCompanyId()));
	...
	@Override
	public int compareTo(BaseFiveInsuranceOneGolds o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseFiveInsuranceOneGolds o = (BaseFiveInsuranceOneGolds)obj;
