...
public class BaseOnSalaryPlateBonusByCompany extends GenericBase implements BaseFactory<BaseOnSalaryPlateBonusByCompany>, Comparable<BaseOnSalaryPlateBonusByCompany> 
{


	public static BaseOnSalaryPlateBonusByCompany newInstance(){
		return new BaseOnSalaryPlateBonusByCompany();
	}

	@Override
	public BaseOnSalaryPlateBonusByCompany make(){
		BaseOnSalaryPlateBonusByCompany b = new BaseOnSalaryPlateBonusByCompany();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "业务部门,年份,月份,,,,,";
	...
	public void cloneCopy(BaseOnSalaryPlateBonusByCompany __bean){
	...
	@Override
	public int compareTo(BaseOnSalaryPlateBonusByCompany o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseOnSalaryPlateBonusByCompany o = (BaseOnSalaryPlateBonusByCompany)obj;
