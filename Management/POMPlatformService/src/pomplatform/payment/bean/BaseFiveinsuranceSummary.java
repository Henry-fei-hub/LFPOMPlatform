...
public class BaseFiveinsuranceSummary extends GenericBase implements BaseFactory<BaseFiveinsuranceSummary>, Comparable<BaseFiveinsuranceSummary> 
{


	public static BaseFiveinsuranceSummary newInstance(){
		return new BaseFiveinsuranceSummary();
	}

	@Override
	public BaseFiveinsuranceSummary make(){
		BaseFiveinsuranceSummary b = new BaseFiveinsuranceSummary();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "所属公司,年份,月份,应缴公积金合计,单位公积金合计,个人公积金合计,应缴社保合计,单位社保合计,个人社保合计,养老保险（单位）,医疗保险（单位）,大额医疗保险（单位）,工伤保险（单位）,失业保险（单位）,生育保险（单位）,养老保险（个人）,医疗保险（个人）,大额医疗保险（个人）,大病医疗保险（个人）,失业保险（个人）,采暖（个人）";
	...
	public void cloneCopy(BaseFiveinsuranceSummary __bean){
	...
	@Override
	public int compareTo(BaseFiveinsuranceSummary o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseFiveinsuranceSummary o = (BaseFiveinsuranceSummary)obj;
