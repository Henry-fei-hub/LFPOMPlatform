...
public class BaseOnSalaryPlateBonusByPlate extends GenericBase implements BaseFactory<BaseOnSalaryPlateBonusByPlate>, Comparable<BaseOnSalaryPlateBonusByPlate> 
{


	public static BaseOnSalaryPlateBonusByPlate newInstance(){
		return new BaseOnSalaryPlateBonusByPlate();
	}

	@Override
	public BaseOnSalaryPlateBonusByPlate make(){
		BaseOnSalaryPlateBonusByPlate b = new BaseOnSalaryPlateBonusByPlate();
		return b;
	}
	...
	public void cloneCopy(BaseOnSalaryPlateBonusByPlate __bean){
	...
	@Override
	public int compareTo(BaseOnSalaryPlateBonusByPlate o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseOnSalaryPlateBonusByPlate o = (BaseOnSalaryPlateBonusByPlate)obj;
