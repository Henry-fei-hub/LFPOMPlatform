...
public class BaseOnSalaryReportByPlate extends GenericBase implements BaseFactory<BaseOnSalaryReportByPlate>, Comparable<BaseOnSalaryReportByPlate> 
{


	public static BaseOnSalaryReportByPlate newInstance(){
		return new BaseOnSalaryReportByPlate();
	}

	@Override
	public BaseOnSalaryReportByPlate make(){
		BaseOnSalaryReportByPlate b = new BaseOnSalaryReportByPlate();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "业务部门,年份,月份,应付工资,离职补偿,应付奖金,应付合计,代扣个税,代扣社保,代扣公积金,代扣补贴,代扣重疾险,实发工资,工资发放人数,单位社保,单位公积金,应补退税,暂扣奖金";
	...
	public void cloneCopy(BaseOnSalaryReportByPlate __bean){
	...
	@Override
	public int compareTo(BaseOnSalaryReportByPlate o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseOnSalaryReportByPlate o = (BaseOnSalaryReportByPlate)obj;
