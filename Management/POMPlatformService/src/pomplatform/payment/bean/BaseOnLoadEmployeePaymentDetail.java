...
public class BaseOnLoadEmployeePaymentDetail extends GenericBase implements BaseFactory<BaseOnLoadEmployeePaymentDetail>, Comparable<BaseOnLoadEmployeePaymentDetail> 
{


	public static BaseOnLoadEmployeePaymentDetail newInstance(){
		return new BaseOnLoadEmployeePaymentDetail();
	}

	@Override
	public BaseOnLoadEmployeePaymentDetail make(){
		BaseOnLoadEmployeePaymentDetail b = new BaseOnLoadEmployeePaymentDetail();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "员工编号,员工姓名,归属公司,部门,主键编码,职员编码,日期,星期,月薪,基本比例（显示用）,基本比例（计算用）,月基本工资,月绩效工资,工龄工资,月工作日,月天数,日工作时间,日工资,日工龄工资,日成本,单位公积金合计,考勤备注,迟到/早退10分钟,迟到/早退30分钟,扣款迟到/早退,事假天数,事假小时数,病假天数,病假扣款比例(显示用),病假扣款比例(计算用),迟到小计,事假小计,病假小计,扣款小计,病假小时数,单位社保合计,全薪,日考勤扣款工资,是否加锁";
	...
	public void cloneCopy(BaseOnLoadEmployeePaymentDetail __bean){
	...
	@Override
	public int compareTo(BaseOnLoadEmployeePaymentDetail o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseOnLoadEmployeePaymentDetail o = (BaseOnLoadEmployeePaymentDetail)obj;
