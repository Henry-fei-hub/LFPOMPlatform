...
public class BaseOnLoadSalaryPaymentChange extends GenericBase implements BaseFactory<BaseOnLoadSalaryPaymentChange>, Comparable<BaseOnLoadSalaryPaymentChange> 
{


	public static BaseOnLoadSalaryPaymentChange newInstance(){
		return new BaseOnLoadSalaryPaymentChange();
	}

	@Override
	public BaseOnLoadSalaryPaymentChange make(){
		BaseOnLoadSalaryPaymentChange b = new BaseOnLoadSalaryPaymentChange();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "归属公司,业务部门,年份,月份,应发工资,离职补偿,应付奖金,应付合计,代扣个税,代扣社保,代扣养老,代扣医疗,代扣失业,代扣大额,代扣采暖,代扣公积金,代扣其他,重疾险,实发工资,工资发放人数";
	...
	public void cloneCopy(BaseOnLoadSalaryPaymentChange __bean){
	...
	@Override
	public int compareTo(BaseOnLoadSalaryPaymentChange o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseOnLoadSalaryPaymentChange o = (BaseOnLoadSalaryPaymentChange)obj;
