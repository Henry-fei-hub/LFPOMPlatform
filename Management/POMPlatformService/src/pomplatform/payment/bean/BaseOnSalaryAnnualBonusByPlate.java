...
public class BaseOnSalaryAnnualBonusByPlate extends GenericBase implements BaseFactory<BaseOnSalaryAnnualBonusByPlate>, Comparable<BaseOnSalaryAnnualBonusByPlate> 
{


	public static BaseOnSalaryAnnualBonusByPlate newInstance(){
		return new BaseOnSalaryAnnualBonusByPlate();
	}

	@Override
	public BaseOnSalaryAnnualBonusByPlate make(){
		BaseOnSalaryAnnualBonusByPlate b = new BaseOnSalaryAnnualBonusByPlate();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "业务部门,年份,应发13薪奖金,应发年度绩效工资,应发项目奖金,调户押金返还,调户押金扣除,应发合计,应纳个税,实发奖金,全薪,补/扣工资差额,报销扣款,其他扣款,备注,流程业务表Id,流程状态,发放时间";
	...
	public void cloneCopy(BaseOnSalaryAnnualBonusByPlate __bean){
	...
	@Override
	public int compareTo(BaseOnSalaryAnnualBonusByPlate o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseOnSalaryAnnualBonusByPlate o = (BaseOnSalaryAnnualBonusByPlate)obj;
