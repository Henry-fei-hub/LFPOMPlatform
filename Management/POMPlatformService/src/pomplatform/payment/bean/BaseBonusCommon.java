...
public class BaseBonusCommon extends GenericBase implements BaseFactory<BaseBonusCommon>, Comparable<BaseBonusCommon> 
{


	public static BaseBonusCommon newInstance(){
		return new BaseBonusCommon();
	}

	@Override
	public BaseBonusCommon make(){
		BaseBonusCommon b = new BaseBonusCommon();
		return b;
	}
	...
	public void cloneCopy(BaseBonusCommon __bean){
	...
	@Override
	public int compareTo(BaseBonusCommon o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseBonusCommon o = (BaseBonusCommon)obj;
