...
public class BaseOnSalaryBonusSendData extends GenericBase implements BaseFactory<BaseOnSalaryBonusSendData>, Comparable<BaseOnSalaryBonusSendData> 
{


	public static BaseOnSalaryBonusSendData newInstance(){
		return new BaseOnSalaryBonusSendData();
	}

	@Override
	public BaseOnSalaryBonusSendData make(){
		BaseOnSalaryBonusSendData b = new BaseOnSalaryBonusSendData();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "归属公司,员工编号,员工姓名,银行账号,年份,月份,实发奖金";
	...
	public void cloneCopy(BaseOnSalaryBonusSendData __bean){
	...
	@Override
	public int compareTo(BaseOnSalaryBonusSendData o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseOnSalaryBonusSendData o = (BaseOnSalaryBonusSendData)obj;
