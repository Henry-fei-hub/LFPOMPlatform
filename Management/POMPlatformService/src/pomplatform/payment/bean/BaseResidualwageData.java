...
public class BaseResidualwageData extends GenericBase implements BaseFactory<BaseResidualwageData>, Comparable<BaseResidualwageData> 
{


	public static BaseResidualwageData newInstance(){
		return new BaseResidualwageData();
	}

	@Override
	public BaseResidualwageData make(){
		BaseResidualwageData b = new BaseResidualwageData();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "归属公司,员工id,员工编号,员工姓名,银行账号,年份,月份,,发放钱数,,发放比例";
	...
	public void cloneCopy(BaseResidualwageData __bean){
	...
	@Override
	public int compareTo(BaseResidualwageData o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseResidualwageData o = (BaseResidualwageData)obj;
