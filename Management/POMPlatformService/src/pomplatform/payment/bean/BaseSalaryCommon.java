...
public class BaseSalaryCommon extends GenericBase implements BaseFactory<BaseSalaryCommon>, Comparable<BaseSalaryCommon> 
{


	public static BaseSalaryCommon newInstance(){
		return new BaseSalaryCommon();
	}

	@Override
	public BaseSalaryCommon make(){
		BaseSalaryCommon b = new BaseSalaryCommon();
		return b;
	}
	...
	public void cloneCopy(BaseSalaryCommon __bean){
	...
	@Override
	public int compareTo(BaseSalaryCommon o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSalaryCommon o = (BaseSalaryCommon)obj;
