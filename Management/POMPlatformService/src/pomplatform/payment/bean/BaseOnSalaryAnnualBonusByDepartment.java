...
public class BaseOnSalaryAnnualBonusByDepartment extends GenericBase implements BaseFactory<BaseOnSalaryAnnualBonusByDepartment>, Comparable<BaseOnSalaryAnnualBonusByDepartment> 
{


	public static BaseOnSalaryAnnualBonusByDepartment newInstance(){
		return new BaseOnSalaryAnnualBonusByDepartment();
	}

	@Override
	public BaseOnSalaryAnnualBonusByDepartment make(){
		BaseOnSalaryAnnualBonusByDepartment b = new BaseOnSalaryAnnualBonusByDepartment();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "所属部门,年份,应发13薪奖金,应发年度绩效工资,应发项目奖金,调户押金返还,调户押金扣除,应发合计,应纳个税,实发奖金,全薪,补/扣工资差额,报销扣款,其他扣款,备注,流程业务表Id,流程状态,发放时间";
	...
	public java.math.BigDecimal getOneToThreeRest() {
		return this.__one_to_three_rest;
	}

	public void setOneToThreeRest( java.math.BigDecimal value ) {
		this.__one_to_three_rest = value;
	}

	public java.math.BigDecimal getHousingSubsidy() {
		return this.__housing_subsidy;
	}

	public void setHousingSubsidy( java.math.BigDecimal value ) {
		this.__housing_subsidy = value;
	}

	public java.math.BigDecimal getDeductPerformanceBonus() {
		return this.__deduct_performance_bonus;
	}

	public void setDeductPerformanceBonus( java.math.BigDecimal value ) {
	...
	public void cloneCopy(BaseOnSalaryAnnualBonusByDepartment __bean){
	...
	@Override
	public int compareTo(BaseOnSalaryAnnualBonusByDepartment o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseOnSalaryAnnualBonusByDepartment o = (BaseOnSalaryAnnualBonusByDepartment)obj;
	...
	public java.lang.String toJSONString() {
		...
		if(getOneToThreeRest() != null) sb.append(__wrapDecimal(count++, "oneToThreeRest", getOneToThreeRest()));
		if(getHousingSubsidy() != null) sb.append(__wrapDecimal(count++, "housingSubsidy", getHousingSubsidy()));
		if(getDeductPerformanceBonus() != null) sb.append(__wrapDecimal(count++, "deductPerformanceBonus", getDeductPerformanceBonus()));
	...
	public void setDataFromMap(Map<String, Object> values){
		...
		if((val = values.get("oneToThreeRest")) != null) setOneToThreeRest(__getDecimal(val));  
		if((val = values.get("housingSubsidy")) != null) setHousingSubsidy(__getDecimal(val));  
		if((val = values.get("deductPerformanceBonus")) != null) setDeductPerformanceBonus(__getDecimal(val)); 
	...
	protected java.math.BigDecimal  __one_to_three_rest ;
	protected java.math.BigDecimal  __housing_subsidy ;
	protected java.math.BigDecimal  __deduct_performance_bonus ;
