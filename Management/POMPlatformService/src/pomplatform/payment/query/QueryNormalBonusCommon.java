...
public class QueryNormalBonusCommon extends AbstractQuery<BaseNormalBonusCommon, ConditionNormalBonusCommon>
{

	private static final Logger __logger = Logger.getLogger(QueryNormalBonusCommon.class);

	public QueryNormalBonusCommon() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseNormalBonusCommon> executeQuery( KeyValuePair[] replacements, ConditionNormalBonusCommon condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseNormalBonusCommon generateBase(Object[] __data) throws java.sql.SQLException {
		BaseNormalBonusCommon __base = new BaseNormalBonusCommon();
		int count = 0;
		Object val;
	...
	private final static String[] fieldNames = { "company_id", "year", "month", "personnel_business_id", "salary_type"};
}
