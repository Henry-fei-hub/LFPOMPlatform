...
import pomplatform.payment.bean.BaseNormalSalaryCommon;
import pomplatform.payment.bean.ConditionNormalSalaryCommon;

public class QueryNormalSalaryCommon extends AbstractQuery<BaseNormalSalaryCommon, ConditionNormalSalaryCommon>
{

	private static final Logger __logger = Logger.getLogger(QueryNormalSalaryCommon.class);

	public QueryNormalSalaryCommon() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseNormalSalaryCommon> executeQuery( KeyValuePair[] replacements, ConditionNormalSalaryCommon condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseNormalSalaryCommon generateBase(Object[] __data) throws java.sql.SQLException {
		BaseNormalSalaryCommon __base = new BaseNormalSalaryCommon();
		int count = 0;
		Object val;
	...
	private final static String[] fieldNames = { "employee_id", "plate_id", "company_id", "salary_type", "year", "month", "year", "month", "company_id"};
}
