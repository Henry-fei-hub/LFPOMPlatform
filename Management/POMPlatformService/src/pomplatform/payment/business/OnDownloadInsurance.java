...
public class OnDownloadInsurance implements GenericQuery,  GenericDownloadProcessor {

	private static final Logger __logger = Logger.getLogger(OnDownloadInsurance.class);

	public static BaseCollection<BaseFiveInsuranceOneGolds> executeQueryInsurance(ConditionFiveInsuranceOneGolds c, KeyValuePair[] replacements ) throws Exception {
	...
	public String find(String creteria) throws Exception {
		...
		BaseCollection<BaseFiveInsuranceOneGolds> result = executeQueryInsurance(c, c.getKeyValues());
	...
	public void execute(String creteria, File downFile, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try(PrintStream ps = new PrintStream(downFile, "GBK")){
			ps.println(BaseFiveInsuranceOneGolds.DOWNLOAD_CAPTIONS);
