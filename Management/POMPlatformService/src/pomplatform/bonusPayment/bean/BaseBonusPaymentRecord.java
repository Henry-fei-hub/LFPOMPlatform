...
public class BaseBonusPaymentRecord extends GenericBase implements BaseFactory<BaseBonusPaymentRecord>, Comparable<BaseBonusPaymentRecord> 
{


	public static BaseBonusPaymentRecord newInstance(){
		return new BaseBonusPaymentRecord();
	}

	@Override
	public BaseBonusPaymentRecord make(){
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,业务部门,发放积分,发放年月,申请缘由,申请人,申请时间,审核状态,审核意见,审核人,审核时间";
	...
	public void cloneCopy(BaseBonusPaymentRecord __bean){
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		String strState = delicacy.system.executor.SelectValueCache.getSelectValue("system_dictionary_36", String.valueOf(getState()));
		sb.append(strState == null ? "" : strState);
		sb.append(",");
		sb.append(getOpinion() == null ? "" : getOpinion());
		sb.append(",");
		String strAuditor = delicacy.system.executor.SelectValueCache.getSelectValue("employees", String.valueOf(getAuditor()));
		sb.append(strAuditor == null ? "" : strAuditor);
		sb.append(",");
	...
	@Override
	public int compareTo(BaseBonusPaymentRecord o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseBonusPaymentRecord o = (BaseBonusPaymentRecord)obj;
