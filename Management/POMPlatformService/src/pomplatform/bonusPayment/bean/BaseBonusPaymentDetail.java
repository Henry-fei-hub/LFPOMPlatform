...
public class BaseBonusPaymentDetail extends GenericBase implements BaseFactory<BaseBonusPaymentDetail>, Comparable<BaseBonusPaymentDetail> 
{
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,奖金发放记录编码,业务部门,员工编码,工号,姓名,价值积分,发放比率(%),发放积分,剩余积分,发放年月,审核状态,在职状态,发放次数,第一次发放积分,第二次发放积分,第三次发放积分";
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		String DepartmentName = delicacy.system.executor.SelectValueCache.getSelectValue("departments", String.valueOf(getDepartmentId()));
		sb.append(DepartmentName == null ? "" : DepartmentName);
		return sb.toString();
	}
	...
	public int hashCode() {
		...
		hash = 97 * hash + Objects.hashCode(this.canEdit);
	...
	public boolean equals(Object obj) {
		...
		if(!Objects.equals(this.canEdit, o.getCanEdit())) return false;
	...
	public java.lang.String toJSONString() {
		...
		if(getCanEdit() != null) sb.append(__wrapBoolean(count++, "canEdit", getCanEdit()));
	...
	public void setDataFromMap(Map<String, Object> values){
		...
		if((val = values.get("canEdit")) != null) setCanEdit(__getBoolean(val)); 
	...
	protected java.lang.Boolean canEdit = true;
