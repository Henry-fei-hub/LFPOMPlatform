...
public class BaseMemployeeaccountrecordeeeor extends GenericBase implements BaseFactory<BaseMemployeeaccountrecordeeeor>, Comparable<BaseMemployeeaccountrecordeeeor> 
{


	public static BaseMemployeeaccountrecordeeeor newInstance(){
		return new BaseMemployeeaccountrecordeeeor();
	}

	@Override
	public BaseMemployeeaccountrecordeeeor make(){
		BaseMemployeeaccountrecordeeeor b = new BaseMemployeeaccountrecordeeeor();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,职员编码,业务部门,业务功能编码,10绩效奖金),积分,日期,是否加锁,操作人,操作时间,备注";
	...
	public void cloneCopy(BaseMemployeeaccountrecordeeeor __bean){
	...
	@Override
	public int compareTo(BaseMemployeeaccountrecordeeeor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseMemployeeaccountrecordeeeor o = (BaseMemployeeaccountrecordeeeor)obj;
	...
	public Map<String, Object> toMap() {
		...
		if(getEmployeeAccountRecordId() != null) res.put("employeeAccountRecordId", getEmployeeAccountRecordId());
