...
public class BaseBonusPaymentApplyOfWorkflow extends GenericBase implements BaseFactory<BaseBonusPaymentApplyOfWorkflow>, Comparable<BaseBonusPaymentApplyOfWorkflow> 
{


	public static BaseBonusPaymentApplyOfWorkflow newInstance(){
		return new BaseBonusPaymentApplyOfWorkflow();
	}

	@Override
	public BaseBonusPaymentApplyOfWorkflow make(){
		BaseBonusPaymentApplyOfWorkflow b = new BaseBonusPaymentApplyOfWorkflow();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,流程类型,业务编码,业务名称,流程编码,活动实列编码,流程状态 0 发起中  1,创建时间,完成时间,主键编码,业务部门,发放积分,发放日期 改成 申请日期,备注,申请人,申请时间 /创建时间,审核状态  0未审核   1审核通过    2审核不通过,审核人,审核时间 改成 发放日期,审核意见,是否二级部门提交的";
	...
	public void cloneCopy(BaseBonusPaymentApplyOfWorkflow __bean){
	...
	@Override
	public int compareTo(BaseBonusPaymentApplyOfWorkflow o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseBonusPaymentApplyOfWorkflow o = (BaseBonusPaymentApplyOfWorkflow)obj;
