...
public class BaseRefuseProjectQuoteTemplate extends GenericBase implements BaseFactory<BaseRefuseProjectQuoteTemplate>, Comparable<BaseRefuseProjectQuoteTemplate> 
{


	public static BaseRefuseProjectQuoteTemplate newInstance(){
		return new BaseRefuseProjectQuoteTemplate();
	}

	@Override
	public BaseRefuseProjectQuoteTemplate make(){
		BaseRefuseProjectQuoteTemplate b = new BaseRefuseProjectQuoteTemplate();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,流程类型,业务编码,业务名称,流程编码,活动实列编码,流程状态,创建时间,完成时间,创建人,信息编号,项目名称,项目地址（省）,项目地址（市）,项目类别,开发商名称,项目来源渠道,联系人,联系电话,详细地址,项目面积,主键编码,项目id,报价状态,基准总额,小计总额,上浮金额,上浮系数,优惠金额,优惠系数,税金,其它税金（采买）,不含税合计,最终系数,含税合计,操作人,操作时间,备注,公司id,业务类别";
	...
	public void cloneCopy(BaseRefuseProjectQuoteTemplate __bean){
	...
	@Override
	public int compareTo(BaseRefuseProjectQuoteTemplate o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseRefuseProjectQuoteTemplate o = (BaseRefuseProjectQuoteTemplate)obj;
