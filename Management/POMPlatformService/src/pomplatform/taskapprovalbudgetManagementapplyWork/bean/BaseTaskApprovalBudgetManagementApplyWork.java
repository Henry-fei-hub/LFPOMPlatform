package pomplatform.taskapprovalbudgetManagementapplyWork.bean;
...
public class BaseTaskApprovalBudgetManagementApplyWork extends GenericBase implements BaseFactory<BaseTaskApprovalBudgetManagementApplyWork>, Comparable<BaseTaskApprovalBudgetManagementApplyWork> 
{


	public static BaseTaskApprovalBudgetManagementApplyWork newInstance(){
		return new BaseTaskApprovalBudgetManagementApplyWork();
	}

	@Override
	public BaseTaskApprovalBudgetManagementApplyWork make(){
		BaseTaskApprovalBudgetManagementApplyWork b = new BaseTaskApprovalBudgetManagementApplyWork();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,业务编码,业务名称,活动编码,流程编码,流程实列编码,返回数据集,附加节点，说明节点是预定义的节点还是动态加的节点， 0 - 正常定义的节点， 1 - 申请人或者审批人加的处理人或者审批人,当前流程实例节点的内部编码,流程实例节点创建时间,流程实例节点开始处于活动时间,状态,操作时间,提交意见,主键id,预算编号,预算类型,预算总金额,预算已用金额,预算剩余金额,申请人id,申请时间,预期关闭时间,预算单状态1,已立项，2立项进行中,项目编码,预算备注,发票编码,申请人归属部门,申请人归属公司,节点类型 0 - 开始 1 - 结束 2 - 审批 3 - 处理 4 - 知会";
	...
	public void cloneCopy(BaseTaskApprovalBudgetManagementApplyWork __bean){
	...
	@Override
	public int compareTo(BaseTaskApprovalBudgetManagementApplyWork o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseTaskApprovalBudgetManagementApplyWork o = (BaseTaskApprovalBudgetManagementApplyWork)obj;
