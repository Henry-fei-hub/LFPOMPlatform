...
public class BaseMyAttentions extends GenericBase implements BaseFactory<BaseMyAttentions>, Comparable<BaseMyAttentions> 
{


	public static BaseMyAttentions newInstance(){
		return new BaseMyAttentions();
	}

	@Override
	public BaseMyAttentions make(){
		BaseMyAttentions b = new BaseMyAttentions();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "流程类型,流程类型名称,需要处理的个数";
	...
	public void cloneCopy(BaseMyAttentions __bean){
	...
	@Override
	public int compareTo(BaseMyAttentions o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseMyAttentions o = (BaseMyAttentions)obj;
