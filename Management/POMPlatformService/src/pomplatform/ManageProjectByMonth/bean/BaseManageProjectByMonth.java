package pomplatform.ManageProjectByMonth.bean;
...
public class BaseManageProjectByMonth extends GenericBase implements BaseFactory<BaseManageProjectByMonth>, Comparable<BaseManageProjectByMonth> 
{


	public static BaseManageProjectByMonth newInstance(){
		return new BaseManageProjectByMonth();
	}

	@Override
	public BaseManageProjectByMonth make(){
		BaseManageProjectByMonth b = new BaseManageProjectByMonth();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "业务部门,年份,月份,项目总积分,剩余积分";
	...
	public void cloneCopy(BaseManageProjectByMonth __bean){
	...
	@Override
	public int compareTo(BaseManageProjectByMonth o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseManageProjectByMonth o = (BaseManageProjectByMonth)obj;
