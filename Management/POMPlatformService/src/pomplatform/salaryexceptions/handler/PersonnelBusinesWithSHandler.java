...
public class PersonnelBusinesWithSHandler implements GenericDao {

	public final static ThreadLocal currentRequest = new ThreadLocal();

	private static final Logger __logger = Logger.getLogger(PersonnelBusinesWithSHandler.class);

	public static BasePersonnelBusinesWithS getPersonnelBusinesWithSById( java.lang.Integer personnel_business_id )
	{
		try{
			TimeSpanCalculator tsc = new TimeSpanCalculator();
			tsc.recordTime();
			BasePersonnelBusinesWithS result;
			...
			if(dao.load(true)){
				...
				tsc.recordTime();
				__logger.info(String.format("Get PersonnelBusinesWithS By ID time used : [%1$d]", tsc.getLastTime()));
				return result;
			}
			return null;
		} catch(Exception ex) {
	...
	public static boolean isPersonnelBusinesWithSExists( pomplatform.salaryexceptions.bean.BasePersonnelBusinesWithS bean, String additional ) {
		...
		try{
			...
			tsc.recordTime();
			__logger.info(String.format("Query PersonnelBusinesWithS List time used : [%1$d]", tsc.getLastTime()));
			return res;
		} catch(Exception ex) {
			ex.printStackTrace();
			return false;
	...
	public static int countPersonnelBusinesWithS( pomplatform.salaryexceptions.bean.BasePersonnelBusinesWithS bean, String additional ) {
	...
	public static BaseCollection<BasePersonnelBusinesWithS> queryPersonnelBusinesWithS( BasePersonnelBusinesWithS bean, int pageNo, int pageLines, String additionalCondition ) {
		...
		try{
			...
			List<BasePersonnelBusinesWithS> result = dao.conditionalLoadExt(additionalCondition);
			BaseCollection<BasePersonnelBusinesWithS> col = new BaseCollection<>();
	...
	public static BasePersonnelBusinesWithS addToPersonnelBusinesWithS ( BasePersonnelBusinesWithS personnelbusineswiths ) {
		return addToPersonnelBusinesWithS ( personnelbusineswiths , false);
	}

	public static BasePersonnelBusinesWithS addToPersonnelBusinesWithS ( BasePersonnelBusinesWithS personnelbusineswiths, boolean singleTransaction ) {
		try{
			TimeSpanCalculator tsc = new TimeSpanCalculator();
			tsc.recordTime();
			if(singleTransaction) ThreadConnection.beginTransaction();
			PersonnelBusinesWithS dao = new PersonnelBusinesWithS();
			dao.setDataFromBase(personnelbusineswiths);
			int result = dao.save();
			if(singleTransaction) ThreadConnection.commit();
			tsc.recordTime();
			__logger.info(String.format("Add to PersonnelBusinesWithS time used : [%1$d]", tsc.getLastTime()));
	...
	public static BasePersonnelBusinesWithS addUpdatePersonnelBusinesWithS ( BasePersonnelBusinesWithS personnelbusineswiths ) {
		return addUpdatePersonnelBusinesWithS ( personnelbusineswiths , false);
	}

	public static BasePersonnelBusinesWithS addUpdatePersonnelBusinesWithS ( BasePersonnelBusinesWithS personnelbusineswiths, boolean singleTransaction  ) {
		if(personnelbusineswiths.getPersonnelBusinessId() == null) return addToPersonnelBusinesWithS(personnelbusineswiths);
		try{
			TimeSpanCalculator tsc = new TimeSpanCalculator();
			tsc.recordTime();
			if(singleTransaction) ThreadConnection.beginTransaction();
	...
	public static BasePersonnelBusinesWithS deletePersonnelBusinesWithS ( BasePersonnelBusinesWithS bean ) {
		try{
			TimeSpanCalculator tsc = new TimeSpanCalculator();
			tsc.recordTime();
			PersonnelBusinesWithS dao = new PersonnelBusinesWithS();
			...
			tsc.recordTime();
			__logger.info(String.format("Delete PersonnelBusinesWithS time used : [%1$d]", tsc.getLastTime()));
	...
	public static BasePersonnelBusinesWithS updatePersonnelBusinesWithS ( BasePersonnelBusinesWithS personnelbusineswiths ) {
		try{
			TimeSpanCalculator tsc = new TimeSpanCalculator();
			tsc.recordTime();
			PersonnelBusinesWithS dao = new PersonnelBusinesWithS();
			dao.setPersonnelBusinessId( personnelbusineswiths.getPersonnelBusinessId() );
			int result = 0;
			if( dao.load() ) {
				dao.setDataFromBase(personnelbusineswiths);
				result = dao.update();
			...
			tsc.recordTime();
			__logger.info(String.format("Update PersonnelBusinesWithS time used : [%1$d]", tsc.getLastTime()));
			return result == 1 ? personnelbusineswiths : null ;
		} catch(Exception ex) {
			ex.printStackTrace();
			return null;
		}
	...
	public static BasePersonnelBusinesWithS updatePersonnelBusinesWithSDirect( BasePersonnelBusinesWithS personnelbusineswiths ) {
		try{
			TimeSpanCalculator tsc = new TimeSpanCalculator();
			tsc.recordTime();
			PersonnelBusinesWithS dao = new PersonnelBusinesWithS();
	...
	public static int setDeleteConditions(BasePersonnelBusinesWithS bean, PersonnelBusinesWithS dao){
		int count = 0;
	...
	public static int setConditions(BasePersonnelBusinesWithS bean, PersonnelBusinesWithS dao){
		int count = 0;
		if(bean.getPersonnelBusinessId() != null) {
			dao.setConditionPersonnelBusinessId("=", bean.getPersonnelBusinessId());
			count++;
	...
	public String findUsingKey(String json) throws Exception{
		BasePersonnelBusinesWithS bean = new BasePersonnelBusinesWithS();
	...
	public String find(String json, int currentPage, int pageSize, String addtion) throws Exception{
		BaseCollection<BasePersonnelBusinesWithS> rlist = new BaseCollection<>();
		BasePersonnelBusinesWithS bean = new BasePersonnelBusinesWithS();
		...
		List<BasePersonnelBusinesWithS> result = dao.conditionalLoadExt(addtion);
