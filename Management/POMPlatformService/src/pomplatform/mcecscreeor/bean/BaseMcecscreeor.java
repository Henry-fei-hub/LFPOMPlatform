...
public class BaseMcecscreeor extends GenericBase implements BaseFactory<BaseMcecscreeor>, Comparable<BaseMcecscreeor> 
{


	public static BaseMcecscreeor newInstance(){
		return new BaseMcecscreeor();
	}

	@Override
	public BaseMcecscreeor make(){
		BaseMcecscreeor b = new BaseMcecscreeor();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键,签约公司,合同编号,备注,操作人,操作时间,员工姓名";
	...
	public void cloneCopy(BaseMcecscreeor __bean){
	...
	@Override
	public int compareTo(BaseMcecscreeor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseMcecscreeor o = (BaseMcecscreeor)obj;
