...
import pomplatform.role.dao.RoleWithR;
...
public class RoleWithRHandler implements GenericDao {
	...
	public static boolean isRoleWithRExists( pomplatform.role.bean.BaseRoleWithR bean, String additional ) {
	...
	public static int countRoleWithR( pomplatform.role.bean.BaseRoleWithR bean, String additional ) {
