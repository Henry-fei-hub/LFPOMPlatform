...
public class BaseSroleror extends GenericBase implements BaseFactory<BaseSroleror>, Comparable<BaseSroleror> 
{
	...
	public java.util.List<BaseRoleFunction> getDetailRoleFunction() {
		return this.__detailRoleFunction;
	}

	public void setDetailRoleFunction( java.util.List<BaseRoleFunction> value ) {
		this.__detailRoleFunction = value;
	}
	...
	public java.lang.String toJSONString() {
		...
		if(getDetailRoleFunction() != null)  sb.append(__wrapList(count++, "detailRoleFunction", getDetailRoleFunction()));
		return sb.toString();
	}
	...
	protected java.util.List<BaseRoleFunction> __detailRoleFunction = null;
}
