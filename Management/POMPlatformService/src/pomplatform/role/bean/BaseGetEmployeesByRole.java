...
public class BaseGetEmployeesByRole extends GenericBase implements BaseFactory<BaseGetEmployeesByRole>, Comparable<BaseGetEmployeesByRole> 
{


	public static BaseGetEmployeesByRole newInstance(){
		return new BaseGetEmployeesByRole();
	}

	@Override
	public BaseGetEmployeesByRole make(){
		BaseGetEmployeesByRole b = new BaseGetEmployeesByRole();
		return b;
	}
	...
	public void cloneCopy(BaseGetEmployeesByRole __bean){
	...
	@Override
	public int compareTo(BaseGetEmployeesByRole o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseGetEmployeesByRole o = (BaseGetEmployeesByRole)obj;
