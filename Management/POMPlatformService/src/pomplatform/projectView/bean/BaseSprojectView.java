...
public class BaseSprojectView extends GenericBase implements BaseFactory<BaseSprojectView>, Comparable<BaseSprojectView> 
{


	public static BaseSprojectView newInstance(){
		return new BaseSprojectView();
	}

	@Override
	public BaseSprojectView make(){
		BaseSprojectView b = new BaseSprojectView();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "公区面积,后勤面积,核算比例,项目总积分,预留积分,项目编码,合同编号,合同名称,客户名称,预估工时,归属部门,设计阶段,项目类型,项目编号,项目名称,项目计划开始日期,项目计划结束日期,项目开始日期,项目结束日期,项目状态,项目进度,项目负责人编码,项目负责人姓名,项目大小,项目积分,项目描述,预算,审核意见,项目等级,板块负责人,板块";
	...
	public java.util.List<BaseProjectCost> getDetailProjectCost() {
		return this.__detailProjectCost;
	}

	public void setDetailProjectCost( java.util.List<BaseProjectCost> value ) {
		this.__detailProjectCost = value;
	}

	public void cloneCopy(BaseSprojectView __bean){
	...
	@Override
	public int compareTo(BaseSprojectView o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSprojectView o = (BaseSprojectView)obj;
	...
	public java.lang.String toJSONString() {
		...
		if(getDetailProjectCost() != null)  sb.append(__wrapList(count++, "detailProjectCost", getDetailProjectCost()));
		return sb.toString();
	}
	...
	protected java.util.List<BaseProjectCost> __detailProjectCost = null;
}
