...
public class BaseMainProjectInfo extends GenericBase implements BaseFactory<BaseMainProjectInfo>, Comparable<BaseMainProjectInfo> 
{


	public static BaseMainProjectInfo newInstance(){
		return new BaseMainProjectInfo();
	}

	@Override
	public BaseMainProjectInfo make(){
		BaseMainProjectInfo b = new BaseMainProjectInfo();
		return b;
	}
	...
	public final static java.lang.String CS_PROJECT_SALESMAN = "project_salesman" ;
	public final static java.lang.String CS_PROJECT_SALES_TEAM_MANAGER = "project_sales_team_manager" ;
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,项目编号,项目名称,项目英文名称,项目状态,设计状态,拟签约公司,项目来源渠道,项目来源说明,设计合作单位,设计合作单位英文名称,项目营销团队,项目营销员,运营董事,主办设计团队,是否高层建筑,信息登记时间,正式立项时间,项目经理,项目主管领导,是否有合同,立项依据,信息编号,立项模式,设计资质章,业务类别,耐火等级,设计预估面积,项目总投资额,实际设计面积,建筑总面积,建筑高度,建筑楼层,装修造价控制,项目等级,省份,城市,详细地址,项目完成时间";
	...
	public java.lang.Integer getProjectSalesman() {
		return this.__project_salesman;
	}

	public void setProjectSalesman( java.lang.Integer value ) {
		this.__project_salesman = value;
	}

	public java.lang.Integer getProjectSalesTeamManager() {
		return this.__project_sales_team_manager;
	}

	public void setProjectSalesTeamManager( java.lang.Integer value ) {
		this.__project_sales_team_manager = value;
	}
	...
	public java.lang.Integer getProjectLeader() {
		return this.__project_leader;
	}

	public void setProjectLeader( java.lang.Integer value ) {
	...
	public void cloneCopy(BaseMainProjectInfo __bean){
		...
		__bean.setProjectSalesman(getProjectSalesman());
		__bean.setProjectSalesTeamManager(getProjectSalesTeamManager());
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		String strProjectSalesman = delicacy.system.executor.SelectValueCache.getSelectValue("employees", String.valueOf(getProjectSalesman()));
		sb.append(strProjectSalesman == null ? "" : strProjectSalesman);
		sb.append(",");
		String strProjectSalesTeamManager = delicacy.system.executor.SelectValueCache.getSelectValue("employees", String.valueOf(getProjectSalesTeamManager()));
		sb.append(strProjectSalesTeamManager == null ? "" : strProjectSalesTeamManager);
		sb.append(",");
	...
	@Override
	public int compareTo(BaseMainProjectInfo o) {
	...
	public int hashCode() {
		...
		hash = 97 * hash + Objects.hashCode(this.__project_salesman);
		hash = 97 * hash + Objects.hashCode(this.__project_sales_team_manager);
	...
	public boolean equals(Object obj) {
		...
		final BaseMainProjectInfo o = (BaseMainProjectInfo)obj;
		...
		if(!Objects.equals(this.__project_salesman, o.getProjectSalesman())) return false;
		if(!Objects.equals(this.__project_sales_team_manager, o.getProjectSalesTeamManager())) return false;
	...
	public java.lang.String toJSONString() {
		...
		if(getProjectSalesman() != null) sb.append(__wrapNumber(count++, "projectSalesman", getProjectSalesman()));
		if(getProjectSalesTeamManager() != null) sb.append(__wrapNumber(count++, "projectSalesTeamManager", getProjectSalesTeamManager()));
		...
		if(getProjectLeader() != null) sb.append(__wrapNumber(count++, "projectLeader", getProjectLeader()));
	...
	public void setDataFromMap(Map<String, Object> values){
		...
		if((val = values.get("projectSalesman")) != null) setProjectSalesman(__getInt(val)); 
		if((val = values.get("projectSalesTeamManager")) != null) setProjectSalesTeamManager(__getInt(val)); 
		...
		if((val = values.get("projectLeader")) != null) setProjectLeader(__getInt(val)); 
	...
	protected java.lang.Integer  __project_salesman ;
	protected java.lang.Integer  __project_sales_team_manager ;
	...
	protected java.lang.Integer  __project_leader ;
