...
public class BaseBidPaySheetProject extends GenericBase implements BaseFactory<BaseBidPaySheetProject>, Comparable<BaseBidPaySheetProject> 
{


	public static BaseBidPaySheetProject newInstance(){
		return new BaseBidPaySheetProject();
	}

	@Override
	public BaseBidPaySheetProject make(){
		BaseBidPaySheetProject b = new BaseBidPaySheetProject();
		return b;
	}
	...
	public void cloneCopy(BaseBidPaySheetProject __bean){
	...
	@Override
	public int compareTo(BaseBidPaySheetProject o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseBidPaySheetProject o = (BaseBidPaySheetProject)obj;
