...
public class BaseContractInfo extends GenericBase implements BaseFactory<BaseContractInfo>, Comparable<BaseContractInfo> 
{
	...
	public final static java.lang.String ALL_CAPTIONS = "合同编码,合同编号,合同名称,客户名称,开始日期,结束日期,状态,我方签约公司名称,项目编号,合同类型,业务类型,项目类型,项目等级,项目总工期,签约总金额,总设计面积,合同单价,项目地点,合同跟进人,备注,合同签订日期";
	...
	public java.lang.String getSigningCompanyName() {
		return this.__signing_company_name;
	}

	public void setSigningCompanyName( java.lang.String value ) {
	...
	public java.lang.String toJSONString() {
		...
		if(getSigningCompanyName() != null) sb.append(__wrapString(count++, "signingCompanyName", getSigningCompanyName()));
	...
	public void setDataFromMap(Map<String, Object> values){
		...
		if((val = values.get("signingCompanyName")) != null) setSigningCompanyName(__getString(val));
	...
	protected java.lang.String  __signing_company_name ;
