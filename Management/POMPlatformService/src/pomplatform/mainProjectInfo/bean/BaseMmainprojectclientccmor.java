...
public class BaseMmainprojectclientccmor extends GenericBase implements BaseFactory<BaseMmainprojectclientccmor>, Comparable<BaseMmainprojectclientccmor> 
{


	public static BaseMmainprojectclientccmor newInstance(){
		return new BaseMmainprojectclientccmor();
	}

	@Override
	public BaseMmainprojectclientccmor make(){
		BaseMmainprojectclientccmor b = new BaseMmainprojectclientccmor();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主项目编码,客户编码,姓名,手机,单位名称,单位地址,职务,微信,QQ,邮箱,联系人角色";
	...
	public void cloneCopy(BaseMmainprojectclientccmor __bean){
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		String strClientRole = delicacy.system.executor.SelectValueCache.getSelectValue("", String.valueOf(getClientRole()));
		sb.append(strClientRole == null ? "" : strClientRole);
		return sb.toString();
	}

	@Override
	public int compareTo(BaseMmainprojectclientccmor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseMmainprojectclientccmor o = (BaseMmainprojectclientccmor)obj;
