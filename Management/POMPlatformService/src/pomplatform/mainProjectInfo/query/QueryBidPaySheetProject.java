...
public class QueryBidPaySheetProject extends AbstractQuery<BaseBidPaySheetProject, ConditionBidPaySheetProject>
{

	private static final Logger __logger = Logger.getLogger(QueryBidPaySheetProject.class);

	public QueryBidPaySheetProject() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseBidPaySheetProject> executeQuery( KeyValuePair[] replacements, ConditionBidPaySheetProject condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseBidPaySheetProject generateBase(Object[] __data) throws java.sql.SQLException {
		BaseBidPaySheetProject __base = new BaseBidPaySheetProject();
		int count = 0;
		Object val;
