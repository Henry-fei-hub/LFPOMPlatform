...
public class BaseSemployeeForHR extends GenericBase implements BaseFactory<BaseSemployeeForHR>, Comparable<BaseSemployeeForHR> 
{


	public static BaseSemployeeForHR newInstance(){
		return new BaseSemployeeForHR();
	}

	@Override
	public BaseSemployeeForHR make(){
		BaseSemployeeForHR b = new BaseSemployeeForHR();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "员工编码,员工编号,员工姓名,角色编码,部门编码,等级,密码,手机,电话,QQ,邮箱,入职日期,离职日期,状态,是否可用,是否为部门负责人,头像,性别,我的签名,age,出生日期,身份证号,家庭地址,备用字段1,备用字段2,备用字段3,是否锁定,板块,职位名称,上级领导,英文名,学历,学位,名族,婚姻状况,身体状况,工作地,注册地,直属上级";
	...
	public void cloneCopy(BaseSemployeeForHR __bean){
	...
	@Override
	public int compareTo(BaseSemployeeForHR o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSemployeeForHR o = (BaseSemployeeForHR)obj;
