...
public class ConditionForEmpManageExportData extends GenericCondition{

	public ConditionForEmpManageExportData(){
	...
	public java.lang.Integer getDuty() {
		return this.__duty;
	}

	public void setDuty( java.lang.Integer value ) {
		this.__duty = value;
	}
	...
	public java.lang.String toJSONString() {
		...
		if(getDuty() != null) sb.append(__wrapNumber(1, "duty", getDuty()));
	...
	public void setDataFromMap(Map<String, Object> values){
		...
		if((val = values.get("duty")) != null) setDuty(__getInt(val)); 
		if((val = values.get("onboardYear")) != null) setOnboardYear(__getInt(val)); 
		if((val = values.get("onboardMonth")) != null) setOnboardMonth(__getInt(val)); 
		if((val = values.get("resiYear")) != null) setResiYear(__getInt(val)); 
		if((val = values.get("resiMonth")) != null) setResiMonth(__getInt(val)); 
		if((val = values.get("birthMonth")) != null) setBirthMonth(__getInt(val)); 
	...
	private java.lang.Integer __duty = null;
