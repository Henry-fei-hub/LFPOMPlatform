...
public class BaseForEmpManageExportData extends GenericBase implements BaseFactory<BaseForEmpManageExportData>, Comparable<BaseForEmpManageExportData> 
{


	public static BaseForEmpManageExportData newInstance(){
		return new BaseForEmpManageExportData();
	}

	@Override
	public BaseForEmpManageExportData make(){
		BaseForEmpManageExportData b = new BaseForEmpManageExportData();
		return b;
	}
	...
	public void cloneCopy(BaseForEmpManageExportData __bean){
	...
	public java.lang.String toCSVString() {
		...
		if(!BaseHelpUtils.isNullOrEmpty(getEducation())){
			if(getEducation().length() >= 2){
				strEducation = getEducation();
			}else{
				strEducation = delicacy.system.executor.SelectValueCache.getSelectValue("system_dictionary_80", String.valueOf(getEducation()));
			}
		}
		sb.append(strEducation == null ? "" : strEducation);
		sb.append(",");
		String strDegree = null;
		if(!BaseHelpUtils.isNullOrEmpty(getDegree())){
			if(getDegree().length() >= 2){
				strDegree = getDegree();
			}else{
				strDegree = delicacy.system.executor.SelectValueCache.getSelectValue("system_dictionary_78", String.valueOf(getDegree()));
			}
		}
	...
	@Override
	public int compareTo(BaseForEmpManageExportData o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseForEmpManageExportData o = (BaseForEmpManageExportData)obj;
