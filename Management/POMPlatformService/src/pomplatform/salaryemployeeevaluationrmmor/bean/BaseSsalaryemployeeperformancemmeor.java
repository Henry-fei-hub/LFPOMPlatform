...
public class BaseSsalaryemployeeperformancemmeor extends GenericBase implements BaseFactory<BaseSsalaryemployeeperformancemmeor>, Comparable<BaseSsalaryemployeeperformancemmeor> 
{


	public static BaseSsalaryemployeeperformancemmeor newInstance(){
		return new BaseSsalaryemployeeperformancemmeor();
	}

	@Override
	public BaseSsalaryemployeeperformancemmeor make(){
		BaseSsalaryemployeeperformancemmeor b = new BaseSsalaryemployeeperformancemmeor();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "工号,员工,业务部门,所属部门,归属公司,员工状态,年,月,月薪,基本比例,月基本工资,月绩效工资,应到天数,实到天数,发生日期,等级,比例,工作系数,实发绩效";
	...
	public void cloneCopy(BaseSsalaryemployeeperformancemmeor __bean){
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		String strPlateRecord = delicacy.system.executor.SelectValueCache.getSelectValue("plate_records", String.valueOf(getPlateId()));
		sb.append(strPlateRecord == null ? "" : strPlateRecord);
		sb.append(",");
...
//		sb.append(getCreateTime() == null ? "" : sdf.format(getCreateTime()));
	...
	@Override
	public int compareTo(BaseSsalaryemployeeperformancemmeor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSsalaryemployeeperformancemmeor o = (BaseSsalaryemployeeperformancemmeor)obj;
