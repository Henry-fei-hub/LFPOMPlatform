...
public class BaseSsalaryemployeeevaluationrmmor extends GenericBase implements BaseFactory<BaseSsalaryemployeeevaluationrmmor>, Comparable<BaseSsalaryemployeeevaluationrmmor> 
{


	public static BaseSsalaryemployeeevaluationrmmor newInstance(){
		return new BaseSsalaryemployeeevaluationrmmor();
	}

	@Override
	public BaseSsalaryemployeeevaluationrmmor make(){
		BaseSsalaryemployeeevaluationrmmor b = new BaseSsalaryemployeeevaluationrmmor();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "salary_employee_evaluation_id,员工主键,年份,月份,grade,绩效发生时间,操作人,操作时间,备注";
	...
	public void cloneCopy(BaseSsalaryemployeeevaluationrmmor __bean){
	...
	@Override
	public int compareTo(BaseSsalaryemployeeevaluationrmmor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSsalaryemployeeevaluationrmmor o = (BaseSsalaryemployeeevaluationrmmor)obj;
