...
public class BasePlateIntegralAssignRecord extends GenericBase implements BaseFactory<BasePlateIntegralAssignRecord>, Comparable<BasePlateIntegralAssignRecord> 
{


	public static BasePlateIntegralAssignRecord newInstance(){
		return new BasePlateIntegralAssignRecord();
	}

	@Override
	public BasePlateIntegralAssignRecord make(){
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,板块,工号,姓名,发放积分,发放日期,事业部负责人,备注";
	...
	public void cloneCopy(BasePlateIntegralAssignRecord __bean){
	...
	@Override
	public int compareTo(BasePlateIntegralAssignRecord o) {
	...
	public boolean equals(Object obj) {
		...
		final BasePlateIntegralAssignRecord o = (BasePlateIntegralAssignRecord)obj;
