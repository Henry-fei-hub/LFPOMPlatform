...
public class BaseApprovalBudgetManagementApplyWork extends GenericBase implements BaseFactory<BaseApprovalBudgetManagementApplyWork>, Comparable<BaseApprovalBudgetManagementApplyWork> 
{


	public static BaseApprovalBudgetManagementApplyWork newInstance(){
		return new BaseApprovalBudgetManagementApplyWork();
	}

	@Override
	public BaseApprovalBudgetManagementApplyWork make(){
		BaseApprovalBudgetManagementApplyWork b = new BaseApprovalBudgetManagementApplyWork();
		return b;
	}
	...
	public void cloneCopy(BaseApprovalBudgetManagementApplyWork __bean){
	...
	@Override
	public int compareTo(BaseApprovalBudgetManagementApplyWork o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseApprovalBudgetManagementApplyWork o = (BaseApprovalBudgetManagementApplyWork)obj;
