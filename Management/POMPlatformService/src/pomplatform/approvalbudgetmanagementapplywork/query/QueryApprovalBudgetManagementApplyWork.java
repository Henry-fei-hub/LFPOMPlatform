package pomplatform.approvalbudgetmanagementapplywork.query;
...
public class QueryApprovalBudgetManagementApplyWork extends AbstractQuery<BaseApprovalBudgetManagementApplyWork, ConditionApprovalBudgetManagementApplyWork>
{

	private static final Logger __logger = Logger.getLogger(QueryApprovalBudgetManagementApplyWork.class);

	public QueryApprovalBudgetManagementApplyWork() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseApprovalBudgetManagementApplyWork> executeQuery( KeyValuePair[] replacements, ConditionApprovalBudgetManagementApplyWork condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseApprovalBudgetManagementApplyWork generateBase(Object[] __data) throws java.sql.SQLException {
		BaseApprovalBudgetManagementApplyWork __base = new BaseApprovalBudgetManagementApplyWork();
		int count = 0;
		Object val;
