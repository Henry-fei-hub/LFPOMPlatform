...
public class BaseSemployeepdror extends GenericBase implements BaseFactory<BaseSemployeepdror>, Comparable<BaseSemployeepdror> {

    public static BaseSemployeepdror newInstance() {
        return new BaseSemployeepdror();
    }

    @Override
    public BaseSemployeepdror make() {
    ...
    public void cloneCopy(BaseSemployeepdror __bean) {
    ...
    @Override
    public int compareTo(BaseSemployeepdror o) {
    ...
    public boolean equals(Object obj) {
        ...
        final BaseSemployeepdror o = (BaseSemployeepdror) obj;
