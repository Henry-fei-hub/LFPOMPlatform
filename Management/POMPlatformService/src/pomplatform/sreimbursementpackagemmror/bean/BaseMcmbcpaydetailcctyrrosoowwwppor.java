...
public class BaseMcmbcpaydetailcctyrrosoowwwppor extends GenericBase implements BaseFactory<BaseMcmbcpaydetailcctyrrosoowwwppor>, Comparable<BaseMcmbcpaydetailcctyrrosoowwwppor> 
{


	public static BaseMcmbcpaydetailcctyrrosoowwwppor newInstance(){
		return new BaseMcmbcpaydetailcctyrrosoowwwppor();
	}

	@Override
	public BaseMcmbcpaydetailcctyrrosoowwwppor make(){
		BaseMcmbcpaydetailcctyrrosoowwwppor b = new BaseMcmbcpaydetailcctyrrosoowwwppor();
		return b;
	}
	...
	public final static java.lang.String CS_CPERROR_MSG = "cperror_msg" ;

	public final static java.lang.String ALL_CAPTIONS = "主键,类型,业务参考号,期望日,付方账号,付方开户地区代码,交易金额,币种代码,结算方式代码,用途,业务摘要,收方账号,收方账户名,自动支付收款联行号,系统内外标志,收方开户行,城市代码,收方省份,收方城市,省,市,总金额(用户记录代发与代扣),总数量(用户记录代发与代扣),收方开户地区代码,报销打包汇总表编码,报销打包表编码,create_time,operator,状态,错误信息,业务类别,业务模式,他行户口开户地,交易代码,交易代码名称,支付总表编码,员工或者收款单位主键,1员工  2收款单位,经办日期,退单标志  1 为正常支付单 2为退单重新支付单,退单来源主键,退单发起状态 1待资料补正 2可提起支付  3已提起支付,4失败,3支付完成(已返回处理结果),错误信息";
	...
	public java.lang.String getCperrorMsg() {
		return this.__cperror_msg;
	}

	public void setCperrorMsg( java.lang.String value ) {
		this.__cperror_msg = value;
	}

	public void cloneCopy(BaseMcmbcpaydetailcctyrrosoowwwppor __bean){
		...
		__bean.setCperrorMsg(getCperrorMsg());
	}
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		sb.append(getCperrorMsg() == null ? "" : getCperrorMsg());
		return sb.toString();
	}

	@Override
	public int compareTo(BaseMcmbcpaydetailcctyrrosoowwwppor o) {
	...
	public int hashCode() {
		...
		hash = 97 * hash + Objects.hashCode(this.__cperror_msg);
		return hash;
	}
	...
	public boolean equals(Object obj) {
		...
		final BaseMcmbcpaydetailcctyrrosoowwwppor o = (BaseMcmbcpaydetailcctyrrosoowwwppor)obj;
		...
		if(!Objects.equals(this.__cperror_msg, o.getCperrorMsg())) return false;
		return true;
	}
	...
	public java.lang.String toJSONString() {
		...
		if(getCperrorMsg() != null) sb.append(__wrapString(count++, "cperrorMsg", getCperrorMsg()));
		return sb.toString();
	}
	...
	public void setDataFromMap(Map<String, Object> values){
		...
		if((val = values.get("cperrorMsg")) != null) setCperrorMsg(__getString(val));
	}
	...
	protected java.lang.String  __cperror_msg ;
}
