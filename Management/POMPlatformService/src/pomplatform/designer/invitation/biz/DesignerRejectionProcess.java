 ...
 * @author guanxgun
 */
public class DesignerRejectionProcess implements GenericProcessor {
    ...
    public String execute(String creteria, HttpServletRequest request) throws Exception {
        ...
        if(dao.load()){
            ...
            pl.setLogContent(String.format("%1$s拒绝了%2$s %3$s的邀请, %4$s", designerName, e.getEmployeeName(),p.getProjectName(), bean.getWorkContent()));
            pl.save();
        }
