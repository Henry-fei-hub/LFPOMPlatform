...
public class BaseOnEmployeeIntegralBusiness extends GenericBase implements BaseFactory<BaseOnEmployeeIntegralBusiness>, Comparable<BaseOnEmployeeIntegralBusiness> 
{


	public static BaseOnEmployeeIntegralBusiness newInstance(){
		return new BaseOnEmployeeIntegralBusiness();
	}

	@Override
	public BaseOnEmployeeIntegralBusiness make(){
		BaseOnEmployeeIntegralBusiness b = new BaseOnEmployeeIntegralBusiness();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,业务功能id,业务功能名称,职员id,积分,日期,状态,操作时间,操作人,备注,业务id";
	...
	public void cloneCopy(BaseOnEmployeeIntegralBusiness __bean){
	...
	@Override
	public int compareTo(BaseOnEmployeeIntegralBusiness o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseOnEmployeeIntegralBusiness o = (BaseOnEmployeeIntegralBusiness)obj;
