package pomplatform.EmployeeAchieveIntegralReturnRecordByMonth.bean;
...
public class BaseEmployeeAchieveIntegralReturnRecordByMonth extends GenericBase implements BaseFactory<BaseEmployeeAchieveIntegralReturnRecordByMonth>, Comparable<BaseEmployeeAchieveIntegralReturnRecordByMonth> 
{


	public static BaseEmployeeAchieveIntegralReturnRecordByMonth newInstance(){
		return new BaseEmployeeAchieveIntegralReturnRecordByMonth();
	}

	@Override
	public BaseEmployeeAchieveIntegralReturnRecordByMonth make(){
		BaseEmployeeAchieveIntegralReturnRecordByMonth b = new BaseEmployeeAchieveIntegralReturnRecordByMonth();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "业务部门,年份,月份,回流积分";
	...
	public void cloneCopy(BaseEmployeeAchieveIntegralReturnRecordByMonth __bean){
	...
	@Override
	public int compareTo(BaseEmployeeAchieveIntegralReturnRecordByMonth o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseEmployeeAchieveIntegralReturnRecordByMonth o = (BaseEmployeeAchieveIntegralReturnRecordByMonth)obj;
