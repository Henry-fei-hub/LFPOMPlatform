package pomplatform.PooledInspectionReport.bean;
...
public class BasePooledInspectionReport extends GenericBase implements BaseFactory<BasePooledInspectionReport>, Comparable<BasePooledInspectionReport> 
{


	public static BasePooledInspectionReport newInstance(){
		return new BasePooledInspectionReport();
	}

	@Override
	public BasePooledInspectionReport make(){
		BasePooledInspectionReport b = new BasePooledInspectionReport();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "业务编码,报销编号,流程类型,流程编码,流程状态,流程编码,主键编码,业务名称,活动编码,返回数据集,节点类型 0 - 开始 1 - 结束 2 - 审批 3 - 处理 4 - 知会,附加节点，说明节点是预定义的节点还是动态加的节点， 0 - 正常定义的节点， 1 - 申请人或者审批人加的处理人或者审批人,当前流程实例节点的内部编码,下一个流程节点的编码,如果是知会节点，所依附的主节点,,流程实例节点创建时间,流程实例节点开始处于活动时间,报销人,操作时间,提交意见,状态,,删除状态  0未删除    1已删除";
	...
	public void cloneCopy(BasePooledInspectionReport __bean){
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		String strDeleteFlag = delicacy.system.executor.SelectValueCache.getSelectValue("", String.valueOf(getDeleteFlag()));
		sb.append(strDeleteFlag == null ? "" : strDeleteFlag);
		return sb.toString();
	}

	@Override
	public int compareTo(BasePooledInspectionReport o) {
	...
	public boolean equals(Object obj) {
		...
		final BasePooledInspectionReport o = (BasePooledInspectionReport)obj;
