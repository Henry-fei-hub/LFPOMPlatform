...
public class BaseMclientctractor extends GenericBase implements BaseFactory<BaseMclientctractor>, Comparable<BaseMclientctractor> 
{


	public static BaseMclientctractor newInstance(){
		return new BaseMclientctractor();
	}

	@Override
	public BaseMclientctractor make(){
		BaseMclientctractor b = new BaseMclientctractor();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "客户编码,联系人姓名,联系人手机,单位名称,单位地址,职务,微信,QQ,邮箱,联系人角色";
	...
	public void cloneCopy(BaseMclientctractor __bean){
	...
	@Override
	public int compareTo(BaseMclientctractor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseMclientctractor o = (BaseMclientctractor)obj;
