...
public class BaseBeProjectApply extends GenericBase implements BaseFactory<BaseBeProjectApply>, Comparable<BaseBeProjectApply> 
{


	public static BaseBeProjectApply newInstance(){
		return new BaseBeProjectApply();
	}

	@Override
	public BaseBeProjectApply make(){
		BaseBeProjectApply b = new BaseBeProjectApply();
		return b;
	}
	...
	public void cloneCopy(BaseBeProjectApply __bean){
	...
	@Override
	public int compareTo(BaseBeProjectApply o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseBeProjectApply o = (BaseBeProjectApply)obj;
