...
public class BaseSearchMainProjectEmployeeDataByProjectId extends GenericBase implements BaseFactory<BaseSearchMainProjectEmployeeDataByProjectId>, Comparable<BaseSearchMainProjectEmployeeDataByProjectId> 
{


	public static BaseSearchMainProjectEmployeeDataByProjectId newInstance(){
		return new BaseSearchMainProjectEmployeeDataByProjectId();
	}

	@Override
	public BaseSearchMainProjectEmployeeDataByProjectId make(){
		BaseSearchMainProjectEmployeeDataByProjectId b = new BaseSearchMainProjectEmployeeDataByProjectId();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "编码,主键编码,员工编码,员工和主项目的关系    1项目营销专员   2项目营销团队负责人   3项目经理   4项目主管领导,员工编号,员工姓名,板块,主要跟进人或协助跟进人（1主要跟进人，2协助跟进人）,是否事业部负责人";
	...
	public void cloneCopy(BaseSearchMainProjectEmployeeDataByProjectId __bean){
	...
	@Override
	public int compareTo(BaseSearchMainProjectEmployeeDataByProjectId o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSearchMainProjectEmployeeDataByProjectId o = (BaseSearchMainProjectEmployeeDataByProjectId)obj;
