...
public class BaseGetPlateManagers extends GenericBase implements BaseFactory<BaseGetPlateManagers>, Comparable<BaseGetPlateManagers> 
{


	public static BaseGetPlateManagers newInstance(){
		return new BaseGetPlateManagers();
	}

	@Override
	public BaseGetPlateManagers make(){
		BaseGetPlateManagers b = new BaseGetPlateManagers();
		return b;
	}
	...
	public void cloneCopy(BaseGetPlateManagers __bean){
	...
	@Override
	public int compareTo(BaseGetPlateManagers o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseGetPlateManagers o = (BaseGetPlateManagers)obj;
