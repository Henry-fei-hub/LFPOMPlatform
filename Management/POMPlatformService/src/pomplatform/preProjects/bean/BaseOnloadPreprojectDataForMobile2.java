...
public class BaseOnloadPreprojectDataForMobile2 extends GenericBase implements BaseFactory<BaseOnloadPreprojectDataForMobile2>, Comparable<BaseOnloadPreprojectDataForMobile2> 
{


	public static BaseOnloadPreprojectDataForMobile2 newInstance(){
		return new BaseOnloadPreprojectDataForMobile2();
	}

	@Override
	public BaseOnloadPreprojectDataForMobile2 make(){
		BaseOnloadPreprojectDataForMobile2 b = new BaseOnloadPreprojectDataForMobile2();
		return b;
	}
	...
	public void cloneCopy(BaseOnloadPreprojectDataForMobile2 __bean){
	...
	@Override
	public int compareTo(BaseOnloadPreprojectDataForMobile2 o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseOnloadPreprojectDataForMobile2 o = (BaseOnloadPreprojectDataForMobile2)obj;
	...
	public Map<String, Object> toMap() {
		...
		if(getSalePerson() != null) res.put("salePerson", getSalePerson());
		if(getSaleLeader() != null) res.put("saleLeader", getSaleLeader());
		if(getProjectManage() != null) res.put("projectManage", getProjectManage());
