...
public class BaseOnloadPreprojectDataForMobile extends GenericBase implements BaseFactory<BaseOnloadPreprojectDataForMobile>, Comparable<BaseOnloadPreprojectDataForMobile> 
{


	public static BaseOnloadPreprojectDataForMobile newInstance(){
		return new BaseOnloadPreprojectDataForMobile();
	}

	@Override
	public BaseOnloadPreprojectDataForMobile make(){
		BaseOnloadPreprojectDataForMobile b = new BaseOnloadPreprojectDataForMobile();
		return b;
	}
	...
	public java.lang.String getIsHighRiseBuilding() {
		return this.__is_high_rise_building;
	}

	public void setIsHighRiseBuilding( java.lang.String value ) {
	...
	public java.lang.String getIsSubProject() {
		return this.__is_sub_project;
	}

	public void setIsSubProject( java.lang.String value ) {
	...
	public java.lang.String getIsPubliclyBidding() {
		return this.__is_publicly_bidding;
	}

	public void setIsPubliclyBidding( java.lang.String value ) {
		this.__is_publicly_bidding = value;
	}

	public java.lang.String getHaveAgents() {
		return this.__have_agents;
	}

	public void setHaveAgents( java.lang.String value ) {
		this.__have_agents = value;
	}

	public java.lang.String getIsWinningBid() {
		return this.__is_winning_bid;
	}

	public void setIsWinningBid( java.lang.String value ) {
	...
	public java.lang.String getSalePerson() {
		return this.__sale_person;
	}

	public void setSalePerson( java.lang.String value ) {
		this.__sale_person = value;
	}

	public java.lang.String getSaleLeader() {
		return this.__sale_leader;
	}

	public void setSaleLeader( java.lang.String value ) {
		this.__sale_leader = value;
	}

	public java.lang.String getProjectManage() {
		return this.__project_manage;
	}

	public void setProjectManage( java.lang.String value ) {
		this.__project_manage = value;
	}
	...
	public void cloneCopy(BaseOnloadPreprojectDataForMobile __bean){
		...
		__bean.setSalePerson(getSalePerson());
		__bean.setSaleLeader(getSaleLeader());
		__bean.setProjectManage(getProjectManage());
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		sb.append(getSalePerson() == null ? "" : getSalePerson());
		sb.append(",");
		sb.append(getSaleLeader() == null ? "" : getSaleLeader());
		sb.append(",");
		sb.append(getProjectManage() == null ? "" : getProjectManage());
		sb.append(",");
	...
	@Override
	public int compareTo(BaseOnloadPreprojectDataForMobile o) {
	...
	public int hashCode() {
		...
		hash = 97 * hash + Objects.hashCode(this.__sale_person);
		hash = 97 * hash + Objects.hashCode(this.__sale_leader);
		hash = 97 * hash + Objects.hashCode(this.__project_manage);
	...
	public boolean equals(Object obj) {
		...
		final BaseOnloadPreprojectDataForMobile o = (BaseOnloadPreprojectDataForMobile)obj;
		...
		if(!Objects.equals(this.__sale_person, o.getSalePerson())) return false;
		if(!Objects.equals(this.__sale_leader, o.getSaleLeader())) return false;
		if(!Objects.equals(this.__project_manage, o.getProjectManage())) return false;
	...
	public java.lang.String toJSONString() {
		...
		if(getIsHighRiseBuilding() != null) sb.append(__wrapString(count++, "isHighRiseBuilding", getIsHighRiseBuilding()));
		...
		if(getIsSubProject() != null) sb.append(__wrapString(count++, "isSubProject", getIsSubProject()));
		if(getContractStatus() != null) sb.append(__wrapNumber(count++, "contractStatus", getContractStatus()));
		if(getIsPubliclyBidding() != null) sb.append(__wrapString(count++, "isPubliclyBidding", getIsPubliclyBidding()));
		if(getHaveAgents() != null) sb.append(__wrapString(count++, "haveAgents", getHaveAgents()));
		if(getIsWinningBid() != null) sb.append(__wrapString(count++, "isWinningBid", getIsWinningBid()));
		...
		if(getSalePerson() != null) sb.append(__wrapString(count++, "salePerson", getSalePerson()));
		if(getSaleLeader() != null) sb.append(__wrapString(count++, "saleLeader", getSaleLeader()));
		if(getProjectManage() != null) sb.append(__wrapString(count++, "projectManage", getProjectManage()));
	...
	public void setDataFromMap(Map<String, Object> values){
		...
		if((val = values.get("isHighRiseBuilding")) != null) setIsHighRiseBuilding(__getString(val));
		...
		if((val = values.get("isSubProject")) != null) setIsSubProject(__getString(val));
		if((val = values.get("contractStatus")) != null) setContractStatus(__getInt(val)); 
		if((val = values.get("isPubliclyBidding")) != null) setIsPubliclyBidding(__getString(val));
		if((val = values.get("haveAgents")) != null) setHaveAgents(__getString(val));
		if((val = values.get("isWinningBid")) != null) setIsWinningBid(__getString(val));
		...
		if((val = values.get("salePerson")) != null) setSalePerson(__getString(val));
		if((val = values.get("saleLeader")) != null) setSaleLeader(__getString(val));
		if((val = values.get("projectManage")) != null) setProjectManage(__getString(val));
	...
	protected java.lang.String  __is_high_rise_building ;
	...
	protected java.lang.String  __is_sub_project ;
	protected java.lang.Integer  __contract_status ;
	protected java.lang.String  __is_publicly_bidding ;
	protected java.lang.String  __have_agents ;
	protected java.lang.String  __is_winning_bid ;
	...
	protected java.lang.String  __sale_person ;
	protected java.lang.String  __sale_leader ;
	protected java.lang.String  __project_manage ;
