...
public class BaseRefuseListOfPreProjectReport extends GenericBase implements BaseFactory<BaseRefuseListOfPreProjectReport>, Comparable<BaseRefuseListOfPreProjectReport>
{


	public static BaseRefuseListOfPreProjectReport newInstance(){
		return new BaseRefuseListOfPreProjectReport();
	}

	@Override
	public BaseRefuseListOfPreProjectReport make(){
		BaseRefuseListOfPreProjectReport b = new BaseRefuseListOfPreProjectReport();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,流程类型,业务编码,业务名称,流程编码,活动实列编码,流程状态,创建时间,完成时间,报备人,项目名称,省份,城市,项目类别,客户名称,项目来源渠道,客户联系人,客户联系人电话,详细地址,建筑总面积,4接洽过未合作客户)(对应于字典表151),是否入库,是否已提供战略报价,信息编号";
	...
	public void cloneCopy(BaseRefuseListOfPreProjectReport __bean){
	...
	@Override
	public int compareTo(BaseRefuseListOfPreProjectReport o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseRefuseListOfPreProjectReport o = (BaseRefuseListOfPreProjectReport)obj;
