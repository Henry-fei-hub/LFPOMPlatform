...
public class BaseLoadCompetitionUnitsData extends GenericBase implements BaseFactory<BaseLoadCompetitionUnitsData>, Comparable<BaseLoadCompetitionUnitsData> 
{


	public static BaseLoadCompetitionUnitsData newInstance(){
		return new BaseLoadCompetitionUnitsData();
	}

	@Override
	public BaseLoadCompetitionUnitsData make(){
		BaseLoadCompetitionUnitsData b = new BaseLoadCompetitionUnitsData();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,主键编码,竞争单位,名称,地址,前期项目id,备注（报价/其他竞争信息）";
	...
	public void cloneCopy(BaseLoadCompetitionUnitsData __bean){
	...
	@Override
	public int compareTo(BaseLoadCompetitionUnitsData o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseLoadCompetitionUnitsData o = (BaseLoadCompetitionUnitsData)obj;
