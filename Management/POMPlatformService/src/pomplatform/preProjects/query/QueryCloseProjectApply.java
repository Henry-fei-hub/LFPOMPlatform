...
public class QueryCloseProjectApply extends AbstractQuery<BaseCloseProjectApply, ConditionCloseProjectApply>
{

	private static final Logger __logger = Logger.getLogger(QueryCloseProjectApply.class);

	public QueryCloseProjectApply() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseCloseProjectApply> executeQuery( KeyValuePair[] replacements, ConditionCloseProjectApply condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseCloseProjectApply generateBase(Object[] __data) throws java.sql.SQLException {
		BaseCloseProjectApply __base = new BaseCloseProjectApply();
		int count = 0;
		Object val;
