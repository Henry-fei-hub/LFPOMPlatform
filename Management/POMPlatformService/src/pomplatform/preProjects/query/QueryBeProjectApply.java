...
public class QueryBeProjectApply extends AbstractQuery<BaseBeProjectApply, ConditionBeProjectApply>
{

	private static final Logger __logger = Logger.getLogger(QueryBeProjectApply.class);

	public QueryBeProjectApply() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseBeProjectApply> executeQuery( KeyValuePair[] replacements, ConditionBeProjectApply condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseBeProjectApply generateBase(Object[] __data) throws java.sql.SQLException {
		BaseBeProjectApply __base = new BaseBeProjectApply();
		int count = 0;
		Object val;
