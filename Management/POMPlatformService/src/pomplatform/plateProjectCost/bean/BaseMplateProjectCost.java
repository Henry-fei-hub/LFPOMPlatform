package pomplatform.plateProjectCost.bean;
...
public class BaseMplateProjectCost extends GenericBase implements BaseFactory<BaseMplateProjectCost>, Comparable<BaseMplateProjectCost> 
{


	public static BaseMplateProjectCost newInstance(){
		return new BaseMplateProjectCost();
	}

	@Override
	public BaseMplateProjectCost make(){
		BaseMplateProjectCost b = new BaseMplateProjectCost();
		return b;
	}
	...
	public void cloneCopy(BaseMplateProjectCost __bean){
	...
	@Override
	public int compareTo(BaseMplateProjectCost o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseMplateProjectCost o = (BaseMplateProjectCost)obj;
