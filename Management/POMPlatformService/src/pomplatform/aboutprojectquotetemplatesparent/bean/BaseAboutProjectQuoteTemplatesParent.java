...
public class BaseAboutProjectQuoteTemplatesParent extends GenericBase implements BaseFactory<BaseAboutProjectQuoteTemplatesParent>, Comparable<BaseAboutProjectQuoteTemplatesParent> 
{


	public static BaseAboutProjectQuoteTemplatesParent newInstance(){
		return new BaseAboutProjectQuoteTemplatesParent();
	}

	@Override
	public BaseAboutProjectQuoteTemplatesParent make(){
		BaseAboutProjectQuoteTemplatesParent b = new BaseAboutProjectQuoteTemplatesParent();
		return b;
	}
	...
	public void cloneCopy(BaseAboutProjectQuoteTemplatesParent __bean){
	...
	@Override
	public int compareTo(BaseAboutProjectQuoteTemplatesParent o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseAboutProjectQuoteTemplatesParent o = (BaseAboutProjectQuoteTemplatesParent)obj;
