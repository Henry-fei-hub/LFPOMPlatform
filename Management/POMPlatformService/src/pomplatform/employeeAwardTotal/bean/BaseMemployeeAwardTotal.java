...
public class BaseMemployeeAwardTotal extends GenericBase implements BaseFactory<BaseMemployeeAwardTotal>, Comparable<BaseMemployeeAwardTotal> 
{


	public static BaseMemployeeAwardTotal newInstance(){
		return new BaseMemployeeAwardTotal();
	}

	@Override
	public BaseMemployeeAwardTotal make(){
		BaseMemployeeAwardTotal b = new BaseMemployeeAwardTotal();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "头像,员工编码,员工姓名,部门,预分配积分,确认积分,项目成本,结算积分,价值积分,人工成本";
	...
	public void cloneCopy(BaseMemployeeAwardTotal __bean){
	...
	@Override
	public int compareTo(BaseMemployeeAwardTotal o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseMemployeeAwardTotal o = (BaseMemployeeAwardTotal)obj;
