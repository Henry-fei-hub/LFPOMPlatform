...
public class BaseOnLoadProjectSettlementDetailOfPlateAccount extends GenericBase implements BaseFactory<BaseOnLoadProjectSettlementDetailOfPlateAccount>, Comparable<BaseOnLoadProjectSettlementDetailOfPlateAccount> 
{


	public static BaseOnLoadProjectSettlementDetailOfPlateAccount newInstance(){
		return new BaseOnLoadProjectSettlementDetailOfPlateAccount();
	}

	@Override
	public BaseOnLoadProjectSettlementDetailOfPlateAccount make(){
		BaseOnLoadProjectSettlementDetailOfPlateAccount b = new BaseOnLoadProjectSettlementDetailOfPlateAccount();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "业务部门,订单编号,订单名称,积分,日期,备注";
	...
	public void cloneCopy(BaseOnLoadProjectSettlementDetailOfPlateAccount __bean){
	...
	@Override
	public int compareTo(BaseOnLoadProjectSettlementDetailOfPlateAccount o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseOnLoadProjectSettlementDetailOfPlateAccount o = (BaseOnLoadProjectSettlementDetailOfPlateAccount)obj;
