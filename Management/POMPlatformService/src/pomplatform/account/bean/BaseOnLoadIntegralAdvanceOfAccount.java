...
public class BaseOnLoadIntegralAdvanceOfAccount extends GenericBase implements BaseFactory<BaseOnLoadIntegralAdvanceOfAccount>, Comparable<BaseOnLoadIntegralAdvanceOfAccount> 
{


	public static BaseOnLoadIntegralAdvanceOfAccount newInstance(){
		return new BaseOnLoadIntegralAdvanceOfAccount();
	}

	@Override
	public BaseOnLoadIntegralAdvanceOfAccount make(){
		BaseOnLoadIntegralAdvanceOfAccount b = new BaseOnLoadIntegralAdvanceOfAccount();
		return b;
	}
	...
	public void cloneCopy(BaseOnLoadIntegralAdvanceOfAccount __bean){
	...
	@Override
	public int compareTo(BaseOnLoadIntegralAdvanceOfAccount o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseOnLoadIntegralAdvanceOfAccount o = (BaseOnLoadIntegralAdvanceOfAccount)obj;
