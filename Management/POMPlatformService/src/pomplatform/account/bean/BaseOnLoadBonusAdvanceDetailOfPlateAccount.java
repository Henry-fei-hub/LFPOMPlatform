...
public class BaseOnLoadBonusAdvanceDetailOfPlateAccount extends GenericBase implements BaseFactory<BaseOnLoadBonusAdvanceDetailOfPlateAccount>, Comparable<BaseOnLoadBonusAdvanceDetailOfPlateAccount> 
{


	public static BaseOnLoadBonusAdvanceDetailOfPlateAccount newInstance(){
		return new BaseOnLoadBonusAdvanceDetailOfPlateAccount();
	}

	@Override
	public BaseOnLoadBonusAdvanceDetailOfPlateAccount make(){
		BaseOnLoadBonusAdvanceDetailOfPlateAccount b = new BaseOnLoadBonusAdvanceDetailOfPlateAccount();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "业务部门,管理项目,项目名称,员工编号,员工姓名,在职状态,职级,积分,日期,备注";
	...
	public void cloneCopy(BaseOnLoadBonusAdvanceDetailOfPlateAccount __bean){
	...
	@Override
	public int compareTo(BaseOnLoadBonusAdvanceDetailOfPlateAccount o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseOnLoadBonusAdvanceDetailOfPlateAccount o = (BaseOnLoadBonusAdvanceDetailOfPlateAccount)obj;
