...
public class BaseOnLoadMonthReportData extends GenericBase implements BaseFactory<BaseOnLoadMonthReportData>, Comparable<BaseOnLoadMonthReportData> 
{


	public static BaseOnLoadMonthReportData newInstance(){
		return new BaseOnLoadMonthReportData();
	}

	@Override
	public BaseOnLoadMonthReportData make(){
		BaseOnLoadMonthReportData b = new BaseOnLoadMonthReportData();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "10绩效奖金),职员编码,员工编号,员工姓名,年份,月份,积分";
	...
	public void cloneCopy(BaseOnLoadMonthReportData __bean){
	...
	@Override
	public int compareTo(BaseOnLoadMonthReportData o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseOnLoadMonthReportData o = (BaseOnLoadMonthReportData)obj;
