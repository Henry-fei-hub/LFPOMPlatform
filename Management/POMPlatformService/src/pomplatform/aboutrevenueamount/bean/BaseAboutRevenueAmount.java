package pomplatform.aboutrevenueamount.bean;
...
public class BaseAboutRevenueAmount extends GenericBase implements BaseFactory<BaseAboutRevenueAmount>, Comparable<BaseAboutRevenueAmount> 
{


	public static BaseAboutRevenueAmount newInstance(){
		return new BaseAboutRevenueAmount();
	}

	@Override
	public BaseAboutRevenueAmount make(){
		BaseAboutRevenueAmount b = new BaseAboutRevenueAmount();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键id,年,月,合同ID,回款金额,营收金额,是否定稿,操作人,操作时间,合同编号,合同名称,客户名称";
	...
	public void cloneCopy(BaseAboutRevenueAmount __bean){
	...
	@Override
	public int compareTo(BaseAboutRevenueAmount o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseAboutRevenueAmount o = (BaseAboutRevenueAmount)obj;
