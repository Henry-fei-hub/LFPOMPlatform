...
public class BaseSmainprojectpppor extends GenericBase implements BaseFactory<BaseSmainprojectpppor>, Comparable<BaseSmainprojectpppor> 
{


	public static BaseSmainprojectpppor newInstance(){
		return new BaseSmainprojectpppor();
	}

	@Override
	public BaseSmainprojectpppor make(){
		BaseSmainprojectpppor b = new BaseSmainprojectpppor();
		return b;
	}
	...
	public void cloneCopy(BaseSmainprojectpppor __bean){
	...
	@Override
	public int compareTo(BaseSmainprojectpppor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSmainprojectpppor o = (BaseSmainprojectpppor)obj;
