package pomplatform.client.bean;
...
public class BaseMemployeeeor extends GenericBase implements BaseFactory<BaseMemployeeeor>, Comparable<BaseMemployeeeor> 
{


	public static BaseMemployeeeor newInstance(){
		return new BaseMemployeeeor();
	}

	@Override
	public BaseMemployeeeor make(){
		BaseMemployeeeor b = new BaseMemployeeeor();
		return b;
	}
	...
	public java.lang.Long getBasicSalary() {
		return this.__basic_salary;
	}

	public void setBasicSalary( java.lang.Long value ) {
		this.__basic_salary = value;
	}

	public java.lang.Long getJobTitleAllowance() {
		return this.__job_title_allowance;
	}

	public void setJobTitleAllowance( java.lang.Long value ) {
		this.__job_title_allowance = value;
	}

	public java.lang.Long getPostAllowance() {
		return this.__post_allowance;
	}

	public void setPostAllowance( java.lang.Long value ) {
	...
	public java.lang.Long getCommunicationSubsidy() {
		return this.__communication_subsidy;
	}

	public void setCommunicationSubsidy( java.lang.Long value ) {
		this.__communication_subsidy = value;
	}

	public java.lang.Long getSubtotalMonthlyWage() {
		return this.__subtotal_monthly_wage;
	}

	public void setSubtotalMonthlyWage( java.lang.Long value ) {
		this.__subtotal_monthly_wage = value;
	}

	public java.lang.Long getMonthlyPreissuedBonus() {
		return this.__monthly_preissued_bonus;
	}

	public void setMonthlyPreissuedBonus( java.lang.Long value ) {
		this.__monthly_preissued_bonus = value;
	}

	public java.lang.Long getTotalMonthlyRemuneration() {
		return this.__total_monthly_remuneration;
	}

	public void setTotalMonthlyRemuneration( java.lang.Long value ) {
	...
	public void cloneCopy(BaseMemployeeeor __bean){
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		sb.append(getRole() == null ? "" : getRole());
		return sb.toString();
	}

	@Override
	public int compareTo(BaseMemployeeeor o) {
	...
	public int hashCode() {
		...
		hash = 97 * hash + Objects.hashCode(this.__role);
		return hash;
	}
	...
	public boolean equals(Object obj) {
		...
		final BaseMemployeeeor o = (BaseMemployeeeor)obj;
		...
		if(!Objects.equals(this.__role, o.getRole())) return false;
		return true;
	}
	...
	public java.lang.String toJSONString() {
		...
		if(getBasicSalary() != null) sb.append(__wrapNumber(count++, "basicSalary", getBasicSalary()));
		if(getJobTitleAllowance() != null) sb.append(__wrapNumber(count++, "jobTitleAllowance", getJobTitleAllowance()));
		if(getPostAllowance() != null) sb.append(__wrapNumber(count++, "postAllowance", getPostAllowance()));
		if(getOther() != null) sb.append(__wrapNumber(count++, "other", getOther()));
		if(getCommunicationSubsidy() != null) sb.append(__wrapNumber(count++, "communicationSubsidy", getCommunicationSubsidy()));
		if(getSubtotalMonthlyWage() != null) sb.append(__wrapNumber(count++, "subtotalMonthlyWage", getSubtotalMonthlyWage()));
		if(getMonthlyPreissuedBonus() != null) sb.append(__wrapNumber(count++, "monthlyPreissuedBonus", getMonthlyPreissuedBonus()));
		if(getTotalMonthlyRemuneration() != null) sb.append(__wrapNumber(count++, "totalMonthlyRemuneration", getTotalMonthlyRemuneration()));
		...
		if(getRole() != null) sb.append(__wrapNumber(count++, "role", getRole()));
		return sb.toString();
	}
	...
	public void setDataFromMap(Map<String, Object> values){
		...
		if((val = values.get("basicSalary")) != null) setBasicSalary(__getLong(val)); 
		if((val = values.get("jobTitleAllowance")) != null) setJobTitleAllowance(__getLong(val)); 
		if((val = values.get("postAllowance")) != null) setPostAllowance(__getLong(val)); 
		if((val = values.get("other")) != null) setOther(__getLong(val)); 
		if((val = values.get("communicationSubsidy")) != null) setCommunicationSubsidy(__getLong(val)); 
		if((val = values.get("subtotalMonthlyWage")) != null) setSubtotalMonthlyWage(__getLong(val)); 
		if((val = values.get("monthlyPreissuedBonus")) != null) setMonthlyPreissuedBonus(__getLong(val)); 
		if((val = values.get("totalMonthlyRemuneration")) != null) setTotalMonthlyRemuneration(__getLong(val)); 
		...
		if((val = values.get("role")) != null) setRole(__getInt(val)); 
	}
	...
	protected java.lang.Long  __basic_salary ;
	protected java.lang.Long  __job_title_allowance ;
	protected java.lang.Long  __post_allowance ;
	protected java.lang.Long  __other ;
	protected java.lang.Long  __communication_subsidy ;
	protected java.lang.Long  __subtotal_monthly_wage ;
	protected java.lang.Long  __monthly_preissued_bonus ;
	protected java.lang.Long  __total_monthly_remuneration ;
	...
	protected java.lang.Integer  __role ;
}
