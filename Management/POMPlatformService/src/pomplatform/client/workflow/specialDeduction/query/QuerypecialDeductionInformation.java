...
public class QuerypecialDeductionInformation extends AbstractQuery<BasepecialDeductionInformation, ConditionpecialDeductionInformation>
{

	private static final Logger __logger = Logger.getLogger(QuerypecialDeductionInformation.class);

	public QuerypecialDeductionInformation() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BasepecialDeductionInformation> executeQuery( KeyValuePair[] replacements, ConditionpecialDeductionInformation condition ) throws java.sql.SQLException {
	...
	@Override
	public BasepecialDeductionInformation generateBase(Object[] __data) throws java.sql.SQLException {
		BasepecialDeductionInformation __base = new BasepecialDeductionInformation();
		int count = 0;
		Object val;
