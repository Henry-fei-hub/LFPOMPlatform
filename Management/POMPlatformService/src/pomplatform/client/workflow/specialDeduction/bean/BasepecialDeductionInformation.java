...
public class BasepecialDeductionInformation extends GenericBase implements BaseFactory<BasepecialDeductionInformation>, Comparable<BasepecialDeductionInformation> 
{


	public static BasepecialDeductionInformation newInstance(){
		return new BasepecialDeductionInformation();
	}

	@Override
	public BasepecialDeductionInformation make(){
		BasepecialDeductionInformation b = new BasepecialDeductionInformation();
		return b;
	}
	...
	public void cloneCopy(BasepecialDeductionInformation __bean){
	...
	@Override
	public int compareTo(BasepecialDeductionInformation o) {
	...
	public boolean equals(Object obj) {
		...
		final BasepecialDeductionInformation o = (BasepecialDeductionInformation)obj;
