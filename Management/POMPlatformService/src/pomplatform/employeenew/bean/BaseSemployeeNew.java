...
public class BaseSemployeeNew extends GenericBase implements BaseFactory<BaseSemployeeNew>, Comparable<BaseSemployeeNew> 
{


	public static BaseSemployeeNew newInstance(){
		return new BaseSemployeeNew();
	}

	@Override
	public BaseSemployeeNew make(){
		BaseSemployeeNew b = new BaseSemployeeNew();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "员工编码,员工编号,员工姓名,角色编码,部门编码,等级,密码,手机,电话,QQ,邮箱,入职日期,离职日期,状态,是否可用,是否为部门负责人,头像,性别,我的签名,age,出生日期,身份证号,家庭地址,备用字段1,备用字段2,备用字段3,是否锁定,业务部门,职位名称,上级领导,英文名,学历,学位,名族,婚姻状况,身体状况,工作地,注册地,直属上级";
	...
	public void cloneCopy(BaseSemployeeNew __bean){
	...
	@Override
	public int compareTo(BaseSemployeeNew o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSemployeeNew o = (BaseSemployeeNew)obj;
