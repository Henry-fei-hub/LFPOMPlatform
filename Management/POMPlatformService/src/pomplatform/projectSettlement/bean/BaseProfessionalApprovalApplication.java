...
public class BaseProfessionalApprovalApplication extends GenericBase implements BaseFactory<BaseProfessionalApprovalApplication>, Comparable<BaseProfessionalApprovalApplication> 
{


	public static BaseProfessionalApprovalApplication newInstance(){
		return new BaseProfessionalApprovalApplication();
	}

	@Override
	public BaseProfessionalApprovalApplication make(){
		BaseProfessionalApprovalApplication b = new BaseProfessionalApprovalApplication();
		return b;
	}
	...
	public final static String ALL_CAPTIONS = "专业负责人审批编码,创建人,工号,开始日期,删除状态  0未删除    1已删除,项目,项目编号,项目名称,合同编码,合同编号,合同名称,业务部门,业务类别,项目类型 1项目 2前期项目,事业部负责人,项目等级,部门经理,积分管理员,专业负责人名称,专业负责人部门,公区面积,后勤面积,设计面积,项目总积分,项目积分,预留积分,核算比例";
	...
	public void cloneCopy(BaseProfessionalApprovalApplication __bean){
	...
	@Override
	public int compareTo(BaseProfessionalApprovalApplication o) {
		return __professional_approval__id == null ? -1 : __professional_approval__id.compareTo(o.getProfessionalApproval_id());
	}
	...
	public boolean equals(Object obj) {
		...
		final BaseProfessionalApprovalApplication o = (BaseProfessionalApprovalApplication)obj;
