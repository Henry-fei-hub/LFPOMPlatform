...
public class BaseSpreProjectRecordRrtor extends GenericBase implements BaseFactory<BaseSpreProjectRecordRrtor>, Comparable<BaseSpreProjectRecordRrtor> 
{


	public static BaseSpreProjectRecordRrtor newInstance(){
		return new BaseSpreProjectRecordRrtor();
	}

	@Override
	public BaseSpreProjectRecordRrtor make(){
		BaseSpreProjectRecordRrtor b = new BaseSpreProjectRecordRrtor();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键id,相关人员,跟踪时间,信息类型（1项目信息  2合同信息）,情况描述,附件,登记人,登记时间,跟踪编号,项目id,附件名称,相关人员名字,前期项目id,赢率,合同状态,合同金额,设计报价";
	...
	public void cloneCopy(BaseSpreProjectRecordRrtor __bean){
	...
	@Override
	public int compareTo(BaseSpreProjectRecordRrtor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSpreProjectRecordRrtor o = (BaseSpreProjectRecordRrtor)obj;
