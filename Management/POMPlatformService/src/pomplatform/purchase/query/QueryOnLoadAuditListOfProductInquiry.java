...
public class QueryOnLoadAuditListOfProductInquiry extends AbstractQuery<BaseOnLoadAuditListOfProductInquiry, ConditionOnLoadAuditListOfProductInquiry>
{

	private static final Logger __logger = Logger.getLogger(QueryOnLoadAuditListOfProductInquiry.class);

	public QueryOnLoadAuditListOfProductInquiry() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseOnLoadAuditListOfProductInquiry> executeQuery( KeyValuePair[] replacements, ConditionOnLoadAuditListOfProductInquiry condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseOnLoadAuditListOfProductInquiry generateBase(Object[] __data) throws java.sql.SQLException {
		BaseOnLoadAuditListOfProductInquiry __base = new BaseOnLoadAuditListOfProductInquiry();
		int count = 0;
		Object val;
