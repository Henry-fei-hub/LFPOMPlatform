...
public class QuerySpaymenttemplateommor extends AbstractQuery<BaseSpaymenttemplateommor, ConditionSpaymenttemplateommor>
{

	private static final Logger __logger = Logger.getLogger(QuerySpaymenttemplateommor.class);

	public QuerySpaymenttemplateommor() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseSpaymenttemplateommor> executeQuery( KeyValuePair[] replacements, ConditionSpaymenttemplateommor condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseSpaymenttemplateommor generateBase(Object[] __data) throws java.sql.SQLException {
		BaseSpaymenttemplateommor __base = new BaseSpaymenttemplateommor();
		int count = 0;
		Object val;
