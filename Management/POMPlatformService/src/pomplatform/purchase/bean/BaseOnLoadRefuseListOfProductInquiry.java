...
public class BaseOnLoadRefuseListOfProductInquiry extends GenericBase implements BaseFactory<BaseOnLoadRefuseListOfProductInquiry>, Comparable<BaseOnLoadRefuseListOfProductInquiry> 
{


	public static BaseOnLoadRefuseListOfProductInquiry newInstance(){
		return new BaseOnLoadRefuseListOfProductInquiry();
	}

	@Override
	public BaseOnLoadRefuseListOfProductInquiry make(){
		BaseOnLoadRefuseListOfProductInquiry b = new BaseOnLoadRefuseListOfProductInquiry();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,业务编码,业务名称,流程编码,活动实列编码,流程状态,完成时间,主键编码,主题,流程类型,事由,申请人工号,申请人部门,创建人,创建时间,删除状态  0未删除    1已删除,备注";
	...
	public void cloneCopy(BaseOnLoadRefuseListOfProductInquiry __bean){
	...
	@Override
	public int compareTo(BaseOnLoadRefuseListOfProductInquiry o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseOnLoadRefuseListOfProductInquiry o = (BaseOnLoadRefuseListOfProductInquiry)obj;
