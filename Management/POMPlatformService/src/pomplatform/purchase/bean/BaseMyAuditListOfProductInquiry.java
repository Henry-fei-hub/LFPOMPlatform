...
public class BaseMyAuditListOfProductInquiry extends GenericBase implements BaseFactory<BaseMyAuditListOfProductInquiry>, Comparable<BaseMyAuditListOfProductInquiry> 
{


	public static BaseMyAuditListOfProductInquiry newInstance(){
		return new BaseMyAuditListOfProductInquiry();
	}

	@Override
	public BaseMyAuditListOfProductInquiry make(){
		BaseMyAuditListOfProductInquiry b = new BaseMyAuditListOfProductInquiry();
		return b;
	}
	...
	public void cloneCopy(BaseMyAuditListOfProductInquiry __bean){
	...
	@Override
	public int compareTo(BaseMyAuditListOfProductInquiry o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseMyAuditListOfProductInquiry o = (BaseMyAuditListOfProductInquiry)obj;
