...
public class BaseAttachmentApprovalAlready extends GenericBase implements BaseFactory<BaseAttachmentApprovalAlready>, Comparable<BaseAttachmentApprovalAlready> 
{


	public static BaseAttachmentApprovalAlready newInstance(){
		return new BaseAttachmentApprovalAlready();
	}

	@Override
	public BaseAttachmentApprovalAlready make(){
		BaseAttachmentApprovalAlready b = new BaseAttachmentApprovalAlready();
		return b;
	}
	...
	public void cloneCopy(BaseAttachmentApprovalAlready __bean){
	...
	@Override
	public int compareTo(BaseAttachmentApprovalAlready o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseAttachmentApprovalAlready o = (BaseAttachmentApprovalAlready)obj;
