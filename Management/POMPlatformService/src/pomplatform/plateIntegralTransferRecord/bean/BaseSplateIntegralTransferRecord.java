package pomplatform.plateIntegralTransferRecord.bean;
...
public class BaseSplateIntegralTransferRecord extends GenericBase implements BaseFactory<BaseSplateIntegralTransferRecord>, Comparable<BaseSplateIntegralTransferRecord> 
{


	public static BaseSplateIntegralTransferRecord newInstance(){
		return new BaseSplateIntegralTransferRecord();
	}

	@Override
	public BaseSplateIntegralTransferRecord make(){
		BaseSplateIntegralTransferRecord b = new BaseSplateIntegralTransferRecord();
		return b;
	}
	...
	public void cloneCopy(BaseSplateIntegralTransferRecord __bean){
	...
	@Override
	public int compareTo(BaseSplateIntegralTransferRecord o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSplateIntegralTransferRecord o = (BaseSplateIntegralTransferRecord)obj;
