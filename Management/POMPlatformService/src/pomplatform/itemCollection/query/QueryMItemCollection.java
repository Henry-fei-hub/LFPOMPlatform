...
public class QueryMItemCollection extends AbstractQuery<BaseMItemCollection, ConditionMItemCollection>
{

	private static final Logger __logger = Logger.getLogger(QueryMItemCollection.class);

	public QueryMItemCollection() throws java.sql.SQLException 
	{
