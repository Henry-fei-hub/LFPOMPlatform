...
public class BaseMItemCollection extends GenericBase implements BaseFactory<BaseMItemCollection>, Comparable<BaseMItemCollection> 
{


	public static BaseMItemCollection newInstance(){
		return new BaseMItemCollection();
	}

	@Override
	public BaseMItemCollection make(){
		BaseMItemCollection b = new BaseMItemCollection();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主订单编码,合同编号,合同名称,客户名称,开始日期,结束日期,结算状态,项目编号,合同类别,项目等级,项目总工期,签约总金额,总设计面积,合同单价,项目地点,合同跟进人,备注,合同签订日期,我方签约公司名称,创建时间,修改时间,业务类别,流转状态，默认为0表示可以提交到运营管理修改承接部门1表示可以提交到运营管理运营价格2表示可以提交到运营管理运营价格审核3表示审核完成,流水号,项目类别,建筑面积,配合专业,省份,城市,详细地址,客户地址,服务建议书,立单时间 提交了立单时间会将保存下来，只是点击保存不会将当前时间保存下来，单每次都会显示当前的时间，提交了下次显示的就是提交时的立单时间,标记补充协议字段；除0之外，其他都表示第n个补充协议,tree结构表示,信息编号";
	...
	public void cloneCopy(BaseMItemCollection __bean){
	...
	@Override
	public int compareTo(BaseMItemCollection o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseMItemCollection o = (BaseMItemCollection)obj;
