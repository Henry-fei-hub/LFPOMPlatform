...
public class BaseInspectionReport extends GenericBase implements BaseFactory<BaseInspectionReport>, Comparable<BaseInspectionReport> 
{


	public static BaseInspectionReport newInstance(){
		return new BaseInspectionReport();
	}

	@Override
	public BaseInspectionReport make(){
	...
	public final static java.lang.String ALL_CAPTIONS = "业务编码,报销编号,流程类型,流程编码,流程状态,流程编码,活动实列编码,业务名称,活动编码,返回数据集,节点类型 0 - 开始 1 - 结束 2 - 审批 3 - 处理 4 - 知会,附加节点，说明节点是预定义的节点还是动态加的节点， 0 - 正常定义的节点， 1 - 申请人或者审批人加的处理人或者审批人,当前流程实例节点的内部编码,下一个流程节点的编码,如果是知会节点，所依附的主节点,,流程实例节点创建时间,流程实例节点开始处于活动时间,报销人,操作时间,提交意见,状态,,删除状态  0未删除    1已删除";
	...
	public void cloneCopy(BaseInspectionReport __bean){
	...
	@Override
	public int compareTo(BaseInspectionReport o) {
		return __business_id == null ? -1 : __business_id.compareTo(o.getBusinessId());
	}
	...
	public boolean equals(Object obj) {
		...
		final BaseInspectionReport o = (BaseInspectionReport)obj;
