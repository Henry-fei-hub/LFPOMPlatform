...
public class BaseLinkOfLeaveTypeAndArea extends GenericBase implements BaseFactory<BaseLinkOfLeaveTypeAndArea>, Comparable<BaseLinkOfLeaveTypeAndArea> 
{


	public static BaseLinkOfLeaveTypeAndArea newInstance(){
		return new BaseLinkOfLeaveTypeAndArea();
	}

	@Override
	public BaseLinkOfLeaveTypeAndArea make(){
		BaseLinkOfLeaveTypeAndArea b = new BaseLinkOfLeaveTypeAndArea();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "请假类型区域关联表,请假类型,适用区域,天数,备注,是否启用";
	...
	public void cloneCopy(BaseLinkOfLeaveTypeAndArea __bean){
	...
	@Override
	public int compareTo(BaseLinkOfLeaveTypeAndArea o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseLinkOfLeaveTypeAndArea o = (BaseLinkOfLeaveTypeAndArea)obj;
