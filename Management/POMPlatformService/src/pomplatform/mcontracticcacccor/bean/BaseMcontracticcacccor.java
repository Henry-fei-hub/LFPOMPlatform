...
public class BaseMcontracticcacccor extends GenericBase implements BaseFactory<BaseMcontracticcacccor>, Comparable<BaseMcontracticcacccor> 
{


	public static BaseMcontracticcacccor newInstance(){
		return new BaseMcontracticcacccor();
	}

	@Override
	public BaseMcontracticcacccor make(){
		BaseMcontracticcacccor b = new BaseMcontracticcacccor();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS_2 = "合同编号,合同名称,客户名称,合同总金额,已开发票金额,已收款金额,已开发票未收款金额,合同未收款金额";
	...
	public void cloneCopy(BaseMcontracticcacccor __bean){
	...
	public java.lang.String toCSVString() {
		...
		sb.append(getContractCode() == null ? "" : StaticMethod.getReplaceAll(getContractCode()));
		sb.append(",");
		sb.append(getContractName() == null ? "" : StaticMethod.getReplaceAll(getContractName()));
		sb.append(",");
		sb.append(getCustomerName() == null ? "" : StaticMethod.getReplaceAll(getCustomerName()));
		sb.append(",");
		sb.append(getSigningMoneySum() == null ? "" : StaticMethod.getReplaceAll(getSigningMoneySum()+""));
		sb.append(",");
		sb.append(getInvoiceAmount() == null ? "" : StaticMethod.getReplaceAll(getInvoiceAmount()+""));
		sb.append(",");
		sb.append(getBorrowMoney() == null ? "" : StaticMethod.getReplaceAll(getBorrowMoney()+""));
		sb.append(",");
		sb.append(getUnReciveMoney() == null ? "" : StaticMethod.getReplaceAll(getUnReciveMoney()+""));
		sb.append(",");
		sb.append(getUnReciveContractMoney() == null ? "" : StaticMethod.getReplaceAll(getUnReciveContractMoney()+""));
		return sb.toString();
	}

	@Override
	public int compareTo(BaseMcontracticcacccor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseMcontracticcacccor o = (BaseMcontracticcacccor)obj;
