...
public class BaseProjectAttachmentManage extends GenericBase implements BaseFactory<BaseProjectAttachmentManage>, Comparable<BaseProjectAttachmentManage> 
{


	public static BaseProjectAttachmentManage newInstance(){
		return new BaseProjectAttachmentManage();
	}

	@Override
	public BaseProjectAttachmentManage make(){
		BaseProjectAttachmentManage b = new BaseProjectAttachmentManage();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "业务部门,合同编号,订单编号,订单名称,主键编码,项目编码,项目阶段,上传时间,附件,备注,附件是否处理,是否是同一个合同,是否是同一个阶段,是否有对方的签字,是否有对方的盖章,对方是否明确确认,是否合格,操作人,操作时间,邮件确认,其它确认";
	...
	public void cloneCopy(BaseProjectAttachmentManage __bean){
	...
	@Override
	public int compareTo(BaseProjectAttachmentManage o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseProjectAttachmentManage o = (BaseProjectAttachmentManage)obj;
