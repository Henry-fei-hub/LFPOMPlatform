...
public class BaseNonconformityAttachmentDetail extends GenericBase implements BaseFactory<BaseNonconformityAttachmentDetail>, Comparable<BaseNonconformityAttachmentDetail> 
{


	public static BaseNonconformityAttachmentDetail newInstance(){
		return new BaseNonconformityAttachmentDetail();
	}

	@Override
	public BaseNonconformityAttachmentDetail make(){
		BaseNonconformityAttachmentDetail b = new BaseNonconformityAttachmentDetail();
		return b;
	}
	...
	public void cloneCopy(BaseNonconformityAttachmentDetail __bean){
	...
	@Override
	public int compareTo(BaseNonconformityAttachmentDetail o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseNonconformityAttachmentDetail o = (BaseNonconformityAttachmentDetail)obj;
