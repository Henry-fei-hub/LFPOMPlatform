...
public class BaseContractIncomeLedgerList extends GenericBase implements BaseFactory<BaseContractIncomeLedgerList>, Comparable<BaseContractIncomeLedgerList> 
{


	public static BaseContractIncomeLedgerList newInstance(){
		return new BaseContractIncomeLedgerList();
	}

	@Override
	public BaseContractIncomeLedgerList make(){
		BaseContractIncomeLedgerList b = new BaseContractIncomeLedgerList();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "合同编号,合同名称,合同签约公司,客户,客户名称,项目经理,项目负责人,合同签约金额,累计收款,未收款,开票日期,发票号码,开票阶段,开票金额,当月收款金额,当月收款日期,当月收款备注,项目状态,备注,联系人,台账年份,台账月份,创建时间,修改时间,是否锁定,收入台账序号";
	...
	public void cloneCopy(BaseContractIncomeLedgerList __bean){
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		sb.append(getCurrentReceiveRemark() == null ? "" : getCurrentReceiveRemark().replaceAll(",", "，"));
		sb.append(",");
	...
	@Override
	public int compareTo(BaseContractIncomeLedgerList o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseContractIncomeLedgerList o = (BaseContractIncomeLedgerList)obj;
