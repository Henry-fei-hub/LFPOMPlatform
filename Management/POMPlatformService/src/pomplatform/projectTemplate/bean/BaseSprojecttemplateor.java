...
public class BaseSprojecttemplateor extends GenericBase implements BaseFactory<BaseSprojecttemplateor>, Comparable<BaseSprojecttemplateor> 
{


	public static BaseSprojecttemplateor newInstance(){
		return new BaseSprojecttemplateor();
	}

	@Override
	public BaseSprojecttemplateor make(){
		BaseSprojecttemplateor b = new BaseSprojecttemplateor();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "项目阶段模板id,项目阶段模板名称,项目类别,业务部门,业务类别";
	...
	public void cloneCopy(BaseSprojecttemplateor __bean){
	...
	@Override
	public int compareTo(BaseSprojecttemplateor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSprojecttemplateor o = (BaseSprojecttemplateor)obj;
