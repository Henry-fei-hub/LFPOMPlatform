...
public class BaseEmployeeViolationCharges extends GenericBase implements BaseFactory<BaseEmployeeViolationCharges>, Comparable<BaseEmployeeViolationCharges> 
{


	public static BaseEmployeeViolationCharges newInstance(){
		return new BaseEmployeeViolationCharges();
	}

	@Override
	public BaseEmployeeViolationCharges make(){
		BaseEmployeeViolationCharges b = new BaseEmployeeViolationCharges();
		return b;
	}

	public final static java.lang.String CS_主键ID = "主键id" ;
	...
	public final static java.lang.String ALL_CAPTIONS = "employee_violation_charges_id,员工,业务部门,项目违规金,违规日期,操作者,操作时间,备注,状态(1待处理,2已同意,3已拒绝)";
	...
	public void cloneCopy(BaseEmployeeViolationCharges __bean){
	...
	@Override
	public int compareTo(BaseEmployeeViolationCharges o) {
		return __主键id == null ? -1 : __主键id.compareTo(o.getEmployeeViolationChargesId());
	}

	@Override
	public int hashCode() {
		int hash = 7;
		hash = 97 * hash + Objects.hashCode(this.__主键id);
	...
	public boolean equals(Object obj) {
		...
		final BaseEmployeeViolationCharges o = (BaseEmployeeViolationCharges)obj;
		if(!Objects.equals(this.__主键id, o.getEmployeeViolationChargesId())) return false;
	...
	protected java.lang.Integer  __主键id ;
