...
public class BaseEmployeeReportRecordDetail extends GenericBase
		implements BaseFactory<BaseEmployeeReportRecordDetail>, Comparable<BaseEmployeeReportRecordDetail> {

	public static BaseEmployeeReportRecordDetail newInstance() {
		return new BaseEmployeeReportRecordDetail();
	}

	@Override
	public BaseEmployeeReportRecordDetail make() {
		BaseEmployeeReportRecordDetail b = new BaseEmployeeReportRecordDetail();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "业务部门,员工,姓名,工号,积分余额,确认积分,奖金补贴,积分借款,积分还款,人工成本,项目成本,项目补贴,在职状态,奖金发放,积分回收,项目违规金";
	...
	public void cloneCopy(BaseEmployeeReportRecordDetail __bean) {
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		String strStatus = delicacy.system.executor.SelectValueCache.getSelectValue("system_dictionary_11",
	...
	@Override
	public int compareTo(BaseEmployeeReportRecordDetail o) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final BaseEmployeeReportRecordDetail o = (BaseEmployeeReportRecordDetail) obj;
		...
		if (!Objects.equals(this.__achieve_integral, o.getAchieveIntegral()))
			return false;
		if (!Objects.equals(this.__sure_integral, o.getSureIntegral()))
			return false;
		...
		if (!Objects.equals(this.__salary_return, o.getSalaryReturn()))
			return false;
		if (!Objects.equals(this.__salary, o.getSalary()))
			return false;
		if (!Objects.equals(this.__project_cost, o.getProjectCost()))
			return false;
		if (!Objects.equals(this.__project_advance, o.getProjectAdvance()))
			return false;
		if (!Objects.equals(this.__status, o.getStatus()))
			return false;
		if (!Objects.equals(this.__bonus_payment, o.getBonusPayment()))
			return false;
		if (!Objects.equals(this.__integral_return, o.getIntegralReturn()))
			return false;
	...
	public java.lang.String toJSONString() {
		...
		if (getSureIntegral() != null)
			sb.append(__wrapDecimal(count++, "sureIntegral", getSureIntegral()));
		...
		if (getSalary() != null)
			sb.append(__wrapDecimal(count++, "salary", getSalary()));
		if (getProjectCost() != null)
			sb.append(__wrapDecimal(count++, "projectCost", getProjectCost()));
		...
		if (getBonusPayment() != null)
			sb.append(__wrapDecimal(count++, "bonusPayment", getBonusPayment()));
		if (getIntegralReturn() != null)
			sb.append(__wrapDecimal(count++, "integralReturn", getIntegralReturn()));
	...
	public void setDataFromMap(Map<String, Object> values) {
		...
		if ((val = values.get("sureIntegral")) != null)
			setSureIntegral(__getDecimal(val));
		...
		if ((val = values.get("salary")) != null)
			setSalary(__getDecimal(val));
		if ((val = values.get("projectCost")) != null)
			setProjectCost(__getDecimal(val));
		...
		if ((val = values.get("bonusPayment")) != null)
			setBonusPayment(__getDecimal(val));
		if ((val = values.get("integralReturn")) != null)
			setIntegralReturn(__getDecimal(val));
