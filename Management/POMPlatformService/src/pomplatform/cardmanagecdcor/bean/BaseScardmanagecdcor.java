...
public class BaseScardmanagecdcor extends GenericBase implements BaseFactory<BaseScardmanagecdcor>, Comparable<BaseScardmanagecdcor> 
{


	public static BaseScardmanagecdcor newInstance(){
		return new BaseScardmanagecdcor();
	}

	@Override
	public BaseScardmanagecdcor make(){
		BaseScardmanagecdcor b = new BaseScardmanagecdcor();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,对象编码,2单位),开户行,银行账号,开户行所在地,2报销卡),是否为默认卡,是否启用,currency_type,招商银行分行代码,真实收付款";
	...
	public void cloneCopy(BaseScardmanagecdcor __bean){
	...
	@Override
	public int compareTo(BaseScardmanagecdcor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseScardmanagecdcor o = (BaseScardmanagecdcor)obj;
