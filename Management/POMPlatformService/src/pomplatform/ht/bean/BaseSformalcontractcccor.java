...
public class BaseSformalcontractcccor extends GenericBase implements BaseFactory<BaseSformalcontractcccor>, Comparable<BaseSformalcontractcccor> 
{


	public static BaseSformalcontractcccor newInstance(){
		return new BaseSformalcontractcccor();
	}

	@Override
	public BaseSformalcontractcccor make(){
		BaseSformalcontractcccor b = new BaseSformalcontractcccor();
		return b;
	}
	...
	public final static java.lang.String CS_CONTRACT_STATUS = "contract_status" ;//合同状态 : 2已签署、1待签署、0未启动、3未签搁置、4解除
	public final static java.lang.String CS_JOB_MIX = "job_mix" ;//现场配合(次)
	public final static java.lang.String CS_SERVICE_AREA = "service_area" ;//服务面积(㎡)
	public final static java.lang.String CS_WITH_THE_AMOUNT = "with_the_amount" ;//配合费用(元)
	public final static java.lang.String CS_ON_SITE_TIME = "on_site_time" ;//驻场时间(月)
	public final static java.lang.String CS_ON_SITE_TOTAL_MONEY = "on_site_total_money" ;//驻场总金额(元)
	
	public final static java.lang.String CS_INFO_CODE = "info_code" ;//信息编号

	public final static java.lang.String ALL_CAPTIONS = "正式合同编码,客户合同编号,正式合同编号,正式合同名称,客户名称,开始日期,结束日期,结算状态,项目编号,合同类别,项目等级,项目总工期,签约总金额,总设计面积,合同单价,项目地点,合同跟进人,备注,合同签订日期,我方签约公司名称,创建时间,修改时间,业务类别,流转状态，默认为0表示可以提交到运营管理修改承接部门1表示可以提交到运营管理运营价格2表示可以提交到运营管理运营价格审核3表示审核完成,流水号,项目类别,建筑面积,配合专业,省份,城市,详细地址,客户地址,服务建议书,立单时间 提交了立单时间会将保存下来，只是点击保存不会将当前时间保存下来，单每次都会显示当前的时间，提交了下次显示的就是提交时的立单时间,标记补充协议字段；除0之外，其他都表示第n个补充协议,合同状态,现场配合(次),服务面积(㎡),配合费用(元),驻场时间(月),驻场总金额(元),信息编号";
	...
	public void cloneCopy(BaseSformalcontractcccor __bean){
	...
	public java.lang.String toCSVString() {
		...
		sb.append(strProjectType == null ? "" : strcontractStatus);
		sb.append(",");
	...
	@Override
	public int compareTo(BaseSformalcontractcccor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSformalcontractcccor o = (BaseSformalcontractcccor)obj;
	...
	public java.lang.String toJSONString() {
		...
		if(getServiceArea() != null) sb.append(__wrapNumber(count++, "serviceArea", getServiceArea()));
		if(getWithTheAmount() != null) sb.append(__wrapNumber(count++, "withTheAmount", getWithTheAmount()));
		if(getOnSiteTotalMoney() != null) sb.append(__wrapNumber(count++, "onSiteTotalMoney", getOnSiteTotalMoney()));
