...
public class BaseOutQuotationApplication extends GenericBase implements BaseFactory<BaseOutQuotationApplication>, Comparable<BaseOutQuotationApplication> 
{


	public static BaseOutQuotationApplication newInstance(){
		return new BaseOutQuotationApplication();
	}

	@Override
	public BaseOutQuotationApplication make(){
		BaseOutQuotationApplication b = new BaseOutQuotationApplication();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "报价单编码,报价单编号(年月日-1),报价单名称,报价单总金额,报价单创建时间,信息编号,项目编号,,业务类型,项目类型,报价单(原附件),报价单的状态 1成功 2不成功 3报价中...,可操作状态 0可操作,1禁止操作,处理人,contract_id,修改时间";
	...
	public void cloneCopy(BaseOutQuotationApplication __bean){
	...
	@Override
	public int compareTo(BaseOutQuotationApplication o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseOutQuotationApplication o = (BaseOutQuotationApplication)obj;
