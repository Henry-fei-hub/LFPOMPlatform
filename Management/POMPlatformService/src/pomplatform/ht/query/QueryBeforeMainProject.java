...
public class QueryBeforeMainProject extends AbstractQuery<BaseMainProject, ConditionMainProject>
{

	private static final Logger __logger = Logger.getLogger(QueryBeforeMainProject.class);

	public QueryBeforeMainProject() throws java.sql.SQLException 
	{
