...
public class BaseContractStageAuditManager extends GenericBase implements BaseFactory<BaseContractStageAuditManager>, Comparable<BaseContractStageAuditManager> 
{


	public static BaseContractStageAuditManager newInstance(){
		return new BaseContractStageAuditManager();
	}

	@Override
	public BaseContractStageAuditManager make(){
		BaseContractStageAuditManager b = new BaseContractStageAuditManager();
		return b;
	}
	...
	public void cloneCopy(BaseContractStageAuditManager __bean){
	...
	@Override
	public int compareTo(BaseContractStageAuditManager o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseContractStageAuditManager o = (BaseContractStageAuditManager)obj;
