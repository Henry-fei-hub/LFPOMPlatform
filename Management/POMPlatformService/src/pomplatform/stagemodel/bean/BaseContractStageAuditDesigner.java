...
public class BaseContractStageAuditDesigner extends GenericBase implements BaseFactory<BaseContractStageAuditDesigner>, Comparable<BaseContractStageAuditDesigner> 
{


	public static BaseContractStageAuditDesigner newInstance(){
		return new BaseContractStageAuditDesigner();
	}

	@Override
	public BaseContractStageAuditDesigner make(){
		BaseContractStageAuditDesigner b = new BaseContractStageAuditDesigner();
		return b;
	}
	...
	public final static java.lang.String CS_AUDIT_STATUS = "audit_status" ;

	public final static java.lang.String ALL_CAPTIONS = "主键编码,合同,合同编号,合同名称,节点名称,是否锁定,审批状态";
	...
	public java.lang.String getAuditStatus() {
		return this.__audit_status;
	}

	public void setAuditStatus( java.lang.String value ) {
		this.__audit_status = value;
	}

	public void cloneCopy(BaseContractStageAuditDesigner __bean){
		...
		__bean.setAuditStatus(getAuditStatus());
	}
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		sb.append(getAuditStatus() == null ? "" : getAuditStatus());
		return sb.toString();
	}

	@Override
	public int compareTo(BaseContractStageAuditDesigner o) {
	...
	public int hashCode() {
		...
		hash = 97 * hash + Objects.hashCode(this.__audit_status);
		return hash;
	}
	...
	public boolean equals(Object obj) {
		...
		final BaseContractStageAuditDesigner o = (BaseContractStageAuditDesigner)obj;
		...
		if(!Objects.equals(this.__audit_status, o.getAuditStatus())) return false;
		return true;
	}
	...
	public java.lang.String toJSONString() {
		...
		if(getAuditStatus() != null) sb.append(__wrapString(count++, "auditStatus", getAuditStatus()));
		return sb.toString();
	}
	...
	public void setDataFromMap(Map<String, Object> values){
		...
		if((val = values.get("auditStatus")) != null) setAuditStatus(__getString(val));
	}
	...
	protected java.lang.String  __audit_status ;
}
