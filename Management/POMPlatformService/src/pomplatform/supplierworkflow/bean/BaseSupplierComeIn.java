...
public class BaseSupplierComeIn extends GenericBase implements BaseFactory<BaseSupplierComeIn>, Comparable<BaseSupplierComeIn> 
{


	public static BaseSupplierComeIn newInstance(){
		return new BaseSupplierComeIn();
	}

	@Override
	public BaseSupplierComeIn make(){
		BaseSupplierComeIn b = new BaseSupplierComeIn();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "供应商编码,供应商名称,供应商联系人,供应商电话,供应商邮箱,供应商类型,供应商主营业务类型,供货范围,社会信用代码,供应商所在(省),供应商所在(市),供应商开户行详细地址,供应商税务登记地址,生产周期,物流周期,供应商法定代表人,合同签订日期,合同周期,合同周期开始时间,合同周期结束时间,操作人,操作时间,供应商来源,供应商状态,收款单位是否有效(0无效，1有效),主键编码,协议类别,协议签订时间,协议签订地点,附件编码,团队规模,擅长领域";
	...
	public java.util.List<BaseSupplierDetail> getDetailSupplierDetail() {
		return this.__detailSupplierDetail;
	}

	public void setDetailSupplierDetail( java.util.List<BaseSupplierDetail> value ) {
		this.__detailSupplierDetail = value;
	}

	public java.util.List<BaseSupplierCooperation> getDetailSupplierCooperation() {
		return this.__detailSupplierCooperation;
	}

	public void setDetailSupplierCooperation( java.util.List<BaseSupplierCooperation> value ) {
		this.__detailSupplierCooperation = value;
	}

	public void cloneCopy(BaseSupplierComeIn __bean){
	...
	@Override
	public int compareTo(BaseSupplierComeIn o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSupplierComeIn o = (BaseSupplierComeIn)obj;
	...
	public java.lang.String toJSONString() {
		...
		if(getDetailSupplierDetail() != null)  sb.append(__wrapList(count++, "detailSupplierDetail", getDetailSupplierDetail()));
		if(getDetailSupplierCooperation() != null)  sb.append(__wrapList(count++, "detailSupplierCooperation", getDetailSupplierCooperation()));
		return sb.toString();
	}
	...
	protected java.util.List<BaseSupplierDetail> __detailSupplierDetail = null;
	protected java.util.List<BaseSupplierCooperation> __detailSupplierCooperation = null;
}
