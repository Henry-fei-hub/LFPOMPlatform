...
public class QueryExcludeMprocessbilllistsmmeor extends AbstractQuery<BaseMprocessbilllistsmmeor, ConditionMprocessbilllistsmmeor>
{

	private static final Logger __logger = Logger.getLogger(QueryExcludeMprocessbilllistsmmeor.class);

	public QueryExcludeMprocessbilllistsmmeor() throws java.sql.SQLException 
	{
