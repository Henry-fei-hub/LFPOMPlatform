package pomplatform.applyfunctions.bean;
...
public class BaseApplyFunctions extends GenericBase implements BaseFactory<BaseApplyFunctions>, Comparable<BaseApplyFunctions> 
{


	public static BaseApplyFunctions newInstance(){
		return new BaseApplyFunctions();
	}

	@Override
	public BaseApplyFunctions make(){
		BaseApplyFunctions b = new BaseApplyFunctions();
		return b;
	}
	...
	public void cloneCopy(BaseApplyFunctions __bean){
	...
	@Override
	public int compareTo(BaseApplyFunctions o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseApplyFunctions o = (BaseApplyFunctions)obj;
