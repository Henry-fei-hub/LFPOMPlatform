package pomplatform.applyfunctions.query;
...
import pomplatform.applyfunctions.bean.BaseApplyFunctions;
import pomplatform.applyfunctions.bean.ConditionApplyFunctions;

public class QueryApplyFunctions extends AbstractQuery<BaseApplyFunctions, ConditionApplyFunctions>
{

	private static final Logger __logger = Logger.getLogger(QueryApplyFunctions.class);

	public QueryApplyFunctions() throws java.sql.SQLException 
	{
		setParameterNumber(67);
		setConnection(ThreadConnection.getConnection());
		setOrderByFields("pb.personnel_business_id");
	}

	@Override
	public BaseCollection<BaseApplyFunctions> executeQuery( KeyValuePair[] replacements, ConditionApplyFunctions condition ) throws java.sql.SQLException {
		return executeQuery(replacements, 
				...
				condition.getAttachmentId(), 
				condition.getAttachmentName()
			);
	}

	@Override
	public BaseApplyFunctions generateBase(Object[] __data) throws java.sql.SQLException {
		BaseApplyFunctions __base = new BaseApplyFunctions();
		int count = 0;
		Object val;
	...
	public int setStatementParameters(int count, java.lang.Object ... args) throws java.sql.SQLException {
		...
		if(args[24] != null) __statement.setBigDecimal(count++, GenericBase.__getDecimal(args[24]));
		...
		if(args[29] != null) __statement.setBoolean(count++, GenericBase.__getBoolean(args[29]));
		...
		if(args[37] != null) __statement.setBoolean(count++, GenericBase.__getBoolean(args[37]));
		if(args[38] != null) __statement.setBigDecimal(count++, GenericBase.__getDecimal(args[38]));
		if(args[39] != null) __statement.setBigDecimal(count++, GenericBase.__getDecimal(args[39]));
		if(args[40] != null) __statement.setInt(count++, GenericBase.__getInt(args[40]));
		if(args[41] != null) __statement.setString(count++, GenericBase.__getString(args[41]));
		if(args[42] != null) __statement.setInt(count++, GenericBase.__getInt(args[42]));
		if(args[43] != null) __statement.setString(count++, GenericBase.__getString(args[43]));
		if(args[44] != null) __statement.setInt(count++, GenericBase.__getInt(args[44]));
		if(args[45] != null) __statement.setBigDecimal(count++, GenericBase.__getDecimal(args[45]));
		...
		if(args[50] != null) __statement.setString(count++, GenericBase.__getString(args[50]));
		if(args[51] != null) __statement.setBigDecimal(count++, GenericBase.__getDecimal(args[51]));
		...
		if(args[57] != null) __statement.setString(count++, GenericBase.__getString(args[57]));
		if(args[58] != null) __statement.setInt(count++, GenericBase.__getInt(args[58]));
		if(args[59] != null) __statement.setTimestamp(count++, generateTimestampFromDate((java.util.Date)args[59]));
		...
		if(args[66] != null) __statement.setString(count++, GenericBase.__getString(args[66]));
		return count;
	}
