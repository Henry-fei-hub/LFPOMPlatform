...
public class BaseSthreadtaskmanagemmmor extends GenericBase implements BaseFactory<BaseSthreadtaskmanagemmmor>, Comparable<BaseSthreadtaskmanagemmmor> 
{


	public static BaseSthreadtaskmanagemmmor newInstance(){
		return new BaseSthreadtaskmanagemmmor();
	}

	@Override
	public BaseSthreadtaskmanagemmmor make(){
		BaseSthreadtaskmanagemmmor b = new BaseSthreadtaskmanagemmmor();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键,任务类型,任务状态,错误信息,操作人,操作类型,开始时间,结束时间,创建时间,备注";
	...
	public void cloneCopy(BaseSthreadtaskmanagemmmor __bean){
	...
	@Override
	public int compareTo(BaseSthreadtaskmanagemmmor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSthreadtaskmanagemmmor o = (BaseSthreadtaskmanagemmmor)obj;
