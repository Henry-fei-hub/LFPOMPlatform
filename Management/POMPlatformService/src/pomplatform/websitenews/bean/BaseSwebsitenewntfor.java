...
public class BaseSwebsitenewntfor extends GenericBase implements BaseFactory<BaseSwebsitenewntfor>, Comparable<BaseSwebsitenewntfor> 
{


	public static BaseSwebsitenewntfor newInstance(){
		return new BaseSwebsitenewntfor();
	}

	@Override
	public BaseSwebsitenewntfor make(){
		BaseSwebsitenewntfor b = new BaseSwebsitenewntfor();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键,主题,文件路径,内容,创建时间,新闻类型  1公告,删除标志 1 未删除  2已删除,排序标志 值越大越靠前";
	...
	public java.lang.Integer getAttachmentId() {
		return __attachment_id;
	}

	public void setAttachmentId(java.lang.Integer __attachment_id) {
		this.__attachment_id = __attachment_id;
	}

	public java.lang.String getAttachmentName() {
		return __attachment_name;
	}

	public void setAttachmentName(java.lang.String __attachment_name) {
		this.__attachment_name = __attachment_name;
	}

	public void cloneCopy(BaseSwebsitenewntfor __bean){
	...
	@Override
	public int compareTo(BaseSwebsitenewntfor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSwebsitenewntfor o = (BaseSwebsitenewntfor)obj;
