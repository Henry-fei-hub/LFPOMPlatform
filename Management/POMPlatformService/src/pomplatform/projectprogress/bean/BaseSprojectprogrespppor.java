...
public class BaseSprojectprogrespppor extends GenericBase implements BaseFactory<BaseSprojectprogrespppor>, Comparable<BaseSprojectprogrespppor> 
{


	public static BaseSprojectprogrespppor newInstance(){
		return new BaseSprojectprogrespppor();
	}

	@Override
	public BaseSprojectprogrespppor make(){
		BaseSprojectprogrespppor b = new BaseSprojectprogrespppor();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "项目进度编码,项目编码,项目负责人编码,设计阶段,完成日期,备用字段1,备用字段2,备用字段3,status";
	...
	public void cloneCopy(BaseSprojectprogrespppor __bean){
	...
	@Override
	public int compareTo(BaseSprojectprogrespppor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSprojectprogrespppor o = (BaseSprojectprogrespppor)obj;
