...
public class ConditionEmployeeSalaryReturnRecord extends GenericCondition {

	public ConditionEmployeeSalaryReturnRecord() {
		setParameterCount(5);
	}
	...
	public java.lang.String getEmployeeNo() {
		return this.__employee_no == null ? null
				: (this.__employee_no.indexOf("%") >= 0 ? this.__employee_no : "%" + this.__employee_no + "%");
	}
	...
	public java.lang.String toJSONString() {
		...
		if (getRecordYear() != null)
			sb.append(__wrapNumber(1, "recordYear", getRecordYear()));
		if (getRecordMonth() != null)
			sb.append(__wrapNumber(1, "recordMonth", getRecordMonth()));
		if (getEmployeeNo() != null)
			sb.append(__wrapString(1, "employeeNo", getEmployeeNo()));
		if (getEmployeeId() != null)
			sb.append(__wrapNumber(1, "employeeId", getEmployeeId()));
		return sb.toString();
	}
	...
	public void setDataFromMap(Map<String, Object> values) {
		...
		if ((val = values.get("recordYear")) != null)
			setRecordYear(__getInt(val));
		if ((val = values.get("recordMonth")) != null)
			setRecordMonth(__getInt(val));
