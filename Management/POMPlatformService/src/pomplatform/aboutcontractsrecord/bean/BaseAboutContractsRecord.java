...
public class BaseAboutContractsRecord extends GenericBase implements BaseFactory<BaseAboutContractsRecord>, Comparable<BaseAboutContractsRecord> 
{


	public static BaseAboutContractsRecord newInstance(){
		return new BaseAboutContractsRecord();
	}

	@Override
	public BaseAboutContractsRecord make(){
		BaseAboutContractsRecord b = new BaseAboutContractsRecord();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键id,项目名称,合同编码,合同名称,合同金额,合同签订状态,跟踪情况描述,跟踪时间,登记人,登记时间,相关人员,相关人员名称,客户名称,合同编号,合同签订日期,合同寄出日期,跟踪类型1.合同跟踪，2.前期项目跟踪,信息编号";
	...
	public void cloneCopy(BaseAboutContractsRecord __bean){
	...
	@Override
	public int compareTo(BaseAboutContractsRecord o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseAboutContractsRecord o = (BaseAboutContractsRecord)obj;
