...
public class BaseOnProjectQuoteTemplate extends GenericBase implements BaseFactory<BaseOnProjectQuoteTemplate>, Comparable<BaseOnProjectQuoteTemplate> 
{


	public static BaseOnProjectQuoteTemplate newInstance(){
		return new BaseOnProjectQuoteTemplate();
	}

	@Override
	public BaseOnProjectQuoteTemplate make(){
		BaseOnProjectQuoteTemplate b = new BaseOnProjectQuoteTemplate();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,项目id,主题名称,过往合作项目报价图片,版本号,2已报价),基准总额,小计总额,上浮金额,上浮系数,优惠金额,优惠系数,特殊折扣金额,特殊折扣系数,税金,其它税金（采买）,最终系数,不含税合计,含税合计,操作人,操作时间,备注,公司id";
	...
	public java.util.List<BaseProjectQuoteDetail> getDetailProjectQuoteDetail() {
		return this.__detailProjectQuoteDetail;
	}

	public void setDetailProjectQuoteDetail( java.util.List<BaseProjectQuoteDetail> value ) {
		this.__detailProjectQuoteDetail = value;
	}

	public void cloneCopy(BaseOnProjectQuoteTemplate __bean){
	...
	@Override
	public int compareTo(BaseOnProjectQuoteTemplate o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseOnProjectQuoteTemplate o = (BaseOnProjectQuoteTemplate)obj;
	...
	public java.lang.String toJSONString() {
		...
		if(getDetailProjectQuoteDetail() != null)  sb.append(__wrapList(count++, "detailProjectQuoteDetail", getDetailProjectQuoteDetail()));
		return sb.toString();
	}
	...
	protected java.util.List<BaseProjectQuoteDetail> __detailProjectQuoteDetail = null;
}
