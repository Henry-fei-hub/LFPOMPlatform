...
public class QueryJobManager extends AbstractQuery<BaseJobManager, ConditionJobManager>
{

	private static final Logger __logger = Logger.getLogger(QueryJobManager.class);

	public QueryJobManager() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseJobManager> executeQuery( KeyValuePair[] replacements, ConditionJobManager condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseJobManager generateBase(Object[] __data) throws java.sql.SQLException {
		BaseJobManager __base = new BaseJobManager();
		int count = 0;
		Object val;
