...
public class QuerySheetReportDetail extends AbstractQuery<BaseSheetReportDetail, ConditionSheetReportDetail>
{

	private static final Logger __logger = Logger.getLogger(QuerySheetReportDetail.class);

	public QuerySheetReportDetail() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseSheetReportDetail> executeQuery( KeyValuePair[] replacements, ConditionSheetReportDetail condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseSheetReportDetail generateBase(Object[] __data) throws java.sql.SQLException {
		BaseSheetReportDetail __base = new BaseSheetReportDetail();
		int count = 0;
		Object val;
