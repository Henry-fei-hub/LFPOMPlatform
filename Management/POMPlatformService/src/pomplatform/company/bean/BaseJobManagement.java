...
public class BaseJobManagement extends GenericBase implements BaseFactory<BaseJobManagement>, Comparable<BaseJobManagement> 
{


	public static BaseJobManagement newInstance(){
		return new BaseJobManagement();
	}

	@Override
	public BaseJobManagement make(){
		BaseJobManagement b = new BaseJobManagement();
		return b;
	}
	...
	public void cloneCopy(BaseJobManagement __bean){
	...
	@Override
	public int compareTo(BaseJobManagement o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseJobManagement o = (BaseJobManagement)obj;
