...
public class BaseSheetTotalByBusinessType extends GenericBase implements BaseFactory<BaseSheetTotalByBusinessType>, Comparable<BaseSheetTotalByBusinessType> 
{


	public static BaseSheetTotalByBusinessType newInstance(){
		return new BaseSheetTotalByBusinessType();
	}

	@Override
	public BaseSheetTotalByBusinessType make(){
		BaseSheetTotalByBusinessType b = new BaseSheetTotalByBusinessType();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "业务类型,订单总积分,投诉保证金,订单积分";
	...
	public void cloneCopy(BaseSheetTotalByBusinessType __bean){
	...
	@Override
	public int compareTo(BaseSheetTotalByBusinessType o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSheetTotalByBusinessType o = (BaseSheetTotalByBusinessType)obj;
