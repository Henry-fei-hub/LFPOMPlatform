...
public class BaseCompanyAccount extends GenericBase implements BaseFactory<BaseCompanyAccount>, Comparable<BaseCompanyAccount> 
{


	public static BaseCompanyAccount newInstance(){
		return new BaseCompanyAccount();
	}

	@Override
	public BaseCompanyAccount make(){
		BaseCompanyAccount b = new BaseCompanyAccount();
		return b;
	}
	...
	public final static java.lang.String CS_PROJECT_ADVANCE = "project_advance";//项目补贴

	public final static java.lang.String ALL_CAPTIONS = "编码,比率,账户余额,合同总额,订单总积分,公司补贴,中标奖金,投诉保证金,项目积分提取,奖金发放,公司费用,公司借款,公司还款,研发项目,管理项目,项目补贴";
	...
	public void cloneCopy(BaseCompanyAccount __bean){
	...
	@Override
	public int compareTo(BaseCompanyAccount o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseCompanyAccount o = (BaseCompanyAccount)obj;
