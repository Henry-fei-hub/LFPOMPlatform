...
public class BaseCompanyIntegralSubcontract extends GenericBase implements BaseFactory<BaseCompanyIntegralSubcontract>, Comparable<BaseCompanyIntegralSubcontract> 
{


	public static BaseCompanyIntegralSubcontract newInstance(){
		return new BaseCompanyIntegralSubcontract();
	}

	@Override
	public BaseCompanyIntegralSubcontract make(){
		BaseCompanyIntegralSubcontract b = new BaseCompanyIntegralSubcontract();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "订单编号,订单名称,业务类别,项目类别,承接部门,订单总积分,投诉保证金比例,投诉保证金,订单积分,小计,公区面积,后勤面积,设计面积,日期,项目编号";
	...
	public void cloneCopy(BaseCompanyIntegralSubcontract __bean){
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		String strDepartmentId = delicacy.system.executor.SelectValueCache.getSelectValue("plate_records_true", String.valueOf(getDepartmentId()));
	...
	@Override
	public int compareTo(BaseCompanyIntegralSubcontract o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseCompanyIntegralSubcontract o = (BaseCompanyIntegralSubcontract)obj;
