...
import pomplatform.projectEmployee.bean.BaseProjectEmployeeReport;
import pomplatform.projectEmployee.bean.ConditionProjectEmployeeReport;

public class QueryProjectEmployeeReport extends AbstractQuery<BaseProjectEmployeeReport, ConditionProjectEmployeeReport>
{

	private static final Logger __logger = Logger.getLogger(QueryProjectEmployeeReport.class);

	public QueryProjectEmployeeReport() throws java.sql.SQLException 
	{
		setParameterNumber(7);
		setConnection(ThreadConnection.getConnection());
		setOrderByFields("* from ( select pe.project_employee_id");
	}

	@Override
	public BaseCollection<BaseProjectEmployeeReport> executeQuery( KeyValuePair[] replacements, ConditionProjectEmployeeReport condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseProjectEmployeeReport generateBase(Object[] __data) throws java.sql.SQLException {
		BaseProjectEmployeeReport __base = new BaseProjectEmployeeReport();
		int count = 0;
		Object val;
