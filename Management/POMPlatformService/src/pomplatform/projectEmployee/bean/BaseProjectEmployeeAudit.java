...
public class BaseProjectEmployeeAudit extends GenericBase implements BaseFactory<BaseProjectEmployeeAudit>, Comparable<BaseProjectEmployeeAudit> 
{


	public static BaseProjectEmployeeAudit newInstance(){
		return new BaseProjectEmployeeAudit();
	}

	@Override
	public BaseProjectEmployeeAudit make(){
		BaseProjectEmployeeAudit b = new BaseProjectEmployeeAudit();
		return b;
	}
	...
	public void cloneCopy(BaseProjectEmployeeAudit __bean){
	...
	@Override
	public int compareTo(BaseProjectEmployeeAudit o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseProjectEmployeeAudit o = (BaseProjectEmployeeAudit)obj;
