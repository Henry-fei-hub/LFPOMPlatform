...
public class BaseRevenueYearStatisticalOfRevenue extends GenericBase implements BaseFactory<BaseRevenueYearStatisticalOfRevenue>, Comparable<BaseRevenueYearStatisticalOfRevenue> 
{


	public static BaseRevenueYearStatisticalOfRevenue newInstance(){
		return new BaseRevenueYearStatisticalOfRevenue();
	}

	@Override
	public BaseRevenueYearStatisticalOfRevenue make(){
		BaseRevenueYearStatisticalOfRevenue b = new BaseRevenueYearStatisticalOfRevenue();
		return b;
	}

	public final static java.lang.String CS_REVENUE_YEAR_STATISTICAL_RECORD_ID = "revenue_year_statistical_record_id" ;
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,项目编码,年份,1月,2月,3月,4月,5月,6月,7月,8月,9月,10月,11月,12月,操作人,操作时间,备注";

	public java.lang.Integer getRevenueYearStatisticalRecordId() {
		return this.__revenue_year_statistical_record_id;
	}

	public void setRevenueYearStatisticalRecordId( java.lang.Integer value ) {
		this.__revenue_year_statistical_record_id = value;
	}
	...
	public void cloneCopy(BaseRevenueYearStatisticalOfRevenue __bean){
		__bean.setRevenueYearStatisticalRecordId(getRevenueYearStatisticalRecordId());
	...
	public java.lang.String toCSVString() {
		...
		sb.append(getRevenueYearStatisticalRecordId() == null ? "" : getRevenueYearStatisticalRecordId());
		sb.append(",");
	...
	@Override
	public int compareTo(BaseRevenueYearStatisticalOfRevenue o) {
		return __revenue_year_statistical_record_id == null ? -1 : __revenue_year_statistical_record_id.compareTo(o.getRevenueYearStatisticalRecordId());
	}

	@Override
	public int hashCode() {
		int hash = 7;
		hash = 97 * hash + Objects.hashCode(this.__revenue_year_statistical_record_id);
	...
	public boolean equals(Object obj) {
		...
		final BaseRevenueYearStatisticalOfRevenue o = (BaseRevenueYearStatisticalOfRevenue)obj;
		if(!Objects.equals(this.__revenue_year_statistical_record_id, o.getRevenueYearStatisticalRecordId())) return false;
	...
	public java.lang.String toJSONString() {
		...
		StringBuilder sb = new StringBuilder();
		int count = 0;
		if(getRevenueYearStatisticalRecordId() != null) sb.append(__wrapNumber(count++, "revenueYearStatisticalRecordId", getRevenueYearStatisticalRecordId()));
	...
	public void setDataFromMap(Map<String, Object> values){
		Object val;
		if((val = values.get("revenueYearStatisticalRecordId")) != null) setRevenueYearStatisticalRecordId(__getInt(val)); 
	...
	protected java.lang.Integer  __revenue_year_statistical_record_id ;
