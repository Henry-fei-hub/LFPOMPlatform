...
public class BaseQualityFeeMonthlyDetail extends GenericBase implements BaseFactory<BaseQualityFeeMonthlyDetail>, Comparable<BaseQualityFeeMonthlyDetail> 
{


	public static BaseQualityFeeMonthlyDetail newInstance(){
		return new BaseQualityFeeMonthlyDetail();
	}

	@Override
	public BaseQualityFeeMonthlyDetail make(){
		BaseQualityFeeMonthlyDetail b = new BaseQualityFeeMonthlyDetail();
		return b;
	}
	...
	public void cloneCopy(BaseQualityFeeMonthlyDetail __bean){
	...
	@Override
	public int compareTo(BaseQualityFeeMonthlyDetail o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseQualityFeeMonthlyDetail o = (BaseQualityFeeMonthlyDetail)obj;
