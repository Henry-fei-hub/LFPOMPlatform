...
public class BaseQualityFeeDetail extends GenericBase implements BaseFactory<BaseQualityFeeDetail>, Comparable<BaseQualityFeeDetail> 
{


	public static BaseQualityFeeDetail newInstance(){
		return new BaseQualityFeeDetail();
	}

	@Override
	public BaseQualityFeeDetail make(){
		BaseQualityFeeDetail b = new BaseQualityFeeDetail();
		return b;
	}
	...
	public void cloneCopy(BaseQualityFeeDetail __bean){
	...
	@Override
	public int compareTo(BaseQualityFeeDetail o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseQualityFeeDetail o = (BaseQualityFeeDetail)obj;
