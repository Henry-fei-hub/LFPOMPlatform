...
public class QueryQualityFeeSumByMonth extends AbstractQuery<BaseQualityFeeSumByMonth, ConditionQualityFeeSumByMonth>
{

	private static final Logger __logger = Logger.getLogger(QueryQualityFeeSumByMonth.class);

	public QueryQualityFeeSumByMonth() throws java.sql.SQLException 
	{
