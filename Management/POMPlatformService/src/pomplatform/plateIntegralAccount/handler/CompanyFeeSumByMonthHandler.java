...
import pomplatform.plateIntegralAccount.query.QueryCompanyFeeSumByMonth;

public class CompanyFeeSumByMonthHandler implements GenericQuery,  GenericDownloadProcessor {

	private static final Logger __logger = Logger.getLogger(CompanyFeeSumByMonthHandler.class);
	...
	public static BaseCollection<BaseQualityFeeSumByMonth> executeQueryQualityFeeSumByMonth(ConditionQualityFeeSumByMonth c, KeyValuePair[] replacements ) throws Exception {
		QueryCompanyFeeSumByMonth dao = new QueryCompanyFeeSumByMonth();
