...
public class BaseScontractreceivabletemplaterrcor extends GenericBase implements BaseFactory<BaseScontractreceivabletemplaterrcor>, Comparable<BaseScontractreceivabletemplaterrcor> 
{


	public static BaseScontractreceivabletemplaterrcor newInstance(){
		return new BaseScontractreceivabletemplaterrcor();
	}

	@Override
	public BaseScontractreceivabletemplaterrcor make(){
		BaseScontractreceivabletemplaterrcor b = new BaseScontractreceivabletemplaterrcor();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "contract_receivable_template_id,阶段名称,备注,收款阶段id的父节点,操作人,创建时间,修改时间,收款百分比";
	...
	public void cloneCopy(BaseScontractreceivabletemplaterrcor __bean){
	...
	@Override
	public int compareTo(BaseScontractreceivabletemplaterrcor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseScontractreceivabletemplaterrcor o = (BaseScontractreceivabletemplaterrcor)obj;
