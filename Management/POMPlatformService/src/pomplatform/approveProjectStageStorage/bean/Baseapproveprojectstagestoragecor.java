...
public class Baseapproveprojectstagestoragecor extends GenericBase implements BaseFactory<Baseapproveprojectstagestoragecor>, Comparable<Baseapproveprojectstagestoragecor> 
{


	public static Baseapproveprojectstagestoragecor newInstance(){
		return new Baseapproveprojectstagestoragecor();
	}

	@Override
	public Baseapproveprojectstagestoragecor make(){
		Baseapproveprojectstagestoragecor b = new Baseapproveprojectstagestoragecor();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "项目主键,合同编号,项目编号,项目名称,项目类别,板块,专业负责人,事业部负责人,部门经理,id,流程id（system_processes）,删除状态  0未删除    1已删除,起草时间";
	...
	public void cloneCopy(Baseapproveprojectstagestoragecor __bean){
	...
	@Override
	public int compareTo(Baseapproveprojectstagestoragecor o) {
	...
	public boolean equals(Object obj) {
		...
		final Baseapproveprojectstagestoragecor o = (Baseapproveprojectstagestoragecor)obj;
