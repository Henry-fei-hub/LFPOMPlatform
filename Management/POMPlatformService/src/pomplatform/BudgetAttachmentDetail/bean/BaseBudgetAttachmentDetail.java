...
public class BaseBudgetAttachmentDetail extends GenericBase implements BaseFactory<BaseBudgetAttachmentDetail>, Comparable<BaseBudgetAttachmentDetail> 
{


	public static BaseBudgetAttachmentDetail newInstance(){
		return new BaseBudgetAttachmentDetail();
	}

	@Override
	public BaseBudgetAttachmentDetail make(){
		BaseBudgetAttachmentDetail b = new BaseBudgetAttachmentDetail();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键id,预算管理id,附件编码,附件名称,上传人员,上传时间,附件备注,合同金额,合同已付款金额,剩余合同金额,供应商,文件路径,预算类别,付款比例,是否审批 0.未审批 1.审批进行中,2.已审批,项目id,是否加锁";
	public final static java.lang.String EXPORT_CAPTIONS = "附件名称,合同预算金额,合同已付款金额,合同剩余金额,付款比例,供应商,预算类别,上传人员,上传时间,审批状态,备注";
	...
	public void cloneCopy(BaseBudgetAttachmentDetail __bean){
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		String strReceiveUnit = SelectValueCache.getSelectValue("receive_unit_manages_company", BaseHelpUtils.getString(getReceiveUnitManageId()));
		sb.append(strReceiveUnit == null ? "" : strReceiveUnit);
		sb.append(",");
		String strBddType = SelectValueCache.getSelectValue("budget_detail_type", BaseHelpUtils.getString(getBddType()));
		sb.append(strBddType == null ? "" : strBddType);
		sb.append(",");
		String strEmployee = SelectValueCache.getSelectValue("employees", BaseHelpUtils.getString(getUploadEmployeeId()));
		sb.append(strEmployee == null ? "" : strEmployee);
		sb.append(",");
		sb.append(getUploadTime() == null ? "" : sdf.format(getUploadTime()));
		sb.append(",");
		String strIsApproval = SelectValueCache.getSelectValue("system_dictionary_192", BaseHelpUtils.getString(getIsApproval()));
		sb.append(strIsApproval == null ? "" : strIsApproval);
		sb.append(",");
	...
	@Override
	public int compareTo(BaseBudgetAttachmentDetail o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseBudgetAttachmentDetail o = (BaseBudgetAttachmentDetail)obj;
