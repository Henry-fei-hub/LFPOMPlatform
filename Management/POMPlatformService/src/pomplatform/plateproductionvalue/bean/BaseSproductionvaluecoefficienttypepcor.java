...
public class BaseSproductionvaluecoefficienttypepcor extends GenericBase implements BaseFactory<BaseSproductionvaluecoefficienttypepcor>, Comparable<BaseSproductionvaluecoefficienttypepcor> 
{


	public static BaseSproductionvaluecoefficienttypepcor newInstance(){
		return new BaseSproductionvaluecoefficienttypepcor();
	}

	@Override
	public BaseSproductionvaluecoefficienttypepcor make(){
		BaseSproductionvaluecoefficienttypepcor b = new BaseSproductionvaluecoefficienttypepcor();
		return b;
	}
	...
	public void cloneCopy(BaseSproductionvaluecoefficienttypepcor __bean){
	...
	@Override
	public int compareTo(BaseSproductionvaluecoefficienttypepcor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSproductionvaluecoefficienttypepcor o = (BaseSproductionvaluecoefficienttypepcor)obj;
