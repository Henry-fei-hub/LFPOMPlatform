...
public class QueryChangeProjectInfo extends AbstractQuery<BaseChangeProjectInfo, ConditionChangeProjectInfo>
{

	private static final Logger __logger = Logger.getLogger(QueryChangeProjectInfo.class);

	public QueryChangeProjectInfo() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseChangeProjectInfo> executeQuery( KeyValuePair[] replacements, ConditionChangeProjectInfo condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseChangeProjectInfo generateBase(Object[] __data) throws java.sql.SQLException {
		BaseChangeProjectInfo __base = new BaseChangeProjectInfo();
		int count = 0;
		Object val;
	...
	private final static String[] fieldNames = { "project_id", "flag"};
}
