...
public class BaseChangeContractInfo extends GenericBase implements BaseFactory<BaseChangeContractInfo>, Comparable<BaseChangeContractInfo> 
{


	public static BaseChangeContractInfo newInstance(){
		return new BaseChangeContractInfo();
	}

	@Override
	public BaseChangeContractInfo make(){
		BaseChangeContractInfo b = new BaseChangeContractInfo();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,合同编码,合同金额,合同变更金额,合同变更后金额,金额变更显示,状态,操作人,操作时间,备注";
	...
	public void cloneCopy(BaseChangeContractInfo __bean){
	...
	@Override
	public int compareTo(BaseChangeContractInfo o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseChangeContractInfo o = (BaseChangeContractInfo)obj;
