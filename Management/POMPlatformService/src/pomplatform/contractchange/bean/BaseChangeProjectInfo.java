...
public class BaseChangeProjectInfo extends GenericBase implements BaseFactory<BaseChangeProjectInfo>, Comparable<BaseChangeProjectInfo> 
{


	public static BaseChangeProjectInfo newInstance(){
		return new BaseChangeProjectInfo();
	}

	@Override
	public BaseChangeProjectInfo make(){
		BaseChangeProjectInfo b = new BaseChangeProjectInfo();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,项目编码,订单合同金额,订单合同变更金额,订单合同变更后金额,订单合同金额变更显示,订单总积分,订单变更积分,订单变更后总积分,订单总积分变更显示,公区面积,后勤面积,设计面积,投诉保证金比例,投诉保证金,状态,操作人,操作时间,备注";
	...
	public void cloneCopy(BaseChangeProjectInfo __bean){
	...
	@Override
	public int compareTo(BaseChangeProjectInfo o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseChangeProjectInfo o = (BaseChangeProjectInfo)obj;
