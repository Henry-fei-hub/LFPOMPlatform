...
public class BaseMcmbcpaydetailctswoowycoor extends GenericBase implements BaseFactory<BaseMcmbcpaydetailctswoowycoor>, Comparable<BaseMcmbcpaydetailctswoowycoor> 
{


	public static BaseMcmbcpaydetailctswoowycoor newInstance(){
		return new BaseMcmbcpaydetailctswoowycoor();
	}

	@Override
	public BaseMcmbcpaydetailctswoowycoor make(){
		BaseMcmbcpaydetailctswoowycoor b = new BaseMcmbcpaydetailctswoowycoor();
		return b;
	}
	...
	public final static java.lang.String CS_ORI_YURREF = "ori_yurref" ;
	public final static java.lang.String CS_ORI_ERROR_MSG = "ori_error_msg" ;

	public final static java.lang.String ALL_CAPTIONS = "主键,类型 1支付 2代发工资 3代发奖金 4代发其他 5 内部转账,业务参考号,期望日,付方账号,付方开户地区代码,交易金额,币种代码,结算方式代码,用途,业务摘要,收方账号,收方账户名,自动支付收款联行号,系统内外标志,收方开户行,城市代码,收方省份,收方城市,省,市,总金额(用户记录代发与代扣),总数量(用户记录代发与代扣),收方开户地区代码,报销打包汇总表编码,报销打包表编码,create_time,operator,状态 1数据录入(等待处理) 2 成功 3失败 4撤销 5退票,错误信息,业务类别,业务模式,他行户口开户地,交易代码,交易代码名称,支付总表编码,员工或者收款单位主键,1员工  2收款单位,经办日期,退单标志  1 为正常支付单 2为退单重新支付单,退单来源主键,退单发起状态 1待资料补正 2可提起支付  3已提起支付,,";
	...
	public java.lang.String getOriErrorMsg() {
		return this.__ori_error_msg;
	}

	public void setOriErrorMsg( java.lang.String value ) {
		this.__ori_error_msg = value;
	}

	public void cloneCopy(BaseMcmbcpaydetailctswoowycoor __bean){
		...
		__bean.setOriYurref(getOriYurref());
		__bean.setOriErrorMsg(getOriErrorMsg());
	}
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		sb.append(getOriYurref() == null ? "" : getOriYurref());
		sb.append(",");
		sb.append(getOriErrorMsg() == null ? "" : getOriErrorMsg());
		return sb.toString();
	}

	@Override
	public int compareTo(BaseMcmbcpaydetailctswoowycoor o) {
	...
	public int hashCode() {
		...
		hash = 97 * hash + Objects.hashCode(this.__ori_yurref);
		hash = 97 * hash + Objects.hashCode(this.__ori_error_msg);
		return hash;
	}
	...
	public boolean equals(Object obj) {
		...
		final BaseMcmbcpaydetailctswoowycoor o = (BaseMcmbcpaydetailctswoowycoor)obj;
		...
		if(!Objects.equals(this.__ori_yurref, o.getOriYurref())) return false;
		if(!Objects.equals(this.__ori_error_msg, o.getOriErrorMsg())) return false;
		return true;
	}
	...
	public java.lang.String toJSONString() {
		...
		if(getOriYurref() != null) sb.append(__wrapString(count++, "oriYurref", getOriYurref()));
		if(getOriErrorMsg() != null) sb.append(__wrapString(count++, "oriErrorMsg", getOriErrorMsg()));
		return sb.toString();
	}
	...
	public void setDataFromMap(Map<String, Object> values){
		...
		if((val = values.get("oriErrorMsg")) != null) setOriErrorMsg(__getString(val));
	}
	...
	protected java.lang.String  __ori_yurref ;
	protected java.lang.String  __ori_error_msg ;
}
