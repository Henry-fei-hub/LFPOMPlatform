...
public class BasePayMoneyStatus2 extends GenericBase implements BaseFactory<BasePayMoneyStatus2>, Comparable<BasePayMoneyStatus2> 
{


	public static BasePayMoneyStatus2 newInstance(){
		return new BasePayMoneyStatus2();
	}

	@Override
	public BasePayMoneyStatus2 make(){
		BasePayMoneyStatus2 b = new BasePayMoneyStatus2();
		return b;
	}
	...
	public void cloneCopy(BasePayMoneyStatus2 __bean){
	...
	@Override
	public int compareTo(BasePayMoneyStatus2 o) {
	...
	public boolean equals(Object obj) {
		...
		final BasePayMoneyStatus2 o = (BasePayMoneyStatus2)obj;
