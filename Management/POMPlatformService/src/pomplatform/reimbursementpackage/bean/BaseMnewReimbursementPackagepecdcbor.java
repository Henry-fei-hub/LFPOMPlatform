...
public class BaseMnewReimbursementPackagepecdcbor extends GenericBase implements BaseFactory<BaseMnewReimbursementPackagepecdcbor>, Comparable<BaseMnewReimbursementPackagepecdcbor> 
{


	public static BaseMnewReimbursementPackagepecdcbor newInstance(){
		return new BaseMnewReimbursementPackagepecdcbor();
	}

	@Override
	public BaseMnewReimbursementPackagepecdcbor make(){
		BaseMnewReimbursementPackagepecdcbor b = new BaseMnewReimbursementPackagepecdcbor();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "流程类型,业务编码,活动编码,流程编码,流程实列编码,当前流程实例节点的内部编码,下一个流程节点的编码,如果是知会节点，所依附的主节点,提交意见,状态,报销编号,处理人,报销部门,报销总金额,归属公司,操作时间,节点类型 0 - 开始 1 - 结束 2 - 审批 3 - 处理 4 - 知会";
	...
	public void cloneCopy(BaseMnewReimbursementPackagepecdcbor __bean){
	...
	@Override
	public int compareTo(BaseMnewReimbursementPackagepecdcbor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseMnewReimbursementPackagepecdcbor o = (BaseMnewReimbursementPackagepecdcbor)obj;
