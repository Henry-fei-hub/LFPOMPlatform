...
public class BaseNormalReimbursementStatus2 extends GenericBase implements BaseFactory<BaseNormalReimbursementStatus2>, Comparable<BaseNormalReimbursementStatus2> 
{


	public static BaseNormalReimbursementStatus2 newInstance(){
		return new BaseNormalReimbursementStatus2();
	}

	@Override
	public BaseNormalReimbursementStatus2 make(){
		BaseNormalReimbursementStatus2 b = new BaseNormalReimbursementStatus2();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "流程类型,业务编码,活动编码,流程编码,流程实列编码,当前流程实例节点的内部编码,下一个流程节点的编码,如果是知会节点，所依附的主节点,提交意见,状态,编号,发起人,归属部门,金额,归属公司,操作时间,节点类型";
	...
	public void cloneCopy(BaseNormalReimbursementStatus2 __bean){
	...
	@Override
	public int compareTo(BaseNormalReimbursementStatus2 o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseNormalReimbursementStatus2 o = (BaseNormalReimbursementStatus2)obj;
