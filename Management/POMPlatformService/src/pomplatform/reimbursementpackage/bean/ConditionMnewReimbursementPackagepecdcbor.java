...
public class ConditionMnewReimbursementPackagepecdcbor extends GenericCondition{

	public ConditionMnewReimbursementPackagepecdcbor(){
		setParameterCount(6);
	}
	...
	public java.lang.String toJSONString() {
		...
		if(getBackViewName() != null) sb.append(__wrapString(1, "backViewName", getBackViewName()));
		return sb.toString();
	}
