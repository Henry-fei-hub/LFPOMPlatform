...
public class BaseScmbcpaydetailctyor extends GenericBase implements BaseFactory<BaseScmbcpaydetailctyor>, Comparable<BaseScmbcpaydetailctyor> 
{


	public static BaseScmbcpaydetailctyor newInstance(){
		return new BaseScmbcpaydetailctyor();
	}

	@Override
	public BaseScmbcpaydetailctyor make(){
		BaseScmbcpaydetailctyor b = new BaseScmbcpaydetailctyor();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键,类型 1支付 2代发工资 3代发奖金 4代发其他 5 内部转账,业务参考号,期望日,付方账号,付方开户地区代码,交易金额,币种代码,结算方式代码,用途,业务摘要,收方账号,收方账户名,自动支付收款联行号,系统内外标志,收方开户行,城市代码,收方省份,收方城市,省,市,总金额(用户记录代发与代扣),总数量(用户记录代发与代扣),收方开户地区代码,报销打包汇总表编码,报销打包表编码,create_time,operator,状态,错误信息,业务类别,业务模式,他行户口开户地,交易代码,交易代码名称";
	...
	public void cloneCopy(BaseScmbcpaydetailctyor __bean){
	...
	@Override
	public int compareTo(BaseScmbcpaydetailctyor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseScmbcpaydetailctyor o = (BaseScmbcpaydetailctyor)obj;
