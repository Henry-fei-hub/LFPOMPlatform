...
public class BaseNewReimbursementPackage extends GenericBase implements BaseFactory<BaseNewReimbursementPackage>, Comparable<BaseNewReimbursementPackage> 
{


	public static BaseNewReimbursementPackage newInstance(){
		return new BaseNewReimbursementPackage();
	}

	@Override
	public BaseNewReimbursementPackage make(){
		BaseNewReimbursementPackage b = new BaseNewReimbursementPackage();
		return b;
	}
	...
	public void cloneCopy(BaseNewReimbursementPackage __bean){
	...
	@Override
	public int compareTo(BaseNewReimbursementPackage o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseNewReimbursementPackage o = (BaseNewReimbursementPackage)obj;
