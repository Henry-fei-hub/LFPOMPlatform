...
public class CustomBaseNewReimbursementPackage extends GenericBase implements BaseFactory<CustomBaseNewReimbursementPackage>, Comparable<CustomBaseNewReimbursementPackage> 
{


	public static CustomBaseNewReimbursementPackage newInstance(){
		return new CustomBaseNewReimbursementPackage();
	}

	@Override
	public CustomBaseNewReimbursementPackage make(){
		CustomBaseNewReimbursementPackage b = new CustomBaseNewReimbursementPackage();
		return b;
	}
	...
	public final static java.lang.String CS_APPROVE_NAME = "approve_name" ;
	public final static java.lang.String CS_FINANCE_NAME = "finance_name" ;
	
	public final static java.lang.String ALL_CAPTIONS = "流程类型,业务编码,活动编码,流程编码,流程实列编码,当前流程实例节点的内部编码,下一个流程节点的编码,如果是知会节点，所依附的主节点,提交意见,状态,编号,处理人,归属部门,金额,归属公司,操作时间,节点类型";
	...
	public java.lang.String getApproveName() {
		return this.__approve_name;
	}

	public void setApproveName( java.lang.String value ) {
		this.__approve_name = value;
	}
	
	public java.lang.String getFinanceName() {
		return this.__finance_name;
	}

	public void setFinanceName( java.lang.String value ) {
		this.__finance_name = value;
	}

	public void cloneCopy(CustomBaseNewReimbursementPackage __bean){
		...
		__bean.setApproveName(getApproveName());
		__bean.setFinanceName(getFinanceName());
	}
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		sb.append(getApproveName() == null ? "" : getApproveName());
		sb.append(",");
		sb.append(getFinanceName() == null ? "" : getFinanceName());
		return sb.toString();
	}

	@Override
	public int compareTo(CustomBaseNewReimbursementPackage o) {
	...
	public int hashCode() {
		...
		hash = 97 * hash + Objects.hashCode(this.__approve_name);
		hash = 97 * hash + Objects.hashCode(this.__finance_name);
		return hash;
	}
	...
	public boolean equals(Object obj) {
		...
		final CustomBaseNewReimbursementPackage o = (CustomBaseNewReimbursementPackage)obj;
		...
		if(!Objects.equals(this.__approve_name, o.getApproveName())) return false;
		if(!Objects.equals(this.__finance_name, o.getFinanceName())) return false;
		return true;
	}
	...
	public java.lang.String toJSONString() {
		...
		if(getInputTax() != null) sb.append(__wrapNumber(count++, "inputTax", getInputTax()));
		if(getApproveName() != null) sb.append(__wrapString(count++, "approveName", getApproveName()));
		if(getFinanceName() != null) sb.append(__wrapString(count++, "financeName", getFinanceName()));
		return sb.toString();
	}
	...
	public void setDataFromMap(Map<String, Object> values){
		...
		if((val = values.get("approveName")) != null) setApproveName(__getString(val)); 
		if((val = values.get("financeName")) != null) setFinanceName(__getString(val));  
	}
	...
	protected java.lang.String  __approve_name ;
	protected java.lang.String  __finance_name ;
}
