...
public class BaseSalarySendDataPay extends GenericBase implements BaseFactory<BaseSalarySendDataPay>, Comparable<BaseSalarySendDataPay> 
{


	public static BaseSalarySendDataPay newInstance(){
		return new BaseSalarySendDataPay();
	}

	@Override
	public BaseSalarySendDataPay make(){
		BaseSalarySendDataPay b = new BaseSalarySendDataPay();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "所属公司,员工id,员工编号,员工姓名,年份,月份,,银行账号,开户行,开户行所在地,真实收付款,";
	...
	public void cloneCopy(BaseSalarySendDataPay __bean){
	...
	@Override
	public int compareTo(BaseSalarySendDataPay o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSalarySendDataPay o = (BaseSalarySendDataPay)obj;
