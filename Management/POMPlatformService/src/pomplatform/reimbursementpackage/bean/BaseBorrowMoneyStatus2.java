...
public class BaseBorrowMoneyStatus2 extends GenericBase implements BaseFactory<BaseBorrowMoneyStatus2>, Comparable<BaseBorrowMoneyStatus2> 
{


	public static BaseBorrowMoneyStatus2 newInstance(){
		return new BaseBorrowMoneyStatus2();
	}

	@Override
	public BaseBorrowMoneyStatus2 make(){
		BaseBorrowMoneyStatus2 b = new BaseBorrowMoneyStatus2();
		return b;
	}
	...
	public void cloneCopy(BaseBorrowMoneyStatus2 __bean){
	...
	@Override
	public int compareTo(BaseBorrowMoneyStatus2 o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseBorrowMoneyStatus2 o = (BaseBorrowMoneyStatus2)obj;
