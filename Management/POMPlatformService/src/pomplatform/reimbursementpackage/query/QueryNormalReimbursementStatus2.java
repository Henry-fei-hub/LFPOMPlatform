...
public class QueryNormalReimbursementStatus2 extends AbstractQuery<BaseNormalReimbursementStatus2, ConditionNormalReimbursementStatus2>
{

	private static final Logger __logger = Logger.getLogger(QueryNormalReimbursementStatus2.class);

	public QueryNormalReimbursementStatus2() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseNormalReimbursementStatus2> executeQuery( KeyValuePair[] replacements, ConditionNormalReimbursementStatus2 condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseNormalReimbursementStatus2 generateBase(Object[] __data) throws java.sql.SQLException {
		BaseNormalReimbursementStatus2 __base = new BaseNormalReimbursementStatus2();
		int count = 0;
		Object val;
	...
	private final static String[] fieldNames = { "process_type", "employee_id", "company_id", "department_id", "code"};
}
