...
public class QueryBorrowMoneyStatus2 extends AbstractQuery<BaseBorrowMoneyStatus2, ConditionBorrowMoneyStatus2>
{

	private static final Logger __logger = Logger.getLogger(QueryBorrowMoneyStatus2.class);

	public QueryBorrowMoneyStatus2() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseBorrowMoneyStatus2> executeQuery( KeyValuePair[] replacements, ConditionBorrowMoneyStatus2 condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseBorrowMoneyStatus2 generateBase(Object[] __data) throws java.sql.SQLException {
		BaseBorrowMoneyStatus2 __base = new BaseBorrowMoneyStatus2();
		int count = 0;
		Object val;
