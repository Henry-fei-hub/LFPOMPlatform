...
public class QueryPayMoneyStatus2 extends AbstractQuery<BasePayMoneyStatus2, ConditionPayMoneyStatus2>
{

	private static final Logger __logger = Logger.getLogger(QueryPayMoneyStatus2.class);

	public QueryPayMoneyStatus2() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BasePayMoneyStatus2> executeQuery( KeyValuePair[] replacements, ConditionPayMoneyStatus2 condition ) throws java.sql.SQLException {
	...
	@Override
	public BasePayMoneyStatus2 generateBase(Object[] __data) throws java.sql.SQLException {
		BasePayMoneyStatus2 __base = new BasePayMoneyStatus2();
		int count = 0;
		Object val;
