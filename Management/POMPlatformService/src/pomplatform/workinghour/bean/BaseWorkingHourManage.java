...
public class BaseWorkingHourManage extends GenericBase implements BaseFactory<BaseWorkingHourManage>, Comparable<BaseWorkingHourManage> 
{


	public static BaseWorkingHourManage newInstance(){
		return new BaseWorkingHourManage();
	}

	@Override
	public BaseWorkingHourManage make(){
		BaseWorkingHourManage b = new BaseWorkingHourManage();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "项目编号,项目名称,员工编号,员工姓名,归属部门,业务部门,归属公司,工时,日期,备注,创建时间,是否锁定";
	...
	public void cloneCopy(BaseWorkingHourManage __bean){
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		sb.append(getWorkDate() == null ? "" : DateUtil.formatDateString(getWorkDate()));
		sb.append(",");
		sb.append(getRemark() == null ? "" : getRemark());
		sb.append(",");
		sb.append(getCreateTime() == null ? "" : DateUtil.formatDateTimeString(getCreateTime()));
		sb.append(",");
	...
	@Override
	public int compareTo(BaseWorkingHourManage o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseWorkingHourManage o = (BaseWorkingHourManage)obj;
