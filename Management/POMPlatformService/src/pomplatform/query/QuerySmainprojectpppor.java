...
public class QuerySmainprojectpppor extends AbstractQuery<BaseSmainprojectpppor, ConditionSmainprojectpppor>
{

	private static final Logger __logger = Logger.getLogger(QuerySmainprojectpppor.class);

	public QuerySmainprojectpppor() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseSmainprojectpppor> executeQuery( KeyValuePair[] replacements, ConditionSmainprojectpppor condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseSmainprojectpppor generateBase(Object[] __data) throws java.sql.SQLException {
		BaseSmainprojectpppor __base = new BaseSmainprojectpppor();
		int count = 0;
		Object val;
