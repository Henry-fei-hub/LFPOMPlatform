...
import pomplatform.bean.BaseCapitalAndInvoiceTwo;
import pomplatform.bean.ConditionCapitalAndInvoiceTwo;
...
public class QueryCapitalAndInvoiceTwo extends AbstractQuery<BaseCapitalAndInvoiceTwo, ConditionCapitalAndInvoiceTwo>
{
	...
	private final static String __SQLText = "SELECT i.invoice_id, i.ticketing_company, i.invoice_type, i.invoice_code, i.invoice_number, i.in_stock_date, i.invalid_remark, i.is_invalid_operator, i.storage_operator, i.info_code, i.project_code, i.contract_id, i.contract_code, i.customer_id, i.invoice_amount, i.billing_operation, i.invoice_date, i.registration_date, i.sign, i.contract_receivable_id, i.acknowledge_letter_id, i.have_voucher, i.is_capital,i.capital_amount FROM invoices i where i.contract_id =? ORDER BY i.invoice_date" ;
