...
public class BaseOnLoadApplyListOfOrderInfo extends GenericBase implements BaseFactory<BaseOnLoadApplyListOfOrderInfo>, Comparable<BaseOnLoadApplyListOfOrderInfo>
{


	public static BaseOnLoadApplyListOfOrderInfo newInstance(){
		return new BaseOnLoadApplyListOfOrderInfo();
	}

	@Override
	public BaseOnLoadApplyListOfOrderInfo make(){
		BaseOnLoadApplyListOfOrderInfo b = new BaseOnLoadApplyListOfOrderInfo();
		return b;
	}
	...
	public final static java.lang.String CS_FLIE_NAME = "flie_name" ;

	public final static java.lang.String ALL_CAPTIONS = "主键编码,业务编码,业务名称,流程编码,流程状态 0 发起中  1,创建人,完成时间,创建时间,主订单编码,主订单编号,信息编号,主订单名称,附件id,附件url,附件名";
	...
	public java.lang.String getFlieName() {
		return this.__flie_name;
	}

	public void setFlieName( java.lang.String value ) {
		this.__flie_name = value;
	}

	public void cloneCopy(BaseOnLoadApplyListOfOrderInfo __bean){
		...
		__bean.setFlieName(getFlieName());
	}
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		sb.append(getFlieName() == null ? "" : getFlieName());
		return sb.toString();
	}

	@Override
	public int compareTo(BaseOnLoadApplyListOfOrderInfo o) {
	...
	public int hashCode() {
		...
		hash = 97 * hash + Objects.hashCode(this.__flie_name);
		return hash;
	}
	...
	public boolean equals(Object obj) {
		...
		final BaseOnLoadApplyListOfOrderInfo o = (BaseOnLoadApplyListOfOrderInfo)obj;
		...
		if(!Objects.equals(this.__flie_name, o.getFlieName())) return false;
		return true;
	}
	...
	public java.lang.String toJSONString() {
		...
		if(getFlieName() != null) sb.append(__wrapString(count++, "flieName", getFlieName()));
		return sb.toString();
	}
	...
	public Map<String, Object> toMap() {
		...
		if(getFlieName() != null) res.put("flieName", getFlieName());
		return res;
	}
	...
	public void setDataFromMap(Map<String, Object> values){
		...
		if((val = values.get("flieName")) != null) setFlieName(__getString(val));
	}
	...
	protected java.lang.String  __flie_name ;
}
