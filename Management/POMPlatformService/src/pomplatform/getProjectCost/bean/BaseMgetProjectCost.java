...
public class BaseMgetProjectCost extends GenericBase implements BaseFactory<BaseMgetProjectCost>, Comparable<BaseMgetProjectCost> 
{


	public static BaseMgetProjectCost newInstance(){
		return new BaseMgetProjectCost();
	}

	@Override
	public BaseMgetProjectCost make(){
		BaseMgetProjectCost b = new BaseMgetProjectCost();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "业务部门,项目编码,员工编码,月份,基本工资";
	...
	public void cloneCopy(BaseMgetProjectCost __bean){
	...
	@Override
	public int compareTo(BaseMgetProjectCost o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseMgetProjectCost o = (BaseMgetProjectCost)obj;
