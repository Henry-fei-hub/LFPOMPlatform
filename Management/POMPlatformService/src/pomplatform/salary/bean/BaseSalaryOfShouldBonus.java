...
public class BaseSalaryOfShouldBonus extends GenericBase implements BaseFactory<BaseSalaryOfShouldBonus>, Comparable<BaseSalaryOfShouldBonus> 
{


	public static BaseSalaryOfShouldBonus newInstance(){
		return new BaseSalaryOfShouldBonus();
	}

	@Override
	public BaseSalaryOfShouldBonus make(){
		BaseSalaryOfShouldBonus b = new BaseSalaryOfShouldBonus();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,员工id,员工编号,员工姓名,归属公司,板块,所属部门,职员状态,日期,应发奖金,标识,是否发放,年份,月份";
	...
	public void cloneCopy(BaseSalaryOfShouldBonus __bean){
	...
	@Override
	public int compareTo(BaseSalaryOfShouldBonus o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSalaryOfShouldBonus o = (BaseSalaryOfShouldBonus)obj;
