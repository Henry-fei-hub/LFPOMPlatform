...
public class BaseReimbursementCost extends GenericBase implements BaseFactory<BaseReimbursementCost>, Comparable<BaseReimbursementCost> 
{


	public static BaseReimbursementCost newInstance(){
		return new BaseReimbursementCost();
	}

	@Override
	public BaseReimbursementCost make(){
		BaseReimbursementCost b = new BaseReimbursementCost();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "流程编码,主键编码,流程类型,业务编码,创建人,,,关联项目或部门,成本";
	...
	public void cloneCopy(BaseReimbursementCost __bean){
	...
	@Override
	public int compareTo(BaseReimbursementCost o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseReimbursementCost o = (BaseReimbursementCost)obj;
