...
public class BaseScontract extends GenericBase implements BaseFactory<BaseScontract>, Comparable<BaseScontract> 
{


	public static BaseScontract newInstance(){
		return new BaseScontract();
	}

	@Override
	public BaseScontract make(){
		BaseScontract b = new BaseScontract();
		return b;
	}
...
//	public final static java.lang.String ALL_CAPTIONS = "合同编码,合同编号,合同名称,客户名称,开始日期,结束日期,结算状态,项目编号,合同类别,项目等级,项目总工期,签约总金额,总设计面积,合同单价,项目地点,合同跟进人,备注,合同签订日期,我方签约公司名称,创建时间,修改时间,业务类别,流转状态，默认为0表示可以提交到运营管理修改承接部门1表示可以提交到运营管理运营价格2表示可以提交到运营管理运营价格审核3表示审核完成,流水号,项目类别,建筑面积,配合专业,省份,城市,详细地址,客户地址,服务建议书,立单时间 提交了立单时间会将保存下来，只是点击保存不会将当前时间保存下来，单每次都会显示当前的时间，提交了下次显示的就是提交时的立单时间,标记补充协议字段；除0之外，其他都表示第n个补充协议,tree结构表示,信息编号,合同状态,客户合同编号";
	public final static java.lang.String ALL_CAPTIONS = "合同编号,合同名称,收款阶段个数";
	...
	public java.lang.Integer getRcnum() {
		return __rcnum;
	}

	public void setRcnum(java.lang.Integer value) {
		this.__rcnum = value;
	}
	...
	public void cloneCopy(BaseScontract __bean){
...
//		sb.append(",");
		...
		sb.append(",");
		sb.append(getRcnum() == null ? "" : getRcnum());
//		sb.append(",");
...
//		sb.append(getClientContractId() == null ? "" : getClientContractId());
	...
	@Override
	public int compareTo(BaseScontract o) {
	...
	public int hashCode() {
		...
		hash = 97 * hash + Objects.hashCode(this.__rcnum);
	...
	public boolean equals(Object obj) {
		...
		final BaseScontract o = (BaseScontract)obj;
		...
		if(!Objects.equals(this.__rcnum, o.getRcnum())) return false;
	...
	public java.lang.String toJSONString() {
		...
		if(getRcnum() != null) sb.append(__wrapNumber(count++, "rcnum", getRcnum()));
	...
	public void setDataFromMap(Map<String, Object> values){
		...
		if((val = values.get("rcnum")) != null) setRcnum(__getInt(val)); 
	...
	protected java.lang.Integer  __rcnum ;
