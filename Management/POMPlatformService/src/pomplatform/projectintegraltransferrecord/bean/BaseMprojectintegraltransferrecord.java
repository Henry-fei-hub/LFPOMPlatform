...
public class BaseMprojectintegraltransferrecord extends GenericBase implements BaseFactory<BaseMprojectintegraltransferrecord>, Comparable<BaseMprojectintegraltransferrecord> 
{


	public static BaseMprojectintegraltransferrecord newInstance(){
		return new BaseMprojectintegraltransferrecord();
	}

	@Override
	public BaseMprojectintegraltransferrecord make(){
		BaseMprojectintegraltransferrecord b = new BaseMprojectintegraltransferrecord();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "头像,主键编码,目标项目,归属项目,转移积分,转移日期,板块,板块负责人,备注";
	...
	public void cloneCopy(BaseMprojectintegraltransferrecord __bean){
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		String strFromProjectId = delicacy.system.executor.SelectValueCache.getSelectValue("projects", String.valueOf(getFromProjectId()));
		sb.append(strFromProjectId == null ? "" : strFromProjectId);
		sb.append(",");
		String strToProjectId = delicacy.system.executor.SelectValueCache.getSelectValue("projects", String.valueOf(getToProjectId()));
		sb.append(strToProjectId == null ? "" : strToProjectId);
		sb.append(",");
	...
	@Override
	public int compareTo(BaseMprojectintegraltransferrecord o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseMprojectintegraltransferrecord o = (BaseMprojectintegraltransferrecord)obj;
