...
public class QueryAuditListOfEmployeeOnboard extends AbstractQuery<BaseAuditListOfEmployeeOnboard, ConditionAuditListOfEmployeeOnboard>
{

	private static final Logger __logger = Logger.getLogger(QueryAuditListOfEmployeeOnboard.class);

	public QueryAuditListOfEmployeeOnboard() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseAuditListOfEmployeeOnboard> executeQuery( KeyValuePair[] replacements, ConditionAuditListOfEmployeeOnboard condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseAuditListOfEmployeeOnboard generateBase(Object[] __data) throws java.sql.SQLException {
		BaseAuditListOfEmployeeOnboard __base = new BaseAuditListOfEmployeeOnboard();
		int count = 0;
		Object val;
