...
public class BaseOnLoadRefuseListOfPersonnel extends GenericBase implements BaseFactory<BaseOnLoadRefuseListOfPersonnel>, Comparable<BaseOnLoadRefuseListOfPersonnel> 
{


	public static BaseOnLoadRefuseListOfPersonnel newInstance(){
		return new BaseOnLoadRefuseListOfPersonnel();
	}

	@Override
	public BaseOnLoadRefuseListOfPersonnel make(){
		BaseOnLoadRefuseListOfPersonnel b = new BaseOnLoadRefuseListOfPersonnel();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,业务编码,业务名称,流程编码,活动实列编码,流程状态,完成时间,人事业务编码,流程类型,申请人,职员编号,归属部门,归属公司,假期类型,开始日期,0上午   1下午,截止日期,0上午   1下午,天数,申请缘由,备注,地址,计划安排,交通工具,预计费用,外访单位,联系人,申请时间,删除状态  0未删除    1已删除,在职状态";
	...
	public void cloneCopy(BaseOnLoadRefuseListOfPersonnel __bean){
	...
	@Override
	public int compareTo(BaseOnLoadRefuseListOfPersonnel o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseOnLoadRefuseListOfPersonnel o = (BaseOnLoadRefuseListOfPersonnel)obj;
