...
public class BaseTaskOfEmployeeOnboard extends GenericBase implements BaseFactory<BaseTaskOfEmployeeOnboard>, Comparable<BaseTaskOfEmployeeOnboard> 
{


	public static BaseTaskOfEmployeeOnboard newInstance(){
		return new BaseTaskOfEmployeeOnboard();
	}

	@Override
	public BaseTaskOfEmployeeOnboard make(){
		BaseTaskOfEmployeeOnboard b = new BaseTaskOfEmployeeOnboard();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,业务编码,业务名称,活动编码,流程编码,流程实列编码,流程类型,返回数据集,附加节点，说明节点是预定义的节点还是动态加的节点， 0 - 正常定义的节点， 1 - 申请人或者审批人加的处理人或者审批人,当前流程实例节点的内部编码,流程实例节点创建时间,流程实例节点开始处于活动时间,状态,操作时间,提交意见,部门,员工编号,员工姓名,入职日期,所属公司,职位名称,发起人,在职状态";
	...
	public void cloneCopy(BaseTaskOfEmployeeOnboard __bean){
	...
	@Override
	public int compareTo(BaseTaskOfEmployeeOnboard o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseTaskOfEmployeeOnboard o = (BaseTaskOfEmployeeOnboard)obj;
