...
public class BaseAuditListOfEmployeeOnboard extends GenericBase implements BaseFactory<BaseAuditListOfEmployeeOnboard>, Comparable<BaseAuditListOfEmployeeOnboard> 
{


	public static BaseAuditListOfEmployeeOnboard newInstance(){
		return new BaseAuditListOfEmployeeOnboard();
	}

	@Override
	public BaseAuditListOfEmployeeOnboard make(){
		BaseAuditListOfEmployeeOnboard b = new BaseAuditListOfEmployeeOnboard();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "活动实列编码,业务编码,业务名称,活动编码,流程编码,主键编码,附加节点，说明节点是预定义的节点还是动态加的节点， 0 - 正常定义的节点， 1 - 申请人或者审批人加的处理人或者审批人,当前流程实例节点的内部编码,下一个流程节点的编码,如果是知会节点，所依附的主节点,流程实例节点创建时间,流程实例节点开始处于活动时间,状态,流程类型,部门,员工编号,员工姓名,入职日期,所属公司,职位名称,发起人,操作时间,提交意见,节点类型 0 - 开始 1 - 结束 2 - 审批 3 - 处理 4 - 知会,返回数据集";
	...
	public void cloneCopy(BaseAuditListOfEmployeeOnboard __bean){
	...
	@Override
	public int compareTo(BaseAuditListOfEmployeeOnboard o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseAuditListOfEmployeeOnboard o = (BaseAuditListOfEmployeeOnboard)obj;
