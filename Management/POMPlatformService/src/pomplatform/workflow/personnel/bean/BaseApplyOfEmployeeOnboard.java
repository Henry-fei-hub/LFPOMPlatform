...
public class BaseApplyOfEmployeeOnboard extends GenericBase implements BaseFactory<BaseApplyOfEmployeeOnboard>, Comparable<BaseApplyOfEmployeeOnboard> 
{


	public static BaseApplyOfEmployeeOnboard newInstance(){
		return new BaseApplyOfEmployeeOnboard();
	}

	@Override
	public BaseApplyOfEmployeeOnboard make(){
		BaseApplyOfEmployeeOnboard b = new BaseApplyOfEmployeeOnboard();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,流程类型,业务编码,业务名称,流程编码,活动实列编码,流程状态,创建时间,完成时间,部门,员工编号,员工姓名,入职日期,所属公司,职位名称,发起人";
	...
	public void cloneCopy(BaseApplyOfEmployeeOnboard __bean){
	...
	@Override
	public int compareTo(BaseApplyOfEmployeeOnboard o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseApplyOfEmployeeOnboard o = (BaseApplyOfEmployeeOnboard)obj;
