...
public class BaseAttentionOfEmployeeOnboard extends GenericBase implements BaseFactory<BaseAttentionOfEmployeeOnboard>, Comparable<BaseAttentionOfEmployeeOnboard> 
{


	public static BaseAttentionOfEmployeeOnboard newInstance(){
		return new BaseAttentionOfEmployeeOnboard();
	}

	@Override
	public BaseAttentionOfEmployeeOnboard make(){
		BaseAttentionOfEmployeeOnboard b = new BaseAttentionOfEmployeeOnboard();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,流程类型,业务编码,业务名称,活动编码,流程编码,流程实列编码,返回数据集,流程实例节点编码,流程实例节点创建时间,流程实例节点开始处于活动时间,状态,操作时间,提交意见,部门,员工编号,员工姓名,入职日期,所属公司,职位名称,发起人,在职状态";
	...
	public void cloneCopy(BaseAttentionOfEmployeeOnboard __bean){
	...
	@Override
	public int compareTo(BaseAttentionOfEmployeeOnboard o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseAttentionOfEmployeeOnboard o = (BaseAttentionOfEmployeeOnboard)obj;
