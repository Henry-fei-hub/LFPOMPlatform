...
public class BaseOnLoadApplyListOfPersonnel extends GenericBase implements BaseFactory<BaseOnLoadApplyListOfPersonnel>, Comparable<BaseOnLoadApplyListOfPersonnel> 
{


	public static BaseOnLoadApplyListOfPersonnel newInstance(){
		return new BaseOnLoadApplyListOfPersonnel();
	}

	@Override
	public BaseOnLoadApplyListOfPersonnel make(){
		BaseOnLoadApplyListOfPersonnel b = new BaseOnLoadApplyListOfPersonnel();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,业务编码,业务名称,流程编码,活动实列编码,流程状态,完成时间,人事业务编码,流程类型,创建人,工号,部门,归属公司,假期类型,开始日期,0上午   1下午,截止日期,0上午   1下午,天数,申请缘由,备注,地址,计划安排,交通工具,预计费用,外访单位,联系人,创建时间,删除状态  0未删除    1已删除,自定义的审核人,假期类型明细项,小时,公司所在省份,目标省份,多胞胎假请填写婴儿数量,附件,是否审批通过,假期类型明细项,项目类型 1项目 2前期项目,项目主键,项目名称,项目编号,父级编码  用于记录是根据哪一条记录进行延期,是否为边远城市,是否提供住宿,生活费用(元/月),住房费用(元/月),起草人,身份证,职务,对等号  与  冲账结合实现 借款与冲账与还款,关联表编码,离职补偿金,薪资1,薪资2,现薪资,月薪,基本比例（显示用）,基本比例（计算用）,月基本工资,月绩效工资,工龄工资,其他补贴,全薪,年度绩效,费用归属(1IT人员,2管理人员,3设计人员,4研发人员,5营销人员),领证时间,项目编码,付款序列编码,预算管理编码,预算附件编码,阶段id,";
	...
	public void cloneCopy(BaseOnLoadApplyListOfPersonnel __bean){
	...
	@Override
	public int compareTo(BaseOnLoadApplyListOfPersonnel o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseOnLoadApplyListOfPersonnel o = (BaseOnLoadApplyListOfPersonnel)obj;
