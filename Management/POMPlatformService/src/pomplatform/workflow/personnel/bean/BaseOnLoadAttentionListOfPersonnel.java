...
public class BaseOnLoadAttentionListOfPersonnel extends GenericBase implements BaseFactory<BaseOnLoadAttentionListOfPersonnel>, Comparable<BaseOnLoadAttentionListOfPersonnel> 
{


	public static BaseOnLoadAttentionListOfPersonnel newInstance(){
		return new BaseOnLoadAttentionListOfPersonnel();
	}

	@Override
	public BaseOnLoadAttentionListOfPersonnel make(){
		BaseOnLoadAttentionListOfPersonnel b = new BaseOnLoadAttentionListOfPersonnel();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,业务编码,业务名称,活动编码,流程编码,主键编码,返回数据集,流程实例节点编码,流程实例节点创建时间,流程实例节点开始处于活动时间,状态,操作时间,提交意见,人事业务编码,流程类型,申请人,职员编号,归属部门,归属公司,假期类型,开始日期,0上午   1下午,截止日期,0上午   1下午,天数,申请缘由,备注,地址,计划安排,交通工具,预计费用,外访单位,联系人,申请时间,删除状态  0未删除    1已删除,在职状态";
	...
	public void cloneCopy(BaseOnLoadAttentionListOfPersonnel __bean){
	...
	@Override
	public int compareTo(BaseOnLoadAttentionListOfPersonnel o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseOnLoadAttentionListOfPersonnel o = (BaseOnLoadAttentionListOfPersonnel)obj;
