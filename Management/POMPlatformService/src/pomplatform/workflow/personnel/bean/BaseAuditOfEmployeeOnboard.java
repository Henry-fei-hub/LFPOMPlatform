...
public class BaseAuditOfEmployeeOnboard extends GenericBase implements BaseFactory<BaseAuditOfEmployeeOnboard>, Comparable<BaseAuditOfEmployeeOnboard> 
{


	public static BaseAuditOfEmployeeOnboard newInstance(){
		return new BaseAuditOfEmployeeOnboard();
	}

	@Override
	public BaseAuditOfEmployeeOnboard make(){
		BaseAuditOfEmployeeOnboard b = new BaseAuditOfEmployeeOnboard();
		return b;
	}
	...
	public void cloneCopy(BaseAuditOfEmployeeOnboard __bean){
	...
	@Override
	public int compareTo(BaseAuditOfEmployeeOnboard o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseAuditOfEmployeeOnboard o = (BaseAuditOfEmployeeOnboard)obj;
