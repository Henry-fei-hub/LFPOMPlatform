package pomplatform.workflow.commonNormalReimbursement.bean;
...
public class BaseNormalReimbursementWithDepartment extends GenericBase implements BaseFactory<BaseNormalReimbursementWithDepartment>, Comparable<BaseNormalReimbursementWithDepartment> 
{


	public static BaseNormalReimbursementWithDepartment newInstance(){
		return new BaseNormalReimbursementWithDepartment();
	}

	@Override
	public BaseNormalReimbursementWithDepartment make(){
		BaseNormalReimbursementWithDepartment b = new BaseNormalReimbursementWithDepartment();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,报销编号,流程编码,起草人,报销人,报销人所在部门,主题,报销时间,状态,报销总金额,申请时间,完成时间,备注,是否冲账,附件,附件(张),归属公司,是否是项目上的报销，默认false,报销类型";
	...
	public void setCurrency(java.lang.Integer __currency) {
	...
	public void setFeeType(java.lang.Integer __fee_type) {
		this.__fee_type = __fee_type;
	}
	...
	public java.util.List<BaseNormalReimbursementLinkDepartment> getDetailNormalReimbursementLinkDepartment() {
		return this.__detailNormalReimbursementLinkDepartment;
	}

	public void setDetailNormalReimbursementLinkDepartment( java.util.List<BaseNormalReimbursementLinkDepartment> value ) {
		this.__detailNormalReimbursementLinkDepartment = value;
	}

	public void cloneCopy(BaseNormalReimbursementWithDepartment __bean){
	...
	@Override
	public int compareTo(BaseNormalReimbursementWithDepartment o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseNormalReimbursementWithDepartment o = (BaseNormalReimbursementWithDepartment)obj;
	...
	public java.lang.String toJSONString() {
		...
		if(getDetailNormalReimbursementLinkDepartment() != null)  sb.append(__wrapList(count++, "detailNormalReimbursementLinkDepartment", getDetailNormalReimbursementLinkDepartment()));
		return sb.toString();
	}
	...
	public void setDataFromMap(Map<String, Object> values){
		...
		if((val = values.get("detailNormalReimbursementLinkDepartment")) != null) setDetailNormalReimbursementLinkDepartment(__getList(val, BaseNormalReimbursementLinkDepartment.newInstance()));
	}
	...
	protected java.util.List<BaseNormalReimbursementLinkDepartment> __detailNormalReimbursementLinkDepartment = null;
}
