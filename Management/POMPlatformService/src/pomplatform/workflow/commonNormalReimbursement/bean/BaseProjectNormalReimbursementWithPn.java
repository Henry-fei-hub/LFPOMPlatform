...
public class BaseProjectNormalReimbursementWithPn extends BaseProjectNormalReimbursement 
{
	...
	public List<BaseNormalReimbursementLinkDepartment> getDetailNormalReimbursementLinkDepartment() {
		return this.__detail_normal_reimbursement_link_departments;
	}

	public void setDetailNormalReimbursementLinkDepartment( List<BaseNormalReimbursementLinkDepartment> value ) {
		this.__detail_normal_reimbursement_link_departments = value;
	}
	...
	public java.lang.String toJSONString() {
		...
		count = sb.length(); sb.append(__wrapList(count, "detailNormalReimbursementLinkDepartment", getDetailNormalReimbursementLinkDepartment()));
		return sb.toString() ;
	}
	...
	protected List<BaseNormalReimbursementLinkDepartment> __detail_normal_reimbursement_link_departments ; 
}
