...
public class QueryEmployeeMoneyAuditOfWorkflow extends AbstractQuery<BaseEmployeeMoneyAuditOfWorkflow, ConditionEmployeeMoneyAuditOfWorkflow>
{

	private static final Logger __logger = Logger.getLogger(QueryEmployeeMoneyAuditOfWorkflow.class);

	public QueryEmployeeMoneyAuditOfWorkflow() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseEmployeeMoneyAuditOfWorkflow> executeQuery( KeyValuePair[] replacements, ConditionEmployeeMoneyAuditOfWorkflow condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseEmployeeMoneyAuditOfWorkflow generateBase(Object[] __data) throws java.sql.SQLException {
		BaseEmployeeMoneyAuditOfWorkflow __base = new BaseEmployeeMoneyAuditOfWorkflow();
		int count = 0;
		Object val;
