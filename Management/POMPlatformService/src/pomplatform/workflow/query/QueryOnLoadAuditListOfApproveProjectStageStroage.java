...
public class QueryOnLoadAuditListOfApproveProjectStageStroage extends AbstractQuery<BaseOnLoadAuditListOfApproveProjectStageStroage, ConditionOnLoadAuditListOfApproveProjectStageStroage>
{

	private static final Logger __logger = Logger.getLogger(QueryOnLoadAuditListOfApproveProjectStageStroage.class);

	public QueryOnLoadAuditListOfApproveProjectStageStroage() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseOnLoadAuditListOfApproveProjectStageStroage> executeQuery( KeyValuePair[] replacements, ConditionOnLoadAuditListOfApproveProjectStageStroage condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseOnLoadAuditListOfApproveProjectStageStroage generateBase(Object[] __data) throws java.sql.SQLException {
		BaseOnLoadAuditListOfApproveProjectStageStroage __base = new BaseOnLoadAuditListOfApproveProjectStageStroage();
		int count = 0;
		Object val;
	...
	private final static String[] fieldNames = { "process_type", "status", "employee_id", "employee_name", "employee_no"};
}
