...
public class QueryOnLoadFlowTravelReimbursementsApplyBuisnessData extends AbstractQuery<BaseOnLoadFlowTravelReimbursementsApplyBuisnessData, ConditionOnLoadFlowTravelReimbursementsApplyBuisnessData>
{

	private static final Logger __logger = Logger.getLogger(QueryOnLoadFlowTravelReimbursementsApplyBuisnessData.class);

	public QueryOnLoadFlowTravelReimbursementsApplyBuisnessData() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseOnLoadFlowTravelReimbursementsApplyBuisnessData> executeQuery( KeyValuePair[] replacements, ConditionOnLoadFlowTravelReimbursementsApplyBuisnessData condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseOnLoadFlowTravelReimbursementsApplyBuisnessData generateBase(Object[] __data) throws java.sql.SQLException {
		BaseOnLoadFlowTravelReimbursementsApplyBuisnessData __base = new BaseOnLoadFlowTravelReimbursementsApplyBuisnessData();
		int count = 0;
		Object val;
