...
import pomplatform.workflow.bean.BaseStravelreimbursementmmmor;
import pomplatform.workflow.bean.ConditionStravelreimbursementmmmor;

public class QueryStravelreimbursementmmmor extends AbstractQuery<BaseStravelreimbursementmmmor, ConditionStravelreimbursementmmmor>
{

	private static final Logger __logger = Logger.getLogger(QueryStravelreimbursementmmmor.class);

	public QueryStravelreimbursementmmmor() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseStravelreimbursementmmmor> executeQuery( KeyValuePair[] replacements, ConditionStravelreimbursementmmmor condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseStravelreimbursementmmmor generateBase(Object[] __data) throws java.sql.SQLException {
		BaseStravelreimbursementmmmor __base = new BaseStravelreimbursementmmmor();
		int count = 0;
		Object val;
	...
	private final static String[] fieldNames = { "min_start_date", "max_start_date", "min_end_date", "max_end_date", "code", "title", "remark", "process_instance_id", "is_project", "delete_flag"};
}
