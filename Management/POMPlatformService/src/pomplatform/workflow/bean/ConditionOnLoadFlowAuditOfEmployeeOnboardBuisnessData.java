...
public class ConditionOnLoadFlowAuditOfEmployeeOnboardBuisnessData extends GenericCondition{

	public ConditionOnLoadFlowAuditOfEmployeeOnboardBuisnessData(){
		setParameterCount(8);
	}
