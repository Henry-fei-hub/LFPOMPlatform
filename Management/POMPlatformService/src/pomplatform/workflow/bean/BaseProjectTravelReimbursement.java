...
public class BaseProjectTravelReimbursement extends GenericBase implements BaseFactory<BaseProjectTravelReimbursement>, Comparable<BaseProjectTravelReimbursement> 
{


	public static BaseProjectTravelReimbursement newInstance(){
		return new BaseProjectTravelReimbursement();
	}

	@Override
	public BaseProjectTravelReimbursement make(){
		BaseProjectTravelReimbursement b = new BaseProjectTravelReimbursement();
		return b;
	}

	public final static java.lang.String CS_TRAVEL_REIMBURSEMENT_ID = "travel_reimbursement_id" ;
	public final static java.lang.String CS_TRAVEL_REIMBURSEMENT_NO = "travel_reimbursement_no" ;
	...
	public final static java.lang.String ALL_CAPTIONS = "差旅报销编码,报销编号,流程编码,主题,申请人,起草人,报销部门,所属项目,报销时间,出差开始日期,出差结束日期,报销金额,冲账,报销事由,申请时间,完成时间,附件,附件数量,状态";
	...
	public java.lang.String getTravelReimbursementNo() {
		return this.__travel_reimbursement_no;
	}

	public void setTravelReimbursementNo( java.lang.String value ) {
		this.__travel_reimbursement_no = value;
	}
	...
	public void cloneCopy(BaseProjectTravelReimbursement __bean){
		__bean.setTravelReimbursementId(getTravelReimbursementId());
		__bean.setTravelReimbursementNo(getTravelReimbursementNo());
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		sb.append(getTravelReimbursementNo() == null ? "" : getTravelReimbursementNo());
		sb.append(",");
	...
	@Override
	public int compareTo(BaseProjectTravelReimbursement o) {
	...
	public int hashCode() {
		...
		hash = 97 * hash + Objects.hashCode(this.__travel_reimbursement_no);
	...
	public boolean equals(Object obj) {
		...
		final BaseProjectTravelReimbursement o = (BaseProjectTravelReimbursement)obj;
		if(!Objects.equals(this.__travel_reimbursement_id, o.getTravelReimbursementId())) return false;
		if(!Objects.equals(this.__travel_reimbursement_no, o.getTravelReimbursementNo())) return false;
	...
	public java.lang.String toJSONString() {
		...
		if(getTravelReimbursementNo() != null) sb.append(__wrapString(count++, "travelReimbursementNo", getTravelReimbursementNo()));
	...
	public void setDataFromMap(Map<String, Object> values){
		...
		if((val = values.get("travelReimbursementNo")) != null) setTravelReimbursementNo(__getString(val));
	...
	protected java.lang.String  __travel_reimbursement_no ;
