...
public class BaseAttentionListOfMainProjectReport extends GenericBase implements BaseFactory<BaseAttentionListOfMainProjectReport>, Comparable<BaseAttentionListOfMainProjectReport> 
{


	public static BaseAttentionListOfMainProjectReport newInstance(){
		return new BaseAttentionListOfMainProjectReport();
	}

	@Override
	public BaseAttentionListOfMainProjectReport make(){
		BaseAttentionListOfMainProjectReport b = new BaseAttentionListOfMainProjectReport();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,业务编码,业务名称,活动编码,流程编码,主键编码,返回数据集,流程实例节点编码,流程实例节点创建时间,流程实例节点开始处于活动时间,状态,流程类型,操作时间,提交意见,项目名称,省份,城市,项目类别,客户名称,项目来源渠道,客户联系人,客户联系人电话,详细地址,建筑总面积,报备人,4接洽过未合作客户)(对应于字典表151),是否入库,是否已提供战略报价,信息编号,报备申请时项目名称,主键编码,是否修改项目,项目阶段,项目编号";
	...
	public void cloneCopy(BaseAttentionListOfMainProjectReport __bean){
	...
	@Override
	public int compareTo(BaseAttentionListOfMainProjectReport o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseAttentionListOfMainProjectReport o = (BaseAttentionListOfMainProjectReport)obj;
