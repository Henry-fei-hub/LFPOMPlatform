...
public class BaseNormalReimbursementsPoolOfWorkflow extends GenericBase implements BaseFactory<BaseNormalReimbursementsPoolOfWorkflow>, Comparable<BaseNormalReimbursementsPoolOfWorkflow> 
{


	public static BaseNormalReimbursementsPoolOfWorkflow newInstance(){
		return new BaseNormalReimbursementsPoolOfWorkflow();
	}

	@Override
	public BaseNormalReimbursementsPoolOfWorkflow make(){
		BaseNormalReimbursementsPoolOfWorkflow b = new BaseNormalReimbursementsPoolOfWorkflow();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,业务编码,业务名称,活动编码,流程编码,主键编码,返回数据集,节点类型 0 - 开始 1 - 结束 2 - 审批 3 - 处理 4 - 知会,附加节点，说明节点是预定义的节点还是动态加的节点， 0 - 正常定义的节点， 1 - 申请人或者审批人加的处理人或者审批人,当前流程实例节点的内部编码,流程实例节点创建时间,流程实例节点开始处于活动时间,状态,流程类型,编号,发起人,归属部门,金额,归属公司,操作时间,提交意见,主题";
	...
	public void cloneCopy(BaseNormalReimbursementsPoolOfWorkflow __bean){
	...
	@Override
	public int compareTo(BaseNormalReimbursementsPoolOfWorkflow o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseNormalReimbursementsPoolOfWorkflow o = (BaseNormalReimbursementsPoolOfWorkflow)obj;
