...
public class ConditionNormalReimbursementsApplyOfWorkflow extends GenericCondition{

	public ConditionNormalReimbursementsApplyOfWorkflow(){
		setParameterCount(6);
	}
	...
	public String getReimbursementName() {
		return this.__reimbursement_name == null ? null : (this.__reimbursement_name.indexOf("%") >= 0 ? this.__reimbursement_name : "%"+this.__reimbursement_name+"%");
	}

	public void setReimbursementName(String __reimbursement_name) {
		this.__reimbursement_name = __reimbursement_name;
	}
