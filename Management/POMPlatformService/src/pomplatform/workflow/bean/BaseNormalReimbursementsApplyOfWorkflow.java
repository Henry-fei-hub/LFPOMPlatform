...
public class BaseNormalReimbursementsApplyOfWorkflow extends GenericBase implements BaseFactory<BaseNormalReimbursementsApplyOfWorkflow>, Comparable<BaseNormalReimbursementsApplyOfWorkflow> 
{


	public static BaseNormalReimbursementsApplyOfWorkflow newInstance(){
		return new BaseNormalReimbursementsApplyOfWorkflow();
	}

	@Override
	public BaseNormalReimbursementsApplyOfWorkflow make(){
		BaseNormalReimbursementsApplyOfWorkflow b = new BaseNormalReimbursementsApplyOfWorkflow();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,流程类型,业务编码,业务名称,流程编码,活动实列编码,流程状态,创建时间,完成时间,报销,创建人,报销总金额,编号,归属公司";
	...
	public void cloneCopy(BaseNormalReimbursementsApplyOfWorkflow __bean){
	...
	@Override
	public int compareTo(BaseNormalReimbursementsApplyOfWorkflow o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseNormalReimbursementsApplyOfWorkflow o = (BaseNormalReimbursementsApplyOfWorkflow)obj;
