...
public class BaseProjectNormalReimbursementWithPn extends BaseProjectNormalReimbursement 
{
	...
	public List<BaseNormalReimbursementLinkMainProject> getDetailNormalReimbursementLinkMainProject() {
		return this.__detail_normal_reimbursement_link_main_projects;
	}

	public void setDetailNormalReimbursementLinkMainProject( List<BaseNormalReimbursementLinkMainProject> value ) {
		this.__detail_normal_reimbursement_link_main_projects = value;
	}
	...
	public java.lang.String toJSONString() {
		...
		count = sb.length(); sb.append(__wrapList(count, "detailNormalReimbursementLinkMainProject", getDetailNormalReimbursementLinkMainProject()));
		return sb.toString() ;
	}
	...
	protected List<BaseNormalReimbursementLinkMainProject> __detail_normal_reimbursement_link_main_projects ; 
}
