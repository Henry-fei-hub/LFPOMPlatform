...
public class BasePreProjectTravelReimbursement extends GenericBase implements BaseFactory<BasePreProjectTravelReimbursement>, Comparable<BasePreProjectTravelReimbursement> 
{


	public static BasePreProjectTravelReimbursement newInstance(){
		return new BasePreProjectTravelReimbursement();
	}

	@Override
	public BasePreProjectTravelReimbursement make(){
		BasePreProjectTravelReimbursement b = new BasePreProjectTravelReimbursement();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "差旅报销编码,报销编号,流程编码,主题,申请人,起草人,报销部门,报销时间,出差开始日期,出差结束日期,报销金额,是否冲账,报销事由,申请时间,完成时间,附件,附件数量,状态,归属公司,是否是项目上的报销，默认false,删除状态  0未删除    1已删除";
	...
	public java.util.List<BaseTravelReimbursementLinkMainProject> getDetailTravelReimbursementLinkMainProject() {
		return this.__detailTravelReimbursementLinkMainProject;
	}

	public void setDetailTravelReimbursementLinkMainProject( java.util.List<BaseTravelReimbursementLinkMainProject> value ) {
		this.__detailTravelReimbursementLinkMainProject = value;
	}

	public void cloneCopy(BasePreProjectTravelReimbursement __bean){
	...
	@Override
	public int compareTo(BasePreProjectTravelReimbursement o) {
	...
	public boolean equals(Object obj) {
		...
		final BasePreProjectTravelReimbursement o = (BasePreProjectTravelReimbursement)obj;
	...
	public java.lang.String toJSONString() {
		...
		if(getDetailTravelReimbursementLinkMainProject() != null)  sb.append(__wrapList(count++, "detailTravelReimbursementLinkMainProject", getDetailTravelReimbursementLinkMainProject()));
		return sb.toString();
	}
	...
	protected java.util.List<BaseTravelReimbursementLinkMainProject> __detailTravelReimbursementLinkMainProject = null;
}
