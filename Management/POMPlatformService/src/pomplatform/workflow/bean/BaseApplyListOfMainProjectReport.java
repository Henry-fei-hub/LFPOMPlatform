...
public class BaseApplyListOfMainProjectReport extends GenericBase implements BaseFactory<BaseApplyListOfMainProjectReport>, Comparable<BaseApplyListOfMainProjectReport> 
{


	public static BaseApplyListOfMainProjectReport newInstance(){
		return new BaseApplyListOfMainProjectReport();
	}

	@Override
	public BaseApplyListOfMainProjectReport make(){
		BaseApplyListOfMainProjectReport b = new BaseApplyListOfMainProjectReport();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,流程类型,业务编码,业务名称,流程编码,活动实列编码,流程状态 0 发起中  1,创建时间,完成时间,创建人,项目名称,省份,城市,项目类别,客户名称,项目来源渠道,客户联系人,客户联系人电话,详细地址,建筑总面积,客户id,4接洽过未合作客户)(对应于字典表151),是否入库,是否已提供战略报价,信息编号,联系人id,主键编码,项目阶段,是否修改项目,项目编号";
	...
	public void cloneCopy(BaseApplyListOfMainProjectReport __bean){
	...
	@Override
	public int compareTo(BaseApplyListOfMainProjectReport o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseApplyListOfMainProjectReport o = (BaseApplyListOfMainProjectReport)obj;
