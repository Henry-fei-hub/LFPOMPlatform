...
public class BaseNormalReimbursementsAuditOfWorkflow extends GenericBase implements BaseFactory<BaseNormalReimbursementsAuditOfWorkflow>, Comparable<BaseNormalReimbursementsAuditOfWorkflow> 
{


	public static BaseNormalReimbursementsAuditOfWorkflow newInstance(){
		return new BaseNormalReimbursementsAuditOfWorkflow();
	}

	@Override
	public BaseNormalReimbursementsAuditOfWorkflow make(){
		BaseNormalReimbursementsAuditOfWorkflow b = new BaseNormalReimbursementsAuditOfWorkflow();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "活动实列编码,业务编码,业务名称,活动编码,流程编码,主键编码,附加节点，说明节点是预定义的节点还是动态加的节点， 0 - 正常定义的节点， 1 - 申请人或者审批人加的处理人或者审批人,当前流程实例节点的内部编码,下一个流程节点的编码,如果是知会节点，所依附的主节点,流程实例节点创建时间,流程实例节点开始处于活动时间,状态,流程类型,编号,发起人,归属部门,金额,归属公司,操作时间,提交意见,节点类型,返回数据集";
	...
	public void cloneCopy(BaseNormalReimbursementsAuditOfWorkflow __bean){
	...
	@Override
	public int compareTo(BaseNormalReimbursementsAuditOfWorkflow o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseNormalReimbursementsAuditOfWorkflow o = (BaseNormalReimbursementsAuditOfWorkflow)obj;
