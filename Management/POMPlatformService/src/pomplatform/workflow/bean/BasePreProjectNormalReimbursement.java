...
public class BasePreProjectNormalReimbursement extends GenericBase implements BaseFactory<BasePreProjectNormalReimbursement>, Comparable<BasePreProjectNormalReimbursement> 
{


	public static BasePreProjectNormalReimbursement newInstance(){
		return new BasePreProjectNormalReimbursement();
	}

	@Override
	public BasePreProjectNormalReimbursement make(){
		BasePreProjectNormalReimbursement b = new BasePreProjectNormalReimbursement();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,报销编号,流程编码,起草人,报销人,报销部门,主题,报销时间,状态,报销总金额,申请时间,完成时间,备注,是否冲账,附件,附件(张),归属公司,是否是项目上的报销，默认false,删除状态  0未删除    1已删除";
	...
	public java.util.List<BaseNormalReimbursementLinkMainProject> getDetailNormalReimbursementLinkMainProject() {
		return this.__detailNormalReimbursementLinkMainProject;
	}

	public void setDetailNormalReimbursementLinkMainProject( java.util.List<BaseNormalReimbursementLinkMainProject> value ) {
		this.__detailNormalReimbursementLinkMainProject = value;
	}

	public void cloneCopy(BasePreProjectNormalReimbursement __bean){
	...
	@Override
	public int compareTo(BasePreProjectNormalReimbursement o) {
	...
	public boolean equals(Object obj) {
		...
		final BasePreProjectNormalReimbursement o = (BasePreProjectNormalReimbursement)obj;
	...
	public java.lang.String toJSONString() {
		...
		if(getDetailNormalReimbursementLinkMainProject() != null)  sb.append(__wrapList(count++, "detailNormalReimbursementLinkMainProject", getDetailNormalReimbursementLinkMainProject()));
		return sb.toString();
	}
	...
	public void setDataFromMap(Map<String, Object> values){
		...
		if((val = values.get("detailNormalReimbursementLinkMainProject")) != null) setDetailNormalReimbursementLinkMainProject(__getList(val, BaseNormalReimbursementLinkMainProject.newInstance()));
	}
	...
	protected java.util.List<BaseNormalReimbursementLinkMainProject> __detailNormalReimbursementLinkMainProject = null;
}
