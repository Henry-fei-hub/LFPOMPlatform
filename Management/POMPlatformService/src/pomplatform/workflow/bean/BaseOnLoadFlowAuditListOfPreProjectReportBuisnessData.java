...
public class BaseOnLoadFlowAuditListOfPreProjectReportBuisnessData extends GenericBase implements BaseFactory<BaseOnLoadFlowAuditListOfPreProjectReportBuisnessData>, Comparable<BaseOnLoadFlowAuditListOfPreProjectReportBuisnessData>
{


	public static BaseOnLoadFlowAuditListOfPreProjectReportBuisnessData newInstance(){
		return new BaseOnLoadFlowAuditListOfPreProjectReportBuisnessData();
	}

	@Override
	public BaseOnLoadFlowAuditListOfPreProjectReportBuisnessData make(){
		BaseOnLoadFlowAuditListOfPreProjectReportBuisnessData b = new BaseOnLoadFlowAuditListOfPreProjectReportBuisnessData();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "流程类型名称,主键编码,,主键编码,业务编码,业务名称,活动编码,流程编码,流程实列编码,附加节点，说明节点是预定义的节点还是动态加的节点， 0 - 正常定义的节点， 1 - 申请人或者审批人加的处理人或者审批人,当前流程实例节点的内部编码,下一个流程节点的编码,如果是知会节点，所依附的主节点,流程实例节点创建时间,流程实例节点开始处于活动时间,操作时间,提交意见,状态,节点类型 0 - 开始 1 - 结束 2 - 审批 3 - 处理 4 - 知会,返回数据集,项目名称,项目地址（省）,项目地址（市）,项目类别,开发商名称,项目来源渠道,联系人,联系电话,详细地址,项目面积,报备人,4接洽过未合作客户)(对应于字典表151),是否入库,是否已提供战略报价,信息编号,联系人id,process_type";
	...
	public void cloneCopy(BaseOnLoadFlowAuditListOfPreProjectReportBuisnessData __bean){
	...
	@Override
	public int compareTo(BaseOnLoadFlowAuditListOfPreProjectReportBuisnessData o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseOnLoadFlowAuditListOfPreProjectReportBuisnessData o = (BaseOnLoadFlowAuditListOfPreProjectReportBuisnessData)obj;
