...
public class ConditionOnLoadAttentionListOfApproveProjectStageStroage extends GenericCondition{

	public ConditionOnLoadAttentionListOfApproveProjectStageStroage(){
		setParameterCount(8);
	}
