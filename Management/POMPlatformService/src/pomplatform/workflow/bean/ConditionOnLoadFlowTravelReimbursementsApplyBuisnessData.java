...
public class ConditionOnLoadFlowTravelReimbursementsApplyBuisnessData extends GenericCondition{

	public ConditionOnLoadFlowTravelReimbursementsApplyBuisnessData(){
		setParameterCount(8);
	}
