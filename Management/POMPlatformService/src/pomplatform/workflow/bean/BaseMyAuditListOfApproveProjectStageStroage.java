...
public class BaseMyAuditListOfApproveProjectStageStroage extends GenericBase implements BaseFactory<BaseMyAuditListOfApproveProjectStageStroage>, Comparable<BaseMyAuditListOfApproveProjectStageStroage> 
{


	public static BaseMyAuditListOfApproveProjectStageStroage newInstance(){
		return new BaseMyAuditListOfApproveProjectStageStroage();
	}

	@Override
	public BaseMyAuditListOfApproveProjectStageStroage make(){
		BaseMyAuditListOfApproveProjectStageStroage b = new BaseMyAuditListOfApproveProjectStageStroage();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,业务编码,业务名称,活动编码,流程编码,流程实列编码,附加节点，说明节点是预定义的节点还是动态加的节点， 0 - 正常定义的节点， 1 - 申请人或者审批人加的处理人或者审批人,当前流程实例节点的内部编码,下一个流程节点的编码,如果是知会节点，所依附的主节点,流程实例节点创建时间,流程实例节点开始处于活动时间,操作时间,提交意见,状态,项目主键,合同编号,项目编号,项目名称,项目类别,板块,专业负责人,事业部负责人,部门经理,id,流程类型,删除状态  0未删除    1已删除,起草时间,处理人,,返回数据集";
	...
	public void cloneCopy(BaseMyAuditListOfApproveProjectStageStroage __bean){
	...
	@Override
	public int compareTo(BaseMyAuditListOfApproveProjectStageStroage o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseMyAuditListOfApproveProjectStageStroage o = (BaseMyAuditListOfApproveProjectStageStroage)obj;
