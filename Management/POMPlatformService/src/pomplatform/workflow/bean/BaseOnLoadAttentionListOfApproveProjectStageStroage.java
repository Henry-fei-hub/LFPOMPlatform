...
public class BaseOnLoadAttentionListOfApproveProjectStageStroage extends GenericBase implements BaseFactory<BaseOnLoadAttentionListOfApproveProjectStageStroage>, Comparable<BaseOnLoadAttentionListOfApproveProjectStageStroage> 
{


	public static BaseOnLoadAttentionListOfApproveProjectStageStroage newInstance(){
		return new BaseOnLoadAttentionListOfApproveProjectStageStroage();
	}

	@Override
	public BaseOnLoadAttentionListOfApproveProjectStageStroage make(){
		BaseOnLoadAttentionListOfApproveProjectStageStroage b = new BaseOnLoadAttentionListOfApproveProjectStageStroage();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,业务编码,业务名称,活动编码,流程编码,流程实列编码,返回数据集,流程实例节点编码,流程实例节点创建时间,流程实例节点开始处于活动时间,状态,操作时间,提交意见,项目主键,合同编号,项目编号,项目名称,项目类别,板块,专业负责人,事业部负责人,部门经理,id,流程类型,删除状态  0未删除    1已删除,起草时间,处理人,";
	...
	public void cloneCopy(BaseOnLoadAttentionListOfApproveProjectStageStroage __bean){
	...
	@Override
	public int compareTo(BaseOnLoadAttentionListOfApproveProjectStageStroage o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseOnLoadAttentionListOfApproveProjectStageStroage o = (BaseOnLoadAttentionListOfApproveProjectStageStroage)obj;
