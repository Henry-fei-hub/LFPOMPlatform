...
public class BasePayMoneyAttentionOfWorkflow extends GenericBase implements BaseFactory<BasePayMoneyAttentionOfWorkflow>, Comparable<BasePayMoneyAttentionOfWorkflow> 
{


	public static BasePayMoneyAttentionOfWorkflow newInstance(){
		return new BasePayMoneyAttentionOfWorkflow();
	}

	@Override
	public BasePayMoneyAttentionOfWorkflow make(){
		BasePayMoneyAttentionOfWorkflow b = new BasePayMoneyAttentionOfWorkflow();
		return b;
	}
	...
	public void cloneCopy(BasePayMoneyAttentionOfWorkflow __bean){
	...
	@Override
	public int compareTo(BasePayMoneyAttentionOfWorkflow o) {
	...
	public boolean equals(Object obj) {
		...
		final BasePayMoneyAttentionOfWorkflow o = (BasePayMoneyAttentionOfWorkflow)obj;
