...
public class BasePayMoneyPoolOfWorkflow extends GenericBase implements BaseFactory<BasePayMoneyPoolOfWorkflow>, Comparable<BasePayMoneyPoolOfWorkflow> 
{


	public static BasePayMoneyPoolOfWorkflow newInstance(){
		return new BasePayMoneyPoolOfWorkflow();
	}

	@Override
	public BasePayMoneyPoolOfWorkflow make(){
		BasePayMoneyPoolOfWorkflow b = new BasePayMoneyPoolOfWorkflow();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,业务编码,业务名称,活动编码,流程编码,流程实列编码,返回数据集,节点类型 0 - 开始 1 - 结束 2 - 审批 3 - 处理 4 - 知会,附加节点，说明节点是预定义的节点还是动态加的节点， 0 - 正常定义的节点， 1 - 申请人或者审批人加的处理人或者审批人,当前流程实例节点的内部编码,流程实例节点创建时间,流程实例节点开始处于活动时间,状态,流程类型,编号,处理人,部门编码,pay_amount,归属公司,操作时间,提交意见,申请缘由";
	...
	public void cloneCopy(BasePayMoneyPoolOfWorkflow __bean){
	...
	@Override
	public int compareTo(BasePayMoneyPoolOfWorkflow o) {
	...
	public boolean equals(Object obj) {
		...
		final BasePayMoneyPoolOfWorkflow o = (BasePayMoneyPoolOfWorkflow)obj;
