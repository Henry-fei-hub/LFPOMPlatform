...
public class BaseOnLoadApplyListOfApproveProjectStageStroage extends GenericBase implements BaseFactory<BaseOnLoadApplyListOfApproveProjectStageStroage>, Comparable<BaseOnLoadApplyListOfApproveProjectStageStroage> 
{


	public static BaseOnLoadApplyListOfApproveProjectStageStroage newInstance(){
		return new BaseOnLoadApplyListOfApproveProjectStageStroage();
	}

	@Override
	public BaseOnLoadApplyListOfApproveProjectStageStroage make(){
		BaseOnLoadApplyListOfApproveProjectStageStroage b = new BaseOnLoadApplyListOfApproveProjectStageStroage();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,流程类型,业务编码,业务名称,流程编码,活动实列编码,流程状态,创建人,创建时间,完成时间,删除状态  0未删除    1已删除,流程走完之后，是否执行了其他操作   0未执行   1已执行,项目主键,合同编号,项目编号,项目名称,项目类别,板块,专业负责人,事业部负责人,部门经理,id,流程类型,删除状态  0未删除    1已删除,创建时间,创建人,";
	...
	public void cloneCopy(BaseOnLoadApplyListOfApproveProjectStageStroage __bean){
	...
	@Override
	public int compareTo(BaseOnLoadApplyListOfApproveProjectStageStroage o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseOnLoadApplyListOfApproveProjectStageStroage o = (BaseOnLoadApplyListOfApproveProjectStageStroage)obj;
