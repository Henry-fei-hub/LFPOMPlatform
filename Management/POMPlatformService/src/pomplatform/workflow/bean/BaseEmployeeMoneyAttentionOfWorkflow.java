...
public class BaseEmployeeMoneyAttentionOfWorkflow extends GenericBase implements BaseFactory<BaseEmployeeMoneyAttentionOfWorkflow>, Comparable<BaseEmployeeMoneyAttentionOfWorkflow> 
{


	public static BaseEmployeeMoneyAttentionOfWorkflow newInstance(){
		return new BaseEmployeeMoneyAttentionOfWorkflow();
	}

	@Override
	public BaseEmployeeMoneyAttentionOfWorkflow make(){
		BaseEmployeeMoneyAttentionOfWorkflow b = new BaseEmployeeMoneyAttentionOfWorkflow();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,业务编码,业务名称,活动编码,流程编码,主键编码,返回数据集,流程实例节点编码,流程实例节点创建时间,流程实例节点开始处于活动时间,状态,流程类型,编号,发起人,归属部门,金额,归属公司,操作时间,提交意见";
	...
	public void cloneCopy(BaseEmployeeMoneyAttentionOfWorkflow __bean){
	...
	@Override
	public int compareTo(BaseEmployeeMoneyAttentionOfWorkflow o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseEmployeeMoneyAttentionOfWorkflow o = (BaseEmployeeMoneyAttentionOfWorkflow)obj;
