...
public class BaseOnLoadPersonnelFlowDetail extends GenericBase implements BaseFactory<BaseOnLoadPersonnelFlowDetail>, Comparable<BaseOnLoadPersonnelFlowDetail> 
{


	public static BaseOnLoadPersonnelFlowDetail newInstance(){
		return new BaseOnLoadPersonnelFlowDetail();
	}

	@Override
	public BaseOnLoadPersonnelFlowDetail make(){
		BaseOnLoadPersonnelFlowDetail b = new BaseOnLoadPersonnelFlowDetail();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "节点类型 0 - 开始 1 - 结束 2 - 审批 3 - 处理 4 - 知会,业务名称,业务编码,主键编码,流程编码,员工姓名,状态,人事业务编码,流程类型,创建人,工号,部门,归属公司,假期类型,开始日期,0上午   1下午,截止日期,0上午   1下午,天数,申请缘由,备注,地址,计划安排,交通工具,预计费用,外访单位,联系人,创建时间,删除状态  0未删除    1已删除";
	...
	public void cloneCopy(BaseOnLoadPersonnelFlowDetail __bean){
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		String strStatus = delicacy.system.executor.SelectValueCache.getSelectValue("system_dictionary_39", String.valueOf(getProcessStatus()));
	...
	@Override
	public int compareTo(BaseOnLoadPersonnelFlowDetail o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseOnLoadPersonnelFlowDetail o = (BaseOnLoadPersonnelFlowDetail)obj;
