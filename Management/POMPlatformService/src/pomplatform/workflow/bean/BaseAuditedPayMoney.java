...
public class BaseAuditedPayMoney extends GenericBase implements BaseFactory<BaseAuditedPayMoney>, Comparable<BaseAuditedPayMoney> 
{


	public static BaseAuditedPayMoney newInstance(){
		return new BaseAuditedPayMoney();
	}

	@Override
	public BaseAuditedPayMoney make(){
		BaseAuditedPayMoney b = new BaseAuditedPayMoney();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,流程类型,业务编码,业务名称,活动编码,流程编码,流程实列编码,附加节点，说明节点是预定义的节点还是动态加的节点， 0 - 正常定义的节点， 1 - 申请人或者审批人加的处理人或者审批人,当前流程实例节点的内部编码,下一个流程节点的编码,如果是知会节点，所依附的主节点,流程实例节点创建时间,流程实例节点开始处于活动时间,编号,发起人,归属部门,金额,归属公司,主题,节点类型 0 - 开始 1 - 结束 2 - 审批 3 - 处理 4 - 知会,返回数据集,操作时间,状态,提交意见,申请缘由";
	...
	public void cloneCopy(BaseAuditedPayMoney __bean){
	...
	@Override
	public int compareTo(BaseAuditedPayMoney o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseAuditedPayMoney o = (BaseAuditedPayMoney)obj;
