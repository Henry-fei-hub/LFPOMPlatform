...
public class ConditionPreProjectTravelReimbursement extends GenericCondition{

	public ConditionPreProjectTravelReimbursement(){
	...
	public java.lang.Integer getTravelReimbursementId() {
		return __travel_reimbursement_id;
	}
