...
public class BaseStravelreimbursementmmmor extends GenericBase implements BaseFactory<BaseStravelreimbursementmmmor>, Comparable<BaseStravelreimbursementmmmor> 
{


	public static BaseStravelreimbursementmmmor newInstance(){
		return new BaseStravelreimbursementmmmor();
	}

	@Override
	public BaseStravelreimbursementmmmor make(){
		BaseStravelreimbursementmmmor b = new BaseStravelreimbursementmmmor();
		return b;
	}
	...
	public void cloneCopy(BaseStravelreimbursementmmmor __bean){
	...
	@Override
	public int compareTo(BaseStravelreimbursementmmmor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseStravelreimbursementmmmor o = (BaseStravelreimbursementmmmor)obj;
