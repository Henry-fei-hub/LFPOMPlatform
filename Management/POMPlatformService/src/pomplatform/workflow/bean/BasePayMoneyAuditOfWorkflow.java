...
public class BasePayMoneyAuditOfWorkflow extends GenericBase implements BaseFactory<BasePayMoneyAuditOfWorkflow>, Comparable<BasePayMoneyAuditOfWorkflow> 
{


	public static BasePayMoneyAuditOfWorkflow newInstance(){
		return new BasePayMoneyAuditOfWorkflow();
	}

	@Override
	public BasePayMoneyAuditOfWorkflow make(){
		BasePayMoneyAuditOfWorkflow b = new BasePayMoneyAuditOfWorkflow();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "活动实列编码,流程类型,业务编码,业务名称,活动编码,流程编码,主键编码,附加节点，说明节点是预定义的节点还是动态加的节点， 0 - 正常定义的节点， 1 - 申请人或者审批人加的处理人或者审批人,当前流程实例节点的内部编码,下一个流程节点的编码,如果是知会节点，所依附的主节点,流程实例节点创建时间,流程实例节点开始处于活动时间,操作时间,提交意见,状态,归属部门,发起人,金额,编号,归属公司,节点类型,";
	...
	public void cloneCopy(BasePayMoneyAuditOfWorkflow __bean){
	...
	@Override
	public int compareTo(BasePayMoneyAuditOfWorkflow o) {
	...
	public boolean equals(Object obj) {
		...
		final BasePayMoneyAuditOfWorkflow o = (BasePayMoneyAuditOfWorkflow)obj;
