...
public class ConditionOnLoadFlowNormalReimbursementsApplyBuisnessData extends GenericCondition{

	public ConditionOnLoadFlowNormalReimbursementsApplyBuisnessData(){
		setParameterCount(9);
	}
