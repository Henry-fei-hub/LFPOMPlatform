...
public class BaseOnLoadFlowNormalReimbursementsBuisnessData extends GenericBase implements BaseFactory<BaseOnLoadFlowNormalReimbursementsBuisnessData>, Comparable<BaseOnLoadFlowNormalReimbursementsBuisnessData> 
{


	public static BaseOnLoadFlowNormalReimbursementsBuisnessData newInstance(){
		return new BaseOnLoadFlowNormalReimbursementsBuisnessData();
	}

	@Override
	public BaseOnLoadFlowNormalReimbursementsBuisnessData make(){
		BaseOnLoadFlowNormalReimbursementsBuisnessData b = new BaseOnLoadFlowNormalReimbursementsBuisnessData();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "流程类型名称,业务编码,业务名称,活动编码,流程编码,流程实列编码,返回数据集,节点类型 0 - 开始 1 - 结束 2 - 审批 3 - 处理 4 - 知会,附加节点，说明节点是预定义的节点还是动态加的节点， 0 - 正常定义的节点， 1 - 申请人或者审批人加的处理人或者审批人,当前流程实例节点的内部编码,流程实例节点创建时间,流程实例节点开始处于活动时间,状态,流程类型,报销编号,处理人,报销部门,报销总金额,归属公司,操作时间,提交意见,收单状态 1已收 2 退回 3转交 4待补正资料,";
	...
	public void cloneCopy(BaseOnLoadFlowNormalReimbursementsBuisnessData __bean){
	...
	@Override
	public int compareTo(BaseOnLoadFlowNormalReimbursementsBuisnessData o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseOnLoadFlowNormalReimbursementsBuisnessData o = (BaseOnLoadFlowNormalReimbursementsBuisnessData)obj;
