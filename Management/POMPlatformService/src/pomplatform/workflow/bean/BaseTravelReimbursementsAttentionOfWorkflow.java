...
public class BaseTravelReimbursementsAttentionOfWorkflow extends GenericBase implements BaseFactory<BaseTravelReimbursementsAttentionOfWorkflow>, Comparable<BaseTravelReimbursementsAttentionOfWorkflow> 
{


	public static BaseTravelReimbursementsAttentionOfWorkflow newInstance(){
		return new BaseTravelReimbursementsAttentionOfWorkflow();
	}

	@Override
	public BaseTravelReimbursementsAttentionOfWorkflow make(){
		BaseTravelReimbursementsAttentionOfWorkflow b = new BaseTravelReimbursementsAttentionOfWorkflow();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,业务编码,业务名称,活动编码,流程编码,主键编码,返回数据集,流程实例节点编码,流程实例节点创建时间,流程实例节点开始处于活动时间,状态,流程类型,编号,申请人,归属部门,金额,归属公司,操作时间,提交意见";
	...
	public void cloneCopy(BaseTravelReimbursementsAttentionOfWorkflow __bean){
	...
	@Override
	public int compareTo(BaseTravelReimbursementsAttentionOfWorkflow o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseTravelReimbursementsAttentionOfWorkflow o = (BaseTravelReimbursementsAttentionOfWorkflow)obj;
