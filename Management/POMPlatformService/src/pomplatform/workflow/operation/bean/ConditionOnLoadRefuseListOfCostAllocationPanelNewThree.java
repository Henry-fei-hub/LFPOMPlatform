...
public class ConditionOnLoadRefuseListOfCostAllocationPanelNewThree extends GenericCondition{

	public ConditionOnLoadRefuseListOfCostAllocationPanelNewThree(){
		setParameterCount(3);
	}
