...
public class ConditionOnLoadRefuseListOfCostAllocationPanelNewFive extends GenericCondition{

	public ConditionOnLoadRefuseListOfCostAllocationPanelNewFive(){
		setParameterCount(3);
	}
