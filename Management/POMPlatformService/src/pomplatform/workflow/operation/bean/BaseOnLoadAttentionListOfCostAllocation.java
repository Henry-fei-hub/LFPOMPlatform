...
public class BaseOnLoadAttentionListOfCostAllocation extends GenericBase implements BaseFactory<BaseOnLoadAttentionListOfCostAllocation>, Comparable<BaseOnLoadAttentionListOfCostAllocation> 
{


	public static BaseOnLoadAttentionListOfCostAllocation newInstance(){
		return new BaseOnLoadAttentionListOfCostAllocation();
	}

	@Override
	public BaseOnLoadAttentionListOfCostAllocation make(){
		BaseOnLoadAttentionListOfCostAllocation b = new BaseOnLoadAttentionListOfCostAllocation();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,业务编码,业务名称,活动编码,流程编码,流程实列编码,返回数据集,流程实例节点编码,流程实例节点创建时间,流程实例节点开始处于活动时间,状态,流程类型,起草人,原成本类型,编号,名称,费用承担主体,申请缘由,操作时间,审批意见";
	...
	public void cloneCopy(BaseOnLoadAttentionListOfCostAllocation __bean){
	...
	@Override
	public int compareTo(BaseOnLoadAttentionListOfCostAllocation o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseOnLoadAttentionListOfCostAllocation o = (BaseOnLoadAttentionListOfCostAllocation)obj;
