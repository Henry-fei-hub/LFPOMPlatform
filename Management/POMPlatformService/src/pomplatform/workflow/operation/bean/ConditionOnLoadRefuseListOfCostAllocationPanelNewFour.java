...
public class ConditionOnLoadRefuseListOfCostAllocationPanelNewFour extends GenericCondition{

	public ConditionOnLoadRefuseListOfCostAllocationPanelNewFour(){
		setParameterCount(3);
	}
