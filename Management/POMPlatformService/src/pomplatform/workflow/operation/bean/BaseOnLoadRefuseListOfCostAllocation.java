...
public class BaseOnLoadRefuseListOfCostAllocation extends GenericBase implements BaseFactory<BaseOnLoadRefuseListOfCostAllocation>, Comparable<BaseOnLoadRefuseListOfCostAllocation> 
{


	public static BaseOnLoadRefuseListOfCostAllocation newInstance(){
		return new BaseOnLoadRefuseListOfCostAllocation();
	}

	@Override
	public BaseOnLoadRefuseListOfCostAllocation make(){
		BaseOnLoadRefuseListOfCostAllocation b = new BaseOnLoadRefuseListOfCostAllocation();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,流程类型,业务编码,业务名称,流程编码,活动实列编码,流程状态,起草人,原成本类型,编号,名称,成本,创建时间,完成时间,申请缘由";
	...
	public void cloneCopy(BaseOnLoadRefuseListOfCostAllocation __bean){
	...
	@Override
	public int compareTo(BaseOnLoadRefuseListOfCostAllocation o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseOnLoadRefuseListOfCostAllocation o = (BaseOnLoadRefuseListOfCostAllocation)obj;
