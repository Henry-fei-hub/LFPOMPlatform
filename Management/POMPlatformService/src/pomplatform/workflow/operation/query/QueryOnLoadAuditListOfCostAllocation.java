...
public class QueryOnLoadAuditListOfCostAllocation extends AbstractQuery<BaseOnLoadAuditListOfCostAllocation, ConditionOnLoadAuditListOfCostAllocation>
{

	private static final Logger __logger = Logger.getLogger(QueryOnLoadAuditListOfCostAllocation.class);

	public QueryOnLoadAuditListOfCostAllocation() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseOnLoadAuditListOfCostAllocation> executeQuery( KeyValuePair[] replacements, ConditionOnLoadAuditListOfCostAllocation condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseOnLoadAuditListOfCostAllocation generateBase(Object[] __data) throws java.sql.SQLException {
		BaseOnLoadAuditListOfCostAllocation __base = new BaseOnLoadAuditListOfCostAllocation();
		int count = 0;
		Object val;
	...
	private final static String[] fieldNames = { "process_type", "status", "employee_id", "code", "name", "cost", "cost_type"};
}
