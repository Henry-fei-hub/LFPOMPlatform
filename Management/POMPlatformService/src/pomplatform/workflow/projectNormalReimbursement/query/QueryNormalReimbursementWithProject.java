package pomplatform.workflow.projectNormalReimbursement.query;
...
public class QueryNormalReimbursementWithProject extends AbstractQuery<BaseNormalReimbursementWithProject, ConditionNormalReimbursementWithProject>
{

	private static final Logger __logger = Logger.getLogger(QueryNormalReimbursementWithProject.class);

	public QueryNormalReimbursementWithProject() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseNormalReimbursementWithProject> executeQuery( KeyValuePair[] replacements, ConditionNormalReimbursementWithProject condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseNormalReimbursementWithProject generateBase(Object[] __data) throws java.sql.SQLException {
		BaseNormalReimbursementWithProject __base = new BaseNormalReimbursementWithProject();
		int count = 0;
		Object val;
