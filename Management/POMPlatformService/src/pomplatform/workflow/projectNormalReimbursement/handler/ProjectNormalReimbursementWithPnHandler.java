...
public class ProjectNormalReimbursementWithPnHandler implements GenericDao {
	...
	public static boolean isProjectNormalReimbursementWithPnExists( pomplatform.workflow.projectNormalReimbursement.bean.BaseProjectNormalReimbursementWithPn bean, String additional ) {
	...
	public static int countProjectNormalReimbursementWithPn( pomplatform.workflow.projectNormalReimbursement.bean.BaseProjectNormalReimbursementWithPn bean, String additional ) {
