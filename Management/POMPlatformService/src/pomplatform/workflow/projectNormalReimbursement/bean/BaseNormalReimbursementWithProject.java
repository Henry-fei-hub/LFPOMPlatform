...
public class BaseNormalReimbursementWithProject extends GenericBase implements BaseFactory<BaseNormalReimbursementWithProject>, Comparable<BaseNormalReimbursementWithProject> 
{


	public static BaseNormalReimbursementWithProject newInstance(){
		return new BaseNormalReimbursementWithProject();
	}

	@Override
	public BaseNormalReimbursementWithProject make(){
		BaseNormalReimbursementWithProject b = new BaseNormalReimbursementWithProject();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "主键编码,报销编号,流程编码,起草人,报销人,报销部门,主题,报销时间,状态,报销总金额,申请时间,完成时间,备注,是否冲账,附件,附件(张),归属公司,是否是项目上的报销，默认false";
	...
	public java.util.List<BaseNormalReimbursementLinkProject> getDetailNormalReimbursementLinkProject() {
		return this.__detailNormalReimbursementLinkProject;
	}

	public void setDetailNormalReimbursementLinkProject( java.util.List<BaseNormalReimbursementLinkProject> value ) {
		this.__detailNormalReimbursementLinkProject = value;
	}

	public void cloneCopy(BaseNormalReimbursementWithProject __bean){
	...
	@Override
	public int compareTo(BaseNormalReimbursementWithProject o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseNormalReimbursementWithProject o = (BaseNormalReimbursementWithProject)obj;
	...
	public java.lang.String toJSONString() {
		...
		if(getDetailNormalReimbursementLinkProject() != null)  sb.append(__wrapList(count++, "detailNormalReimbursementLinkProject", getDetailNormalReimbursementLinkProject()));
		return sb.toString();
	}
	...
	protected java.util.List<BaseNormalReimbursementLinkProject> __detailNormalReimbursementLinkProject = null;
}
