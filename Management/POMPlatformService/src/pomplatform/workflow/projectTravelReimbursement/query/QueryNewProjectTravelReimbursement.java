package pomplatform.workflow.projectTravelReimbursement.query;
...
public class QueryNewProjectTravelReimbursement extends AbstractQuery<BaseNewProjectTravelReimbursement, ConditionNewProjectTravelReimbursement>
{

	private static final Logger __logger = Logger.getLogger(QueryNewProjectTravelReimbursement.class);

	public QueryNewProjectTravelReimbursement() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseNewProjectTravelReimbursement> executeQuery( KeyValuePair[] replacements, ConditionNewProjectTravelReimbursement condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseNewProjectTravelReimbursement generateBase(Object[] __data) throws java.sql.SQLException {
		BaseNewProjectTravelReimbursement __base = new BaseNewProjectTravelReimbursement();
		int count = 0;
		Object val;
	...
	private final static String __SQLText = "select tr.travel_reimbursement_id, tr.code, tr.process_instance_id, tr.title, tr.applicant, tr.drafter, tr.department_id, 1 AS project_id, tr.reimbursement_time, tr.start_date, tr.end_date, tr.amount, tr.strike_a_balance, tr.remark, tr.apply_time, tr.complete_time, tr.attachment, tr.attachment_number, tr.status, tr.company_id from travel_reimbursements tr where tr.travel_reimbursement_id = ?" ;
	private final static String RESULTSETFIELDLIST = "travel_reimbursement_id,code,process_instance_id,title,applicant,drafter,department_id,project_id,reimbursement_time,start_date,end_date,amount,strike_a_balance,remark,apply_time,complete_time,attachment,attachment_number,status,company_id";
