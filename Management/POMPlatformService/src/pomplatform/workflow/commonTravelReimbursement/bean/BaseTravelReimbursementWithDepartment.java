package pomplatform.workflow.commonTravelReimbursement.bean;
...
public class BaseTravelReimbursementWithDepartment extends GenericBase implements BaseFactory<BaseTravelReimbursementWithDepartment>, Comparable<BaseTravelReimbursementWithDepartment> 
{


	public static BaseTravelReimbursementWithDepartment newInstance(){
		return new BaseTravelReimbursementWithDepartment();
	}

	@Override
	public BaseTravelReimbursementWithDepartment make(){
		BaseTravelReimbursementWithDepartment b = new BaseTravelReimbursementWithDepartment();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "差旅报销编码,报销编号,流程编码,主题,申请人,起草人,报销人所在部门,报销时间,出差开始日期,出差结束日期,报销金额,冲账,报销事由,申请时间,完成时间,附件,附件数量,状态,归属公司,是否是项目上的报销，默认false";
	...
	public java.util.List<BaseTravelReimbursementLinkDepartment> getDetailTravelReimbursementLinkDepartment() {
		return this.__detailTravelReimbursementLinkDepartment;
	}

	public void setDetailTravelReimbursementLinkDepartment( java.util.List<BaseTravelReimbursementLinkDepartment> value ) {
		this.__detailTravelReimbursementLinkDepartment = value;
	}

	public void cloneCopy(BaseTravelReimbursementWithDepartment __bean){
	...
	@Override
	public int compareTo(BaseTravelReimbursementWithDepartment o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseTravelReimbursementWithDepartment o = (BaseTravelReimbursementWithDepartment)obj;
	...
	public java.lang.String toJSONString() {
		...
		if(getDetailTravelReimbursementLinkDepartment() != null)  sb.append(__wrapList(count++, "detailTravelReimbursementLinkDepartment", getDetailTravelReimbursementLinkDepartment()));
		return sb.toString();
	}
	...
	public void setDataFromMap(Map<String, Object> values){
		...
		if((val = values.get("detailTravelReimbursementLinkDepartment")) != null) setDetailTravelReimbursementLinkDepartment(__getList(val, BaseTravelReimbursementLinkDepartment.newInstance()));
	}
	...
	protected java.util.List<BaseTravelReimbursementLinkDepartment> __detailTravelReimbursementLinkDepartment = null;
}
