...
public class BaseTravelReimbursementWithTt extends BaseTravelReimbursement 
{
	...
	public List<BaseTravelReimbursementLinkDepartment> getDetailTravelReimbursementLinkDepartment() {
		return this.__detail_travel_reimbursement_link_departments;
	}

	public void setDetailTravelReimbursementLinkDepartment( List<BaseTravelReimbursementLinkDepartment> value ) {
		this.__detail_travel_reimbursement_link_departments = value;
	}
	...
	public java.lang.String toJSONString() {
		...
		count = sb.length(); sb.append(__wrapList(count, "detailTravelReimbursementLinkDepartment", getDetailTravelReimbursementLinkDepartment()));
		return sb.toString() ;
	}
	...
	protected List<BaseTravelReimbursementLinkDepartment> __detail_travel_reimbursement_link_departments ; 
}
