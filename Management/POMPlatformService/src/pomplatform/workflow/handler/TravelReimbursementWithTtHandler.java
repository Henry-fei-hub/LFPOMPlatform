...
public class TravelReimbursementWithTtHandler implements GenericDao {
	...
	public static boolean isTravelReimbursementWithTtExists( pomplatform.workflow.bean.BaseTravelReimbursementWithTt bean, String additional ) {
	...
	public static int countTravelReimbursementWithTt( pomplatform.workflow.bean.BaseTravelReimbursementWithTt bean, String additional ) {
