...
public class BaseOvertimeApply extends GenericBase implements BaseFactory<BaseOvertimeApply>, Comparable<BaseOvertimeApply> 
{


	public static BaseOvertimeApply newInstance(){
		return new BaseOvertimeApply();
	}

	@Override
	public BaseOvertimeApply make(){
		BaseOvertimeApply b = new BaseOvertimeApply();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "人事业务编码,流程类型,申请人,工号,部门,归属公司,假期类型,开始日期,0上午   1下午,截止日期,0上午   1下午,天数,申请缘由,备注,地址,计划安排,交通工具,预计费用,外访单位,联系人,起草时间,删除状态  0未删除    1已删除,小时";
	...
	public void cloneCopy(BaseOvertimeApply __bean){
	...
	@Override
	public int compareTo(BaseOvertimeApply o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseOvertimeApply o = (BaseOvertimeApply)obj;
