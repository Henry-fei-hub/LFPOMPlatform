...
public class BaseSalaryAdjustmentApply extends GenericBase implements BaseFactory<BaseSalaryAdjustmentApply>, Comparable<BaseSalaryAdjustmentApply> 
{


	public static BaseSalaryAdjustmentApply newInstance(){
		return new BaseSalaryAdjustmentApply();
	}

	@Override
	public BaseSalaryAdjustmentApply make(){
		BaseSalaryAdjustmentApply b = new BaseSalaryAdjustmentApply();
		return b;
	}
	...
	public void cloneCopy(BaseSalaryAdjustmentApply __bean){
	...
	@Override
	public int compareTo(BaseSalaryAdjustmentApply o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSalaryAdjustmentApply o = (BaseSalaryAdjustmentApply)obj;
