...
public class BaseNetworkPrivileges extends GenericBase implements BaseFactory<BaseNetworkPrivileges>, Comparable<BaseNetworkPrivileges> 
{


	public static BaseNetworkPrivileges newInstance(){
		return new BaseNetworkPrivileges();
	}

	@Override
	public BaseNetworkPrivileges make(){
		BaseNetworkPrivileges b = new BaseNetworkPrivileges();
		return b;
	}
	...
	public void cloneCopy(BaseNetworkPrivileges __bean){
	...
	@Override
	public int compareTo(BaseNetworkPrivileges o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseNetworkPrivileges o = (BaseNetworkPrivileges)obj;
