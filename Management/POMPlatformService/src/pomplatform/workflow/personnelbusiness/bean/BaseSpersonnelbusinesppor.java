...
public class BaseSpersonnelbusinesppor extends GenericBase implements BaseFactory<BaseSpersonnelbusinesppor>, Comparable<BaseSpersonnelbusinesppor> 
{


	public static BaseSpersonnelbusinesppor newInstance(){
		return new BaseSpersonnelbusinesppor();
	}

	@Override
	public BaseSpersonnelbusinesppor make(){
		BaseSpersonnelbusinesppor b = new BaseSpersonnelbusinesppor();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "人事业务编码,类型 12请假  13出差  14打卡  15外出  16加班,申请人,工号,部门,归属公司,假期类型,开始日期,0上午   1下午,截止日期,0上午   1下午,天数,申请缘由,备注,地址,计划安排,交通工具,预计费用,外访单位,联系人,起草时间,删除状态  0未删除    1已删除,自定义的审核人,假期类型明细项,小时,公司所在省份,目标省份,多胞胎假请填写婴儿数量,附件,是否审批通过,假期类型明细项,项目类型 1项目 2前期项目,项目主键,项目名称,项目编号,父级编码  用于记录是根据哪一条记录进行延期,是否为边远城市,是否提供住宿,生活费用(元/月),住房费用(元/月)";
	...
	public void cloneCopy(BaseSpersonnelbusinesppor __bean){
	...
	@Override
	public int compareTo(BaseSpersonnelbusinesppor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSpersonnelbusinesppor o = (BaseSpersonnelbusinesppor)obj;
