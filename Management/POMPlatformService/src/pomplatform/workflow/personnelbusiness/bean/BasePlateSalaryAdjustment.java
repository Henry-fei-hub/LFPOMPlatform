...
public class BasePlateSalaryAdjustment extends GenericBase implements BaseFactory<BasePlateSalaryAdjustment>, Comparable<BasePlateSalaryAdjustment> 
{


	public static BasePlateSalaryAdjustment newInstance(){
		return new BasePlateSalaryAdjustment();
	}

	@Override
	public BasePlateSalaryAdjustment make(){
		BasePlateSalaryAdjustment b = new BasePlateSalaryAdjustment();
		return b;
	}
	...
	public java.lang.Long getChangePay() {
		return this.__change_pay;
	}

	public void setChangePay( java.lang.Long value ) {
	...
	public void cloneCopy(BasePlateSalaryAdjustment __bean){
	...
	@Override
	public int compareTo(BasePlateSalaryAdjustment o) {
	...
	public boolean equals(Object obj) {
		...
		final BasePlateSalaryAdjustment o = (BasePlateSalaryAdjustment)obj;
	...
	public java.lang.String toJSONString() {
		...
		if(getChangePay() != null) sb.append(__wrapNumber(count++, "changePay", getChangePay()));
	...
	public void setDataFromMap(Map<String, Object> values){
		...
		if((val = values.get("changePay")) != null) setChangePay(__getLong(val)); 
	...
	protected java.lang.Long  __change_pay ;
