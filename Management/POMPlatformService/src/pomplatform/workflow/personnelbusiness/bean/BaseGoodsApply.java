...
public class BaseGoodsApply extends GenericBase implements BaseFactory<BaseGoodsApply>, Comparable<BaseGoodsApply> 
{


	public static BaseGoodsApply newInstance(){
		return new BaseGoodsApply();
	}

	@Override
	public BaseGoodsApply make(){
		BaseGoodsApply b = new BaseGoodsApply();
		return b;
	}
	...
	public void cloneCopy(BaseGoodsApply __bean){
	...
	@Override
	public int compareTo(BaseGoodsApply o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseGoodsApply o = (BaseGoodsApply)obj;
