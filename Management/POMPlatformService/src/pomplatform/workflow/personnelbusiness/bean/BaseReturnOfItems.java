...
public class BaseReturnOfItems extends GenericBase implements BaseFactory<BaseReturnOfItems>, Comparable<BaseReturnOfItems> 
{


	public static BaseReturnOfItems newInstance(){
		return new BaseReturnOfItems();
	}

	@Override
	public BaseReturnOfItems make(){
		BaseReturnOfItems b = new BaseReturnOfItems();
		return b;
	}
	...
	public void cloneCopy(BaseReturnOfItems __bean){
	...
	@Override
	public int compareTo(BaseReturnOfItems o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseReturnOfItems o = (BaseReturnOfItems)obj;
