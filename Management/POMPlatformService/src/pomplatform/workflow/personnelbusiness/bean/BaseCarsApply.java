...
public class BaseCarsApply extends GenericBase implements BaseFactory<BaseCarsApply>, Comparable<BaseCarsApply> 
{


	public static BaseCarsApply newInstance(){
		return new BaseCarsApply();
	}

	@Override
	public BaseCarsApply make(){
		BaseCarsApply b = new BaseCarsApply();
		return b;
	}
	...
	public void cloneCopy(BaseCarsApply __bean){
	...
	@Override
	public int compareTo(BaseCarsApply o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseCarsApply o = (BaseCarsApply)obj;
