...
public class BaseFillcheckApply extends GenericBase implements BaseFactory<BaseFillcheckApply>, Comparable<BaseFillcheckApply> 
{


	public static BaseFillcheckApply newInstance(){
		return new BaseFillcheckApply();
	}

	@Override
	public BaseFillcheckApply make(){
		BaseFillcheckApply b = new BaseFillcheckApply();
		return b;
	}
	...
	public void cloneCopy(BaseFillcheckApply __bean){
	...
	@Override
	public int compareTo(BaseFillcheckApply o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseFillcheckApply o = (BaseFillcheckApply)obj;
