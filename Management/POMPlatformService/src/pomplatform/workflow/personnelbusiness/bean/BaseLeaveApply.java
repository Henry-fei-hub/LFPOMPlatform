...
public class BaseLeaveApply extends GenericBase implements BaseFactory<BaseLeaveApply>, Comparable<BaseLeaveApply> 
{


	public static BaseLeaveApply newInstance(){
		return new BaseLeaveApply();
	}

	@Override
	public BaseLeaveApply make(){
		BaseLeaveApply b = new BaseLeaveApply();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "人事业务编码,类型 12请假  13出差  14打卡  15外出  16加班,申请人,工号,部门,归属公司,假期类型,开始日期,0上午   1下午,截止日期,0上午   1下午,天数,申请缘由,备注,地址,计划安排,交通工具,预计费用,外访单位,联系人,起草时间,删除状态  0未删除    1已删除,自定义的审核人,假期类型明细项,小时,公司所在省份,目标省份,多胞胎假请填写婴儿数量,附件";
	...
	public void cloneCopy(BaseLeaveApply __bean){
	...
	@Override
	public int compareTo(BaseLeaveApply o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseLeaveApply o = (BaseLeaveApply)obj;
