...
public class BaseCheckWorkHandover extends GenericBase implements BaseFactory<BaseCheckWorkHandover>, Comparable<BaseCheckWorkHandover> 
{


	public static BaseCheckWorkHandover newInstance(){
		return new BaseCheckWorkHandover();
	}

	@Override
	public BaseCheckWorkHandover make(){
		BaseCheckWorkHandover b = new BaseCheckWorkHandover();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "工作交接表编码,工作交接类型  1离职   2转岗,关联编码,名称,主要内容,交接者,被交接者,创建时间,接手人姓名";
	...
	public void cloneCopy(BaseCheckWorkHandover __bean){
	...
	@Override
	public int compareTo(BaseCheckWorkHandover o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseCheckWorkHandover o = (BaseCheckWorkHandover)obj;
