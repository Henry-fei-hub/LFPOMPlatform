...
public class BaseNumberOfPunches extends GenericBase implements BaseFactory<BaseNumberOfPunches>, Comparable<BaseNumberOfPunches> 
{


	public static BaseNumberOfPunches newInstance(){
		return new BaseNumberOfPunches();
	}

	@Override
	public BaseNumberOfPunches make(){
		BaseNumberOfPunches b = new BaseNumberOfPunches();
		return b;
	}
	...
	public void cloneCopy(BaseNumberOfPunches __bean){
	...
	@Override
	public int compareTo(BaseNumberOfPunches o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseNumberOfPunches o = (BaseNumberOfPunches)obj;
