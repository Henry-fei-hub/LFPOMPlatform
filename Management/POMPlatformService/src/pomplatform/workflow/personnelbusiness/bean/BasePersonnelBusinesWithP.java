...
public class BasePersonnelBusinesWithP extends BasePersonnelBusines 
{
	...
	public List<BasePersonnelBusinessLinkEquipment> getDetailPersonnelBusinessLinkEquipment() {
		return this.__detail_personnel_business_link_equipments;
	}

	public void setDetailPersonnelBusinessLinkEquipment( List<BasePersonnelBusinessLinkEquipment> value ) {
		this.__detail_personnel_business_link_equipments = value;
	}
	...
	public java.lang.String toJSONString() {
		...
		count = sb.length(); sb.append(__wrapList(count, "detailPersonnelBusinessLinkEquipment", getDetailPersonnelBusinessLinkEquipment()));
		return sb.toString() ;
	}
	...
	protected List<BasePersonnelBusinessLinkEquipment> __detail_personnel_business_link_equipments ; 
}
