...
public class BaseBusinessCardApply extends GenericBase implements BaseFactory<BaseBusinessCardApply>, Comparable<BaseBusinessCardApply> 
{


	public static BaseBusinessCardApply newInstance(){
		return new BaseBusinessCardApply();
	}

	@Override
	public BaseBusinessCardApply make(){
		BaseBusinessCardApply b = new BaseBusinessCardApply();
		return b;
	}
	...
	public void cloneCopy(BaseBusinessCardApply __bean){
	...
	@Override
	public int compareTo(BaseBusinessCardApply o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseBusinessCardApply o = (BaseBusinessCardApply)obj;
