...
public class BaseStampCarvingApply extends GenericBase implements BaseFactory<BaseStampCarvingApply>, Comparable<BaseStampCarvingApply> 
{


	public static BaseStampCarvingApply newInstance(){
		return new BaseStampCarvingApply();
	}

	@Override
	public BaseStampCarvingApply make(){
		BaseStampCarvingApply b = new BaseStampCarvingApply();
		return b;
	}
	...
	public void cloneCopy(BaseStampCarvingApply __bean){
	...
	@Override
	public int compareTo(BaseStampCarvingApply o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseStampCarvingApply o = (BaseStampCarvingApply)obj;
