...
public class BaseEmployeeOnboardInformation extends GenericBase implements BaseFactory<BaseEmployeeOnboardInformation>, Comparable<BaseEmployeeOnboardInformation> 
{


	public static BaseEmployeeOnboardInformation newInstance(){
		return new BaseEmployeeOnboardInformation();
	}

	@Override
	public BaseEmployeeOnboardInformation make(){
		BaseEmployeeOnboardInformation b = new BaseEmployeeOnboardInformation();
		return b;
	}
	...
	public java.util.List<BaseEmployeeEducationInformation> getDetailEmployeeEducationInformation() {
		return this.__detailEmployeeEducationInformation;
	}

	public void setDetailEmployeeEducationInformation( java.util.List<BaseEmployeeEducationInformation> value ) {
		this.__detailEmployeeEducationInformation = value;
	}

	public java.util.List<BaseEmployeeFamilyInformation> getDetailEmployeeFamilyInformation() {
		return this.__detailEmployeeFamilyInformation;
	}

	public void setDetailEmployeeFamilyInformation( java.util.List<BaseEmployeeFamilyInformation> value ) {
		this.__detailEmployeeFamilyInformation = value;
	}

	public java.util.List<BaseEmployeeRewardExperience> getDetailEmployeeRewardExperience() {
		return this.__detailEmployeeRewardExperience;
	}

	public void setDetailEmployeeRewardExperience( java.util.List<BaseEmployeeRewardExperience> value ) {
		this.__detailEmployeeRewardExperience = value;
	}

	public java.util.List<BaseEmployeeWorkExperience> getDetailEmployeeWorkExperience() {
		return this.__detailEmployeeWorkExperience;
	}

	public void setDetailEmployeeWorkExperience( java.util.List<BaseEmployeeWorkExperience> value ) {
		this.__detailEmployeeWorkExperience = value;
	}

	public java.util.List<BaseEmployeeTechnicalTitle> getDetailEmployeeTechnicalTitle() {
		return this.__detailEmployeeTechnicalTitle;
	}

	public void setDetailEmployeeTechnicalTitle( java.util.List<BaseEmployeeTechnicalTitle> value ) {
		this.__detailEmployeeTechnicalTitle = value;
	}

	public void cloneCopy(BaseEmployeeOnboardInformation __bean){
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		String strOwnedCompany = delicacy.system.executor.SelectValueCache.getSelectValue("company_records", String.valueOf(getOwnedCompany()));
		sb.append(strOwnedCompany == null ? "" : strOwnedCompany);
		sb.append(",");
		...
		sb.append(",");
		String strMarriedStatus = delicacy.system.executor.SelectValueCache.getSelectValue("system_dictionary_77", String.valueOf(getMarriedStatus()));
		sb.append(strMarriedStatus == null ? "" : strMarriedStatus);
		sb.append(",");
		String strPoliticalFace = delicacy.system.executor.SelectValueCache.getSelectValue("system_dictionary_76", String.valueOf(getPoliticalFace()));
		sb.append(strPoliticalFace == null ? "" : strPoliticalFace);
		sb.append(",");
		...
		sb.append(",");
		String strEducation = delicacy.system.executor.SelectValueCache.getSelectValue("system_dictionary_80", String.valueOf(getEducation()));
		sb.append(strEducation == null ? "" : strEducation);
		sb.append(",");
		String strDegree = delicacy.system.executor.SelectValueCache.getSelectValue("system_dictionary_78", String.valueOf(getDegree()));
		sb.append(strDegree == null ? "" : strDegree);
		return sb.toString();
	}

	@Override
	public int compareTo(BaseEmployeeOnboardInformation o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseEmployeeOnboardInformation o = (BaseEmployeeOnboardInformation)obj;
	...
	public java.lang.String toJSONString() {
		...
		if(getDetailEmployeeEducationInformation() != null)  sb.append(__wrapList(count++, "detailEmployeeEducationInformation", getDetailEmployeeEducationInformation()));
		if(getDetailEmployeeFamilyInformation() != null)  sb.append(__wrapList(count++, "detailEmployeeFamilyInformation", getDetailEmployeeFamilyInformation()));
		if(getDetailEmployeeRewardExperience() != null)  sb.append(__wrapList(count++, "detailEmployeeRewardExperience", getDetailEmployeeRewardExperience()));
		if(getDetailEmployeeWorkExperience() != null)  sb.append(__wrapList(count++, "detailEmployeeWorkExperience", getDetailEmployeeWorkExperience()));
		if(getDetailEmployeeTechnicalTitle() != null)  sb.append(__wrapList(count++, "detailEmployeeTechnicalTitle", getDetailEmployeeTechnicalTitle()));
		return sb.toString();
	}
	...
	protected java.util.List<BaseEmployeeEducationInformation> __detailEmployeeEducationInformation = null;
	protected java.util.List<BaseEmployeeFamilyInformation> __detailEmployeeFamilyInformation = null;
	protected java.util.List<BaseEmployeeRewardExperience> __detailEmployeeRewardExperience = null;
	protected java.util.List<BaseEmployeeWorkExperience> __detailEmployeeWorkExperience = null;
	protected java.util.List<BaseEmployeeTechnicalTitle> __detailEmployeeTechnicalTitle = null;
}
