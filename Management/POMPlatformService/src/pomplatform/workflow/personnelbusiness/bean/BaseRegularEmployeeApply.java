...
public class BaseRegularEmployeeApply extends GenericBase implements BaseFactory<BaseRegularEmployeeApply>, Comparable<BaseRegularEmployeeApply> 
{


	public static BaseRegularEmployeeApply newInstance(){
		return new BaseRegularEmployeeApply();
	}

	@Override
	public BaseRegularEmployeeApply make(){
		BaseRegularEmployeeApply b = new BaseRegularEmployeeApply();
		return b;
	}
	...
	public void cloneCopy(BaseRegularEmployeeApply __bean){
	...
	@Override
	public int compareTo(BaseRegularEmployeeApply o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseRegularEmployeeApply o = (BaseRegularEmployeeApply)obj;
