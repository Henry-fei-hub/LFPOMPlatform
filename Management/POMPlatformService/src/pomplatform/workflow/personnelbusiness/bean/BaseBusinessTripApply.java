...
public class BaseBusinessTripApply extends GenericBase implements BaseFactory<BaseBusinessTripApply>, Comparable<BaseBusinessTripApply> 
{


	public static BaseBusinessTripApply newInstance(){
		return new BaseBusinessTripApply();
	}

	@Override
	public BaseBusinessTripApply make(){
		BaseBusinessTripApply b = new BaseBusinessTripApply();
		return b;
	}
	...
	public void cloneCopy(BaseBusinessTripApply __bean){
	...
	@Override
	public int compareTo(BaseBusinessTripApply o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseBusinessTripApply o = (BaseBusinessTripApply)obj;
