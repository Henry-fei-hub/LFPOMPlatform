...
public class QueryRegularEmployeeApply extends AbstractQuery<BaseRegularEmployeeApply, ConditionRegularEmployeeApply>
{

	private static final Logger __logger = Logger.getLogger(QueryRegularEmployeeApply.class);

	public QueryRegularEmployeeApply() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseRegularEmployeeApply> executeQuery( KeyValuePair[] replacements, ConditionRegularEmployeeApply condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseRegularEmployeeApply generateBase(Object[] __data) throws java.sql.SQLException {
		BaseRegularEmployeeApply __base = new BaseRegularEmployeeApply();
		int count = 0;
		Object val;
