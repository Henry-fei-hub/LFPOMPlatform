...
import pomplatform.workflow.personnelbusiness.bean.BaseBusinessCardApply;
import pomplatform.workflow.personnelbusiness.bean.ConditionBusinessCardApply;

public class QueryBusinessCardApply extends AbstractQuery<BaseBusinessCardApply, ConditionBusinessCardApply>
{

	private static final Logger __logger = Logger.getLogger(QueryBusinessCardApply.class);

	public QueryBusinessCardApply() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseBusinessCardApply> executeQuery( KeyValuePair[] replacements, ConditionBusinessCardApply condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseBusinessCardApply generateBase(Object[] __data) throws java.sql.SQLException {
		BaseBusinessCardApply __base = new BaseBusinessCardApply();
		int count = 0;
		Object val;
