...
public class QueryEmployeeOnboardInformation extends AbstractQuery<BaseEmployeeOnboardInformation, ConditionEmployeeOnboardInformation>
{

	private static final Logger __logger = Logger.getLogger(QueryEmployeeOnboardInformation.class);

	public QueryEmployeeOnboardInformation() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseEmployeeOnboardInformation> executeQuery( KeyValuePair[] replacements, ConditionEmployeeOnboardInformation condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseEmployeeOnboardInformation generateBase(Object[] __data) throws java.sql.SQLException {
		BaseEmployeeOnboardInformation __base = new BaseEmployeeOnboardInformation();
		int count = 0;
		Object val;
