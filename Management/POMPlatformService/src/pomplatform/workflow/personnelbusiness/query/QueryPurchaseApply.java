...
public class QueryPurchaseApply extends AbstractQuery<BasePurchaseApply, ConditionPurchaseApply>
{

	private static final Logger __logger = Logger.getLogger(QueryPurchaseApply.class);

	public QueryPurchaseApply() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BasePurchaseApply> executeQuery( KeyValuePair[] replacements, ConditionPurchaseApply condition ) throws java.sql.SQLException {
	...
	@Override
	public BasePurchaseApply generateBase(Object[] __data) throws java.sql.SQLException {
		BasePurchaseApply __base = new BasePurchaseApply();
		int count = 0;
		Object val;
