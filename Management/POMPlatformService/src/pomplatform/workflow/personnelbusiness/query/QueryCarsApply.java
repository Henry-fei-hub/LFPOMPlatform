...
public class QueryCarsApply extends AbstractQuery<BaseCarsApply, ConditionCarsApply>
{

	private static final Logger __logger = Logger.getLogger(QueryCarsApply.class);

	public QueryCarsApply() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseCarsApply> executeQuery( KeyValuePair[] replacements, ConditionCarsApply condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseCarsApply generateBase(Object[] __data) throws java.sql.SQLException {
		BaseCarsApply __base = new BaseCarsApply();
		int count = 0;
		Object val;
