...
public class QuerySalaryAdjustmentApply extends AbstractQuery<BaseSalaryAdjustmentApply, ConditionSalaryAdjustmentApply>
{

	private static final Logger __logger = Logger.getLogger(QuerySalaryAdjustmentApply.class);

	public QuerySalaryAdjustmentApply() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseSalaryAdjustmentApply> executeQuery( KeyValuePair[] replacements, ConditionSalaryAdjustmentApply condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseSalaryAdjustmentApply generateBase(Object[] __data) throws java.sql.SQLException {
		BaseSalaryAdjustmentApply __base = new BaseSalaryAdjustmentApply();
		int count = 0;
		Object val;
