...
public class QueryBusinessTripApply extends AbstractQuery<BaseBusinessTripApply, ConditionBusinessTripApply>
{

	private static final Logger __logger = Logger.getLogger(QueryBusinessTripApply.class);

	public QueryBusinessTripApply() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseBusinessTripApply> executeQuery( KeyValuePair[] replacements, ConditionBusinessTripApply condition ) throws java.sql.SQLException {
		return executeQuery(replacements
			);
	}

	@Override
	public BaseBusinessTripApply generateBase(Object[] __data) throws java.sql.SQLException {
		BaseBusinessTripApply __base = new BaseBusinessTripApply();
		int count = 0;
		Object val;
