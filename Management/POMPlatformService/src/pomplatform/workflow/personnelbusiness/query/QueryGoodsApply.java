...
public class QueryGoodsApply extends AbstractQuery<BaseGoodsApply, ConditionGoodsApply>
{

	private static final Logger __logger = Logger.getLogger(QueryGoodsApply.class);

	public QueryGoodsApply() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseGoodsApply> executeQuery( KeyValuePair[] replacements, ConditionGoodsApply condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseGoodsApply generateBase(Object[] __data) throws java.sql.SQLException {
		BaseGoodsApply __base = new BaseGoodsApply();
		int count = 0;
		Object val;
