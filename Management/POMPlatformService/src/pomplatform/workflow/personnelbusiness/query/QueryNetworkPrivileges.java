...
public class QueryNetworkPrivileges extends AbstractQuery<BaseNetworkPrivileges, ConditionNetworkPrivileges>
{

	private static final Logger __logger = Logger.getLogger(QueryNetworkPrivileges.class);

	public QueryNetworkPrivileges() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseNetworkPrivileges> executeQuery( KeyValuePair[] replacements, ConditionNetworkPrivileges condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseNetworkPrivileges generateBase(Object[] __data) throws java.sql.SQLException {
		BaseNetworkPrivileges __base = new BaseNetworkPrivileges();
		int count = 0;
		Object val;
