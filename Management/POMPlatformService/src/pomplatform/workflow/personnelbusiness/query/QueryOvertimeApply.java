...
public class QueryOvertimeApply extends AbstractQuery<BaseOvertimeApply, ConditionOvertimeApply>
{

	private static final Logger __logger = Logger.getLogger(QueryOvertimeApply.class);

	public QueryOvertimeApply() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseOvertimeApply> executeQuery( KeyValuePair[] replacements, ConditionOvertimeApply condition ) throws java.sql.SQLException {
		return executeQuery(replacements
			);
	}

	@Override
	public BaseOvertimeApply generateBase(Object[] __data) throws java.sql.SQLException {
		BaseOvertimeApply __base = new BaseOvertimeApply();
		int count = 0;
		Object val;
	...
	private final static String __SQLText = "select pb.personnel_business_id, pb.process_type, pb.employee_id, pb.employee_no, pb.department_id, pb.company_id, pb.type, pb.start_date, pb.start_date_detail, pb.end_date, pb.end_date_detail, pb.days, pb.reason, pb.remark, pb.address, pb.plan, pb.transportation, pb.fee, pb.unit, pb.contact_person, pb.create_time, pb.delete_flag, pb.hours from personnel_business pb" ;
	private final static String RESULTSETFIELDLIST = "personnel_business_id,process_type,employee_id,employee_no,department_id,company_id,type,start_date,start_date_detail,end_date,end_date_detail,days,reason,remark,address,plan,transportation,fee,unit,contact_person,create_time,delete_flag,hours";
