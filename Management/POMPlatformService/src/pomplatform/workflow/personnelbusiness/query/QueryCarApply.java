...
public class QueryCarApply extends AbstractQuery<BaseCarApply, ConditionCarApply>
{

	private static final Logger __logger = Logger.getLogger(QueryCarApply.class);

	public QueryCarApply() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseCarApply> executeQuery( KeyValuePair[] replacements, ConditionCarApply condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseCarApply generateBase(Object[] __data) throws java.sql.SQLException {
		BaseCarApply __base = new BaseCarApply();
		int count = 0;
		Object val;
