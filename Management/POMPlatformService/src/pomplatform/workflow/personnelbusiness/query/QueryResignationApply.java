...
import pomplatform.workflow.personnelbusiness.bean.BaseResignationApply;
import pomplatform.workflow.personnelbusiness.bean.ConditionResignationApply;

public class QueryResignationApply extends AbstractQuery<BaseResignationApply, ConditionResignationApply>
{

	private static final Logger __logger = Logger.getLogger(QueryResignationApply.class);

	public QueryResignationApply() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseResignationApply> executeQuery( KeyValuePair[] replacements, ConditionResignationApply condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseResignationApply generateBase(Object[] __data) throws java.sql.SQLException {
		BaseResignationApply __base = new BaseResignationApply();
		int count = 0;
		Object val;
