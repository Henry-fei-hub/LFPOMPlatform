...
public class QueryStampCarvingApply extends AbstractQuery<BaseStampCarvingApply, ConditionStampCarvingApply>
{

	private static final Logger __logger = Logger.getLogger(QueryStampCarvingApply.class);

	public QueryStampCarvingApply() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseStampCarvingApply> executeQuery( KeyValuePair[] replacements, ConditionStampCarvingApply condition ) throws java.sql.SQLException {
	...
	@Override
	public BaseStampCarvingApply generateBase(Object[] __data) throws java.sql.SQLException {
		BaseStampCarvingApply __base = new BaseStampCarvingApply();
		int count = 0;
		Object val;
