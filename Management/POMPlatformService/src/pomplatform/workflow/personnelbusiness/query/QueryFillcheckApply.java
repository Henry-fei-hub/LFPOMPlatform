...
public class QueryFillcheckApply extends AbstractQuery<BaseFillcheckApply, ConditionFillcheckApply>
{

	private static final Logger __logger = Logger.getLogger(QueryFillcheckApply.class);

	public QueryFillcheckApply() throws java.sql.SQLException 
	{
	...
	@Override
	public BaseCollection<BaseFillcheckApply> executeQuery( KeyValuePair[] replacements, ConditionFillcheckApply condition ) throws java.sql.SQLException {
		return executeQuery(replacements
			);
	}

	@Override
	public BaseFillcheckApply generateBase(Object[] __data) throws java.sql.SQLException {
		BaseFillcheckApply __base = new BaseFillcheckApply();
		int count = 0;
		Object val;
