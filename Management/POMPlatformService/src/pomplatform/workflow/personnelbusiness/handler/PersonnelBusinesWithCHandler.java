...
public class PersonnelBusinesWithCHandler implements GenericDao {

	public final static ThreadLocal currentRequest = new ThreadLocal();

	private static final Logger __logger = Logger.getLogger(PersonnelBusinesWithCHandler.class);

	public static BasePersonnelBusinesWithC getPersonnelBusinesWithCById( java.lang.Integer personnel_business_id )
	{
		try{
			TimeSpanCalculator tsc = new TimeSpanCalculator();
			tsc.recordTime();
			BasePersonnelBusinesWithC result;
			...
			if(dao.load(true)){
				...
				tsc.recordTime();
				__logger.info(String.format("Get PersonnelBusinesWithC By ID time used : [%1$d]", tsc.getLastTime()));
				return result;
			}
			return null;
		} catch(Exception ex) {
	...
	public static boolean isPersonnelBusinesWithCExists( pomplatform.workflow.personnelbusiness.bean.BasePersonnelBusinesWithC bean, String additional ) {
		...
		try{
			...
			tsc.recordTime();
			__logger.info(String.format("Query PersonnelBusinesWithC List time used : [%1$d]", tsc.getLastTime()));
			return res;
		} catch(Exception ex) {
			ex.printStackTrace();
			return false;
	...
	public static int countPersonnelBusinesWithC( pomplatform.workflow.personnelbusiness.bean.BasePersonnelBusinesWithC bean, String additional ) {
	...
	public static BaseCollection<BasePersonnelBusinesWithC> queryPersonnelBusinesWithC( BasePersonnelBusinesWithC bean, int pageNo, int pageLines, String additionalCondition ) {
		...
		try{
			...
			List<BasePersonnelBusinesWithC> result = dao.conditionalLoadExt(additionalCondition);
			BaseCollection<BasePersonnelBusinesWithC> col = new BaseCollection<>();
	...
	public static BasePersonnelBusinesWithC addToPersonnelBusinesWithC ( BasePersonnelBusinesWithC personnelbusineswithc ) {
		return addToPersonnelBusinesWithC ( personnelbusineswithc , false);
	}

	public static BasePersonnelBusinesWithC addToPersonnelBusinesWithC ( BasePersonnelBusinesWithC personnelbusineswithc, boolean singleTransaction ) {
		try{
			TimeSpanCalculator tsc = new TimeSpanCalculator();
			tsc.recordTime();
			if(singleTransaction) ThreadConnection.beginTransaction();
			PersonnelBusinesWithC dao = new PersonnelBusinesWithC();
			dao.setDataFromBase(personnelbusineswithc);
			int result = dao.save();
			if(singleTransaction) ThreadConnection.commit();
			tsc.recordTime();
			__logger.info(String.format("Add to PersonnelBusinesWithC time used : [%1$d]", tsc.getLastTime()));
	...
	public static BasePersonnelBusinesWithC addUpdatePersonnelBusinesWithC ( BasePersonnelBusinesWithC personnelbusineswithc ) {
		return addUpdatePersonnelBusinesWithC ( personnelbusineswithc , false);
	}

	public static BasePersonnelBusinesWithC addUpdatePersonnelBusinesWithC ( BasePersonnelBusinesWithC personnelbusineswithc, boolean singleTransaction  ) {
		if(personnelbusineswithc.getPersonnelBusinessId() == null) return addToPersonnelBusinesWithC(personnelbusineswithc);
		try{
			TimeSpanCalculator tsc = new TimeSpanCalculator();
			tsc.recordTime();
			if(singleTransaction) ThreadConnection.beginTransaction();
	...
	public static BasePersonnelBusinesWithC deletePersonnelBusinesWithC ( BasePersonnelBusinesWithC bean ) {
		try{
			TimeSpanCalculator tsc = new TimeSpanCalculator();
			tsc.recordTime();
			PersonnelBusinesWithC dao = new PersonnelBusinesWithC();
			...
			tsc.recordTime();
			__logger.info(String.format("Delete PersonnelBusinesWithC time used : [%1$d]", tsc.getLastTime()));
	...
	public static BasePersonnelBusinesWithC updatePersonnelBusinesWithC ( BasePersonnelBusinesWithC personnelbusineswithc ) {
		try{
			TimeSpanCalculator tsc = new TimeSpanCalculator();
			tsc.recordTime();
			PersonnelBusinesWithC dao = new PersonnelBusinesWithC();
			dao.setPersonnelBusinessId( personnelbusineswithc.getPersonnelBusinessId() );
			int result = 0;
			if( dao.load() ) {
				dao.setDataFromBase(personnelbusineswithc);
				result = dao.update();
			...
			tsc.recordTime();
			__logger.info(String.format("Update PersonnelBusinesWithC time used : [%1$d]", tsc.getLastTime()));
			return result == 1 ? personnelbusineswithc : null ;
		} catch(Exception ex) {
			ex.printStackTrace();
			return null;
		}
	...
	public static BasePersonnelBusinesWithC updatePersonnelBusinesWithCDirect( BasePersonnelBusinesWithC personnelbusineswithc ) {
		try{
			TimeSpanCalculator tsc = new TimeSpanCalculator();
			tsc.recordTime();
			PersonnelBusinesWithC dao = new PersonnelBusinesWithC();
	...
	public static int setDeleteConditions(BasePersonnelBusinesWithC bean, PersonnelBusinesWithC dao){
		int count = 0;
	...
	public static int setConditions(BasePersonnelBusinesWithC bean, PersonnelBusinesWithC dao){
		int count = 0;
		if(bean.getPersonnelBusinessId() != null) {
			dao.setConditionPersonnelBusinessId("=", bean.getPersonnelBusinessId());
			count++;
	...
	public String findUsingKey(String json) throws Exception{
		BasePersonnelBusinesWithC bean = new BasePersonnelBusinesWithC();
	...
	public String find(String json, int currentPage, int pageSize, String addtion) throws Exception{
		BaseCollection<BasePersonnelBusinesWithC> rlist = new BaseCollection<>();
		BasePersonnelBusinesWithC bean = new BasePersonnelBusinesWithC();
		...
		List<BasePersonnelBusinesWithC> result = dao.conditionalLoadExt(addtion);
