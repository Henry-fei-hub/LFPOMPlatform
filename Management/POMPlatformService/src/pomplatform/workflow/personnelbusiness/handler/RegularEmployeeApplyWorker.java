...
public class RegularEmployeeApplyWorker implements GenericWorkflowProcessor {
	...
	public boolean computeExpression(String expression) throws Exception {
		...
		if(expression.contains("转正类型")){
			e.setValue("转正类型", null == bean.getType() ? "暂无" : (2 == bean.getType().intValue() ? "提前转正" : "按期转正"));
		}
