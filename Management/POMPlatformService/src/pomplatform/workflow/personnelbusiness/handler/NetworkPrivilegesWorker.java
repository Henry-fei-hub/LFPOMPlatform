...
public class NetworkPrivilegesWorker implements GenericWorkflowProcessor {
	...
	public BusinessAbstract startNewWorkflow(SystemProcessDefinition pd, Map params, int employeeId) throws Exception {
		...
		dataValidate(dao);
		dao.save();
		BusinessAbstract ba = new BusinessAbstract(dao.getPersonnelBusinessId(), "网络权限申请");
		return ba;
	}
