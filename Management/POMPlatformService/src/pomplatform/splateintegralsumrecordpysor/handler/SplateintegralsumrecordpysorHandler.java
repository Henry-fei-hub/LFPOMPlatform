...
public class SplateintegralsumrecordpysorHandler implements GenericQuery,  GenericDownloadProcessor {

	private static final Logger __logger = Logger.getLogger(SplateintegralsumrecordpysorHandler.class);

	public static BaseCollection<BaseSplateintegralsumrecordpysor> executeQuerySplateintegralsumrecordpysor(ConditionSplateintegralsumrecordpysor c, KeyValuePair[] replacements ) throws Exception {
		QuerySplateintegralsumrecordpysor dao = new QuerySplateintegralsumrecordpysor();
		dao.setCurrentPage(c.getCurrentPage());
		dao.setPageLines(c.getPageLines());
		BaseCollection<BaseSplateintegralsumrecordpysor> result = dao.executeQuery( c.getKeyValues(), c) ;
		return result;
	}
