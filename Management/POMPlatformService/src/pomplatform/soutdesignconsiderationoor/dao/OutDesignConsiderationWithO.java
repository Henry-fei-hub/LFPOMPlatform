package pomplatform.soutdesignconsiderationoor.dao;

import java.util.*;
import pomplatform.soutdesignconsiderationoor.bean.BaseOutDesignConsiderationWithO;
import com.pomplatform.db.bean.BaseOutDesignConsideration;
import com.pomplatform.db.dao.OutDesignConsideration;

public class OutDesignConsiderationWithO extends com.pomplatform.db.dao.OutDesignConsideration
{


	public OutDesignConsiderationWithO() throws java.sql.SQLException { initColumnNames(); }
	...
	public List<BaseOutDesignConsiderationWithO> conditionalLoadExt(String addtional) throws java.sql.SQLException {
		List<BaseOutDesignConsiderationWithO> result = BaseOutDesignConsiderationWithO.getBeanList(conditionalLoad(addtional));
		return result;
	}

	public BaseOutDesignConsiderationWithO generateBaseExt() {
		BaseOutDesignConsiderationWithO ____result = new BaseOutDesignConsiderationWithO();
		setDataToBase(____result);
		return ____result;
	}

	public void setDataFromBase(BaseOutDesignConsiderationWithO __base) {
		super.setDataFromBase(__base);
		setDetailOutDesignConsideration(__base.getDetailOutDesignConsideration());
	}

	public void setDataToBase(BaseOutDesignConsiderationWithO __base) {
