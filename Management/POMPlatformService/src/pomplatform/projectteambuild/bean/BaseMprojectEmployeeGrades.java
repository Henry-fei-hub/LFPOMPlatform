...
public class BaseMprojectEmployeeGrades extends GenericBase implements BaseFactory<BaseMprojectEmployeeGrades>, Comparable<BaseMprojectEmployeeGrades> 
{


	public static BaseMprojectEmployeeGrades newInstance(){
		return new BaseMprojectEmployeeGrades();
	}

	@Override
	public BaseMprojectEmployeeGrades make(){
		BaseMprojectEmployeeGrades b = new BaseMprojectEmployeeGrades();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "员工编码,员工编号,员工姓名,部门,等级,状态";
	...
	public void cloneCopy(BaseMprojectEmployeeGrades __bean){
	...
	public java.lang.String toCSVString() {
		...
		sb.append(",");
		String strGradeId = delicacy.system.executor.SelectValueCache.getSelectValue("", String.valueOf(getGradeId()));
	...
	@Override
	public int compareTo(BaseMprojectEmployeeGrades o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseMprojectEmployeeGrades o = (BaseMprojectEmployeeGrades)obj;
