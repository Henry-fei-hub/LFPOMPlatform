...
public class BaseSprojectteambuild extends GenericBase implements BaseFactory<BaseSprojectteambuild>, Comparable<BaseSprojectteambuild> 
{


	public static BaseSprojectteambuild newInstance(){
		return new BaseSprojectteambuild();
	}

	@Override
	public BaseSprojectteambuild make(){
		BaseSprojectteambuild b = new BaseSprojectteambuild();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "项目编码,合同编号,合同名称,客户名称,预估工时,归属部门,设计阶段,项目类型,项目编号,项目名称,项目计划开始日期,项目计划结束日期,项目开始日期,项目结束日期,项目状态,项目进度,项目负责人编码,项目负责人姓名,项目大小,项目积分,项目描述,预算,审核意见,项目等级,板块负责人,板块";
	...
	public void cloneCopy(BaseSprojectteambuild __bean){
	...
	@Override
	public int compareTo(BaseSprojectteambuild o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseSprojectteambuild o = (BaseSprojectteambuild)obj;
