...
public class BaseMcontractreceivablecipcor extends GenericBase implements BaseFactory<BaseMcontractreceivablecipcor>, Comparable<BaseMcontractreceivablecipcor> 
{


	public static BaseMcontractreceivablecipcor newInstance(){
		return new BaseMcontractreceivablecipcor();
	}

	@Override
	public BaseMcontractreceivablecipcor make(){
		BaseMcontractreceivablecipcor b = new BaseMcontractreceivablecipcor();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "合同阶段id,信息编号,项目编号,合同id,合同主编号,阶段名称,收款百分比,收款金额,是否已经被用做过确认函,收款阶段备注,收款阶段id的父节点,操作人,创建时间,修改时间,签约总金额";
	...
	public void cloneCopy(BaseMcontractreceivablecipcor __bean){
	...
	@Override
	public int compareTo(BaseMcontractreceivablecipcor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseMcontractreceivablecipcor o = (BaseMcontractreceivablecipcor)obj;
	...
	public Map<String, Object> toMap() {
		...
		if(getReceivableSumMoney() != null) res.put("receivableSumMoney", getReceivableSumMoney());
		if(getIsConfirmationLetter() != null) res.put("isConfirmationLetter", getIsConfirmationLetter());
