...
public class BaseScontractreceivablecipor extends GenericBase implements BaseFactory<BaseScontractreceivablecipor>, Comparable<BaseScontractreceivablecipor> 
{


	public static BaseScontractreceivablecipor newInstance(){
		return new BaseScontractreceivablecipor();
	}

	@Override
	public BaseScontractreceivablecipor make(){
		BaseScontractreceivablecipor b = new BaseScontractreceivablecipor();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "合同阶段id,信息编号,项目编号,合同id,合同主编号,阶段名称,阶段收款率(%),收款金额,是否已经被用做过确认函,收款阶段备注,收款阶段id的父节点";
	...
	public void cloneCopy(BaseScontractreceivablecipor __bean){
	...
	@Override
	public int compareTo(BaseScontractreceivablecipor o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseScontractreceivablecipor o = (BaseScontractreceivablecipor)obj;
