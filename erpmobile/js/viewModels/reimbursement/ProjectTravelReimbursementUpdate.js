define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'ojs/ojknockout', 'promise', 'ojs/ojselectcombobox', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource','ojs/ojarraytabledatasource'],
        function (oj, ko, $, dl) {
            function ProjectTravelReimbursementUpdateViewModel(params) {
                var self = this;
                ...
                //部门分摊费用
                self.detailTravelReimbursementLinkProject = ko.observableArray();
                //账单流水
                ...
                //部门分摊费用
                self.dataSource2 = new oj.ArrayTableDataSource(self.detailTravelReimbursementLinkProject, {idAttribute: 'travelReimbursementLinkProjectId'});
                ...
                self.datareceived = function (data) {
                    ...
                    self.detailTravelReimbursementLinkProject(arrData[0].detailTravelReimbursementLinkProject);

                    for (var i = 0; i < self.detailTravelReimbursementLinkProject.length; i++) {
                        detailTravelReimbursementLinkProject[i].projectId = [detailTravelReimbursementLinkProject[i].projectId.toString()];
                    }
                    //  某人的报销页面的标题以报销人+主题 
                ...
                self.getValues = function () {
                    ...
                    var detailTravelReimbursementLinkProject = [];
                    for (var i = 0; i < self.detailTravelReimbursementLinkProject().length; i++) {
                        detailTravelReimbursementLinkProject.push(dl.processInlineData(self.detailTravelReimbursementLinkProject()[i]));
                    }
                    ...
                    resultData[0].detailTravelReimbursementLinkProject = detailTravelReimbursementLinkProject;
                ...
                self.jinduClick = function (data, event) {
                    ...
                    dl.pushPageStack({name: 'reimbursement/ProjectTravelReimbursementUpdate', params: self.parentViewModel, cacheKey: 'reimbursement/ProjectTravelReimbursementUpdate'});
                ...
                self.handleAttached = function (info) {
                    ...
                    dl.callOperation("NQ_NewProjectTravelReimbursement", 'find', condition, self.datareceived);
            ...
            return ProjectTravelReimbursementUpdateViewModel;
        }
);
