define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'ojs/ojknockout', 'promise', 'ojs/ojselectcombobox', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource','ojs/ojarraytabledatasource'],
        function (oj, ko, $, dl) {
            function CommonTravelReimbursementUpdateViewModel(params) {
                var self = this;
                self.viewModelName = 'ProjectTravelReimbursementUpdateViewModel';
                ...
                //部门分摊费用
                self.detailTravelReimbursementLinkDepartment = ko.observableArray();
                //账单流水
                ...
                //部门分摊费用
                self.dataSource2 = new oj.ArrayTableDataSource(self.detailTravelReimbursementLinkDepartment, {idAttribute: 'travelReimbursementLinkDepartmentId'});
                ...
                self.datareceived = function (data) {
                    ...
                    self.detailTravelReimbursementLinkDepartment(arrData[0].detailTravelReimbursementLinkDepartment);

                    for (var i = 0; i < self.detailTravelReimbursementLinkDepartment.length; i++) {
                        detailTravelReimbursementLinkDepartment[i].projectId = [detailTravelReimbursementLinkDepartment[i].projectId.toString()];
                    }
                    //  某人的报销页面的标题以报销人+主题 
                ...
                self.getValues = function () {
                    ...
                    var detailTravelReimbursementLinkDepartment = [];
                    for (var i = 0; i < self.detailTravelReimbursementLinkDepartment().length; i++) {
                        detailTravelReimbursementLinkDepartment.push(dl.processInlineData(self.detailTravelReimbursementLinkDepartment()[i]));
                    }
                    ...
                    resultData[0].detailTravelReimbursementLinkDepartment = detailTravelReimbursementLinkDepartment;
                ...
                self.jinduClick = function (data, event) {
                    ...
                    dl.pushPageStack({name: 'reimbursement/CommonTravelReimbursementUpdate', params: self.parentViewModel, cacheKey: 'reimbursement/CommonTravelReimbursementUpdate'});
                ...
                self.handleAttached = function (info) {
                    ...
                    dl.callOperation("NQ_TravelReimbursementWithDepartment", 'find', condition, self.datareceived);
            ...
            return CommonTravelReimbursementUpdateViewModel;
        }
);
