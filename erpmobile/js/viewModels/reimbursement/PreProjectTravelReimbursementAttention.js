define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'ojs/ojknockout', 'promise', 'ojs/ojselectcombobox', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojarraytabledatasource'],
        function (oj, ko, $, dl) {
            function PreProjectTravelReimbursementAttentionViewModel(params) {
                var self = this;
                self.viewModelName = 'PreProjectTravelReimbursementAttentionViewModel';
                ...
                self.datareceived = function (data) {
                    ...
                    //费用分拆
                    self.dataSource2(new oj.ArrayTableDataSource(arrData[0].userData.detailTravelReimbursementLinkMainProject, {idAttribute: 'travelReimbursementLinkMainProjectId'}));
                    //  某人的报销页面的标题以报销人+主题 
...
//                进度按钮
                self.jinduClick = function (data, event) {
                    ...
                    dl.pushPageStack({name: 'reimbursement/PreProjectTravelReimbursementAttention', params: self.parentViewModel});
            ...
            return PreProjectTravelReimbursementAttentionViewModel;
        }
);
