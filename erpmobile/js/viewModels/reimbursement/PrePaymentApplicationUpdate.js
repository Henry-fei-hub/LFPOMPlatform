define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'ojs/ojknockout', 'promise', 'ojs/ojselectcombobox', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource','ojs/ojarraytabledatasource'],
        function (oj, ko, $, dl) {
            function PrePaymentApplicationUpdateViewModel(params) {
                var self = this;
                self.viewModelName = 'PrePaymentApplicationUpdateViewModel';
                ...
                self.dataSource = new oj.ArrayTableDataSource(self.resultData, {idAttribute: 'payMoneyManageId'});
                ...
                self.jinduClick = function (data, event) {
                    ...
                    dl.pushPageStack({name: 'reimbursement/PrePaymentApplicationUpdate', params: self.parentViewModel, cacheKey: 'reimbursement/PrePaymentApplicationUpdate'});
            ...
            return PrePaymentApplicationUpdateViewModel;
        }
);
