define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'ojs/ojknockout', 'promise', 'ojs/ojselectcombobox', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource','ojs/ojarraytabledatasource'],
        function (oj, ko, $, dl) {
            function PreProjectNormalReimbursementUpdateViewModel(params) {
                var self = this;
                self.viewModelName = 'PreProjectNormalReimbursementUpdateViewModel';
                ...
                //部门分摊费用
                self.detailNormalReimbursementLinkMainProject = ko.observableArray();
                //账单流水
                ...
                //部门分摊费用
                self.dataSource2 = new oj.ArrayTableDataSource(self.detailNormalReimbursementLinkMainProject, {idAttribute: 'normalReimbursementLinkMainProjectId'});
                ...
                self.datareceived = function (data) {
                    ...
                    self.detailNormalReimbursementLinkMainProject(arrData[0].detailNormalReimbursementLinkMainProject);

                    for (var i = 0; i < self.detailNormalReimbursementLinkMainProject.length; i++) {
                        detailNormalReimbursementLinkMainProject[i].projectId = [detailNormalReimbursementLinkMainProject[i].projectId.toString()];
                    }
                    self.specialHeaderTitle(dl.getLabelByValue('employees', arrData[0]['employeeId']) + arrData[0]['reimbursementName']);
                };
                ...
                self.getValues = function () {
                    ...
                    var detailNormalReimbursementLinkMainProject = [];
                    for (var i = 0; i < self.detailNormalReimbursementLinkMainProject().length; i++) {
                        detailNormalReimbursementLinkMainProject.push(dl.processInlineData(self.detailNormalReimbursementLinkMainProject()[i]));
                    }
                    ...
                    resultData[0].detailNormalReimbursementLinkMainProject = detailNormalReimbursementLinkMainProject;
                ...
                self.jinduClick = function (data, event) {
                    ...
                    dl.pushPageStack({name: 'reimbursement/PreProjectNormalReimbursementUpdate', params: self.parentViewModel, cacheKey: 'reimbursement/PreProjectNormalReimbursementUpdate'});
                ...
                self.handleAttached = function (info) {
                    ...
                    dl.callOperation("NQ_PreProjectNormalReimbursement", 'find', condition, self.datareceived);
            ...
            return PreProjectNormalReimbursementUpdateViewModel;
        }
);
