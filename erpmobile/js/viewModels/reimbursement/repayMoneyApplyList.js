...
define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl) {
            function repayMoneyApplyListViewModel(params) {
                var self = this;
                self.viewModelName = 'repayMoneyApplyListViewModel';
              ...
              //                放查询条件
                self.searchData = {
                        ...
                        status: 1 ,
                        keyValues:[{key:'spt.parent_process_type_id = 12', value:'spt.parent_process_type_id = 1'}]
                          };
                repayMoneyApplyListModel = oj.Model.extend({
                    parse: dl.parseModel,
                    idAttribute: 'processInstanceActivityId'
                });

                repayMoneyApplyListCollection = oj.Collection.extend({
                    model: new repayMoneyApplyListModel(),
                ...
                self.collection = new repayMoneyApplyListCollection();
            ...
            return repayMoneyApplyListViewModel;
        }
);
