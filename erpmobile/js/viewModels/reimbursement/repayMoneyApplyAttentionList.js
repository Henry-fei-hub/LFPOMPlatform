define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient','dl/msgbox', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl ,sc) {
            function repayMoneyApplyAttentionListViewModel(params) {
                var self = this;
                self.viewModelName = 'repayMoneyApplyAttentionListViewModel';
...
//                一键标记已读的回调函数
                ...
                self.commonClick = function (data, event) {
                   ...
                   pageName = dl.getProcessPageName(processType, !dl.isNullOrUndefined(self.pageFlag) && self.pageFlag === 2 ? 2 : 4);
                    ...
                    dl.pushPageStack({name: 'reimbursement/repayMoneyApplyAttentionList', params: self.parentViewModel});
                ...
                repayMoneyApplyAttentionListModel = oj.Model.extend({
                    parse: dl.parseModel,
                    idAttribute: 'systemProcessAttentionId'
                });

               repayMoneyApplyAttentionListCollection = oj.Collection.extend({
                    model: new repayMoneyApplyAttentionListModel(),
                ...
                self.collection = new repayMoneyApplyAttentionListCollection();
            ...
            return repayMoneyApplyAttentionListViewModel;
        }
);
