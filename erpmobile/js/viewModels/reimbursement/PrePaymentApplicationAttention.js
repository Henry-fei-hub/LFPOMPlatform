define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'ojs/ojknockout', 'promise', 'ojs/ojselectcombobox', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource','ojs/ojarraytabledatasource'],
        function (oj, ko, $, dl) {
            function PrePaymentApplicationAttentionViewModel(params) {
                var self = this;
                self.viewModelName = 'PrePaymentApplicationAttentionViewModel';
                ...
                self.datareceived = function (data) {
                    ...
                    self.dataSource(new oj.ArrayTableDataSource(arrData, {idAttribute: 'payMoneyManageId'}));
                    //  某人的报销页面的标题以报销人+主题 
                    self.specialHeaderTitle(dl.getLabelByValue('employees', arrData[0]['emploeeId']) + arrData[0]['titleName']);
//                    进入即阅
...
//                进度按钮
                self.jinduClick = function (data, event) {
                    ...
                    dl.pushPageStack({name: 'reimbursement/PrePaymentApplicationAttention', params: self.parentViewModel, cacheKey: 'reimbursement/PrePaymentApplicationAttention'});
                ...
                self.handleAttached = function (info) {
                    var condition = {
                        payMoneyManageId: params.rowData.businessId
                    };
                    dl.callOperation("ST_PayMoneyManage", 'find', condition, self.datareceived);
            ...
            return PrePaymentApplicationAttentionViewModel;
        }
);
