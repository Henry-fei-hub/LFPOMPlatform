define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'ojs/ojknockout', 'promise', 'ojs/ojselectcombobox', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource','ojs/ojarraytabledatasource'],
        function (oj, ko, $, dl) {
            function NormalReimbursementWithProjectAttentionViewModel(params) {
                var self = this;
                self.viewModelName = 'NormalReimbursementWithProjectAttentionViewModel';
                ...
                self.datareceived = function (data) {
                   var arr = [];
                    ...
                    //部门分摊费用
                    self.dataSource2(new oj.ArrayTableDataSource(arrData[0].userData.detailNormalReimbursementLinkProject, {idAttribute: 'normalReimbursementLinkProjectId'}));
                    //  某人的报销页面的标题以报销人+主题 
...
//                进度按钮
                self.jinduClick = function (data, event) {
                    ...
                    dl.pushPageStack({name: 'reimbursement/NormalReimbursementWithProjectAttention', params: self.parentViewModel, cacheKey: 'reimbursement/NormalReimbursementWithProjectAttention'});
            ...
            return NormalReimbursementWithProjectAttentionViewModel;
        }
);
