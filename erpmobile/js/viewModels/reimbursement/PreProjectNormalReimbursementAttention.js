define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'ojs/ojknockout', 'promise', 'ojs/ojselectcombobox', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource','ojs/ojarraytabledatasource'],
        function (oj, ko, $, dl) {
            function PreProjectNormalReimbursementAttentionViewModel(params) {
                var self = this;
                self.viewModelName = 'PreProjectNormalReimbursementAttentionViewModel';
...
//                进度按钮
                self.jinduClick = function (data, event) {
                    ...
                    dl.pushPageStack({name: 'reimbursement/PreProjectNormalReimbursementAttention', params: self.parentViewModel, cacheKey: 'reimbursement/PreProjectNormalReimbursementAttention'});
            ...
            return PreProjectNormalReimbursementAttentionViewModel;
        }
);
