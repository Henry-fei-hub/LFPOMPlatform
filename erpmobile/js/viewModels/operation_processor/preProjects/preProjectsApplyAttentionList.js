define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient','dl/msgbox', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource','ojs/ojarraytabledatasource'],
        function (oj, ko, $, dl, sc) {
            function preProjectsApplyAttentionListViewModel(params) {
                var self = this;
                self.viewModelName = 'preProjectsApplyAttentionListViewModel';
                ...
                self.commonClick = function (event, selfData) {
                    ...
                    dl.pushPageStack({name: 'operation_processor/preProjects/preProjectsApplyAttentionList', params: self.parentViewModel, cacheKey:  'operation_processor/preProjects/preProjectsApplyAttentionList'});
...
//                一键标记已读的回调函数
            ...
            return preProjectsApplyAttentionListViewModel;
        }
);
