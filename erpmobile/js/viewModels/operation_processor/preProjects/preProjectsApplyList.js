...
define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl) {
            function preProjectsApplyListViewModel(params) {
                var self = this;
                self.viewModelName = 'preProjectsApplyListViewModel';
              ...
              //                放查询条件
                ...
                preProjectsApplyListModel = oj.Model.extend({
                    parse: dl.parseModel,
                    idAttribute: 'processInstanceActivityId'
                });

                preProjectsApplyListCollection = oj.Collection.extend({
                    model: new preProjectsApplyListModel(),
                ...
                self.collection = new preProjectsApplyListCollection();
            ...
            return preProjectsApplyListViewModel;
        }
);
