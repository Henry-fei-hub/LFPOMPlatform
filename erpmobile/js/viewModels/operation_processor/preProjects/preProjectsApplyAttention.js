define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojselectcombobox', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource','ojs/ojarraytabledatasource'],
        function (oj, ko, $, dl) {
            function preProjectApplyAttentionViewModel(params) {
                var self = this;
                self.viewModelName = 'preProjectApplyAttentionViewModel';
...
//                    进入即阅
                ...
                self.jinduClick = function (data, event) {
                    ...
                    dl.pushPageStack({name: 'operation_processor/preProjects/preProjectsApplyAttention', params: self.parentViewModel, cacheKey: 'operation_processor/preProjects/preProjectsApplyAttention'});
            ...
            return preProjectApplyAttentionViewModel;
        }
);
