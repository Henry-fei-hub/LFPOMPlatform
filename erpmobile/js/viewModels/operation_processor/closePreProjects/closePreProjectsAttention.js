define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojselectcombobox', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource','ojs/ojarraytabledatasource'],
        function (oj, ko, $, dl) {
            function closePreProjectsAttentionViewModel(params) {
                var self = this;
                self.viewModelName = 'closePreProjectsAttentionViewModel';
...
//                    进入即阅
                ...
                self.jinduClick = function (data, event) {
                    ...
                    dl.pushPageStack({name: 'operation_processor/closePreProjects/closePreProjectsAttention', params: self.parentViewModel, cacheKey: 'operation_processor/closePreProjects/closePreProjectsAttention'});
            ...
            return closePreProjectsAttentionViewModel;
        }
);
