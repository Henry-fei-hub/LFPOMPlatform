...
define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist', 'ojs/ojlistview',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl) {
            function costAdjustmentApplyListViewModel(params) {
                var self = this;
                self.viewModelName = 'costAdjustmentApplyListViewModel';
              ...
              //                放查询条件
                ...
                costAdjustmentApplyListModel = oj.Model.extend({
                    parse: dl.parseModel,
                    idAttribute: 'resetCostId'
                });

                costAdjustmentApplyListCollection = oj.Collection.extend({
                    model: new costAdjustmentApplyListModel(),
                ...
                self.collection = new costAdjustmentApplyListCollection();
            ...
            return costAdjustmentApplyListViewModel;
        }
);
