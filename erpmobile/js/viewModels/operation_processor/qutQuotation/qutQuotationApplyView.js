define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/msgbox', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojselectcombobox', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojarraytabledatasource'],
        function (oj, ko, $, dl, sc) {
            function qutQuotationApplyViewViewModel(params) {
                var self = this;
                self.viewModelName = 'qutQuotationApplyViewViewModel';
                ...
                self.processbillListData1 = null;
                ...
                self.datareceived2 = function (data) {
                    var arrData = dl.parseCollection(data);
                    self.processbillListData1 = arrData;
                ...
                self.getValues = function () {
                    ...
                    userData[0].detailOutDesignConsideration = self.processbillListData;
                    userData[0].detailMainProjectBusinessType = self.processbillListData1;
                    return userData[0];
                };
...
//                进度按钮
                self.jinduClick = function (data, event) {
                    ...
                    dl.getGlobalModule({name: 'schedule', params: self});
                    dl.pushPageStack({name: 'operation_processor/qutQuotation/qutQuotationApplyView', params: self.parentViewModel});
            ...
            return qutQuotationApplyViewViewModel;
        }
);
