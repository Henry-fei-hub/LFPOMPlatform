define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/msgbox', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojselectcombobox', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojarraytabledatasource'],
        function (oj, ko, $, dl, sc) {
            function projectStagesProcessApplyViewViewModel(params) {
                var self = this;
                self.viewModelName = 'projectStagesProcessApplyViewViewModel';
                ...
                self.datareceived = function (data) {
                    ...
                    //  某人的报销页面的标题以报销人+主题 
                    self.specialHeaderTitle(arrData[0]['projectName']);
                };
                ...
                self.getValues = function () {
                    ...
                    userData[0].detailProjectStageProcessDetail = self.processbillListData;
                    return userData[0];
                };
...
//                进度按钮
                self.jinduClick = function (data, event) {
                    ...
                    dl.getGlobalModule({name: 'schedule', params: self});
                    dl.pushPageStack({name: 'operation_processor/projectStagesProcess/projectStagesProcessApplyView', params: self.parentViewModel});
            ...
            return projectStagesProcessApplyViewViewModel;
        }
);
