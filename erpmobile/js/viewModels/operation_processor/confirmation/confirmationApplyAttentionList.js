...
define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient','dl/msgbox',  'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl,sc) {
            function confirmationApplyAttentionListViewModel(params) {
                var self = this;
                self.viewModelName = 'confirmationApplyAttentionListViewModel';
...
//                一键标记已读的回调函数
                ...
                self.commonClick = function (data, event) {
                    ...
                    dl.pushPageStack({name: 'operation_processor/confirmation/confirmationApplyAttentionList', params: self.parentViewModel});
                ...
                confirmationApplyAttentionListModel = oj.Model.extend({
                    parse: dl.parseModel,
                    idAttribute: 'systemProcessAttentionId'
                });

               confirmationApplyAttentionListCollection = oj.Collection.extend({
                    model: new confirmationApplyAttentionListModel(),
                ...
                self.collection = new confirmationApplyAttentionListCollection();
            ...
            return confirmationApplyAttentionListViewModel;
        }
);
