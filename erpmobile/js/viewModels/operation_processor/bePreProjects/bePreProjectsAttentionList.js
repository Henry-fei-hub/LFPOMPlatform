define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient','dl/msgbox', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource','ojs/ojarraytabledatasource'],
        function (oj, ko, $, dl, sc) {
            function bePreProjectsAttentionListViewModel(params) {
                var self = this;
                self.viewModelName = 'bePreProjectsAttentionListViewModel';
                ...
                self.commonClick = function (event, selfData) {
                    ...
                    dl.pushPageStack({name: 'operation_processor/bePreProjects/bePreProjectsAttentionList', params: self.parentViewModel, cacheKey:  'operation_processor/bePreProjects/bePreProjectsAttentionList'});
...
//                一键标记已读的回调函数
            ...
            return bePreProjectsAttentionListViewModel;
        }
);
