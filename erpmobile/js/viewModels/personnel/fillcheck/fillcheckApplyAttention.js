define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojselectcombobox', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource','ojs/ojarraytabledatasource'],
        function (oj, ko, $, dl) {
            function fillcheckApplyAttentionViewModel(params) {
                var self = this;
                self.viewModelName = 'fillcheckApplyAttentionViewModel';
...
//                    进入即阅
                ...
                self.jinduClick = function (data, event) {
                    ...
                    dl.pushPageStack({name: 'personnel/fillcheck/fillcheckApplyAttention', params: self.parentViewModel, cacheKey: 'personnel/fillcheck/fillcheckApplyAttention'});
            ...
            return fillcheckApplyAttentionViewModel;
        }
);
