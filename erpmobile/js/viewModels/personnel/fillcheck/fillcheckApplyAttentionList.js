...
define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient','dl/msgbox', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl,sc) {
            function fillcheckApplyAttentionListViewModel(params) {
                var self = this;
                self.viewModelName = 'fillcheckApplyAttentionListViewModel';
...
//                一键标记已读的回调函数
                ...
                self.commonClick = function (data,event) {
                    ...
                    dl.pushPageStack({name: 'personnel/fillcheck/fillcheckApplyAttentionList', params: self.parentViewModel});
                ...
                fillcheckApplyAttentionListModel = oj.Model.extend({
                         parse: dl.parseModel,
                        idAttribute: 'businessId'
                });
               fillcheckApplyAttentionListCollection = oj.Collection.extend({
                        model: new fillcheckApplyAttentionListModel(),
                ...
                self.collection = new fillcheckApplyAttentionListCollection();
            ...
            return fillcheckApplyAttentionListViewModel;
        }
);
