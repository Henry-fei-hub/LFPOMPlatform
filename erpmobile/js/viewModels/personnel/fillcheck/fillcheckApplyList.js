...
define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl) {
            ...
            function fillcheckApplyListViewModel(params) {
                var self = this;
                self.viewModelName = 'fillcheckApplyListViewModel';
                ...
                fillcheckApplyListModel = oj.Model.extend({
                    parse: dl.parseModel,
                    idAttribute: 'processInstanceActivityId'
                });

                fillcheckApplyListCollection = oj.Collection.extend({
                    model: new fillcheckApplyListModel(),
                ...
                self.collection = new fillcheckApplyListCollection();
            ...
            return fillcheckApplyListViewModel;
        }
);
