define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojselectcombobox', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource','ojs/ojarraytabledatasource'],
        function (oj, ko, $, dl) {
            function projectAccreditApplyAttentionViewModel(params) {
                var self = this;
                self.viewModelName = 'projectAccreditApplyAttentionViewModel';
...
//                    进入即阅
                ...
                self.jinduClick = function (data, event) {
                    ...
                    dl.pushPageStack({name: 'personnel/projectAccredit/projectAccreditApplyAttention', params: self.parentViewModel, cacheKey: 'personnel/projectAccredit/projectAccreditApplyAttention'});
            ...
            return projectAccreditApplyAttentionViewModel;
        }
);
