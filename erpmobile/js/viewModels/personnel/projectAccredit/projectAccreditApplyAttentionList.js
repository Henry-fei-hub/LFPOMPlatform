...
define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/msgbox','dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl,sc) {
            function projectAccreditApplyAttentionListViewModel(params) {
                var self = this;
                self.viewModelName = 'projectAccreditApplyAttentionListViewModel';
...
//                一键标记已读的回调函数
                ...
                self.commonClick = function (data,event) {
                    ...
                    dl.pushPageStack({name: "personnel/projectAccredit/projectAccreditApplyAttentionList", params: self.parentViewModel});
                ...
                projectAccreditApplyAttentionListModel = oj.Model.extend({
                    parse: dl.parseModel,
                    idAttribute: 'systemProcessAttentionId'
                });

               projectAccreditApplyAttentionListCollection = oj.Collection.extend({
                    model: new projectAccreditApplyAttentionListModel(),
                ...
                self.collection = new projectAccreditApplyAttentionListCollection();
            ...
            return projectAccreditApplyAttentionListViewModel;
        }
);
