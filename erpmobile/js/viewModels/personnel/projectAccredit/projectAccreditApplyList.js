...
define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl) {
            function projectAccreditApplyListViewModel(params) {
                var self = this;
                self.viewModelName = 'projectAccreditApplyListViewModel';
              ...
              //                放查询条件
                ...
                projectAccreditApplyListModel = oj.Model.extend({
                    parse: dl.parseModel,
                    idAttribute: 'processInstanceActivityId'
                });

                projectAccreditApplyListCollection = oj.Collection.extend({
                    model: new projectAccreditApplyListModel(),
                ...
                self.collection = new projectAccreditApplyListCollection();
            ...
            return projectAccreditApplyListViewModel;
        }
);
