...
define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist', 'ojs/ojlistview',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl) {
            function leaveApplyListViewModel(params) {
                var self = this;
                self.viewModelName = 'leaveApplyListViewModel';
                ...
                self.commonClick = function (event, selfData) {
                    ...
                    dl.headerTitle(dl.getLabelByValue('employees', d.employeeId) + dl.getLabelByValue('leave_types', d.type));
                };
              ...
              //                放查询条件
                ...
                leaveApplyListModel = oj.Model.extend({
                    parse: dl.parseModel,
                    idAttribute: 'processInstanceActivityId'
                });

                leaveApplyListCollection = oj.Collection.extend({
                    model: new leaveApplyListModel(),
                ...
                self.collection = new leaveApplyListCollection();
            ...
            return leaveApplyListViewModel;
        }
);
