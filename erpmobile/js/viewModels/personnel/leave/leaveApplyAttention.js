define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'ojs/ojknockout', 'promise', 'ojs/ojselectcombobox', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource','ojs/ojarraytabledatasource'],
        function (oj, ko, $, dl) {
            function leaveApplyAttentionViewModel(params) {
                var self = this;
                self.viewModelName = 'leaveApplyAttentionViewModel';
...
//                    进入即阅
                ...
                self.jinduClick = function (data, event) {
                    ...
                    dl.pushPageStack({name: 'personnel/leave/leaveApplyAttention', params: self.parentViewModel, cacheKey: 'personnel/leave/leaveApplyAttention'});
            ...
            return leaveApplyAttentionViewModel;
        }
);
