...
define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl) {
            ...
            function workTimeApplyListViewModel(params) {
                var self = this;
                self.viewModelName = 'workTimeApplyListViewModel';
                ...
                workTimeApplyListModel = oj.Model.extend({
                    parse: dl.parseModel,
                    idAttribute: 'processInstanceActivityId'
                });

                workTimeApplyListCollection = oj.Collection.extend({
                    model: new workTimeApplyListModel(),
                ...
                self.collection = new workTimeApplyListCollection();
            ...
            return workTimeApplyListViewModel;
        }
);
