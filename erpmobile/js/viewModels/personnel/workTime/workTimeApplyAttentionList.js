...
define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient','dl/msgbox', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl,sc) {
            function workTimeApplyAttentionListViewModel(params) {
                var self = this;
                self.viewModelName = 'workTimeApplyAttentionListViewModel';
...
//                一键标记已读的回调函数
                ...
                self.commonClick = function (data,event) {
                    ...
                    dl.pushPageStack({name: 'personnel/workTime/workTimeApplyAttentionList', params: self.parentViewModel});
                ...
                workTimeApplyAttentionListModel = oj.Model.extend({
                         parse: dl.parseModel,
                        idAttribute: 'businessId'
                });
               workTimeApplyAttentionListCollection = oj.Collection.extend({
                        model: new workTimeApplyAttentionListModel(),
                ...
                self.collection = new workTimeApplyAttentionListCollection();
            ...
            return workTimeApplyAttentionListViewModel;
        }
);
