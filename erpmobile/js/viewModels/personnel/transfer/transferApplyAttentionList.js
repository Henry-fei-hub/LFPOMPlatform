...
define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient','dl/msgbox',  'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl,sc) {
            function transferApplyAttentionListViewModel(params) {
                var self = this;
                self.viewModelName = 'transferApplyAttentionListViewModel';
...
//                一键标记已读的回调函数
                ...
                self.commonClick = function (data, event) {
                    ...
                    dl.pushPageStack({name: 'personnel/transfer/transferApplyAttentionList', params: self.parentViewModel});
                ...
                transferApplyAttentionListModel = oj.Model.extend({
                    parse: dl.parseModel,
                    idAttribute: 'systemProcessAttentionId'
                });

               transferApplyAttentionListCollection = oj.Collection.extend({
                    model: new transferApplyAttentionListModel(),
                ...
                self.collection = new transferApplyAttentionListCollection();
            ...
            return transferApplyAttentionListViewModel;
        }
);
