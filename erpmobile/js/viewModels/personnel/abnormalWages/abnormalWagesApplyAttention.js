define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojselectcombobox', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource','ojs/ojarraytabledatasource'],
        function (oj, ko, $, dl) {
            function abnormalWagesApplyAttentionViewModel(params) {
                var self = this;
                self.viewModelName = 'abnormalWagesApplyAttentionViewModel';
...
//                    进入即阅
                ...
                self.jinduClick = function (data, event) {
                    ...
                    dl.pushPageStack({name: 'personnel/abnormalWages/abnormalWagesApplyAttention', params: self.parentViewModel, cacheKey: 'personnel/abnormalWages/abnormalWagesApplyAttention'});
                ...
                self.handleAttached = function (info) {
                    ...
                    dl.callOperation("NQ_OnSalaryExceptions", 'find', condition, self.datareceived);
                };
            ...
            return abnormalWagesApplyAttentionViewModel;
        }
);
