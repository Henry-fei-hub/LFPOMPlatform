...
define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient','dl/msgbox', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl, sc) {
            function overtimeApplyAttentionListViewModel(params) {
                var self = this;
                self.viewModelName = 'overtimeApplyAttentionListViewModel';
...
//                一键标记已读的回调函数
                ...
                self.commonClick = function (data, event) {
                    ...
                    dl.pushPageStack({name: "personnel/overtime/overtimeApplyAttentionList", params: self.parentViewModel});
                ...
                overtimeApplyAttentionListModel = oj.Model.extend({
                    parse: dl.parseModel,
                    idAttribute: 'systemProcessAttentionId'
                });

                overtimeApplyAttentionListCollection = oj.Collection.extend({
                    model: new overtimeApplyAttentionListModel(),
                ...
                self.collection = new overtimeApplyAttentionListCollection();
            ...
            return overtimeApplyAttentionListViewModel;
        }
);
