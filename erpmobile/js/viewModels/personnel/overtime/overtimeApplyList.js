...
define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl) {
            function overtimeApplyListViewModel(params) {
                var self = this;
                self.viewModelName = 'overtimeApplyListViewModel';
              ...
              //                放查询条件
                ...
                overtimeApplyListModel = oj.Model.extend({
                    parse: dl.parseModel,
                    idAttribute: 'processInstanceActivityId'
                });

                overtimeApplyListCollection = oj.Collection.extend({
                    model: new overtimeApplyListModel(),
                ...
                self.collection = new overtimeApplyListCollection();
            ...
            return overtimeApplyListViewModel;
        }
);
