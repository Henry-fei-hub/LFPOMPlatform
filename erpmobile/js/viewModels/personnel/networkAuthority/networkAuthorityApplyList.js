...
define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl) {
            function networkAuthorityApplyListViewModel(params) {
                var self = this;
                self.viewModelName = 'networkAuthorityApplyListViewModel';
                ...
                self.searchData = {
                    ...
                    keyValues: [{key: 'spt.parent_process_type_id = 12', value: 'spt.parent_process_type_id = 32'}],
                    status:1
                };
                networkAuthorityApplyListModel = oj.Model.extend({
                    parse: dl.parseModel,
                    idAttribute: 'processInstanceActivityId'
                });

                networkAuthorityApplyListCollection = oj.Collection.extend({
                    model: new networkAuthorityApplyListModel(),
                ...
                self.collection = new networkAuthorityApplyListCollection();
            ...
            return networkAuthorityApplyListViewModel;
        }
);
