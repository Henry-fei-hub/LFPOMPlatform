define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojselectcombobox', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource','ojs/ojarraytabledatasource'],
        function (oj, ko, $, dl) {
            function networkAuthorityApplyAttentionViewModel(params) {
                var self = this;
                self.viewModelName = 'networkAuthorityApplyAttentionViewModel';
...
//                    进入即阅
                ...
                self.jinduClick = function (data, event) {
                    ...
                    dl.pushPageStack({name: 'personnel/networkAuthority/networkAuthorityApplyAttention', params: self.parentViewModel, cacheKey: 'personnel/networkAuthority/networkAuthorityApplyAttention'});
            ...
            return networkAuthorityApplyAttentionViewModel;
        }
);
