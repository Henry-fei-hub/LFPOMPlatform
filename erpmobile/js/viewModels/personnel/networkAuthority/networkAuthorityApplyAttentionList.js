...
define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient','dl/msgbox', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl ,sc) {
            function networkAuthorityApplyAttentionListViewModel(params) {
                var self = this;
                self.viewModelName = 'networkAuthorityApplyAttentionListViewModel';
...
//                一键标记已读的回调函数
                ...
                self.commonClick = function (event, selfData) {
                    ...
                    dl.pushPageStack({name: 'personnel/networkAuthority/networkAuthorityApplyAttentionList', params: self.parentViewModel});
                ...
                networkAuthorityApplyAttentionListModel = oj.Model.extend({
                    parse: dl.parseModel,
                    idAttribute: 'systemProcessAttentionId'
                });

               networkAuthorityApplyAttentionListCollection = oj.Collection.extend({
                    model: new networkAuthorityApplyAttentionListModel(),
                ...
                self.collection = new networkAuthorityApplyAttentionListCollection();
            ...
            return networkAuthorityApplyAttentionListViewModel;
        }
);
