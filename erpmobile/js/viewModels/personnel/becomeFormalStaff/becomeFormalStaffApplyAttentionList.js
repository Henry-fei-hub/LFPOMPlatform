...
define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient','dl/msgbox', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl,sc) {
            function becomeFormalStaffApplyAttentionListViewModel(params) {
                var self = this;
                self.viewModelName = 'becomeFormalStaffApplyAttentionListViewModel';
...
//                  pageFlag 待知会 空， 已阅2
                ...
                self.commonClick = function (data, event) {
                    ...
                    dl.pushPageStack({name: 'personnel/becomeFormalStaff/becomeFormalStaffApplyAttentionList', params: self.parentViewModel});
...
//                一键标记已读的回调函数
                ...
                becomeFormalStaffApplyAttentionListModel = oj.Model.extend({
                    parse: dl.parseModel,
                    idAttribute: 'systemProcessAttentionId'
                });

               becomeFormalStaffApplyAttentionListCollection = oj.Collection.extend({
                    model: new becomeFormalStaffApplyAttentionListModel(),
                ...
                self.collection = new becomeFormalStaffApplyAttentionListCollection();
            ...
            return becomeFormalStaffApplyAttentionListViewModel;
        }
);
