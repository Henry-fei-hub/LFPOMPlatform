define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'ojs/ojknockout', 'promise', 'ojs/ojselectcombobox', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource','ojs/ojarraytabledatasource'],
        function (oj, ko, $, dl) {
            function becomeFormalStaffApplyAttentionViewModel(params) {
                var self = this;
                self.viewModelName = 'becomeFormalStaffApplyAttentionViewModel';
...
//                    进入即阅
                ...
                self.jinduClick = function (data, event) {
                    ...
                    dl.pushPageStack({name: 'personnel/becomeFormalStaff/becomeFormalStaffApplyAttention', params: self.parentViewModel, cacheKey: 'personnel/becomeFormalStaff/becomeFormalStaffApplyAttention'});
            ...
            return becomeFormalStaffApplyAttentionViewModel;
        }
);
