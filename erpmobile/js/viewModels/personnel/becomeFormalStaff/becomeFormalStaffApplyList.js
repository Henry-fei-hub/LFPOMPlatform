...
define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl) {
            ...
            function becomeFormalStaffApplyListViewModel(params) {
                var self = this;
                self.viewModelName = 'becomeFormalStaffApplyListViewModel';
                ...
                self.commonClick = function (event, selfData) {
                    ...
                    dl.headerTitle(dl.getLabelByValue('employees', d.employeeId) + dl.dateViewConverter.format(dl.parseValueFromService(d.endDate)));
                };
              ...
              //                放查询条件
                ...
                becomeFormalStaffApplyListModel = oj.Model.extend({
                    parse: dl.parseModel,
                    idAttribute: 'processInstanceActivityId'
                });

                becomeFormalStaffApplyListCollection = oj.Collection.extend({
                    model: new becomeFormalStaffApplyListModel(),
                ...
                self.collection = new becomeFormalStaffApplyListCollection();
            ...
            return becomeFormalStaffApplyListViewModel;
        }
);
