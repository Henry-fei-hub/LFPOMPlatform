...
define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl) {
            ...
            function travelApplyListViewModel(params) {
                var self = this;
                self.viewModelName = 'travelApplyListViewModel';
              ...
              //                放查询条件
                ...
                travelApplyListModel = oj.Model.extend({
                    parse: dl.parseModel,
                    idAttribute: 'processInstanceActivityId'
                });

                travelApplyListCollection = oj.Collection.extend({
                    model: new travelApplyListModel(),
                ...
                self.collection = new travelApplyListCollection();
            ...
            return travelApplyListViewModel;
        }
);
