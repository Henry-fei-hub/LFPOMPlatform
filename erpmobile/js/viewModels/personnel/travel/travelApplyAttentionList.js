...
define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient','dl/msgbox', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl ,sc) {
            function travelApplyAttentionListViewModel(params) {
                var self = this;
                self.viewModelName = 'travelApplyAttentionListViewModel';
...
//                一键标记已读的回调函数
                ...
                self.commonClick = function (data, event) {
                    ...
                    dl.pushPageStack({name: 'personnel/travel/travelApplyAttentionList', params: self.parentViewModel});
                ...
                travelApplyAttentionListModel = oj.Model.extend({
                    parse: dl.parseModel,
                    idAttribute: 'systemProcessAttentionId'
                });

                travelApplyAttentionListCollection = oj.Collection.extend({
                    model: new travelApplyAttentionListModel(),
                ...
                self.collection = new travelApplyAttentionListCollection();
            ...
            return travelApplyAttentionListViewModel;
        }
);
