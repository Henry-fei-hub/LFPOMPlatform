define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojselectcombobox', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource','ojs/ojarraytabledatasource'],
        function (oj, ko, $, dl) {
            function travelApplyAttentionViewModel(params) {
                var self = this;
                self.viewModelName = 'travelApplyAttentionViewModel';
...
//                    进入即阅
                ...
                self.jinduClick = function (data, event) {
                    ...
                    dl.pushPageStack({name: 'personnel/travel/travelApplyAttention', params: self.parentViewModel, cacheKey: 'personnel/travel/travelApplyAttention'});
            ...
            return travelApplyAttentionViewModel;
        }
);
