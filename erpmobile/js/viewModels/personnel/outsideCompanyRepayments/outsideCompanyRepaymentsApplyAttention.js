define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojselectcombobox', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojarraytabledatasource'],
        function (oj, ko, $, dl) {
            function outsideCompanyRepaymentsApplyAttentionViewModel(params) {
                var self = this;
                self.viewModelName = 'outsideCompanyRepaymentsApplyAttentionViewModel';
...
//                    进入即阅
                ...
                self.jinduClick = function (data, event) {
                    ...
                    dl.pushPageStack({name: 'personnel/outsideCompanyRepayments/outsideCompanyRepaymentsApplyAttention', params: self.parentViewModel, cacheKey: 'personnel/outsideCompanyRepayments/outsideCompanyRepaymentsApplyAttention'});
            ...
            return outsideCompanyRepaymentsApplyAttentionViewModel;
        }
);
