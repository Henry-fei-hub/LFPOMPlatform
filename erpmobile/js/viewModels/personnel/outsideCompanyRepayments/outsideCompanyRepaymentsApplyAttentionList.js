define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient','dl/msgbox', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource','ojs/ojarraytabledatasource'],
        function (oj, ko, $, dl, sc) {
            function outsideCompanyRepaymentsApplyAttentionListViewModel(params) {
                var self = this;
                self.viewModelName = 'outsideCompanyRepaymentsApplyAttentionListViewModel';
...
//                一键标记已读的回调函数
                ...
                self.commonClick = function (event, selfData) {
                    ...
                    dl.pushPageStack({name: 'personnel/outsideCompanyRepayments/outsideCompanyRepaymentsApplyAttentionList', params: self.parentViewModel});
            ...
            return outsideCompanyRepaymentsApplyAttentionListViewModel;
        }
);
