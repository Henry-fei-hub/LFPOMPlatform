define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource','ojs/ojarraytabledatasource'],
        function (oj, ko, $, dl) {
            function outsideCompanyRepaymentsApplyListViewModel(params) {
                var self = this;
                self.viewModelName = 'outsideCompanyRepaymentsApplyListViewModel';
                ...
                self.commonClick = function (event, selfData) {
                    ...
                    dl.pushPageStack({name: 'personnel/outsideCompanyRepayments/outsideCompanyRepaymentsApplyList', params: self.parentViewModel});
                    dl.getGlobalModule({name: pageName, params: self});
                    dl.pushHeader(dl.headerTitle());
                    dl.headerTitle(dl.getLabelByValue('employees', d.employeeId) + '('+dl.currencyConverter.format(d.fee).slice(2)+')');
                };
            ...
            return outsideCompanyRepaymentsApplyListViewModel;
        }
);
