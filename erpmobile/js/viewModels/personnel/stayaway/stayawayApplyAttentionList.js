...
define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/msgbox', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl,sc) {
            function stayawayApplyAttentionListViewModel(params) {
                var self = this;
                self.viewModelName = 'stayawayApplyAttentionListViewModel';
               ...
               self.pageFlag = self.parentViewModel.rowData['pageFlag'];
                ...
                self.commonClick = function (data,event) {
                    ...
                    dl.pushPageStack({name: 'personnel/stayaway/stayawayApplyAttentionList', params: self.parentViewModel});
...
//                一键标记已读的回调函数
                ...
                stayawayApplyAttentionListModel = oj.Model.extend({
                    parse: dl.parseModel,
                    idAttribute: 'systemProcessAttentionId'
                });

                stayawayApplyAttentionListCollection = oj.Collection.extend({
                    model: new stayawayApplyAttentionListModel(),
                ...
                self.collection = new stayawayApplyAttentionListCollection();
            ...
            return stayawayApplyAttentionListViewModel;
        }
);
