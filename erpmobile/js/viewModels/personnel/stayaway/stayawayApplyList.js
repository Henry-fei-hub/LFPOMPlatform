...
define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl) {
            function stayawayApplyListViewModel(params) {
                var self = this;
                self.viewModelName = 'stayawayApplyListViewModel';
              ...
              //                放查询条件
                ...
                stayawayApplyListModel = oj.Model.extend({
                    parse: dl.parseModel,
                    idAttribute: 'processInstanceActivityId'
                });

                stayawayApplyListCollection = oj.Collection.extend({
                    model: new stayawayApplyListModel(),
                ...
                self.collection = new stayawayApplyListCollection();
            ...
            return stayawayApplyListViewModel;
        }
);
