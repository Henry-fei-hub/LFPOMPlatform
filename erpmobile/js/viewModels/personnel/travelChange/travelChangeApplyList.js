...
define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist', 'ojs/ojlistview',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl) {
            function travelChangeApplyListViewModel(params) {
                var self = this;
                self.viewModelName = 'travelChangeApplyListViewModel';
              ...
              //                放查询条件
                ...
                travelChangeApplyListModel = oj.Model.extend({
                    parse: dl.parseModel,
                    idAttribute: 'resetCostId'
                });

                travelChangeApplyListCollection = oj.Collection.extend({
                    model: new travelChangeApplyListModel(),
                ...
                self.collection = new travelChangeApplyListCollection();
            ...
            return travelChangeApplyListViewModel;
        }
);
