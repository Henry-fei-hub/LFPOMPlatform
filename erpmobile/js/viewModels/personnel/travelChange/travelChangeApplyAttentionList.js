...
define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient','dl/msgbox',  'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl,sc) {
            function travelChangeApplyAttentionListViewModel(params) {
                var self = this;
                self.viewModelName = 'travelChangeApplyAttentionListViewModel';
...
//                一键标记已读的回调函数
                ...
                self.commonClick = function (data, event) {
                    ...
                    dl.pushPageStack({name: 'personnel/travelChange/travelChangeApplyAttentionList', params: self.parentViewModel});
                ...
                travelChangeApplyAttentionListModel = oj.Model.extend({
                    parse: dl.parseModel,
                    idAttribute: 'systemProcessAttentionId'
                });

               travelChangeApplyAttentionListCollection = oj.Collection.extend({
                    model: new travelChangeApplyAttentionListModel(),
                ...
                self.collection = new travelChangeApplyAttentionListCollection();
            ...
            return travelChangeApplyAttentionListViewModel;
        }
);
