...
define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl) {
            ...
            function failInAtenderExamineListViewModel(params) {
                var self = this;
                self.viewModelName = 'failInAtenderExamineListViewModel';
...
//                  每个报销特有businessId
                    ...
                    dl.pushPageStack({name: "myExamine/failInAtenderExamineList", params: self.parentViewModel});
                ...
                self.returnTitle = function (data) {
                        return dl.getLabelByValue('employees', data['employeeId']) + '___'+ data['projectName'];
                };
            ...
            return failInAtenderExamineListViewModel;
        }
);
