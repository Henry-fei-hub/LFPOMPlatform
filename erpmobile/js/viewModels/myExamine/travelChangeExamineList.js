...
define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl) {
            ...
            function travelChangeExamineListViewModel(params) {
                var self = this;
                self.viewModelName = 'travelChangeExamineListViewModel';
...
//                  每个报销特有businessId  
                    ...
                    dl.pushPageStack({name: "myExamine/travelChangeExamineList", params: self.parentViewModel});
...
//                    headerTitle
                ...
                travelChangeExamineListModel = oj.Model.extend({
                    parse: dl.parseModel,
                    idAttribute: 'processInstanceActivityId'
                });

                travelChangeExamineListCollection = oj.Collection.extend({
                    model: new travelChangeExamineListModel(),
                ...
                self.collection = new travelChangeExamineListCollection();
            ...
            return travelChangeExamineListViewModel;
        }
);
