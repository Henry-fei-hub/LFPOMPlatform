define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl) {
            function projectEmployeeProcessExamineListViewModel(params) {
                var self = this;
                self.viewModelName = 'projectEmployeeProcessExamineListViewModel';
...
//                  每个报销特有businessId  
                    ...
                    dl.pushPageStack({name: "myExamine/projectEmployeeProcessExamineList", params: self.parentViewModel});
...
//                    headerTitle
                ...
                self.searchData = {
                  ...
                  projectEmployeeProcessExamineListModel = oj.Model.extend({
                    parse: dl.parseModel,
                    idAttribute: 'processInstanceActivityId'
                });

                  projectEmployeeProcessExamineListCollection = oj.Collection.extend({
                    model: new projectEmployeeProcessExamineListModel(),
                ...
                self.collection = new projectEmployeeProcessExamineListCollection();
            ...
            return projectEmployeeProcessExamineListViewModel;
        }
);
