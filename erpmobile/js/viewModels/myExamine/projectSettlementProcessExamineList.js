...
define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl) {
            ...
            function projectSettlementProcessExamineListViewModel(params) {
                var self = this;
                self.viewModelName = 'projectSettlementProcessExamineListViewModel';
...
//                  每个报销特有businessId  
                    ...
                    dl.pushPageStack({name: "myExamine/projectSettlementProcessExamineList", params: self.parentViewModel});
...
//                    headerTitle
                ...
                self.searchData = {
                  ...
                  projectSettlementProcessExamineListModel = oj.Model.extend({
                    parse: dl.parseModel,
                    idAttribute: 'processInstanceActivityId'
                });

                  projectSettlementProcessExamineListCollection = oj.Collection.extend({
                    model: new projectSettlementProcessExamineListModel(),
                ...
                self.collection = new projectSettlementProcessExamineListCollection();
            ...
            return projectSettlementProcessExamineListViewModel;
        }
);
