define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl) {
            function projectStagesProcessExamineListViewModel(params) {
                var self = this;
                self.viewModelName = 'projectStagesProcessExamineListViewModel';
...
//                  每个报销特有businessId  
                    ...
                    dl.pushPageStack({name: "myExamine/projectStagesProcessExamineList", params: self.parentViewModel});
...
//                    headerTitle
                ...
                self.searchData = {
                  ...
                  projectStagesProcessExamineListModel = oj.Model.extend({
                    parse: dl.parseModel,
                    idAttribute: 'processInstanceActivityId'
                });

                  projectStagesProcessExamineListCollection = oj.Collection.extend({
                    model: new projectStagesProcessExamineListModel(),
                ...
                self.collection = new projectStagesProcessExamineListCollection();
            ...
            return projectStagesProcessExamineListViewModel;
        }
);
