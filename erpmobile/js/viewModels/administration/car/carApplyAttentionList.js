...
define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/msgbox', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl, sc) {
            function carApplyListViewModel(params) {
                var self = this;
                self.viewModelName = 'carApplyListViewModel';
...
//                一键标记已读的回调函数
                ...
                self.commonClick = function (data, event) {
                    ...
                    dl.pushPageStack({name: 'administration/car/carApplyAttentionList', params: self.parentViewModel});
                ...
                carApplyAttentionListModel = oj.Model.extend({
                    parse: dl.parseModel,
                    idAttribute: 'systemProcessAttentionId'
                });

                carApplyAttentionListCollection = oj.Collection.extend({
                    model: new carApplyAttentionListModel(),
                ...
                self.collection = new carApplyAttentionListCollection();
