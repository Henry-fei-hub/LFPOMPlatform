define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient','dl/msgbox', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojselectcombobox', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource','ojs/ojarraytabledatasource'],
        function (oj, ko, $, dl, sc) {
            function goodsApplyViewViewModel(params) {
                var self = this;
                self.viewModelName = 'goodsApplyViewViewModel';
                ...
                self.datareceived = function (data) {
                    ...
                    //  某人的报销页面的标题以报销人+主题 
                    self.specialHeaderTitle(dl.getLabelByValue('employees', arrData[0]['employeeId']) + dl.getLabelByValue('system_dictionary_109', arrData[0]['type']));
                };
                ...
                self.getValues = function () {
                    ...
                    userData[0].detailPersonnelBusinessLinkEquipment = self.processbillListData;
                    return userData[0];
                };
               ...
               self.submitClick = function (data, event) {
                ...
                self.jinduClick = function (data, event) {
                    ...
                    dl.getGlobalModule({name: 'schedule', params: self});
                    dl.pushPageStack({name: 'administration/goods/goodsApplyView', params: self.parentViewModel, cacheKey: 'administration/goods/goodsApplyView'});
...
//                        不用写死 父级有传过来   params.rowData.activityType|self.parentViewModel.rowData.processType都可
            ...
            return goodsApplyViewViewModel;
        }
);
