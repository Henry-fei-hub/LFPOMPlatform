define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl) {
            function goodsApplyListViewModel(params) {
                var self = this;
                self.viewModelName = 'goodsApplyListViewModel';
                ...
                goodsApplyListModel = oj.Model.extend({
                    parse: dl.parseModel,
                    idAttribute: 'processInstanceActivityId'
                });

                goodsApplyListCollection = oj.Collection.extend({
                    model: new goodsApplyListModel(),
                ...
                self.collection = new goodsApplyListCollection();
            ...
            return goodsApplyListViewModel;
        }
);
