...
define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient','dl/msgbox',  'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl,sc) {
            function goodsApplyAttentionListViewModel(params) {
                var self = this;
                self.viewModelName = 'goodsApplyAttentionListViewModel';
...
//                一键标记已读的回调函数
                ...
                self.commonClick = function (data, event) {
                    ...
                    dl.pushPageStack({name: 'administration/goods/goodsApplyAttentionList', params: self.parentViewModel});
                ...
                goodsApplyAttentionListModel = oj.Model.extend({
                    parse: dl.parseModel,
                    idAttribute: 'systemProcessAttentionId'
                });

               goodsApplyAttentionListCollection = oj.Collection.extend({
                    model: new goodsApplyAttentionListModel(),
                ...
                self.collection = new goodsApplyAttentionListCollection();
            ...
            return goodsApplyAttentionListViewModel;
        }
);
