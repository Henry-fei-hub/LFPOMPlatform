define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/msgbox','dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl ,sc) {
            function salaryReportApplyListViewModel(params) {
                var self = this;
                self.viewModelName = 'salaryReportApplyListViewModel';
...
//                一键标记已读的回调函数
                ...
                self.commonClick = function (data,event) {
                    ...
                    dl.pushPageStack({name: 'administration/salaryReport/salaryReportApplyAttentionList', params: self.parentViewModel});
                ...
                salaryReportApplyAttentionListModel = oj.Model.extend({
                    parse: dl.parseModel,
                    idAttribute: 'systemProcessAttentionId'
                });

               salaryReportApplyAttentionListCollection = oj.Collection.extend({
                    model: new salaryReportApplyAttentionListModel(),
                ...
                self.collection = new salaryReportApplyAttentionListCollection();
            ...
            return salaryReportApplyListViewModel;
        }
);
