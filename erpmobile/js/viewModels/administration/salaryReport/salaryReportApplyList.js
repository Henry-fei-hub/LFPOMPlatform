        ...
        function (oj, ko, $, dl) {
            ...
            function salaryReportApplyListViewModel(params) {
                ...
                self.commonClick = function (event, selfData) {
                    ...
                    dl.pushPageStack({name: 'administration/salaryReport/salaryReportApplyList', params: self.parentViewModel});
              ...
              //                放查询条件
                ...
                salaryReportApplyListModel = oj.Model.extend({
                    parse: dl.parseModel,
                    idAttribute: 'processInstanceActivityId'
                });

                salaryReportApplyListCollection = oj.Collection.extend({
                    model: new salaryReportApplyListModel(),
                ...
                self.collection = new salaryReportApplyListCollection();
