define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl) {
            ...
            function stampCarvingApplyListViewModel(params) {
                var self = this;
                self.viewModelName = 'stampCarvingApplyListViewModel';
                ...
                stampCarvingExamineListModel = oj.Model.extend({
                    parse: dl.parseModel,
                    idAttribute: 'processInstanceActivityId'
                });

                stampCarvingExamineListCollection = oj.Collection.extend({
                    model: new stampCarvingExamineListModel(),
                ...
                self.collection = new stampCarvingExamineListCollection();
            ...
            return stampCarvingApplyListViewModel;
        }
);
