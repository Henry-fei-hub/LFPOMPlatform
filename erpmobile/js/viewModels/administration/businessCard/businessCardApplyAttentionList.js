...
define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/msgbox', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl,sc) {
            function businessCardApplyAttentionListViewModel(params) {
                var self = this;
                self.viewModelName = 'businessCardApplyAttentionListViewModel';
...
//                一键标记已读的回调函数
                ...
                self.commonClick = function (event, selfData) {
                    ...
                    dl.pushPageStack({name: 'administration/businessCard/businessCardApplyAttentionList', params: self.parentViewModel});
                ...
                businessCardApplyAttentionListModel = oj.Model.extend({
                    parse: dl.parseModel,
                    idAttribute: 'systemProcessAttentionId'
                });

               businessCardApplyAttentionListCollection = oj.Collection.extend({
                    model: new businessCardApplyAttentionListModel(),
                ...
                self.collection = new businessCardApplyAttentionListCollection();
            ...
            return businessCardApplyAttentionListViewModel;
        }
);
