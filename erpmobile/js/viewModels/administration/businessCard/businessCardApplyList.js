define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl) {
            function businessCardApplyListViewModel(params) {
                var self = this;
                self.viewModelName = 'businessCardApplyListViewModel';
                ...
                businessCarExamineListModel = oj.Model.extend({
                    parse: dl.parseModel,
                    idAttribute: 'processInstanceActivityId'
                });

                businessCarExamineListCollection = oj.Collection.extend({
                    model: new businessCarExamineListModel(),
                ...
                self.collection = new businessCarExamineListCollection();
            ...
            return businessCardApplyListViewModel;
        }
);
