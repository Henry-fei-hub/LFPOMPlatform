define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl) {
            ...
            function SalaryAdjustApplyListViewModel(params) {
                var self = this;
                self.viewModelName = 'SalaryAdjustApplyListViewModel';
              ...
              //                放查询条件
                ...
                SalaryAdjustApplyListModel = oj.Model.extend({
                    parse: dl.parseModel,
                    idAttribute: 'processInstanceActivityId'
                });

                SalaryAdjustApplyListCollection = oj.Collection.extend({
                    model: new SalaryAdjustApplyListModel(),
                ...
                self.collection = new SalaryAdjustApplyListCollection();
            ...
            return SalaryAdjustApplyListViewModel;
        }
);
