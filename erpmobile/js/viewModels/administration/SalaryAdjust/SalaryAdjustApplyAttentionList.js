...
define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/msgbox', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource','ojs/ojarraytabledatasource'],
        function (oj, ko, $, dl, sc) {
            function SalaryAdjustApplyAttentionListViewModel(params) {
                var self = this;
                self.viewModelName = 'SalaryAdjustApplyAttentionListViewModel';
...
//                     dl.getProcessPageName = function (processType, activityType) activityType 2 view 4 atttention
                    ...
                    dl.pushPageStack({name: 'administration/SalaryAdjust/SalaryAdjustApplyAttentionList', params: self.parentViewModel, cacheKey: 'administration/SalaryAdjust/SalaryAdjustApplyAttentionList'});
            ...
            return SalaryAdjustApplyAttentionListViewModel;
        }
);
