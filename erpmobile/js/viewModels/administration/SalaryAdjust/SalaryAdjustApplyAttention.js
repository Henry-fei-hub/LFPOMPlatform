...
define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojselectcombobox', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource','ojs/ojarraytabledatasource'],
        function (oj, ko, $, dl) {
            function SalaryAdjustAttentionViewModel(params) {
                var self = this;
                self.viewModelName = 'SalaryAdjustAttentionViewModel';
...
//                    进入即阅
                ...
                self.jinduClick = function (data, event) {
                    ...
                    dl.pushPageStack({name: 'administration/SalaryAdjust/SalaryAdjustApplyAttention', params: self.parentViewModel, cacheKey: 'administration/SalaryAdjust/SalaryAdjustApplyAttention'});
             ...
             return SalaryAdjustAttentionViewModel;
        }
);
