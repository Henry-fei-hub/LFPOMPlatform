define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl) {
            ...
            function purchaseApplyListViewModel(params) {
                var self = this;
                self.viewModelName = 'purchaseApplyListViewModel';
                ...
                purchaseApplyListModel = oj.Model.extend({
                    parse: dl.parseModel,
                    idAttribute: 'processInstanceActivityId'
                });

                purchaseApplyListCollection = oj.Collection.extend({
                    model: new purchaseApplyListModel(),
                ...
                self.collection = new purchaseApplyListCollection();
            ...
            return purchaseApplyListViewModel;
        }
);
