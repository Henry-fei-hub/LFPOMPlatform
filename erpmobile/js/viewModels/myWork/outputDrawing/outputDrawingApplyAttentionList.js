...
define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient','dl/msgbox', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl,sc) {
            function outputDrawingApplyAttentionListViewModel(params) {
                var self = this;
                self.viewModelName = 'outputDrawingApplyAttentionListViewModel';
...
//                一键标记已读的回调函数
                ...
                self.commonClick = function (data,event) {
                    ...
                    dl.pushPageStack({name: 'myWork/outputDrawing/outputDrawingApplyAttentionList', params: self.parentViewModel});
                ...
                outputDrawingApplyAttentionListModel = oj.Model.extend({
                         parse: dl.parseModel,
                        idAttribute: 'businessId'
                });
               outputDrawingApplyAttentionListCollection = oj.Collection.extend({
                        model: new outputDrawingApplyAttentionListModel(),
                ...
                self.collection = new outputDrawingApplyAttentionListCollection();
            ...
            return outputDrawingApplyAttentionListViewModel;
        }
);
