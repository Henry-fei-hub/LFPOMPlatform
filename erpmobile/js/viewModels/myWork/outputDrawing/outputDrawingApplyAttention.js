define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojselectcombobox', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource','ojs/ojarraytabledatasource'],
        function (oj, ko, $, dl) {
            function outputDrawingApplyAttentionViewModel(params) {
                var self = this;
                self.viewModelName = 'outputDrawingApplyAttentionViewModel';
...
//                    进入即阅
                ...
                self.jinduClick = function (data, event) {
                    ...
                    dl.pushPageStack({name: 'myWork/outputDrawing/outputDrawingApplyAttention', params: self.parentViewModel});
            ...
            return outputDrawingApplyAttentionViewModel;
        }
);
