...
define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl) {
            ...
            function outputDrawingApplyListViewModel(params) {
                var self = this;
                self.viewModelName = 'outputDrawingApplyListViewModel';
                ...
                outputDrawingApplyListModel = oj.Model.extend({
                    parse: dl.parseModel,
                    idAttribute: 'processInstanceActivityId'
                });

                outputDrawingApplyListCollection = oj.Collection.extend({
                    model: new outputDrawingApplyListModel(),
                ...
                self.collection = new outputDrawingApplyListCollection();
            ...
            return outputDrawingApplyListViewModel;
        }
);
