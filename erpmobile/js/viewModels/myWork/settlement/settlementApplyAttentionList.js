...
define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient','dl/msgbox', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl,sc) {
            function settlementApplyAttentionListViewModel(params) {
                var self = this;
                self.viewModelName = 'settlementApplyAttentionListViewModel';
...
//                一键标记已读的回调函数
                ...
                self.commonClick = function (data,event) {
                    ...
                    dl.pushPageStack({name: 'myWork/settlement/settlementApplyAttentionList', params: self.parentViewModel});
                ...
                settlementApplyAttentionListModel = oj.Model.extend({
                         parse: dl.parseModel,
                        idAttribute: 'businessId'
                });
               settlementApplyAttentionListCollection = oj.Collection.extend({
                        model: new settlementApplyAttentionListModel(),
                ...
                self.collection = new settlementApplyAttentionListCollection();
            ...
            return settlementApplyAttentionListViewModel;
        }
);
