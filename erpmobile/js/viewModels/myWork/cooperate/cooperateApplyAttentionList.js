...
define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient','dl/msgbox', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl,sc) {
            function cooperateApplyAttentionListViewModel(params) {
                var self = this;
                self.viewModelName = 'cooperateApplyAttentionListViewModel';
...
//                一键标记已读的回调函数
                ...
                self.commonClick = function (data,event) {
                    ...
                    dl.pushPageStack({name: 'myWork/cooperate/cooperateApplyAttentionList', params: self.parentViewModel});
                ...
                cooperateApplyAttentionListModel = oj.Model.extend({
                         parse: dl.parseModel,
                        idAttribute: 'businessId'
                });
               cooperateApplyAttentionListCollection = oj.Collection.extend({
                        model: new cooperateApplyAttentionListModel(),
                ...
                self.collection = new cooperateApplyAttentionListCollection();
            ...
            return cooperateApplyAttentionListViewModel;
        }
);
