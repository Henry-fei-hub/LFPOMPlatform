...
define(['ojs/ojcore', 'knockout', 'jquery', 'dl/commclient', 'dl/workflow', 'ojs/ojknockout', 'promise', 'ojs/ojnavigationlist',
    'ojs/ojdatagrid', 'ojs/ojrowexpander', 'ojs/ojflattenedtreedatagriddatasource', 'ojs/ojjsontreedatasource', 'ojs/ojcollectiontabledatasource'],
        function (oj, ko, $, dl) {
            ...
            function cooperateApplyListViewModel(params) {
                var self = this;
                self.viewModelName = 'cooperateApplyListViewModel';
                ...
                cooperateApplyListModel = oj.Model.extend({
                    parse: dl.parseModel,
                    idAttribute: 'processInstanceActivityId'
                });

                cooperateApplyListCollection = oj.Collection.extend({
                    model: new cooperateApplyListModel(),
                ...
                self.collection = new cooperateApplyListCollection();
            ...
            return cooperateApplyListViewModel;
        }
);
